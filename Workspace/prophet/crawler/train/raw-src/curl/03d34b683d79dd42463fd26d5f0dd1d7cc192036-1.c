...
# 364 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
...
# 392 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_ntlm_create_type1_message(const char *userp,
                                        const char *passwdp,
                                        struct ntlmdata *ntlm,
                                        char **outptr,
                                        size_t *outlen)
{
# 412 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  unsigned char ntlmbuf[1024];
  size_t size;
# 481 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  const char *host = "";
  const char *domain = "";
  size_t hostlen = 0;
  size_t domlen = 0;
  ...
  do { } while(0);
# 558 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  return Curl_base64_encode(((void*)0), (char *)ntlmbuf, size, outptr, outlen);
}
# 580 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_ntlm_create_type3_message(struct SessionHandle *data,
                                        const char *userp,
                                        const char *passwdp,
                                        struct ntlmdata *ntlm,
                                        ...
                                        size_t *outlen)
{
# 605 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  unsigned char ntlmbuf[1024];
  size_t size;
# 657 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  int lmrespoff;
  ...
  do { } while(0);
# 937 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
