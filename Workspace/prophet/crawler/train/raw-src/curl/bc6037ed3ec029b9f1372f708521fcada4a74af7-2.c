# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
# 1 "../lib/non-ascii.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
...
# 59 "../lib/curlx.h" 2
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2

# 1 "../lib/memdebug.h" 1
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c" 2
...
CURLcode Curl_proxy_connect(struct connectdata *conn)
{
  if(conn->bits.tunnel_proxy && conn->bits.httpproxy) {
    ...
    void *prot_save;
    CURLcode result;
# 69 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_proxy.c"
    prot_save = conn->data->state.proto.generic;
    memset(&http_proxy, 0, sizeof(http_proxy));
    conn->data->state.proto.http = &http_proxy;
    conn->bits.close = 0;
    result = Curl_proxyCONNECT(conn, 0,
                           ...
                           unsigned short remote_port)
{
  ...
  CURLcode result;
  long timeout =
    data->set.timeout?data->set.timeout:(3600*1000);
  curl_socket_t tunnelsocket = conn->sock[sockindex];
  curl_off_t cl=0;
  _Bool closeConnection = 0;
  _Bool chunked_encoding = 0;
  long check;
  ...
  do {
    if(TUNNEL_INIT == conn->tunnel_state[sockindex]) {
      ...
      host_port = curl_maprintf("%s:%hu", hostname, remote_port);
      if(!host_port) {
      ...
      result = Curl_http_output_auth(conn, "CONNECT", host_port, 1);
      ...
      if(CURLE_OK == result) {
        ...
        const char *http = (conn->proxytype == CURLPROXY_HTTP_1_0) ?
          "1.0" : "1.1";
        char *hostheader=
          curl_maprintf("%s%s%s:%hu", conn->bits.ipv6_ip?"[":"",
      ...
      do {if((req_buffer)) {Curl_cfree((req_buffer)); (req_buffer) = ((void*)0);}} while(0);
      if(result)
        return result;
...

    {
      ...
      while((nread<16384) && (keepon && !error)) {


        check = timeout -
          curlx_tvdiff(curlx_tvnow(),conn->now);
        if(check <= 0) {
        ...
        switch (Curl_socket_check(tunnelsocket, -1, -1, check<1000L?check:1000)) {
        ...
        default:
          do { } while(0);
          result = Curl_read(conn, tunnelsocket, ptr, 16384 -nread,
                             &gotbytes);
          if(result==CURLE_AGAIN)
            ...
            if(data->set.proxyauth && data->state.authproxy.avail) {
              ...
              conn->bits.proxy_connect_closed = 1;
            }
            else {
              error = 1;
            ...
            if(keepon > 1) {
              ...
              for(i = 0; i < gotbytes; ptr++, i++) {
                ...
                if(*ptr == 0x0a) {
                  ...
                  if(('\r' == line_start[0]) ||
                    ...
                    if((407 == k->httpcode) && !data->state.authproblem) {
                      ...
                      if(200 == data->info.httpproxycode) {
                        if(gotbytes - (i+1))
                          Curl_failf(data, "Proxy CONNECT followed by %zd bytes "
                  ...
                  if((Curl_raw_nequal("WWW-Authenticate:",line_start,strlen("WWW-Authenticate:")) &&
                      (401 == k->httpcode)) ||
                     (Curl_raw_nequal("Proxy-authenticate:",line_start,strlen("Proxy-authenticate:")) &&
                      (407 == k->httpcode))) {
                  ...
                  else if(Curl_raw_nequal("Content-Length:",line_start,strlen("Content-Length:"))) {
                    cl = strtol(line_start +
                                         strlen("Content-Length:"), ((void*)0), 10);
                  }
  ...
  conn->allocptr.proxyuserpwd = ((void*)0);

  data->state.authproxy.done = 1;

  Curl_infof (data, "Proxy replied OK to CONNECT request\n");
  data->req.ignorebody = 0;
