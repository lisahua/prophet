# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostcheck.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostcheck.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostcheck.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostcheck.c" 2
...
# 26 "../lib/hostcheck.h" 2



int Curl_cert_hostcheck(const char *match_pattern, const char *hostname);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostcheck.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostcheck.c" 2
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostcheck.c"
static int hostmatch(const char *hostname, const char *pattern)
{
  const char *pattern_label_end, *pattern_wildcard, *hostname_label_end;
  int wildcard_enabled;
  size_t prefixlen, suffixlen;
  pattern_wildcard = (__extension__ (__builtin_constant_p ('*') && !__builtin_constant_p (pattern) && ('*') == '\0' ? (char *) __rawmemchr (pattern, '*') : __builtin_strchr (pattern, '*')));
  ...
  wildcard_enabled = 1;
  pattern_label_end = (__extension__ (__builtin_constant_p ('.') && !__builtin_constant_p (pattern) && ('.') == '\0' ? (char *) __rawmemchr (pattern, '.') : __builtin_strchr (pattern, '.')));
  if(pattern_label_end == ((void*)0) || (__extension__ (__builtin_constant_p ('.') && !__builtin_constant_p (pattern_label_end+1) && ('.') == '\0' ? (char *) __rawmemchr (pattern_label_end+1, '.') : __builtin_strchr (pattern_label_end+1, '.'))) == ((void*)0) ||
  ...
  hostname_label_end = (__extension__ (__builtin_constant_p ('.') && !__builtin_constant_p (hostname) && ('.') == '\0' ? (char *) __rawmemchr (hostname, '.') : __builtin_strchr (hostname, '.')));
...
int Curl_cert_hostcheck(const char *match_pattern, const char *hostname)
{
  ...
  if(hostmatch(hostname,match_pattern) == 1)
    return 1;
  return 0;
}
