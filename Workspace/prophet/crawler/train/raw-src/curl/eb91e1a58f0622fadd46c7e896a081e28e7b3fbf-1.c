...
# 308 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  ntlm->flags = 0;
  ...
  do { } while(0);
# 340 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  Curl_cfree(buffer);

  return CURLE_OK;
}
# 366 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
...
# 395 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_ntlm_create_type1_message(const char *userp,
                                        const char *passwdp,
                                        struct ntlmdata *ntlm,
                                        char **outptr,
                                        size_t *outlen)
{
# 415 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  unsigned char ntlmbuf[1024];
  size_t size;
# 544 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  const char *host = "";
  const char *domain = "";
  size_t hostlen = 0;
  size_t domlen = 0;
  ...
  do { } while(0);
# 621 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  return Curl_base64_encode(((void*)0), (char *)ntlmbuf, size, outptr, outlen);
}
# 643 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_ntlm_create_type3_message(struct SessionHandle *data,
                                        const char *userp,
                                        const char *passwdp,
                                        struct ntlmdata *ntlm,
                                        ...
                                        size_t *outlen)
{
# 668 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  unsigned char ntlmbuf[1024];
  size_t size;
# 715 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  int lmrespoff;
  ...
  do { } while(0);
# 992 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
