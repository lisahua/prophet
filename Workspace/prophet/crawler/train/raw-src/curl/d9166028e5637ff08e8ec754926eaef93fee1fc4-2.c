# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c" 2
...
# 59 "../lib/curlx.h" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c" 2
# 1 "../src/tool_msgs.h" 1
# 26 "../src/tool_msgs.h"
void warnf(struct OperationConfig *config, const char *fmt, ...);

void helpf(FILE *errors, const char *fmt, ...);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c" 2
# 1 "../src/tool_cb_dbg.h" 1
# 30 "../src/tool_cb_dbg.h"
int tool_debug_cb(CURL *handle, curl_infotype type,
                  unsigned char *data, size_t size,
                  void *userdata);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c" 2
# 1 "../src/tool_util.h" 1
# 26 "../src/tool_util.h"
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c" 2

# 1 "../lib/memdebug.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c" 2
    ...
    case CURLINFO_SSL_DATA_OUT:
      if(!traced_data) {
        ...
        if(!config->isatty || ((output != stderr) && (output != stdout))) {
          if(!newl)
            curl_mfprintf(output, "%s%s ", timebuf, s_infotype[type]);
          curl_mfprintf(output, "[%zd bytes data]\n", size);
          newl = 0;
          traced_data = 1;
        }
      }
...
# 185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c"
  switch (type) {
  case CURLINFO_TEXT:
...
# 260 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cb_dbg.c"
      (void)infotype;
