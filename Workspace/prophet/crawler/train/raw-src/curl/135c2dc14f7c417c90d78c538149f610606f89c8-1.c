# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
...
extern int fgetpwent_r (FILE *__restrict __stream,
   ...
   char *__restrict __buffer, size_t __buflen,
   struct passwd **__restrict __result);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
# 1 "../lib/netrc.h" 1
# 26 "../lib/netrc.h"
int Curl_parsenetrc(const char *host,
                    ...
                    char **passwordp,
                    char *filename);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2

# 1 "../lib/strequal.h" 1
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
# 1 "../lib/strtok.h" 1
# 25 "../lib/strtok.h"
...
# 26 "../lib/strtok.h" 2
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2


# 1 "../lib/memdebug.h" 1
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/netrc.c" 2
                    ...
                    char *netrcfile)
{
  ...
  if(!netrcfile) {
    ...
    if(home_alloc)
      do {if((home)) {Curl_cfree((home)); (home) = ((void*)0);}} while(0);
    if(!netrcfile) {
      return -1;
    }
    netrc_alloc = 1;
  ...
  if(netrc_alloc)
    do {if((netrcfile)) {Curl_cfree((netrcfile)); (netrcfile) = ((void*)0);}} while(0);
  if(file) {
    char *tok;
    char *tok_buf;
    _Bool done=0;
    ...
    while(!done && fgets(netrcbuffer, netrcbuffsize, file)) {
      tok=(__extension__ (__builtin_constant_p (" \t\n") && ((size_t)(const void *)((" \t\n") + 1) - (size_t)(const void *)(" \t\n") == 1) && ((const char *) (" \t\n"))[0] != '\0' && ((const char *) (" \t\n"))[1] == '\0' ? __strtok_r_1c (netrcbuffer, ((const char *) (" \t\n"))[0], &tok_buf) : __strtok_r (netrcbuffer, " \t\n", &tok_buf)));
      while(!done && tok) {
