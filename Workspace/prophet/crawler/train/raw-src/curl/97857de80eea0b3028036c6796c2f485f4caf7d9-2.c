...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm.c" 2
...
# 1 "../lib/memdebug.h" 1
# 56 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm.c" 2
                          ...
                          _Bool proxy)
{
  ...
  if(!passwdp)
    passwdp = "";
# 174 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm.c"
  switch(ntlm->state) {
...
void Curl_http_ntlm_cleanup(struct connectdata *conn)
{
  ...
  do {if((conn->proxyntlm.target_info)) {Curl_cfree((conn->proxyntlm.target_info)); (conn->proxyntlm.target_info) = ((void*)0);}} while(0);
