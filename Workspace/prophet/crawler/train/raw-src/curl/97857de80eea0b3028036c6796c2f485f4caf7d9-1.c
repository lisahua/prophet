# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c"
# 1 "../lib/urldata.h" 1
# 71 "../lib/urldata.h"
# 1 "../lib/cookie.h" 1
# 26 "../lib/cookie.h"
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
# 1 "../lib/curl_ntlm.h" 1
# 30 "../lib/curl_ntlm.h"
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
...
CURLcode Curl_ntlm_decode_type2_target(struct SessionHandle *data,
                                       ...
                                       size_t size,
                                       struct ntlmdata* ntlm);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
# 1 "../lib/curl_ntlm_wb.h" 1
# 31 "../lib/curl_ntlm_wb.h"
CURLcode Curl_output_ntlm_wb(struct connectdata *conn, _Bool proxy);

void Curl_ntlm_wb_cleanup(struct connectdata *conn);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
# 1 "../lib/url.h" 1
# 30 "../lib/url.h"
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
...
# 1 "../lib/memdebug.h" 1
# 56 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c" 2
...

{
  ...
  if(Curl_raw_nequal("NTLM",header,strlen("NTLM"))) {
    header += strlen("NTLM");

    while(*header && (((*__ctype_b_loc ())[(int) (((int) ((unsigned char)*header)))] & (unsigned short int) _ISspace)))
      header++;
                          ...
                          _Bool proxy)
{
  ...
  if(!passwdp)
    passwdp = "";
# 174 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm.c"
  switch(ntlm->state) {
...
void Curl_http_ntlm_cleanup(struct connectdata *conn)
{
  ...
  do {if((conn->ntlm.target_info)) {Curl_cfree((conn->ntlm.target_info)); (conn->ntlm.target_info) = ((void*)0);}} while(0);
