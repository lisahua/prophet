# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/inet_pton.h" 1
# 27 "../lib/inet_pton.h"
int Curl_inet_pton(int, const char *, void *);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/ssluse.h" 1
# 34 "../lib/ssluse.h"
...
void Curl_ossl_md5sum(unsigned char *tmp,
                      ...
                      size_t unused);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/strequal.h" 1
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/sslgen.h" 1
# 30 "../lib/sslgen.h"
...
void Curl_ssl_md5sum(unsigned char *tmp,
                     ...
                     unsigned char *md5sum,
                     size_t md5len);
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/hostcheck.h" 1
# 29 "../lib/hostcheck.h"
int Curl_cert_hostcheck(const char *match_pattern, const char *hostname);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
...
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
...
# 60 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
...
# 71 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
...
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 1 "../lib/non-ascii.h" 1
# 73 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2


# 1 "../lib/memdebug.h" 1
# 76 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c" 2
# 148 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
...
# 178 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
static _Bool rand_enough(void)
{
  return (0 != RAND_status()) ? 1 : 0;
}
# 191 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
static int ossl_seed(struct SessionHandle *data)
{
  char *buf = data->state.buffer;
  int nread=0;
# 205 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
  {
...
# 281 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
...
# 328 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
    ...
    case 43:
    {
      ...
      if(ca && sk_num(((_STACK*) (1 ? (ca) : (struct stack_st_X509*)0)))) {
        for(i = 0; i < sk_num(((_STACK*) (1 ? (ca) : (struct stack_st_X509*)0))); i++) {
          if(!SSL_CTX_ctrl(ctx,14,0,(char *)((X509 *)sk_value(((_STACK*) (1 ? (ca) : (struct stack_st_X509*)0)), (i))))) {
          ...
          if(!SSL_CTX_add_client_CA(ctx, ((X509 *)sk_value(((_STACK*) (1 ? (ca) : (struct stack_st_X509*)0)), (i))))) {
...
# 673 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
int Curl_ossl_init(void)
{
...
# 730 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
...
# 763 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
  if(!e) {
...
# 1047 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
  ...
  if(altnames) {
    ...
    for(i=0; (i<numalts) && (matched != 1); i++) {
      ...
      if(check->type == target) {
        ...
        switch(target) {
        case 2:
# 1110 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
    ...
    if(i>=0) {
      ...
      if(tmp) {
        if(ASN1_STRING_type(tmp) == 12) {
          ...
          if(j >= 0) {
            peer_CN = CRYPTO_malloc((int)j+1,"/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c",1173);
            if(peer_CN) {
...
# 1345 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
static CURLcode
                   ...
                   int sockindex)
{
  ...
  case CURL_SSLVERSION_DEFAULT:
    ...
    if(data->set.ssl.authtype == CURL_TLSAUTH_SRP) {
      Curl_infof(data, "Set version TLSv1 for SRP authorisation\n");
...
# 1405 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
...
# 1480 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
  ...
  if(data->set.str[STRING_SSL_CIPHER_LIST]) {
    if(!SSL_CTX_set_cipher_list(connssl->ctx,
      ...
      Curl_failf(data, "failed setting cipher list");
                                  ...
                                  size_t valuelen)
{
  ...
  output = Curl_cmalloc(outlen);
  if(!output)
    return CURLE_OUT_OF_MEMORY;


  curl_msnprintf(output, outlen, "%s:", label);
...
# 1888 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
                         ...
                         int num)
{
  ...
  ci->num_of_certs = num;
  table = Curl_ccalloc((size_t)num, sizeof(struct curl_slist *));
  if(!table)
    return 1;
...
# 2007 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
...

{
  ...
  for(i=0; i<numcerts; i++) {
    ...
    push_certinfo(data, i, "Version", bufp);
    ...
    if(bufp[0])
      push_certinfo(data, i, "Serial Number", bufp);
...
# 2179 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
                           ...
                           _Bool strict)
{
  ...
  if(rc) {
    if(strict)
      Curl_failf(data, "SSL: couldn't get X509-subject!");
...
# 2344 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
...
# 2377 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
  if(!data->set.ssl.verifypeer)
...
# 2691 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ssluse.c"
}
