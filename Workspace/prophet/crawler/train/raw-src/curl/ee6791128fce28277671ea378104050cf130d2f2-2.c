                           ...
                           struct sigpipe_ignore *ig)
{
  ...
  if(!data->set.no_signal) {
    ...
    sigaction(13, ((void*)0), &ig->old_pipe_act);
    action = ig->old_pipe_act;

    action.__sigaction_handler.sa_handler = ((__sighandler_t) 1);
    sigaction(13, &action, ((void*)0));
  }
}
...
static void sigpipe_restore(struct sigpipe_ignore *ig)
{
  if(!ig->no_signal)
    ...
    sigaction(13, &ig->old_pipe_act, ((void*)0));
}
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c" 2
...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c" 2

# 1 "../lib/memdebug.h" 1
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c" 2
# 71 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
static CURLMcode multi_timeout(struct Curl_multi *multi,
                               long *timeout_ms);
# 106 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
)
{
  ...
  data->mstate = state;
# 138 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  if(state == CURLM_STATE_COMPLETED)

    data->multi->num_alive--;
}
# 153 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 253 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                                ...
                                CURL *easy_handle)
{
  ...
  if(!timeoutlist)
    return CURLM_OUT_OF_MEMORY;
# 380 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  ...
  multi->num_alive++;
# 454 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 476 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                                   ...
                                   CURL *curl_handle)
{
  ...
  if(easy) {
    _Bool premature = (data->mstate < CURLM_STATE_COMPLETED) ? 1 : 0;
    _Bool easy_owns_conn = (data->easy_conn &&
    ...
    if(data->easy_conn) {
      data->easy_conn->data = ((void*)0);
      data->easy_conn = ((void*)0);
    }
                         ...
                         int numsocks)
{
  ...
  switch(data->mstate) {
  default:
# 699 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    return 0;
                           ...
                           fd_set *exc_fd_set, int *max_fd)
{
  ...
  data=multi->easyp;
  while(data) {
    bitmap = multi_getsock(data, sockbunch, 5);
                          ...
                          int *ret)
{
  ...
  if(nfds) {
    ...
    Curl_infof(data, "Curl_poll(%d ds, %d ms)\n", nfds, timeout_ms);
                                 ...
                                 struct SessionHandle *data)
{
  ...
  if(!((data) && (((struct SessionHandle *)(data))->magic == 0xc0dedbadU)))
    return CURLM_BAD_EASY_HANDLE;
  ...
  do {
    ...
    if(data->easy_conn &&
      ...
      if(timeout_ms < 0) {
        ...
        if(data->mstate == CURLM_STATE_WAITRESOLVE)
          ...
          if(k->size != -1) {
            Curl_failf(data, "Operation timed out after %ld milliseconds with %"
                  "ld" " out of %"
                  "ld" " bytes received",
                  curlx_tvdiff(k->now,data->progress.t_startsingle),
                  k->bytecount, k->size);
          }
          else {
            Curl_failf(data, "Operation timed out after %ld milliseconds with %"
        ...
        mstate(data,CURLM_STATE_COMPLETED);
        break;
      }
    }
      ...
      if(CURLE_OK == data->result) {
        ...
        if(CURLE_OK != data->result)
          ...
          if(async)
            ...
            mstate(data,CURLM_STATE_WAITRESOLVE);
          else {
            ...
            if(protocol_connect)
              mstate(data,multi->pipelining_enabled? CURLM_STATE_WAITDO:CURLM_STATE_DO);

            else {

              if(data->easy_conn->tunnel_state[0] == TUNNEL_CONNECT)
                mstate(data,CURLM_STATE_WAITPROXYCONNECT);
              else

                mstate(data,CURLM_STATE_WAITCONNECT);
            }
          }
        }
      }
    ...
    case CURLM_STATE_WAITPROXYCONNECT:
      ...
      if(data->easy_conn->bits.proxy_connect_closed) {
        ...
        if(data->easy_conn->tunnel_state[0] == TUNNEL_COMPLETE)
          mstate(data,CURLM_STATE_WAITCONNECT);
      }
      break;
    ...
    case CURLM_STATE_PROTOCONNECT:
      ...
      if((data->result == CURLE_OK) && protocol_connect) {
        ...
        Curl_done(&data->easy_conn, data->result, 1);
        disconnect_conn = 1;
      }
      break;

    case CURLM_STATE_WAITDO:
# 1226 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
      if(!data->easy_conn->writechannel_inuse &&
         isHandleAtHead(data,
                        data->easy_conn->send_pipe)) {

        data->easy_conn->writechannel_inuse = 1;
        mstate(data,CURLM_STATE_DO);
        result = CURLM_CALL_MULTI_PERFORM;
      }
      break;
    ...
    case CURLM_STATE_DO:
      if(data->set.connect_only) {
        ...
        if(CURLE_OK == data->result) {
          if(!dophase_done) {
            ...
            if(data->set.wildcardmatch) {
              ...
              if(wc->state == CURLWC_DONE || wc->state == CURLWC_SKIP) {
                ...
                Curl_done(&data->easy_conn, CURLE_OK, 0);
                mstate(data,CURLM_STATE_DONE);
                result = CURLM_CALL_MULTI_PERFORM;
                break;
              }
            ...
            mstate(data,CURLM_STATE_DO_MORE);
            result = CURLM_OK;
          }
          else {

            mstate(data,CURLM_STATE_DO_DONE);
            result = CURLM_CALL_MULTI_PERFORM;
          }
        }
          ...
          Curl_posttransfer(data);
          drc = Curl_done(&data->easy_conn, data->result, 0);
          ...
          Curl_posttransfer(data);
          if(data->easy_conn)
            Curl_done(&data->easy_conn, data->result, 0);
          disconnect_conn = 1;
        }
      }
      break;
    ...
    case CURLM_STATE_DOING:
      ...
      if(CURLE_OK == data->result) {
        if(dophase_done) {
          ...
          mstate(data,data->easy_conn->bits.do_more? CURLM_STATE_DO_MORE: CURLM_STATE_DO_DONE);
    ...
    case CURLM_STATE_DO_MORE:
      ...
      if(CURLE_OK == data->result) {
        if(control) {
          ...
          mstate(data,control==1? CURLM_STATE_DO_DONE: CURLM_STATE_DOING);
    ...
    case CURLM_STATE_DO_DONE:
      ...
      if((data->easy_conn->sockfd != -1) ||
         (data->easy_conn->writesockfd != -1))
        mstate(data,CURLM_STATE_WAITPERFORM);
      else
        mstate(data,CURLM_STATE_DONE);
      result = CURLM_CALL_MULTI_PERFORM;
      break;
    ...
    case CURLM_STATE_WAITPERFORM:
      ...
      if(!data->easy_conn->readchannel_inuse &&
        ...
        data->easy_conn->readchannel_inuse = 1;
        mstate(data,CURLM_STATE_PERFORM);
        result = CURLM_CALL_MULTI_PERFORM;
      }
# 1430 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(!(k->keepon & (1<<0))) {
        ...
        data->easy_conn->readchannel_inuse = 0;
      }

      if(!(k->keepon & (1<<1))) {

        data->easy_conn->writechannel_inuse = 0;
      }
      ...
      if(data->result) {
# 1524 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
        if(!(data->easy_conn->handler->flags & (1<<1)))
          data->easy_conn->bits.close = 1;
        ...
        if(data->req.newurl || retry) {
          if(!retry) {
            ...
            follow = FOLLOW_RETRY;
          data->result = Curl_done(&data->easy_conn, CURLE_OK, 0);
          if(CURLE_OK == data->result) {
    ...
    case CURLM_STATE_DONE:
      ...
      if(data->easy_conn) {
        ...
        res = Curl_done(&data->easy_conn, CURLE_OK, 0);
    ...
    if(data->mstate < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != data->result) {
# 1670 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
        data->state.pipe_broke = 0;
        ...
        if(data->easy_conn) {
          ...
          if(disconnect_conn) {
            ...
            Curl_disconnect(data->easy_conn, 0);
        ...
        mstate(data,(data->mstate < CURLM_STATE_DONE)? CURLM_STATE_DONE: CURLM_STATE_COMPLETED);
...
# 1785 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  do {
...
# 1898 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                         ...
                         struct SessionHandle *data)
{
  ...
  curraction = multi_getsock(data, socks, 5);
...
# 2087 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_multi_closed(struct connectdata *conn, curl_socket_t s)
{
...
# 2122 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
                              ...
                              int *running_handles)
{
  ...
  if(checkall) {
    ...
    if(!entry)
      ...
      if(data->easy_conn &&
         !(data->easy_conn->handler->flags & (1<<3)))
...
# 2520 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode
...
# 2568 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
