...

{
  ...
  for(; fcmd != DONE; fcmd++) {
    ...
    if(EPRT == fcmd) {
# 1274 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1335 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
static CURLcode ftp_state_use_pasv(struct connectdata *conn)
{
  struct ftp_conn *ftpc = &conn->proto.ftpc;
  CURLcode result = CURLE_OK;
# 1359 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1387 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_state_prepare_transfer(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
  struct FTP *ftp = conn->data->req.protop;
...
static CURLcode ftp_state_list(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
  struct SessionHandle *data = conn->data;
# 1490 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1642 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1877 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
                                    ...
                                    int ftpcode)
{
  ...
  if((ftpc->count1 == 0) &&
      ...
      if(5 == sscanf(ptr, "%c%c%c%u%c",
        ...
        if(ptr) {
          ...
          if(conn->bits.tunnel_proxy ||
            ...
            curl_msnprintf(ftpc->newhost, sizeof(ftpc->newhost), "%s",
                     conn->host.name);
          else

            curl_msnprintf(ftpc->newhost, 48, "%s", conn->ip_addr_str);
        }
      }
      else
        ptr=((void*)0);
    ...
    int ip[4];
    int port[2];
# 1981 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    while(*str) {
    ...
    if(data->set.ftp_skip_ip) {
      ...
      if(conn->bits.tunnel_proxy ||
        ...
        curl_msnprintf(ftpc->newhost, sizeof(ftpc->newhost), "%s", conn->host.name);
      else
        curl_msnprintf(ftpc->newhost, sizeof(ftpc->newhost), "%s",
                 conn->ip_addr_str);
    }
    else
      curl_msnprintf(ftpc->newhost, sizeof(ftpc->newhost),
...
# 2082 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  if(data->set.verbose)
...
# 2481 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    curl_off_t size=-1;
# 2493 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    if((instate != FTP_LIST) &&
...
static CURLcode ftp_state_loggedin(struct connectdata *conn)
{
  ...
  if(conn->ssl[0].use) {
# 2600 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 2772 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    ...
    case FTP_PWD:
      if(ftpcode == 257) {
        ...
        if(!dir)
          return CURLE_OUT_OF_MEMORY;
# 2876 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 2914 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 3164 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 3447 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
...
# 3543 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static void
...
# 3621 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 3770 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
...
# 4035 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
  struct ftp_conn *ftpc = &conn->proto.ftpc;
...
# 4132 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_quit(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
...
# 4162 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_disconnect(struct connectdata *conn, _Bool dead_connection)
{
  struct ftp_conn *ftpc= &conn->proto.ftpc;
  struct pingpong *pp = &ftpc->pp;
# 4174 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  if(dead_connection)
    ftpc->ctl_valid = 0;
...
# 4215 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
CURLcode ftp_parse_url_path(struct connectdata *conn)
{
  ...
  case FTPFILE_NOCWD:
# 4244 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    if(data->state.path &&
       data->state.path[0] &&
...
# 4467 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
