# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                     int pkt_size);
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
# 1 "../lib/strequal.h" 1
# 58 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
# 1 "../lib/dict.h" 1
# 26 "../lib/dict.h"
extern const struct Curl_handler Curl_handler_dict;
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 60 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2
...
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2

# 1 "../lib/memdebug.h" 1
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/dict.c" 2





static CURLcode dict_do(struct connectdata *conn, _Bool *done);
...
static char *unescape_word(struct SessionHandle *data, const char *inputbuff)
{
  ...
  dictp = Curl_cmalloc(((size_t)len)*2 + 1);
  if(dictp) {
...
static CURLcode dict_do(struct connectdata *conn, _Bool *done)
{
  ...
  *done = 1;
  ...
  if(Curl_raw_nequal(path, "/MATCH:", sizeof("/MATCH:")-1) ||
      Curl_raw_nequal(path, "/M:", sizeof("/M:")-1) ||
      Curl_raw_nequal(path, "/FIND:", sizeof("/FIND:")-1)) {

    word = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (path) && (':') == '\0' ? (char *) __rawmemchr (path, ':') : __builtin_strchr (path, ':')));
    if(word) {
      word++;
      database = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (word) && (':') == '\0' ? (char *) __rawmemchr (word, ':') : __builtin_strchr (word, ':')));
      if(database) {
        *database++ = (char)0;
        strategy = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (database) && (':') == '\0' ? (char *) __rawmemchr (database, ':') : __builtin_strchr (database, ':')));
        if(strategy) {
          *strategy++ = (char)0;
          nthdef = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (strategy) && (':') == '\0' ? (char *) __rawmemchr (strategy, ':') : __builtin_strchr (strategy, ':')));
          if(nthdef) {
            *nthdef = (char)0;
          }
        }
    ...
    if((word == ((void*)0)) || (*word == (char)0)) {
      Curl_infof(data, "lookup word is missing\n");
      word=(char *)"default";
    }
    if((database == ((void*)0)) || (*database == (char)0)) {
      database = (char *)"!";
    }
    if((strategy == ((void*)0)) || (*strategy == (char)0)) {
      strategy = (char *)".";
    }
    ...
    Curl_setup_transfer(conn, 0, -1, 0, bytecount,
                        -1, ((void*)0));
  }
  else if(Curl_raw_nequal(path, "/DEFINE:", sizeof("/DEFINE:")-1) ||
           Curl_raw_nequal(path, "/D:", sizeof("/D:")-1) ||
           Curl_raw_nequal(path, "/LOOKUP:", sizeof("/LOOKUP:")-1)) {
    ...
    if(word) {
      ...
      if(database) {
        *database++ = (char)0;
        nthdef = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (database) && (':') == '\0' ? (char *) __rawmemchr (database, ':') : __builtin_strchr (database, ':')));
        if(nthdef) {
          *nthdef = (char)0;
        }
      }
    ...
    ppath = (__extension__ (__builtin_constant_p ('/') && !__builtin_constant_p (path) && ('/') == '\0' ? (char *) __rawmemchr (path, '/') : __builtin_strchr (path, '/')));
    if(ppath) {
      int i;
      ...
      Curl_setup_transfer(conn, 0, -1, 0, bytecount, -1, ((void*)0));
    }
  }
