...
# 1099 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1166 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
int Curl_single_getsock(const struct connectdata *conn,
                        curl_socket_t *sock,
...
# 1243 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                             int pkt_size)
{
...
# 1339 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    Curl_initinfo(data);
...
CURLcode Curl_follow(struct SessionHandle *data,
                     ...
                     followtype type)
{
# 1626 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1717 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  ...
  default:
    ...
    break;
  case 301:
# 1747 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    ...
    break;
  case 302:
# 1771 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    if((data->set.httpreq == HTTPREQ_POST
        || data->set.httpreq == HTTPREQ_POST_FORM)
...
Curl_reconnect_request(struct connectdata **connp)
{
  ...
  *connp = ((void*)0);
# 1840 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  ...
  )
{
  ...
  if(k->getheader || !data->set.opt_no_body) {
    ...
    if(conn->writesockfd != -1) {
      struct HTTP *http = data->req.protop;
# 1977 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
