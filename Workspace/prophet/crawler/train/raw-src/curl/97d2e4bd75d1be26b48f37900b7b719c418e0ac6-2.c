...
# 142 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
                      ...
                      long timeout_ms)
{
  ...
  struct pollfd pfd[3];
  int num;
# 158 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
  ...
  return ret;
# 367 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
}
# 382 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
int Curl_poll(struct pollfd ufds[], unsigned int nfds, int timeout_ms)
{
# 392 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
  struct timeval initial_tv = {0,0};
  _Bool fds_none = 1;
  unsigned int i;
  int pending_ms = 0;
...
# 553 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
  return r;
}
