# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c" 2
# 88 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c"
...
# 89 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c" 2
# 466 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c"
# 1 "../lib/memdebug.h" 1
# 467 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/md5.c" 2

const HMAC_params Curl_HMAC_MD5[] = {
  {
    (HMAC_hinit_func) MD5_Init,
    (HMAC_hupdate_func) MD5_Update,
    (HMAC_hfinal_func) MD5_Final,
    sizeof(MD5_CTX),
    64,
    16
  }
...
const MD5_params Curl_DIGEST_MD5[] = {
  {
    (Curl_MD5_init_func) MD5_Init,
    (Curl_MD5_update_func) MD5_Update,
    (Curl_MD5_final_func) MD5_Final,
    sizeof(MD5_CTX),
    16
  }
};
...
MD5_context *Curl_MD5_init(const MD5_params *md5params)
{
  ...
  ctxt = Curl_cmalloc(sizeof *ctxt);

  if(!ctxt)
    return ctxt;

  ctxt->md5_hashctx = Curl_cmalloc(md5params->md5_ctxtsize);
...
int Curl_MD5_final(MD5_context *context, unsigned char *result)
{
  ...
  Curl_cfree(context->md5_hashctx);
  Curl_cfree(context);
