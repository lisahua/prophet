# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                     int pkt_size);
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 1 "../lib/telnet.h" 1
# 25 "../lib/telnet.h"
extern const struct Curl_handler Curl_handler_telnet;
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2




# 1 "../lib/arpa_telnet.h" 1
# 43 "../lib/arpa_telnet.h"
...
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
...
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 1 "../lib/strequal.h" 1
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2


# 1 "../lib/memdebug.h" 1
# 70 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c" 2
# 99 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
static
...
static CURLcode telnet_do(struct connectdata *conn, _Bool *done);
static CURLcode telnet_done(struct connectdata *conn,
                                 CURLcode, _Bool premature);
static CURLcode send_telnet_data(struct connectdata *conn,
                                 char *buffer, ssize_t nread);
# 139 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
typedef enum
{
   CURL_TS_DATA = 0,
   CURL_TS_IAC,
...
# 241 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
static
CURLcode init_telnet(struct connectdata *conn)
{
  struct TELNET *tn;

  tn = Curl_ccalloc(1, sizeof(struct TELNET));
  if(!tn)
  ...
  tn->subpointer = tn->subbuffer;


  tn->us_preferred[3] = 1;
  tn->him_preferred[3] = 1;
  ...
  tn->him_preferred[1] = 1;
# 288 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
  tn->subnegotiation[31] = 1;
  return CURLE_OK;
}
...
static void negotiate(struct connectdata *conn)
{
  ...
  for(i = 0;i < 40;i++) {
    ...
    if(tn->us_preferred[i] == 1)
      set_local_option(conn, i, 1);

    if(tn->him_preferred[i] == 1)
      set_remote_option(conn, i, 1);
  }
}
                        ...
                        const char *direction, int cmd, int option)
{
  ...
  if(data->set.verbose) {
    if(cmd == 255) {
      if(( ((unsigned int)(option) >= 236) && ((unsigned int)(option) <= 255) ))
        Curl_infof(data, "%s IAC %s\n", direction, telnetcmds[(option)-236]);
      else
        Curl_infof(data, "%s IAC %d\n", direction, option);
    }
    else {
      fmt = (cmd == 251) ? "WILL" : (cmd == 252) ? "WONT" :
        (cmd == 253) ? "DO" : (cmd == 254) ? "DONT" : 0;
      if(fmt) {
        if(((option) <= 39))
          opt = telnetoptions[option];
        else if(option == 255)
          opt = "EXOPL";
        else
          opt = ((void*)0);
...
static void send_negotiation(struct connectdata *conn, int cmd, int option)
{
   ...
   bytes_written = (ssize_t)send((int)(conn->sock[0]), (void *)(buf), (size_t)(3), (int)(MSG_NOSIGNAL));
   if(bytes_written < 0) {
     err = ((*__errno_location ()));
     Curl_failf(data,"Sending data failed (%d)",err);
   }
...
void set_remote_option(struct connectdata *conn, int option, int newstate)
{
  ...
  if(newstate == 1) {
    ...
    case 0:
      tn->him[option] = 2;
      send_negotiation(conn, 253, option);
      break;
    ...
    case 1:
      tn->him[option] = 3;
      send_negotiation(conn, 254, option);
      break;
...
set_local_option(struct connectdata *conn, int option, int newstate)
{
  ...
  if(newstate == 1) {
    ...
    case 0:
      tn->us[option] = 2;
      send_negotiation(conn, 251, option);
      break;
    ...
    case 1:
      tn->us[option] = 3;
      send_negotiation(conn, 252, option);
      break;
...
void rec_do(struct connectdata *conn, int option)
{
  ...
  switch(tn->us[option]) {
  case 0:
    if(tn->us_preferred[option] == 1) {
      tn->us[option] = 1;
      send_negotiation(conn, 251, option);
      if(tn->subnegotiation[option] == 1)

        sendsuboption(conn, option);
    }
    else if(tn->subnegotiation[option] == 1) {
                     ...
                     size_t length)
{
  ...
  if(data->set.verbose) {
    if(direction) {
      ...
      if(length >= 3) {
        ...
        if(i != 255 || j != 240) {
          ...
          if(((i) <= 39))
            Curl_infof(data, "%s ", telnetoptions[i]);
          else if(( ((unsigned int)(i) >= 236) && ((unsigned int)(i) <= 255) ))
            Curl_infof(data, "%s ", telnetcmds[(i)-236]);
          else
            Curl_infof(data, "%u ", i);
          if(((j) <= 39))
            Curl_infof(data, "%s", telnetoptions[j]);
          else if(( ((unsigned int)(j) >= 236) && ((unsigned int)(j) <= 255) ))
            Curl_infof(data, "%s", telnetcmds[(j)-236]);
          else
            Curl_infof(data, "%d", j);
    ...
    if(((pointer[0]) <= 39)) {
      ...
      case 39:
      case 31:
        Curl_infof(data, "%s", telnetoptions[pointer[0]]);
        break;
      default:
        Curl_infof(data, "%s (unsupported)", telnetoptions[pointer[0]]);
        break;
      }
    }
    else
    ...
    case 31:
      ...
      Curl_infof(data, "Width: %hu ; Height: %hu",
            (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (pval[0]); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; })), (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (pval[1]); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; })));
      break;
    default:
      switch(pointer[1]) {
      case 0:
...
static CURLcode check_telnet_options(struct connectdata *conn)
{
  ...
  if(conn->bits.user_passwd) {
    curl_msnprintf(option_arg, sizeof(option_arg), "USER,%s", conn->user);
  ...
  for(head = data->set.telnet_options; head; head=head->next) {
    if(sscanf(head->data, "%127[^= ]%*[ =]%255s",
      ...
      if(Curl_raw_equal(option_keyword, "TTYPE")) {
        __builtin_strncpy (tn->subopt_ttype, option_arg, 31);
        tn->subopt_ttype[31] = 0;
        tn->us_preferred[24] = 1;
        continue;
      }


      if(Curl_raw_equal(option_keyword, "XDISPLOC")) {
        __builtin_strncpy (tn->subopt_xdisploc, option_arg, 127);
        tn->subopt_xdisploc[127] = 0;
        tn->us_preferred[35] = 1;
        continue;
      }
      ...
      if(Curl_raw_equal(option_keyword, "WS")) {
        if(sscanf(option_arg, "%hu%*[xX]%hu",
          ...
          tn->us_preferred[31] = 1;
        else {
          Curl_failf(data, "Syntax error in telnet option: %s", head->data);
      ...
      if(Curl_raw_equal(option_keyword, "BINARY")) {
        ...
        if(binary_option!=1) {
          tn->us_preferred[0] = 0;
          tn->him_preferred[0] = 0;
        }
        continue;
      }

      Curl_failf(data, "Unknown telnet option %s", head->data);
...
# 927 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
static void suboption(struct connectdata *conn)
{
  ...
  printsub(data, '<', (unsigned char *)tn->subbuffer, (tn->subend - tn->subpointer)+2);
  switch (((*tn->subpointer++)&0xff)) {
    case 24:
      len = strlen(tn->subopt_ttype) + 4 + 2;
      curl_msnprintf((char *)temp, sizeof(temp),
               "%c%c%c%c%s%c%c", 255, 250, 24,
               0, tn->subopt_ttype, 255, 240);
      bytes_written = (ssize_t)send((int)(conn->sock[0]), (void *)(temp), (size_t)(len), (int)(MSG_NOSIGNAL));
      if(bytes_written < 0) {
        err = ((*__errno_location ()));
        Curl_failf(data,"Sending data failed (%d)",err);
      }
    ...
    case 35:
      ...
      curl_msnprintf((char *)temp, sizeof(temp),
               "%c%c%c%c%s%c%c", 255, 250, 35,
               0, tn->subopt_xdisploc, 255, 240);
      bytes_written = (ssize_t)send((int)(conn->sock[0]), (void *)(temp), (size_t)(len), (int)(MSG_NOSIGNAL));
      if(bytes_written < 0) {
        err = ((*__errno_location ()));
        Curl_failf(data,"Sending data failed (%d)",err);
...
# 1004 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
static void sendsuboption(struct connectdata *conn, int option)
{
  ssize_t bytes_written;
  int err;
  ...
  case 31:
    ...
    tn->subpointer = tn->subbuffer;
    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (255); } while(0);
    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (250); } while(0);
    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (31); } while(0);


    x=(__extension__ ({ unsigned short int __v, __x = (unsigned short int) (tn->subopt_wsx); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }));
    y=(__extension__ ({ unsigned short int __v, __x = (unsigned short int) (tn->subopt_wsy); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }));
    uc1 = (unsigned char*)&x;
    uc2 = (unsigned char*)&y;
    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (uc1[0]); } while(0);
    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (uc1[1]); } while(0);
    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (uc2[0]); } while(0);
    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (uc2[1]); } while(0);

    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (255); } while(0);
    do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (240); } while(0);
    do { tn->subend = tn->subpointer; tn->subpointer = tn->subbuffer; } while(0);


    printsub(data, '>', (unsigned char *)tn->subbuffer+2,
             (tn->subend - tn->subpointer)-2);


    bytes_written = (ssize_t)send((int)(conn->sock[0]), (void *)(tn->subbuffer), (size_t)(3), (int)(MSG_NOSIGNAL));
    if(bytes_written < 0) {
      err = ((*__errno_location ()));
      Curl_failf(data, "Sending data failed (%d)", err);
    }
    ...
    bytes_written = (ssize_t)send((int)(conn->sock[0]), (void *)(tn->subbuffer+7), (size_t)(2), (int)(MSG_NOSIGNAL));
    if(bytes_written < 0) {
      err = ((*__errno_location ()));
      Curl_failf(data, "Sending data failed (%d)", err);
    }
                ...
                ssize_t count)
{
  ...
  struct SessionHandle *data = conn->data;
  struct TELNET *tn = (struct TELNET *)data->req.protop;
# 1089 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
  while(count--) {
    c = inbuf[in];
    ...
    case CURL_TS_CR:
      tn->telrcv_state = CURL_TS_DATA;
      if(c == '\0') {
        if(startwrite >= 0) { result = Curl_client_write(conn, (1<<0), (char *)&inbuf[startwrite], in-startwrite); if(result != CURLE_OK) return result; } startwrite = -1;
        break;
      }
      if(startwrite < 0) startwrite = in;
      break;
    ...
    process_iac:
      ...
      default:
        tn->telrcv_state = CURL_TS_DATA;
        printoption(data, "RCVD", 255, c);
        break;
      }
      break;

      case CURL_TS_WILL:
        printoption(data, "RCVD", 251, c);
      ...
      case CURL_TS_SB:
        if(c == 255)
          ...
          do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (c); } while(0);
        break;

      case CURL_TS_SE:
        if(c != 240) {
          if(c != 255) {
# 1194 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
            do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (255); } while(0);
            do { if(tn->subpointer < (tn->subbuffer+sizeof tn->subbuffer)) *tn->subpointer++ = (c); } while(0);
            tn->subpointer -= 2;
            do { tn->subend = tn->subpointer; tn->subpointer = tn->subbuffer; } while(0);

            printoption(data, "In SUBOPTION processing, RCVD", 255, c);
            suboption(conn);
            tn->telrcv_state = CURL_TS_IAC;
            goto process_iac;
          }
  ...
  while(rc == CURLE_OK && nread--) {
    ...
    do {
      ...
      switch (Curl_poll(pfd, 1, -1)) {
        ...
        default:
          bytes_written = 0;
          rc = Curl_write(conn, conn->sock[0], outbuf+total_written,
                                 ...
                                 CURLcode status, _Bool premature)
{
  ...
  do {if((conn->data->req.protop)) {Curl_cfree((conn->data->req.protop)); (conn->data->req.protop) = ((void*)0);}} while(0);
...
# 1303 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
  int interval_ms;
  struct pollfd pfd[2];
  int poll_cnt;
  ...
  *done = 1;
  ...
  if(code)
    return code;
# 1566 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
  pfd[0].fd = sockfd;
  pfd[0].events = 0x001;
  ...
  while(keepon) {
    ...
    default:
      if(pfd[0].revents & 0x001) {

        code = Curl_read(conn, sockfd, buf, 16384 - 1, &nread);
      ...
      nread = 0;
      if(poll_cnt == 2) {
        if(pfd[1].revents & 0x001) {
          nread = read(pfd[1].fd, buf, 16384 - 1);
        }
      }
      else {

        nread = (int)conn->fread_func(buf, 1, 16384 - 1, conn->fread_in);
        if(nread == 0x10000000) {
          keepon = 0;
          break;
        }
    ...
    if(data->set.timeout) {
      now = curlx_tvnow();
      if(curlx_tvdiff(now,conn->created) >= data->set.timeout) {
