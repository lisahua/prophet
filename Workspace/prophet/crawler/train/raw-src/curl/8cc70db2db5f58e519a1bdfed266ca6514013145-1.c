...
# 344 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_core.c"
void Curl_ntlm_core_lm_resp(const unsigned char *keys,
                            const unsigned char *plaintext,
                            unsigned char *results)
{
  ...
  DES_ecb_encrypt((DES_cblock*) plaintext, (DES_cblock*) (results + 16),
                  &ks, 1);
# 393 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_core.c"
}
                                   ...
                                   unsigned char *lmbuffer )
{
...

  {
    ...
    DES_ecb_encrypt((DES_cblock *)magic, (DES_cblock *)(lmbuffer + 8),
                    &ks, 1);
# 457 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_core.c"
...
# 548 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_core.c"
...
# 621 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_core.c"
CURLcode Curl_ntlm_core_mk_ntlmv2_resp(unsigned char *ntlmv2hash,
                                       unsigned char *challenge_client,
                                       struct ntlmdata *ntlm,
                                       unsigned char **ntresp,
                                       unsigned int *ntresp_len)
{
# 642 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_core.c"
  unsigned int len = 0;
  ...
  CURLcode result = CURLE_OK;
# 659 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_core.c"
...
# 715 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_core.c"
CURLcode Curl_ntlm_core_mk_lmv2_resp(unsigned char *ntlmv2hash,
                                      unsigned char *challenge_client,
                                      unsigned char *challenge_server,
                                      unsigned char *lmresp)
