...
CURLcode Curl_follow(struct SessionHandle *data,
                     ...
                     followtype type)
{
# 1631 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
...
# 1722 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
  ...
  default:
    ...
    break;
  case 301:
# 1752 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
    ...
    break;
  case 302:
# 1776 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
    if((data->set.httpreq == HTTPREQ_POST
        || data->set.httpreq == HTTPREQ_POST_FORM)
...
Curl_reconnect_request(struct connectdata **connp)
{
  ...
  *connp = ((void*)0);
# 1845 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
  ...
  )
{
  ...
  if(k->getheader || !data->set.opt_no_body) {
    ...
    if(conn->writesockfd != -1) {
      struct HTTP *http = data->req.protop;
# 1982 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
