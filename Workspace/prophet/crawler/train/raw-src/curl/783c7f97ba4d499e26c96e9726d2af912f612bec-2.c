# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2
# 1 "../lib/curl_sasl.h" 1
# 27 "../lib/curl_sasl.h"
struct SessionHandle;
struct connectdata;
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2


# 1 "../lib/memdebug.h" 1
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c" 2
...

{
  ...
  if(!Curl_raw_nequal("Digest",header,strlen("Digest")))
...
# 137 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_digest.c"
  if(authp->iestyle && ((tmp = (__extension__ (__builtin_constant_p ('?') && !__builtin_constant_p ((char *)uripath) && ('?') == '\0' ? (char *) __rawmemchr ((char *)uripath, '?') : __builtin_strchr ((char *)uripath, '?')))) != ((void*)0))) {
    size_t urilen = tmp - (char *)uripath;

    path = (unsigned char *) curl_maprintf("%.*s", urilen, uripath);
  }
  else
    path = (unsigned char *) Curl_cstrdup((char *)uripath);
