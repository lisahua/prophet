    ...
    for(form = first_form;
      ...
      if(((!form->name || !form->value) && !post) ||
        ...
        if(((form->flags & (1<<0)) ||
            (form->flags & (1<<4))) &&
           !form->contenttype ) {
          char *f = form->flags & (1<<4)?
            form->showfilename : form->value;


          form->contenttype = Curl_cstrdup(ContentTypeForFilename(f, prevtype));
          if(!form->contenttype) {
            return_value = CURL_FORMADD_MEMORY;
            break;
          }
...
# 848 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/formdata.c"
...
# 954 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/formdata.c"
...
# 1077 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/formdata.c"
...
# 1148 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/formdata.c"
CURLcode Curl_getformdata(struct SessionHandle *data,
...
# 1448 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/formdata.c"
