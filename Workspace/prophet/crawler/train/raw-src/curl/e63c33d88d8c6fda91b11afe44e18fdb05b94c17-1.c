...
{
  struct imap_conn *imapc = &conn->proto.imapc;
# 493 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
...
static CURLcode imap_fetch(struct connectdata *conn)
{
  ...
  if(result)
    return result;
# 1156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
                                      ...
                                      imapstate instate)
{
  ...
  if(*ptr == '{') {
    ...
    if(!size)
      ...
      Curl_setup_transfer(conn, 0, size, 0, imap->bytecountp,
                          -1, ((void*)0));
...
# 1436 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
static CURLcode imap_connect(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
  struct imap_conn *imapc = &conn->proto.imapc;
...
# 1485 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
static CURLcode imap_done(struct connectdata *conn, CURLcode status,
                          _Bool premature)
{
  CURLcode result = CURLE_OK;
...
# 1566 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
static CURLcode imap_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
...
# 1623 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
...
# 1652 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
...
# 1832 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
