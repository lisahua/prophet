# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c" 2
# 1 "../lib/slist.h" 1
# 30 "../lib/slist.h"
...
struct curl_slist *Curl_slist_append_nodup(struct curl_slist *list,
                                           char *data);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c" 2


# 1 "../lib/memdebug.h" 1
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c" 2
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c"
struct curl_slist *Curl_slist_append_nodup(struct curl_slist *list, char *data)
{
  ...
  new_item = Curl_cmalloc(sizeof(struct curl_slist));
  if(!new_item)
    return ((void*)0);
...
# 88 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/slist.c"
struct curl_slist *curl_slist_append(struct curl_slist *list,
                                     const char *data)
{
  char *dupdata = Curl_cstrdup(data);
...
void curl_slist_free_all(struct curl_slist *list)
{
  ...
  do {
    next = item->next;
    do {if((item->data)) {Curl_cfree((item->data)); (item->data) = ((void*)0);}} while(0);
    Curl_cfree(item);
    item = next;
  } while(next);
}
