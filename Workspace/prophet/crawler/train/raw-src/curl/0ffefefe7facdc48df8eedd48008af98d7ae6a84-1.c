...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c" 2
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c" 2
# 58 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c" 2
# 1 "../lib/urldata.h" 1
# 69 "../lib/urldata.h"
# 1 "../lib/cookie.h" 1
# 28 "../lib/cookie.h"
    ...
    if(len >= 8 && !memcmp(line, "STARTTLS", 8))
      ...
      for(;;) {
        ...
        if(wordlen == 5 && !memcmp(line, "LOGIN", 5))
          smtpc->authmechs |= 0x0001;
        else if(wordlen == 5 && !memcmp(line, "PLAIN", 5))
          smtpc->authmechs |= 0x0002;
        else if(wordlen == 8 && !memcmp(line, "CRAM-MD5", 8))
          smtpc->authmechs |= 0x0004;
        else if(wordlen == 10 && !memcmp(line, "DIGEST-MD5", 10))
          smtpc->authmechs |= 0x0008;
        else if(wordlen == 6 && !memcmp(line, "GSSAPI", 6))
          smtpc->authmechs |= 0x0010;
        else if(wordlen == 8 && !memcmp(line, "EXTERNAL", 8))
          smtpc->authmechs |= 0x0020;
        else if(wordlen == 4 && !memcmp(line, "NTLM", 4))
          smtpc->authmechs |= 0x0040;
...
static CURLcode smtp_authenticate(struct connectdata *conn)
{
  ...
  if(smtpc->authmechs & 0x0008) {
    mech = "DIGEST-MD5";
    state1 = SMTP_AUTH_DIGESTMD5;
    smtpc->authused = 0x0008;
  }
  else if(smtpc->authmechs & 0x0004) {
    mech = "CRAM-MD5";
    state1 = SMTP_AUTH_CRAMMD5;
    smtpc->authused = 0x0004;
  }
  else


  if(smtpc->authmechs & 0x0040) {
    mech = "NTLM";
    state1 = SMTP_AUTH_NTLM;
    state2 = SMTP_AUTH_NTLM_TYPE2MSG;
    smtpc->authused = 0x0040;
  ...
  if(smtpc->authmechs & 0x0001) {
    mech = "LOGIN";
    state1 = SMTP_AUTH_LOGIN;
    state2 = SMTP_AUTH_LOGIN_PASSWD;
    smtpc->authused = 0x0001;
    result = Curl_sasl_create_login_message(conn->data, conn->user,
                                            &initresp, &len);
  }
  else if(smtpc->authmechs & 0x0002) {
    mech = "PLAIN";
    state1 = SMTP_AUTH_PLAIN;
    state2 = SMTP_AUTH;
    smtpc->authused = 0x0002;
...
# 1310 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
static CURLcode smtp_connect(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
  struct smtp_conn *smtpc = &conn->proto.smtpc;
  ...
  *done = 0;
  ...
  result = Curl_urldecode(conn->data, path, 0, &smtpc->domain, ((void*)0), 1);
  if(result)
    return result;
...
# 1371 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
static CURLcode smtp_done(struct connectdata *conn, CURLcode status,
                          _Bool premature)
{
  CURLcode result = CURLE_OK;
...
# 1426 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
# 1442 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
# 1483 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
static CURLcode smtp_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
...
# 1511 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
# 1534 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
# 1601 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
