# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
extern void siglongjmp (sigjmp_buf __env, int __val)
     __attribute__ ((__nothrow__)) __attribute__ ((__noreturn__));
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
# 1 "../lib/strerror.h" 1
# 27 "../lib/strerror.h"
const char *Curl_strerror (struct connectdata *conn, int err);
# 56 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
# 1 "../lib/url.h" 1
# 30 "../lib/url.h"
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
# 1 "../lib/inet_ntop.h" 1
# 27 "../lib/inet_ntop.h"
char *Curl_inet_ntop(int af, const void *addr, char *buf, size_t size);
# 58 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2

# 1 "../lib/memdebug.h" 1
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c" 2
# 113 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
static struct curl_hash hostname_cache;
static int host_cache_initialized;

static void freednsentry(void *freethis);
# 125 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
struct curl_hash *Curl_global_host_cache_init(void)
{
  int rc = 0;
  ...
  return rc?((void*)0):&hostname_cache;
}
...
# 168 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
const char *
Curl_printable_address(const Curl_addrinfo *ai, char *buf, size_t bufsize)
{
  ...
  switch (ai->ai_family) {
    case 2:
      ...
      return inet_ntop(ai->ai_family,(const void *)ipaddr4,buf,(curl_socklen_t)bufsize);


    case 10:
      sa6 = (const void *)ai->ai_addr;
      ipaddr6 = &sa6->sin6_addr;
      return inet_ntop(ai->ai_family,(const void *)ipaddr6,buf,(curl_socklen_t)bufsize);
...
create_hostcache_id(const char *name, int port)
{
  ...
  char *id = curl_maprintf("%s:%d", name, port);
  char *ptr = id;
  if(ptr) {

    while(*ptr && (*ptr != ':')) {
      *ptr = (char)((__extension__ ({ int __res; if (sizeof ((int) ((unsigned char)*ptr)) > 1) { if (__builtin_constant_p ((int) ((unsigned char)*ptr))) { int __c = ((int) ((unsigned char)*ptr)); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower ((int) ((unsigned char)*ptr)); } else __res = (*__ctype_tolower_loc ())[(int) ((int) ((unsigned char)*ptr))]; __res; })));
      ptr++;
    }
  }
  return id;
...
# 229 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
static int
...
# 326 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
struct Curl_dns_entry *
                ...
                int port)
{
  ...
  dns = Curl_ccalloc(1, sizeof(struct Curl_dns_entry));
  if(!dns) {
    Curl_cfree(entry_id);
    return ((void*)0);
  }
...
# 396 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
int Curl_resolv(struct connectdata *conn,
                const char *hostname,
                int port,
                struct Curl_dns_entry **entry)
{
  char *entry_id = ((void*)0);
...
# 536 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
                        ...
                        long timeoutms)
{
  ...
  *entry = ((void*)0);
  ...
  sigaction(14, ((void*)0), &sigact);
  keep_sigact = sigact;
  keep_copysig = 1;
  sigact.__sigaction_handler.sa_handler = alarmfunc;


  sigact.sa_flags &= ~0x10000000;


  sigaction(14, &sigact, ((void*)0));
# 604 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
  ...
  if(__sigsetjmp (curl_jmpenv, 1)) {

    Curl_failf(data, "name lookup timed out");
    rc = -1;
    goto clean_up;
  }
# 631 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
...
clean_up:
  ...
  if(keep_copysig) {
    ...
    sigaction(14, &keep_sigact, ((void*)0));
  }
# 655 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
  if(prev_alarm) {

    unsigned long elapsed_ms = curlx_tvdiff(curlx_tvnow(),conn->created);
...
# 687 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
...
# 746 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/hostip.c"
