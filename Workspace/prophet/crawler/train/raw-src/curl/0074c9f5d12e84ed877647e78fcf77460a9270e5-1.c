# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c"
...
extern __pid_t wait4 (__pid_t __pid, __WAIT_STATUS __stat_loc, int __options,
        struct rusage *__usage) __attribute__ ((__nothrow__));
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
# 1 "../lib/curl_ntlm_wb.h" 1
# 31 "../lib/curl_ntlm_wb.h"
CURLcode Curl_output_ntlm_wb(struct connectdata *conn, _Bool proxy);

void Curl_ntlm_wb_cleanup(struct connectdata *conn);
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
# 1 "../lib/url.h" 1
# 30 "../lib/url.h"
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
# 1 "../lib/strerror.h" 1
# 27 "../lib/strerror.h"
const char *Curl_strerror (struct connectdata *conn, int err);
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2


# 1 "../lib/memdebug.h" 1
# 56 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c" 2
# 73 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c"
void Curl_ntlm_wb_cleanup(struct connectdata *conn)
{
  if(conn->ntlm_auth_hlpr_socket != -1) {
    close((conn->ntlm_auth_hlpr_socket));
  ...
  if(conn->ntlm_auth_hlpr_pid) {
    int i;
    for(i = 0; i < 4; i++) {
      pid_t ret = waitpid(conn->ntlm_auth_hlpr_pid, ((void*)0), 1);
      if(ret == conn->ntlm_auth_hlpr_pid || (*__errno_location ()) == 10)
        break;
      switch(i) {
      case 0:
        kill(conn->ntlm_auth_hlpr_pid, 15);
        break;
      case 1:
        ...
        break;
      case 2:
        kill(conn->ntlm_auth_hlpr_pid, 9);
        break;
      case 3:
        break;
      }
  ...
  do {if((conn->challenge_header)) {Curl_cfree((conn->challenge_header)); (conn->challenge_header) = ((void*)0);}} while(0);
  conn->challenge_header = ((void*)0);
  do {if((conn->response_header)) {Curl_cfree((conn->response_header)); (conn->response_header) = ((void*)0);}} while(0);
...
static CURLcode ntlm_wb_init(struct connectdata *conn, const char *userp)
{
  ...
  pid_t child_pid;
  const char *username;
  char *slash, *domain = ((void*)0);
  const char *ntlm_auth = ((void*)0);
  char *ntlm_auth_alloc = ((void*)0);
  int error;
  ...
  username = userp;
  slash = __extension__ ({ char __a0, __a1, __a2; (__builtin_constant_p ("\\/") && ((size_t)(const void *)(("\\/") + 1) - (size_t)(const void *)("\\/") == 1) ? ((__builtin_constant_p (username) && ((size_t)(const void *)((username) + 1) - (size_t)(const void *)(username) == 1)) ? __builtin_strpbrk (username, "\\/") : ((__a0 = ((const char *) ("\\/"))[0], __a0 == '\0') ? ((void) (username), (char *) ((void*)0)) : ((__a1 = ((const char *) ("\\/"))[1], __a1 == '\0') ? __builtin_strchr (username, __a0) : ((__a2 = ((const char *) ("\\/"))[2], __a2 == '\0') ? __strpbrk_c2 (username, __a0, __a1) : (((const char *) ("\\/"))[3] == '\0' ? __strpbrk_c3 (username, __a0, __a1, __a2) : __builtin_strpbrk (username, "\\/")))))) : __builtin_strpbrk (username, "\\/")); });
  if(slash) {
    if((domain = Curl_cstrdup(username)) == ((void*)0))
      return CURLE_OUT_OF_MEMORY;
    slash = domain + (slash - username);
    *slash = '\0';
    username = username + (slash - domain) + 1;
  }
# 146 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c"
    ntlm_auth = "/usr/bin/ntlm_auth";

  if(access(ntlm_auth, 1) != 0) {
    error = ((*__errno_location ()));
    Curl_failf(conn->data, "Could not access ntlm_auth: %s errno %d: %s",
          ntlm_auth, error, Curl_strerror(conn, error));
    goto done;
  }

  if(socketpair(1, SOCK_STREAM, 0, sockfds)) {
    error = ((*__errno_location ()));
    Curl_failf(conn->data, "Could not open socket pair. errno %d: %s",
  ...
  if(child_pid == -1) {
    ...
    close((sockfds[0]));
    close((sockfds[1]));
    Curl_failf(conn->data, "Could not fork. errno %d: %s",
          error, Curl_strerror(conn, error));
    goto done;
  }
  else if(!child_pid) {
    ...
    close((sockfds[0]));
    if(dup2(sockfds[1], 0) == -1) {
      error = ((*__errno_location ()));
      Curl_failf(conn->data, "Could not redirect child stdin. errno %d: %s",
            error, Curl_strerror(conn, error));
      exit(1);
    }

    if(dup2(sockfds[1], 1) == -1) {
      error = ((*__errno_location ()));
      Curl_failf(conn->data, "Could not redirect child stdout. errno %d: %s",
            error, Curl_strerror(conn, error));
      exit(1);
    }
    ...
    error = ((*__errno_location ()));
    close((sockfds[1]));
    Curl_failf(conn->data, "Could not execl(). errno %d: %s",
          error, Curl_strerror(conn, error));
    exit(1);
  }
  ...
  do {if((domain)) {Curl_cfree((domain)); (domain) = ((void*)0);}} while(0);
  do {if((ntlm_auth_alloc)) {Curl_cfree((ntlm_auth_alloc)); (ntlm_auth_alloc) = ((void*)0);}} while(0);
  return CURLE_OK;
                                 ...
                                 const char *input, curlntlm state)
{
  ...
  while(len_in > 0) {
    ssize_t written = (ssize_t)send((int)(conn->ntlm_auth_hlpr_socket), (void *)(input), (size_t)(len_in), (int)(MSG_NOSIGNAL));
    if(written == -1) {
  ...
  while(len_out > 0) {
    size = (ssize_t)recv((int)(conn->ntlm_auth_hlpr_socket), (void *)(tmpbuf), (size_t)(len_out), (int)(0));
    if(size == -1) {
      if((*__errno_location ()) == 4)
        continue;
      goto done;
...
wrfinish:
  ...
  conn->response_header = curl_maprintf("NTLM %.*s", size - 4, buf + 3);
  return CURLE_OK;
done:
  return CURLE_REMOTE_ACCESS_DENIED;
}
                              ...
                              _Bool proxy)
{
  ...
  default:
# 343 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_wb.c"
    ...
    do {if((*allocuserpwd)) {Curl_cfree((*allocuserpwd)); (*allocuserpwd) = ((void*)0);}} while(0);
    *allocuserpwd = curl_maprintf("%sAuthorization: %s\r\n",
                            proxy ? "Proxy-" : "",
  ...
  case NTLMSTATE_TYPE2:
    input = curl_maprintf("TT %s", conn->challenge_header);
    if(!input)
      return CURLE_OUT_OF_MEMORY;
