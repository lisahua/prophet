...
# 407 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  if(new_closure) {
...
# 508 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(easy->state) {
  default:
# 722 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    return 0;
...
# 1219 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 1412 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(easy->result) {
# 1506 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    ...
    if(easy->state < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != easy->result) {
# 1653 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1764 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  do {
...
# 1870 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 2065 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2453 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode
...
# 2501 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
