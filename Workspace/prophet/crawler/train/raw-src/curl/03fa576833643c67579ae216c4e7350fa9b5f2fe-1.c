...
# 926 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
...
# 1304 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
  int interval_ms;
  struct pollfd pfd[2];
  int poll_cnt;
  ...
  *done = 1;
  ...
  if(result)
    return result;
# 1568 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/telnet.c"
  pfd[0].fd = sockfd;
  pfd[0].events = 0x001;
