...
)
{
  ...
  data->mstate = state;
# 137 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  if(state == CURLM_STATE_COMPLETED)

    data->multi->num_alive--;
}
# 152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 252 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                                ...
                                CURL *easy_handle)
{
  ...
  if(!timeoutlist)
    return CURLM_OUT_OF_MEMORY;
# 375 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  ...
  multi->num_alive++;
# 449 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 471 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(data->mstate) {
  default:
# 690 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    return 0;
...
# 1207 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 1404 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(data->result) {
# 1498 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    ...
    if(data->mstate < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != data->result) {
# 1637 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1748 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  do {
...
# 1853 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 2042 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_multi_closed(struct connectdata *conn, curl_socket_t s)
{
...
# 2077 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2225 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  now.tv_usec += 3000;
...
# 2480 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode
...
# 2528 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
