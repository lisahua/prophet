# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
# 1 "../lib/speedcheck.h" 1
# 29 "../lib/speedcheck.h"
void Curl_speedinit(struct SessionHandle *data);
CURLcode Curl_speedcheck(struct SessionHandle *data,
                         struct timeval now);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
# 1 "../lib/non-ascii.h" 1
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2

# 1 "../lib/memdebug.h" 1
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c"
  timeout_ms = response_time -
    curlx_tvdiff(curlx_tvnow(),pp->response);

  if(data->set.timeout) {

    timeout2_ms = data->set.timeout -
      curlx_tvdiff(curlx_tvnow(),conn->now);


    timeout_ms = ((timeout_ms)<(timeout2_ms)?(timeout_ms):(timeout2_ms));
  }
...
CURLcode Curl_pp_statemach(struct pingpong *pp, _Bool block)
{
  ...
  if(Curl_pp_moredata(pp))
    ...
    rc = Curl_socket_check(pp->sendleft?-1:sock, -1, pp->sendleft?sock:-1, interval_ms);
  ...
  if(block) {
    ...
    if(Curl_pgrsUpdate(conn))
      ...
      result = Curl_speedcheck(data, curlx_tvnow());
...
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c"
CURLcode Curl_pp_vsendf(struct pingpong *pp,
                        const char *fmt,
                        va_list args)
{
  ...
  fmt_crlf = curl_maprintf("%s\r\n", fmt);
  if(!fmt_crlf)
    return CURLE_OUT_OF_MEMORY;

  s = curl_mvaprintf(fmt_crlf, args);
  Curl_cfree(fmt_crlf);
  if(!s)
    return CURLE_OUT_OF_MEMORY;
  ...
  error = Curl_write(conn, conn->sock[0], s, write_len,
                     &bytes_written);
...
# 243 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c"
CURLcode Curl_pp_sendf(struct pingpong *pp,
                       const char *fmt, ...)
{
  CURLcode res;
                          ...
                          size_t *size)
{
  ...
  *size = 0;
  ...
  while((pp->nread_resp<16384) && (keepon && !result)) {
    ...
    if(pp->cache) {
      ...
      do { } while(0);
      res = Curl_read(conn, sockfd, ptr, 16384 -pp->nread_resp,
                      &gotbytes);
    ...
    if(!keepon)
      ...
      for(i = 0; i < gotbytes; ptr++, i++) {
        ...
        if(*ptr=='\n') {
          ...
          result = Curl_client_write(conn, (1<<1),
      ...
      if(!keepon && (i != gotbytes)) {
        ...
        if((perline == gotbytes) && (gotbytes > 16384/2)) {



          Curl_infof(data, "Excessive server response line length received, "
                "%zd bytes. Stripping\n", gotbytes);
          restart = 1;
      ...
      if(clipamount) {
        ...
        pp->cache = Curl_cmalloc(pp->cache_size);
        if(pp->cache)
