# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_writeout.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_writeout.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_writeout.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_writeout.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_writeout.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_writeout.c" 2
# 1 "../src/tool_writeout.h" 1
# 26 "../src/tool_writeout.h"
void ourWriteOut(CURL *curl, struct OutStruct *outs, const char *writeinfo);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_writeout.c" 2

# 1 "../lib/memdebug.h" 1
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_writeout.c" 2
  ...
  while(ptr && *ptr) {
    if('%' == *ptr) {
      if('%' == ptr[1]) {
        ...
        char keepit;
        int i;
        if(('{' == ptr[1]) && ((end = (__extension__ (__builtin_constant_p ('}') && !__builtin_constant_p (ptr) && ('}') == '\0' ? (char *) __rawmemchr (ptr, '}') : __builtin_strchr (ptr, '}')))) != ((void*)0))) {
          _Bool match = 0;
          ptr += 2;
          keepit = *end;
          *end = 0;
          for(i = 0; replacements[i].name; i++) {
            if(curl_strequal(ptr, replacements[i].name)) {
              ...
              case VAR_HTTP_CODE_PROXY:
                if(CURLE_OK ==
                   curl_easy_getinfo(curl,CURLINFO_HTTP_CONNECTCODE,&longinfo))
              ...
              case VAR_REDIRECT_TIME:
                if(CURLE_OK ==
                  ...
                  curl_mfprintf(stream, "%.3f", doubleinfo);
                break;
              case VAR_TOTAL_TIME:
                if(CURLE_OK ==
              ...
              case VAR_NAMELOOKUP_TIME:
                if(CURLE_OK ==
                   curl_easy_getinfo(curl,CURLINFO_NAMELOOKUP_TIME,&doubleinfo))
              ...
              case VAR_APPCONNECT_TIME:
                if(CURLE_OK ==
                   curl_easy_getinfo(curl,CURLINFO_APPCONNECT_TIME,&doubleinfo))
              ...
              case VAR_SIZE_UPLOAD:
                if(CURLE_OK ==
                  ...
                  curl_mfprintf(stream, "%.0f", doubleinfo);
                break;
              ...
              case VAR_EFFECTIVE_FILENAME:
                if(outs->filename)
                  curl_mfprintf(stream, "%s", outs->filename);
                break;
              case VAR_PRIMARY_IP:
                if(CURLE_OK ==
                   curl_easy_getinfo(curl,CURLINFO_PRIMARY_IP,&stringp))

                  curl_mfprintf(stream, "%s", stringp);
                break;
