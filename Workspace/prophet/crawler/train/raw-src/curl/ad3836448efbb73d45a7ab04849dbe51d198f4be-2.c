# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c"
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2
# 1 "../lib/non-ascii.h" 1
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2


# 1 "../lib/memdebug.h" 1
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c" 2
...
# 98 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c"
CURLcode Curl_base64_decode(const char *src,
                            unsigned char **outptr, size_t *outlen)
{
  size_t srclen = 0;
  ...
  *outlen = 0;
  ...
  for(i = 0; i < numQuantums; i++) {
    ...
    if(!result) {
      do {if((newstr)) {Curl_cfree((newstr)); (newstr) = ((void*)0);}} while(0);
...
# 187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/base64.c"
CURLcode Curl_base64_encode(struct SessionHandle *data,
                            const char *inputbuff, size_t insize,
                            char **outptr, size_t *outlen)
{
  ...
  *outlen = 0;
  ...
  while(insize > 0) {
    ...
    switch(inputparts) {
    case 1:
      curl_msnprintf(output, 5, "%c%c==",
               table64[obuf[0]],
               table64[obuf[1]]);
      break;
    case 2:
      curl_msnprintf(output, 5, "%c%c%c=",
               table64[obuf[0]],
               table64[obuf[1]],
               table64[obuf[2]]);
      break;
    default:
      curl_msnprintf(output, 5, "%c%c%c%c",
               table64[obuf[0]],
               table64[obuf[1]],
               table64[obuf[2]],
               table64[obuf[3]] );
