                                    ...
                                    int ftpcode)
{
  ...
  if((ftpc->count1 == 0) &&
    ...
    int ip[4];
    int port[2];
# 1991 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
    while(*str) {
...
# 2087 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
  if(data->set.verbose)
...
# 2486 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
    curl_off_t size=-1;
# 2498 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
    if((instate != FTP_LIST) &&
...
# 3626 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
...
# 3775 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
static
...
# 4040 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
static CURLcode ftp_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
  struct ftp_conn *ftpc = &conn->proto.ftpc;
...
# 4137 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
static CURLcode ftp_quit(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
...
# 4220 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
static
CURLcode ftp_parse_url_path(struct connectdata *conn)
{
  ...
  case FTPFILE_NOCWD:
# 4249 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
    if(data->state.path &&
       data->state.path[0] &&
...
# 4472 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/ftp.c"
static
