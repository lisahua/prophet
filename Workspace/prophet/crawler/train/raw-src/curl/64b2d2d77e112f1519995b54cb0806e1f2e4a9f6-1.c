...
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 400 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  if(new_closure) {
  ...
  multi->num_alive++;
# 479 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 501 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(easy->state) {
  default:
# 715 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    return 0;
...
# 1185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 1376 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(easy->result) {
# 1470 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    ...
    if(easy->state < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != easy->result) {
# 1620 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1733 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  do {
...
# 1835 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 2030 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
static int checkPendPipeline(struct connectdata *conn)
{
  ...
  if(conn->server_supports_pipelining || pipeLen == 0) {
    ...
    const size_t maxPipeLen =
      conn->server_supports_pipelining ? 5 : 1;
...
# 2514 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode
...
# 2562 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
