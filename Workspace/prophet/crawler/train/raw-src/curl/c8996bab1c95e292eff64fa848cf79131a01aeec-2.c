# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cfgable.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cfgable.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cfgable.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cfgable.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cfgable.c" 2
# 1 "../src/tool_main.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cfgable.c" 2

# 1 "../lib/memdebug.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/src/tool_cfgable.c" 2
...
static void free_config_fields(struct OperationConfig *config)
{
  ...
  do {if((config->random_file)) {free((config->random_file)); (config->random_file) = ((void*)0);}} while(0);
  do {if((config->egd_file)) {free((config->egd_file)); (config->egd_file) = ((void*)0);}} while(0);
  do {if((config->useragent)) {free((config->useragent)); (config->useragent) = ((void*)0);}} while(0);
  do {if((config->cookie)) {free((config->cookie)); (config->cookie) = ((void*)0);}} while(0);
  do {if((config->cookiejar)) {free((config->cookiejar)); (config->cookiejar) = ((void*)0);}} while(0);
  do {if((config->cookiefile)) {free((config->cookiefile)); (config->cookiefile) = ((void*)0);}} while(0);

  do {if((config->postfields)) {free((config->postfields)); (config->postfields) = ((void*)0);}} while(0);
  do {if((config->referer)) {free((config->referer)); (config->referer) = ((void*)0);}} while(0);

  do {if((config->headerfile)) {free((config->headerfile)); (config->headerfile) = ((void*)0);}} while(0);
  do {if((config->ftpport)) {free((config->ftpport)); (config->ftpport) = ((void*)0);}} while(0);
  do {if((config->iface)) {free((config->iface)); (config->iface) = ((void*)0);}} while(0);

  do {if((config->range)) {free((config->range)); (config->range) = ((void*)0);}} while(0);

  do {if((config->userpwd)) {free((config->userpwd)); (config->userpwd) = ((void*)0);}} while(0);
  do {if((config->tls_username)) {free((config->tls_username)); (config->tls_username) = ((void*)0);}} while(0);
  do {if((config->tls_password)) {free((config->tls_password)); (config->tls_password) = ((void*)0);}} while(0);
  do {if((config->tls_authtype)) {free((config->tls_authtype)); (config->tls_authtype) = ((void*)0);}} while(0);
  do {if((config->proxyuserpwd)) {free((config->proxyuserpwd)); (config->proxyuserpwd) = ((void*)0);}} while(0);
  do {if((config->proxy)) {free((config->proxy)); (config->proxy) = ((void*)0);}} while(0);

  do {if((config->dns_ipv6_addr)) {free((config->dns_ipv6_addr)); (config->dns_ipv6_addr) = ((void*)0);}} while(0);
  do {if((config->dns_ipv4_addr)) {free((config->dns_ipv4_addr)); (config->dns_ipv4_addr) = ((void*)0);}} while(0);
  do {if((config->dns_interface)) {free((config->dns_interface)); (config->dns_interface) = ((void*)0);}} while(0);
  do {if((config->dns_servers)) {free((config->dns_servers)); (config->dns_servers) = ((void*)0);}} while(0);

  do {if((config->noproxy)) {free((config->noproxy)); (config->noproxy) = ((void*)0);}} while(0);

  do {if((config->mail_from)) {free((config->mail_from)); (config->mail_from) = ((void*)0);}} while(0);
  curl_slist_free_all(config->mail_rcpt);
  do {if((config->mail_auth)) {free((config->mail_auth)); (config->mail_auth) = ((void*)0);}} while(0);

  do {if((config->netrc_file)) {free((config->netrc_file)); (config->netrc_file) = ((void*)0);}} while(0);
  ...
  while(urlnode) {
    ...
    do {if((urlnode)) {free((urlnode)); (urlnode) = ((void*)0);}} while(0);
    urlnode = next;
  }
  ...
  do {if((config->cipher_list)) {free((config->cipher_list)); (config->cipher_list) = ((void*)0);}} while(0);
  do {if((config->cert)) {free((config->cert)); (config->cert) = ((void*)0);}} while(0);
  do {if((config->cert_type)) {free((config->cert_type)); (config->cert_type) = ((void*)0);}} while(0);
  do {if((config->cacert)) {free((config->cacert)); (config->cacert) = ((void*)0);}} while(0);
  do {if((config->capath)) {free((config->capath)); (config->capath) = ((void*)0);}} while(0);
  do {if((config->crlfile)) {free((config->crlfile)); (config->crlfile) = ((void*)0);}} while(0);
  do {if((config->pinnedpubkey)) {free((config->pinnedpubkey)); (config->pinnedpubkey) = ((void*)0);}} while(0);
  do {if((config->key)) {free((config->key)); (config->key) = ((void*)0);}} while(0);
  do {if((config->key_type)) {free((config->key_type)); (config->key_type) = ((void*)0);}} while(0);
  do {if((config->key_passwd)) {free((config->key_passwd)); (config->key_passwd) = ((void*)0);}} while(0);
  do {if((config->pubkey)) {free((config->pubkey)); (config->pubkey) = ((void*)0);}} while(0);
  do {if((config->hostpubmd5)) {free((config->hostpubmd5)); (config->hostpubmd5) = ((void*)0);}} while(0);
  do {if((config->engine)) {free((config->engine)); (config->engine) = ((void*)0);}} while(0);

  do {if((config->customrequest)) {free((config->customrequest)); (config->customrequest) = ((void*)0);}} while(0);
  do {if((config->krblevel)) {free((config->krblevel)); (config->krblevel) = ((void*)0);}} while(0);

  do {if((config->xoauth2_bearer)) {free((config->xoauth2_bearer)); (config->xoauth2_bearer) = ((void*)0);}} while(0);

  do {if((config->writeout)) {free((config->writeout)); (config->writeout) = ((void*)0);}} while(0);
  ...
  if(config->httppost) {
    ...
    config->httppost = ((void*)0);
  }
  config->last_post = ((void*)0);

  curl_slist_free_all(config->telnet_options);
  curl_slist_free_all(config->resolve);

  do {if((config->socksproxy)) {free((config->socksproxy)); (config->socksproxy) = ((void*)0);}} while(0);
  do {if((config->socks5_gssapi_service)) {free((config->socks5_gssapi_service)); (config->socks5_gssapi_service) = ((void*)0);}} while(0);

  do {if((config->ftp_account)) {free((config->ftp_account)); (config->ftp_account) = ((void*)0);}} while(0);
  do {if((config->ftp_alternative_to_user)) {free((config->ftp_alternative_to_user)); (config->ftp_alternative_to_user) = ((void*)0);}} while(0);
}
