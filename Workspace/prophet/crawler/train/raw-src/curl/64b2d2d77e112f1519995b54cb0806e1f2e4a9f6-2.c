...
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 400 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  if(new_closure) {
  ...
  multi->num_alive++;
# 479 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 501 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(easy->state) {
  default:
# 715 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    return 0;
...
# 1185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 1378 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(easy->result) {
# 1472 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    ...
    if(easy->state < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != easy->result) {
# 1622 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1735 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  do {
...
# 1837 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 2032 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2516 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode
...
# 2564 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
