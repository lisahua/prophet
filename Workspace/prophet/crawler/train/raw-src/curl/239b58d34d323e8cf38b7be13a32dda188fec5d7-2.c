...
# 103 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
)
{
  ...
  easy->state = state;
# 135 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  if(state == CURLM_STATE_COMPLETED)

    easy->easy_handle->multi->num_alive--;
}
# 150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 250 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 405 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  if(new_closure) {
...
# 506 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(easy->state) {
  default:
# 720 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    return 0;
...
# 1403 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(easy->result) {
# 1497 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    ...
    if(easy->state < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != easy->result) {
# 1644 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1755 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  do {
...
# 1861 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 2056 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2444 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode
...
# 2492 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
