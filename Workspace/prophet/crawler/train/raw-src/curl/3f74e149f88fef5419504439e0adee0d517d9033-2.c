# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                     int pkt_size);
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/tftp.h" 1
# 25 "../lib/tftp.h"
extern const struct Curl_handler Curl_handler_tftp;
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/strerror.h" 1
# 27 "../lib/strerror.h"
const char *Curl_strerror (struct connectdata *conn, int err);
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/url.h" 1
# 30 "../lib/url.h"
...
# 58 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/speedcheck.h" 1
# 29 "../lib/speedcheck.h"
void Curl_speedinit(struct SessionHandle *data);
CURLcode Curl_speedcheck(struct SessionHandle *data,
                         struct timeval now);
# 60 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
...
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2


# 1 "../lib/memdebug.h" 1
# 69 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c" 2
# 80 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
typedef enum {
...
static CURLcode tftp_connect(struct connectdata *conn, _Bool *done);
static CURLcode tftp_disconnect(struct connectdata *conn,
                                _Bool dead_connection);
static CURLcode tftp_do(struct connectdata *conn, _Bool *done);
static CURLcode tftp_done(struct connectdata *conn,
                          CURLcode, _Bool premature);
static CURLcode tftp_setup_connection(struct connectdata * conn);
static CURLcode tftp_multi_statemach(struct connectdata *conn, _Bool *done);
static CURLcode tftp_doing(struct connectdata *conn, _Bool *dophase_done);
...
# 201 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_set_timeouts(tftp_state_data_t *state)
{
  time_t maxtime, timeout;
  long timeout_ms;
  _Bool start = (state->state == TFTP_STATE_START) ? 1 : 0;
...
# 284 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
                                      ...
                                      const char *ptr, int len)
{
  ...
  while(tmp < ptr + len) {
    ...
    if(tmp == ((void*)0)) {
      Curl_failf(data, "Malformed ACK packet, rejecting");
      return CURLE_TFTP_ILLEGAL;
    }

    Curl_infof(data, "got option=(%s) value=(%s)\n", option, value);

    if(Curl_raw_nequal(option,"blksize",strlen(option))) {
      long blksize;

      blksize = strtol( value, ((void*)0), 10 );

      if(!blksize) {
        Curl_failf(data, "invalid blocksize value in OACK packet");
        return CURLE_TFTP_ILLEGAL;
      }
      else if(blksize > 65464) {
        Curl_failf(data, "%s (%d)", "blksize is larger than max supported",
              65464);
        return CURLE_TFTP_ILLEGAL;
      }
      else if(blksize < 8) {
        Curl_failf(data, "%s (%d)", "blksize is smaller than min supported",
              8);
        return CURLE_TFTP_ILLEGAL;
      }
        ...
        Curl_failf(data, "%s (%ld)",
              "server requested blksize larger than allocated", blksize);
        return CURLE_TFTP_ILLEGAL;
      }

      state->blksize = (int)blksize;
      Curl_infof(data, "%s (%d) %s (%d)\n", "blksize parsed from OACK",
            state->blksize, "requested", state->requested_blksize);
    }
    else if(Curl_raw_nequal(option,"tsize",strlen(option))) {
      long tsize = 0;

      tsize = strtol( value, ((void*)0), 10 );
      Curl_infof(data, "%s (%ld)\n", "tsize parsed from OACK", tsize);



      if(!data->set.upload) {
        if(!tsize) {
          Curl_failf(data, "invalid tsize -:%s:- value in OACK packet", value);
          return CURLE_TFTP_ILLEGAL;
        }
...
static CURLcode tftp_send_first(tftp_state_data_t *state, tftp_event_t event)
{
  ...
  case TFTP_EVENT_TIMEOUT:
    ...
    if(data->set.upload && (data->set.infilesize != -1))
      curl_msnprintf(buf, sizeof(buf), "%" "ld",
               data->set.infilesize);
    else
      strcpy(buf, "0");
    ...
    if(senddata != (ssize_t)sbytes) {
      Curl_failf(data, "%s", Curl_strerror(state->conn, ((*__errno_location ()))));
    }
    do {if((filename)) {Curl_cfree((filename)); (filename) = ((void*)0);}} while(0);
    break;
  ...
  default:
    Curl_failf(state->conn->data, "tftp_send_first: internal error");
    break;
  }
  return res;
}
# 579 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_rx(tftp_state_data_t *state, tftp_event_t event)
{
  ssize_t sbytes;
  int rblock;
  ...
  case TFTP_EVENT_DATA:
    ...
    if((((state->block)+1)&0xffff) == rblock) {
  ...
  case TFTP_EVENT_TIMEOUT:
    ...
    Curl_infof(data,
          ...
          (((state->block)+1)&0xffff), state->retries);
    if(state->retries > state->retry_max) {
...
# 700 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_tx(tftp_state_data_t *state, tftp_event_t event)
{
  struct SessionHandle *data = state->conn->data;
  ssize_t sbytes;
  ...
  case TFTP_EVENT_OACK:
    if(event == TFTP_EVENT_ACK) {
      ...
      if(rblock != state->block &&
        ...
        if(state->retries>state->retry_max) {
          Curl_failf(data, "tftp_tx: giving up waiting for block %d ack",
                state->block);
  ...
  case TFTP_EVENT_TIMEOUT:
    ...
    state->retries++;
    Curl_infof(data, "Timeout waiting for block %d ACK. "
          " Retries = %d\n", (((state->block)+1)&0xffff), state->retries);
  ...
  case TFTP_EVENT_ERROR:
    ...
    setpacketevent(&state->spacket, TFTP_EVENT_ERROR);
    setpacketblock(&state->spacket, state->block);
    (void)sendto(state->sockfd, (void *)state->spacket.data, 4, MSG_NOSIGNAL,
                 (struct sockaddr *)&state->remote_addr,
                 state->remote_addrlen);
  ...
  default:
    Curl_failf(data, "tftp_tx: internal error, event: %i", (int)(event));
    break;
  }

  return res;
}
# 832 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_translate_code(tftp_error_t error)
{
...
# 885 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 922 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_disconnect(struct connectdata *conn, _Bool dead_connection)
{
  ...
  if(state) {
    do {if((state->rpacket.data)) {Curl_cfree((state->rpacket.data)); (state->rpacket.data) = ((void*)0);}} while(0);
    do {if((state->spacket.data)) {Curl_cfree((state->spacket.data)); (state->spacket.data) = ((void*)0);}} while(0);
    Curl_cfree(state);
  }

  return CURLE_OK;
}
# 944 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_connect(struct connectdata *conn, _Bool *done)
{
  CURLcode code;
  ...
  state = conn->proto.tftpc = Curl_ccalloc(1, sizeof(tftp_state_data_t));
  if(!state)
    return CURLE_OUT_OF_MEMORY;
  ...
  if(!state->rpacket.data) {
    state->rpacket.data = Curl_ccalloc(1, blksize + 2 + 2);
  ...
  if(!state->spacket.data) {
    state->spacket.data = Curl_ccalloc(1, blksize + 2 + 2);
  ...
  state->conn = conn;
  state->sockfd = state->conn->sock[0];
  ...
  if(!conn->bits.bound) {
# 1007 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
    rc = bind(state->sockfd, (struct sockaddr *)&state->local_addr,
              conn->ip_addr->ai_addrlen);
    if(rc) {
      Curl_failf(conn->data, "bind() failed; %s",
...
# 1031 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 1057 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static int tftp_getsock(struct connectdata *conn, curl_socket_t *socks,
                        int numsocks)
{
  if(!numsocks)
...
# 1075 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_receive_packet(struct connectdata *conn)
{
  ...
  if(state->rbytes < 4) {
    ...
    case TFTP_EVENT_DATA:
      ...
      if(state->rbytes > 4 &&
         ((((state->block)+1)&0xffff) == getrpacketblock(&state->rpacket))) {
...
# 1159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 1194 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_multi_statemach(struct connectdata *conn, _Bool *done)
{
  int rc;
  tftp_event_t event;
  ...
  *done = 0;
  ...
  if(timeout_ms <= 0) {
    Curl_failf(data, "TFTP response timeout");
    return CURLE_OPERATION_TIMEDOUT;
  }
    ...
    if(result != CURLE_OK)
      return(result);
    *done = (state->state == TFTP_STATE_FIN) ? 1 : 0;
    if(*done)
    ...
    rc = Curl_socket_check(state->sockfd, -1, -1, 0);

    if(rc == -1) {

      int error = ((*__errno_location ()));
      Curl_failf(data, "%s", Curl_strerror(conn, error));
...
# 1253 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_doing(struct connectdata *conn, _Bool *dophase_done)
{
  CURLcode result;
...
# 1280 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_perform(struct connectdata *conn, _Bool *dophase_done)
{
  CURLcode result = CURLE_OK;
  tftp_state_data_t *state = (tftp_state_data_t *)conn->proto.tftpc;
...
# 1311 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_do(struct connectdata *conn, _Bool *done)
{
  tftp_state_data_t *state;
  CURLcode code;
