...
CURLcode Curl_fillreadbuffer(struct connectdata *conn, int bytes, int *nreadp)
{
  ...
  int nread;
# 112 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
...
# 172 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
    char hexbuffer[11];
...
# 222 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
    if((nread - hexlen) == 0)
...
# 238 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
  *nreadp = nread;
...
# 325 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
...
# 356 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
}
    ...
    *didwhat |= (1<<0);
    ...
    if(k->str && !k->header && (nread > 0 || is_empty_data)) {
      ...
      if(0 == k->bodywrites && !is_empty_data) {
        ...
        if(conn->handler->protocol&(((1<<0)|(1<<1))|(1<<18))) {
      ...
      if(k->chunk) {
        ...
        if(CHUNKE_OK < res) {
          ...
          Curl_failf(data, "%s in chunked-encoding", Curl_chunked_strerror(res));
        ...
        if(k->badheader < HEADER_ALLBAD) {
          ...
          case 0:
            ...
            if(!k->ignorebody) {
              ...
              if(conn->handler->protocol&((1<<14)|(1<<15)))
                                 ...
                                 int *didwhat)
{
  ...
  *didwhat |= (1<<1);
# 840 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
  do {
    ...
    if(0 == data->req.upload_present) {
      ...
      if(conn->handler->protocol & ((1<<16)|(1<<17))) {
...
# 1104 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
...
# 1171 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
...
# 1192 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
int Curl_single_getsock(const struct connectdata *conn,
                        curl_socket_t *sock,
...
# 1248 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                             int pkt_size)
{
...
# 1344 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
    Curl_initinfo(data);
...
CURLcode Curl_follow(struct SessionHandle *data,
                     ...
                     followtype type)
{
# 1632 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
...
# 1723 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
  ...
  default:
    ...
    break;
  case 301:
# 1753 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
    ...
    break;
  case 302:
# 1777 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
    if((data->set.httpreq == HTTPREQ_POST
        || data->set.httpreq == HTTPREQ_POST_FORM)
...
Curl_reconnect_request(struct connectdata **connp)
{
  ...
  *connp = ((void*)0);
# 1846 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
                            ...
                            char **url)
{
  ...
  *url = ((void*)0);
  ...
  if(data->set.upload &&
     !(conn->handler->protocol&(((1<<0)|(1<<1))|(1<<18))))
    return CURLE_OK;
  ...
  )
{
  ...
  if(k->getheader || !data->set.opt_no_body) {
    ...
    if(conn->writesockfd != -1) {
      struct HTTP *http = data->req.protop;
# 1983 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/transfer.c"
      if((data->state.expect100header) &&
         (conn->handler->protocol&((1<<0)|(1<<1))) &&
         (http->sending == HTTPSEND_BODY)) {
