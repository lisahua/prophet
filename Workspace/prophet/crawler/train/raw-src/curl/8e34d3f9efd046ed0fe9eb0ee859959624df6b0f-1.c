...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2

# 1 "../lib/memdebug.h" 1
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c" 2
...
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c"
...
CURLcode Curl_pp_statemach(struct pingpong *pp, _Bool block)
{
  ...
  if(Curl_pp_moredata(pp))
    ...
    rc = 1;
  else if(!pp->sendleft && Curl_ssl_data_pending(conn, 0))
...
# 160 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c"
CURLcode Curl_pp_vsendf(struct pingpong *pp,
                        const char *fmt,
                        va_list args)
{
...
# 247 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pingpong.c"
CURLcode Curl_pp_sendf(struct pingpong *pp,
                       const char *fmt, ...)
{
  CURLcode res;
