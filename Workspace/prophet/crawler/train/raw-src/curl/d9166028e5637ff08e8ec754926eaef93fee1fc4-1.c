# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c" 2
...
# 59 "../lib/curlx.h" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c" 2
# 1 "../src/tool_msgs.h" 1
# 26 "../src/tool_msgs.h"
void warnf(struct OperationConfig *config, const char *fmt, ...);

void helpf(FILE *errors, const char *fmt, ...);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c" 2
# 1 "../src/tool_cb_dbg.h" 1
# 30 "../src/tool_cb_dbg.h"
int tool_debug_cb(CURL *handle, curl_infotype type,
                  unsigned char *data, size_t size,
                  void *userdata);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c" 2
# 1 "../src/tool_util.h" 1
# 26 "../src/tool_util.h"
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c" 2

# 1 "../lib/memdebug.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c" 2
                  ...
                  void *userdata)
{
  ...
  if(!config->trace_stream) {
    ...
    else if(curl_strequal("%", config->trace_dump))

      config->trace_stream = config->errors;
    else {
      config->trace_stream = fopen(config->trace_dump, "w");
      config->trace_fopened = 1;
    }
  }
    ...
    case CURLINFO_HEADER_OUT:
      if(size > 0) {
        for(i = 0; i < size - 1; i++) {
          if(data[i] == '\n') {
            if(!newl) {
              curl_mfprintf(output, "%s%s ", timebuf, s_infotype[type]);
            }
    ...
    case CURLINFO_SSL_DATA_OUT:
      if(!traced_data) {
        ...
        if(!config->isatty || ((output != stderr) && (output != stdout))) {
          if(!newl)
            curl_mfprintf(output, "%s%s ", timebuf, s_infotype[type]);
          curl_mfprintf(output, "[data not shown]\n");
          newl = 0;
          traced_data = 1;
        }
      }
...
# 185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c"
  switch (type) {
  case CURLINFO_TEXT:
    curl_mfprintf(output, "%s== Info: %s", timebuf, data);
  default:
    return 0;
                 ...
                 trace tracetype, curl_infotype infotype)
{
  ...
  curl_mfprintf(stream, "%s%s, %zd bytes (0x%zx)\n", timebuf, text, size, size);
...
# 260 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_dbg.c"
      (void)infotype;
      curl_mfprintf(stream, "%c", ((ptr[i+c] >= 0x20) && (ptr[i+c] < 0x80)) ?
              ptr[i+c] : '.');
