...
# 1 "../lib/memdebug.h" 1
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_main.c" 2
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_main.c"
...
# 121 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_main.c"
int main(int argc, char *argv[])
{
  ...
  if(config) {
    ...
    do {if((config)) {free((config)); (config) = ((void*)0);}} while(0);
  }
  else {
    helpf(stderr, "error initializing curl\n");
    res = CURLE_FAILED_INIT;
  }
# 167 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_main.c"
  return res;
