# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_urlglob.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_urlglob.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_urlglob.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_urlglob.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_urlglob.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_urlglob.c" 2
# 1 "../src/tool_vms.h" 1
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_urlglob.c" 2

# 1 "../lib/memdebug.h" 1
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_urlglob.c" 2
...
static GlobCode glob_fixed(URLGlob *glob, char *fixed, size_t len)
{
  ...
  if(!pat->content.Set.elements)
    return glob->error = "out of memory", glob->pos = 0, GLOB_NO_MEM;;
                         ...
                         int globindex)
{
  ...
  while(!done) {
    switch (*pattern) {
    case '\0':
      return glob->error = "unmatched brace", glob->pos = opos, GLOB_ERROR;;

    case '{':
    case '[':
      return glob->error = "nested brace", glob->pos = *posp, GLOB_ERROR;;

    case '}':
      if(opattern == pattern)
        return glob->error = "empty string within braces", glob->pos = *posp, GLOB_ERROR;;


      if(multiply(amount, pat->content.Set.size+1))
        return glob->error = "range overflow", glob->pos = 0, GLOB_ERROR;;
    ...
    case ']':
      return glob->error = "unexpected close bracket", glob->pos = *posp, GLOB_ERROR;;
  ...
  if((((*__ctype_b_loc ())[(int) (((int) ((unsigned char)*pattern)))] & (unsigned short int) _ISalpha))) {
    ...
    *posp += (pattern - *patternp);
    ...
    if((rc != 2) || (min_c >= max_c) || ((max_c - min_c) > ('z' - 'a')) ||
      ...
      return glob->error = "bad range", glob->pos = *posp, GLOB_ERROR;;
    ...
    if(multiply(amount, (pat->content.CharRange.max_c -
      ...
      return glob->error = "range overflow", glob->pos = *posp, GLOB_ERROR;;
  }
    ...
    *posp += (pattern - *patternp);
    ...
    return glob->error = "bad range specification", glob->pos = *posp, GLOB_ERROR;;
  ...
  *amount = 1;
  ...
  while(*pattern && !res) {
    ...
    while(*pattern && *pattern != '{') {
      ...
      if(*pattern == '}' || *pattern == ']')
        return glob->error = "unmatched close brace/bracket", glob->pos = pos, GLOB_ERROR;;
    ...
    if(++glob->size > 100)
      return glob->error = "too many globs", glob->pos = pos, GLOB_ERROR;;
  }
  return res;
}
