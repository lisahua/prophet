                                ...
                                CURL *easy_handle)
{
  ...
  if(!timeoutlist)
    return CURLM_OUT_OF_MEMORY;
# 380 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  ...
  multi->num_alive++;
# 454 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 476 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(data->mstate) {
  default:
# 699 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    return 0;
...
# 1226 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 1430 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(data->result) {
# 1524 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    ...
    if(data->mstate < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != data->result) {
# 1670 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1785 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  do {
...
# 1898 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 2087 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_multi_closed(struct connectdata *conn, curl_socket_t s)
{
...
# 2520 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode
...
# 2568 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
