# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
# 1 "../lib/vtls/vtls.h" 1
# 30 "../lib/vtls/vtls.h"
...
void Curl_ssl_md5sum(unsigned char *tmp,
                     ...
                     size_t md5len);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
# 1 "../lib/non-ascii.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
# 1 "../lib/strerror.h" 1
# 27 "../lib/strerror.h"
const char *Curl_strerror (struct connectdata *conn, int err);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2


# 1 "../lib/memdebug.h" 1
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c" 2
                               ...
                               char *startPtr, size_t size)
{
  ...
  if(data->state.prev_block_had_trailing_cr) {
    ...
    data->state.prev_block_had_trailing_cr = 0;
  }
    ...
    if(inPtr < startPtr+size) {
      ...
      if(*inPtr == '\r') {
        ...
        *outPtr = '\n';
        ...
        data->state.prev_block_had_trailing_cr = 1;
      }
      else {
...
void Curl_infof(struct SessionHandle *data, const char *fmt, ...)
{
  if(data && data->set.verbose) {
    ...
    curl_mvsnprintf(print_buffer, sizeof(print_buffer), fmt, ap);
    __builtin_va_end(ap);
    len = strlen(print_buffer);
    Curl_debug(data, CURLINFO_TEXT, print_buffer, len, ((void*)0));
  }
}
...
void Curl_failf(struct SessionHandle *data, const char *fmt, ...)
{
  ...
  curl_mvsnprintf(data->state.buffer, 16384, fmt, ap);

  if(data->set.errorbuffer && !data->state.errorbuf) {
    curl_msnprintf(data->set.errorbuffer, 256, "%s", data->state.buffer);
    data->state.errorbuf = 1;
  }
  if(data->set.verbose) {
    ...
    Curl_debug(data, CURLINFO_TEXT, data->state.buffer, len, ((void*)0));
  }
...
# 223 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c"
CURLcode Curl_write(struct connectdata *conn,
                    curl_socket_t sockfd,
                    const void *mem,
                    size_t len,
                        ...
                        const void *mem, size_t len, CURLcode *code)
{
  ...
  ssize_t bytes_written = (ssize_t)send((int)(sockfd), (void *)(mem), (size_t)(len), (int)(MSG_NOSIGNAL));
  ...
  if(-1 == bytes_written) {
    ...
    if(
      ...
      *code = CURLE_AGAIN;
      ...
      Curl_failf(conn->data, "Send failure: %s",
...
{
  curl_socket_t sockfd = conn->sock[num];
  ssize_t nread = (ssize_t)recv((int)(sockfd), (void *)(buf), (size_t)(len), (int)(0));
  ...
  if(-1 == nread) {
    ...
    if(
      ...
      *code = CURLE_AGAIN;
      ...
      Curl_failf(conn->data, "Recv failure: %s",
            Curl_strerror(conn, err));
      conn->data->state.os_errno = err;
...
# 386 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c"
                           ...
                           size_t len)
{
  ...
  if(data->req.keepon & (1<<4)) {
    ...
    newptr = Curl_crealloc(data->state.tempwrite, newlen);
    if(!newptr)
      return CURLE_OUT_OF_MEMORY;
  ...
  if(type & (1<<0)) {
    ...
    if(0x10000001 == wrote) {
      ...
      Curl_failf(data, "Failed writing body (%zu != %zu)", wrote, len);
      return CURLE_WRITE_ERROR;
    }
  }
  ...
  if((type & (1<<1)) &&
    ...
    if(0x10000001 == wrote)
      ...
      return pausewrite(data, (1<<1), ptr, len);
...
CURLcode Curl_read_plain(curl_socket_t sockfd,
                         ...
                         ssize_t *n)
{
  ssize_t nread = (ssize_t)recv((int)(sockfd), (void *)(buf), (size_t)(bytesfromsocket), (int)(0));
                   ...
                   ssize_t *n)
{
  ...
  char *buffertofill = ((void*)0);
  _Bool pipelining = Curl_multi_pipeline_enabled(conn->data->multi);
  ...
  *n=0;
  ...
  if(pipelining) {
    size_t bytestocopy = ((conn->buf_len - conn->read_pos)<(sizerequested)?(conn->buf_len - conn->read_pos):(sizerequested));
    ...
    bytesfromsocket = ((sizerequested)<(16384 * sizeof (char))?(sizerequested):(16384 * sizeof (char)));
    buffertofill = conn->master_buffer;
  }
  else {
    bytesfromsocket = (((long)sizerequested)<(conn->data->set.buffer_size ? conn->data->set.buffer_size : 16384)?((long)sizerequested):(conn->data->set.buffer_size ? conn->data->set.buffer_size : 16384));
                  ...
                  char *ptr, size_t size)
{
  static const char s_infotype[CURLINFO_END][3] = {
    "* ", "< ", "> ", "{ ", "} ", "{ ", "} " };
# 629 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/sendf.c"
  if(data->set.fdebug)
               ...
               struct connectdata *conn)
{
  ...
  if(data->set.printhost && conn && conn->host.dispname) {
    ...
    if(t) {
      curl_msnprintf(buffer, sizeof(buffer), "[%s %s %s]", w, t,
               conn->host.dispname);
