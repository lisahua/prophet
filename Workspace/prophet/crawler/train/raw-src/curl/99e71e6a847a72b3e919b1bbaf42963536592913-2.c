...
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c" 2
# 1 "../lib/strtoofft.h" 1
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c" 2
# 1 "../lib/strequal.h" 1
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c" 2
# 1 "../lib/vtls/vtls.h" 1
# 26 "../lib/vtls/vtls.h"
# 1 "../lib/vtls/openssl.h" 1
# 34 "../lib/vtls/openssl.h"
...
# 1 "../lib/vtls/curl_schannel.h" 1
# 34 "../lib/vtls/vtls.h" 2
# 1 "../lib/vtls/curl_darwinssl.h" 1
...
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c" 2
# 1 "../lib/strerror.h" 1
# 27 "../lib/strerror.h"
...
CURLcode Curl_speedcheck(struct SessionHandle *data,
                         struct timeval now);
# 77 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 85 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c" 2

# 1 "../lib/memdebug.h" 1
# 87 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c" 2
# 101 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static void _state(struct connectdata *conn,
                   ftpstate newstate);
# 111 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
static CURLcode ftp_dophase_done(struct connectdata *conn,
                                 _Bool connected);
# 168 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 283 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static void freedirs(struct ftp_conn *ftpc)
{
  ...
  do {if((ftpc->file)) {Curl_cfree((ftpc->file)); (ftpc->file) = ((void*)0);}} while(0);


  do {if((ftpc->newhost)) {Curl_cfree((ftpc->newhost)); (ftpc->newhost) = ((void*)0);}} while(0);
}
...
# 323 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 380 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 418 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 489 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 540 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 594 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 642 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 671 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  ...
  *nreadp=0;
  ...
  while(!*ftpcode && !result) {
    ...
    if(timeout < interval_ms)
      interval_ms = timeout;
# 728 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 816 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static void _state(struct connectdata *conn,
                   ftpstate newstate
...
{
  struct ftp_conn *ftpc = &conn->proto.ftpc;
# 837 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  ftpc->state = newstate;
}
...
static CURLcode ftp_state_user(struct connectdata *conn)
{
  ...
  if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"USER %s",ftp->user?ftp->user:""))) return result;
...
static CURLcode ftp_state_pwd(struct connectdata *conn)
{
  ...
  if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"%s","PWD"))) return result;
  _state(conn,FTP_PWD);
...
static CURLcode ftp_state_cwd(struct connectdata *conn)
{
  ...
  if(ftpc->cwddone)
    ...
    if(conn->bits.reuse && ftpc->entrypath) {
      ...
      if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"CWD %s",ftpc->entrypath))) return result;
      _state(conn,FTP_CWD);
    }
    else {
      if(ftpc->dirdepth) {
        ...
        if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"CWD %s",ftpc->dirs[ftpc->count1 -1]))) return result;
        _state(conn,FTP_CWD);
      }
      else {
...

{
  ...
  for(; fcmd != DONE; fcmd++) {
    ...
    if(EPRT == fcmd) {
# 1282 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1343 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
static CURLcode ftp_state_use_pasv(struct connectdata *conn)
{
  struct ftp_conn *ftpc = &conn->proto.ftpc;
  CURLcode result = CURLE_OK;
# 1367 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  ...
  if((result = Curl_pp_sendf(&ftpc->pp,"%s",mode[modeoff]))) return result;
...
# 1395 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_state_prepare_transfer(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
  struct FTP *ftp = conn->data->req.protop;
  ...
  if(ftp->transfer != FTPTRANSFER_BODY) {
    ...
    if(data->set.ftp_use_pret) {
      ...
      if(!conn->proto.ftpc.file) {
        if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"PRET %s",data->set.str[STRING_CUSTOMREQUEST]? data->set.str[STRING_CUSTOMREQUEST]: (data->set.ftp_list_only?"NLST":"LIST")))) return result;



      }
      else if(data->set.upload) {
        if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"PRET STOR %s",conn->proto.ftpc.file))) return result;
      }
      else {
        if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"PRET RETR %s",conn->proto.ftpc.file))) return result;
      }
...
static CURLcode ftp_state_rest(struct connectdata *conn)
{
  ...
  if((ftp->transfer != FTPTRANSFER_BODY) && ftpc->file) {
    ...
    if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"REST %d",0))) return result;
...
static CURLcode ftp_state_size(struct connectdata *conn)
{
  ...
  if((ftp->transfer == FTPTRANSFER_INFO) && ftpc->file) {
    ...
    if((result = Curl_pp_sendf(&ftpc->pp,"SIZE %s",ftpc->file))) return result;
...
static CURLcode ftp_state_list(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
  struct SessionHandle *data = conn->data;
# 1498 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
static CURLcode ftp_state_mdtm(struct connectdata *conn)
{
  ...
  if((data->set.get_filetime || data->set.timecondition) && ftpc->file) {
    ...
    if((result = Curl_pp_sendf(&ftpc->pp,"MDTM %s",ftpc->file))) return result;
...
# 1650 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  ...
  if((result = Curl_pp_sendf(&ftpc->pp,data->set.ftp_append?"APPE %s":"STOR %s",ftpc->file))) return result;
                                ...
                                ftpstate instate)
{
  ...
  if(item) {
    ...
    if(item) {
      ...
      if((result = Curl_pp_sendf(&ftpc->pp,"%s",cmd))) return result;
      _state(conn,instate);
      quote = 1;
    }
  }
...
static CURLcode ftp_epsv_disable(struct connectdata *conn)
{
  ...
  if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"%s","PASV"))) return result;
...
# 1892 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
                                    ...
                                    int ftpcode)
{
  ...
  if((ftpc->count1 == 0) &&
    ...
    if(ptr) {
      ...
      if(5 == sscanf(ptr, "%c%c%c%u%c",
        ...
        if(ptr) {
          ...
          ftpc->newhost = Curl_cstrdup(conn->host.name);
          if(!ftpc->newhost)
            return CURLE_OUT_OF_MEMORY;
        }
      }
    ...
    int ip[4];
    int port[2];
# 1991 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    while(*str) {
    ...
    if(data->set.ftp_skip_ip) {
      ...
      Curl_infof(data, "Skip %d.%d.%d.%d for data connection, re-use %s instead\n",
            ip[0], ip[1], ip[2], ip[3],
            conn->host.name);
      ...
      ftpc->newhost = curl_maprintf("%d.%d.%d.%d", ip[0], ip[1], ip[2], ip[3]);
  ...
  if(conn->bits.proxy) {
    ...
    if(!addr) {
      Curl_failf(data, "Can't resolve new host %s:%hu", ftpc->newhost, connectport);
      return CURLE_FTP_CANT_GET_HOST;
    }
  }
...
# 2087 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  if(data->set.verbose)
                                         ...
                                         curl_off_t filesize)
{
  ...
  if(data->state.resume_from) {
    ...
    Curl_infof(data, "Instructs server to resume from offset %"
          "ld" "\n", data->state.resume_from);

    if((result = Curl_pp_sendf(&ftpc->pp,"REST %" "ld",data->state.resume_from))) return result;
    ...
    if((result = Curl_pp_sendf(&ftpc->pp,"RETR %s",ftpc->file))) return result;
...
# 2486 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    curl_off_t size=-1;
# 2498 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    if((instate != FTP_LIST) &&
...
static CURLcode ftp_state_loggedin(struct connectdata *conn)
{
  ...
  if(conn->ssl[0].use) {
# 2605 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"PBSZ %d",0))) return result;
                                    ...
                                    ftpstate instate)
{
  ...
  if((ftpcode == 331) && (ftpc->state == FTP_USER)) {
    ...
    if((result = Curl_pp_sendf(&ftpc->pp,"PASS %s",ftp->passwd?ftp->passwd:""))) return result;
    ...
    if(data->set.str[STRING_FTP_ACCOUNT]) {
      if((result = Curl_pp_sendf(&ftpc->pp,"ACCT %s",data->set.str[STRING_FTP_ACCOUNT]))) return result;
    ...
    if(conn->data->set.str[STRING_FTP_ALTERNATIVE_TO_USER] &&
      ...
      if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"%s",conn->data->set.str[STRING_FTP_ALTERNATIVE_TO_USER]))) return result;
...
# 2736 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
      if(data->set.use_ssl && !conn->ssl[0].use) {
        ...
        if((result = Curl_pp_sendf(&ftpc->pp,"AUTH %s",ftpauth[ftpc->count1]))) return result;
    ...
    case FTP_AUTH:
# 2777 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    ...
    case FTP_PBSZ:
      if((result = Curl_pp_sendf(&ftpc->pp,"PROT %c",data->set.use_ssl == CURLUSESSL_CONTROL ? 'C' : 'P'))) return result;
    ...
    case FTP_PROT:
      ...
      if(data->set.ftp_ccc) {
        ...
        if((result = Curl_pp_sendf(&ftpc->pp,"%s","CCC"))) return result;
        _state(conn,FTP_CCC);
      }
      else {
        result = ftp_state_pwd(conn);
...
# 2919 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    ...
    case FTP_CWD:
      if(ftpcode/100 != 2) {
        ...
        if(conn->data->set.ftp_create_missing_dirs &&
          ...
          ftpc->count2++;
          if((result = Curl_pp_sendf(&ftpc->pp,"MKD %s",ftpc->dirs[ftpc->count1 - 1]))) return result;
          _state(conn,FTP_MKD);
        }
        else {
        ...
        if(++ftpc->count1 <= ftpc->dirdepth) {
          ...
          if((result = Curl_pp_sendf(&ftpc->pp,"CWD %s",ftpc->dirs[ftpc->count1 - 1]))) return result;
        }
        else {
          result = ftp_state_mdtm(conn);
          if(result)
...
# 3169 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 3213 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
                              ...
                              _Bool premature)
{
  ...
  if(result || premature)
    ...
    if((-1 != data->req.size) &&
      ...
      Curl_failf(data, "Received only partial file: %" "ld"
...
# 3452 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
CURLcode ftp_sendquote(struct connectdata *conn, struct curl_slist *quote)
{
  ...
  while(item) {
    if(item->data) {
      ...
      if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"%s",cmd))) return result;
...
# 3518 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_nb_type(struct connectdata *conn,
                            _Bool ascii, ftpstate newstate)
{
  struct ftp_conn *ftpc = &conn->proto.ftpc;
  ...
  if((result = Curl_pp_sendf(&ftpc->pp,"TYPE %c",want))) return result;
  _state(conn,newstate);
...
# 3548 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static void
...
# 3626 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 3775 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
...
# 4040 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
  struct ftp_conn *ftpc = &conn->proto.ftpc;
                       ...
                       const char *fmt, ...)
{
  ...
  result = ((void)conn->data, CURLE_OK);
  ...
  for(;;) {
    ...
    result = Curl_write(conn, conn->sock[0], sptr, write_len,
                        &bytes_written);
...
# 4137 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_quit(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
...
# 4167 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_disconnect(struct connectdata *conn, _Bool dead_connection)
{
  struct ftp_conn *ftpc= &conn->proto.ftpc;
  struct pingpong *pp = &ftpc->pp;
...
CURLcode ftp_parse_url_path(struct connectdata *conn)
{
  ...
  case FTPFILE_NOCWD:
# 4249 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    if(data->state.path &&
       data->state.path[0] &&
...
# 4472 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
