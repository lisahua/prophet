...
# 154 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c"
enum smb_req_state {
  SMB_REQUESTING,
  SMB_TREE_CONNECT,
  SMB_OPEN,
...
static CURLcode smb_send_setup(struct connectdata *conn)
{
  ...
  msg.byte_count = ((unsigned short)(p - msg.bytes));
...
static CURLcode smb_send_open(struct connectdata *conn)
{
  ...
  msg.word_count = 0x18;
  msg.andx.command = 0xff;
  msg.name_length = ((unsigned short)strlen(req->path));
  ...
  msg.byte_count = ((unsigned short) (msg.name_length + 1));
