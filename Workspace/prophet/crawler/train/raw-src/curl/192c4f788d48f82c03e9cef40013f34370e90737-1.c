# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2
# 1 "../lib/urldata.h" 1
# 71 "../lib/urldata.h"
# 1 "../lib/cookie.h" 1
# 28 "../lib/cookie.h"
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2
# 1 "../lib/non-ascii.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2
# 1 "../lib/escape.h" 1
# 27 "../lib/escape.h"
CURLcode Curl_urldecode(struct SessionHandle *data,
                        ...
                        _Bool reject_crlf);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2


# 1 "../lib/memdebug.h" 1
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c" 2





static _Bool Curl_isunreserved(unsigned char in)
{
  switch (in) {
...
char *curl_easy_escape(CURL *handle, const char *string, int inlength)
{
  ...
  while(length--) {
    ...
    if(Curl_isunreserved(in))
      ...
      if(newlen > alloc) {
        alloc *= 2;
        testing_ptr = Curl_crealloc(ns, alloc);
        if(!testing_ptr) {
          Curl_cfree(ns);
          return ((void*)0);
        }
      ...
      curl_msnprintf(&ns[strindex], 4, "%%%02X", in);
...
# 145 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/escape.c"
CURLcode Curl_urldecode(struct SessionHandle *data,
                        const char *string, size_t length,
                        char **ostring, size_t *olen,
                        _Bool reject_ctrl)
{
  ...
  while(--alloc > 0) {
    in = *string;
    if(('%' == in) && (((*__ctype_b_loc ())[(int) (((int) ((unsigned char)string[1])))] & (unsigned short int) _ISxdigit)) && (((*__ctype_b_loc ())[(int) (((int) ((unsigned char)string[2])))] & (unsigned short int) _ISxdigit))) {
