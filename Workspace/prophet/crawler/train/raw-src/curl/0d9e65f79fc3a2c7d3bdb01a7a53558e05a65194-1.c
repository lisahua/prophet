# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
# 1 "../lib/getinfo.h" 1
# 24 "../lib/getinfo.h"
CURLcode Curl_getinfo(struct SessionHandle *data, CURLINFO info, ...);
CURLcode Curl_initinfo(struct SessionHandle *data);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
# 1 "../lib/sslgen.h" 1
# 30 "../lib/sslgen.h"
...
void Curl_ssl_md5sum(unsigned char *tmp,
                     ...
                     size_t md5len);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2


# 1 "../lib/memdebug.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/getinfo.c" 2
                               ...
                               double *param_doublep)
{
  ...
  case CURLINFO_CONTENT_LENGTH_DOWNLOAD:
    *param_doublep = (data->progress.flags & (1<<6))?
      (double)data->progress.size_dl:-1;
    break;
  case CURLINFO_CONTENT_LENGTH_UPLOAD:
    *param_doublep = (data->progress.flags & (1<<5))?
...
{
  va_list arg;
  long *param_longp=((void*)0);
  double *param_doublep=((void*)0);
  char **param_charp=((void*)0);
  struct curl_slist **param_slistp=((void*)0);
  int type;
  ...
  type = 0xf00000 & (int)info;
  switch(type) {
  case 0x100000:
    param_charp = __builtin_va_arg(arg, char **);
    if(((void*)0) != param_charp)
      ret = getinfo_char(data, info, param_charp);
    break;
  case 0x200000:
    param_longp = __builtin_va_arg(arg, long *);
    if(((void*)0) != param_longp)
      ret = getinfo_long(data, info, param_longp);
    break;
  case 0x300000:
    param_doublep = __builtin_va_arg(arg, double *);
    if(((void*)0) != param_doublep)
      ret = getinfo_double(data, info, param_doublep);
    break;
  case 0x400000:
    param_slistp = __builtin_va_arg(arg, struct curl_slist **);
    if(((void*)0) != param_slistp)
