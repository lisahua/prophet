...
# 69 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
static CURLMcode multi_timeout(struct Curl_multi *multi,
                               long *timeout_ms);
# 105 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
)
{
  ...
  data->mstate = state;
# 141 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  if(state == CURLM_STATE_COMPLETED)

    data->multi->num_alive--;
}
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 255 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                                ...
                                CURL *easy_handle)
{
  ...
  if(!timeoutlist)
    return CURLM_OUT_OF_MEMORY;
# 387 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  ...
  multi->num_alive++;
# 463 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 485 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                                   ...
                                   CURL *curl_handle)
{
  ...
  premature = (data->mstate < CURLM_STATE_COMPLETED) ? 1 : 0;
                         ...
                         int numsocks)
{
  ...
  switch(data->mstate) {
  default:
# 712 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    return 0;
  ...
  do {
    ...
    if(data->easy_conn &&
      ...
      if(timeout_ms < 0) {
        ...
        (void)Curl_done(&data->easy_conn, result, 1);
    ...
    case CURLM_STATE_WAITPROXYCONNECT:
      ...
      if(data->easy_conn->bits.proxy_connect_closed) {
        ...
        if(data->easy_conn->tunnel_state[0] == TUNNEL_COMPLETE)
          ...
          mstate(data,CURLM_STATE_SENDPROTOCONNECT);
      }
      break;
    ...
    case CURLM_STATE_WAITCONNECT:
      ...
      result = Curl_is_connected(data->easy_conn, 0, &connected);
      if(connected && !result) {
        rc = CURLM_CALL_MULTI_PERFORM;
        mstate(data,data->easy_conn->bits.tunnel_proxy? CURLM_STATE_WAITPROXYCONNECT: CURLM_STATE_SENDPROTOCONNECT);
    ...
    case CURLM_STATE_SENDPROTOCONNECT:
      ...
      if(!protocol_connect)
        ...
        Curl_done(&data->easy_conn, result, 1);
        disconnect_conn = 1;
      }
      break;
...
# 1256 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    ...
    case CURLM_STATE_DO:
      if(data->set.connect_only) {
        ...
        if(!result) {
          ...
          Curl_posttransfer(data);
          drc = Curl_done(&data->easy_conn, result, 0);
          ...
          Curl_posttransfer(data);
          if(data->easy_conn)
            Curl_done(&data->easy_conn, result, 0);
          disconnect_conn = 1;
        }
      }
      break;
...
# 1461 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
    {
      ...
      if(result) {
# 1555 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        ...
        if(data->req.newurl || retry) {
          if(!retry) {
            ...
            follow = FOLLOW_RETRY;
          result = Curl_done(&data->easy_conn, CURLE_OK, 0);
          if(!result) {
    ...
    case CURLM_STATE_DONE:
      ...
      if(data->easy_conn) {
        ...
        res = Curl_done(&data->easy_conn, result, 0);
    ...
    if(data->mstate < CURLM_STATE_COMPLETED) {
      if(result) {
# 1702 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        data->state.pipe_broke = 0;
        ...
        if(data->easy_conn) {
          ...
          if(disconnect_conn) {
            ...
            _Bool dead_connection = result == CURLE_OPERATION_TIMEDOUT;
...
# 1819 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  do {
...
# 1928 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 2117 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_multi_closed(struct connectdata *conn, curl_socket_t s)
{
...
# 2152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2588 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
...
# 2682 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire_latest(struct SessionHandle *data, long milli)
{
