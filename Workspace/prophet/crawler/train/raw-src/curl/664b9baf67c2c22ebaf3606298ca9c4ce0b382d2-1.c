    ...
    if((((*__ctype_b_loc ())[(int) (((int) ((unsigned char)*date)))] & (unsigned short int) _ISalpha))) {
      ...
      if((secnum == -1) &&
        ...
        if((tzoff == -1) &&
           ...
           (indate< date) &&
           ((date[-1] == '+' || date[-1] == '-'))) {
# 435 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
          found = 1;
  ...
  if((-1 == mdaynum) ||
    ...
    return -1;
# 502 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
  if(yearnum < 1970) {
    *output = 0;
    return 2;
  }
...
# 525 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
  t = my_timegm(&tm);
