...
# 728 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
int Curl_ossl_init(void)
{
...
# 785 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 818 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  if(!e) {
...
# 1102 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  ...
  if(altnames) {
    ...
    for(i=0; (i<numalts) && (matched != 1); i++) {
      ...
      if(check->type == target) {
        ...
        switch(target) {
        case 2:
# 1165 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
    ...
    if(i>=0) {
      ...
      if(tmp) {
        if(ASN1_STRING_type(tmp) == 12) {
          ...
          if(j >= 0) {
            peer_CN = CRYPTO_malloc((int)j+1,"/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c",1230);
            if(peer_CN) {
                   ...
                   int sockindex)
{
  ...
  struct in6_addr addr;
# 1473 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  do { } while(0);
...
# 1504 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 1699 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
ossl_connect_step2(struct connectdata *conn, int sockindex)
{
  ...
  if(1 != err) {
    ...
    Curl_infof (data, "SSL connection using %s\n",
           SSL_CIPHER_get_name(SSL_get_current_cipher(connssl->handle)));
# 1994 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
    return CURLE_OK;
  }
}
...
# 2053 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2155 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2327 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2485 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2518 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2838 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
}
