# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
# 1 "../lib/urldata.h" 1
# 82 "../lib/urldata.h"
# 1 "../lib/cookie.h" 1
# 26 "../lib/cookie.h"
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 1 "../lib/non-ascii.h" 1
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 1 "../lib/curl_gethostname.h" 1
# 29 "../lib/curl_gethostname.h"
int Curl_gethostname(char *name, size_t namelen);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 1 "../lib/curl_multibyte.h" 1
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
...
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 1 "../lib/curl_sasl.h" 1
# 27 "../lib/curl_sasl.h"
struct SessionHandle;
struct connectdata;
...
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
...
# 58 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2


# 1 "../lib/memdebug.h" 1
# 61 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c" 2
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
...
# 188 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
                                         ...
                                         struct ntlmdata *ntlm)
{
  ...
  if(size >= 48) {
    ...
    if(target_info_len > 0) {
      ...
      ntlm->target_info = Curl_cmalloc(target_info_len);
      if(!ntlm->target_info)
...
# 252 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
CURLcode Curl_sasl_decode_ntlm_type2_message(struct SessionHandle *data,
                                             const char *type2msg,
                                             struct ntlmdata *ntlm)
{
  static const char type2_marker[] = { 0x02, 0x00, 0x00, 0x00 };
# 274 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
  CURLcode result = CURLE_OK;
  unsigned char *type2 = ((void*)0);
  size_t type2_len = 0;
# 288 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
  ...
  if(!type2) {
    Curl_infof(data, "NTLM handshake failure (empty type-2 message)\n");
    return CURLE_BAD_CONTENT_ENCODING;
  }
  ...
  if((type2_len < 32) ||
     (memcmp(type2, "\x4e\x54\x4c\x4d\x53\x53\x50", 8) != 0) ||
  ...
  do { } while(0);
# 332 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
  Curl_cfree(type2);
...
# 365 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
CURLcode Curl_sasl_create_ntlm_type1_message(const char *userp,
                                             const char *passwdp,
                                             struct ntlmdata *ntlm,
                                             char **outptr, size_t *outlen)
{
# 384 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
  size_t size;

  unsigned char ntlmbuf[1024];
  const char *host = "";
  const char *domain = "";
  size_t hostlen = 0;
  size_t domlen = 0;
  ...
  curl_msnprintf((char *)ntlmbuf, 1024,
           "\x4e\x54\x4c\x4d\x53\x53\x50" "%c"
           "\x01%c%c%c"
           "%c%c%c%c"
           "%c%c"
           "%c%c"
           ...
           (((1<<1) | (1<<2) | (1<<9) | (1<<19) | (1<<15)) & 0xff), ((((1<<1) | (1<<2) | (1<<9) | (1<<19) | (1<<15)) >> 8) & 0xff), ((((1<<1) | (1<<2) | (1<<9) | (1<<19) | (1<<15)) >> 16) & 0xff), ((((1<<1) | (1<<2) | (1<<9) | (1<<19) | (1<<15)) >> 24) & 0xff),




           ((domlen) & 0xff), (((domlen) >> 8) & 0xff),
           ((domlen) & 0xff), (((domlen) >> 8) & 0xff),
           ((domoff) & 0xff), (((domoff) >> 8) & 0xff),
           0, 0,
           ((hostlen) & 0xff), (((hostlen) >> 8) & 0xff),
           ((hostlen) & 0xff), (((hostlen) >> 8) & 0xff),
           ((hostoff) & 0xff), (((hostoff) >> 8) & 0xff),
           0, 0,
           host,
           domain );
  ...
  do { } while(0);
# 464 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
  return Curl_base64_encode(((void*)0), (char *)ntlmbuf, size, outptr, outlen);
}
# 485 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
CURLcode Curl_sasl_create_ntlm_type3_message(struct SessionHandle *data,
                                             const char *userp,
                                             const char *passwdp,
                                             struct ntlmdata *ntlm,
...
{
# 510 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
  CURLcode result = CURLE_OK;
  size_t size;
  unsigned char ntlmbuf[1024];
  int lmrespoff;
  ...
  unsigned char *ntlmv2resp = ((void*)0);

  _Bool unicode = (ntlm->flags & (1<<0)) ? 1 : 0;
  char host[1024 + 1] = "";
  const char *user;
  const char *domain = "";
  size_t hostoff = 0;
  ...
  user = (__extension__ (__builtin_constant_p ('\\') && !__builtin_constant_p (userp) && ('\\') == '\0' ? (char *) __rawmemchr (userp, '\\') : __builtin_strchr (userp, '\\')));
  if(!user)
    user = (__extension__ (__builtin_constant_p ('/') && !__builtin_constant_p (userp) && ('/') == '\0' ? (char *) __rawmemchr (userp, '/') : __builtin_strchr (userp, '/')));
  ...
  if(ntlm->flags & (1<<19)) {
    ...
    Curl_ssl_md5sum(tmp, 16, md5sum, 16);
  ...
  size = curl_msnprintf((char *)ntlmbuf, 1024,
                  "\x4e\x54\x4c\x4d\x53\x53\x50" "%c"
                  "\x03%c%c%c"
                  ...
                  ((0x18) & 0xff), (((0x18) >> 8) & 0xff),
                  ((0x18) & 0xff), (((0x18) >> 8) & 0xff),
                  ((lmrespoff) & 0xff), (((lmrespoff) >> 8) & 0xff),
                  0x0, 0x0,


                  ((ntresplen) & 0xff), (((ntresplen) >> 8) & 0xff),
                  ((ntresplen) & 0xff), (((ntresplen) >> 8) & 0xff),
                  ((ntrespoff) & 0xff), (((ntrespoff) >> 8) & 0xff),
                  0x0, 0x0,
                  ...
                  ((userlen) & 0xff), (((userlen) >> 8) & 0xff),
                  ((userlen) & 0xff), (((userlen) >> 8) & 0xff),
                  ((useroff) & 0xff), (((useroff) >> 8) & 0xff),
                  0x0, 0x0,
                  ...
                  ((ntlm->flags) & 0xff), (((ntlm->flags) >> 8) & 0xff), (((ntlm->flags) >> 16) & 0xff), (((ntlm->flags) >> 24) & 0xff));
  ...
  do {if((ntlmv2resp)) {Curl_cfree((ntlmv2resp)); (ntlmv2resp) = ((void*)0);}} while(0);



  do { } while(0);
# 797 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_msgs.c"
  if(size + userlen + domlen + hostlen >= 1024) {
  ...
  result = Curl_base64_encode(((void*)0), (char *)ntlmbuf, size, outptr, outlen);
