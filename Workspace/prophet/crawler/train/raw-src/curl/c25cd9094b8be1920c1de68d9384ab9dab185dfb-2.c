...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c" 2
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c" 2
...
# 1 "../lib/memdebug.h" 1
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c" 2
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
static CURLMcode multi_timeout(struct Curl_multi *multi,
                               long *timeout_ms);
# 107 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
)
{
  ...
  data->mstate = state;
# 139 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  if(state == CURLM_STATE_COMPLETED)

    data->multi->num_alive--;
}
# 154 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 254 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                                ...
                                CURL *easy_handle)
{
  ...
  if(!timeoutlist)
    return CURLM_OUT_OF_MEMORY;
# 386 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  ...
  multi->num_alive++;
# 462 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 484 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(data->mstate) {
  default:
# 707 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    return 0;
  ...
  do {
...

    {
      ...
      if(dns) {
        ...
        data->result = 0;
        Curl_infof(data, "Hostname was found in DNS cache\n");
      }
      if(stale)
...
# 1267 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 1471 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(data->result) {
# 1565 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    ...
    case CURLM_STATE_DONE:
      ...
      if(data->easy_conn) {
        ...
        res = Curl_done(&data->easy_conn, data->result, 0);
    ...
    if(data->mstate < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != data->result) {
# 1711 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1826 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  do {
...
# 1935 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 2124 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_multi_closed(struct connectdata *conn, curl_socket_t s)
{
...
# 2159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2557 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode
...
# 2605 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
...
# 2699 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_expire_latest(struct SessionHandle *data, long milli)
{
