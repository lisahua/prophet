# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/transfer.h" 1
# 25 "../lib/transfer.h"
...
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                     int pkt_size);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/url.h" 1
# 30 "../lib/url.h"
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/easyif.h" 1
# 28 "../lib/easyif.h"
void Curl_easy_addmulti(struct SessionHandle *data, void *multi);

void Curl_easy_initHandleData(struct SessionHandle *data);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/multiif.h" 1
# 30 "../lib/multiif.h"
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/speedcheck.h" 1
# 29 "../lib/speedcheck.h"
void Curl_speedinit(struct SessionHandle *data);
CURLcode Curl_speedcheck(struct SessionHandle *data,
                         struct timeval now);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/conncache.h" 1
# 25 "../lib/conncache.h"
struct conncache {
  struct curl_hash *hash;
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/bundles.h" 1
# 25 "../lib/bundles.h"
...
int Curl_bundle_remove_conn(struct connectbundle *cb_ptr,
                            struct connectdata *conn);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 1 "../lib/pipeline.h" 1
# 25 "../lib/pipeline.h"
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
...
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2

# 1 "../lib/memdebug.h" 1
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c" 2
# 70 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static void singlesocket(struct Curl_multi *multi,
                         struct Curl_one_easy *easy);
static int update_timer(struct Curl_multi *multi);

static _Bool isHandleAtHead(struct SessionHandle *handle,
                           struct curl_llist *pipeline);
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d);
# 103 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
)
{
  ...
  easy->state = state;
# 135 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  if(state == CURLM_STATE_COMPLETED)

    easy->easy_handle->multi->num_alive--;
}
# 150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                                         ...
                                         struct SessionHandle *data)
{
  ...
  check = Curl_ccalloc(1, sizeof(struct Curl_sh_entry));
  if(!check)
    return ((void*)0);
  check->easy = data;
  check->socket = s;
  ...
  if(((void*)0) == Curl_hash_add(sh, (char *)&s, sizeof(curl_socket_t), check)) {
    Curl_cfree(check);
    return ((void*)0);
  }
...
# 250 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
struct Curl_multi *Curl_multi_handle(int hashsize,
                                     int chashsize)
{
  struct Curl_multi *multi = Curl_ccalloc(1, sizeof(struct Curl_multi));

  if(!multi)
    return ((void*)0);

  multi->type = 0x000bab1e;
  ...
  multi->sockhash = ((void*)0);
  Curl_hash_destroy(multi->hostcache);
  multi->hostcache = ((void*)0);
  Curl_conncache_destroy(multi->conn_cache);
  multi->conn_cache = ((void*)0);
                                ...
                                CURL *easy_handle)
{
  ...
  struct SessionHandle *new_closure = ((void*)0);
  struct curl_hash *hostcache = ((void*)0);


  if(!((multi) && (((struct Curl_multi *)(multi))->type == 0x000bab1e)))
    return CURLM_BAD_HANDLE;


  if(!((easy_handle) && (((struct SessionHandle *)(easy_handle))->magic == 0xc0dedbadU)))
  ...
  easy = Curl_ccalloc(1, sizeof(struct Curl_one_easy));
  if(!easy) {
    Curl_llist_destroy(timeoutlist, ((void*)0));
    return CURLM_OUT_OF_MEMORY;
  }
...
# 405 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  if(new_closure) {
  ...
  multi->num_alive++;
# 484 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 506 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                                   ...
                                   CURL *curl_handle)
{
  ...
  if(!((curl_handle) && (((struct SessionHandle *)(curl_handle))->magic == 0xc0dedbadU)))
    return CURLM_BAD_EASY_HANDLE;
  ...
  if(easy) {
    _Bool premature = (easy->state < CURLM_STATE_COMPLETED) ? 1 : 0;
    _Bool easy_owns_conn = (easy->easy_conn &&
    ...
    if(easy->easy_handle->dns.hostcachetype == HCACHE_MULTI) {
      ...
      easy->easy_handle->dns.hostcache = ((void*)0);
      easy->easy_handle->dns.hostcachetype = HCACHE_NONE;
    }
    ...
    if(easy->easy_conn) {
      ...
      easy->easy_handle->state.conn_cache = ((void*)0);
    ...
    if(easy->easy_conn) {
      easy->easy_conn->data = ((void*)0);
      easy->easy_conn = ((void*)0);
    }

    Curl_easy_addmulti(easy->easy_handle, ((void*)0));
    ...
    easy->easy_handle->set.one_easy = ((void*)0);


    easy->easy_handle->multi_pos = ((void*)0);
...
_Bool Curl_multi_pipeline_enabled(const struct Curl_multi *multi)
{
  return (multi && multi->pipelining_enabled) ? 1 : 0;
}
                         ...
                         int numsocks)
{
  ...
  switch(easy->state) {
  default:
# 720 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    return 0;
                           ...
                           fd_set *exc_fd_set, int *max_fd)
{
  ...
  while(easy != &multi->easy) {
    bitmap = multi_getsock(easy, sockbunch, 5);

    for(i=0; i< 5; i++) {
      curl_socket_t s = -1;

      if((bitmap & (1 << (i))) && ((((sockbunch[i])) >= 0) && (((sockbunch[i])) < 1024))) {
        ((void) (((read_fd_set)->__fds_bits)[((sockbunch[i]) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) 1 << ((sockbunch[i]) % (8 * (int) sizeof (__fd_mask))))));
        s = sockbunch[i];
      }
      if((bitmap & (1 << (16 + (i)))) && ((((sockbunch[i])) >= 0) && (((sockbunch[i])) < 1024))) {
        ((void) (((write_fd_set)->__fds_bits)[((sockbunch[i]) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) 1 << ((sockbunch[i]) % (8 * (int) sizeof (__fd_mask))))));
        s = sockbunch[i];
      }
      if(s == -1)
                          ...
                          int *ret)
{
  ...
  if(nfds) {
    ufds = Curl_cmalloc(nfds * sizeof(struct pollfd));
    if(!ufds)
      return CURLM_OUT_OF_MEMORY;
  }
  nfds = 0;
    ...
    while(easy != &multi->easy) {
      ...
      for(i=0; i< 5; i++) {
        ...
        if(bitmap & (1 << (i))) {
          ...
          ufds[nfds].events = 0x001;
          ++nfds;
          s = sockbunch[i];
        }
        if(bitmap & (1 << (16 + (i)))) {
          ufds[nfds].fd = sockbunch[i];
          ufds[nfds].events = 0x004;
          ++nfds;
          s = sockbunch[i];
        }
        if(s == -1) {
  ...
  for(i = 0; i < extra_nfds; i++) {
    ...
    ufds[nfds].events = 0;
    if(extra_fds[i].events & 0x0001)
      ufds[nfds].events |= 0x001;
    if(extra_fds[i].events & 0x0002)
      ufds[nfds].events |= 0x002;
    if(extra_fds[i].events & 0x0004)
      ufds[nfds].events |= 0x004;
    ++nfds;
  }
  ...
  do {if((ufds)) {Curl_cfree((ufds)); (ufds) = ((void*)0);}} while(0);
  if(ret)
    *ret = i;
  return CURLM_OK;
}
...
static CURLMcode multi_runsingle(struct Curl_multi *multi,
                                 ...
                                 struct Curl_one_easy *easy)
{
  struct Curl_message *msg = ((void*)0);
  _Bool connected;
  _Bool async;
  _Bool protocol_connect = 0;
  _Bool dophase_done = 0;
  _Bool done = 0;
  ...
  if(!((easy->easy_handle) && (((struct SessionHandle *)(easy->easy_handle))->magic == 0xc0dedbadU)))
    return CURLM_BAD_EASY_HANDLE;
  ...
  do {
    ...
    _Bool disconnect_conn = 0;



    if(data->state.pipe_broke) {
      Curl_infof(data, "Pipe broke: handle 0x%p, url = %s\n",
            easy, data->state.path);

      if(easy->state < CURLM_STATE_COMPLETED) {

        mstate(easy,CURLM_STATE_CONNECT);
        result = CURLM_CALL_MULTI_PERFORM;
        easy->result = CURLE_OK;
      }

      data->state.pipe_broke = 0;
      easy->easy_conn = ((void*)0);
      break;
    }
    ...
    if(easy->easy_conn &&
      ...
      if(timeout_ms < 0) {
        ...
        if(easy->state == CURLM_STATE_WAITRESOLVE)
          Curl_failf(data, "Resolving timed out after %ld milliseconds",
                curlx_tvdiff(now,data->progress.t_startsingle));
        else if(easy->state == CURLM_STATE_WAITCONNECT)
          Curl_failf(data, "Connection timed out after %ld milliseconds",
                curlx_tvdiff(now,data->progress.t_startsingle));
        else {
          k = &data->req;
          Curl_failf(data, "Operation timed out after %ld milliseconds with %"
                "ld" " out of %" "ld" " bytes received",
                curlx_tvdiff(now,data->progress.t_startsingle), k->bytecount,
                k->size);
        }
        ...
        mstate(easy,CURLM_STATE_COMPLETED);
        break;
      }
    }
    ...
    case CURLM_STATE_CONNECT:
      ...
      if(CURLE_NO_CONNECTION_AVAILABLE == easy->result) {
        ...
        mstate(easy,CURLM_STATE_CONNECT_PEND);
        easy->result = CURLE_OK;
        break;
      }
      ...
      if(CURLE_OK == easy->result) {
        ...
        if(CURLE_OK != easy->result)
          ...
          if(async)
            ...
            mstate(easy,CURLM_STATE_WAITRESOLVE);
          else {
            ...
            if(protocol_connect)
              mstate(easy,multi->pipelining_enabled? CURLM_STATE_WAITDO:CURLM_STATE_DO);

            else {

              if(easy->easy_conn->tunnel_state[0] == TUNNEL_CONNECT)
                mstate(easy,CURLM_STATE_WAITPROXYCONNECT);
              else

                mstate(easy,CURLM_STATE_WAITCONNECT);
            }
          }
        }
      }
...

    {
      ...
      easy->result = CURLE_COULDNT_RESOLVE_HOST;
    ...
    case CURLM_STATE_WAITPROXYCONNECT:
      ...
      if(easy->easy_conn->bits.proxy_connect_closed) {
        ...
        if(easy->easy_conn->tunnel_state[0] == TUNNEL_COMPLETE)
          mstate(easy,CURLM_STATE_WAITCONNECT);
      }
      break;
      ...
      if(connected) {
        if(!protocol_connect) {
          ...
          if(easy->easy_conn->tunnel_state[0] == TUNNEL_CONNECT)
            ...
            mstate(easy,CURLM_STATE_PROTOCONNECT);
    ...
    case CURLM_STATE_PROTOCONNECT:
      ...
      if((easy->result == CURLE_OK) && protocol_connect) {
        ...
        Curl_done(&easy->easy_conn, easy->result, 1);
        disconnect_conn = 1;
      }
      break;

    case CURLM_STATE_WAITDO:
# 1210 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
      if(!easy->easy_conn->writechannel_inuse &&
         isHandleAtHead(data,
                        easy->easy_conn->send_pipe)) {

        easy->easy_conn->writechannel_inuse = 1;
        mstate(easy,CURLM_STATE_DO);
        result = CURLM_CALL_MULTI_PERFORM;
      }
      break;
    ...
    case CURLM_STATE_DO:
      if(data->set.connect_only) {
        ...
        easy->easy_conn->bits.close = 0;
        mstate(easy,CURLM_STATE_DONE);
        easy->result = CURLE_OK;
        result = CURLM_CALL_MULTI_PERFORM;
      }
      else {
        ...
        if(CURLE_OK == easy->result) {
          if(!dophase_done) {
            ...
            if(data->set.wildcardmatch) {
              ...
              if(wc->state == CURLWC_DONE || wc->state == CURLWC_SKIP) {
                ...
                Curl_done(&easy->easy_conn, CURLE_OK, 0);
                mstate(easy,CURLM_STATE_DONE);
                result = CURLM_CALL_MULTI_PERFORM;
                break;
              }
            ...
            mstate(easy,CURLM_STATE_DO_MORE);
            result = CURLM_OK;
          }
          else {

            mstate(easy,CURLM_STATE_DO_DONE);
            result = CURLM_CALL_MULTI_PERFORM;
          }
        }
          ...
          Curl_posttransfer(data);
          drc = Curl_done(&easy->easy_conn, easy->result, 0);
          ...
          Curl_posttransfer(data);
          if(easy->easy_conn)
            Curl_done(&easy->easy_conn, easy->result, 0);
          disconnect_conn = 1;
        }
      }
      break;
    ...
    case CURLM_STATE_DOING:
      ...
      if(CURLE_OK == easy->result) {
        if(dophase_done) {
          ...
          mstate(easy,easy->easy_conn->bits.do_more? CURLM_STATE_DO_MORE: CURLM_STATE_DO_DONE);
    ...
    case CURLM_STATE_DO_DONE:
      ...
      mstate(easy,CURLM_STATE_WAITPERFORM);
      result = CURLM_CALL_MULTI_PERFORM;
      break;
    ...
    case CURLM_STATE_WAITPERFORM:
      ...
      if(!easy->easy_conn->readchannel_inuse &&
        ...
        easy->easy_conn->readchannel_inuse = 1;
        mstate(easy,CURLM_STATE_PERFORM);
        result = CURLM_CALL_MULTI_PERFORM;
      }
# 1403 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if((data->set.max_send_speed > 0) &&
        ...
        mstate(easy,CURLM_STATE_TOOFAST);


        buffersize = (int)(data->set.buffer_size ?
                           data->set.buffer_size : 16384);
      ...
      if(!(k->keepon & (1<<0))) {
        ...
        easy->easy_conn->readchannel_inuse = 0;
      }

      if(!(k->keepon & (1<<1))) {

        easy->easy_conn->writechannel_inuse = 0;
      }
      ...
      if(easy->result) {
# 1497 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        if(!(easy->easy_conn->handler->flags & (1<<1)))
          easy->easy_conn->bits.close = 1;
        ...
        if(data->req.newurl || retry) {
          if(!retry) {
            ...
            follow = FOLLOW_RETRY;
          easy->result = Curl_done(&easy->easy_conn, CURLE_OK, 0);
    ...
    if(easy->state < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != easy->result) {
# 1644 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        data->state.pipe_broke = 0;
        ...
        if(easy->easy_conn) {
          ...
          if(disconnect_conn) {
            ...
            Curl_disconnect(easy->easy_conn, 0);
        ...
        mstate(easy,(easy->state < CURLM_STATE_DONE)? CURLM_STATE_DONE: CURLM_STATE_COMPLETED);
  ...
  if(CURLM_STATE_COMPLETED == easy->state) {
    ...
    mstate(easy,CURLM_STATE_MSGSENT);
  }
...
# 1755 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  do {
...
CURLMcode curl_multi_cleanup(CURLM *multi_handle)
{
  ...
  if(((multi) && (((struct Curl_multi *)(multi))->type == 0x000bab1e))) {
    ...
    Curl_pipeline_set_site_blacklist(((void*)0), &multi->pipelining_site_bl);
    Curl_pipeline_set_server_blacklist(((void*)0), &multi->pipelining_server_bl);
...
# 1861 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
CURLMsg *curl_multi_info_read(CURLM *multi_handle, int *msgs_in_queue)
{
  ...
  *msgs_in_queue = 0;
  ...
  if(((multi) && (((struct Curl_multi *)(multi))->type == 0x000bab1e)) && Curl_llist_count(multi->msglist)) {
                         ...
                         struct Curl_one_easy *easy)
{
  ...
  curraction = multi_getsock(easy, socks, 5);
...
# 2056 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
{
  CURLMcode result = CURLM_OK;
  struct SessionHandle *data = ((void*)0);
  struct Curl_tree *t;
  struct timeval now = curlx_tvnow();
  ...
  if(checkall) {
    ...
    if(!entry)
      ...
      if(data->set.one_easy->easy_conn &&
         !(data->set.one_easy->easy_conn->handler->flags & (1<<3)))
                            ...
                            CURLMoption option, ...)
{
  ...
  case CURLMOPT_SOCKETFUNCTION:
    multi->socket_cb = __builtin_va_arg(param, curl_socket_callback);
    break;
  case CURLMOPT_SOCKETDATA:
    multi->socket_userp = __builtin_va_arg(param, void *);
    break;
  case CURLMOPT_PIPELINING:
    multi->pipelining_enabled = (0 != __builtin_va_arg(param, long)) ? 1 : 0;
    break;
  case CURLMOPT_TIMERFUNCTION:
    multi->timer_cb = __builtin_va_arg(param, curl_multi_timer_callback);
    break;
  case CURLMOPT_TIMERDATA:
    multi->timer_userp = __builtin_va_arg(param, void *);
    break;
  case CURLMOPT_MAXCONNECTS:
    multi->maxconnects = __builtin_va_arg(param, long);
    break;
  case CURLMOPT_MAX_HOST_CONNECTIONS:
    multi->max_host_connections = __builtin_va_arg(param, long);
    break;
  case CURLMOPT_MAX_PIPELINE_LENGTH:
    multi->max_pipeline_length = __builtin_va_arg(param, long);
    break;
  case CURLMOPT_CONTENT_LENGTH_PENALTY_SIZE:
    multi->content_length_penalty_size = __builtin_va_arg(param, long);
    break;
  case CURLMOPT_CHUNK_LENGTH_PENALTY_SIZE:
    multi->chunk_length_penalty_size = __builtin_va_arg(param, long);
    break;
  case CURLMOPT_PIPELINING_SITE_BL:
    res = Curl_pipeline_set_site_blacklist(__builtin_va_arg(param, char **),
                                           &multi->pipelining_site_bl);
    break;
  case CURLMOPT_PIPELINING_SERVER_BL:
    res = Curl_pipeline_set_server_blacklist(__builtin_va_arg(param, char **),
                                             &multi->pipelining_server_bl);
    break;
  case CURLMOPT_MAX_TOTAL_CONNECTIONS:
    multi->max_total_connections = __builtin_va_arg(param, long);
    break;
  default:
...
CURLMcode curl_multi_socket(CURLM *multi_handle, curl_socket_t s,
                            int *running_handles)
{
  CURLMcode result = multi_socket((struct Curl_multi *)multi_handle, 0, s,
                                  0, running_handles);
  if(CURLM_OK >= result)
                               ...
                               long *timeout_ms)
{
  ...
  if(multi->timetree) {
    ...
    if(( ((multi->timetree->key.tv_sec) < (now.tv_sec)) ? -1 : ( ((multi->timetree->key.tv_sec) > (now.tv_sec)) ? 1 : ( ((multi->timetree->key.tv_usec) < (now.tv_usec)) ? -1 : ( ((multi->timetree->key.tv_usec) > (now.tv_usec)) ? 1 : 0 )))) > 0) {
...
static int update_timer(struct Curl_multi *multi)
{
  ...
  if(timeout_ms < 0) {
    ...
    if(( ((none.tv_sec) < (multi->timer_lastcall.tv_sec)) ? -1 : ( ((none.tv_sec) > (multi->timer_lastcall.tv_sec)) ? 1 : ( ((none.tv_usec) < (multi->timer_lastcall.tv_usec)) ? -1 : ( ((none.tv_usec) > (multi->timer_lastcall.tv_usec)) ? 1 : 0 ))))) {
  ...
  if(( ((multi->timetree->key.tv_sec) < (multi->timer_lastcall.tv_sec)) ? -1 : ( ((multi->timetree->key.tv_sec) > (multi->timer_lastcall.tv_sec)) ? 1 : ( ((multi->timetree->key.tv_usec) < (multi->timer_lastcall.tv_usec)) ? -1 : ( ((multi->timetree->key.tv_usec) > (multi->timer_lastcall.tv_usec)) ? 1 : 0 )))) == 0)
    return 0;
...
# 2444 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode
                 ...
                 struct timeval *stamp)
{
  ...
  timedup = Curl_cmalloc(sizeof(*timedup));
  if(!timedup)
    return CURLM_OUT_OF_MEMORY;
...
# 2492 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
