...
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
unsigned long long Curl_read64_be(unsigned char *buf)
{
...
# 190 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
void Curl_write16_le(const short value, unsigned char *buffer)
{
  buffer[0] = (char)(value & 0x00FF);
  buffer[1] = (char)((value & 0xFF00) >> 8);
}
# 207 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
void Curl_write32_le(const int value, unsigned char *buffer)
{
...
# 228 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
void Curl_write64_le(const long long value, unsigned char *buffer)
