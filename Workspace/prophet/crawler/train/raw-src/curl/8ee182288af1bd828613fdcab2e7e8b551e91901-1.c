...
# 500 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  ...
  do { } while(0);
# 582 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
...
CURLcode Curl_ntlm_create_type3_message(struct SessionHandle *data,
                                        ...
                                        size_t *outlen)
{
# 630 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  size_t size;
# 689 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  unsigned char ntlmbuf[1024];
  int lmrespoff;
  ...
  do { } while(0);
# 970 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
