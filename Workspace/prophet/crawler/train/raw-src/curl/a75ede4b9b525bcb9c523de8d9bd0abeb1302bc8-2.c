...
# 79 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
unsigned long long Curl_read64_le(unsigned char *buf)
{
...
# 113 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
unsigned short Curl_read16_be(unsigned char *buf)
{
  return (unsigned short)(((unsigned short)buf[0] << 8) |
                          ((unsigned short)buf[1]));
}
# 132 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
unsigned int Curl_read32_be(unsigned char *buf)
{
  return ((unsigned int)buf[0] << 24) | ((unsigned int)buf[1] << 16) |
         ((unsigned int)buf[2] << 8) | ((unsigned int)buf[3]);
}
# 152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
unsigned long long Curl_read64_be(unsigned char *buf)
{
...
# 184 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
void Curl_write16_le(const short value, unsigned char *buffer)
{
  buffer[0] = (char)(value & 0x00FF);
  buffer[1] = (char)((value & 0xFF00) >> 8);
}
# 201 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
void Curl_write32_le(const int value, unsigned char *buffer)
{
...
# 222 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_endian.c"
void Curl_write64_le(const long long value, unsigned char *buffer)
