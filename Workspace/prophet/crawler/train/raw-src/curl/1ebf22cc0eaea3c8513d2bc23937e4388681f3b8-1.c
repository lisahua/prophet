...
CURLcode Curl_fillreadbuffer(struct connectdata *conn, int bytes, int *nreadp)
{
  ...
  int nread;
# 114 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 174 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    char hexbuffer[11];
...
# 224 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    if((nread - hexlen) == 0)
...
# 240 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  *nreadp = nread;
...
# 345 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
}
                                 ...
                                 int *didwhat)
{
  ...
  *didwhat |= (1<<1);
# 817 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  do {
...
# 1077 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1144 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1165 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
int Curl_single_getsock(const struct connectdata *conn,
                        curl_socket_t *sock,
...
# 1221 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                             int pkt_size)
{
...
# 1319 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    Curl_initinfo(data);
...
CURLcode Curl_follow(struct SessionHandle *data,
                     ...
                     followtype type)
{
# 1606 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1697 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  ...
  default:
    ...
    break;
  case 301:
# 1726 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    ...
    break;
  case 302:
# 1754 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    if((data->set.httpreq == HTTPREQ_POST
        || data->set.httpreq == HTTPREQ_POST_FORM)
...
Curl_reconnect_request(struct connectdata **connp)
{
  ...
  *connp = ((void*)0);
# 1824 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  ...
  )
{
  ...
  if(k->getheader || !data->set.opt_no_body) {
    ...
    if(conn->writesockfd != -1) {
      struct HTTP *http = data->req.protop;
# 1963 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
