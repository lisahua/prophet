# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2
...
# 59 "../lib/curlx.h" 2
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2
# 1 "../src/tool_mfiles.h" 1
# 31 "../src/tool_mfiles.h"
struct multi_files {
...
void FreeMultiInfo(struct multi_files **multi_first,
                   struct multi_files **multi_last);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2
# 1 "../src/tool_msgs.h" 1
# 26 "../src/tool_msgs.h"
void warnf(struct OperationConfig *config, const char *fmt, ...);

void helpf(FILE *errors, const char *fmt, ...);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2
...
int formparse(struct OperationConfig *config,
              ...
              struct curl_httppost **last_post,
              _Bool literal_value);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2

# 1 "../lib/memdebug.h" 1
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c" 2
    ...
    while(*ptr) {
      ...
      if(*ptr == '"') {
        *end_pos = ptr;
        ...
        while(*ptr && ((void*)0)==(__extension__ (__builtin_constant_p (*ptr) && !__builtin_constant_p (end_chars) && (*ptr) == '\0' ? (char *) __rawmemchr (end_chars, *ptr) : __builtin_strchr (end_chars, *ptr))))
          ++ptr;
        *str = ptr;
        return word_begin+1;
      }
...
# 143 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_formparse.c"
int formparse(struct OperationConfig *config,
              const char *input,
              struct curl_httppost **httppost,
              struct curl_httppost **last_post,
              _Bool literal_value)
{
  ...
  if((1 == sscanf(input, "%255[^=]=", name)) &&
     ((contp = (__extension__ (__builtin_constant_p ('=') && !__builtin_constant_p (input) && ('=') == '\0' ? (char *) __rawmemchr (input, '=') : __builtin_strchr (input, '=')))) != ((void*)0))) {



    contents = (__extension__ (__builtin_constant_p (contp+1) && ((size_t)(const void *)((contp+1) + 1) - (size_t)(const void *)(contp+1) == 1) ? (((const char *) (contp+1))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (contp+1) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void*)0)) __retval = (char *) memcpy (__retval, contp+1, __len); __retval; })) : __strdup (contp+1)));
    if(!contents) {
    ...
    if('@' == contp[0] && !literal_value) {
      ...
      struct multi_files *multi_start = ((void*)0);
      struct multi_files *multi_current = ((void*)0);
      ...
      do {
        ...
        *word_end = '\0';
        ...
        while(semicolon) {
          ...
          if(Curl_raw_nequal("type=",ptr,strlen("type="))) {
            ...
            if(2 != sscanf(type, "%127[^/]/%127[^;,\n]",
              ...
              do {if((contents)) {free((contents)); (contents) = ((void*)0);}} while(0);
            ...
            ptr = sep;
            if(*sep==';') {
              if(!Curl_raw_nequal(";filename=",sep,strlen(";filename="))) {
                ptr = sep + 1;
          ...
          else if(Curl_raw_nequal("filename=",ptr,strlen("filename="))) {
            ptr += 9;
      ...
      if(multi_start) {
        ...
        if(!forms) {
          curl_mfprintf(config->global->errors, "Error building form post!\n");
          do {if((contents)) {free((contents)); (contents) = ((void*)0);}} while(0);
          FreeMultiInfo(&multi_start, &multi_current);
          return 4;
        }
        ...
        if(curl_formadd(httppost, last_post,
          ...
          do {if((forms)) {free((forms)); (forms) = ((void*)0);}} while(0);
          do {if((contents)) {free((contents)); (contents) = ((void*)0);}} while(0);
          return 5;
        }
        do {if((forms)) {free((forms)); (forms) = ((void*)0);}} while(0);
      ...
      int i = 0;
      char *ct = literal_value ? ((void*)0) : strstr(contp, ";type=");
