...
# 1388 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
static CURLcode smtp_connect(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
  struct smtp_conn *smtpc = &conn->proto.smtpc;
...
# 1447 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
static CURLcode smtp_done(struct connectdata *conn, CURLcode status,
                          _Bool premature)
{
  CURLcode result = CURLE_OK;
  ...
  if(status) {
    ...
    if(bytes_written != 5) {
      ...
      pp->sendthis = Curl_cstrdup("\x0d\x0a\x2e\x0d\x0a");
      pp->sendsize = 5;
      pp->sendleft = 5 - bytes_written;
    }
    else
...
# 1502 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
# 1518 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
# 1559 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
static CURLcode smtp_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
...
# 1652 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smtp.c"
...
CURLcode Curl_smtp_escape_eob(struct connectdata *conn, ssize_t nread)
{
  ...
  for(i = 0, si = 0; i < nread; i++) {
    if("\x0d\x0a\x2e\x0d\x0a"[smtpc->eob] == data->req.upload_fromhere[i])
      smtpc->eob++;
    else if(smtpc->eob) {

      memcpy(&data->state.scratch[si], "\x0d\x0a\x2e\x0d\x0a", smtpc->eob);
      si += smtpc->eob;
