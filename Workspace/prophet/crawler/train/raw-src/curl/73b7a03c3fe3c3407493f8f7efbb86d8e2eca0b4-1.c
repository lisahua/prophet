# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c" 2
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c"
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c" 2
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c" 2

# 1 "../lib/memdebug.h" 1
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c" 2
...
# 326 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c"
...
# 617 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c"
const char *Curl_strerror(struct connectdata *conn, int err)
{
  char *buf, *p;
  size_t max;
  ...
  *buf = '\0';
# 661 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c"
  if(0 != strerror_r(err, buf, max)) {
    if('\0' == buf[0])
      curl_msnprintf(buf, max, "Unknown error %d", err);
  }
# 703 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/strerror.c"
  buf[max] = '\0';


  if((p = strrchr(buf,'\n')) != ((void*)0) && (p - buf) >= 2)
     *p = '\0';
  if((p = strrchr(buf,'\r')) != ((void*)0) && (p - buf) >= 1)
     *p = '\0';

  if(old_errno != ((*__errno_location ())))
