...
static CURLcode tftp_send_first(tftp_state_data_t *state, tftp_event_t event)
{
  ...
  case TFTP_EVENT_TIMEOUT:
    ...
    if(data->set.upload && (data->set.infilesize != -1))
      curl_msnprintf( buf, sizeof(buf), "%" "ld", data->set.infilesize );
    else
      strcpy(buf, "0");
...
# 578 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_rx(tftp_state_data_t *state, tftp_event_t event)
{
  ssize_t sbytes;
  int rblock;
...
# 699 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_tx(tftp_state_data_t *state, tftp_event_t event)
{
  struct SessionHandle *data = state->conn->data;
  ssize_t sbytes;
...
# 831 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_translate_code(tftp_error_t error)
{
...
# 884 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 921 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 943 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_connect(struct connectdata *conn, _Bool *done)
{
  CURLcode code;
  ...
  if(!conn->bits.bound) {
# 1006 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 1030 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 1055 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static int tftp_getsock(struct connectdata *conn, curl_socket_t *socks,
                        int numsocks)
{
  if(!numsocks)
...
# 1073 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 1157 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 1192 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_multi_statemach(struct connectdata *conn, _Bool *done)
{
  int rc;
  tftp_event_t event;
...
# 1251 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_doing(struct connectdata *conn, _Bool *dophase_done)
{
  CURLcode result;
...
# 1278 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
...
# 1309 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/tftp.c"
static CURLcode tftp_do(struct connectdata *conn, _Bool *done)
{
  tftp_state_data_t *state;
  CURLcode code;
