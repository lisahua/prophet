...
static CURLMcode multi_timeout(struct Curl_multi *multi,
                               long *timeout_ms);
# 104 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
)
{
  ...
  data->mstate = state;
# 140 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  if(state == CURLM_STATE_COMPLETED)

    data->multi->num_alive--;
}
# 155 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 256 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                                ...
                                CURL *easy_handle)
{
  ...
  if(!timeoutlist)
    return CURLM_OUT_OF_MEMORY;
# 388 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  ...
  multi->num_alive++;
# 464 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 486 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(data->mstate) {
  default:
# 703 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    return 0;
...
# 1259 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 1464 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
    {
      ...
      if(result) {
# 1558 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
    ...
    if(data->mstate < CURLM_STATE_COMPLETED) {
      if(result) {
# 1708 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1824 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
  do {
...
# 1933 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
...
# 2122 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_multi_closed(struct connectdata *conn, curl_socket_t s)
{
...
# 2157 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2545 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
static CURLMcode
...
# 2593 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
...
# 2687 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/multi.c"
void Curl_expire_latest(struct SessionHandle *data, long milli)
{
