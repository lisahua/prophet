# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
# 1 "../lib/non-ascii.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
...
# 59 "../lib/curlx.h" 2
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2

# 1 "../lib/memdebug.h" 1
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c" 2
...
CURLcode Curl_proxy_connect(struct connectdata *conn)
{
  if(conn->bits.tunnel_proxy && conn->bits.httpproxy) {
    ...
    void *prot_save;
    CURLcode result;
# 69 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/http_proxy.c"
  ...
  do {
    if(TUNNEL_INIT == conn->tunnel_state[sockindex]) {
      ...
      if(CURLE_OK == result) {
        ...
        if(CURLE_OK == result)
          result = Curl_add_custom_headers(conn, 1, req_buffer);
    ...
    check = Curl_timeleft(data, ((void*)0), 1);
    if(check <= 0) {
      Curl_failf(data, "Proxy CONNECT aborted due to timeout");
      return CURLE_RECV_ERROR;
    }

    if(0 == Curl_socket_check(tunnelsocket, -1, -1, 0))
