...

{
  ...
  for(; fcmd != DONE; fcmd++) {
    ...
    if(EPRT == fcmd) {
# 1281 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
static CURLcode ftp_state_use_pasv(struct connectdata *conn)
{
  struct ftp_conn *ftpc = &conn->proto.ftpc;
  CURLcode result = CURLE_OK;
# 1366 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1394 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_state_prepare_transfer(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
  struct FTP *ftp = conn->data->req.protop;
...
static CURLcode ftp_state_list(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
  struct SessionHandle *data = conn->data;
# 1497 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1649 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1884 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
                                    ...
                                    int ftpcode)
{
  ...
  if((ftpc->count1 == 0) &&
    ...
    int ip[4];
    int port[2];
# 1988 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    while(*str) {
...
# 2089 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  if(data->set.verbose)
