...
# 251 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_sasl_decode_ntlm_type2_message(struct SessionHandle *data,
                                             const char *type2msg,
                                             struct ntlmdata *ntlm)
{
  static const char type2_marker[] = { 0x02, 0x00, 0x00, 0x00 };
# 273 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  CURLcode result = CURLE_OK;
  unsigned char *type2 = ((void*)0);
  size_t type2_len = 0;
# 287 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  ...
  do { } while(0);
# 331 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  Curl_cfree(type2);
...
CURLcode Curl_sasl_create_ntlm_type1_message(const char *userp,
                                             ...
                                             char **outptr, size_t *outlen)
{
# 383 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  size_t size;
  ...
  do { } while(0);
# 463 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  return Curl_base64_encode(((void*)0), (char *)ntlmbuf, size, outptr, outlen);
}
# 484 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_sasl_create_ntlm_type3_message(struct SessionHandle *data,
                                             const char *userp,
                                             const char *passwdp,
                                             struct ntlmdata *ntlm,
...
{
# 509 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  CURLcode result = CURLE_OK;
  size_t size;
  unsigned char ntlmbuf[1024];
  int lmrespoff;
  ...
  do { } while(0);
# 796 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
