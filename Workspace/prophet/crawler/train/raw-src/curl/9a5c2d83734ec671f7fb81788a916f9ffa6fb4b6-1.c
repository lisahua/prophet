...
# 1 "../src/tool_version.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_operhlp.c" 2


# 1 "../lib/memdebug.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_operhlp.c" 2
...
char *my_useragent(void)
{
  return (__extension__ (__builtin_constant_p ("curl" "/" "7.32.0-DEV") && ((size_t)(const void *)(("curl" "/" "7.32.0-DEV") + 1) - (size_t)(const void *)("curl" "/" "7.32.0-DEV") == 1) ? (((const char *) ("curl" "/" "7.32.0-DEV"))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen ("curl" "/" "7.32.0-DEV") + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void*)0)) __retval = (char *) memcpy (__retval, "curl" "/" "7.32.0-DEV", __len); __retval; })) : __strdup ("curl" "/" "7.32.0-DEV")));
}
...
# 191 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_operhlp.c"
  return CURLE_OK;
}
...
CURLcode main_init(void)
{
  ...
  return curl_global_init(((1<<0)|(1<<1)));
}
