...
# 164 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    char hexbuffer[11];
...
# 214 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    if((nread - hexlen) == 0)
...
# 230 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  *nreadp = nread;
...
# 335 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
}
                                 ...
                                 int *didwhat)
{
  ...
  *didwhat |= (1<<1);
# 803 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  do {
...
# 1063 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1129 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
int Curl_single_getsock(const struct connectdata *conn,
                        curl_socket_t *sock,
...
# 1206 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                             int pkt_size)
{
...
# 1304 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    Curl_initinfo(data);
...
CURLcode Curl_follow(struct SessionHandle *data,
                     ...
                     followtype type)
{
# 1591 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
...
# 1682 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  ...
  default:
    ...
    break;
  case 301:
# 1711 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    ...
    break;
  case 302:
# 1739 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
    if((data->set.httpreq == HTTPREQ_POST
        || data->set.httpreq == HTTPREQ_POST_FORM)
...
Curl_reconnect_request(struct connectdata **connp)
{
  ...
  *connp = ((void*)0);
# 1809 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
  ...
  )
{
  ...
  if(k->getheader || !data->set.opt_no_body) {
    ...
    if(conn->writesockfd != -1) {
      struct HTTP *http = data->req.protop;
# 1948 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/transfer.c"
