...
# 316 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_core.c"
void Curl_ntlm_core_lm_resp(const unsigned char *keys,
                            const unsigned char *plaintext,
                            unsigned char *results)
{
                                   ...
                                   unsigned char *lmbuffer )
{
...

  {
    ...
    DES_ecb_encrypt((DES_cblock *)magic, (DES_cblock *)(lmbuffer + 8),
                    &ks, 1);
# 429 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_core.c"
...
# 520 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_core.c"
...
# 593 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_core.c"
CURLcode Curl_ntlm_core_mk_ntlmv2_resp(unsigned char *ntlmv2hash,
                                       unsigned char *challenge_client,
                                       struct ntlmdata *ntlm,
                                       unsigned char **ntresp,
                                       unsigned int *ntresp_len)
{
# 614 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_core.c"
  unsigned int len = 0;
...
# 687 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/curl_ntlm_core.c"
CURLcode Curl_ntlm_core_mk_lmv2_resp(unsigned char *ntlmv2hash,
                                      unsigned char *challenge_client,
                                      unsigned char *challenge_server,
                                      unsigned char *lmresp)
