# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
...
Curl_unencode_gzip_write(struct connectdata *conn,
                         ...
                         ssize_t nread);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
# 1 "../lib/non-ascii.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
# 1 "../lib/strtoofft.h" 1
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2


# 1 "../lib/memdebug.h" 1
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c" 2
# 82 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c"
static _Bool Curl_isxdigit(char digit)
{
  return ( (digit >= 0x30 && digit <= 0x39)
        || (digit >= 0x41 && digit <= 0x46)
        || (digit >= 0x61 && digit <= 0x66) ) ? 1 : 0;
}
...
# 108 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/http_chunks.c"
                              ...
                              ssize_t *wrotep)
{
  ...
  *wrote = 0;
  ...
  if(data->set.http_te_skip && !k->ignorebody) {
    result = Curl_client_write(conn, (1<<0), datap, datalen);
    if(result)
  ...
  while(length) {
    ...
    case CHUNK_HEX:
      if(Curl_isxdigit(*datap)) {
        ...
        ch->datasize=strtol(ch->hexbuffer, &endptr, 16);
        if((ch->datasize == 0x7FFFFFFFFFFFFFFFL) && ((*__errno_location ()) == 34))
    ...
    case CHUNK_DATA:
      ...
      switch (conn->data->set.http_ce_skip?
              0 : data->req.auto_decoding) {
      case 0:

        if(!k->ignorebody) {
          if(!data->set.http_te_skip)
            result = Curl_client_write(conn, (1<<0), datap,
                                       piece);
          else
            result = CURLE_OK;
        }
    ...
    case CHUNK_TRAILER:
      if((*datap == 0x0d) || (*datap == 0x0a)) {
        ...
        if(conn->trlPos >= conn->trlMax) {
          ...
          if(conn->trlMax) {
            conn->trlMax *= 2;
            ptr = Curl_crealloc(conn->trailer, conn->trlMax + 3);
          }
          else {
            conn->trlMax=128;
            ptr = Curl_cmalloc(conn->trlMax + 3);
          }
          if(!ptr)
