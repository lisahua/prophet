...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.h"
...
# 150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 180 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
static _Bool rand_enough(void)
{
  return (0 != RAND_status()) ? 1 : 0;
}
# 193 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
static int ossl_seed(struct SessionHandle *data)
{
  char *buf = data->state.buffer;
  int nread=0;
# 207 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  {
...
# 283 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 373 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 730 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
int Curl_ossl_init(void)
{
...
# 758 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 804 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 837 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  if(!e) {
...
# 1121 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  ...
  if(altnames) {
    ...
    for(i=0; (i<numalts) && (matched != 1); i++) {
      ...
      if(check->type == target) {
        ...
        switch(target) {
        case 2:
# 1184 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
    ...
    if(i>=0) {
      ...
      if(tmp) {
        if(ASN1_STRING_type(tmp) == 12) {
          ...
          if(j >= 0) {
            peer_CN = CRYPTO_malloc((int)j+1,"/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c",1249);
            if(peer_CN) {
                          ...
                          struct connectdata *conn)
{
  ...
  txt_len = curl_msnprintf(ssl_buf, sizeof(ssl_buf), "SSLv%c, %s%s (%d):\n",
...
# 1476 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
static const char *
                   ...
                   int sockindex)
{
  ...
  struct in6_addr addr;
# 1525 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  do { } while(0);
...
# 1558 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 1633 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  ...
  case CURL_SSLVERSION_TLSv1_2:
    ...
    ctx_options |= 0x10000000L;
    break;
# 1712 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  default:
...
# 1751 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2044 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
    return CURLE_OK;
  }
}
...
# 2103 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2203 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
static CURLcode pkp_pin_peer_pubkey(X509* cert, const char *pinnedpubkey)
{
  ...
  do {
    ...
    buff1 = temp = CRYPTO_malloc((int)len1,"/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c",2398);
    if(((void*)0) == buff1)
      break;
...
# 2434 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2598 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2631 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  if(!data->set.ssl.verifypeer && !data->set.ssl.verifyhost)
    ...
    retcode = servercert(conn, connssl, 1);
                  ...
                  int sockindex)
{
  ...
  retcode = ossl_connect_common(conn, sockindex, 0, &done);
  if(retcode)
    return retcode;
...
# 2970 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
}
