# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c"
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
...
# 60 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.h"
...
void Curl_ossl_md5sum(unsigned char *tmp,
                      ...
                      size_t unused);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.h" 2
...
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
# 1 "../lib/slist.h" 1
# 30 "../lib/slist.h"
...
struct curl_slist *Curl_slist_append_nodup(struct curl_slist *list,
                                           char *data);
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
# 1 "../lib/url.h" 1
# 30 "../lib/url.h"
...
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
...
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
# 1 "../lib/share.h" 1
# 39 "../lib/share.h"
struct Curl_share {
...
# 69 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
...
# 71 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
...
# 73 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
...
# 76 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2


# 1 "../lib/memdebug.h" 1
# 79 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c" 2
...
static _Bool safe_strequal(char* str1, char* str2)
{
  if(str1 && str2)

    return (0 != Curl_raw_equal(str1, str2)) ? 1 : 0;
  else
                      ...
                      struct ssl_config_data *dest)
{
  ...
  if(source->CAfile) {
    dest->CAfile = Curl_cstrdup(source->CAfile);
    if(!dest->CAfile)
      return 0;
  }
  else
  ...
  if(source->CApath) {
    dest->CApath = Curl_cstrdup(source->CApath);
    if(!dest->CApath)
      return 0;
  }
  else
  ...
  if(source->cipher_list) {
    dest->cipher_list = Curl_cstrdup(source->cipher_list);
    if(!dest->cipher_list)
      return 0;
  }
  else
    dest->cipher_list = ((void*)0);

  if(source->egdsocket) {
    dest->egdsocket = Curl_cstrdup(source->egdsocket);
    if(!dest->egdsocket)
      return 0;
  }
  else
    dest->egdsocket = ((void*)0);

  if(source->random_file) {
    dest->random_file = Curl_cstrdup(source->random_file);
    if(!dest->random_file)
      return 0;
  }
  else
    dest->random_file = ((void*)0);
...
void Curl_free_ssl_config(struct ssl_config_data* sslc)
{
  do {if((sslc->CAfile)) {Curl_cfree((sslc->CAfile)); (sslc->CAfile) = ((void*)0);}} while(0);
  do {if((sslc->CApath)) {Curl_cfree((sslc->CApath)); (sslc->CApath) = ((void*)0);}} while(0);
  do {if((sslc->cipher_list)) {Curl_cfree((sslc->cipher_list)); (sslc->cipher_list) = ((void*)0);}} while(0);
  do {if((sslc->egdsocket)) {Curl_cfree((sslc->egdsocket)); (sslc->egdsocket) = ((void*)0);}} while(0);
  do {if((sslc->random_file)) {Curl_cfree((sslc->random_file)); (sslc->random_file) = ((void*)0);}} while(0);
}
# 186 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c"
unsigned int Curl_rand(struct SessionHandle *data)
{
  unsigned int r = 0;
  static unsigned int randseed;
  static _Bool seeded = 0;
# 209 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c"
...
int Curl_ssl_backend(void)
{
  return (int)CURLSSLBACKEND_OPENSSL;
}




static _Bool init_ssl=0;
...
Curl_ssl_connect(struct connectdata *conn, int sockindex)
{
  ...
  result = Curl_ossl_connect(conn, sockindex);
                             ...
                             _Bool *done)
{
  ...
  result = Curl_ossl_connect_nonblocking(conn, sockindex, done);
                           ...
                           size_t *idsize)
{
  ...
  *ssl_sessionid = ((void*)0);
  ...
  if((data->share && (data->share->specifier & (1<<CURL_LOCK_DATA_SSL_SESSION)))) {
...
void Curl_ssl_kill_session(struct curl_ssl_session *session)
{
  if(session->sessionid) {
    ...
    do {if((session->name)) {Curl_cfree((session->name)); (session->name) = ((void*)0);}} while(0);
  }
}
                               ...
                               size_t idsize)
{
  ...
  clone_host = Curl_cstrdup(conn->host.name);
  if(!clone_host)
  ...
  if(!Curl_clone_ssl_config(&conn->ssl_config, &store->ssl_config)) {
    store->sessionid = ((void*)0);
    Curl_cfree(clone_host);
    return CURLE_OUT_OF_MEMORY;
  }
...
void Curl_ssl_close_all(struct SessionHandle *data)
{
  ...
  if(data->state.session && !(data->share && (data->share->specifier & (1<<CURL_LOCK_DATA_SSL_SESSION)))) {
    for(i = 0; i < data->set.ssl.max_ssl_sessions; i++)

      Curl_ssl_kill_session(&data->state.session[i]);


    do {if((data->state.session)) {Curl_cfree((data->state.session)); (data->state.session) = ((void*)0);}} while(0);
  }
...
CURLcode Curl_ssl_initsessions(struct SessionHandle *data, size_t amount)
{
  ...
  session = Curl_ccalloc(amount, sizeof(struct curl_ssl_session));
  if(!session)
    return CURLE_OUT_OF_MEMORY;
...
# 581 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c"
int Curl_ssl_check_cxn(struct connectdata *conn)
{
...
_Bool Curl_ssl_data_pending(const struct connectdata *conn,
                           int connindex)
{
  return Curl_ossl_data_pending(conn,connindex);
}
...
void Curl_ssl_free_certinfo(struct SessionHandle *data)
{
  ...
  if(ci->num_of_certs) {
    ...
    for(i=0; i<ci->num_of_certs; i++) {
      ...
      ci->certinfo[i] = ((void*)0);
    }

    Curl_cfree(ci->certinfo);
    ci->certinfo = ((void*)0);
    ci->num_of_certs = 0;
  }
}
...
int Curl_ssl_random(struct SessionHandle *data,
                     ...
                     size_t length)
{
  return Curl_ossl_random(data,entropy,length);
}
                                  ...
                                  unsigned char **der, size_t *der_len)
{
  ...
  stripped_pem = Curl_cmalloc(pem_len - pem_count + 1);
  if(!stripped_pem)
    return CURLE_OUT_OF_MEMORY;
  ...
  do {if((stripped_pem)) {Curl_cfree((stripped_pem)); (stripped_pem) = ((void*)0);}} while(0);
...
{
  FILE *fp;
  unsigned char *buf = ((void*)0), *pem_ptr = ((void*)0);
  long filesize;
  size_t size, pem_len;
  CURLcode pem_read;
  ...
  do {if((buf)) {Curl_cfree((buf)); (buf) = ((void*)0);}} while(0);
  do {if((pem_ptr)) {Curl_cfree((pem_ptr)); (pem_ptr) = ((void*)0);}} while(0);
  fclose(fp);
                     ...
                     size_t md5len)
{
  ...
  Curl_ossl_md5sum(tmp,tmplen,md5sum,md5len);
# 849 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/vtls.c"
}
