    ...
    if(i>=0) {
      ...
      if(tmp) {
        if(ASN1_STRING_type(tmp) == 12) {
          ...
          if(j >= 0) {
            peer_CN = CRYPTO_malloc((int)j+1,"/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c",1260);
            if(peer_CN) {
...
# 1370 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c"
  ...
  for(i = 0; i < sk_num(((_STACK*) (1 ? (br->tbsResponseData->responses) : (struct stack_st_OCSP_SINGLERESP*)0))); i++) {
    int cert_status, crl_reason;
    OCSP_SINGLERESP *single = ((void*)0);

    ASN1_GENERALIZEDTIME *rev, *thisupd, *nextupd;

    if(!((OCSP_SINGLERESP *)sk_value(((_STACK*) (1 ? (br->tbsResponseData->responses) : (struct stack_st_OCSP_SINGLERESP*)0)), (i))))
      continue;

    single = ((OCSP_SINGLERESP *)sk_value(((_STACK*) (1 ? (br->tbsResponseData->responses) : (struct stack_st_OCSP_SINGLERESP*)0)), (i)));
...
# 1446 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c"
...
# 1616 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c"
static int
                     ...
                     void *arg)
{
  ...
  (void)ssl;
# 1653 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c"
...
# 1745 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c"
...
# 1820 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c"
  ...
  case CURL_SSLVERSION_TLSv1_2:
    ...
    ctx_options |= 0x10000000L;
    break;
# 1899 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c"
  default:
...
# 1939 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/vtls/openssl.c"
  ...
  if(!ciphers)
    ciphers = (char *)"ALL!EXPORT!EXPORT40!EXPORT56!aNULL!LOW!RC4";
