# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
# 1 "../lib/url.h" 1
# 30 "../lib/url.h"
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
# 1 "../lib/multiif.h" 1
# 28 "../lib/multiif.h"
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
# 1 "../lib/pipeline.h" 1
# 25 "../lib/pipeline.h"
...
CURLMcode Curl_pipeline_set_server_blacklist(char **servers,
                                             struct curl_llist **list_ptr);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
# 1 "../lib/bundles.h" 1
# 25 "../lib/bundles.h"
...
int Curl_bundle_remove_conn(struct connectbundle *cb_ptr,
                            struct connectdata *conn);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2

# 1 "../lib/memdebug.h" 1
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pipeline.c" 2
...
static void site_blacklist_llist_dtor(void *user, void *element)
{
  ...
  do {if((entry->hostname)) {Curl_cfree((entry->hostname)); (entry->hostname) = ((void*)0);}} while(0);
  do {if((entry)) {Curl_cfree((entry)); (entry) = ((void*)0);}} while(0);
}
                             ...
                             struct connectdata *conn)
{
  if(data) {
    ...
    Curl_infof(data, "Conn: %ld (%p) Receive pipe weight: (%"
          "ld" "/%zu), penalized: %s\n",
                                           ...
                                           struct curl_llist **list_ptr)
{
  ...
  struct curl_llist *new_list = ((void*)0);
  ...
  if(sites) {
    ...
    while(*sites) {
      ...
      hostname = Curl_cstrdup(*sites);
      if(!hostname) {
        Curl_llist_destroy(new_list, ((void*)0));
        return CURLM_OUT_OF_MEMORY;
      }

      entry = Curl_cmalloc(sizeof(struct site_blacklist_entry));
      if(!entry) {
        Curl_cfree(hostname);
        Curl_llist_destroy(new_list, ((void*)0));
        return CURLM_OUT_OF_MEMORY;
      ...
      port = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (hostname) && (':') == '\0' ? (char *) __rawmemchr (hostname, ':') : __builtin_strchr (hostname, ':')));
      if(port) {
        *port = '\0';
        port++;
        entry->port = (unsigned short)strtol(port, ((void*)0), 10);
      }
      else {
      ...
      if(!Curl_llist_insert_next(new_list, new_list->tail, entry)) {
        site_blacklist_llist_dtor(((void*)0), entry);
        Curl_llist_destroy(new_list, ((void*)0));
        return CURLM_OUT_OF_MEMORY;
      }
  ...
  if(old_list) {
    Curl_llist_destroy(old_list, ((void*)0));
  }
                                             ...
                                             struct curl_llist **list_ptr)
{
  ...
  if(servers) {
    ...
    while(*servers) {
      ...
      server_name = Curl_cstrdup(*servers);
      if(!server_name)
        return CURLM_OUT_OF_MEMORY;
