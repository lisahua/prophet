# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c" 2
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c" 2
...
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
int Curl_wait_ms(int timeout_ms)
{
  ...
  do {
    ...
    if(error && (Curl_ack_eintr || error != 4))
      break;
...
# 140 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
                      ...
                      long timeout_ms)
{
  ...
  struct pollfd pfd[3];
  int num;
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
  ...
  if(readfd0 != -1) {
    pfd[num].fd = readfd0;
    pfd[num].events = 0x040|0x001|0x080|0x002;
    pfd[num].revents = 0;
    num++;
  }
  if(readfd1 != -1) {
  ...
  do {
    ...
    if(error && (Curl_ack_eintr || error != 4))
      break;
    if(timeout_ms > 0) {
      pending_ms = (int)(timeout_ms - (int)curlx_tvdiff(curlx_tvnow(), initial_tv));
      if(pending_ms <= 0) {
        r = 0;
        break;
      }
  ...
  num = 0;
  if(readfd0 != -1) {
    if(pfd[num].revents & (0x040|0x001|0x008|0x010))
      ret |= 0x01;
    if(pfd[num].revents & (0x080|0x002|0x020))
      ret |= 0x04;
    num++;
  }
  if(readfd1 != -1) {
  ...
  if(writefd != -1) {
    if(pfd[num].revents & (0x100|0x004))
      ret |= 0x02;
    if(pfd[num].revents & (0x008|0x010|0x020))
      ret |= 0x04;
  }

  return ret;
# 365 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
}
# 380 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
int Curl_poll(struct pollfd ufds[], unsigned int nfds, int timeout_ms)
{
# 390 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
  struct timeval initial_tv = {0,0};
  _Bool fds_none = 1;
  unsigned int i;
  int pending_ms = 0;
  ...
  for(i = 0; i < nfds; i++) {
    if(ufds[i].fd == -1)
      continue;
    if(ufds[i].revents & 0x010)
      ufds[i].revents |= 0x001;
    if(ufds[i].revents & 0x008)
      ufds[i].revents |= (0x001|0x004);
  }
# 547 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/select.c"
  return r;
}
