...
# 1836 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/smtp.c"
...
# 1878 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/smtp.c"
...
# 1897 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/smtp.c"
...
# 1948 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/smtp.c"
static CURLcode smtp_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
...
# 1971 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/smtp.c"
...
# 2036 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/smtp.c"
                                       ...
                                       smtpstate *state1, smtpstate *state2)
{
  ...
  struct SessionHandle *data = conn->data;
  struct smtp_conn *smtpc = &conn->proto.smtpc;
# 2244 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/smtp.c"
...
CURLcode Curl_smtp_escape_eob(struct connectdata *conn, const ssize_t nread)
{
  ...
  for(i = 0, si = 0; i < nread; i++) {
    ...
    if(3 == smtp->eob) {
      ...
      memcpy(&scratch[si], "\x0d\x0a\x2e\x2e" + eob_sent,
             4 - eob_sent);
      si += 4 - eob_sent;
      smtp->eob = 0;
      eob_sent = 0;
