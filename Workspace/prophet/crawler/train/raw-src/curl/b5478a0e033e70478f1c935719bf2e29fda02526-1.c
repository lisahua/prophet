# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 26 "../lib/strequal.h" 2
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/urldata.h" 1
# 71 "../lib/urldata.h"
# 1 "../lib/cookie.h" 1
# 28 "../lib/cookie.h"
...
# 60 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                     int pkt_size);
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/sslgen.h" 1
# 30 "../lib/sslgen.h"
...
void Curl_ssl_md5sum(unsigned char *tmp,
                     ...
                     size_t md5len);
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/url.h" 1
# 30 "../lib/url.h"
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/getinfo.h" 1
# 24 "../lib/getinfo.h"
CURLcode Curl_getinfo(struct SessionHandle *data, CURLINFO info, ...);
CURLcode Curl_initinfo(struct SessionHandle *data);
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/strdup.h" 1
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 69 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 70 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/easyif.h" 1
# 28 "../lib/easyif.h"
void Curl_easy_addmulti(struct SessionHandle *data, void *multi);

void Curl_easy_initHandleData(struct SessionHandle *data);
# 71 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/select.h" 1
# 28 "../lib/select.h"
...
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 73 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/curl_ntlm.h" 1
# 30 "../lib/curl_ntlm.h"
...
# 74 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 75 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/slist.h" 1
# 30 "../lib/slist.h"
...
struct curl_slist *Curl_slist_append_nodup(struct curl_slist *list,
                                           char *data);
# 76 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/amigaos.h" 1
# 77 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/non-ascii.h" 1
# 78 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 79 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/conncache.h" 1
# 25 "../lib/conncache.h"
struct conncache {
  struct curl_hash *hash;
...
# 80 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
# 1 "../lib/multiif.h" 1
# 30 "../lib/multiif.h"
...
# 81 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 84 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2


# 1 "../lib/memdebug.h" 1
# 87 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c" 2
...
# 101 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
...
# 140 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
...
{
# 199 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
  return CURLE_OK;
}
# 225 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
static unsigned int initialized;
static long init_flags;
# 250 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
curl_malloc_callback Curl_cmalloc = (curl_malloc_callback)malloc;
curl_free_callback Curl_cfree = (curl_free_callback)free;
curl_realloc_callback Curl_crealloc = (curl_realloc_callback)realloc;
curl_strdup_callback Curl_cstrdup = (curl_strdup_callback)strdup;
curl_calloc_callback Curl_ccalloc = (curl_calloc_callback)calloc;
# 278 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
...
# 322 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
  if(CURLE_OK != CURLE_OK) {
    do { } while(0);
    return CURLE_FAILED_INIT;
  }
# 334 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
  if(flags & (1<<2))
    Curl_ack_eintr = 1;
...
# 470 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
CURLcode curl_easy_perform(CURL *easy)
{
  ...
  if(data->multi) {
    Curl_failf(data, "easy handled already used in multi handle");
    return CURLE_FAILED_INIT;
  }
  ...
  while(!done && !mcode) {
    ...
    before = curlx_tvnow();
    mcode = curl_multi_wait(multi, ((void*)0), 0, 1000, &ret);
...
CURLcode curl_easy_getinfo(CURL *curl, CURLINFO info, ...)
{
  ...
  paramp = __builtin_va_arg(arg, void *);
...
CURL *curl_easy_duphandle(CURL *incurl)
{
  ...
  struct SessionHandle *outcurl = Curl_ccalloc(1, sizeof(struct SessionHandle));
  if(((void*)0) == outcurl)
    goto fail;
  ...
  outcurl->state.headerbuff = Curl_cmalloc(256);
  if(!outcurl->state.headerbuff)
    goto fail;
  outcurl->state.headersize = 256;
  ...
  if(data->change.url) {
    outcurl->change.url = Curl_cstrdup(data->change.url);
    if(!outcurl->change.url)
      goto fail;
    outcurl->change.url_alloc = 1;
  }

  if(data->change.referer) {
    outcurl->change.referer = Curl_cstrdup(data->change.referer);
    if(!outcurl->change.referer)
      goto fail;
    outcurl->change.referer_alloc = 1;
  }
  ...
  if(outcurl) {
    ...
    do {if((outcurl->state.headerbuff)) {Curl_cfree((outcurl->state.headerbuff)); (outcurl->state.headerbuff) = ((void*)0);}} while(0);
    do {if((outcurl->change.url)) {Curl_cfree((outcurl->change.url)); (outcurl->change.url) = ((void*)0);}} while(0);
    do {if((outcurl->change.referer)) {Curl_cfree((outcurl->change.referer)); (outcurl->change.referer) = ((void*)0);}} while(0);
...
# 768 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
CURLcode curl_easy_pause(CURL *curl, int action)
{
  ...
  int newstate = k->keepon &~ ((1<<4)| (1<<5));


  newstate |= ((action & (1<<0))?(1<<4):0) |
    ((action & (1<<2))?(1<<5):0);


  k->keepon = newstate;

  if(!(newstate & (1<<4)) && data->state.tempwrite) {
...
# 812 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/easy.c"
    do {
      chunklen = (tempsize > 16384)?16384:tempsize;
      ...
      if(data->state.tempwrite && (tempsize - chunklen)) {
        ...
        newptr = Curl_crealloc(data->state.tempwrite, tempsize);
