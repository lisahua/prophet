...
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/select.c"
  ...
  return ret;
# 365 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/select.c"
}
# 380 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/select.c"
int Curl_poll(struct pollfd ufds[], unsigned int nfds, int timeout_ms)
{
# 390 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/select.c"
  struct timeval initial_tv = {0,0};
  _Bool fds_none = 1;
  unsigned int i;
  int pending_ms = 0;
...
# 547 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/select.c"
  return r;
}
