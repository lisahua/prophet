...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c" 2
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c" 2
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
...
# 60 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c" 2
# 1 "../lib/urldata.h" 1
# 69 "../lib/urldata.h"
# 1 "../lib/cookie.h" 1
# 28 "../lib/cookie.h"
...
CURLcode Curl_pp_statemach(struct pingpong *pp, _Bool wait);
...
# 61 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c" 2
# 1 "../lib/if2ip.h" 1
# 26 "../lib/if2ip.h"
...
void Curl_ssl_md5sum(unsigned char *tmp,
                     ...
                     size_t md5len);
# 74 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
# 88 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c" 2
...
# 223 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
                           ...
                           int *resp)
{
  ...
  if(pop3c->state == POP3_SERVERGREET) {
    ...
    if(len >= 4 && !memcmp(line, "STLS", 4))
      ...
      pop3c->authtypes |= 0x0001;


    else if(len >= 4 && !memcmp(line, "APOP", 4))
      pop3c->authtypes |= 0x0002;


    else if(len >= 5 && !memcmp(line, "SASL ", 5)) {
      pop3c->authtypes |= 0x0004;
      ...
      for(;;) {
        ...
        if(wordlen == 5 && !memcmp(line, "LOGIN", 5))
          pop3c->authmechs |= 0x0001;
        else if(wordlen == 5 && !memcmp(line, "PLAIN", 5))
          pop3c->authmechs |= 0x0002;
        else if(wordlen == 8 && !memcmp(line, "CRAM-MD5", 8))
          pop3c->authmechs |= 0x0004;
        else if(wordlen == 10 && !memcmp(line, "DIGEST-MD5", 10))
          pop3c->authmechs |= 0x0008;
        else if(wordlen == 6 && !memcmp(line, "GSSAPI", 6))
          pop3c->authmechs |= 0x0010;
        else if(wordlen == 8 && !memcmp(line, "EXTERNAL", 8))
          pop3c->authmechs |= 0x0020;
        else if(wordlen == 4 && !memcmp(line, "NTLM", 4))
          pop3c->authmechs |= 0x0040;
...
{
  struct pop3_conn *pop3c = &conn->proto.pop3c;
# 377 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
...
static CURLcode pop3_authenticate(struct connectdata *conn)
{
  ...
  if(pop3c->authtypes & 0x0004) {

    if(pop3c->authmechs & 0x0008) {
      mech = "DIGEST-MD5";
      authstate = POP3_AUTH_DIGESTMD5;
      pop3c->authused = 0x0008;
    }
    else if(pop3c->authmechs & 0x0004) {
      mech = "CRAM-MD5";
      authstate = POP3_AUTH_CRAMMD5;
      pop3c->authused = 0x0004;
    }
    else


    if(pop3c->authmechs & 0x0040) {
      mech = "NTLM";
      authstate = POP3_AUTH_NTLM;
      pop3c->authused = 0x0040;
    }
    else

    if(pop3c->authmechs & 0x0001) {
      mech = "LOGIN";
      authstate = POP3_AUTH_LOGIN;
      pop3c->authused = 0x0001;
    }
    else if(pop3c->authmechs & 0x0002) {
      mech = "PLAIN";
      authstate = POP3_AUTH_PLAIN;
      pop3c->authused = 0x0002;
    }
  }
  ...
  else if(pop3c->authtypes & 0x0002)

    result = pop3_state_apop(conn);

  else if(pop3c->authtypes & 0x0001)
                                        ...
                                        pop3state instate)
{
  ...
  Curl_setup_transfer(conn, 0, -1, 0, pop3->bytecountp,
                      -1, ((void*)0));
...
static CURLcode pop3_init(struct connectdata *conn)
{
  ...
  if(!pop3) {
    pop3 = data->state.proto.pop3 = Curl_ccalloc(sizeof(struct FTP), 1);
    if(!pop3)
      return CURLE_OUT_OF_MEMORY;
  }
...
# 1332 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
static CURLcode pop3_connect(struct connectdata *conn, _Bool *done)
{
  CURLcode result;
  struct pop3_conn *pop3c = &conn->proto.pop3c;
...
# 1378 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
static CURLcode pop3_done(struct connectdata *conn, CURLcode status,
                          _Bool premature)
{
  struct SessionHandle *data = conn->data;
  ...
  do {if((pop3c->mailbox)) {Curl_cfree((pop3c->mailbox)); (pop3c->mailbox) = ((void*)0);}} while(0);
  do {if((pop3c->custom)) {Curl_cfree((pop3c->custom)); (pop3c->custom) = ((void*)0);}} while(0);
...
# 1418 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
...
# 1459 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
static CURLcode pop3_do(struct connectdata *conn, _Bool *done)
{
...
# 1499 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
static CURLcode pop3_quit(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;

  result = Curl_pp_sendf(&conn->proto.pop3c.pp, "QUIT", ((void*)0));
  if(result)
    return result;
...
# 1521 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
...
static CURLcode pop3_parse_url_path(struct connectdata *conn)
{
  ...
  return Curl_urldecode(data, path, 0, &pop3c->mailbox, ((void*)0), 1);
}
...
static CURLcode pop3_parse_custom_request(struct connectdata *conn)
{
  ...
  if(custom)
    result = Curl_urldecode(data, custom, 0, &pop3c->custom, ((void*)0), 1);
...
# 1619 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/pop3.c"
