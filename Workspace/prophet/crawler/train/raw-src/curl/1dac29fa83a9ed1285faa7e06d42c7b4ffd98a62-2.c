...
static CURLcode imap_fetch(struct connectdata *conn)
{
  ...
  if(result)
    return result;
# 1122 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/imap.c"
                                      ...
                                      imapstate instate)
{
  ...
  if(*ptr == '{') {
    curl_off_t filesize = strtol(ptr + 1, ((void*)0), 10);
    if(filesize)
    ...
    if(!filesize)
      ...
      Curl_setup_transfer(conn, 0, filesize, 0,
                          imap->bytecountp, -1, ((void*)0));
...
static CURLcode imap_init(struct connectdata *conn)
{
  ...
  if(!imap) {
    imap = data->state.proto.imap = Curl_ccalloc(sizeof(struct FTP), 1);
    if(!imap)
      return CURLE_OUT_OF_MEMORY;
  }
...
# 1405 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/imap.c"
static CURLcode imap_connect(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
  struct imap_conn *imapc = &conn->proto.imapc;
...
# 1454 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/imap.c"
static CURLcode imap_done(struct connectdata *conn, CURLcode status,
                          _Bool premature)
{
  CURLcode result = CURLE_OK;
...
# 1489 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/imap.c"
...
# 1530 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/imap.c"
static CURLcode imap_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
...
# 1588 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/imap.c"
...
# 1620 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/imap.c"
static CURLcode imap_parse_url_path(struct connectdata *conn)
{
  ...
  return Curl_urldecode(data, path, 0, &imapc->mailbox, ((void*)0), 1);
}
...
# 1675 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/imap.c"
