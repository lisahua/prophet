...
static CURLcode ftp_dophase_done(struct connectdata *conn,
                                 _Bool connected);
# 172 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 287 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 327 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 384 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 422 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 493 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 544 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 598 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 646 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 675 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  ...
  *nreadp=0;
  ...
  while(!*ftpcode && !result) {
    ...
    if(timeout < interval_ms)
      interval_ms = timeout;
# 732 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
{
# 826 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  struct ftp_conn *ftpc = &conn->proto.ftpc;
...
static CURLcode ftp_state_pwd(struct connectdata *conn)
{
  ...
  if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"%s","PWD")) != CURLE_OK) return result;
  _state(conn,FTP_PWD);
                              ...
                              int numsocks)
{
  ...
  if(!numsocks)
    return 0;
# 889 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  switch(ftpc->state) {
  case FTP_STOP:
  case FTP_STOR:
    break;
...

{
  ...
  for(; fcmd != DONE; fcmd++) {
    ...
    if(EPRT == fcmd) {
# 1271 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1332 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
static CURLcode ftp_state_use_pasv(struct connectdata *conn)
{
  struct ftp_conn *ftpc = &conn->proto.ftpc;
  CURLcode result = CURLE_OK;
# 1356 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1384 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_state_prepare_transfer(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
  struct FTP *ftp = conn->data->req.protop;
...
static CURLcode ftp_state_list(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
  struct SessionHandle *data = conn->data;
# 1487 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 1639 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
static CURLcode ftp_epsv_disable(struct connectdata *conn)
{
  ...
  if((result = Curl_pp_sendf(&conn->proto.ftpc.pp,"%s","PASV")) != CURLE_OK) return result;
                                    ...
                                    int ftpcode)
{
  ...
  if((ftpc->count1 == 0) &&
    ...
    int ip[4];
    int port[2];
# 1906 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    while(*str) {
...
# 2477 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    curl_off_t size=-1;
# 2489 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    if((instate != FTP_LIST) &&
...
{
  CURLcode result = CURLE_OK;
# 2592 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  if(conn->ssl[0].use) {
# 2607 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 2779 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    ...
    case FTP_PROT:
      ...
      if(data->set.ftp_ccc) {
        ...
        if((result = Curl_pp_sendf(&ftpc->pp,"%s","CCC")) != CURLE_OK) return result;
        _state(conn,FTP_CCC);
      }
      else {
        result = ftp_state_pwd(conn);
    ...
    case FTP_PWD:
      if(ftpcode == 257) {
        ...
        if(!dir)
          return CURLE_OUT_OF_MEMORY;
# 2883 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 2921 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 3171 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 3454 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
...
# 3520 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_nb_type(struct connectdata *conn,
                            _Bool ascii, ftpstate newstate)
{
  struct ftp_conn *ftpc = &conn->proto.ftpc;
...
# 3550 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static void
...
# 3627 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
...
# 3772 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
...
# 4038 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_do(struct connectdata *conn, _Bool *done)
{
...
# 4135 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_quit(struct connectdata *conn)
{
  CURLcode result = CURLE_OK;
...
# 4165 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static CURLcode ftp_disconnect(struct connectdata *conn, _Bool dead_connection)
{
  struct ftp_conn *ftpc= &conn->proto.ftpc;
  struct pingpong *pp = &ftpc->pp;
# 4177 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
  if(dead_connection)
    ftpc->ctl_valid = 0;
...
# 4218 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
CURLcode ftp_parse_url_path(struct connectdata *conn)
{
  ...
  case FTPFILE_NOCWD:
# 4247 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
    if(data->state.path &&
       data->state.path[0] &&
...
# 4470 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/ftp.c"
static
...
static CURLcode ftp_setup_connection(struct connectdata *conn)
{
  ...
  conn->data->req.protop = ftp = Curl_cmalloc(sizeof(struct FTP));
  if(((void*)0) == ftp)
    return CURLE_OUT_OF_MEMORY;
