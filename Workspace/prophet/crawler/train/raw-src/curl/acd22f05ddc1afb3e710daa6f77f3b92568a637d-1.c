...
{
  struct imap_conn *imapc = &conn->proto.imapc;
# 474 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
...
static CURLcode imap_fetch(struct connectdata *conn)
{
  ...
  if(result)
    return result;
# 706 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
...
# 1473 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
static CURLcode imap_connect(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
  struct imap_conn *imapc = &conn->proto.imapc;
...
# 1522 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
static CURLcode imap_done(struct connectdata *conn, CURLcode status,
                          _Bool premature)
{
  CURLcode result = CURLE_OK;
...
# 1603 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
static CURLcode imap_do(struct connectdata *conn, _Bool *done)
{
  CURLcode result = CURLE_OK;
...
# 1689 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
...
# 1871 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/imap.c"
