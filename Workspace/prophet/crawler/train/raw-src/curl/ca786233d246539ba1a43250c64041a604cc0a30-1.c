# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c" 2
...
# 59 "../lib/curlx.h" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c" 2
# 1 "../src/tool_util.h" 1
# 26 "../src/tool_util.h"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c" 2

# 1 "../lib/memdebug.h" 1
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c" 2
                     ...
                     double ultotal, double ulnow)
{
  ...
  int barwidth;
  int num;
  struct timeval now = tool_tvnow();
  struct ProgressData *bar = (struct ProgressData *)clientp;
  curl_off_t total;
  curl_off_t point;

  if(tool_tvdiff((now), (bar->prevtime)) < 200L)
    return 0;
                     ...
                     struct Configurable *config)
{
  ...
  if(colp) {
    ...
    bar->width = 79;
# 147 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/src/tool_cb_prg.c"
