...
# 196 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_ntlm_decode_type2_message(struct SessionHandle *data,
                                        const char* header,
                                        struct ntlmdata* ntlm)
{
...
# 220 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  size_t size = 0;
...
# 246 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  ntlm->flags = 0;
  ...
  do { } while(0);
# 269 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  Curl_cfree(buffer);

  return CURLE_OK;
}
# 295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
...
# 324 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_ntlm_create_type1_message(const char *userp,
                                        const char *passwdp,
                                        struct ntlmdata *ntlm,
                                        char **outptr,
                                        size_t *outlen)
{
# 344 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  unsigned char ntlmbuf[1024];
  size_t size;
# 474 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  const char *host = "";
  const char *domain = "";
  size_t hostlen = 0;
  size_t domlen = 0;
  ...
  do { } while(0);
# 551 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  return Curl_base64_encode(((void*)0), (char *)ntlmbuf, size, outptr, outlen);
}
# 573 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
CURLcode Curl_ntlm_create_type3_message(struct SessionHandle *data,
                                        const char *userp,
                                        const char *passwdp,
                                        struct ntlmdata *ntlm,
...
# 598 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  unsigned char ntlmbuf[1024];
  size_t size;
# 645 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
  int lmrespoff;
  ...
  do { } while(0);
# 880 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/curl_ntlm_msgs.c"
