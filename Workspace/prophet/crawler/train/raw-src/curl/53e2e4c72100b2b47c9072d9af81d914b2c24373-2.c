...
)
{
  ...
  data->mstate = state;
# 143 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  if(state == CURLM_STATE_COMPLETED)

    data->multi->num_alive--;
}
# 158 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 259 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                                ...
                                CURL *easy_handle)
{
  ...
  if(!timeoutlist)
    return CURLM_OUT_OF_MEMORY;
# 391 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  ...
  multi->num_alive++;
# 467 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  memset(&multi->timer_lastcall, 0, sizeof(multi->timer_lastcall));

  update_timer(multi);
  return CURLM_OK;
}
# 489 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
                         ...
                         int numsocks)
{
  ...
  switch(data->mstate) {
  default:
# 706 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    return 0;
...
# 1265 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 1470 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
    {
      ...
      if(result) {
# 1564 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    ...
    if(data->mstate < CURLM_STATE_COMPLETED) {
      if(result) {
# 1714 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1830 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  do {
...
# 1939 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 2128 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_multi_closed(struct connectdata *conn, curl_socket_t s)
{
...
# 2163 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2551 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode
...
# 2599 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_expire(struct SessionHandle *data, long milli)
{
...
# 2693 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_expire_latest(struct SessionHandle *data, long milli)
{
