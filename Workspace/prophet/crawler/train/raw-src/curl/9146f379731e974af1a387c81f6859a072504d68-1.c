# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c" 2
# 76 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
...
# 77 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c" 2
...
# 80 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c" 2
...
# 83 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c" 2
# 1 "../lib/rawstr.h" 1
# 35 "../lib/rawstr.h"
...
# 84 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c" 2
# 1 "../lib/warnless.h" 1
# 29 "../lib/warnless.h"
...
# 85 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c" 2
# 1 "../lib/parsedate.h" 1
# 25 "../lib/parsedate.h"
...
# 86 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c" 2
...
# 112 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
static int parsedate(const char *date, time_t *output);
# 122 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
...
static void skip(const char **date)
{
  ...
  while(**date && !(((*__ctype_b_loc ())[(int) (((int) ((unsigned char)**date)))] & (unsigned short int) _ISalnum)))
    (*date)++;
}
...
# 331 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
static int parsedate(const char *date, time_t *output)
{
  time_t t = 0;
  int wdaynum=-1;
  ...
  while(*date && (part < 6)) {
    ...
    if((((*__ctype_b_loc ())[(int) (((int) ((unsigned char)*date)))] & (unsigned short int) _ISalpha))) {
    ...
    else if((((*__ctype_b_loc ())[(int) (((int) ((unsigned char)*date)))] & (unsigned short int) _ISdigit))) {
      ...
      if((secnum == -1) &&
        ...
        if((lval > (long)2147483647) || (lval < (long)(-2147483647 -1)))
          return -1;
        ...
        if((tzoff == -1) &&
           ...
           (indate< date) &&
           ((date[-1] == '+' || date[-1] == '-'))) {
# 433 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
          found = 1;
  ...
  if((-1 == mdaynum) ||
    ...
    return -1;
# 500 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
  if(yearnum < 1970) {
    *output = 0;
    return 2;
  }
...
# 523 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
  t = my_timegm(&tm);
  ...
  if(-1 != (int)t) {
    ...
    if((delta>0) && (t > 9223372036854775807L - delta))
      return -1;
...
# 567 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/parsedate.c"
CURLcode Curl_gmtime(time_t intime, struct tm *store)
{
  const struct tm *tm;
