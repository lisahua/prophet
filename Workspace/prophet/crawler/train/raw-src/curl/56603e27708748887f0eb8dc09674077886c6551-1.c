# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c"
# 1 "../lib/smb.h" 1
# 25 "../lib/smb.h"
enum smb_conn_state {
  SMB_NOT_CONNECTED = 0,
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 1 "../lib/urldata.h" 1
# 82 "../lib/urldata.h"
# 1 "../lib/cookie.h" 1
# 26 "../lib/cookie.h"
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 1 "../lib/sendf.h" 1
# 27 "../lib/sendf.h"
...
int Curl_debug(struct SessionHandle *handle, curl_infotype type,
               ...
               struct connectdata *conn);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 1 "../lib/multiif.h" 1
# 28 "../lib/multiif.h"
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 1 "../lib/connect.h" 1
# 26 "../lib/connect.h"
# 1 "../lib/nonblock.h" 1
# 27 "../lib/nonblock.h"
...
CURLcode Curl_socket(struct connectdata *conn,
                     ...
                     curl_socket_t *sockfd);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 1 "../lib/progress.h" 1
# 28 "../lib/progress.h"
typedef enum {
  TIMER_NONE,
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 1 "../lib/transfer.h" 1
# 25 "../lib/transfer.h"
...
long Curl_sleep_time(curl_off_t rate_bps, curl_off_t cur_rate_bps,
                     int pkt_size);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 1 "../lib/vtls/vtls.h" 1
# 26 "../lib/vtls/vtls.h"
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
# 1 "../lib/escape.h" 1
# 27 "../lib/escape.h"
CURLcode Curl_urldecode(struct SessionHandle *data,
                        ...
                        _Bool reject_crlf);
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2


# 1 "../lib/memdebug.h" 1
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c" 2
...
# 159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c"
enum smb_req_state {
  SMB_REQUESTING,
  SMB_TREE_CONNECT,
  SMB_OPEN,
...
# 199 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c"
  smb->state = newstate;
}
...
# 225 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/smb.c"
  req->state = newstate;
}
                         ...
                         size_t upload_size)
{
  ...
  result = Curl_write(conn, 0, conn->data->state.uploadbuffer,
                      len, &bytes_written);
  if(result)
    return result;
...
static CURLcode smb_send_write(struct connectdata *conn)
{
  ...
  if(upload_size >= 0x8000 - 1)
    upload_size = 0x8000 - 1;
  ...
  msg->offset = ((unsigned int) offset);
  msg->offset_high = ((unsigned int) (offset >> 32));
  msg->data_length = ((unsigned short) upload_size);
  msg->data_offset = (sizeof(*msg) - sizeof(unsigned int));
  msg->byte_count = ((unsigned short) upload_size + 1);
...
static CURLcode smb_send_and_recv(struct connectdata *conn, void **msg)
{
  ...
  if(!smbc->send_size && smbc->upload_size) {
    int nread = smbc->upload_size > 16384 ? 16384 :
