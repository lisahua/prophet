...
# 74 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c" 2
...
# 75 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c" 2
# 1 "../lib/non-ascii.h" 1
...
# 152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 182 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
static _Bool rand_enough(void)
{
  return (0 != RAND_status()) ? 1 : 0;
}
# 195 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
static int ossl_seed(struct SessionHandle *data)
{
  char *buf = data->state.buffer;
  int nread=0;
# 209 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  {
...
# 285 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
static int ssl_ui_writer(UI *ui, UI_STRING *uis)
{
  ...
  case UIT_PROMPT:
  case UIT_VERIFY:
    if(((void*)0) != UI_get0_user_data(ui) &&
       UI_get_input_flags(uis) & 0x02) {
      return 1;
    }
  default:
               ...
               const char *key_type)
{
  ...
  if(cert_file != ((void*)0) || file_type == 42) {
    SSL *ssl;
    X509 *x509;
    int cert_done = 0;

    if(data->set.str[STRING_KEY_PASSWD]) {
# 375 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 732 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
int Curl_ossl_init(void)
{
...
# 760 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  (void)CONF_modules_load_file(((void*)0), ((void*)0),
                               0x20|
                               0x10);
...
# 806 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 839 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  if(!e) {
...
# 1123 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  ...
  if(altnames) {
    ...
    for(i=0; (i<numalts) && (matched != 1); i++) {
      ...
      if(check->type == target) {
        ...
        switch(target) {
        case 2:
# 1185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
    ...
    if(i>=0) {
      ...
      if(tmp) {
        if(ASN1_STRING_type(tmp) == 12) {
          ...
          if(j >= 0) {
            peer_CN = CRYPTO_malloc((int)j+1,"/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c",1250);
            if(peer_CN) {
...
# 1514 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
static const char *
...
static CURLcode ossl_connect_step1(struct connectdata *conn, int sockindex)
{
  ...
  struct in6_addr addr;
# 1560 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  do { } while(0);
...
# 1593 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 1668 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 1787 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2082 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
    return CURLE_OK;
  }
}
...
# 2141 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2241 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  ...
  for(i=0; i<numcerts; i++) {
    ...
    if(!pubkey)
      ...
      case 6:
        ...
        do { if(pubkey->pkey.rsa->n != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.rsa->n)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.rsa->n, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "rsa", "n", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.rsa->e != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.rsa->e)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.rsa->e, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "rsa", "e", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.rsa->d != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.rsa->d)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.rsa->d, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "rsa", "d", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.rsa->p != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.rsa->p)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.rsa->p, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "rsa", "p", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.rsa->q != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.rsa->q)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.rsa->q, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "rsa", "q", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.rsa->dmp1 != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.rsa->dmp1)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.rsa->dmp1, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "rsa", "dmp1", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.rsa->dmq1 != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.rsa->dmq1)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.rsa->dmq1, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "rsa", "dmq1", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.rsa->iqmp != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.rsa->iqmp)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.rsa->iqmp, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "rsa", "iqmp", (unsigned char*)bufp, len); } } } while(0);
        break;
      case 116:
        do { if(pubkey->pkey.dsa->p != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dsa->p)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dsa->p, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dsa", "p", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.dsa->q != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dsa->q)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dsa->q, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dsa", "q", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.dsa->g != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dsa->g)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dsa->g, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dsa", "g", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.dsa->priv_key != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dsa->priv_key)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dsa->priv_key, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dsa", "priv_key", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.dsa->pub_key != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dsa->pub_key)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dsa->pub_key, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dsa", "pub_key", (unsigned char*)bufp, len); } } } while(0);
        break;
      case 28:
        do { if(pubkey->pkey.dh->p != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dh->p)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dh->p, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dh", "p", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.dh->g != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dh->g)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dh->g, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dh", "g", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.dh->priv_key != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dh->priv_key)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dh->priv_key, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dh", "priv_key", (unsigned char*)bufp, len); } } } while(0);
        do { if(pubkey->pkey.dh->pub_key != ((void*)0)) { int len = ((BN_num_bits(pubkey->pkey.dh->pub_key)+7)/8); if(len < 8192) { BN_bn2bin(pubkey->pkey.dh->pub_key, (unsigned char*)bufp); bufp[len] = 0; pubkey_show(data, i, "dh", "pub_key", (unsigned char*)bufp, len); } } } while(0);
        break;
...
static CURLcode pkp_pin_peer_pubkey(X509* cert, const char *pinnedpubkey)
{
  ...
  do {
    ...
    buff1 = temp = CRYPTO_malloc((int)len1,"/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c",2436);
    if(((void*)0) == buff1)
      break;
    ...
    if(len1 != len2 || temp == ((void*)0) || ((temp - buff1) != len1))
      break;
...
# 2472 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2639 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
...
# 2673 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
  if(!data->set.ssl.verifypeer && !data->set.ssl.verifyhost)
    (void)servercert(conn, connssl, 0);
  else
    result = servercert(conn, connssl, 1);
...
# 3008 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/vtls/openssl.c"
}
