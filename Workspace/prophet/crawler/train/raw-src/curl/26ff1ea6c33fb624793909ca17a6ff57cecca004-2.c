...
# 1211 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 1408 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
      break;
    ...
    case CURLM_STATE_PERFORM:
      ...
      if(data->result) {
# 1502 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
    ...
    if(data->mstate < CURLM_STATE_COMPLETED) {
      if(CURLE_OK != data->result) {
# 1641 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
        data->state.pipe_broke = 0;
...
# 1752 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  do {
...
# 1865 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
...
# 2054 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
void Curl_multi_closed(struct connectdata *conn, curl_socket_t s)
{
...
# 2089 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
static CURLMcode add_next_timeout(struct timeval now,
                                  struct Curl_multi *multi,
                                  struct SessionHandle *d)
{
...
# 2237 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/lib/multi.c"
  now.tv_usec += 3000;
