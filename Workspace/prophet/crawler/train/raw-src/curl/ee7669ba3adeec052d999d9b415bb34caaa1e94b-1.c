# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
extern int bindresvport6 (int __sockfd, struct sockaddr_in6 *__sock_in)
     __attribute__ ((__nothrow__ ));
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2


# 1 "/usr/include/stropts.h" 1 3 4
# 23 "/usr/include/stropts.h" 3 4
# 1 "/usr/include/x86_64-linux-gnu/bits/xtitypes.h" 1 3 4
# 29 "/usr/include/x86_64-linux-gnu/bits/xtitypes.h" 3 4
typedef int __t_scalar_t;
typedef unsigned int __t_uscalar_t;
# 24 "/usr/include/stropts.h" 2 3 4
# 35 "/usr/include/stropts.h" 3 4
...
extern int fattach (int __fildes, const char *__path) __attribute__ ((__nothrow__ ));


extern int fdetach (const char *__path) __attribute__ ((__nothrow__ ));
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
# 1 "../lib/strequal.h" 1
# 25 "../lib/strequal.h"
...
# 26 "../lib/strequal.h" 2
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
# 1 "../lib/if2ip.h" 1
# 26 "../lib/if2ip.h"
...
# 56 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
# 61 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2

# 1 "../lib/memdebug.h" 1
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/lib/if2ip.c" 2
...
_Bool Curl_if_is_interface_name(const char *interf)
{
  ...
  if(getifaddrs(&head) >= 0) {
    for(iface=head; iface != ((void*)0); iface=iface->ifa_next) {
      ...
      if(iface->ifa_addr != ((void*)0)) {
        if(iface->ifa_addr->sa_family == af) {
          if(curl_strequal(iface->ifa_name, interf)) {
            ...
            res = IF2IP_FOUND;
            ip = (char *) inet_ntop(af,addr,ipstr,(curl_socklen_t)sizeof(ipstr));
