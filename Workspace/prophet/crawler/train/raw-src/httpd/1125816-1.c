# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c" 2
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c"
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c" 2
# 1 "/usr/include/pcre.h" 1 3 4
# 276 "/usr/include/pcre.h" 3 4
struct real_pcre;
...
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c" 2
...
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c" 2
...
addlength = (preg != ((void*)0) && (int)preg->re_erroffset != -1)?
...
# 101 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c"
void ap_regfree(ap_regex_t *preg)
{
(pcre_free)(preg->re_pcre);
}
# 123 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c"
...
if ((cflags & 0x01) != 0) options |= 0x00000001;
if ((cflags & 0x02) != 0) options |= 0x00000002;
if ((cflags & 0x40) != 0) options |= 0x00000004;

preg->re_pcre = pcre_compile(pattern, options, &errorptr, &erroffset, ((void*)0));
preg->re_erroffset = erroffset;

if (preg->re_pcre == ((void*)0)) return AP_REG_INVARG;

preg->re_nsub = pcre_info((const pcre *)preg->re_pcre, ((void*)0), ((void*)0));
return 0;
}
# 155 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/util_pcre.c"
int ap_regexec(const ap_regex_t *preg, const char *string,
...
int options = 0;
int *ovector = ((void*)0);
int small_ovector[(10) * 3];
int allocated_ovector = 0;

if ((eflags & 0x04) != 0) options |= 0x00000080;
if ((eflags & 0x08) != 0) options |= 0x00000100;
...
if (nmatch > 0)
  ...
  if (nmatch <= (10))
    ...
    if (ovector == ((void*)0)) return AP_REG_ESPACE;
    allocated_ovector = 1;
    }
  }

rc = pcre_exec((const pcre *)preg->re_pcre, ((void*)0), buff, (int)len,
...
if (rc >= 0)
  ...
  switch(rc)
    {
    case (-1): return AP_REG_NOMATCH;
    case (-2): return AP_REG_INVARG;
    case (-3): return AP_REG_INVARG;
    case (-4): return AP_REG_INVARG;
    case (-5): return AP_REG_ASSERT;
    case (-6): return AP_REG_ESPACE;

    case (-8): return AP_REG_ESPACE;


    case (-10): return AP_REG_INVARG;


    case (-11): return AP_REG_INVARG;
