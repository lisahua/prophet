# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
# 1 "./ssl_private.h" 1
# 30 "./ssl_private.h"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c" 2
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
...
X509 *SSL_read_X509(char* filename, X509 **x509, pem_password_cb *cb)
{
    ...
    if ((bioS=BIO_new_file(filename, "r")) == ((void*)0))
        return ((void*)0);
    rc = PEM_read_bio_X509 (bioS, x509, cb, ((void*)0));
    BIO_free(bioS);
    ...
    if (rc == ((void*)0)) {
        ...
        if ((bioF = BIO_new(BIO_f_base64())) == ((void*)0)) {
            BIO_free(bioS);
            return ((void*)0);
        }
        bioS = BIO_push(bioF, bioS);
        rc = d2i_X509_bio(bioS, ((void*)0));
        BIO_free_all(bioS);
...
EVP_PKEY *SSL_read_PrivateKey(char* filename, EVP_PKEY **key, pem_password_cb *cb, void *s)
{
    ...
    if (rc == ((void*)0)) {
        ...
        bioS = BIO_push(bioF, bioS);
        rc = d2i_PrivateKey_bio(bioS, ((void*)0));
        BIO_free_all(bioS);
...
int SSL_smart_shutdown(SSL *ssl)
{
    int i;
    int rc;
# 177 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
    rc = 0;
    for (i = 0; i < 4 ; i++) {
...
# 192 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
unsigned int SSL_X509_isSGC(X509 *cert)
{
    int ext_nid;
    ...
    is_sgc = 0;
    sk = X509_get_ext_d2i(cert, 126, ((void*)0), ((void*)0));
    if (sk) {
        for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_OBJECT*)0))); i++) {
            ext_nid = OBJ_obj2nid(((ASN1_OBJECT *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_OBJECT*)0)), (i))));
            if (ext_nid == 137 || ext_nid == 139) {
                is_sgc = (!0);
                break;
            }
        }
...
unsigned int SSL_X509_getBC(X509 *cert, int *ca, int *pathlen)
{
    BASIC_CONSTRAINTS *bc;
    BIGNUM *bn = ((void*)0);
    char *cp;

    bc = X509_get_ext_d2i(cert, 87, ((void*)0), ((void*)0));
    if (bc == ((void*)0))
        return 0;
    *ca = bc->ca;
    *pathlen = -1 ;
    if (bc->pathlen != ((void*)0)) {
        if ((bn = ASN1_INTEGER_to_BN(bc->pathlen, ((void*)0))) == ((void*)0))
            return 0;
        if ((cp = BN_bn2dec(bn)) == ((void*)0))
            return 0;
        *pathlen = atoi(cp);
        free(cp);
        BN_free(bn);
...
char *SSL_X509_NAME_ENTRY_to_string(apr_pool_t *p, X509_NAME_ENTRY *xsne)
{
    ...
    ASN1_STRING_print_ex(bio, X509_NAME_ENTRY_get_data(xsne),
                         2|0x10);
    len = (int)BIO_ctrl(bio,10,0,((void*)0));
...
char *SSL_X509_NAME_to_string(apr_pool_t *p, X509_NAME *dn, int maxlen)
{
    ...
    if ((bio = BIO_new(BIO_s_mem())) == ((void*)0))
        return ((void*)0);
    X509_NAME_print_ex(bio, dn, 0, ((1 | 2 | 4 | 0x10 | 0x100 | 0x200) | (1 << 16) | (1 << 20) | 0 | (1 << 24)));
    len = (int)BIO_ctrl(bio,10,0,((void*)0));
    if (len > 0) {
...
unsigned int SSL_X509_getIDs(apr_pool_t *p, X509 *x509, apr_array_header_t **ids)
{
    ...
    if ((names = X509_get_ext_d2i(x509, 85, ((void*)0), ((void*)0))) &&
        (bio = BIO_new(BIO_s_mem()))) {
        GENERAL_NAME *name;

        for (i = 0; i < sk_num(((_STACK*) (1 ? (names) : (struct stack_st_GENERAL_NAME*)0))); i++) {
            name = ((GENERAL_NAME *)sk_value(((_STACK*) (1 ? (names) : (struct stack_st_GENERAL_NAME*)0)), (i)));
            if (name->type == 2) {
                ASN1_STRING_print_ex(bio, name->d.ia5, 2|
                                     0x10);
    ...
    if (names)
        sk_pop_free(((_STACK*) (1 ? (names) : (struct stack_st_GENERAL_NAME*)0)), ((void (*)(void *)) ((1 ? (GENERAL_NAME_free) : (void (*)(GENERAL_NAME *))0))));


    subj = X509_get_subject_name(x509);
    i = -1;
    while ((i = X509_NAME_get_index_by_NID(subj, 13, i)) != -1) {
        cpp = (char **)apr_array_push(*ids);
        *cpp = SSL_X509_NAME_ENTRY_to_string(p, X509_NAME_get_entry(subj, i));
    }

    return apr_is_empty_array(*ids) ? 0 : (!0);
}
...
unsigned int SSL_X509_match_name(apr_pool_t *p, X509 *x509, const char *name,
                         unsigned int allow_wildcard, server_rec *s)
{
    unsigned int matched = 0;
    apr_array_header_t *ids;
# 362 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
    if (SSL_X509_getIDs(p, x509, &ids)) {
        ...
        for (i = 0; i < ids->nelts; i++) {
            ...
            if ((allow_wildcard == (!0) && is_wildcard == (!0) &&
                 (cp = (__extension__ (__builtin_constant_p ('.') && !__builtin_constant_p (name) && ('.') == '\0' ? (char *) __rawmemchr (name, '.') : __builtin_strchr (name, '.')))) && !strcasecmp(id[i]+1, cp)) ||
                !strcasecmp(id[i], name)) {
                matched = (!0);
            }

            if (s) {
                do { const server_rec *sr__ = s; if (( ((((7 + 3))&15) <= 5) || (sr__ == ((void*)0)) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (&(sr__)->log)->module_levels == ((void*)0) || (&(sr__)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (&(sr__)->log)->level : (&(sr__)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 3))&15) ) )) ap_log_error_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c", 392, (aplog_module_index ? *aplog_module_index : -1), (7 + 3), 0, sr__, "[%s] SSL_X509_match_name: expecting name '%s', " "%smatched by ID '%s'", ((SSLSrvConfigRec *)(((void **)(s->module_config))[(&ssl_module)->module_index]))->vhost_id, name, matched == (!0) ? "" : "NOT ", id[i]); } while(0);
    ...
    if (s) {
        ssl_log_xerror("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c",407, 7, 0, p, s, x509,
                       "AH" "02412" ": " "[%s] Cert %s for name '%s'",
                       ((SSLSrvConfigRec *)(((void **)(s->module_config))[(&ssl_module)->module_index]))->vhost_id,
                       matched == (!0) ? "matches" : "does not match",
                       name);
    }
...
unsigned int SSL_X509_INFO_load_file(apr_pool_t *ptemp,
                             ...
                             const char *filename)
{
    ...
    if (BIO_ctrl(in,108, 0x01|0x02,(char *)filename) <= 0) {
        BIO_free(in);
        return 0;
    }
    ...
    PEM_X509_INFO_read_bio(in, sk, ((void*)0), ((void*)0));
...
unsigned int SSL_X509_INFO_load_path(apr_pool_t *ptemp,
                             struct stack_st_X509_INFO *sk,
                             const char *pathname)
{
    ...
    if (apr_dir_open(&dir, pathname, ptemp) != 0) {
        return 0;
    }

    while ((apr_dir_read(&dirent, finfo_flags, dir)) == 0) {
...
# 495 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
    ...
    SSL_CTX *ctx, char *file, int skipfirst, pem_password_cb *cb)
{
    ...
    if ((bio = BIO_new(BIO_s_file())) == ((void*)0))
        return -1;
    if (BIO_ctrl(bio,108, 0x01|0x02,(char *)file) <= 0) {
        BIO_free(bio);
        return -1;
    }

    if (skipfirst) {
        if ((x509 = PEM_read_bio_X509(bio, ((void*)0), cb, ((void*)0))) == ((void*)0)) {
            BIO_free(bio);
            return -1;
        }
        X509_free(x509);
    ...
    n = 0;
    while ((x509 = PEM_read_bio_X509(bio, ((void*)0), cb, ((void*)0))) != ((void*)0)) {
        if (!SSL_CTX_ctrl(ctx,14,0,(char *)x509)) {
            X509_free(x509);
            BIO_free(bio);
            return -1;
        }
    ...
    if ((err = ERR_peek_error()) > 0) {
        if (!( (int)((((unsigned long)err)>>24L)&0xffL) == 9
              && (int)((err)&0xfffL) == 108)) {
            BIO_free(bio);
            return -1;
        }
