# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c" 2
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c"
# 1 "./mod_proxy.h" 1
# 29 "./mod_proxy.h"
...
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c" 2




module proxy_connect_module;
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c"
typedef struct {
...
{
    connect_conf *c = memset(apr_palloc(p, sizeof(connect_conf)), 0, sizeof(connect_conf));
    ...
    set_allowed_ports(cmd_parms *parms, void *dummy, const char *arg)
{
    ...
    int first, last;
    connect_conf *conf =
        (((void **)(s->module_config))[(&proxy_connect_module)->module_index]);
    port_range *New;
    char *endptr;
    const char *p = arg;
    ...
    do {
        ...
        if (rv == 0) {
            ...
            if (rv == 0) {
                ...
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 176, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "01017" ": " "error on %s - ap_pass_brigade", name); } while(0);


            }
        } else if (!((rv) == 11)) {
            do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 181, (aplog_module_index ? *aplog_module_index : -1), 7, rv, r, "AH" "01018" ": " "error on %s - ap_get_brigade", name); } while(0);
...
{
    connect_conf *c_conf =
        (((void **)(r->server->module_config))[(&proxy_connect_module)->module_index]);
    ...
    if (r->method_number != 4) {
        do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 226, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "declining URL %s", url); } while(0);
        return -1;
    }
    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 229, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "serving URL %s", url); } while(0);
# 239 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c"
    if (0 != apr_uri_parse_hostinfo(p, url, &uri)) {
        return ap_proxyerror(r, 400,
                             apr_pstrcat(p, "URI cannot be parsed: ", url,
                                         ((void*)0)));
    }

    do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 245, (aplog_module_index ? *aplog_module_index : -1), 7, 0, r, "AH" "01019" ": " "connecting %s to %s:%d", url, uri.hostname, uri.port); } while(0);
    ...
    rv = apr_sockaddr_info_get(&nexthop, connectname, 0,
                               connectport, 0, p);
    if (rv != 0) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 256, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "02327" ": " "failed to resolve hostname '%s'", connectname); } while(0);
    ...
    if (ap_proxy_checkproxyblock(r, conf, uri.hostname,
                                 proxyname ? ((void*)0) : nexthop) != 0) {
        return ap_proxyerror(r, 403,
                             "Connect to remote machine blocked");
    }

    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 270, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "connecting to remote proxy %s on port %d", connectname, connectport); } while(0);
...
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c"
    ...
    do { if (( ((((7 + 2))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 2))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 310, (aplog_module_index ? *aplog_module_index : -1), (7 + 2), 0, r, "setting up poll()"); } while(0);

    if ((rv = apr_pollset_create(&pollset, 2, r->pool, 0)) != 0) {
        apr_socket_close(sock);
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 314, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "01020" ": " "error apr_pollset_create()"); } while(0);
    ...
    pollfd.reqevents = 0x001 | 0x020;
    pollfd.desc.s = client_socket;
    pollfd.client_data = ((void*)0);
    ...
    if (!backconn) {
        ...
        do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 341, (aplog_module_index ? *aplog_module_index : -1), 6, 0, r, "AH" "01021" ": " "an error occurred creating a new connection " "to %pI (%s)", nexthop, connectname); } while(0);
    ...
    if (rc != 0 && rc != -2) {
        backconn->aborted = 1;
        do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 351, (aplog_module_index ? *aplog_module_index : -1), 7, 0, r, "AH" "01022" ": " "pre_connection setup failed (%d)", rc); } while(0);

        return 500;
    }

    do { if (( ((((7 + 3))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 3))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 356, (aplog_module_index ? *aplog_module_index : -1), (7 + 3), 0, r, "connection complete to %pI (%s)", nexthop, connectname); } while(0);
    ...
    if (proxyport) {
        ...
        do { if (( ((((7 + 2))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 2))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 368, (aplog_module_index ? *aplog_module_index : -1), (7 + 2), 0, r, "sending the CONNECT request to the remote proxy"); } while(0);

        ap_fprintf(backconn->output_filters, bb,
                   "CONNECT %s HTTP/1.0" "\015\012", r->uri);
        ap_fprintf(backconn->output_filters, bb,
                   "Proxy-agent: %s" "\015\012" "\015\012", ap_get_server_banner());
        ap_fflush(backconn->output_filters, bb);
    }
    else {
        do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 377, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "Returning 200 OK"); } while(0);
        nbytes = apr_snprintf(buffer, sizeof(buffer),
                              "HTTP/1.0 200 Connection Established" "\015\012");
                                               ;
        apr_brigade_write(bb, ap_filter_flush, c->output_filters, buffer, nbytes);
        nbytes = apr_snprintf(buffer, sizeof(buffer),
...
# 397 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c"
    }

    do { if (( ((((7 + 2))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 2))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 399, (aplog_module_index ? *aplog_module_index : -1), (7 + 2), 0, r, "setting up poll()"); } while(0);
# 410 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c"
    ...
    while (1) {
        if ((rv = apr_pollset_poll(pollset, -1, &pollcnt, &signalled))
            ...
            apr_socket_close(sock);
            do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 423, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "01023" ": " "error apr_poll()"); } while(0);
            return 500;
        }
        ...
        for (pi = 0; pi < pollcnt; pi++) {
            ...
            if (cur->desc.s == sock) {
                ...
                else if (pollevent & 0x010) {
                    rv = 32;
                    backconn->aborted = 1;
                    do { if (( (((5)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((5)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 446, (aplog_module_index ? *aplog_module_index : -1), 5, 0, r, "AH" "01026" ": " "err on backconn"); } while(0);
                ...
                if (pollevent & (0x001 | 0x020)) {
                    ...
                    rv = 32;
                    c->aborted = 1;
                    do { if (( (((5)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((5)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 462, (aplog_module_index ? *aplog_module_index : -1), 5, 0, r, "AH" "02827" ": " "err on client"); } while(0);

                }
            }
            else {
                rv = 9;
                do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 468, (aplog_module_index ? *aplog_module_index : -1), 6, 0, r, "AH" "01028" ": " "unknown socket in pollset"); } while(0);
    ...
    do { if (( ((((7 + 2))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 2))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", 478, (aplog_module_index ? *aplog_module_index : -1), (7 + 2), 0, r, "finished with poll() - cleaning up"); } while(0);
# 487 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c"
    if (backconn->aborted)
        apr_socket_close(sock);
    else
...
{
    proxy_hook_scheme_handler(proxy_connect_handler, ((void*)0), ((void*)0), 10);
    proxy_hook_canon_handler(proxy_connect_canon, ((void*)0), ((void*)0), 10);
}

static const command_rec cmds[] =
{
    { "AllowCONNECT", { .take1=set_allowed_ports }, ((void*)0), 128, ITERATE, "A list of ports or port ranges which CONNECT may connect to" },

    {((void*)0)}
};

extern module proxy_connect_module; static int * const aplog_module_index = &(proxy_connect_module.module_index); module proxy_connect_module = {
    20150121, 1, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/proxy/mod_proxy_connect.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
    ((void*)0),
    ((void*)0),
    create_config,
    merge_config,
