# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c" 2
# 17 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c"
# 1 "./mod_proxy.h" 1
# 29 "./mod_proxy.h"
...
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c" 2
...
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c" 2

module proxy_wstunnel_module;
...
static int proxy_wstunnel_pump(ws_baton_t *baton, apr_time_t timeout, int try_async) {
    ...
    while(1) {
        if ((rv = apr_pollset_poll(pollset, timeout, &pollcnt, &signalled))
            ...
            if (((rv) == 4)) {
                ...
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 73, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "02444" ": " "error apr_poll()"); } while(0);
                return 500;
            }
        }

        do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 78, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "AH" "02445" ": " "woke from poll(), i=%d", pollcnt); } while(0);
        ...
        for (pi = 0; pi < pollcnt; pi++) {
            ...
            if (cur->desc.s == sock) {
                ...
                if (pollevent & (0x001 | 0x020)) {
                    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 87, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "AH" "02446" ": " "sock was readable"); } while(0);
                    ...
                    rv = 32;
                    backconn->aborted = 1;
                    do { if (( (((5)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((5)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 94, (aplog_module_index ? *aplog_module_index : -1), 5, 0, r, "AH" "02447" ": " "error on backconn"); } while(0);

                }
                else {
                    rv = (20000 + 14);
                    do { if (( (((5)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((5)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 99, (aplog_module_index ? *aplog_module_index : -1), 5, 0, r, "AH" "02605" ": " "unknown event on backconn %d", pollevent); } while(0);
                ...
                pollevent = cur->rtnevents;
                if (pollevent & (0x001 | 0x020)) {
                    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 106, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "AH" "02448" ": " "client was readable"); } while(0);
                    ...
                    rv = 32;
                    c->aborted = 1;
                    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 113, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "AH" "02607" ": " "error on client conn"); } while(0);

                }
                else {
                    rv = (20000 + 14);
                    do { if (( (((5)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((5)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 118, (aplog_module_index ? *aplog_module_index : -1), 5, 0, r, "AH" "02606" ": " "unknown event on client conn %d", pollevent); } while(0);

                }
            }
            else {
                rv = 9;
                do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 124, (aplog_module_index ? *aplog_module_index : -1), 6, 0, r, "AH" "02449" ": " "unknown socket in pollset"); } while(0);
    ...
    do { if (( ((((7 + 2))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 2))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 134, (aplog_module_index ? *aplog_module_index : -1), (7 + 2), 0, r, "finished with poll() - cleaning up"); } while(0);
...
static void proxy_wstunnel_finish(ws_baton_t *baton) {
    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels == ((void*)0) || (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->level : (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 141, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, baton->r, "proxy_wstunnel_finish"); } while(0);
    baton->proxy_connrec->close = 1;
...
static void proxy_wstunnel_cancel_callback(void *b)
{
    ...
    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels == ((void*)0) || (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->level : (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 159, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, baton->r, "proxy_wstunnel_cancel_callback, IO timed out"); } while(0);
...
static void proxy_wstunnel_callback(void *b) {
    int status;
    apr_socket_t *sockets[3] = {((void*)0), ((void*)0), ((void*)0)};
    ws_baton_t *baton = (ws_baton_t*)b;
    proxyws_dir_conf *dconf = (((void **)(baton->r->per_dir_config))[(&proxy_wstunnel_module)->module_index]);
    ...
    if (status == -3) {
        ...
        ap_mpm_register_socket_callback_timeout(sockets, baton->subpool, 1,
            ...
            baton,
            dconf->idle_timeout);
        do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels == ((void*)0) || (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->level : (((baton->r)->log ? (baton->r)->log : (baton->r)->connection->log ? (baton->r)->connection->log : &(baton->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 184, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, baton->r, "proxy_wstunnel_callback suspend"); } while(0);
    }
    else {
        proxy_wstunnel_finish(baton);
    }
}
# 198 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c"
static int proxy_wstunnel_canon(request_rec *r, char *url)
{
    ...
    port = def_port;
    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 222, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "canonicalising URL %s", url); } while(0);
    ...
    if (err) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 230, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "02439" ": " "error parsing URL %s: %s", url, err); } while(0);
    ...
    do {
        ...
        if (rv == 0) {
            ...
            if (rv == 0) {
                ...
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 295, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "02441" ": " "error on %s - ap_pass_brigade", name); } while(0);


            }
        } else if (!((rv) == 11) && !((rv) == ((20000 + 50000) + 14))) {
            do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 300, (aplog_module_index ? *aplog_module_index : -1), 7, rv, r, "AH" "02442" ": " "error on %s - ap_get_brigade", name); } while(0);
                                ...
                                char *url, char *server_portstr, char *scheme)
{
    ...
    apr_bucket_brigade *header_brigade;
    apr_bucket *e;
    char *old_cl_val = ((void*)0);
    char *old_te_val = ((void*)0);
    apr_bucket_brigade *bb = apr_brigade_create(p, c->bucket_alloc);
    apr_socket_t *client_socket = ap_get_conn_socket(c);
    ws_baton_t *baton = memset(apr_palloc(r->pool, sizeof(ws_baton_t)), 0, sizeof(ws_baton_t));
    apr_socket_t *sockets[3] = {((void*)0), ((void*)0), ((void*)0)};
    int status;
    proxyws_dir_conf *dconf = (((void **)(r->per_dir_config))[(&proxy_wstunnel_module)->module_index]);

    header_brigade = apr_brigade_create(p, backconn->bucket_alloc);

    do { if (( ((((7 + 2))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 2))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 342, (aplog_module_index ? *aplog_module_index : -1), (7 + 2), 0, r, "sending request"); } while(0);
    ...
    buf = apr_pstrcat(p, "Upgrade: WebSocket", "\015\012", "Connection: Upgrade", "\015\012", "\015\012", ((void*)0));
                                             ;
    ...
    do { if (( ((((7 + 2))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 2))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 360, (aplog_module_index ? *aplog_module_index : -1), (7 + 2), 0, r, "setting up poll()"); } while(0);

    if ((rv = apr_pollset_create(&pollset, 2, p, 0)) != 0) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 363, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "02443" ": " "error apr_pollset_create()"); } while(0);

        return 500;
    }
# 375 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c"
    pollfd.p = p;
    ...
    baton->bb = bb;
    baton->scheme = scheme;
    apr_pool_create_ex(&baton->subpool, r->pool, ((void*)0), ((void*)0));
    ...
    if (!dconf->is_async) {
        ...
        if (status == -3) {
            ...
            if (rv == 0) {
                ...
                do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 423, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, "AH" "02544" ": " "No async support"); } while(0);
                status = proxy_wstunnel_pump(baton, dconf->idle_timeout, 0);
            }
            else {
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 427, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "02543" ": " "error creating websockets tunnel"); } while(0);
                             ...
                             apr_port_t proxyport)
{
    ...
    if (strncasecmp(url, "wss:", 4) == 0) {
        ...
        do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 469, (aplog_module_index ? *aplog_module_index : -1), 7, 0, r, "AH" "02450" ": " "declining URL %s", url); } while(0);
        return -1;
    }

    uri = apr_palloc(p, sizeof(*uri));
    do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 474, (aplog_module_index ? *aplog_module_index : -1), 7, 0, r, "AH" "02451" ": " "serving URL %s", url); } while(0);
    ...
    while (retry < 2) {
        ...
        if (ap_proxy_connect_backend(scheme, backend, worker, r->server)) {
            do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", 504, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "02452" ": " "failed to make connection to backend: %s", backend->hostname); } while(0);
...
static void *create_proxyws_dir_config(apr_pool_t *p, char *dummy)
{
    proxyws_dir_conf *new =
        (proxyws_dir_conf *) memset(apr_palloc(p, sizeof(proxyws_dir_conf)), 0, sizeof(proxyws_dir_conf));
...
static const char * proxyws_set_idle(cmd_parms *cmd, void *conf, const char *val)
{
    ...
    if (ap_timeout_parameter_parse(val, &(dconf->idle_timeout), "s") != 0)
...
{
    proxyws_dir_conf *dconf = conf;
    if (ap_timeout_parameter_parse(val, &(dconf->async_delay), "s") != 0)
...
{
    { "ProxyWebsocketAsync", { .flag=ap_set_flag_slot_char }, (void*)((long) (((char *) (&(((proxyws_dir_conf*)((void*)0))->is_async))) - ((char *) ((void*)0)))), 128|64, FLAG, "on if idle websockets connections should be monitored asyncronously" },



    { "ProxyWebsocketIdleTimeout", { .take1=proxyws_set_idle }, ((void*)0), 128|64, TAKE1, "timeout for activity in either direction, unlimited by default" },


    { "ProxyWebsocketAsyncDelay", { .take1=proxyws_set_aysnch_delay }, ((void*)0), 128|64, TAKE1, "amount of time to poll before going asyncronous" },
...
{
    proxy_hook_scheme_handler(proxy_wstunnel_handler, ((void*)0), ((void*)0), 0);
    proxy_hook_canon_handler(proxy_wstunnel_canon, ((void*)0), ((void*)0), 0);
}

extern module proxy_wstunnel_module; static int * const aplog_module_index = &(proxy_wstunnel_module.module_index); module proxy_wstunnel_module = {
    20140627, 9, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy_wstunnel.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
