...
# 212 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
apr_status_t ap_rgetline_core(char **s, apr_size_t n,
...
# 382 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
            c = *str;
            if (c == '\040' || c == '\011') {
...
# 470 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
int ap_getline(char *s, int n, request_rec *r, int fold)
{
    char *tmp_s = s;
    apr_status_t rv;
...
# 513 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    while ((uri[0] == '/') && (uri[1] == '/')) {
        ++uri ;
    }
    ...
    if (status == 0) {
        ...
        r->uri = r->parsed_uri.path ? r->parsed_uri.path
                 : apr_pstrdup(r->pool, "/");
# 549 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    }
    else {
        r->args = ((void*)0);
        r->hostname = ((void*)0);
...
# 592 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    do {
        apr_status_t rv;
...
# 644 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    ...
    ap_parse_uri(r, uri);
# 662 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    if (r->method_number != 4
        && !r->parsed_uri.scheme
        && uri[0] != '/'
        && !(uri[0] == '*' && uri[1] == '\0')) {
        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 666, 0, 6, 0, r, "AH" "00559" ": " "invalid request-URI %s", uri); } while(0);
                                     ...
                                     const char *value)
{
    ...
    apr_table_setn(r->notes, "error-notes",
                   apr_pstrcat(r->pool, "Size of a request header field "
                               ...
                               "</pre>\n", ((void*)0)));
    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 719, 0, 6, 0, r, "AH" "00560" ": " "Request header " "exceeds LimitRequestFieldSize after merging: %s", key); } while(0);
            ...
            if (rv == 28 && field) {
                ...
                apr_table_setn(r->notes, "error-notes",
                               apr_pstrcat(r->pool,
                                           ...
                                           "<pre>\n",
                                           ap_escape_html2(r->pool,field,0),
                                           "</pre>\n", ((void*)0)));
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 779, 0, 6, 0, r, "AH" "00561" ": " "Request header exceeds LimitRequestFieldSize: " "%.*s", field_name_len(field), field); } while(0);
        ...
        if (last_field != ((void*)0)) {
            if ((len > 0) && ((*field == '\t') || *field == ' ')) {
                ...
                if (fold_len >= (apr_size_t)(r->server->limit_req_fieldsize)) {
                    ...
                    apr_table_setn(r->notes, "error-notes",
                                   apr_pstrcat(r->pool,
                                               ...
                                               "</pre>\n", ((void*)0)));
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 809, 0, 6, 0, r, "AH" "00562" ": " "Request header exceeds LimitRequestFieldSize " "after folding: %.*s", field_name_len(last_field), last_field); } while(0);
                ...
                if (r->server->limit_req_fields
                    ...
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 838, 0, 6, 0, r, "AH" "00563" ": " "Number of request headers exceeds " "LimitRequestFields"); } while(0);
                ...
                if (!(value = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (last_field) && (':') == '\0' ? (char *) __rawmemchr (last_field, ':') : __builtin_strchr (last_field, ':'))))) {
                    ...
                    apr_table_setn(r->notes, "error-notes",
                                   apr_pstrcat(r->pool,
                                               ...
                                               "</pre>\n", ((void*)0)));
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 854, 0, 6, 0, r, "AH" "00564" ": " "Request header field is missing ':' " "separator: %.*s", (int)80, last_field); } while(0);
...
request_rec *ap_read_request(conn_rec *conn)
{
    ...
    if (!read_request_line(r, tmp_bb)) {
        if (r->status == 414
            || r->status == 400) {
            if (r->status == 414) {
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 991, 0, 6, 0, r, "AH" "00565" ": " "request failed: URI too long (longer than %d)", r->server->limit_req_line); } while(0);


            }
            else if (r->method == ((void*)0)) {
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 996, 0, 6, 0, r, "AH" "00566" ": " "request failed: invalid characters in URI"); } while(0);
    ...
    if (!r->assbackwards) {
        ap_get_mime_headers_core(r, tmp_bb);
        if (r->status != 200) {
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1033, 0, 6, 0, r, "AH" "00567" ": " "request failed: error reading the headers"); } while(0);
        ...
        if (r->header_only) {
            ...
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1058, 0, 6, 0, r, "AH" "00568" ": " "client sent invalid HTTP/0.9 request: HEAD %s", r->uri); } while(0);
    ...
    if ((!r->hostname && (r->proto_num >= (1000*(1)+(1))))
        ...
        r->status = 400;
        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1100, 0, 6, 0, r, "AH" "00569" ": " "client sent HTTP/1.1 request without hostname " "(see RFC2616 section 14.23): %s", r->uri); } while(0);


    }
# 1112 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    ...
    if (((expect = apr_table_get(r->headers_in, "Expect")) != ((void*)0))
        ...
        if (strcasecmp(expect, "100-continue") == 0) {
            ...
            r->status = 417;
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1143, 0, 6, 0, r, "AH" "00570" ": " "client sent an unrecognized expectation value of " "Expect: %s", expect); } while(0);
...
# 1186 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
...
int ap_get_basic_auth_pw(request_rec *r, const char **pw)
{
    ...
    if (!ap_auth_name(r)) {
        do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1293, 0, 3, 0, r, "AH" "00572" ": " "need AuthName: %s", r->uri); } while(0);
    ...
    if (strcasecmp(ap_getword(r->pool, &auth_line, ' '), "Basic")) {
        ...
        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1305, 0, 6, 0, r, "AH" "00573" ": " "client used wrong authentication scheme: %s", r->uri); } while(0);
    ...
    while (e != (struct apr_bucket *)((char *)(&(&(b)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))) {
        ...
        if (e->length == (apr_size_t)-1) {
            ...
            if (rv == 0) {
                ...
                do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1399, 0, 3, rv, r, "AH" "00574" ": " "ap_content_length_filter: " "apr_bucket_read() failed"); } while(0);
...
# 1428 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
...
void ap_send_interim_response(request_rec *r, int send_headers)
{
    ...
    apr_brigade_puts(x.bb, ap_filter_flush, x.f, status_line);
    if (send_headers) {
