# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c" 2
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c"
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c" 2
# 56 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c"
int main(int argc, char *argv[])
{
    ...
    for (c = 0; c < 256; ++c) {
        ...
        if (c % 20 == 0)
            printf("\n    ");
# 101 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/gen_test_char.c"
        if (c && (__extension__ (__builtin_constant_p (c) && !__builtin_constant_p ("&;`'\"|*?~<>^()[]{}$\\\n") && (c) == '\0' ? (char *) __rawmemchr ("&;`'\"|*?~<>^()[]{}$\\\n", c) : __builtin_strchr ("&;`'\"|*?~<>^()[]{}$\\\n", c)))) {
            flags |= (0x01);
        }


        if (!(((*__ctype_b_loc ())[(int) ((((unsigned char)(c))))] & (unsigned short int) _ISalnum)) && !(__extension__ (__builtin_constant_p (c) && !__builtin_constant_p ("$-_.+!*'(),:@&=~") && (c) == '\0' ? (char *) __rawmemchr ("$-_.+!*'(),:@&=~", c) : __builtin_strchr ("$-_.+!*'(),:@&=~", c)))) {
            flags |= (0x02);
        }
        ...
        if (c && ((((*__ctype_b_loc ())[(int) ((((unsigned char)(c))))] & (unsigned short int) _IScntrl)) || (__extension__ (__builtin_constant_p (c) && !__builtin_constant_p (" \t()<>@,;:\\\"/[]?={}") && (c) == '\0' ? (char *) __rawmemchr (" \t()<>@,;:\\\"/[]?={}", c) : __builtin_strchr (" \t()<>@,;:\\\"/[]?={}", c))))) {
            flags |= (0x08);
        }
