# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c"
...
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
apr_status_t apr_bucket_file_enable_mmap(apr_bucket *b,
                                                      int enabled);
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
# 1185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1313 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1330 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
char * ap_getword_nulls(apr_pool_t *p, const char **line,
                                    char stop);
# 1404 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1421 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1582 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
char * ap_pregsub(apr_pool_t *p, const char *input,
                              ...
                              ap_regmatch_t pmatch[]);
# 1814 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1919 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
apr_status_t ap_pstr2_alnum(apr_pool_t *p, const char *src,
                                        const char **dest);
# 1931 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
apr_status_t ap_str2_alnum(const char *src, char *dest);
# 1941 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
typedef struct {
    const char *name;
...
# 1986 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 2050 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
void * ap_malloc(size_t size)
                    __attribute__((malloc))
                                            ;
# 2158 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
void * ap_calloc(size_t nelem, size_t size)
                   __attribute__((malloc))
                                              ;
# 2169 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
void * ap_realloc(void *ptr, size_t size)
                   __attribute__((warn_unused_result))
                                           ;
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
...
apr_bucket * ap_bucket_eor_create(apr_bucket_alloc_t *list,
                                              request_rec *r);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/mod_request.h" 1
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/mod_request.h"
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c" 2
                                     ...
                                     apr_off_t readbytes)
{
    ...
    if (!ctx) {
        const char *lenp;
        char *endstr = ((void*)0);
        request_dir_conf *dconf = (((void **)(f->r->per_dir_config))[(&request_module)->module_index]);
        ...
        if (lenp) {
            ...
            if (dconf->keep_body < ctx->remaining) {
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels == ((void*)0) || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->level : (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c", 112, (aplog_module_index ? *aplog_module_index : -1), 3, 0, f->r, "AH" "01412" ": " "Requested content-length of %" "ld" " is larger than the configured limit" " of %" "ld", ctx->remaining, dconf->keep_body); } while(0);
    ...
    if (0 == rv && len > ctx->remaining) {
        if (f->r->kept_body) {
            apr_brigade_cleanup(f->r->kept_body);
            f->r->kept_body = ((void*)0);
        }
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels == ((void*)0) || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->level : (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c", 139, (aplog_module_index ? *aplog_module_index : -1), 3, 0, f->r, "AH" "01413" ": " "Requested content-length of %" "ld" " is larger than the configured limit" " of %" "ld", len, ctx->keep_body); } while(0);
    ...
    for (bucket = (&(b)->list)->next;
         bucket != (struct apr_bucket *)((char *)(&(&(b)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))));
         bucket = ((bucket))->link.next)
    {
        (bucket)->type->copy(bucket, &e);
        do { apr_bucket *ap__b = (e); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&(f->r->kept_body)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&(f->r->kept_body)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&(f->r->kept_body)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&(f->r->kept_body)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
    }
...
# 181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c"
                                     ...
                                     apr_off_t readbytes)
{
    ...
    if ((rv = apr_brigade_partition(kept_body, ctx->offset, &ec)) != 0) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c", 236, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "01414" ": " "apr_brigade_partition() failed on kept_body at %" "ld", ctx->offset); } while(0);

        return rv;
    }
    if ((rv = apr_brigade_partition(kept_body, ctx->offset + readbytes, &e2)) != 0) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c", 241, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "01415" ": " "apr_brigade_partition() failed on kept_body at %" "ld", ctx->offset + readbytes); } while(0);
...
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c"
static void ap_request_insert_filter(request_rec * r)
{
    request_dir_conf *conf = (((void **)(r->per_dir_config))[(&request_module)->module_index]);
...
static void *create_request_dir_config(apr_pool_t *p, char *dummy)
{
    request_dir_conf *new =
        (request_dir_conf *) memset(apr_palloc(p, sizeof(request_dir_conf)), 0, sizeof(request_dir_conf));
...
{
    request_dir_conf *new = (request_dir_conf *) memset(apr_palloc(p, sizeof(request_dir_conf)), 0, sizeof(request_dir_conf));
                                      ...
                                      const char *arg)
{
    ...
    if (0 != apr_strtoff(&(conf->keep_body), arg, &end, 10)
...
static const command_rec request_cmds[] = {
    { "KeptBodySize", { .take1=set_kept_body_size }, ((void*)0), 64, TAKE1, "Maximum size of request bodies kept aside for use by filters" },
...
static void register_hooks(apr_pool_t *p)
{
    keep_body_input_filter_handle =
        ap_register_input_filter("KEEP_BODY", keep_body_filter,
                                 ((void*)0), AP_FTYPE_RESOURCE);
    kept_body_input_filter_handle =
        ap_register_input_filter("KEPT_BODY", kept_body_filter,
                                 kept_body_filter_init, AP_FTYPE_RESOURCE);
    ap_hook_insert_filter(ap_request_insert_filter, ((void*)0), ((void*)0), 20);
    do { apr_OFN_ap_request_insert_filter_t *apu__opt = ap_request_insert_filter; apr_dynamic_fn_register("ap_request_insert_filter",(apr_opt_fn_t *)apu__opt); } while (0);
    do { apr_OFN_ap_request_remove_filter_t *apu__opt = ap_request_remove_filter; apr_dynamic_fn_register("ap_request_remove_filter",(apr_opt_fn_t *)apu__opt); } while (0);
}

extern module request_module; static int * const aplog_module_index = &(request_module.module_index); module request_module = {
    20120211, 2, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_request.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
