# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
# 17 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c"
...
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
char * ap_get_exec_line(apr_pool_t *p,
                                    const char *cmd,
                                    const char * const *argv);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
apr_bucket * ap_bucket_eor_create(apr_bucket_alloc_t *list,
                                              request_rec *r);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c" 2
...
{
    auth_basic_config_rec *newconf = memset(apr_palloc(p, sizeof(*newconf)), 0, sizeof(*newconf));
...
static const char *add_basic_fake(cmd_parms * cmd, void *config, const char *user, const char *pass)
{
    ...
    conf->fakeuser = ap_expr_parse_cmd_mi(cmd, user, 8, &err, ((void*)0), (aplog_module_index ? *aplog_module_index : -1));
    ...
    conf->fakepass = ap_expr_parse_cmd_mi(cmd, pass, 8, &err, ((void*)0), (aplog_module_index ? *aplog_module_index : -1));
...
static const command_rec auth_basic_cmds[] =
{
    ...
    { "AuthBasicAuthoritative", { .flag=set_authoritative }, ((void*)0), 8, FLAG, "Set to 'Off' to allow access control to be passed along to " "lower modules if the UserID is not known to this module" },


    { "AuthBasicFake", { .take2=add_basic_fake }, ((void*)0), 8, TAKE2, "Fake basic authentication using the given expressions for " "username and password" },
...
# 180 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c"
...
static int authenticate_basic_user(request_rec *r)
{
    ...
    if (!ap_auth_name(r)) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 262, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01615" ": " "need AuthName: %s", r->uri); } while(0);
    ...
    do {
        ...
        if (!current_provider) {
            ...
            if (!provider || !provider->check_password) {
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 287, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01616" ": " "No Authn provider configured"); } while(0);
    ...
    if (auth_result != AUTH_GRANTED) {
        ...
        switch (auth_result) {
        case AUTH_DENIED:
            do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 327, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01617" ": " "user %s: authentication failure for \"%s\": " "Password Mismatch", sent_user, r->uri); } while(0);
        ...
        case AUTH_USER_NOT_FOUND:
            do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 334, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01618" ": " "user %s not found: %s", sent_user, r->uri); } while(0);
...
static int authenticate_basic_fake(request_rec *r)
{
    ...
    if (err) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 372, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "02455" ": " "AuthBasicFake: could not evaluate user expression for URI '%s': %s", r->uri, err); } while(0);

        return 500;
    }
    if (!user || !*user) {
        do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 377, (aplog_module_index ? *aplog_module_index : -1), 6, 0, r, "AH" "02458" ": " "AuthBasicFake: empty username expression for URI '%s', ignoring", r->uri); } while(0);
    ...
    if (err) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 387, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "02456" ": " "AuthBasicFake: could not evaluate password expression for URI '%s': %s", r->uri, err); } while(0);

        return 500;
    }
    if (!pass || !*pass) {
        do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 392, (aplog_module_index ? *aplog_module_index : -1), 6, 0, r, "AH" "02459" ": " "AuthBasicFake: empty password expression for URI '%s', ignoring", r->uri); } while(0);
    ...
    do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", 407, (aplog_module_index ? *aplog_module_index : -1), 6, 0, r, "AH" "02457" ": " "AuthBasicFake: \"Authorization: %s\"", auth_line); } while(0);
...
{
    ap_hook_check_authn(authenticate_basic_user, ((void*)0), ((void*)0), 10,
                        1);
    ap_hook_fixups(authenticate_basic_fake, ((void*)0), ((void*)0), 20);
    ap_hook_note_auth_failure(hook_note_basic_auth_failure, ((void*)0), ((void*)0),
                              10);
}

extern module auth_basic_module; static int * const aplog_module_index = &(auth_basic_module.module_index); module auth_basic_module =
{
    20121222, 7, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/aaa/mod_auth_basic.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
