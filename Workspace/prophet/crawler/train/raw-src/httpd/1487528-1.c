# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
apr_status_t apr_bucket_file_enable_mmap(apr_bucket *b,
                                                      int enabled);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
apr_bucket * ap_bucket_eor_create(apr_bucket_alloc_t *list,
                                              request_rec *r);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
int ap_matches_request_vhost(request_rec *r, const char *host,
    apr_port_t port);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/util_charset.h" 1
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c" 2
...
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
...
# 107 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
...
# 171 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
apr_time_t ap_rationalize_mtime(request_rec *r, apr_time_t mtime)
{
    apr_time_t now;
# 184 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
    now = (mtime < r->request_time) ? r->request_time : apr_time_now();
    return (mtime > now) ? now : mtime;
}
# 213 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
apr_status_t ap_rgetline_core(char **s, apr_size_t n,
...
# 380 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
            c = *str;
            if (c == '\040' || c == '\011') {
...
# 468 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
int ap_getline(char *s, int n, request_rec *r, int fold)
{
    char *tmp_s = s;
    apr_status_t rv;
...
# 511 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
    while ((uri[0] == '/') && (uri[1] == '/')) {
        ++uri ;
    }
    ...
    if (status == 0) {
        ...
        r->uri = r->parsed_uri.path ? r->parsed_uri.path
                 : apr_pstrdup(r->pool, "/");
# 547 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
    }
    else {
        r->args = ((void*)0);
        r->hostname = ((void*)0);
...
# 590 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
    do {
        apr_status_t rv;
    ...
    if (len == 8
        ...
        if (strict) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 674, 0, 7, 0, r, "AH" "02418" ": " "Invalid protocol '%s'", r->protocol); } while(0);
    ...
    if (strict) {
        ...
        if (ap_has_cntrl(r->the_request)) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 694, 0, 7, 0, r, "AH" "02420" ": " "Request line must not contain control characters"); } while(0);

            err = 400;
        }
        if (r->parsed_uri.fragment) {

            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 700, 0, 7, 0, r, "AH" "02421" ": " "URI must not contain a fragment"); } while(0);

            err = 400;
        }
        else if (r->parsed_uri.user || r->parsed_uri.password) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 705, 0, 7, 0, r, "AH" "02422" ": " "URI must not contain a username/password"); } while(0);

            err = 400;
        }
        else if (r->method_number == 26) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 710, 0, 7, 0, r, "AH" "02423" ": " "Invalid HTTP method string: %s", r->method); } while(0);

            err = 501;
        }
        else if (r->assbackwards == 0 && r->proto_num < (1000*(1)+(0))) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 715, 0, 7, 0, r, "AH" "02424" ": " "HTTP/0.x does not take a protocol"); } while(0);
                                     ...
                                     const char *value)
{
    ...
    apr_table_setn(r->notes, "error-notes",
                   apr_pstrcat(r->pool, "Size of a request header field "
                               ...
                               "</pre>\n", ((void*)0)));
    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 743, 0, 6, 0, r, "AH" "00560" ": " "Request header " "exceeds LimitRequestFieldSize after merging: %s", key); } while(0);
            ...
            if (rv == 28) {
                ...
                apr_table_setn(r->notes, "error-notes",
                               apr_psprintf(r->pool,
                                           ...
                                           field_escaped));
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 812, 0, 6, 0, r, "AH" "00561" ": " "Request header exceeds LimitRequestFieldSize%s" "%.*s", *field ? ": " : "", field_name_len(field), field); } while(0);
        ...
        if (last_field != ((void*)0)) {
            if ((len > 0) && ((*field == '\t') || *field == ' ')) {
                ...
                if (fold_len >= (apr_size_t)(r->server->limit_req_fieldsize)) {
                    ...
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 844, 0, 6, 0, r, "AH" "00562" ": " "Request header exceeds LimitRequestFieldSize " "after folding: %.*s", field_name_len(last_field), last_field); } while(0);
                ...
                if (r->server->limit_req_fields
                    ...
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 873, 0, 6, 0, r, "AH" "00563" ": " "Number of request headers exceeds " "LimitRequestFields"); } while(0);
                ...
                if (!(value = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (last_field) && (':') == '\0' ? (char *) __rawmemchr (last_field, ':') : __builtin_strchr (last_field, ':'))))) {
                    ...
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 889, 0, 6, 0, r, "AH" "00564" ": " "Request header field is missing ':' " "separator: %.*s", (int)80, last_field); } while(0);
                ...
                *value++ = '\0';
                ...
                if (conf->http_conformance & 2) {
                    ...
                    if (*last_field == '\0') {
                        err = 400;
                        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 922, 0, 6, 0, r, "AH" "02425" ": " "Empty request header field name not allowed"); } while(0);

                    }
                    else if (ap_has_cntrl(last_field)) {
                        err = 400;
                        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 927, 0, 6, 0, r, "AH" "02426" ": " "[HTTP strict] Request header field name contains " "control character: %.*s", (int)80, last_field); } while(0);
                        ...
                        err = 400;
                        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 934, 0, 6, 0, r, "AH" "02427" ": " "Request header field '%.*s' contains" "control character", (int)80, last_field); } while(0);
...
request_rec *ap_read_request(conn_rec *conn)
{
    ...
    if (!read_request_line(r, tmp_bb)) {
        ...
        case 501:
            if (r->status == 414) {
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1056, 0, 6, 0, r, "AH" "00565" ": " "request failed: client's request-line exceeds LimitRequestLine (longer than %d)", r->server->limit_req_line); } while(0);


            }
            else if (r->method == ((void*)0)) {
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1061, 0, 6, 0, r, "AH" "00566" ": " "request failed: invalid characters in URI"); } while(0);
    ...
    if (!r->assbackwards) {
        ap_get_mime_headers_core(r, tmp_bb);
        if (r->status != 200) {
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1096, 0, 6, 0, r, "AH" "00567" ": " "request failed: error reading the headers"); } while(0);
        ...
        if (r->header_only) {
            ...
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1121, 0, 6, 0, r, "AH" "00568" ": " "client sent invalid HTTP/0.9 request: HEAD %s", r->uri); } while(0);
    ...
    if ((!r->hostname && (r->proto_num >= (1000*(1)+(1))))
        ...
        access_status = 400;
        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1164, 0, 6, 0, r, "AH" "00569" ": " "client sent HTTP/1.1 request without hostname " "(see RFC2616 section 14.23): %s", r->uri); } while(0);


    }
# 1176 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
    ...
    if (((expect = apr_table_get(r->headers_in, "Expect")) != ((void*)0))
        ...
        if (strcasecmp(expect, "100-continue") == 0) {
            ...
            r->status = 417;
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1201, 0, 6, 0, r, "AH" "00570" ": " "client sent an unrecognized expectation value of " "Expect: %s", expect); } while(0);
...
# 1244 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
...
int ap_get_basic_auth_pw(request_rec *r, const char **pw)
{
    ...
    if (!ap_auth_name(r)) {
        do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1369, 0, 3, 0, r, "AH" "00572" ": " "need AuthName: %s", r->uri); } while(0);
    ...
    if (strcasecmp(ap_getword(r->pool, &auth_line, ' '), "Basic")) {
        ...
        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1381, 0, 6, 0, r, "AH" "00573" ": " "client used wrong authentication scheme: %s", r->uri); } while(0);
    ...
    while (e != (struct apr_bucket *)((char *)(&(&(b)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))) {
        ...
        if (e->length == (apr_size_t)-1) {
            ...
            if (rv == 0) {
                ...
                do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1475, 0, 3, rv, r, "AH" "00574" ": " "ap_content_length_filter: " "apr_bucket_read() failed"); } while(0);
...
# 1504 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c"
...
void ap_send_interim_response(request_rec *r, int send_headers)
{
    ...
    if (!(((r->status) >= 100)&&((r->status) < 200))) {
        do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/protocol.c", 1832, 0, 7, 0, r, "AH" "00575" ": " "Status is %d - not sending interim response", r->status); } while(0);
