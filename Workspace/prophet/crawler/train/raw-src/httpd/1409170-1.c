# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2
# 17 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c"
# 1 "./mod_session.h" 1
# 50 "./mod_session.h"
...
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2
...
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2
...
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/util_cookies.h" 1
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/util_cookies.h"
typedef struct {
    request_rec *r;
    const char *name;
    const char *encoded;
...
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/util_cookies.h"
apr_status_t ap_cookie_write(request_rec * r, const char *name,
                                         const char *val, const char *attrs,
                                         long maxage, ...)
                         __attribute__((sentinel));
# 85 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/util_cookies.h"
apr_status_t ap_cookie_write2(request_rec * r, const char *name2,
                                          const char *val, const char *attrs2,
                                          long maxage, ...)
                         __attribute__((sentinel));
# 100 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/util_cookies.h"
apr_status_t ap_cookie_remove(request_rec * r, const char *name,
                                          const char *attrs, ...)
                         __attribute__((sentinel));
# 114 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/util_cookies.h"
apr_status_t ap_cookie_remove2(request_rec * r, const char *name2,
                                           const char *attrs2, ...)
                         __attribute__((sentinel));
# 127 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/util_cookies.h"
apr_status_t ap_cookie_read(request_rec * r, const char *name, const char **val,
                                        int remove);
...
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c" 2



module session_dbd_module;
...
static ap_dbd_t *(*session_dbd_acquire_fn) (request_rec *) = ((void*)0);
static void (*session_dbd_prepare_fn) (server_rec *, const char *, const char *) = ((void*)0);
                             ...
                             apr_dbd_prepared_t **statementp)
{
    ...
    if (!dbd) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 77, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01851" ": " "failed to acquire database connection"); } while(0);

        return (20000 + 14);
    }

    statement = apr_hash_get(dbd->prepared, query, (-1));
    if (!statement) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 84, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01852" ": " "failed to find the prepared statement called '%s'", query); } while(0);
...
static apr_status_t dbd_load(request_rec * r, const char *key, const char **val)
{
    ...
    session_dbd_dir_conf *conf = (((void **)(r->per_dir_config))[(&session_dbd_module)->module_index]);


    if (conf->selectlabel == ((void*)0)) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 112, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01853" ": " "no SessionDBDselectlabel has been specified"); } while(0);
    ...
    rv = apr_dbd_pvbselect(dbd->driver, r->pool, dbd->handle, &res, statement,
                          0, key, &expiry, ((void*)0));
    if (rv) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 124, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01854" ": " "query execution error saving session '%s' " "in database using query '%s': %s", key, conf->selectlabel, apr_dbd_error(dbd->driver, dbd->handle, rv)); } while(0);
    ...
    for (rv = apr_dbd_get_row(dbd->driver, r->pool, res, &row, -1);
        ...
        if (rv != 0) {
            do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 134, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "01855" ": " "error retrieving results while saving '%s' " "in database using query '%s': %s", key, conf->selectlabel, apr_dbd_error(dbd->driver, dbd->handle, rv)); } while(0);
...
# 164 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c"
static apr_status_t session_dbd_load(request_rec * r, session_rec ** z)
{
    ...
    note = apr_pstrcat(r->pool, "mod_session_dbd", name, ((void*)0));
    ...
    zz->uuid = (apr_uuid_t *) memset(apr_palloc(zz->pool, sizeof(apr_uuid_t)), 0, sizeof(apr_uuid_t));
    if (key) {
                             ...
                             apr_int64_t expiry)
{
    ...
    if (conf->updatelabel == ((void*)0)) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 266, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01856" ": " "no SessionDBDupdatelabel has been specified"); } while(0);
    ...
    rv = apr_dbd_pvbquery(dbd->driver, r->pool, dbd->handle, &rows, statement,
                          val, &expiry, key, ((void*)0));
    if (rv) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 278, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01857" ": " "query execution error updating session '%s' " "using database query '%s': %s", key, conf->updatelabel, apr_dbd_error(dbd->driver, dbd->handle, rv)); } while(0);
    ...
    if (conf->insertlabel == ((void*)0)) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 294, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01858" ": " "no SessionDBDinsertlabel has been specified"); } while(0);
    ...
    rv = apr_dbd_pvbquery(dbd->driver, r->pool, dbd->handle, &rows, statement,
                          val, &expiry, key, ((void*)0));
    if (rv) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 306, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "01859" ": " "query execution error inserting session '%s' " "in database with '%s': %s", key, conf->insertlabel, apr_dbd_error(dbd->driver, dbd->handle, rv)); } while(0);
    ...
    do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 321, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01860" ": " "the session insert query did not cause any rows to be added " "to the database for session '%s', session not inserted", key); } while(0);
...
static apr_status_t dbd_remove(request_rec * r, const char *key)
{
    ...
    if (conf->deletelabel == ((void*)0)) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 344, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01862" ": " "no SessionDBDdeletelabel has been specified"); } while(0);
    ...
    rv = apr_dbd_pvbquery(dbd->driver, r->pool, dbd->handle, &rows, statement,
                          key, ((void*)0));
    if (rv != 0) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 359, (aplog_module_index ? *aplog_module_index : -1), 3, rv, r, "AH" "01864" ": " "query execution error removing session '%s' " "from database", key); } while(0);
...
# 376 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c"
...
# 397 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c"
static apr_status_t session_dbd_save(request_rec * r, session_rec * z)
{
    ...
    if (conf->name_set || conf->name2_set) {
        ...
        buffer = memset(apr_palloc(r->pool, 36 + 1), 0, 36 + 1);
        ...
        if (conf->name_set) {
            ap_cookie_write(r, conf->name, buffer, conf->name_attrs, z->maxage,
                            r->headers_out, r->err_headers_out, ((void*)0));
        }
        ...
        if (r->user) {
            ...
            do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", 456, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01865" ": " "peruser sessions can only be saved if a user is logged in, " "session not saved: %s", r->uri); } while(0);
...
static void *create_session_dbd_dir_config(apr_pool_t * p, char *dummy)
{
    ...
    (session_dbd_dir_conf *) memset(apr_palloc(p, sizeof(session_dbd_dir_conf)), 0, sizeof(session_dbd_dir_conf));
...
{
    session_dbd_dir_conf *new = (session_dbd_dir_conf *) memset(apr_palloc(p, sizeof(session_dbd_dir_conf)), 0, sizeof(session_dbd_dir_conf));
...
{
    if (0 != ap_cookie_check_string(string)) {
...
{
    { "SessionDBDSelectLabel", { .take1=ap_set_string_slot }, (void *) ((long) (((char *) (&(((session_dbd_dir_conf*)((void*)0))->selectlabel))) - ((char *) ((void*)0)))), 128|8, TAKE1, "Query label used to select a new session" },


    { "SessionDBDInsertLabel", { .take1=ap_set_string_slot }, (void *) ((long) (((char *) (&(((session_dbd_dir_conf*)((void*)0))->insertlabel))) - ((char *) ((void*)0)))), 128|8, TAKE1, "Query label used to insert a new session" },


    { "SessionDBDUpdateLabel", { .take1=ap_set_string_slot }, (void *) ((long) (((char *) (&(((session_dbd_dir_conf*)((void*)0))->updatelabel))) - ((char *) ((void*)0)))), 128|8, TAKE1, "Query label used to update an existing session" },


    { "SessionDBDDeleteLabel", { .take1=ap_set_string_slot }, (void *) ((long) (((char *) (&(((session_dbd_dir_conf*)((void*)0))->deletelabel))) - ((char *) ((void*)0)))), 128|8, TAKE1, "Query label used to delete an existing session" },


    { "SessionDBDPerUser", { .flag=set_dbd_peruser }, ((void*)0), 128|8, FLAG, "Save the session per user" },

    { "SessionDBDCookieRemove", { .flag=set_dbd_cookie_remove }, ((void*)0), 128|8, FLAG, "Remove the session cookie after session load. On by default." },

    { "SessionDBDCookieName", { .raw_args=set_cookie_name }, ((void*)0), 128|8, RAW_ARGS, "The name of the RFC2109 cookie carrying the session key" },

    { "SessionDBDCookieName2", { .raw_args=set_cookie_name2 }, ((void*)0), 128|8, RAW_ARGS, "The name of the RFC2965 cookie carrying the session key" },
...
{
    ap_hook_session_load(session_dbd_load, ((void*)0), ((void*)0), 10);
    ap_hook_session_save(session_dbd_save, ((void*)0), ((void*)0), 10);
    ap_hook_monitor(session_dbd_monitor, ((void*)0), ((void*)0), 10);
}

extern module session_dbd_module; static int * const aplog_module_index = &(session_dbd_module.module_index); module session_dbd_module =
{
    20120724, 7, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/session/mod_session_dbd.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
