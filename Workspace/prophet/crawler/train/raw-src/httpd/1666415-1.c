# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
# 17 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c"
...
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
apr_status_t apr_pollcb_poll(apr_pollcb_t *pollcb,
                                          ...
                                          void *baton);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c" 2
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c"
...
static adjusted_time_t get_now(rotate_config_t *config, apr_int32_t *offset)
{
    ...
    return ((tNow) / 1000000L) + utc_offset;
}
...
# 231 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c"
static void checkRotate(rotate_config_t *config, rotate_status_t *status)
{
    if (status->current.fd == ((void*)0)) {
        ...
        if (current_size > config->sRotation) {
            ...
            if (get_now(config, ((void*)0)) >= status->tLogEnd) {
                        ...
                        rotate_config_t *config, rotate_status_t *status)
{
    ...
    if ((rv = apr_procattr_create(&pattr, pool)) != 0) {
        char *error = apr_psprintf(pool, "post_rotate: apr_procattr_create failed " "for '%s': %pm\n", config->postrotate_prog, &rv);
    ...
    if (rv != 0) {
        char *error = apr_psprintf(pool, "post_rotate: could not set up process " "attributes for '%s': %pm\n", config->postrotate_prog,
    ...
    if (rv != 0) {
        char *error = apr_psprintf(pool, "Could not spawn post-rotate process " "'%s': %pm\n", config->postrotate_prog, &rv);
...
static void truncate_and_write_error(rotate_status_t *status, const char *message)
{
    ...
    if (apr_file_write_full(status->current.fd, message, buflen, ((void*)0)) != 0) {
        fprintf(stderr, "Error writing error (%s) to the file %s\n",
                message, status->current.name);
        exit(2);
    }
}
# 373 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c"
static void doRotate(rotate_config_t *config, rotate_status_t *status)
{
    ...
    if (config->use_strftime) {
        ...
        if (config->use_localtime)
            apr_time_exp_lt(&e, tNow - ((apr_time_t)(offset) * 1000000L));
        else
    ...
    if (config->create_path) {
        ...
        if (ptr && ptr > newlog.name) {
            ...
            rv = apr_dir_make_recursive(path, 0x0FFF, newlog.pool);
            if (rv != 0) {
...
# 511 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c"
...
int main (int argc, const char * const argv[])
{
    ...
    while ((rv = apr_getopt(opt, "lL:p:fdtvecn:", &c, &opt_arg)) == 0) {
    ...
    for (;;) {
        ...
        if (config.create_empty && config.tRotation) {
            polltimeout = status.tLogEnd ? status.tLogEnd - get_now(&config, ((void*)0)) : config.tRotation;
            if (polltimeout <= 0) {
...
# 741 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/support/rotatelogs.c"
        ...
        if (nWrite != nRead) {
            ...
            status.nMessCount++;
            apr_pool_create_ex(&pool, status.pool, ((void*)0), ((void*)0));
            error = apr_psprintf(pool, "Error %d writing to log file at offset %"
                                 "ld" ". %10d messages lost (%pm)\n",
        ...
        if (config.echo) {
            if (apr_file_write_full(f_stdout, buf, nRead, ((void*)0))) {
