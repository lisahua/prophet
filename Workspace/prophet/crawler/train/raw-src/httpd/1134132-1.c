# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
apr_status_t apr_bucket_file_enable_mmap(apr_bucket *b,
                                                      int enabled);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
# 1307 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1324 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1341 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
char * ap_field_noparam(apr_pool_t *p, const char *intype);
# 1351 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
char * ap_ht_time(apr_pool_t *p, apr_time_t t, const char *fmt, int gmt);
# 1364 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1383 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
char * ap_getword_white(apr_pool_t *p, const char **line);
# 1393 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
char * ap_getword_nulls(apr_pool_t *p, const char **line,
        char stop);
# 1415 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1432 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1455 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1489 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1507 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1594 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
apr_size_t ap_escape_errorlog_item(char *dest, const char *source,
                                               apr_size_t buflen);
# 1622 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1660 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1783 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1879 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1916 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
apr_bucket * ap_bucket_eor_create(apr_bucket_alloc_t *list,
                                              request_rec *r);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c" 2
...
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c"
static apr_status_t data_out_filter(ap_filter_t *f, apr_bucket_brigade *bb)
{
    ...
    if (!ctx) {
        ...
        ctx = f->ctx = memset(apr_palloc(r->pool, sizeof(*ctx)), 0, sizeof(*ctx));
        ctx->bb = apr_brigade_create(r->pool, f->c->bucket_alloc);

        type = apr_pstrdup(r->pool, r->content_type);
        if (type) {
            charset = (__extension__ (__builtin_constant_p (' ') && !__builtin_constant_p (type) && (' ') == '\0' ? (char *) __rawmemchr (type, ' ') : __builtin_strchr (type, ' ')));
            if (charset) {
                *charset++ = 0;
                end = (__extension__ (__builtin_constant_p (' ') && !__builtin_constant_p (charset) && (' ') == '\0' ? (char *) __rawmemchr (charset, ' ') : __builtin_strchr (charset, ' ')));
                if (end) {
                    *end++ = 0;
                }
            }
        ...
        apr_brigade_printf(ctx->bb, ((void*)0), ((void*)0), "data:%s%s;base64,",
    ...
    while (0 == rv && !(((&(bb)->list))->next == (struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) {
        const char *data;
        apr_size_t size;
        apr_size_t tail;
        apr_size_t len;
        ...
        if (((e)->type == &apr_bucket_type_eos)) {
            ...
            if (ctx->count) {
                len = apr_base64_encode_binary(encoded, ctx->overflow,
                        ctx->count);
                apr_brigade_write(ctx->bb, ((void*)0), ((void*)0), encoded, len - 1);
                ctx->count = 0;
            }
            ...
            if ((0 == rv) && (!(((&(bb)->list))->next == (struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))) {
        ...
        apr_brigade_partition(bb, (8000 / 4 * 3), &ee);


        if (0 == (rv = (e)->type->read(e, &data, &size, APR_BLOCK_READ))) {
            ...
            if (size) {
                ...
                apr_brigade_write(ctx->bb, ((void*)0), ((void*)0), buffer, len - 1);
            }
...
static const command_rec data_cmds[] = { { ((void*)0) } };

static void register_hooks(apr_pool_t *p)
{
    ap_register_output_filter("DATA", data_out_filter, ((void*)0),
            AP_FTYPE_RESOURCE);
}
extern module data_module; static int * const aplog_module_index = &(data_module.module_index); module data_module = { 20110605, 1, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_data.c", ((void*)0), ((void*)0), 0x41503234UL, ((void*)0),
    ((void*)0),
    ((void*)0),
    ((void*)0),
    ((void*)0),
