# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c" 2
# 17 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c"
# 1 "./ssl_private.h" 1
# 30 "./ssl_private.h"
...
# 751 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/http_core.h"
...
# 806 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/http_core.h"
...
# 824 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/http_core.h"
typedef struct {
...
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c" 2
...
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c" 2



static const char *extract_responder_uri(X509 *cert, apr_pool_t *pool)
{
    struct stack_st_ACCESS_DESCRIPTION *values;
    char *result = ((void*)0);
    int j;

    values = X509_get_ext_d2i(cert, 177, ((void*)0), ((void*)0));
    if (!values) {
        return ((void*)0);
    }

    for (j = 0; j < sk_num(((_STACK*) (1 ? (values) : (struct stack_st_ACCESS_DESCRIPTION*)0))) && !result; j++) {
        ACCESS_DESCRIPTION *value = ((ACCESS_DESCRIPTION *)sk_value(((_STACK*) (1 ? (values) : (struct stack_st_ACCESS_DESCRIPTION*)0)), (j)));


        if (OBJ_obj2nid(value->method) == 178
            && value->location->type == 6) {
                                          ...
                                          conn_rec *c, apr_pool_t *p)
{
    ...
    if (rv || !u->hostname) {
        do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c", 84, (aplog_module_index ? *aplog_module_index : -1), 7, rv, c, "failed to parse OCSP responder URI '%s'", s); } while(0);

        return ((void*)0);
    }

    if (strcasecmp(u->scheme, "http") != 0) {
        do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c", 90, (aplog_module_index ? *aplog_module_index : -1), 7, rv, c, "cannot handle OCSP responder URI '%s'", s); } while(0);
                                    ...
                                    server_rec *s, apr_pool_t *p)
{
    ...
    *certid = OCSP_cert_to_id(((void*)0), cert, ctx->current_issuer);
    if (!*certid || !OCSP_request_add0_id(req, *certid)) {
        ssl_log_ssl_error("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c",113, 3, s);
        do { const server_rec *sr = s; if (( (((3)&15) <= 5) || (sr == ((void*)0)) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (&(sr)->log)->module_levels == ((void*)0) || (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (&(sr)->log)->level : (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_error_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c", 114, (aplog_module_index ? *aplog_module_index : -1), 3, 0, sr, "could not retrieve certificate id"); } while(0);
...
{
    int rc = 0;
    OCSP_RESPONSE *response = ((void*)0);
    OCSP_BASICRESP *basicResponse = ((void*)0);
    OCSP_REQUEST *request = ((void*)0);
    OCSP_CERTID *certID = ((void*)0);
    apr_uri_t *ruri;
    ...
    if (request) {
        apr_interval_time_t to = sc->server->ocsp_responder_timeout == (-1) ?
                                 10 :
    ...
    if (rc == 0) {
        ...
        if (r != 0) {
            do { const server_rec *sr = s; if (( (((3)&15) <= 5) || (sr == ((void*)0)) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (&(sr)->log)->module_levels == ((void*)0) || (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (&(sr)->log)->level : (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_error_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c", 158, (aplog_module_index ? *aplog_module_index : -1), 3, 0, sr, "OCSP response not successful: %d", rc); } while(0);
    ...
    if (rc == 0) {
        ...
        if (!basicResponse) {
            ssl_log_ssl_error("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c",167, 3, s);
            do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c", 168, (aplog_module_index ? *aplog_module_index : -1), 3, 0, c, "could not retrieve OCSP basic response"); } while(0);
    ...
    if (rc == 0) {
        if (OCSP_check_nonce(request, basicResponse) != 1) {
            do { const server_rec *sr = s; if (( (((3)&15) <= 5) || (sr == ((void*)0)) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (&(sr)->log)->module_levels == ((void*)0) || (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (&(sr)->log)->level : (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_error_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c", 176, (aplog_module_index ? *aplog_module_index : -1), 3, 0, sr, "Bad OCSP responder answer (bad nonce)"); } while(0);
    ...
    if (rc == 0) {
        ...
        if (OCSP_basic_verify(basicResponse, ((void*)0), ctx->ctx, 0) != 1) {
            ssl_log_ssl_error("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c",185, 3, s);
            do { const server_rec *sr = s; if (( (((3)&15) <= 5) || (sr == ((void*)0)) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (&(sr)->log)->module_levels == ((void*)0) || (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (&(sr)->log)->level : (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_error_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c", 186, (aplog_module_index ? *aplog_module_index : -1), 3, 0, sr, "failed to verify the OCSP response"); } while(0);
    ...
    if (rc == 0) {
        int reason = -1, status;
        ASN1_GENERALIZEDTIME *thisup = ((void*)0), *nextup = ((void*)0);

        rc = OCSP_resp_find_status(basicResponse, certID, &status,
                                   &reason, ((void*)0), &thisup, &nextup);
        if (rc != 1) {
            ssl_log_ssl_error("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c",199, 3, s);
            ssl_log_cxerror("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c",200, 3, 0, c, cert,
        ...
        if (rc != 2) {
            long resptime_skew = sc->server->ocsp_resptime_skew == (-1) ?
                                 (60 * 5) : sc->server->ocsp_resptime_skew;
            ...
            if (vrc != 1) {
                ssl_log_ssl_error("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c",219, 3, s);
                ssl_log_cxerror("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c",220, 3, 0, c, cert,
...

        {
            ...
            const char *result =
                status == 0 ? "good" :
                (status == 1 ? "revoked" : "unknown");

            ssl_log_cxerror("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c",233, level, 0, c, cert,
                       ...
                       server_rec *s, conn_rec *c, apr_pool_t *pool)
{
    ...
    if (cert->valid && X509_check_issued(cert,cert) == 0) {
        do { if (( ((((7 + 2))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 2))&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/ssl_engine_ocsp.c", 257, (aplog_module_index ? *aplog_module_index : -1), (7 + 2), 0, c, "Skipping OCSP check for valid self-issued cert"); } while(0);
    ...
    apr_pool_create_ex(&vpool, pool, ((void*)0), ((void*)0));
    ...
    case 1:
        X509_STORE_CTX_set_error(ctx, 23);
        break;
