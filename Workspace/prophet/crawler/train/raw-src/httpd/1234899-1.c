...
char * ap_append_pid(apr_pool_t *p, const char *string,
                                 const char *delim);
# 1906 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 1951 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
typedef struct {
    const char *name;
...
# 1996 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 2077 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
void * ap_calloc(size_t nelem, size_t size)
                   __attribute__((malloc))
                                              ;
# 2162 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/include/httpd.h"
...
# 575 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
proxy_worker * ap_proxy_get_worker(apr_pool_t *p,
                                                  proxy_balancer *balancer,
                                                  proxy_server_conf *conf,
                                                  const char *url);
# 589 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
char * ap_proxy_define_worker(apr_pool_t *p,
                                             ...
                                             const char *url,
                                             int do_malloc);
# 603 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
apr_status_t ap_proxy_share_worker(proxy_worker *worker,
                                                  proxy_worker_shared *shm,
                                                  int i);
# 614 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
...
# 635 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
proxy_balancer * ap_proxy_get_balancer(apr_pool_t *p,
                                                      proxy_server_conf *conf,
                                                      const char *url,
                                                      int careactive);
# 647 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
char * ap_proxy_update_balancer(apr_pool_t *p,
                                               proxy_balancer *balancer,
                                               const char *url);
# 661 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
char * ap_proxy_define_balancer(apr_pool_t *p,
                                               ...
                                               const char *alias,
                                               int do_malloc);
# 675 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
apr_status_t ap_proxy_share_balancer(proxy_balancer *balancer,
                                                    proxy_balancer_shared *shm,
                                                    int i);
# 686 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
apr_status_t ap_proxy_initialize_balancer(proxy_balancer *balancer,
                                                         server_rec *s,
                                                         apr_pool_t *p);
# 701 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
int ap_proxy_pre_request(proxy_worker **worker,
                                        proxy_balancer **balancer,
                                        request_rec *r,
                                        proxy_server_conf *conf,
                                        char **url);
# 716 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
int ap_proxy_post_request(proxy_worker *worker,
                                         proxy_balancer *balancer,
                                         request_rec *r,
                                         proxy_server_conf *conf);
# 736 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
...
# 770 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
int ap_proxy_acquire_connection(const char *proxy_function,
                                               proxy_conn_rec **conn,
                                               proxy_worker *worker,
                                               server_rec *s);
# 782 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
int ap_proxy_release_connection(const char *proxy_function,
                                               proxy_conn_rec *conn,
                                               server_rec *s);
# 795 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
int ap_proxy_connect_backend(const char *proxy_function,
                                            proxy_conn_rec *conn,
                                            proxy_worker *worker,
                                            server_rec *s);
# 809 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
...
# 829 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
...
# 841 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
apr_status_t ap_proxy_set_wstatus(char c, int set, proxy_worker *w);
# 850 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
char * ap_proxy_parse_wstatus(apr_pool_t *p, proxy_worker *w);
# 860 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
apr_status_t ap_proxy_sync_balancer(proxy_balancer *b,
                                                   server_rec *s,
                                                   proxy_server_conf *conf);
# 872 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
int ap_proxy_trans_match(request_rec *r,
                                        struct proxy_alias *ent,
                                        proxy_dir_conf *dconf);
# 887 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/proxy/mod_proxy.h"
...
# 103 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/core_filters.c"
        return 0;
    }
    ...
    if (!ctx)
    {
        ...
        ctx = memset(apr_palloc(f->c->pool, sizeof(*ctx)), 0, sizeof(*ctx));
        ctx->b = apr_brigade_create(f->c->pool, f->c->bucket_alloc);
        ctx->tmpbb = apr_brigade_create(ctx->b->p, ctx->b->bucket_alloc);

        e = apr_bucket_socket_create(net->client_socket, f->c->bucket_alloc);
        do { apr_bucket *ap__b = (e); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&(ctx->b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&(ctx->b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&(ctx->b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&(ctx->b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
        net->in_ctx = ctx;
    }
    ...
    if (mode == AP_MODE_EATCRLF) {
        apr_bucket *e;
        const char *c;
# 167 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/core_filters.c"
        while (1) {
            if ((((&(ctx->b)->list))->next == (struct apr_bucket *)((char *)(&((&(ctx->b)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))
                return ((20000 + 50000) + 14);
...
# 206 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/core_filters.c"
...
# 248 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/core_filters.c"
            do { do { (((((e))))->link.prev)->link.next = ((((e))))->link.next; (((((e))))->link.next)->link.prev = ((((e))))->link.prev; } while (0); do { (e)->type->destroy((e)->data); (e)->free(e); } while (0); } while (0);
...
static apr_status_t sendfile_nonblocking(apr_socket_t *s,
                                         ...
                                         apr_size_t *cumulative_bytes_written,
                                         conn_rec *c);
# 363 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/core_filters.c"
...
apr_status_t ap_core_output_filter(ap_filter_t *f, apr_bucket_brigade *new_bb)
{
    ...
    if (ctx == ((void*)0)) {
        ...
        rv = apr_socket_opt_set(net->client_socket, 8, 1);
        if (rv != 0) {
            return rv;
        }
...
# 465 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/core_filters.c"
    if (new_bb == ((void*)0)) {
...
# 607 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/core_filters.c"
static apr_status_t send_brigade_nonblocking(apr_socket_t *s,
                                             apr_bucket_brigade *bb,
                                             apr_size_t *bytes_written,
                                             conn_rec *c)
                                         ...
                                         conn_rec *c)
{
    ...
    if (!((bucket)->type == &apr_bucket_type_file)) {
        do { const server_rec *sr = c->base_server; if (( (((3)&15) <= 5) || (sr == ((void*)0)) || (((((0) < 0 || (&(sr)->log)->module_levels == ((void*)0) || (&(sr)->log)->module_levels[0] < 0) ? (&(sr)->log)->level : (&(sr)->log)->module_levels[0])) >= ((3)&15) ) )) ap_log_error_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/server/core_filters.c", 820, 0, 3, rv, sr, "AH" "00006" ": " "core_filter: sendfile_nonblocking: " "this should never happen"); } while(0);
