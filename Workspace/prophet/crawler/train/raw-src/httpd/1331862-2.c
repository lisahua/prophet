# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c" 2
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/apreq_error.h" 1
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/apreq_error.h"
...
char * apr_strerror(apr_status_t statcode, char *buf,
                                 apr_size_t bufsize);
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/apreq_error.h" 2
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/apreq_error.h" 2
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/apreq_error.h"
char * apreq_strerror(apr_status_t s,
                                     char *buf,
                                     apr_size_t bufsize);
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c" 2
...
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c" 2
...
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c" 2
...
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c" 2
...
int apr_xml_insert_uri(apr_array_header_t *uri_array,
                                    const char *uri);
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c" 2
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/apreq_parser.c"
apreq_parser_t * apreq_parser_make(apr_pool_t *pool,
                                                  apr_bucket_alloc_t *ba,
                                                  const char *content_type,
                                                  apreq_parser_function_t pfn,
...
static apr_hash_t *default_parsers = ((void*)0);
static apr_pool_t *default_parser_pool = ((void*)0);

static apr_status_t apreq_parsers_cleanup(void *data)
{
    default_parsers_lock = 0;
    default_parsers = ((void*)0);
    default_parser_pool = ((void*)0);
...
apr_status_t apreq_pre_initialize(apr_pool_t *pool)
{
    ...
    if (default_parser_pool != ((void*)0))
        return 0;

    if (default_parsers_lock)
        return ((20000 + 50000) + 50000);

    status = apr_pool_create_ex(&default_parser_pool, pool, ((void*)0), ((void*)0));
    if (status != 0)
        return status;

    apr_pool_cleanup_register(default_parser_pool, ((void*)0),
...
apr_status_t apreq_register_parser(const char *enctype,
                                                  apreq_parser_function_t pfn)
{
    apreq_parser_function_t *f = ((void*)0);

    if (default_parsers == ((void*)0))
...
apreq_parser_function_t apreq_parser(const char *enctype)
{
    ...
    if (enctype == ((void*)0) || default_parsers_lock == 0)
        return ((void*)0);
...
apr_status_t apreq_hook_disable_uploads (apreq_hook_t *hook, apreq_param_t *param, apr_bucket_brigade *bb)
{
    return (bb == ((void*)0)) ? 0 : ((20000 + 50000) + 50000);
}
...
apr_status_t apreq_parse_generic (apreq_parser_t *parser, apr_table_t *t, apr_bucket_brigade *bb)
{
    ...
    if (ctx == ((void*)0)) {
        ...
        ctx->param->info = apr_table_make(pool, 8);
    }


    do { if (ctx->status == GEN_ERROR) return ((20000 + 50000) + 50000); else if (ctx->status == GEN_COMPLETE) return 0; else if (bb == ((void*)0)) return ((20000 + 50000) + 8); } while (0);;

    while (e != (struct apr_bucket *)((char *)(&(&(bb)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))) {
...
apr_status_t apreq_hook_apr_xml_parser (apreq_hook_t *hook, apreq_param_t *param, apr_bucket_brigade *bb)
{
    ...
    do { if (ctx->status == XML_ERROR) return ((20000 + 50000) + 50000); else if (ctx->status == XML_COMPLETE) return 0; else if (bb == ((void*)0)) return ((20000 + 50000) + 8); } while (0);;
         ...
         e = ((e))->link.next)
    {
        ...
        s = (e)->type->read(e, &data, &dlen, APR_BLOCK_READ);
...
apr_status_t apreq_hook_find_param (apreq_hook_t *hook, apreq_param_t *param, apr_bucket_brigade *bb)
{
    ...
    int is_final = (bb == ((void*)0)) || (((&(bb)->list)->prev)->type == &apr_bucket_type_eos);
    apr_status_t s = (hook->next == ((void*)0))
        ? 0 : apreq_hook_run(hook->next, param, bb);

    if (is_final && s == 0 && ctx->param == ((void*)0)
