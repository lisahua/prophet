# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c" 2
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c"
...
char * ap_get_exec_line(apr_pool_t *p,
                                    const char *cmd,
                                    const char * const *argv);
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c" 2
...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c" 2
...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c" 2
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c"
...
# 102 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c"
void ap_regfree(ap_regex_t *preg)
{
    (pcre_free)(preg->re_pcre);
}
# 123 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c"
int ap_regcomp(ap_regex_t * preg, const char *pattern, int cflags)
{
    ...
    preg->re_pcre =
        pcre_compile2(pattern, options, &errcode, &errorptr, &erroffset, ((void*)0));
    preg->re_erroffset = erroffset;

    if (preg->re_pcre == ((void*)0)) {
    ...
    pcre_fullinfo((const pcre *)preg->re_pcre, ((void*)0),
                   2, &(preg->re_nsub));
    return 0;
}
# 175 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_pcre.c"
int ap_regexec(const ap_regex_t *preg, const char *string,
