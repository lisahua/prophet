...
# 214 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/support/rotatelogs.c"
...
# 358 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/support/rotatelogs.c"
static void doRotate(rotate_config_t *config, rotate_status_t *status)
{
    ...
    rv = apr_file_open(&newlog.fd, newlog.name, 0x00002 | 0x00004 | 0x00008
                       | (config->truncate ? 0x00010 : 0), 0x0FFF, newlog.pool);
    if (rv == 0) {
...
# 458 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/support/rotatelogs.c"
...
int main (int argc, const char * const argv[])
{
    ...
    while ((rv = apr_getopt(opt, "lL:p:ftvec", &c, &opt_arg)) == 0) {
...
# 663 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/support/rotatelogs.c"
