# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c"
# 1 "./ssl_private.h" 1
# 30 "./ssl_private.h"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c" 2
# 1 "./mod_ssl.h" 1
# 34 "./mod_ssl.h"
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c" 2
# 58 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c"
static const command_rec ssl_config_cmds[] = {



    { "SSL""PassPhraseDialog", { .take1=ssl_cmd_SSLPassPhraseDialog }, ((void*)0), 128, TAKE1, "SSL dialog mechanism for the pass phrase query " "('builtin', '|/path/to/pipe_program', " "or 'exec:/path/to/cgi_program')" },



    { "SSL""SessionCache", { .take1=ssl_cmd_SSLSessionCache }, ((void*)0), 128, TAKE1, "SSL Session Cache storage " "('none', 'nonenotnull', 'dbm:/path/to/file')" },



    { "SSL""CryptoDevice", { .take1=ssl_cmd_SSLCryptoDevice }, ((void*)0), 128, TAKE1, "SSL external Crypto Device usage " "('builtin', '...')" },



    { "SSL""RandomSeed", { .take3=ssl_cmd_SSLRandomSeed }, ((void*)0), 128, TAKE23, "SSL Pseudo Random Number Generator (PRNG) seeding source " "('startup|connect builtin|file:/path|exec:/path [bytes]')" },
    ...
    { "SSL""Engine", { .take1=ssl_cmd_SSLEngine }, ((void*)0), 128, TAKE1, "SSL switch for the protocol engine " "('on', 'off')" },


    { "SSL""FIPS", { .flag=ssl_cmd_SSLFIPS }, ((void*)0), 128, FLAG, "Enable FIPS-140 mode " "(`on', `off')" },


    { "SSL""CipherSuite", { .take1=ssl_cmd_SSLCipherSuite }, ((void*)0), 128|8, TAKE1, "Colon-delimited list of permitted SSL Ciphers " "('XXX:...:XXX' - see manual)" },


    { "SSL""CertificateFile", { .take1=ssl_cmd_SSLCertificateFile }, ((void*)0), 128, TAKE1, "SSL Server Certificate file " "('/path/to/file' - PEM or DER encoded)" },


    { "SSL""CertificateKeyFile", { .take1=ssl_cmd_SSLCertificateKeyFile }, ((void*)0), 128, TAKE1, "SSL Server Private Key file " "('/path/to/file' - PEM or DER encoded)" },


    { "SSL""CertificateChainFile", { .take1=ssl_cmd_SSLCertificateChainFile }, ((void*)0), 128, TAKE1, "SSL Server CA Certificate Chain file " "('/path/to/file' - PEM encoded)" },


    { "SSL""PKCS7CertificateFile", { .take1=ssl_cmd_SSLPKCS7CertificateFile }, ((void*)0), 128, TAKE1, "PKCS#7 file containing server certificate and chain" " certificates ('/path/to/file' - PEM encoded)" },


    { "SSL""RSAAuthzFile", { .take1=ssl_cmd_SSLRSAAuthzFile }, ((void*)0), 128|8, TAKE1, "RFC 5878 Authz Extension file for RSA certificate " "(`/path/to/file')" },


    { "SSL""DSAAuthzFile", { .take1=ssl_cmd_SSLDSAAuthzFile }, ((void*)0), 128|8, TAKE1, "RFC 5878 Authz Extension file for DSA certificate " "(`/path/to/file')" },


    { "SSL""ECAuthzFile", { .take1=ssl_cmd_SSLECAuthzFile }, ((void*)0), 128|8, TAKE1, "RFC 5878 Authz Extension file for EC certificate " "(`/path/to/file')" },



    { "SSL""SessionTicketKeyFile", { .take1=ssl_cmd_SSLSessionTicketKeyFile }, ((void*)0), 128, TAKE1, "TLS session ticket encryption/decryption key file (RFC 5077) " "('/path/to/file' - file with 48 bytes of random data)" },



    { "SSL""CACertificatePath", { .take1=ssl_cmd_SSLCACertificatePath }, ((void*)0), 128|8, TAKE1, "SSL CA Certificate path " "('/path/to/dir' - contains PEM encoded files)" },


    { "SSL""CACertificateFile", { .take1=ssl_cmd_SSLCACertificateFile }, ((void*)0), 128|8, TAKE1, "SSL CA Certificate file " "('/path/to/file' - PEM encoded)" },


    { "SSL""CADNRequestPath", { .take1=ssl_cmd_SSLCADNRequestPath }, ((void*)0), 128, TAKE1, "SSL CA Distinguished Name path " "('/path/to/dir' - symlink hashes to PEM of acceptable CA names to request)" },


    { "SSL""CADNRequestFile", { .take1=ssl_cmd_SSLCADNRequestFile }, ((void*)0), 128, TAKE1, "SSL CA Distinguished Name file " "('/path/to/file' - PEM encoded to derive acceptable CA names to request)" },


    { "SSL""CARevocationPath", { .take1=ssl_cmd_SSLCARevocationPath }, ((void*)0), 128, TAKE1, "SSL CA Certificate Revocation List (CRL) path " "('/path/to/dir' - contains PEM encoded files)" },


    { "SSL""CARevocationFile", { .take1=ssl_cmd_SSLCARevocationFile }, ((void*)0), 128, TAKE1, "SSL CA Certificate Revocation List (CRL) file " "('/path/to/file' - PEM encoded)" },


    { "SSL""CARevocationCheck", { .take1=ssl_cmd_SSLCARevocationCheck }, ((void*)0), 128, TAKE1, "SSL CA Certificate Revocation List (CRL) checking mode" },

    { "SSL""VerifyClient", { .take1=ssl_cmd_SSLVerifyClient }, ((void*)0), 128|8, TAKE1, "SSL Client verify type " "('none', 'optional', 'require', 'optional_no_ca')" },


    { "SSL""VerifyDepth", { .take1=ssl_cmd_SSLVerifyDepth }, ((void*)0), 128|8, TAKE1, "SSL Client verify depth " "('N' - number of intermediate certificates)" },


    { "SSL""SessionCacheTimeout", { .take1=ssl_cmd_SSLSessionCacheTimeout }, ((void*)0), 128, TAKE1, "SSL Session Cache object lifetime " "('N' - number of seconds)" },
    ...
    { "SSL""Protocol", { .raw_args=ssl_cmd_SSLProtocol }, ((void*)0), 128, RAW_ARGS, "Enable or disable various SSL protocols " "('[+-][" "SSLv3|TLSv1|TLSv1.1|TLSv1.2" "] ...' - see manual)" },


    { "SSL""HonorCipherOrder", { .flag=ssl_cmd_SSLHonorCipherOrder }, ((void*)0), 128, FLAG, "Use the server's cipher ordering preference" },

    { "SSL""Compression", { .flag=ssl_cmd_SSLCompression }, ((void*)0), 128, FLAG, "Enable SSL level compression" "(`on', `off')" },


    { "SSL""InsecureRenegotiation", { .flag=ssl_cmd_SSLInsecureRenegotiation }, ((void*)0), 128, FLAG, "Enable support for insecure renegotiation" },

    { "SSL""UserName", { .take1=ssl_cmd_SSLUserName }, ((void*)0), 128|8, TAKE1, "Set user name to SSL variable value" },

    { "SSL""StrictSNIVHostCheck", { .flag=ssl_cmd_SSLStrictSNIVHostCheck }, ((void*)0), 128, FLAG, "Strict SNI virtual host checking" },



    { "SSL""SRPVerifierFile", { .take1=ssl_cmd_SSLSRPVerifierFile }, ((void*)0), 128, TAKE1, "SRP verifier file " "('/path/to/file' - created by srptool)" },


    { "SSL""SRPUnknownUserSeed", { .take1=ssl_cmd_SSLSRPUnknownUserSeed }, ((void*)0), 128, TAKE1, "SRP seed for unknown users (to avoid leaking a user's existence) " "('some secret text')" },
    ...
    { "SSL""ProxyEngine", { .flag=ssl_cmd_SSLProxyEngine }, ((void*)0), 128, FLAG, "SSL switch for the proxy protocol engine " "('on', 'off')" },


    { "SSL""ProxyProtocol", { .raw_args=ssl_cmd_SSLProxyProtocol }, ((void*)0), 128, RAW_ARGS, "SSL Proxy: enable or disable SSL protocol flavors " "('[+-][" "SSLv3|TLSv1|TLSv1.1|TLSv1.2" "] ...' - see manual)" },


    { "SSL""ProxyCipherSuite", { .take1=ssl_cmd_SSLProxyCipherSuite }, ((void*)0), 128, TAKE1, "SSL Proxy: colon-delimited list of permitted SSL ciphers " "('XXX:...:XXX' - see manual)" },


    { "SSL""ProxyVerify", { .take1=ssl_cmd_SSLProxyVerify }, ((void*)0), 128, TAKE1, "SSL Proxy: whether to verify the remote certificate " "('on' or 'off')" },


    { "SSL""ProxyVerifyDepth", { .take1=ssl_cmd_SSLProxyVerifyDepth }, ((void*)0), 128, TAKE1, "SSL Proxy: maximum certificate verification depth " "('N' - number of intermediate certificates)" },


    { "SSL""ProxyCACertificateFile", { .take1=ssl_cmd_SSLProxyCACertificateFile }, ((void*)0), 128, TAKE1, "SSL Proxy: file containing server certificates " "('/path/to/file' - PEM encoded certificates)" },


    { "SSL""ProxyCACertificatePath", { .take1=ssl_cmd_SSLProxyCACertificatePath }, ((void*)0), 128, TAKE1, "SSL Proxy: directory containing server certificates " "('/path/to/dir' - contains PEM encoded certificates)" },


    { "SSL""ProxyCARevocationPath", { .take1=ssl_cmd_SSLProxyCARevocationPath }, ((void*)0), 128, TAKE1, "SSL Proxy: CA Certificate Revocation List (CRL) path " "('/path/to/dir' - contains PEM encoded files)" },


    { "SSL""ProxyCARevocationFile", { .take1=ssl_cmd_SSLProxyCARevocationFile }, ((void*)0), 128, TAKE1, "SSL Proxy: CA Certificate Revocation List (CRL) file " "('/path/to/file' - PEM encoded)" },


    { "SSL""ProxyCARevocationCheck", { .take1=ssl_cmd_SSLProxyCARevocationCheck }, ((void*)0), 128, TAKE1, "SSL Proxy: CA Certificate Revocation List (CRL) checking mode" },

    { "SSL""ProxyMachineCertificateFile", { .take1=ssl_cmd_SSLProxyMachineCertificateFile }, ((void*)0), 128, TAKE1, "SSL Proxy: file containing client certificates " "('/path/to/file' - PEM encoded certificates)" },


    { "SSL""ProxyMachineCertificatePath", { .take1=ssl_cmd_SSLProxyMachineCertificatePath }, ((void*)0), 128, TAKE1, "SSL Proxy: directory containing client certificates " "('/path/to/dir' - contains PEM encoded certificates)" },


    { "SSL""ProxyMachineCertificateChainFile", { .take1=ssl_cmd_SSLProxyMachineCertificateChainFile }, ((void*)0), 128, TAKE1, "SSL Proxy: file containing issuing certificates " "of the client certificate " "(`/path/to/file' - PEM encoded certificates)" },



    { "SSL""ProxyCheckPeerExpire", { .flag=ssl_cmd_SSLProxyCheckPeerExpire }, ((void*)0), 128, FLAG, "SSL Proxy: check the peer certificate's expiration date" },

    { "SSL""ProxyCheckPeerCN", { .flag=ssl_cmd_SSLProxyCheckPeerCN }, ((void*)0), 128, FLAG, "SSL Proxy: check the peer certificate's CN" },

    { "SSL""ProxyCheckPeerName", { .flag=ssl_cmd_SSLProxyCheckPeerName }, ((void*)0), 128, FLAG, "SSL Proxy: check the peer certificate's name " "(must be present in subjectAltName extension or CN" },
    ...
    { "SSL""Options", { .raw_args=ssl_cmd_SSLOptions }, ((void*)0), 2, RAW_ARGS, "Set one or more options to configure the SSL engine" "('[+-]option[=value] ...' - see manual)" },


    { "SSL""RequireSSL", { .no_args=ssl_cmd_SSLRequireSSL }, ((void*)0), 8, RAW_ARGS, "Require the SSL protocol for the per-directory context " "(no arguments)" },


    { "SSL""Require", { .raw_args=ssl_cmd_SSLRequire }, ((void*)0), 8, RAW_ARGS, "Require a boolean expression to evaluate to true for granting access" "(arbitrary complex boolean expression - see manual)" },


    { "SSL""RenegBufferSize", { .take1=ssl_cmd_SSLRenegBufferSize }, ((void*)0), 8, TAKE1, "Configure the amount of memory that will be used for buffering the " "request body if a per-location SSL renegotiation is required due to " "changed access control requirements" },




    { "SSL""OCSPEnable", { .flag=ssl_cmd_SSLOCSPEnable }, ((void*)0), 128, FLAG, "Enable use of OCSP to verify certificate revocation ('on', 'off')" },

    { "SSL""OCSPDefaultResponder", { .take1=ssl_cmd_SSLOCSPDefaultResponder }, ((void*)0), 128, TAKE1, "URL of the default OCSP Responder" },

    { "SSL""OCSPOverrideResponder", { .flag=ssl_cmd_SSLOCSPOverrideResponder }, ((void*)0), 128, FLAG, "Force use of the default responder URL ('on', 'off')" },

    { "SSL""OCSPResponseTimeSkew", { .take1=ssl_cmd_SSLOCSPResponseTimeSkew }, ((void*)0), 128, TAKE1, "Maximum time difference in OCSP responses" },

    { "SSL""OCSPResponseMaxAge", { .take1=ssl_cmd_SSLOCSPResponseMaxAge }, ((void*)0), 128, TAKE1, "Maximum age of OCSP responses" },

    { "SSL""OCSPResponderTimeout", { .take1=ssl_cmd_SSLOCSPResponderTimeout }, ((void*)0), 128, TAKE1, "OCSP responder query timeout" },
    ...
    { "SSL""StaplingCache", { .take1=ssl_cmd_SSLStaplingCache }, ((void*)0), 128, TAKE1, "SSL Stapling Response Cache storage " "(`dbm:/path/to/file')" },


    { "SSL""UseStapling", { .flag=ssl_cmd_SSLUseStapling }, ((void*)0), 128, FLAG, "SSL switch for the OCSP Stapling protocol " "(`on', `off')" },

    { "SSL""StaplingResponseTimeSkew", { .take1=ssl_cmd_SSLStaplingResponseTimeSkew }, ((void*)0), 128, TAKE1, "SSL stapling option for maximum time difference in OCSP responses" },

    { "SSL""StaplingResponderTimeout", { .take1=ssl_cmd_SSLStaplingResponderTimeout }, ((void*)0), 128, TAKE1, "SSL stapling option for OCSP responder timeout" },

    { "SSL""StaplingResponseMaxAge", { .take1=ssl_cmd_SSLStaplingResponseMaxAge }, ((void*)0), 128, TAKE1, "SSL stapling option for maximum age of OCSP responses" },

    { "SSL""StaplingStandardCacheTimeout", { .take1=ssl_cmd_SSLStaplingStandardCacheTimeout }, ((void*)0), 128, TAKE1, "SSL stapling option for normal OCSP Response Cache Lifetime" },

    { "SSL""StaplingReturnResponderErrors", { .flag=ssl_cmd_SSLStaplingReturnResponderErrors }, ((void*)0), 128, FLAG, "SSL stapling switch to return Status Errors Back to Client" "(`on', `off')" },


    { "SSL""StaplingFakeTryLater", { .flag=ssl_cmd_SSLStaplingFakeTryLater }, ((void*)0), 128, FLAG, "SSL stapling switch to send tryLater response to client on error " "(`on', `off')" },


    { "SSL""StaplingErrorCacheTimeout", { .take1=ssl_cmd_SSLStaplingErrorCacheTimeout }, ((void*)0), 128, TAKE1, "SSL stapling option for OCSP Response Error Cache Lifetime" },

    { "SSL""StaplingForceURL", { .take1=ssl_cmd_SSLStaplingForceURL }, ((void*)0), 128, TAKE1, "SSL stapling option to Force the OCSP Stapling URL" },
# 289 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c"
    { "SSLLog", { .raw_args=ap_set_deprecated }, ((void*)0), (1|2|4|8|16), RAW_ARGS, "SSLLog directive is no longer supported - use ErrorLog." },

    { "SSLLogLevel", { .raw_args=ap_set_deprecated }, ((void*)0), (1|2|4|8|16), RAW_ARGS, "SSLLogLevel directive is no longer supported - use LogLevel." },
...
int modssl_run_npn_advertise_protos_hook (conn_rec *connection, apr_array_header_t *protos) { modssl_LINK_npn_advertise_protos_hook_t *pHook; int n; int rv; apr_array_header_t *pHookArray=apr_optional_hook_get("npn_advertise_protos_hook"); if(!pHookArray) return 0; pHook=( modssl_LINK_npn_advertise_protos_hook_t *)pHookArray->elts; for(n=0 ; n < pHookArray->nelts ; ++n) { rv=(pHook[n].pFunc)(connection, protos); if(rv != 0 && rv != -1) return rv; } return 0; }





int modssl_run_npn_proto_negotiated_hook (conn_rec *connection, const char *proto_name, apr_size_t proto_name_len) { modssl_LINK_npn_proto_negotiated_hook_t *pHook; int n; int rv; apr_array_header_t *pHookArray=apr_optional_hook_get("npn_proto_negotiated_hook"); if(!pHookArray) return 0; pHook=( modssl_LINK_npn_proto_negotiated_hook_t *)pHookArray->elts; for(n=0 ; n < pHookArray->nelts ; ++n) { rv=(pHook[n].pFunc)(connection, proto_name, proto_name_len); if(rv != 0 && rv != -1) return rv; } return 0; }
...
# 348 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c"
    return 0;
}
...
static int ssl_hook_pre_config(apr_pool_t *pconf,
                               ...
                               apr_pool_t *ptemp)
{
# 363 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c"
    ...
    apr_pool_cleanup_register(pconf, ((void*)0), ssl_cleanup_pre_config,
    ...
    ap_mutex_register(pconf, "ssl-cache", ((void*)0), APR_LOCK_DEFAULT, 0);

    ap_mutex_register(pconf, "ssl-stapling", ((void*)0), APR_LOCK_DEFAULT, 0);
...
static SSLConnRec *ssl_init_connection_ctx(conn_rec *c)
{
    ...
    sslconn = memset(apr_palloc(c->pool, sizeof(*sslconn)), 0, sizeof(*sslconn));

    sslconn->server = c->base_server;
    sslconn->verify_depth = (-1);

    ((((void **)(c->conn_config))[(&ssl_module)->module_index]) = (sslconn));
...
int ssl_engine_disable(conn_rec *c)
{
    ...
    if (sslconn) {
        ...
        sc = (SSLSrvConfigRec *)(((void **)(c->base_server->module_config))[(&ssl_module)->module_index]);
    }
...
int ssl_init_ssl_connection(conn_rec *c, request_rec *r)
{
    ...
    if (!(ssl = SSL_new(mctx->ssl_ctx))) {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c", 484, (aplog_module_index ? *aplog_module_index : -1), 3, 0, c, "AH" "01962" ": " "Unable to create a new SSL connection from the SSL " "context"); } while(0);


        ssl_log_ssl_error("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c",487, 3, server);
    ...
    if (!SSL_set_session_id_context(ssl, (unsigned char *)vhost_md5,
                                    16*2))
    {
        do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c", 500, (aplog_module_index ? *aplog_module_index : -1), 3, 0, c, "AH" "01963" ": " "Unable to set session id context to '%s'", vhost_md5); } while(0);

        ssl_log_ssl_error("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c",502, 3, server);
    ...
    (SSL_set_ex_data(ssl,0,(char *)c));
    SSL_set_app_data2(ssl, ((void*)0));
...
static int ssl_hook_pre_connection(conn_rec *c, void *csd)
{
    ...
    do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c", 588, (aplog_module_index ? *aplog_module_index : -1), 6, 0, c, "AH" "01964" ": " "Connection to child %ld established " "(server %s)", c->id, sc->vhost_id); } while(0);



    return ssl_init_ssl_connection(c, ((void*)0));
}
...
static void ssl_register_hooks(apr_pool_t *p)
{
    ...
    static const char *pre_prr[] = { "mod_setenvif.c", ((void*)0) };

    ssl_io_filter_register(p);

    ap_hook_pre_connection(ssl_hook_pre_connection,((void*)0),((void*)0), 10);
    ap_hook_test_config (ssl_hook_ConfigTest, ((void*)0),((void*)0), 10);
    ap_hook_post_config (ssl_init_Module, ((void*)0),((void*)0), 10);
    ap_hook_http_scheme (ssl_hook_http_scheme, ((void*)0),((void*)0), 10);
    ap_hook_default_port (ssl_hook_default_port, ((void*)0),((void*)0), 10);
    ap_hook_pre_config (ssl_hook_pre_config, ((void*)0),((void*)0), 10);
    ap_hook_child_init (ssl_init_Child, ((void*)0),((void*)0), 10);
    ap_hook_check_authn (ssl_hook_UserCheck, ((void*)0),((void*)0), 0,
                           1);
    ap_hook_fixups (ssl_hook_Fixup, ((void*)0),((void*)0), 10);
    ap_hook_check_access (ssl_hook_Access, ((void*)0),((void*)0), 10,
                           1);
    ap_hook_check_authz (ssl_hook_Auth, ((void*)0),((void*)0), 10,
                           1);
    ap_hook_post_read_request(ssl_hook_ReadReq, pre_prr,((void*)0), 10);

    ssl_var_register(p);

    do { apr_OFN_ssl_proxy_enable_t *apu__opt = ssl_proxy_enable; apr_dynamic_fn_register("ssl_proxy_enable",(apr_opt_fn_t *)apu__opt); } while (0);
    do { apr_OFN_ssl_engine_disable_t *apu__opt = ssl_engine_disable; apr_dynamic_fn_register("ssl_engine_disable",(apr_opt_fn_t *)apu__opt); } while (0);

    ap_register_auth_provider(p, "authz", "ssl",
                              "0",
                              &ssl_authz_provider_require_ssl,
                              1);

    ap_register_auth_provider(p, "authz", "ssl-verify-client",
                              "0",
...
module ssl_module = {
    20121222, 3, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/ssl/mod_ssl.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
