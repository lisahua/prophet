# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
apr_status_t apr_bucket_file_enable_mmap(apr_bucket *b,
                                                      int enabled);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/util_filter.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/util_filter.h"
...
char * ap_get_exec_line(apr_pool_t *p,
                                    const char *cmd,
                                    const char * const *argv);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/util_filter.h" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
apr_bucket * ap_bucket_eor_create(apr_bucket_alloc_t *list,
                                              request_rec *r);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
int ap_matches_request_vhost(request_rec *r, const char *host,
    apr_port_t port);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/util_charset.h" 1
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c" 2
...
static struct { apr_array_header_t *link_pre_read_request; apr_array_header_t *link_post_read_request; apr_array_header_t *link_log_transaction; apr_array_header_t *link_http_scheme; apr_array_header_t *link_default_port; apr_array_header_t *link_note_auth_failure; } _hooks;
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
                ap_filter_rec_t *ap_old_write_func = ((void*)0);
...
void ap_setup_make_content_type(apr_pool_t *pool)
{
    ...
    needcset_patterns[i] = ((void*)0);
    charset_pattern = apr_strmatch_precompile(pool, "charset=", 0);
}
# 107 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
const char *ap_make_content_type(request_rec *r, const char *type)
{
    ...
    if (conf->add_default_charset != (1)) {
        return type;
    }

    request_conf = (((void **)(r->request_config))[0]);
    ...
    if ((*((charset_pattern)->compare))((charset_pattern), (type), (type_len)) != ((void*)0)) {
        ...
        for (pcset = needcset_patterns; *pcset ; pcset++) {
            if ((*((*pcset)->compare))((*pcset), (type), (type_len)) != ((void*)0)) {
                ...
                type = apr_pstrcatv(r->pool, concat, 3, ((void*)0));
                break;
            }
        }
    }
...
# 171 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
apr_time_t ap_rationalize_mtime(request_rec *r, apr_time_t mtime)
{
    apr_time_t now;
# 184 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    now = (mtime < r->request_time) ? r->request_time : apr_time_now();
    return (mtime > now) ? now : mtime;
}
# 213 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
apr_status_t ap_rgetline_core(char **s, apr_size_t n,
                                          ...
                                          int fold, apr_bucket_brigade *bb)
{
    ...
    int do_alloc = (*s == ((void*)0)), saw_eos = 0;
    ...
    for (;;) {
             ...
             e = ((e))->link.next)
        {
            ...
            rv = (e)->type->read(e, &str, &len, APR_BLOCK_READ);
            if (rv != 0) {
                return rv;
            }
    ...
    if (last_char > *s && last_char[-1] == '\015') {
        last_char--;
    }
    *last_char = '\0';
...
# 380 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
            c = *str;
            if (c == '\040' || c == '\011') {
...
# 468 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
int ap_getline(char *s, int n, request_rec *r, int fold)
{
    char *tmp_s = s;
    apr_status_t rv;
    ...
    rv = ap_rgetline_core((&tmp_s), (n), (&len), (r), (fold), (tmp_bb));
...
# 511 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    while ((uri[0] == '/') && (uri[1] == '/')) {
        ++uri ;
    }
    ...
    if (status == 0) {
        ...
        r->uri = r->parsed_uri.path ? r->parsed_uri.path
                 : apr_pstrdup(r->pool, "/");
# 547 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    }
    else {
        r->args = ((void*)0);
        r->hostname = ((void*)0);
...
static int read_request_line(request_rec *r, apr_bucket_brigade *bb)
{
    ...
    core_server_config *conf = (((void **)(r->server->module_config))[0]);
    int strict = conf->http_conformance & 2;
    int enforce_strict = !(conf->http_conformance & 4);

    if (max_blank_lines <= 0) {
        max_blank_lines = 100;
    }
# 590 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    do {
        apr_status_t rv;
        ...
        r->the_request = ((void*)0);
        rv = ap_rgetline_core((&(r->the_request)), ((apr_size_t)(r->server->limit_req_line + 2)), (&len), (r), (0), (bb));
        ...
        if (rv != 0) {
            ...
            if (((rv) == 28 || (rv) == 122)) {
                r->status = 414;
                r->proto_num = (1000*(1)+(0));
                r->protocol = apr_pstrdup(r->pool, "HTTP/1.0");
            }
            else if (((rv) == ((20000 + 50000) + 7))) {
                r->status = 408;
            }
            else if (((rv) == 22)) {
                r->status = 400;
    ...
    if (( ((((7 + 5))&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= (((7 + 5))&15) ) )) {
        do { if (( ((((7 + 5))&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= (((7 + 5))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 623, 0, (7 + 5), 0, r, "Request received from client: %s", ap_escape_logitem(r->pool, r->the_request)); } while(0);
    ...
    if (r->method_number == 0 && r->method[0] == 'H') {
        r->header_only = 1;
    }
    ...
    if (len == 8
        ...
        && pro[4] == '/' && (((*__ctype_b_loc ())[(int) ((((unsigned char)(pro[5]))))] & (unsigned short int) _ISdigit)) && pro[6] == '.'
        && (((*__ctype_b_loc ())[(int) ((((unsigned char)(pro[7]))))] & (unsigned short int) _ISdigit))) {
        r->proto_num = (1000*(pro[5] - '0')+(pro[7] - '0'));
    }
    else {
        if (strict) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 674, 0, 7, 0, r, "AH" "02418" ": " "Invalid protocol '%s'", r->protocol); } while(0);
    ...
    if (strict) {
        ...
        if (ap_has_cntrl(r->the_request)) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 694, 0, 7, 0, r, "AH" "02420" ": " "Request line must not contain control characters"); } while(0);

            err = 400;
        }
        if (r->parsed_uri.fragment) {

            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 700, 0, 7, 0, r, "AH" "02421" ": " "URI must not contain a fragment"); } while(0);

            err = 400;
        }
        else if (r->parsed_uri.user || r->parsed_uri.password) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 705, 0, 7, 0, r, "AH" "02422" ": " "URI must not contain a username/password"); } while(0);

            err = 400;
        }
        else if (r->method_number == 26) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 710, 0, 7, 0, r, "AH" "02423" ": " "Invalid HTTP method string: %s", r->method); } while(0);

            err = 501;
        }
        else if (r->assbackwards == 0 && r->proto_num < (1000*(1)+(0))) {
            do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 715, 0, 7, 0, r, "AH" "02424" ": " "HTTP/0.x does not take a protocol"); } while(0);
...
{
    request_rec *r = r_;
    if (value == ((void*)0) || r->server->limit_req_fieldsize >= strlen(value) )
        return 1;
    ...
    apr_table_setn(r->notes, "error-notes",
                   apr_pstrcat(r->pool, "Size of a request header field "
                               ...
                               "\n<pre>\n",
                               ap_escape_html2(r->pool,key,0),
                               "</pre>\n", ((void*)0)));
    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 743, 0, 6, 0, r, "AH" "00560" ": " "Request header " "exceeds LimitRequestFieldSize after merging: %s", key); } while(0);
...
{
    const char *end = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (field) && (':') == '\0' ? (char *) __rawmemchr (field, ':') : __builtin_strchr (field, ':')));
    if (end == ((void*)0) || end - field > 80)
        return 80;
    return end - field;
}
...
void ap_get_mime_headers_core(request_rec *r, apr_bucket_brigade *bb)
{
    ...
    while(1) {
        ...
        field = ((void*)0);
        rv = ap_rgetline_core((&field), (r->server->limit_req_fieldsize + 2), (&len), (r), (0), (bb));
        ...
        if (rv != 0) {
            ...
            if (rv == 28) {
                ...
                if (field) {
                    ...
                    field[len - 1] = '\0';
                    field_escaped = ap_escape_html2(r->pool,field,0);
                }
                else {
                    field_escaped = field = "";
                }
                ...
                apr_table_setn(r->notes, "error-notes",
                               apr_psprintf(r->pool,
                                           ...
                                           field_escaped));
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 812, 0, 6, 0, r, "AH" "00561" ": " "Request header exceeds LimitRequestFieldSize%s" "%.*s", *field ? ": " : "", field_name_len(field), field); } while(0);
        ...
        if (last_field != ((void*)0)) {
            if ((len > 0) && ((*field == '\t') || *field == ' ')) {
                ...
                if (fold_len >= (apr_size_t)(r->server->limit_req_fieldsize)) {
                    ...
                    apr_table_setn(r->notes, "error-notes",
                                   apr_psprintf(r->pool,
                                               ...
                                               ap_escape_html2(r->pool,last_field,0)));
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 844, 0, 6, 0, r, "AH" "00562" ": " "Request header exceeds LimitRequestFieldSize " "after folding: %.*s", field_name_len(last_field), last_field); } while(0);
                ...
                if (r->server->limit_req_fields
                    ...
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 873, 0, 6, 0, r, "AH" "00563" ": " "Number of request headers exceeds " "LimitRequestFields"); } while(0);


                    return;
                }

                if (!(value = (__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (last_field) && (':') == '\0' ? (char *) __rawmemchr (last_field, ':') : __builtin_strchr (last_field, ':'))))) {
                    r->status = 400;
                    apr_table_setn(r->notes, "error-notes",
                                   apr_psprintf(r->pool,
                    ...
                    do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 889, 0, 6, 0, r, "AH" "00564" ": " "Request header field is missing ':' " "separator: %.*s", (int)80, last_field); } while(0);
                ...
                *value++ = '\0';
                ...
                if (conf->http_conformance & 2) {
                    ...
                    if (*last_field == '\0') {
                        err = 400;
                        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 922, 0, 6, 0, r, "AH" "02425" ": " "Empty request header field name not allowed"); } while(0);

                    }
                    else if (ap_has_cntrl(last_field)) {
                        err = 400;
                        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 927, 0, 6, 0, r, "AH" "02426" ": " "[HTTP strict] Request header field name contains " "control character: %.*s", (int)80, last_field); } while(0);
                        ...
                        err = 400;
                        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 934, 0, 6, 0, r, "AH" "02427" ": " "Request header field '%.*s' contains" "control character", (int)80, last_field); } while(0);



                    }
                    if (err && !(conf->http_conformance & 4)) {
                        r->status = err;
                        return;
                    }
                }
    ...
    apr_table_compress(r->headers_in, (1));


    apr_table_do(table_do_fn_check_lengths, r, r->headers_in, ((void*)0));
}
...
request_rec *ap_read_request(conn_rec *conn)
{
    ...
    apr_pool_create_ex(&p, conn->pool, ((void*)0), ((void*)0));
    apr_pool_tag(p, "request");
    r = memset(apr_palloc(p, sizeof(request_rec)), 0, sizeof(request_rec));
                                                       ;
    r->pool = p;
    r->connection = conn;
    ...
    if (!read_request_line(r, tmp_bb)) {
        ...
        case 501:
            if (r->status == 414) {
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1056, 0, 6, 0, r, "AH" "00565" ": " "request failed: client's request-line exceeds LimitRequestLine (longer than %d)", r->server->limit_req_line); } while(0);


            }
            else if (r->method == ((void*)0)) {
                do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1061, 0, 6, 0, r, "AH" "00566" ": " "request failed: invalid characters in URI"); } while(0);

            }
            ap_send_error_response(r, 0);
            ap_update_child_status(conn->sbh, 6, r);
    ...
    if (!r->assbackwards) {
        ap_get_mime_headers_core(r, tmp_bb);
        if (r->status != 200) {
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1096, 0, 6, 0, r, "AH" "00567" ": " "request failed: error reading the headers"); } while(0);
        ...
        if (r->header_only) {
            ...
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1123, 0, 6, 0, r, "AH" "00568" ": " "client sent invalid HTTP/0.9 request: HEAD %s", r->uri); } while(0);
    ...
    if ((!r->hostname && (r->proto_num >= (1000*(1)+(1))))
        ...
        access_status = 400;
        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1166, 0, 6, 0, r, "AH" "00569" ": " "client sent HTTP/1.1 request without hostname " "(see RFC2616 section 14.23): %s", r->uri); } while(0);


    }
# 1178 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
    ap_add_input_filter_handle(ap_http_input_filter_handle,
                               ((void*)0), r, r->connection);
    ...
    if (((expect = apr_table_get(r->headers_in, "Expect")) != ((void*)0))
        && (expect[0] != '\0')) {
        ...
        if (strcasecmp(expect, "100-continue") == 0) {
            ...
            r->status = 417;
            do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1203, 0, 6, 0, r, "AH" "00570" ": " "client sent an unrecognized expectation value of " "Expect: %s", expect); } while(0);
...
# 1246 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
...
static void error_output_stream(request_rec *r, int status)
{
    ...
    b = ap_bucket_error_create(status, ((void*)0), r->pool,
...
int ap_get_basic_auth_pw(request_rec *r, const char **pw)
{
    ...
    if (!ap_auth_name(r)) {
        do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1371, 0, 3, 0, r, "AH" "00572" ": " "need AuthName: %s", r->uri); } while(0);
    ...
    if (strcasecmp(ap_getword(r->pool, &auth_line, ' '), "Basic")) {
        ...
        do { if (( (((6)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1383, 0, 6, 0, r, "AH" "00573" ": " "client used wrong authentication scheme: %s", r->uri); } while(0);
    ...
    apr_bucket_brigade *b)
{
    ...
    e = (&(b)->list)->next;
    while (e != (struct apr_bucket *)((char *)(&(&(b)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))) {
        if (((e)->type == &apr_bucket_type_eos)) {
            eos = 1;
            break;
        }
        if (e->length == (apr_size_t)-1) {
            ...
            if (rv == 0) {
                ...
                if (e != (&(b)->list)->next) {
                    ...
                    do { apr_bucket *ap__b = (flush); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&(b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&(b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&(b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&(b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
                    rv = ap_pass_brigade(f->next, b);
                    if (rv != 0 || f->c->aborted) {
                        return rv;
                    }
                    apr_brigade_cleanup(b);
                    do { do { if (!((((&(ctx->tmpbb)->list)))->next == (struct apr_bucket *)((char *)(&(((&(ctx->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) { do { ((((&(ctx->tmpbb)->list))->prev))->link.next = ((struct apr_bucket *)((char *)(&((&(b)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))); ((((&(ctx->tmpbb)->list))->next))->link.prev = (((struct apr_bucket *)((char *)(&((&(b)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&((&(b)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev)->link.next = (((&(ctx->tmpbb)->list))->next); (((struct apr_bucket *)((char *)(&((&(b)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev = (((&(ctx->tmpbb)->list))->prev); } while (0); do { (((&(ctx->tmpbb)->list)))->next = (struct apr_bucket *)((char *)(&(((&(ctx->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))); (((&(ctx->tmpbb)->list)))->prev = (struct apr_bucket *)((char *)(&(((&(ctx->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))); } while (0); } } while (0); ; } while (0);
                    e = (&(b)->list)->next;
                ...
                do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1477, 0, 3, rv, r, "AH" "00574" ": " "ap_content_length_filter: " "apr_bucket_read() failed"); } while(0);
...
# 1506 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c"
...
apr_status_t ap_send_fd(apr_file_t *fd, request_rec *r,
                                    apr_off_t offset, apr_size_t len,
                                    apr_size_t *nbytes)
{
    conn_rec *c = r->connection;
    apr_bucket_brigade *bb = ((void*)0);
    apr_status_t rv;
...
static ap_filter_t *insert_old_write_filter(request_rec *r)
{
    ...
    for (f = r->output_filters; f != ((void*)0); f = f->next) {
    ...
    if (f == ((void*)0)) {
        ...
        ctx = memset(apr_palloc(r->pool, sizeof(*ctx)), 0, sizeof(*ctx));
        ctx->tmpbb = apr_brigade_create(r->pool, r->connection->bucket_alloc);
                                  ...
                                  const char *str, apr_size_t len)
{
    ...
    if (f != r->output_filters) {
        ...
        do { apr_bucket *ap__b = (b); do { ((((ap__b))))->link.next = ((struct apr_bucket *)((char *)(&(((&(ctx->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))); ((((ap__b))))->link.prev = (((struct apr_bucket *)((char *)(&(((&(ctx->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&(((&(ctx->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev)->link.next = (((ap__b))); (((struct apr_bucket *)((char *)(&(((&(ctx->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev = (((ap__b))); } while (0); ; } while (0);
    ...
    return apr_brigade_write(ctx->bb, ap_filter_flush, f->next, str, len);
}
...
int ap_rwrite(const void *buf, int nbyte, request_rec *r)
{
    ...
    if (buffer_output(r, buf, nbyte) != 0)
        return -1;
...
static int r_flush(apr_vformatter_buff_t *buff)
{
    ...
    if (buffer_output(vd->r, vd->buff, 8192)) {
        return -1;
    }
...
int ap_vrprintf(request_rec *r, const char *fmt, va_list va)
{
    ...
    if (written != -1) {
        ...
        if (buffer_output(r, vrprintf_buf,n) != 0)
            return -1;
...
int ap_rvputs(request_rec *r, ...)
{
    ...
    __builtin_va_start(va, r);
    while (1) {
        s = __builtin_va_arg(va, const char *);
        if (s == ((void*)0))
            break;

        len = strlen(s);
        if (buffer_output(r, s, len) != 0) {
            return -1;
        }
...
void ap_set_last_modified(request_rec *r)
{
    if (!r->assbackwards) {
        ...
        char *datestr = apr_palloc(r->pool, (30));
...
static int send_header(void *data, const char *key, const char *val)
{
    ap_fputstrs(((hdr_ptr*)data)->f, ((hdr_ptr*)data)->bb,
                key, ": ", val, "\015\012", ((void*)0));
    return 1;
}
void ap_send_interim_response(request_rec *r, int send_headers)
{
    hdr_ptr x;
    char *status_line = ((void*)0);
    request_rec *rr;

    if (r->proto_num < (1000*(1)+(1))) {

        return;
    }
    if (!(((r->status) >= 100)&&((r->status) < 200))) {
        do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/protocol.c", 1835, 0, 7, 0, r, "AH" "00575" ": " "Status is %d - not sending interim response", r->status); } while(0);

        return;
    }
    if ((r->status == 100) && !r->expecting_100) {
    ...
    for (rr = r; rr != ((void*)0); rr = rr->main) {
        rr->expecting_100 = 0;
    }

    status_line = apr_pstrcat(r->pool, "HTTP/1.1", " ", r->status_line, "\015\012", ((void*)0));
                                                             ;

    x.f = r->connection->output_filters;
    x.bb = apr_brigade_create(r->pool, r->connection->bucket_alloc);

    apr_brigade_write(x.bb, ap_filter_flush, x.f, status_line, strlen(status_line));
    if (send_headers) {
        apr_table_do(send_header, &x, r->headers_out, ((void*)0));
        apr_table_clear(r->headers_out);
    }
    apr_brigade_write(x.bb, ap_filter_flush, x.f, "\015\012", strlen("\015\012"));
    ap_fflush(x.f, x.bb);
    apr_brigade_destroy(x.bb);
}


void ap_hook_pre_read_request(ap_HOOK_pre_read_request_t *pf,const char * const *aszPre, const char * const *aszSucc,int nOrder) { ap_LINK_pre_read_request_t *pHook; if(!_hooks.link_pre_read_request) { _hooks.link_pre_read_request=apr_array_make(apr_hook_global_pool,1,sizeof(ap_LINK_pre_read_request_t)); apr_hook_sort_register("pre_read_request",&_hooks.link_pre_read_request); } pHook=apr_array_push(_hooks.link_pre_read_request); pHook->pFunc=pf; pHook->aszPredecessors=aszPre; pHook->aszSuccessors=aszSucc; pHook->nOrder=nOrder; pHook->szName=apr_hook_debug_current; if(apr_hook_debug_enabled) apr_hook_debug_show("pre_read_request",aszPre,aszSucc); } apr_array_header_t * ap_hook_get_pre_read_request(void) { return _hooks.link_pre_read_request; } void ap_run_pre_read_request (request_rec *r, conn_rec *c) { ap_LINK_pre_read_request_t *pHook; int n; ; ; if(_hooks.link_pre_read_request) { pHook=(ap_LINK_pre_read_request_t *)_hooks.link_pre_read_request->elts; for(n=0 ; n < _hooks.link_pre_read_request->nelts ; ++n) { ; pHook[n].pFunc (r, c); ; } } ; }


void ap_hook_post_read_request(ap_HOOK_post_read_request_t *pf,const char * const *aszPre, const char * const *aszSucc,int nOrder) { ap_LINK_post_read_request_t *pHook; if(!_hooks.link_post_read_request) { _hooks.link_post_read_request=apr_array_make(apr_hook_global_pool,1,sizeof(ap_LINK_post_read_request_t)); apr_hook_sort_register("post_read_request",&_hooks.link_post_read_request); } pHook=apr_array_push(_hooks.link_post_read_request); pHook->pFunc=pf; pHook->aszPredecessors=aszPre; pHook->aszSuccessors=aszSucc; pHook->nOrder=nOrder; pHook->szName=apr_hook_debug_current; if(apr_hook_debug_enabled) apr_hook_debug_show("post_read_request",aszPre,aszSucc); } apr_array_header_t * ap_hook_get_post_read_request(void) { return _hooks.link_post_read_request; } int ap_run_post_read_request (request_rec *r) { ap_LINK_post_read_request_t *pHook; int n; int rv = 0; ; ; if(_hooks.link_post_read_request) { pHook=(ap_LINK_post_read_request_t *)_hooks.link_post_read_request->elts; for(n=0 ; n < _hooks.link_post_read_request->nelts ; ++n) { ; rv=pHook[n].pFunc (r); ; if(rv != 0 && rv != -1) break; rv = 0; } } ; return rv; }

void ap_hook_log_transaction(ap_HOOK_log_transaction_t *pf,const char * const *aszPre, const char * const *aszSucc,int nOrder) { ap_LINK_log_transaction_t *pHook; if(!_hooks.link_log_transaction) { _hooks.link_log_transaction=apr_array_make(apr_hook_global_pool,1,sizeof(ap_LINK_log_transaction_t)); apr_hook_sort_register("log_transaction",&_hooks.link_log_transaction); } pHook=apr_array_push(_hooks.link_log_transaction); pHook->pFunc=pf; pHook->aszPredecessors=aszPre; pHook->aszSuccessors=aszSucc; pHook->nOrder=nOrder; pHook->szName=apr_hook_debug_current; if(apr_hook_debug_enabled) apr_hook_debug_show("log_transaction",aszPre,aszSucc); } apr_array_header_t * ap_hook_get_log_transaction(void) { return _hooks.link_log_transaction; } int ap_run_log_transaction (request_rec *r) { ap_LINK_log_transaction_t *pHook; int n; int rv = 0; ; ; if(_hooks.link_log_transaction) { pHook=(ap_LINK_log_transaction_t *)_hooks.link_log_transaction->elts; for(n=0 ; n < _hooks.link_log_transaction->nelts ; ++n) { ; rv=pHook[n].pFunc (r); ; if(rv != 0 && rv != -1) break; rv = 0; } } ; return rv; }

void ap_hook_http_scheme(ap_HOOK_http_scheme_t *pf,const char * const *aszPre, const char * const *aszSucc,int nOrder) { ap_LINK_http_scheme_t *pHook; if(!_hooks.link_http_scheme) { _hooks.link_http_scheme=apr_array_make(apr_hook_global_pool,1,sizeof(ap_LINK_http_scheme_t)); apr_hook_sort_register("http_scheme",&_hooks.link_http_scheme); } pHook=apr_array_push(_hooks.link_http_scheme); pHook->pFunc=pf; pHook->aszPredecessors=aszPre; pHook->aszSuccessors=aszSucc; pHook->nOrder=nOrder; pHook->szName=apr_hook_debug_current; if(apr_hook_debug_enabled) apr_hook_debug_show("http_scheme",aszPre,aszSucc); } apr_array_header_t * ap_hook_get_http_scheme(void) { return _hooks.link_http_scheme; } const char * ap_run_http_scheme (const request_rec *r) { ap_LINK_http_scheme_t *pHook; int n; const char * rv = ((void*)0); ; ; if(_hooks.link_http_scheme) { pHook=(ap_LINK_http_scheme_t *)_hooks.link_http_scheme->elts; for(n=0 ; n < _hooks.link_http_scheme->nelts ; ++n) { ; rv=pHook[n].pFunc (r); ; if(rv != ((void*)0)) break; } } ; return rv; }

void ap_hook_default_port(ap_HOOK_default_port_t *pf,const char * const *aszPre, const char * const *aszSucc,int nOrder) { ap_LINK_default_port_t *pHook; if(!_hooks.link_default_port) { _hooks.link_default_port=apr_array_make(apr_hook_global_pool,1,sizeof(ap_LINK_default_port_t)); apr_hook_sort_register("default_port",&_hooks.link_default_port); } pHook=apr_array_push(_hooks.link_default_port); pHook->pFunc=pf; pHook->aszPredecessors=aszPre; pHook->aszSuccessors=aszSucc; pHook->nOrder=nOrder; pHook->szName=apr_hook_debug_current; if(apr_hook_debug_enabled) apr_hook_debug_show("default_port",aszPre,aszSucc); } apr_array_header_t * ap_hook_get_default_port(void) { return _hooks.link_default_port; } unsigned short ap_run_default_port (const request_rec *r) { ap_LINK_default_port_t *pHook; int n; unsigned short rv = 0; ; ; if(_hooks.link_default_port) { pHook=(ap_LINK_default_port_t *)_hooks.link_default_port->elts; for(n=0 ; n < _hooks.link_default_port->nelts ; ++n) { ; rv=pHook[n].pFunc (r); ; if(rv != 0) break; } } ; return rv; }

void ap_hook_note_auth_failure(ap_HOOK_note_auth_failure_t *pf,const char * const *aszPre, const char * const *aszSucc,int nOrder) { ap_LINK_note_auth_failure_t *pHook; if(!_hooks.link_note_auth_failure) { _hooks.link_note_auth_failure=apr_array_make(apr_hook_global_pool,1,sizeof(ap_LINK_note_auth_failure_t)); apr_hook_sort_register("note_auth_failure",&_hooks.link_note_auth_failure); } pHook=apr_array_push(_hooks.link_note_auth_failure); pHook->pFunc=pf; pHook->aszPredecessors=aszPre; pHook->aszSuccessors=aszSucc; pHook->nOrder=nOrder; pHook->szName=apr_hook_debug_current; if(apr_hook_debug_enabled) apr_hook_debug_show("note_auth_failure",aszPre,aszSucc); } apr_array_header_t * ap_hook_get_note_auth_failure(void) { return _hooks.link_note_auth_failure; } int ap_run_note_auth_failure (request_rec *r, const char *auth_type) { ap_LINK_note_auth_failure_t *pHook; int n; int rv = -1; ; ; if(_hooks.link_note_auth_failure) { pHook=(ap_LINK_note_auth_failure_t *)_hooks.link_note_auth_failure->elts; for(n=0 ; n < _hooks.link_note_auth_failure->nelts ; ++n) { ; rv=pHook[n].pFunc (r, auth_type); ; if(rv != -1) break; } } ; return rv; }
