# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c"
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
...
apr_bucket * ap_bucket_eor_create(apr_bucket_alloc_t *list,
                                              request_rec *r);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c" 2
                                      ...
                                      int use_regex)
{
    ...
    if (use_regex) {
        new->regexp = ap_pregcomp(cmd->pool, fake, (0));
    ...
    if (!use_regex) {
        for (i = 0; i < conf->aliases->nelts - 1; ++i) {
            ...
            if ( (!alias->regexp && alias_matches(fake, alias->fake) > 0)
                || (alias->regexp && !ap_regexec(alias->regexp, fake, 0, ((void*)0), 0))) {
                do { const server_rec *sr = cmd->server; if (( (((4)&15) <= 5) || (sr == ((void*)0)) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (&(sr)->log)->module_levels == ((void*)0) || (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (&(sr)->log)->level : (&(sr)->log)->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((4)&15) ) )) ap_log_error_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c", 140, (aplog_module_index ? *aplog_module_index : -1), 4, 0, sr, "The %s directive in %s at line %d will probably " "never match because it overlaps an earlier " "%sAlias%s.", cmd->cmd->name, cmd->directive->filename, cmd->directive->line_num, alias->handler ? "Script" : "", alias->regexp ? "Match" : ""); } while(0);
# 149 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c"
                break;
            }
        }
    }
                                         ...
                                         const char *arg3, int use_regex)
{
    ...
    int grokarg1 = 1;
    ap_regex_t *regex = ((void*)0);
    const char *fake = arg2;
    const char *url = arg3;
# 191 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c"
    ...
    if (use_regex) {
        regex = ap_pregcomp(cmd->pool, fake, (0));
        if (regex == ((void*)0))
            return "Regular expression could not be compiled.";
    }
                            ...
                            int doesc, int *status)
{
    ...
    for (i = 0; i < aliases->nelts; ++i) {
        ...
        if (alias->regexp) {
            if (!ap_regexec(alias->regexp, r->uri, 10, regm, 0)) {
                if (alias->real) {
            ...
            if (l > 0) {
                if (doesc) {
                    ...
                    found = apr_pstrcat(r->pool, alias->real, escurl, ((void*)0));
                }
                else
                    found = apr_pstrcat(r->pool, alias->real, r->uri + l, ((void*)0));
            }
        }
...
static int translate_alias_redir(request_rec *r)
{
    ...
    if ((ret = try_alias_list(r, serverconf->redirects, 1, &status)) != ((void*)0)) {
        if ((((status) >= 300)&&((status) < 400))) {
            ...
            if (!ap_is_url(ret)) {
                status = 500;
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c", 439, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "cannot redirect '%s' to '%s'; " "target is not a valid absoluteURI or abs_path", r->uri, ret); } while(0);
                ...
                if (r->args && !(__extension__ (__builtin_constant_p ('?') && !__builtin_constant_p (ret) && ('?') == '\0' ? (char *) __rawmemchr (ret, '?') : __builtin_strchr (ret, '?')))) {
    ...
    if ((ret = try_alias_list(r, dirconf->redirects, 1, &status)) != ((void*)0)) {
        if ((((status) >= 300)&&((status) < 400))) {
            if (ret[0] == '/') {
                ...
                ret = ap_construct_url(r->pool, ret, r);
                do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c", 481, (aplog_module_index ? *aplog_module_index : -1), 7, 0, r, "incomplete redirection target of '%s' for " "URI '%s' modified to '%s'", orig_target, r->uri, ret); } while(0);
            ...
            if (!ap_is_url(ret)) {
                status = 500;
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c", 488, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "cannot redirect '%s' to '%s'; " "target is not a valid absoluteURI or abs_path", r->uri, ret); } while(0);
...
extern module alias_module; static int * const aplog_module_index = &(alias_module.module_index); module alias_module =
{
    20110329, 0, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/mappers/mod_alias.c", ((void*)0), ((void*)0), 0x41503234UL, ((void*)0),
