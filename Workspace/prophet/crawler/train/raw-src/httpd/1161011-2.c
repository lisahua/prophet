...
# 751 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/http_core.h"
...
# 806 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/http_core.h"
...
# 824 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/http_core.h"
typedef struct {
...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_provider.h"
apr_status_t ap_register_provider(apr_pool_t *pool,
                                              const char *provider_group,
                                              const char *provider_name,
                                              const char *provider_version,
                                              const void *provider);
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_provider.h"
void * ap_lookup_provider(const char *provider_group,
                                      const char *provider_name,
                                      const char *provider_version);
# 77 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_provider.h"
...
# 127 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_socache.h"
...
# 150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_socache.h"
    apr_status_t (*store)(ap_socache_instance_t *instance, server_rec *s,
                          const unsigned char *id, unsigned int idlen,
                          apr_time_t expiry,
                          unsigned char *data, unsigned int datalen,
                          apr_pool_t *pool);
# 169 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_socache.h"
    apr_status_t (*retrieve)(ap_socache_instance_t *instance, server_rec *s,
                             const unsigned char *id, unsigned int idlen,
                             unsigned char *data, unsigned int *datalen,
                             apr_pool_t *pool);
# 181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_socache.h"
    apr_status_t (*remove)(ap_socache_instance_t *instance, server_rec *s,
                           const unsigned char *id, unsigned int idlen,
                           apr_pool_t *pool);
# 193 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_socache.h"
    void (*status)(ap_socache_instance_t *instance, request_rec *r, int flags);
# 206 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_socache.h"
...
# 470 "/usr/include/openssl/ssl.h" 3 4
...
# 815 "/usr/include/openssl/ssl.h" 3 4
 ...
 SRP_CTX srp_ctx;
# 976 "/usr/include/openssl/ssl.h" 3 4
...
# 1115 "/usr/include/openssl/ssl.h" 3 4
struct ssl_st
 {
 ...
 BIO *wbio;
 BIO *bbio;
# 1143 "/usr/include/openssl/ssl.h" 3 4
 int rwstate;


 int in_handshake;
 int (*handshake_func)(SSL *);
# 1157 "/usr/include/openssl/ssl.h" 3 4
 int server;
...
# 1225 "/usr/include/openssl/ssl.h" 3 4
 ...
 SSL_CTX * initial_ctx;
# 1338 "/usr/include/openssl/ssl.h" 3 4
...
# 406 "/usr/include/openssl/ssl3.h" 3 4
...
# 118 "/usr/include/openssl/dtls1.h" 3 4
...
unsigned int SSL_X509_getCN(apr_pool_t *, X509 *, char **);
...
int SSL_X509_INFO_create_chain(const X509 *, struct stack_st_X509_INFO *, struct stack_st_X509_INFO *);
# 162 "./ssl_private.h" 2
...
typedef struct {
    ...
    struct stack_st_X509_INFO **ca_certs;
} modssl_pk_proxy_t;
...
X509_STORE *SSL_X509_STORE_create(char *cpFile, char *cpPath)
{
    ...
    if (cpFile == ((void*)0) && cpPath == ((void*)0))
        return ((void*)0);
    if ((pStore = X509_STORE_new()) == ((void*)0))
        return ((void*)0);
    if (cpFile != ((void*)0)) {
        ...
        rv = X509_LOOKUP_ctrl((pLookup),1,(cpFile),(long)(1),((void*)0));
    }
    if (cpPath != ((void*)0) && rv == 1) {
        pLookup = X509_STORE_add_lookup(pStore, X509_LOOKUP_hash_dir());
        if (pLookup == ((void*)0)) {
            X509_STORE_free(pStore);
            return ((void*)0);
        }
        rv = X509_LOOKUP_ctrl((pLookup),2,(cpPath),(long)(1),((void*)0));
    }
    return rv == 1 ? pStore : ((void*)0);
}
                          ...
                          X509_NAME *pName, X509_OBJECT *pObj)
{
    ...
    X509_STORE_CTX_init(&pStoreCtx, pStore, ((void*)0), ((void*)0));
...
char *SSL_make_ciphersuite(apr_pool_t *p, SSL *ssl)
{
    ...
    if (ssl == ((void*)0))
        return "";
    if ((sk = (struct stack_st_SSL_CIPHER *)SSL_get_ciphers(ssl)) == ((void*)0))
        return "";
    l = 0;
    for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_SSL_CIPHER*)0))); i++) {
        c = ((SSL_CIPHER *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_SSL_CIPHER*)0)), (i)));
...
# 282 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
...
unsigned int SSL_X509_getCN(apr_pool_t *p, X509 *xs, char **cppCN)
{
    X509_NAME *xsn;
    ...
    for (i = 0; i < sk_num(((_STACK*) (1 ? ((struct stack_st_X509_NAME_ENTRY *) xsn->entries) : (struct stack_st_X509_NAME_ENTRY*)0))); i++) {

        xsne = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? ((struct stack_st_X509_NAME_ENTRY *) xsn->entries) : (struct stack_st_X509_NAME_ENTRY*)0)), (i)));
...
int SSL_X509_INFO_create_chain(const X509 *x509,
                             struct stack_st_X509_INFO *ca_certs,
                             struct stack_st_X509_INFO *chain)
{
    int can_proceed = 1;
    int len = 0;
    int i;
    ...
    while (can_proceed) {
        ...
        for (i = 0; i < sk_num(((_STACK*) (1 ? (ca_certs) : (struct stack_st_X509_INFO*)0))); i++) {
            info = ((X509_INFO *)sk_value(((_STACK*) (1 ? (ca_certs) : (struct stack_st_X509_INFO*)0)), (i)));
            ...
            if (X509_NAME_cmp(cert_issuer_name, ca_name) == 0) {
                ...
                sk_unshift(((_STACK*) (1 ? (chain) : (struct stack_st_X509_INFO*)0)), ((void*) (1 ? (info) : (X509_INFO*)0)));
                break;
            }
        }
    }
...
# 488 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/ssl/ssl_util_ssl.c"
    ...
    SSL_CTX *ctx, char *file, int skipfirst, pem_password_cb *cb)
{
    ...
    if (extra_certs != ((void*)0)) {
        sk_pop_free(((_STACK*) (1 ? ((struct stack_st_X509 *)extra_certs) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
        ctx->extra_certs = ((void*)0);
    }
