# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
# 17 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c"
...
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/ap_mmn.h" 1
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h" 1
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
char * ap_get_exec_line(apr_pool_t *p,
                                    const char *cmd,
                                    const char * const *argv);
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
...
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
...
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2

# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_want.h" 1
# 118 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_want.h"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c" 2
...
{
    remoteip_config_t *config = memset(apr_palloc(p, sizeof *config), 0, sizeof *config);
...
static const char *header_name_set(cmd_parms *cmd, void *dummy,
                                   const char *arg)
{
    remoteip_config_t *config = (((void **)(cmd->server->module_config))[(&remoteip_module)->module_index]);
...
{
    if ((__extension__ (__builtin_constant_p (':') && !__builtin_constant_p (ipstr) && (':') == '\0' ? (char *) __rawmemchr (ipstr, ':') : __builtin_strchr (ipstr, ':')))) {

        return 1;
    }


    while ((*ipstr == '.') || (((*__ctype_b_loc ())[(int) ((((unsigned char)(*ipstr))))] & (unsigned short int) _ISdigit)))
        ipstr++;
    return (*ipstr == '\0');
}
                               ...
                               const char *arg)
{
    ...
    char *s = (__extension__ (__builtin_constant_p ('/') && !__builtin_constant_p (ip) && ('/') == '\0' ? (char *) __rawmemchr (ip, '/') : __builtin_strchr (ip, '/')));
    if (s) {
        *s++ = '\0';
    }
    ...
    else
    {
        ...
        rv = apr_sockaddr_info_get(&temp_sa, ip, 0, 0,
                                   0x01, cmd->temp_pool);
        while (rv == 0)
        {
            apr_sockaddr_ip_get(&ip, temp_sa);
            rv = apr_ipsubnet_create(&match->ip, ip, ((void*)0), cmd->pool);
                                  ...
                                  const char *filename)
{
    ...
    while (!(ap_cfg_getline(lbuf, 8192, cfp))) {
        args = lbuf;
...
static int remoteip_modify_request(request_rec *r)
{
    ...
    remoteip_config_t *config = (remoteip_config_t *)
        (((void **)(r->server->module_config))[(&remoteip_module)->module_index]);
    remoteip_req_t *req = ((void*)0);

    apr_sockaddr_t *temp_sa;

    apr_status_t rv;
    char *remote;
    char *proxy_ips = ((void*)0);
    char *parse_remote;
    char *eos;
    unsigned char *addrbyte;
    void *internal = ((void*)0);
    ...
    while (remote) {
        ...
        if ((parse_remote = strrchr(remote, ',')) == ((void*)0)) {
            parse_remote = remote;
            remote = ((void*)0);
        }
        else {
        ...
        if (!internal
              && ((temp_sa->family == 2
               ...
               || (temp_sa->family == 10
                      ...
                      && ((temp_sa->sa.sin6.sin6_addr.__in6_u.__u6_addr8[0] & 0xe0) != 0x20))

        )) {
            do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c", 338, (aplog_module_index ? *aplog_module_index : -1), 7, rv, r, "AH" "01569" ": " "RemoteIP: Header %s value of %s appears to be " "a private IP or nonsensical.  Ignored", config->header_name, parse_remote); } while(0);
    ...
    do { if (( ((((7 + 1))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 1))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c", 398, (aplog_module_index ? *aplog_module_index : -1), (7 + 1), 0, r, req->proxy_ips ? "Using %s as client's IP by proxies %s" : "Using %s as client's IP by internal proxies%s", req->useragent_ip, (req->proxy_ips ? req->proxy_ips : "")); } while(0);
...
{
    { "RemoteIPHeader", { .take1=header_name_set }, ((void*)0), 128, TAKE1, "Specifies a request header to trust as the client IP, " "e.g. X-Forwarded-For" },


    { "RemoteIPProxiesHeader", { .take1=proxies_header_name_set }, ((void*)0), 128, TAKE1, "Specifies a request header to record proxy IP's, " "e.g. X-Forwarded-By; if not given then do not record" },



    { "RemoteIPTrustedProxy", { .take1=proxies_set }, 0, 128, ITERATE, "Specifies one or more proxies which are trusted " "to present IP headers" },


    { "RemoteIPInternalProxy", { .take1=proxies_set }, (void*)1, 128, ITERATE, "Specifies one or more internal (transparent) proxies " "which are trusted to present IP headers" },


    { "RemoteIPTrustedProxyList", { .take1=proxylist_read }, 0, 128 | 256, TAKE1, "The filename to read the list of trusted proxies, " "see the RemoteIPTrustedProxy directive" },



    { "RemoteIPInternalProxyList", { .take1=proxylist_read }, (void*)1, 128 | 256, TAKE1, "The filename to read the list of internal proxies, " "see the RemoteIPInternalProxy directive" },
...
{
    ap_hook_post_read_request(remoteip_modify_request, ((void*)0), ((void*)0), 0);
}

extern module remoteip_module; static int * const aplog_module_index = &(remoteip_module.module_index); module remoteip_module = {
    20131230, 2, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/metadata/mod_remoteip.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
    ((void*)0),
    ((void*)0),
