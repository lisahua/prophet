# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c" 2
# 17 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c"
...
char * ap_get_exec_line(apr_pool_t *p,
                                    const char *cmd,
                                    const char * const *argv);
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c" 2
...
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c" 2
...
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c" 2
...
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c" 2
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c" 2
...
# 58 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c"
static apr_status_t
rate_limit_filter(ap_filter_t *f, apr_bucket_brigade *input_bb)
{
    ...
    while (ctx->state != RATE_ERROR &&
        ...
        while (ctx->state == RATE_FULLSPEED && !(((&(bb)->list))->next == (struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) {
            ...
            if (rv != 0) {
                ctx->state = RATE_ERROR;
                do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels == ((void*)0) || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->level : (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c", 149, (aplog_module_index ? *aplog_module_index : -1), 3, rv, f->r, "AH" "01455" ": " "rl: full speed brigade pass failed."); } while(0);
        ...
        while (ctx->state == RATE_LIMIT && !(((&(bb)->list))->next == (struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) {
            ...
            while (!(((&(bb)->list))->next == (struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) {
                ...
                if (rv != 0 && rv != ((20000 + 50000) + 8)) {
                    ctx->state = RATE_ERROR;
                    do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels == ((void*)0) || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->level : (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c", 190, (aplog_module_index ? *aplog_module_index : -1), 3, rv, f->r, "AH" "01456" ": " "rl: partition failed."); } while(0);
                ...
                if (rv != 0) {
                    ctx->state = RATE_ERROR;
                    do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels == ((void*)0) || (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->level : (((f->r)->log ? (f->r)->log : (f->r)->connection->log ? (f->r)->connection->log : &(f->r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c", 221, (aplog_module_index ? *aplog_module_index : -1), 3, 0, f->r, "AH" "01457" ": " "rl: brigade pass failed."); } while(0);
...
extern module ratelimit_module; static int * const aplog_module_index = &(ratelimit_module.module_index); module ratelimit_module = {
    20121222, 14, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/filters/mod_ratelimit.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
    ((void*)0),
    ((void*)0),
    ((void*)0),
    ((void*)0),
