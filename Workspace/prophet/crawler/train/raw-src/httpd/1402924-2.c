# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
apr_status_t apr_match_glob(const char *dir_pattern,
                                         ...
                                         apr_pool_t *p);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
apr_bucket * ap_bucket_eor_create(apr_bucket_alloc_t *list,
                                              request_rec *r);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/util_charset.h" 1
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c" 2
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c"
...
void ap_die(int type, request_rec *r)
{
    ...
    if (r->status != 200) {
        ...
        if (r_1st_err != r) {
# 138 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c"
    ...
    if (custom_response && custom_response[0] != '"') {
        ...
        if (ap_is_url(custom_response)) {
            ...
            recursive_error = 500;
            do { if (( (((3)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((3)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c", 211, (aplog_module_index ? *aplog_module_index : -1), 3, 0, r, "AH" "01580" ": " "Invalid error redirection directive: %s", custom_response); } while(0);
...
static void check_pipeline(conn_rec *c)
{
    if (c->keepalive != AP_CONN_CLOSE) {
        ...
        rv = ap_get_brigade(c->input_filters, bb, AP_MODE_SPECULATIVE,
                            APR_NONBLOCK_READ, 1);
        if (rv != 0 || (((&(bb)->list))->next == (struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) {
...
void ap_process_request_after_handler(request_rec *r)
{
    ...
    if (ap_extended_status) {
        ap_time_process_request(c->sbh, 2);
    }
}
...
void ap_process_async_request(request_rec *r)
{
    conn_rec *c = r->connection;
    int access_status;
# 291 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c"
                                                  ;
    if (ap_extended_status) {
    ...
    if (( ((((7 + 4))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 4))&15) ) )) {
        ...
        do { if (( ((((7 + 4))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 4))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c", 300, (aplog_module_index ? *aplog_module_index : -1), (7 + 4), 0, r, "Headers received from client:"); } while(0);

        for (i = 0; i < t_h->nelts; i++, t_elt++) {
            do { if (( ((((7 + 4))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 4))&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c", 303, (aplog_module_index ? *aplog_module_index : -1), (7 + 4), 0, r, "  %s: %s", ap_escape_logitem(r->pool, t_elt->key), ap_escape_logitem(r->pool, t_elt->val)); } while(0);
    ...
    apr_thread_mutex_create(&r->invoke_mtx, 0x0, r->pool);
...
void ap_process_request(request_rec *r)
{
    ...
    if (!c->data_in_input_filters) {
        ...
        if (((rv) == ((20000 + 50000) + 7))) {
# 379 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c"
            do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c", 379, (aplog_module_index ? *aplog_module_index : -1), 6, rv, r, "AH" "01581" ": " "Timeout while writing data for URI %s to the" " client", r->unparsed_uri); } while(0);
...
static request_rec *internal_internal_redirect(const char *new_uri,
    ...
    if ((((new->status) >= 300)&&((new->status) < 400))) {
    ...
    if (new->main) {
        ...
        do {
            ...
            if (f->r == r && f->frec != ap_subreq_core_filter_handle) {
                do { if (( (((7)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c", 503, (aplog_module_index ? *aplog_module_index : -1), 7, 0, r, "AH" "01582" ": " "dropping filter '%s' in internal redirect from %s to %s", f->frec->name, r->unparsed_uri, new_uri); } while(0);
...
# 615 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/http/http_request.c"
        ap_filter_t *next;
