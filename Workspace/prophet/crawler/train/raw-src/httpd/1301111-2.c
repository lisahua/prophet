# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c"
...
void * ap_realloc(void *ptr, size_t size)
                   __attribute__((warn_unused_result))
                                           ;
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c" 2

module dumpio_module ;

typedef struct dumpio_conf_t {
    int enable_input;
    int enable_output;
} dumpio_conf_t;
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c"
static void dumpit(ap_filter_t *f, apr_bucket *b, dumpio_conf_t *ptr)
{
    conn_rec *c = f->c;

    do { if (( ((((7 + 7))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 7))&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c", 58, (aplog_module_index ? *aplog_module_index : -1), (7 + 7), 0, c, "mod_dumpio:  %s (%s-%s): %" "lu" " bytes", f->frec->name, (((b)->type->is_metadata)) ? "metadata" : "data", b->type->name, b->length); } while(0) ;
    ...
    if (!(((b)->type->is_metadata)))
    {
        ...
        const char *buf;
        apr_size_t nbytes;
        apr_status_t rv = (b)->type->read(b, &buf, &nbytes, APR_BLOCK_READ);
        ...
        if (rv == 0)
        {
            while (nbytes)
            {
                ...
                if (logbytes > 8192 / 4 - 80)
                    logbytes = 8192 / 4 - 80;
                nbytes -= logbytes;
# 100 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c"
                do { if (( ((((7 + 7))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 7))&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c", 100, (aplog_module_index ? *aplog_module_index : -1), (7 + 7), 0, c, "mod_dumpio:  %s (%s-%s): %.*s", f->frec->name, (((b)->type->is_metadata)) ? "metadata" : "data", b->type->name, (int)logbytes, buf); } while(0);
            ...
            do { if (( ((((7 + 7))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 7))&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c", 107, (aplog_module_index ? *aplog_module_index : -1), (7 + 7), rv, c, "mod_dumpio:  %s (%s-%s): %s", f->frec->name, (((b)->type->is_metadata)) ? "metadata" : "data", b->type->name, "error reading data"); } while(0);
...
# 124 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c"
    ...
    ap_input_mode_t mode, apr_read_type_e block, apr_off_t readbytes)
{
    ...
    do { if (( ((((7 + 7))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 7))&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c", 133, (aplog_module_index ? *aplog_module_index : -1), (7 + 7), 0, c, "mod_dumpio: %s [%s-%s] %" "ld" " readbytes", f->frec->name, ( (( mode ) == AP_MODE_READBYTES) ? "readbytes" : (( mode ) == AP_MODE_GETLINE) ? "getline" : (( mode ) == AP_MODE_EATCRLF) ? "eatcrlf" : (( mode ) == AP_MODE_SPECULATIVE) ? "speculative" : (( mode ) == AP_MODE_EXHAUSTIVE) ? "exhaustive" : (( mode ) == AP_MODE_INIT) ? "init" : "unknown" ), ((block) == APR_BLOCK_READ) ? "blocking" : "nonblocking", readbytes); } while(0) ;
    ...
    if (ret == 0) {
        for (b = (&(bb)->list)->next; b != (struct apr_bucket *)((char *)(&(&(bb)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))); b = ((b))->link.next) {
          dumpit(f, b, ptr);
        }
    } else {
        do { if (( ((((7 + 7))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 7))&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c", 147, (aplog_module_index ? *aplog_module_index : -1), (7 + 7), 0, c, "mod_dumpio: %s - %d", f->frec->name, ret); } while(0) ;
...
static int dumpio_output_filter (ap_filter_t *f, apr_bucket_brigade *bb)
{
    ...
    do { if (( ((((7 + 7))&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= (((7 + 7))&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c", 161, (aplog_module_index ? *aplog_module_index : -1), (7 + 7), 0, c, "mod_dumpio: %s", f->frec->name); } while(0);
    ...
    for (b = (&(bb)->list)->next; b != (struct apr_bucket *)((char *)(&(&(bb)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))); b = ((b))->link.next) {
        ...
        if (((b)->type == &apr_bucket_type_eos)) {
            ...
            do { apr_bucket *ap__a = (b), *ap__b = (flush); do { (((ap__b)))->link.next = ((ap__a)); (((ap__b)))->link.prev = (((ap__a)))->link.prev; ((((ap__a)))->link.prev)->link.next = ((ap__b)); (((ap__a)))->link.prev = ((ap__b)); } while (0); ; } while (0);
        }
        dumpit(f, b, ptr);
    }
...
static int dumpio_pre_conn(conn_rec *c, void *csd)
{
    ...
    ptr = (dumpio_conf_t *) (((void **)(c->base_server->module_config))[(&dumpio_module)->module_index]);


    if (ptr->enable_input)
        ap_add_input_filter("DUMPIO_IN", ptr, ((void*)0), c);
    if (ptr->enable_output)
        ap_add_output_filter("DUMPIO_OUT", ptr, ((void*)0), c);
    return 0;
}
...
static void dumpio_register_hooks(apr_pool_t *p)
{
  ...
  ap_register_output_filter("DUMPIO_OUT", dumpio_output_filter,
        ((void*)0), AP_FTYPE_CONNECTION + 3) ;

  ap_register_input_filter("DUMPIO_IN", dumpio_input_filter,
        ((void*)0), AP_FTYPE_CONNECTION + 3) ;

  ap_hook_pre_connection(dumpio_pre_conn, ((void*)0), ((void*)0), 10);
}

static void *dumpio_create_sconfig(apr_pool_t *p, server_rec *s)
{
    dumpio_conf_t *ptr = memset(apr_palloc(p, sizeof *ptr), 0, sizeof *ptr);
...
{
    dumpio_conf_t *ptr =
    (dumpio_conf_t *) (((void **)(cmd->server->module_config))[(&dumpio_module)->module_index]);
...
static const command_rec dumpio_cmds[] = {
    { "DumpIOInput", { .flag=dumpio_enable_input }, ((void*)0), 128, FLAG, "Enable I/O Dump on Input Data" },

    { "DumpIOOutput", { .flag=dumpio_enable_output }, ((void*)0), 128, FLAG, "Enable I/O Dump on Output Data" },

    { ((void*)0) }
};

extern module dumpio_module; static int * const aplog_module_index = &(dumpio_module.module_index); module dumpio_module = {
        20120211, 2, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/modules/debugging/mod_dumpio.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
        ((void*)0),
        ((void*)0),
