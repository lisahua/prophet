# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
# 17 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c"
...
char * ap_get_exec_line(apr_pool_t *p,
                                    const char *cmd,
                                    const char * const *argv);
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
...
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
...
apr_bucket * ap_bucket_eor_create(apr_bucket_alloc_t *list,
                                              request_rec *r);
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
...
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
...
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c" 2

module reqtimeout_module;
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c"
typedef struct
{
    int header_timeout;
...
static void extend_timeout(reqtimeout_con_cfg *ccfg, apr_bucket_brigade *bb)
{
    ...
    if (apr_brigade_length(bb, 0, &len) != 0 || len <= 0)
        return;
                                    ...
                                    apr_time_t now)
{
    ...
    *time_left_p = ccfg->timeout_at - now;
    ...
    if (*time_left_p < ((apr_time_t)(1) * 1000000L)) {
        *time_left_p = ((apr_time_t)(1) * 1000000L);
    }
    return 0;
}
...
{
    apr_bucket *b = (&(bb)->list)->prev;

    for ( ; b != (struct apr_bucket *)((char *)(&(&(bb)->list)->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))) ; b = ((b))->link.prev ) {
        const char *str;
        apr_size_t len;
        apr_status_t rv;
        ...
        if (((b)->type->is_metadata))
            continue;

        rv = (b)->type->read(b, &str, &len, APR_BLOCK_READ);
        if (rv != 0)
            return rv;
...
{
    while (!(((&(bbIn)->list))->next == (struct apr_bucket *)((char *)(&((&(bbIn)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) {
        apr_bucket *e = (&(bbIn)->list)->next;
        const char *str;
        apr_size_t len;
        apr_status_t rv;
                                      ...
                                      apr_off_t readbytes)
{
    ...
    if (ccfg->new_timeout > 0) {
        ...
        now = apr_time_now();
        ccfg->timeout_at = now + ((apr_time_t)(ccfg->new_timeout) * 1000000L);
        ccfg->new_timeout = 0;
        if (ccfg->new_max_timeout > 0) {
            ccfg->max_timeout_at = now + ((apr_time_t)(ccfg->new_max_timeout) * 1000000L);
    ...
    rv = apr_socket_timeout_set(ccfg->socket, ((time_left) < (saved_sock_timeout) ? (time_left) : (saved_sock_timeout)));
    ((void)0);
    ...
    if (mode == AP_MODE_GETLINE) {
        ...
        do {
            ...
            rv = apr_socket_timeout_set(ccfg->socket,
                                   ((time_left) < (saved_sock_timeout) ? (time_left) : (saved_sock_timeout)));
            ((void)0);

        } while (1);

        if (ccfg->tmpbb)
            do { do { if (!((((&(ccfg->tmpbb)->list)))->next == (struct apr_bucket *)((char *)(&(((&(ccfg->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) { do { ((((&(ccfg->tmpbb)->list))->next))->link.prev = ((struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))); ((((&(ccfg->tmpbb)->list))->prev))->link.next = (((struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.next; ((((struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.next)->link.prev = (((&(ccfg->tmpbb)->list))->prev); (((struct apr_bucket *)((char *)(&((&(bb)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.next = (((&(ccfg->tmpbb)->list))->next); } while (0); do { (((&(ccfg->tmpbb)->list)))->next = (struct apr_bucket *)((char *)(&(((&(ccfg->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))); (((&(ccfg->tmpbb)->list)))->prev = (struct apr_bucket *)((char *)(&(((&(ccfg->tmpbb)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))); } while (0); } } while (0); ; } while (0);
...
out:
    if (((rv) == ((20000 + 50000) + 7))) {
        do { if (( (((6)&15) <= 5) || ((((((aplog_module_index ? *aplog_module_index : -1)) < 0 || (((f->c)->log ? (f->c)->log : &(f->c)->base_server->log))->module_levels == ((void*)0) || (((f->c)->log ? (f->c)->log : &(f->c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)] < 0) ? (((f->c)->log ? (f->c)->log : &(f->c)->base_server->log))->level : (((f->c)->log ? (f->c)->log : &(f->c)->base_server->log))->module_levels[(aplog_module_index ? *aplog_module_index : -1)])) >= ((6)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c", 318, (aplog_module_index ? *aplog_module_index : -1), 6, 0, f->c, "AH" "01382" ": " "Request %s read timeout", ccfg->type); } while(0);
...
static int reqtimeout_init(conn_rec *c)
{
    ...
    cfg = (((void **)(c->base_server->module_config))[(&reqtimeout_module)->module_index]);
    ...
    ccfg = memset(apr_palloc(c->pool, sizeof(reqtimeout_con_cfg)), 0, sizeof(reqtimeout_con_cfg));
    ccfg->type = "header";
    if (cfg->header_timeout != -1) {
        ...
        ccfg->new_timeout = 20;
        ccfg->new_max_timeout = 40;
        ccfg->min_rate = 500;
        ccfg->rate_factor = default_header_rate_factor;
    }
    ((((void **)(c->conn_config))[(&reqtimeout_module)->module_index]) = (ccfg));

    ap_add_input_filter("reqtimeout", ccfg, ((void*)0), c);
...
static int reqtimeout_after_headers(request_rec *r)
{
    reqtimeout_srv_cfg *cfg;
    reqtimeout_con_cfg *ccfg =
        (((void **)(r->connection->conn_config))[(&reqtimeout_module)->module_index]);

    if (ccfg == ((void*)0) || r->method_number == 4) {

        return 0;
    }
    cfg = (((void **)(r->connection->base_server->module_config))[(&reqtimeout_module)->module_index]);
...
{
    reqtimeout_srv_cfg *cfg = memset(apr_palloc(p, sizeof(reqtimeout_srv_cfg)), 0, sizeof(reqtimeout_srv_cfg));
...
static void *reqtimeout_merge_srv_config(apr_pool_t *p, void *base_, void *add_)
{
    ...
    cfg->header_timeout = (add->header_timeout == -1) ? base->header_timeout : add->header_timeout;;
    cfg->header_max_timeout = (add->header_max_timeout == -1) ? base->header_max_timeout : add->header_max_timeout;;
    cfg->header_min_rate = (add->header_min_rate == -1) ? base->header_min_rate : add->header_min_rate;;
    cfg->body_timeout = (add->body_timeout == -1) ? base->body_timeout : add->body_timeout;;
    cfg->body_max_timeout = (add->body_max_timeout == -1) ? base->body_max_timeout : add->body_max_timeout;;
    cfg->body_min_rate = (add->body_min_rate == -1) ? base->body_min_rate : add->body_min_rate;;

    cfg->header_rate_factor = (cfg->header_min_rate == -1) ?
                              base->header_rate_factor : add->header_rate_factor;
    cfg->body_rate_factor = (cfg->body_min_rate == -1) ?
                                      ...
                                      const char *val)
{
    ...
    char *rate_str = ((void*)0), *initial_str, *max_str = ((void*)0);
    ...
    if ((rate_str = ap_strcasestr(val, ",minrate="))) {
        ...
        if ((max_str = (__extension__ (__builtin_constant_p ('-') && !__builtin_constant_p (initial_str) && ('-') == '\0' ? (char *) __rawmemchr (initial_str, '-') : __builtin_strchr (initial_str, '-'))))) {
            *max_str++ = '\0';
        ...
        if ((__extension__ (__builtin_constant_p ('-') && !__builtin_constant_p (val) && ('-') == '\0' ? (char *) __rawmemchr (val, '-') : __builtin_strchr (val, '-'))))
    ...
    if (type == PARAM_HEADER) {
        ...
        if (rate)
            conf->header_rate_factor = ((apr_time_t)(1) * 1000000L) / rate;
    }
    else {
        ...
        if (rate)
            conf->body_rate_factor = ((apr_time_t)(1) * 1000000L) / rate;
    }
    return ret;
}
                                   ...
                                   const char *arg)
{
    ...
    (((void **)(cmd->server->module_config))[(&reqtimeout_module)->module_index]);
...
static void reqtimeout_hooks(apr_pool_t *pool)
{
    ...
    ap_register_input_filter(reqtimeout_filter_name, reqtimeout_filter, ((void*)0),
                             AP_FTYPE_CONNECTION + 8);
# 607 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c"
    ap_hook_process_connection(reqtimeout_init, ((void*)0), ((void*)0), 20);

    ap_hook_post_read_request(reqtimeout_after_headers, ((void*)0), ((void*)0),
                              10);
    ap_hook_log_transaction(reqtimeout_after_body, ((void*)0), ((void*)0),
                            10);


    default_header_rate_factor = ((apr_time_t)(1) * 1000000L) / 500;


    default_body_rate_factor = ((apr_time_t)(1) * 1000000L) / 500;

}

static const command_rec reqtimeout_cmds[] = {
    { "RequestReadTimeout", { .raw_args=set_reqtimeouts }, ((void*)0), 128, RAW_ARGS, "Set various timeout parameters for reading request " "headers and body" },


    {((void*)0)}
};

extern module reqtimeout_module; static int * const aplog_module_index = &(reqtimeout_module.module_index); module reqtimeout_module = {
    20121222, 5, -1, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/modules/filters/mod_reqtimeout.c", ((void*)0), ((void*)0), 0x41503235UL, ((void*)0),
    ((void*)0),
    ((void*)0),
