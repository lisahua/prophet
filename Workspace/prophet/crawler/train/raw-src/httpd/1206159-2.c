# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
# 18 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c"
...
# 19 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 20 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
...
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
...
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
...
# 1034 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
typedef enum {
    AP_CONN_UNKNOWN,
    AP_CONN_CLOSE,
    AP_CONN_KEEPALIVE
...
struct conn_rec {
    ...
    const char *log_id;
# 1131 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1322 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1362 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1381 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
char * ap_getword_nulls(apr_pool_t *p, const char **line,
                                    char stop);
# 1413 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1496 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1591 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1695 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
char * ap_make_full_path(apr_pool_t *a, const char *dir, const char *f);
# 1705 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1731 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1805 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
char * ap_append_pid(apr_pool_t *p, const char *string,
                                 const char *delim);
# 1903 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
apr_status_t ap_pstr2_alnum(apr_pool_t *p, const char *src,
                                        const char **dest);
# 1938 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 1963 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 2074 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 2116 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
...
# 2155 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/httpd.h"
void * ap_realloc(void *ptr, size_t size)
                   __attribute__((warn_unused_result));
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
...
# 811 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/http_core.h"
typedef int ap_errorlog_handler_fn_t(const ap_errorlog_info *info,
                                     const char *arg, char *buf, int buflen);
# 821 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/http_core.h"
...
# 839 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/http_core.h"
typedef struct {
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
...
# 635 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/include/http_log.h"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c" 2
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c"
...
static filter_trie_node *registered_output_filters = ((void*)0);
static filter_trie_node *registered_input_filters = ((void*)0);


static apr_status_t filter_cleanup(void *ctx)
{
    registered_output_filters = ((void*)0);
    registered_input_filters = ((void*)0);
    return 0;
}
                            ...
                            filter_trie_node **reg_filter_set)
{
    ...
    if (!*reg_filter_set) {
        *reg_filter_set = trie_node_alloc(apr_hook_global_pool, ((void*)0), 0);
    }
    ...
    for (n = normalized_name; *n; n++) {
        filter_trie_node *child = trie_node_alloc(apr_hook_global_pool, node, *n);
        if ((((*__ctype_b_loc ())[(int) ((((unsigned char)(*n))))] & (unsigned short int) _ISalpha))) {
            trie_node_link(apr_hook_global_pool, node, child, ((__extension__ ({ int __res; if (sizeof (((unsigned char)(*n))) > 1) { if (__builtin_constant_p (((unsigned char)(*n)))) { int __c = (((unsigned char)(*n))); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (((unsigned char)(*n))); } else __res = (*__ctype_toupper_loc ())[(int) (((unsigned char)(*n)))]; __res; }))));
        }
        node = child;
    }
    if (node->frec) {
        ...
        frec = memset(apr_palloc(apr_hook_global_pool, sizeof(*frec)), 0, sizeof(*frec));
        node->frec = frec;
    ...
    apr_pool_cleanup_register(apr_hook_global_pool, ((void*)0), filter_cleanup,
                                          ...
                                          ap_filter_t **c_filters)
{
    ...
    if (frec->ftype < AP_FTYPE_PROTOCOL) {
        if (r) {
            ...
            do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[0] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c", 297, 0, 3, 0, c, "a content filter was added without a request: %s", frec->name); } while(0);
        ...
        if (r) {
            ...
            do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels == ((void*)0) || (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[0] < 0) ? (((c)->log ? (c)->log : &(c)->base_server->log))->level : (((c)->log ? (c)->log : &(c)->base_server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c", 307, 0, 3, 0, c, "a protocol filter was added without a request: %s", frec->name); } while(0);
    ...
    f->r = frec->ftype < AP_FTYPE_CONNECTION ? r : ((void*)0);
    f->c = c;
    f->next = ((void*)0);

    if (((*outf) == ((void*)0) || (*outf)->frec->ftype > (f)->frec->ftype || (*outf)->r != (f)->r)) {
        f->next = *outf;

        if (*outf) {
            ap_filter_t *first = ((void*)0);
        ...
        *outf = f;
        ...
        while (!((fscan->next) == ((void*)0) || (fscan->next)->frec->ftype > (f)->frec->ftype || (fscan->next)->r != (f)->r))
            fscan = fscan->next;
                                   ...
                                   ap_filter_t **c_filters)
{
    ...
    do { if (( (((3)&15) <= 5) || (((((0) < 0 || (((r ? r->connection : c)->log ? (r ? r->connection : c)->log : &(r ? r->connection : c)->base_server->log))->module_levels == ((void*)0) || (((r ? r->connection : c)->log ? (r ? r->connection : c)->log : &(r ? r->connection : c)->base_server->log))->module_levels[0] < 0) ? (((r ? r->connection : c)->log ? (r ? r->connection : c)->log : &(r ? r->connection : c)->base_server->log))->level : (((r ? r->connection : c)->log ? (r ? r->connection : c)->log : &(r ? r->connection : c)->base_server->log))->module_levels[0])) >= ((3)&15) ) )) ap_log_cerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c", 404, 0, 3, 0, r ? r->connection : c, "an unknown filter was not added: %s", name); } while(0);
                                              ...
                                              request_rec *r, conn_rec *c)
{
    return add_any_filter(name, ctx, r, c, registered_input_filters,
                          r ? &r->input_filters : ((void*)0),
                          r ? &r->proto_input_filters : ((void*)0), &c->input_filters);
}
...
ap_filter_t * ap_add_input_filter_handle(ap_filter_rec_t *f,
                                                     ...
                                                     conn_rec *c)
{
    return add_any_filter_handle(f, ctx, r, c, r ? &r->input_filters : ((void*)0),
                                 r ? &r->proto_input_filters : ((void*)0),
                                 &c->input_filters);
}
                                               ...
                                               request_rec *r, conn_rec *c)
{
    return add_any_filter(name, ctx, r, c, registered_output_filters,
                          r ? &r->output_filters : ((void*)0),
                          r ? &r->proto_output_filters : ((void*)0), &c->output_filters);
}
...
ap_filter_t * ap_add_output_filter_handle(ap_filter_rec_t *f,
                                                      ...
                                                      conn_rec *c)
{
    return add_any_filter_handle(f, ctx, r, c, r ? &r->output_filters : ((void*)0),
                                 r ? &r->proto_output_filters : ((void*)0),
                                 &c->output_filters);
}
...
void ap_remove_input_filter(ap_filter_t *f)
{
    remove_any_filter(f, f->r ? &f->r->input_filters : ((void*)0),
                      f->r ? &f->r->proto_input_filters : ((void*)0),
                      &f->c->input_filters);
}

void ap_remove_output_filter(ap_filter_t *f)
{
    remove_any_filter(f, f->r ? &f->r->output_filters : ((void*)0),
                      f->r ? &f->r->proto_output_filters : ((void*)0),
                      &f->c->output_filters);
}
# 489 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c"
apr_status_t ap_get_brigade(ap_filter_t *next,
                                        apr_bucket_brigade *bb,
                                        ap_input_mode_t mode,
                                        apr_read_type_e block,
                                        apr_off_t readbytes)
...
apr_status_t ap_pass_brigade(ap_filter_t *next,
                                         apr_bucket_brigade *bb)
{
    if (next) {
        apr_bucket *e;
        if ((e = (&(bb)->list)->prev) && ((e)->type == &apr_bucket_type_eos) && next->r) {
# 521 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c"
            next->r->eos_sent = 1;
...
# 545 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c"
apr_status_t ap_pass_brigade_fchk(request_rec *r,
                                              apr_bucket_brigade *bb,
                                              const char *fmt,
                                              ...)
    ...
    if (rv != 0) {
        if (rv != -102) {
            if (!fmt)
                ...
                do { if (( (((7)&15) <= 5) || (((((0) < 0 || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels == ((void*)0) || (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0] < 0) ? (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->level : (((r)->log ? (r)->log : (r)->connection->log ? (r)->connection->log : &(r)->server->log))->module_levels[0])) >= ((7)&15) ) )) ap_log_rerror_("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/server/util_filter.c", 568, 0, 7, rv, r, res, ((void*)0)); } while(0);
            }
            return 500;
        }
        return -102;
                                         ...
                                         apr_bucket_brigade **b, apr_pool_t *p)
{
         ...
         e = ((e))->link.next)
    {
        ...
        if (rv == ((20000 + 50000) + 23)) {
            ...
            rv = (e)->type->read(e, &s, &n, APR_BLOCK_READ);
            if (rv == 0) {
                rv = (e)->type->setaside(e,p);
            }
        }
    ...
    do { do { if (!((((&(*b)->list)))->next == (struct apr_bucket *)((char *)(&(((&(*b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))))) { do { ((((&(*b)->list))->prev))->link.next = ((struct apr_bucket *)((char *)(&((&(*saveto)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))); ((((&(*b)->list))->next))->link.prev = (((struct apr_bucket *)((char *)(&((&(*saveto)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev; ((((struct apr_bucket *)((char *)(&((&(*saveto)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev)->link.next = (((&(*b)->list))->next); (((struct apr_bucket *)((char *)(&((&(*saveto)->list))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0)))))))->link.prev = (((&(*b)->list))->prev); } while (0); do { (((&(*b)->list)))->next = (struct apr_bucket *)((char *)(&(((&(*b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))); (((&(*b)->list)))->prev = (struct apr_bucket *)((char *)(&(((&(*b)->list)))->next) - ((long) (((char *) (&(((struct apr_bucket*)((void*)0))->link))) - ((char *) ((void*)0))))); } while (0); } } while (0); ; } while (0);
    return srv;
}
