# 1 "ext/date/lib/parse_iso_intervals.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "ext/date/lib/parse_iso_intervals.c" 2
# 1 "ext/date/lib/parse_iso_intervals.re"
# 21 "ext/date/lib/parse_iso_intervals.re"
...
# 22 "ext/date/lib/parse_iso_intervals.re" 2
...
# 25 "ext/date/lib/parse_iso_intervals.re" 2
# 60 "ext/date/lib/parse_iso_intervals.re"
typedef unsigned char uchar;
# 87 "ext/date/lib/parse_iso_intervals.re"
...
# 276 "ext/date/lib/parse_iso_intervals.re"
...
std:
 s->tok = cursor;
 s->len = 0;
# 311 "ext/date/lib/parse_iso_intervals.re"
# 291 "ext/date/lib/parse_iso_intervals.c"
{
 uchar yych;
 ...
 if (yych <= ',') {
  ...
  if (yych <= 'O') {
   ...
   if (yych != 'R') goto yy11;
                      ...
                      ;
 ++cursor;
 if ((yych = *cursor) <= '/') goto yy3;
 if (yych <= '9') goto yy98;
yy3:
                      ;
# 424 "ext/date/lib/parse_iso_intervals.re"
 {
  add_error(s, "Unexpected character");
  goto std;
 }
# 366 "ext/date/lib/parse_iso_intervals.c"
yy4:
                      ;
 yyaccept = 0;
 yych = *(s->ptr = ++cursor);
...
yy6:
                      ;
# 351 "ext/date/lib/parse_iso_intervals.re"
 {
  timelib_sll nr;
  int in_time = 0;
                        ;
...
# 424 "ext/date/lib/parse_iso_intervals.c"
yy7:
                      ;
 ++cursor;
                      ;
# 413 "ext/date/lib/parse_iso_intervals.re"
 {
  goto std;
 }
# 433 "ext/date/lib/parse_iso_intervals.c"
yy9:
                      ;
 ++cursor;
                       ;
# 418 "ext/date/lib/parse_iso_intervals.re"
 {
  s->pos = cursor; s->line++;
  goto std;
 }
# 443 "ext/date/lib/parse_iso_intervals.c"
yy11:
                       ;
 yych = *++cursor;
 goto yy3;
...
yy51:
 ...
 ++cursor;
                       ;
# 393 "ext/date/lib/parse_iso_intervals.re"
 {
                             ;
  s->cur = cursor; str = timelib_string(s); ptr = str;
...
# 792 "ext/date/lib/parse_iso_intervals.c"
yy59:
                       ;
 yych = *++cursor;
 if (yych <= '/') goto yy13;
...
yy83:
 ...
 ++cursor;
                       ;
# 327 "ext/date/lib/parse_iso_intervals.re"
 {
...
# 944 "ext/date/lib/parse_iso_intervals.c"
yy85:
                       ;
 yych = *++cursor;
 if (yych <= '/') goto yy13;
...
yy100:
                        ;
# 316 "ext/date/lib/parse_iso_intervals.re"
 {
                             ;
  s->cur = cursor; str = timelib_string(s); ptr = str;
  ptr++;
...
# 1032 "ext/date/lib/parse_iso_intervals.c"
}
# 428 "ext/date/lib/parse_iso_intervals.re"
         ...
         struct timelib_error_container **errors)
{
 ...
 in.str = malloc((e - s) + 20);
 memset(in.str, 0, (e - s) + 20);
 memcpy(in.str, s, (e - s));
 in.lim = in.str + (e - s) + 20;
 in.cur = in.str;
