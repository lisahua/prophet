 ...
 while (*bucket != ((void*)0)) {
   ...
   *bucket = (*bucket)->next;
      ...
      if(r->path == r->realpath)
                            (cwd_globals.realpath_cache_size) -= sizeof(realpath_cache_bucket) + r->path_len + 1;
                        else
...
# 1216 "TSRM/tsrm_virtual_cwd.c"
  memcpy(resolved_path, path, path_length + 1);
 }
# 1268 "TSRM/tsrm_virtual_cwd.c"
