...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "TSRM/tsrm_virtual_cwd.c" 2
# 22 "TSRM/tsrm_virtual_cwd.c"
...
# 31 "TSRM/tsrm_virtual_cwd.c" 2

# 1 "TSRM/tsrm_virtual_cwd.h" 1
# 25 "TSRM/tsrm_virtual_cwd.h"
# 1 "TSRM/TSRM.h" 1
# 20 "TSRM/TSRM.h"
# 1 "TSRM/tsrm_config.h" 1
# 1 "TSRM/../main/php_config.h" 1
# 2887 "TSRM/../main/php_config.h"
...
# 2888 "TSRM/../main/php_config.h" 2
# 2 "TSRM/tsrm_config.h" 2
# 21 "TSRM/TSRM.h" 2
# 39 "TSRM/TSRM.h"
typedef long tsrm_intptr_t;
typedef unsigned long tsrm_uintptr_t;
# 26 "TSRM/tsrm_virtual_cwd.h" 2
# 1 "TSRM/tsrm_config_common.h" 1
# 13 "TSRM/tsrm_config_common.h"
# 1 "TSRM/tsrm_config.h" 1
# 1 "TSRM/../main/php_config.h" 1
# 2 "TSRM/tsrm_config.h" 2
# 14 "TSRM/tsrm_config_common.h" 2
...
# 15 "TSRM/tsrm_config_common.h" 2
# 37 "TSRM/tsrm_config_common.h"
...
# 38 "TSRM/tsrm_config_common.h" 2
# 27 "TSRM/tsrm_virtual_cwd.h" 2
...
extern int utime (const char *__file,
    const struct utimbuf *__file_times)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 34 "TSRM/tsrm_virtual_cwd.h" 2
# 89 "TSRM/tsrm_virtual_cwd.h"
...
extern __ssize_t getdirentries (int __fd, char *__restrict __buf,
    ...
    __off_t *__restrict __basep)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (2, 4)));
# 90 "TSRM/tsrm_virtual_cwd.h" 2
# 137 "TSRM/tsrm_virtual_cwd.h"
...
# 33 "TSRM/tsrm_virtual_cwd.c" 2
# 1 "TSRM/tsrm_strtok_r.h" 1



char *tsrm_strtok_r(char *s, const char *delim, char **last);
# 34 "TSRM/tsrm_virtual_cwd.c" 2
# 63 "TSRM/tsrm_virtual_cwd.c"
virtual_cwd_globals cwd_globals;


cwd_state main_cwd_state;
# 279 "TSRM/tsrm_virtual_cwd.c"
static int php_is_dir_ok(const cwd_state *state)
{
 struct stat buf;

 if (stat(state->cwd, &buf) == 0 && ((((buf.st_mode)) & 0170000) == (0040000)))
  return (0);
...
static int php_is_file_ok(const cwd_state *state)
{
 ...
 if (stat(state->cwd, &buf) == 0 && ((((buf.st_mode)) & 0170000) == (0100000)))
  return (0);
...
{
 (&cwd_globals->cwd)->cwd_length = (&main_cwd_state)->cwd_length; (&cwd_globals->cwd)->cwd = (char *) malloc((&main_cwd_state)->cwd_length+1); memcpy((&cwd_globals->cwd)->cwd, (&main_cwd_state)->cwd, (&main_cwd_state)->cwd_length+1);;
 cwd_globals->realpath_cache_size = 0;
 cwd_globals->realpath_cache_size_limit = 0;
 cwd_globals->realpath_cache_ttl = (2*60);
...
# 335 "TSRM/tsrm_virtual_cwd.c"
 ...
 main_cwd_state.cwd = (__extension__ (__builtin_constant_p (cwd) && ((size_t)(const void *)((cwd) + 1) - (size_t)(const void *)(cwd) == 1) ? (((const char *) (cwd))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (cwd) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void*)0)) __retval = (char *) memcpy (__retval, cwd, __len); __retval; })) : __strdup (cwd)));
...
# 404 "TSRM/tsrm_virtual_cwd.c"
 *length = state->cwd_length;
 return (__extension__ (__builtin_constant_p (state->cwd) && ((size_t)(const void *)((state->cwd) + 1) - (size_t)(const void *)(state->cwd) == 1) ? (((const char *) (state->cwd))[0] == '\0' ? (char *) calloc ((size_t) 1, (size_t) 1) : ({ size_t __len = strlen (state->cwd) + 1; char *__retval = (char *) malloc (__len); if (__retval != ((void*)0)) __retval = (char *) memcpy (__retval, state->cwd, __len); __retval; })) : __strdup (state->cwd)));
}
...
__attribute__ ((visibility("default"))) void realpath_cache_clean(void)
{
 ...
 for (i = 0; i < sizeof((cwd_globals.realpath_cache))/sizeof((cwd_globals.realpath_cache)[0]); i++) {
  ...
  (cwd_globals.realpath_cache)[i] = ((void*)0);
 }
 (cwd_globals.realpath_cache_size) = 0;
}
...
__attribute__ ((visibility("default"))) void realpath_cache_del(const char *path, int path_len )
{
 ...
 unsigned long n = key % (sizeof((cwd_globals.realpath_cache)) / sizeof((cwd_globals.realpath_cache)[0]));
 realpath_cache_bucket **bucket = &(cwd_globals.realpath_cache)[n];
 ...
 while (*bucket != ((void*)0)) {
   ...
   *bucket = (*bucket)->next;
   (cwd_globals.realpath_cache_size) -= sizeof(realpath_cache_bucket) + r->path_len + 1 + r->realpath_len + 1;
   free(r);
   return;
  } else {
   bucket = &(*bucket)->next;
...
static inline void realpath_cache_add(const char *path, int path_len, const char *realpath, int realpath_len, int is_dir, time_t t )
{
 ...
 if ((cwd_globals.realpath_cache_size) + size <= (cwd_globals.realpath_cache_size_limit)) {
  ...
  bucket->expires = t + (cwd_globals.realpath_cache_ttl);
  n = bucket->key % (sizeof((cwd_globals.realpath_cache)) / sizeof((cwd_globals.realpath_cache)[0]));
  bucket->next = (cwd_globals.realpath_cache)[n];
  (cwd_globals.realpath_cache)[n] = bucket;
  (cwd_globals.realpath_cache_size) += size;
 }
}
...
static inline realpath_cache_bucket* realpath_cache_find(const char *path, int path_len, time_t t )
{
 ...
 while (*bucket != ((void*)0)) {
  if ((cwd_globals.realpath_cache_ttl) && (*bucket)->expires < t) {
   realpath_cache_bucket *r = *bucket;
   *bucket = (*bucket)->next;
   (cwd_globals.realpath_cache_size) -= sizeof(realpath_cache_bucket) + r->path_len + 1 + r->realpath_len + 1;
   free(r);
...
__attribute__ ((visibility("default"))) int realpath_cache_size(void)
{
 return (cwd_globals.realpath_cache_size);
}

__attribute__ ((visibility("default"))) int realpath_cache_max_buckets(void)
{
 return (sizeof((cwd_globals.realpath_cache)) / sizeof((cwd_globals.realpath_cache)[0]));
}

__attribute__ ((visibility("default"))) realpath_cache_bucket** realpath_cache_get_buckets(void)
{
 return (cwd_globals.realpath_cache);
}
...
static int tsrm_realpath_r(char *path, int start, int len, int *ll, time_t *t, int use_realpath, int is_dir, int *link_is_dir )
{
 ...
 while (1) {
  ...
  if (i == len ||
   ...
   j = tsrm_realpath_r(path, start, i-1, ll, t, use_realpath, 1, ((void*)0) );
   if (j > start) {
    j--;
  ...
  if (start && save && (cwd_globals.realpath_cache_size_limit)) {

   if (!*t) {
    *t = time(0);
   }
      if ((bucket = realpath_cache_find(path, len, *t )) != ((void*)0)) {
...
# 888 "TSRM/tsrm_virtual_cwd.c"
  ...
  tmp = ((use_heap = ((len+1) > (4096))) ? malloc(len+1) : __builtin_alloca (len+1));
  memcpy(tmp, path, len+1);

  if (save && ((((st.st_mode)) & 0170000) == (0120000))) {
   if (++(*ll) > 32 || (j = readlink(tmp, path, 4096)) < 0) {

    do { if (use_heap) free(tmp); } while (0);
    return -1;
   }
   path[j] = 0;
   if ((((path[0]) == '/'))) {
   ...
   if (save) {
    directory = ((((st.st_mode)) & 0170000) == (0040000));
    if (link_is_dir) {
     *link_is_dir = directory;
    }
    if (is_dir && !directory) {
   ...
   if (i - 1 <= start) {
    ...
    j = tsrm_realpath_r(path, start, i-1, ll, t, save ? 1 : use_realpath, 1, ((void*)0) );
    if (j > start) {
     path[j++] = '/';
    }
   }
# 967 "TSRM/tsrm_virtual_cwd.c"
   if (j < 0 || j + len - i >= 4096 -1) {
    do { if (use_heap) free(tmp); } while (0);
    return -1;
   }
  ...
  if (save && start && (cwd_globals.realpath_cache_size_limit)) {
...
__attribute__ ((visibility("default"))) int virtual_file_ex(cwd_state *state, const char *path, verify_path_func verify_path, int use_realpath)
{
 ...
 if (path_length == 0 || path_length >= 4096 -1) {
  return 1;
 }
# 1012 "TSRM/tsrm_virtual_cwd.c"
 if (!(((path[0]) == '/'))) {
  if (state->cwd_length == 0) {
...
# 1045 "TSRM/tsrm_virtual_cwd.c"
   if (path_length + state_cwd_length + 1 >= 4096 -1) {
    return 1;
   }
...
# 1063 "TSRM/tsrm_virtual_cwd.c"
  memcpy(resolved_path, path, path_length + 1);
 }
# 1115 "TSRM/tsrm_virtual_cwd.c"
 add_slash = (use_realpath != 2) && path_length > 0 && ((resolved_path[path_length-1]) == '/');
 t = (cwd_globals.realpath_cache_ttl) ? 0 : -1;
 path_length = tsrm_realpath_r(resolved_path, start, path_length, &ll, &t, use_realpath, 0, ((void*)0) );
 ...
 if (add_slash && path_length && !((resolved_path[path_length-1]) == '/')) {
  if (path_length >= 4096 -1) {
   return -1;
  }
  resolved_path[path_length++] = '/';
 }
 ...
 if (verify_path) {
  ...
  (&old_state)->cwd_length = (state)->cwd_length; (&old_state)->cwd = (char *) malloc((state)->cwd_length+1); memcpy((&old_state)->cwd, (state)->cwd, (state)->cwd_length+1);;
...
__attribute__ ((visibility("default"))) int virtual_chdir(const char *path )
{
 return virtual_file_ex(&(cwd_globals.cwd), path, php_is_dir_ok, 2)?-1:0;
}
...
__attribute__ ((visibility("default"))) int virtual_chdir_file(const char *path, int (*p_chdir)(const char *path ) )
{
 ...
 temp = (char *) ((use_heap = ((length+1) > (4096))) ? malloc(length+1) : __builtin_alloca (length+1));
 ...
 retval = p_chdir(temp );
 do { if (use_heap) free(temp); } while (0);
 return retval;
}
...
__attribute__ ((visibility("default"))) char *virtual_realpath(const char *path, char *real_path )
{
 ...
 if (!*path) {
  ...
  (&new_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&new_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&new_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 } else {
  new_state.cwd = (char*)malloc(1);
  new_state.cwd[0] = '\0';
  new_state.cwd_length = 0;
 ...
 if (virtual_file_ex(&new_state, path, ((void*)0), 2)==0) {
  int len = new_state.cwd_length>4096 -1?4096 -1:new_state.cwd_length;
...
__attribute__ ((visibility("default"))) FILE *virtual_fopen(const char *path, const char *mode )
{
 ...
 (&new_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&new_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&new_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 if (virtual_file_ex(&new_state, path, ((void*)0), 1)) {
  free((&new_state)->cwd);;
  return ((void*)0);
 }
...
__attribute__ ((visibility("default"))) int virtual_access(const char *pathname, int mode )
{
 ...
 (&new_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&new_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&new_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 if (virtual_file_ex(&new_state, pathname, ((void*)0), 2)) {
  free((&new_state)->cwd);;
  return -1;
 }
...
__attribute__ ((visibility("default"))) int virtual_utime(const char *filename, struct utimbuf *buf )
{
 ...
 (&new_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&new_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&new_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 if (virtual_file_ex(&new_state, filename, ((void*)0), 2)) {
  free((&new_state)->cwd);;
  return -1;
 }
...
__attribute__ ((visibility("default"))) int virtual_open(const char *path , int flags, ...)
{
 ...
 if (flags & 0100) {
  ...
  mode = (mode_t) __builtin_va_arg(arg, int);
...
__attribute__ ((visibility("default"))) int virtual_rename(char *oldname, char *newname )
{
 ...
 (&old_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&old_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&old_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 if (virtual_file_ex(&old_state, oldname, ((void*)0), 0)) {
  free((&old_state)->cwd);;
  return -1;
 }
 ...
 (&new_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&new_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&new_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 if (virtual_file_ex(&new_state, newname, ((void*)0), 0)) {
  free((&old_state)->cwd);;
  free((&new_state)->cwd);;
  return -1;
 }
...
__attribute__ ((visibility("default"))) int virtual_lstat(const char *path, struct stat *buf )
{
 ...
 (&new_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&new_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&new_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 if (virtual_file_ex(&new_state, path, ((void*)0), 0)) {
  free((&new_state)->cwd);;
  return -1;
 }
...
__attribute__ ((visibility("default"))) int virtual_mkdir(const char *pathname, mode_t mode )
{
 ...
 (&new_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&new_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&new_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 if (virtual_file_ex(&new_state, pathname, ((void*)0), 1)) {
  free((&new_state)->cwd);;
  return -1;
 }
...
__attribute__ ((visibility("default"))) int virtual_rmdir(const char *pathname )
{
 ...
 (&new_state)->cwd_length = (&(cwd_globals.cwd))->cwd_length; (&new_state)->cwd = (char *) malloc((&(cwd_globals.cwd))->cwd_length+1); memcpy((&new_state)->cwd, (&(cwd_globals.cwd))->cwd, (&(cwd_globals.cwd))->cwd_length+1);;
 if (virtual_file_ex(&new_state, pathname, ((void*)0), 0)) {
  free((&new_state)->cwd);;
  return -1;
 }
...
__attribute__ ((visibility("default"))) FILE *virtual_popen(const char *command, const char *type )
{
 ...
 dir_length = (cwd_globals.cwd).cwd_length;
 dir = (cwd_globals.cwd).cwd;
 while (dir_length > 0) {
  if (*dir == '\'') extra+=3;
  dir++;
  dir_length--;
 ...
 if ((cwd_globals.cwd).cwd_length == 0) {
  *ptr++ = '/';
 } else {
  *ptr++ = '\'';
  while (dir_length > 0) {
...
__attribute__ ((visibility("default"))) char *tsrm_realpath(const char *path, char *real_path )
{
 ...
 if (real_path) {
  int copy_len = new_state.cwd_length>4096 -1 ? 4096 -1 : new_state.cwd_length;
