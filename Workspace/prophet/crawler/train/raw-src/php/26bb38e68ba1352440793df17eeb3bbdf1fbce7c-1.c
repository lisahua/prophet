...
# 32 "TSRM/tsrm_virtual_cwd.c" 2

# 1 "TSRM/tsrm_virtual_cwd.h" 1
# 26 "TSRM/tsrm_virtual_cwd.h"
# 1 "TSRM/TSRM.h" 1
# 20 "TSRM/TSRM.h"
# 1 "TSRM/tsrm_config.h" 1
# 1 "TSRM/../main/php_config.h" 1
# 2926 "TSRM/../main/php_config.h"
...
extern int utime (const char *__file,
    const struct utimbuf *__file_times)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 35 "TSRM/tsrm_virtual_cwd.h" 2
# 90 "TSRM/tsrm_virtual_cwd.h"
...
extern __ssize_t getdirentries (int __fd, char *__restrict __buf,
    ...
    __off_t *__restrict __basep)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (2, 4)));
# 91 "TSRM/tsrm_virtual_cwd.h" 2
# 145 "TSRM/tsrm_virtual_cwd.h"
...
# 35 "TSRM/tsrm_virtual_cwd.c" 2
# 76 "TSRM/tsrm_virtual_cwd.c"
virtual_cwd_globals cwd_globals;


cwd_state main_cwd_state;
# 394 "TSRM/tsrm_virtual_cwd.c"
...
{
 (&cwd_g->cwd)->cwd_length = (&main_cwd_state)->cwd_length; (&cwd_g->cwd)->cwd = (char *) malloc((&main_cwd_state)->cwd_length+1); memcpy((&cwd_g->cwd)->cwd, (&main_cwd_state)->cwd, (&main_cwd_state)->cwd_length+1);;
 cwd_g->realpath_cache_size = 0;
 cwd_g->realpath_cache_size_limit = 0;
 cwd_g->realpath_cache_ttl = (2*60);
...
# 1190 "TSRM/tsrm_virtual_cwd.c"
  memcpy(resolved_path, path, path_length + 1);
 }
# 1242 "TSRM/tsrm_virtual_cwd.c"
