# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c"
# 1 "../libtiff/tif_config.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c"
...
extern const TIFFFieldInfo* TIFFFindFieldInfoByName(TIFF* , const char *,
          TIFFDataType);
# 58 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
...
const char* bytefmt = "%s%#02x";
const char* sbytefmt = "%s%d";
const char* shortfmt = "%s%u";
const char* sshortfmt = "%s%d";
const char* longfmt = "%s%lu";
const char* slongfmt = "%s%ld";
const char* ifdfmt = "%s%#04lx";





const char* long8fmt = "%s%llu";
const char* slong8fmt = "%s%lld";
const char* ifd8fmt = "%s%#08llx";

const char* rationalfmt = "%s%g";
const char* srationalfmt = "%s%g";
const char* floatfmt = "%s%g";
const char* doublefmt = "%s%g";
...
main(int argc, char* argv[])
{
 ...
 while ((c = getopt(argc, argv, "m:o:h")) != -1) {
  ...
  case 'h':
   ...
   break;
  case 'o':
   diroff = (uint64) strtoul(optarg, ((void*)0), 0);
   break;
  case 'm':
   maxitems = strtoul(optarg, ((void*)0), 0);
   break;
  default:
   usage();
  }
...
dump(int fd, uint64 diroff)
{
 ...
 if (hdr.common.tiff_magic != 0x4d4d && hdr.common.tiff_magic != 0x4949 &&
 ...
 if (hdr.common.tiff_version==42)
 {
  ...
  printf("Magic: %#x <%s-endian> Version: %#x <%s>\n",
      ...
      hdr.classic.tiff_magic == 0x4d4d ? "big" : "little",
      42,"ClassicTIFF");
  if (diroff == 0)
 ...
 else if (hdr.common.tiff_version==43)
 {
  ...
  printf("Magic: %#x <%s-endian> Version: %#x <%s>\n",
      hdr.big.tiff_magic,
      hdr.big.tiff_magic == 0x4d4d ? "big" : "little",
      43,"BigTIFF");
...
ReadDirectory(int fd, unsigned int ix, uint64 off)
{
 ...
 if (lseek(fd, (off_t)off, 0) != (off_t)off) {
 ...
 for (dp = (uint8*)dirmem, n = dircount; n > 0; n--) {
  ...
  if (!datafits)
  {
   ...
   if (datamem) {
    ...
    if (read(fd, datamem, (size_t)datasize) != (signed long)datasize)
    {
     Error(
...
static const struct tagname {
 ...
 const char* name;
    ...
    { 32953, "IgReferencePoints (Island Graphics)" },
    { 32954, "IgRegionTackPoint (Island Graphics)" },
    { 32955,"IgRegionWarpCorners (Island Graphics)" },
    { 32956, "IgRegionAffine (Island Graphics)" },
...
# 653 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/tiffdump.c" 2
...
PrintASCII(FILE* fd, uint32 cc, const unsigned char* cp)
{
 for (; cc > 0; cc--, cp++) {
  ...
  if (((*__ctype_b_loc ())[(int) ((*cp))] & (unsigned short int) _ISprint)) {
   fputc(*cp, fd);
   continue;
  }
  for (tp = "\tt\bb\rr\nn\vv"; *tp; tp++)
