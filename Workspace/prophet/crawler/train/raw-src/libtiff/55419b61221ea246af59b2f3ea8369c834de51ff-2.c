# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c"
# 1 "./tiffiop.h" 1
# 33 "./tiffiop.h"
# 1 "./tif_config.h" 1
# 34 "./tiffiop.h" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c" 2
# 92 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c"
# 1 "./tif_predict.h" 1
# 38 "./tif_predict.h"
typedef struct {
 int predictor;
...
# 93 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c" 2
...
# 94 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c" 2
...
# 97 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c" 2
...
# 98 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c" 2
# 108 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c"
 ...
 float *ToLinearF)
{
 ...
 if (stride == 3) {
  ...
  op[3] = t3;
     ...
     { int i; i=stride; do { i--; *op = ToLinearF[*wp&mask]; wp++; op++; } while (i>0); }
     n -= stride;
     while (n > 0) {
  { int i; i=stride; do { i--; wp[stride] += *wp; *op = ToLinearF[*wp&mask]; wp++; op++; } while (i>0); }
 ...
 float *ToLinearF)
{
 ...
 mask = 0x7ff;
 if (stride == 3) {
     t0 = ToLinearF[cr = (wp[0] & mask)] * 2048.0F;
     t1 = ToLinearF[cg = (wp[1] & mask)] * 2048.0F;
     t2 = ToLinearF[cb = (wp[2] & mask)] * 2048.0F;
     op[0] = (((t0) < 3071) ? (uint16) (t0) : 3071);
     op[1] = (((t1) < 3071) ? (uint16) (t1) : 3071);
     op[2] = (((t2) < 3071) ? (uint16) (t2) : 3071);
     n -= 3;
     while (n > 0) {
  wp += 3;
  op += 3;
  ...
  op[2] = (((t2) < 3071) ? (uint16) (t2) : 3071);
     ...
     t1 = ToLinearF[cg = (wp[1] & mask)] * 2048.0F;
     t2 = ToLinearF[cb = (wp[2] & mask)] * 2048.0F;
     t3 = ToLinearF[ca = (wp[3] & mask)] * 2048.0F;
     op[0] = (((t0) < 3071) ? (uint16) (t0) : 3071);
     op[1] = (((t1) < 3071) ? (uint16) (t1) : 3071);
     op[2] = (((t2) < 3071) ? (uint16) (t2) : 3071);
     op[3] = (((t3) < 3071) ? (uint16) (t3) : 3071);
     n -= 4;
     while (n > 0) {
  wp += 4;
  op += 4;
  ...
  op[3] = (((t3) < 3071) ? (uint16) (t3) : 3071);
     ...
     { int i; i=stride; do { i--; t0 = ToLinearF[*wp&mask] * 2048.0F; *op = (((t0) < 3071) ? (uint16) (t0) : 3071); wp++; op++; } while (i>0); }

     n -= stride;
     while (n > 0) {
  { int i; i=stride; do { i--; wp[stride] += *wp; t0 = ToLinearF[wp[stride]&mask]*2048.0F; *op = (((t0) < 3071) ? (uint16) (t0) : 3071); wp++; op++; } while (i>0); }
 ...
 uint16 *ToLinear16)
{
 ...
 if (stride == 3) {
  ...
  op[3] = ToLinear16[(ca += wp[3]) & mask];
     ...
     { int i; i=stride; do { i--; *op = ToLinear16[*wp&mask]; wp++; op++; } while (i>0); }
     n -= stride;
     while (n > 0) {
  { int i; i=stride; do { i--; wp[stride] += *wp; *op = ToLinear16[*wp&mask]; wp++; op++; } while (i>0); }
...
horizontalAccumulate11(uint16 *wp, int n, int stride, uint16 *op)
{
 ...
 if (stride == 3) {
  ...
  op[3] = (ca += wp[3]) & mask;
     ...
     { int i; i=stride; do { i--; *op = *wp&mask; wp++; op++; } while (i>0); }
     n -= stride;
     while (n > 0) {
  { int i; i=stride; do { i--; wp[stride] += *wp; *op = *wp&mask; wp++; op++; } while (i>0); }
 ...
 unsigned char *ToLinear8)
{
 ...
 if (stride == 3) {
  ...
  op[3] = ToLinear8[(ca += wp[3]) & mask];
     ...
     { int i; i=stride; do { i--; *op = ToLinear8[*wp&mask]; wp++; op++; } while (i>0); }
     n -= stride;
     while (n > 0) {
  { int i; i=stride; do { i--; wp[stride] += *wp; *op = ToLinear8[*wp&mask]; wp++; op++; } while (i>0); }
...
{
# 494 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c"
    int nlin, lt2size;
    int i, j;
    ...
    ToLinearF = (float *)_TIFFmalloc(2049 * sizeof(float));
    ToLinear16 = (uint16 *)_TIFFmalloc(2049 * sizeof(uint16));
    ToLinear8 = (unsigned char *)_TIFFmalloc(2049 * sizeof(unsigned char));
    if (FromLT2 == ((void*)0) || From14 == ((void*)0) || From8 == ((void*)0) ||
  ToLinearF == ((void*)0) || ToLinear16 == ((void*)0) || ToLinear8 == ((void*)0)) {
...
PixarLogSetupDecode(TIFF* tif)
{
 ...
 ((sp != ((void*)0)) ? (void) (0) : __assert_fail ("sp != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 662, __PRETTY_FUNCTION__));
 ...
 sp->stride = (td->td_planarconfig == 1 ?
 ...
 if (inflateInit_((&sp->stream), "1.2.8", (int)sizeof(z_stream)) != 0) {
...
PixarLogPreDecode(TIFF* tif, uint16 s)
{
 ...
 (void) s;
 ((sp != ((void*)0)) ? (void) (0) : __assert_fail ("sp != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 707, __PRETTY_FUNCTION__));
 sp->stream.next_in = tif->tif_rawdata;
 ((sizeof(sp->stream.avail_in)==4) ? (void) (0) : __assert_fail ("sizeof(sp->stream.avail_in)==4", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 709, __PRETTY_FUNCTION__));
 ...
 return (inflateReset(&sp->stream) == 0);
}
...
PixarLogDecode(TIFF* tif, uint8* op, tmsize_t occ, uint16 s)
{
 ...
 (void) s;
 ((sp != ((void*)0)) ? (void) (0) : __assert_fail ("sp != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 756, __PRETTY_FUNCTION__));
 sp->stream.next_out = (unsigned char *) sp->tbuf;
 ((sizeof(sp->stream.avail_out)==4) ? (void) (0) : __assert_fail ("sizeof(sp->stream.avail_out)==4", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 758, __PRETTY_FUNCTION__));
...
PixarLogSetupEncode(TIFF* tif)
{
 ...
 ((sp != ((void*)0)) ? (void) (0) : __assert_fail ("sp != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 864, __PRETTY_FUNCTION__));
 ...
 if (deflateInit_((&sp->stream), (sp->quality), "1.2.8", (int)sizeof(z_stream)) != 0) {
  TIFFErrorExt(tif->tif_clientdata, module, "%s", sp->stream.msg);
  return (0);
 } else {
  sp->state |= 1;
...
PixarLogPreEncode(TIFF* tif, uint16 s)
{
 ...
 (void) s;
 ((sp != ((void*)0)) ? (void) (0) : __assert_fail ("sp != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 903, __PRETTY_FUNCTION__));
 sp->stream.next_out = tif->tif_rawdata;
 ((sizeof(sp->stream.avail_out)==4) ? (void) (0) : __assert_fail ("sizeof(sp->stream.avail_out)==4", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 905, __PRETTY_FUNCTION__));
 ...
 return (deflateReset(&sp->stream) == 0);
}
...
horizontalDifferenceF(float *ip, int n, int stride, uint16 *wp, uint16 *FromLT2)
{
    ...
    if (n >= stride) {
 if (stride == 3) {
     r2 = wp[0] = (uint16) ( (ip[0]<(float)0.) ? 0 : (ip[0]<(float)2.) ? FromLT2[(int)(ip[0]*fltsize)] : (ip[0]>(float)24.2) ? 2047 : LogK1*log(ip[0]*LogK2) + 0.5 );
     g2 = wp[1] = (uint16) ( (ip[1]<(float)0.) ? 0 : (ip[1]<(float)2.) ? FromLT2[(int)(ip[1]*fltsize)] : (ip[1]>(float)24.2) ? 2047 : LogK1*log(ip[1]*LogK2) + 0.5 );
     b2 = wp[2] = (uint16) ( (ip[2]<(float)0.) ? 0 : (ip[2]<(float)2.) ? FromLT2[(int)(ip[2]*fltsize)] : (ip[2]>(float)24.2) ? 2047 : LogK1*log(ip[2]*LogK2) + 0.5 );
     n -= 3;
     while (n > 0) {
  n -= 3;
  wp += 3;
  ip += 3;
  r1 = (int32) ( (ip[0]<(float)0.) ? 0 : (ip[0]<(float)2.) ? FromLT2[(int)(ip[0]*fltsize)] : (ip[0]>(float)24.2) ? 2047 : LogK1*log(ip[0]*LogK2) + 0.5 ); wp[0] = (r1-r2) & mask; r2 = r1;
  g1 = (int32) ( (ip[1]<(float)0.) ? 0 : (ip[1]<(float)2.) ? FromLT2[(int)(ip[1]*fltsize)] : (ip[1]>(float)24.2) ? 2047 : LogK1*log(ip[1]*LogK2) + 0.5 ); wp[1] = (g1-g2) & mask; g2 = g1;
  b1 = (int32) ( (ip[2]<(float)0.) ? 0 : (ip[2]<(float)2.) ? FromLT2[(int)(ip[2]*fltsize)] : (ip[2]>(float)24.2) ? 2047 : LogK1*log(ip[2]*LogK2) + 0.5 ); wp[2] = (b1-b2) & mask; b2 = b1;
     }
 } else if (stride == 4) {
     r2 = wp[0] = (uint16) ( (ip[0]<(float)0.) ? 0 : (ip[0]<(float)2.) ? FromLT2[(int)(ip[0]*fltsize)] : (ip[0]>(float)24.2) ? 2047 : LogK1*log(ip[0]*LogK2) + 0.5 );
     g2 = wp[1] = (uint16) ( (ip[1]<(float)0.) ? 0 : (ip[1]<(float)2.) ? FromLT2[(int)(ip[1]*fltsize)] : (ip[1]>(float)24.2) ? 2047 : LogK1*log(ip[1]*LogK2) + 0.5 );
     b2 = wp[2] = (uint16) ( (ip[2]<(float)0.) ? 0 : (ip[2]<(float)2.) ? FromLT2[(int)(ip[2]*fltsize)] : (ip[2]>(float)24.2) ? 2047 : LogK1*log(ip[2]*LogK2) + 0.5 );
     a2 = wp[3] = (uint16) ( (ip[3]<(float)0.) ? 0 : (ip[3]<(float)2.) ? FromLT2[(int)(ip[3]*fltsize)] : (ip[3]>(float)24.2) ? 2047 : LogK1*log(ip[3]*LogK2) + 0.5 );
     n -= 4;
     while (n > 0) {
  n -= 4;
  wp += 4;
  ...
  g1 = (int32) ( (ip[1]<(float)0.) ? 0 : (ip[1]<(float)2.) ? FromLT2[(int)(ip[1]*fltsize)] : (ip[1]>(float)24.2) ? 2047 : LogK1*log(ip[1]*LogK2) + 0.5 ); wp[1] = (g1-g2) & mask; g2 = g1;
  b1 = (int32) ( (ip[2]<(float)0.) ? 0 : (ip[2]<(float)2.) ? FromLT2[(int)(ip[2]*fltsize)] : (ip[2]>(float)24.2) ? 2047 : LogK1*log(ip[2]*LogK2) + 0.5 ); wp[2] = (b1-b2) & mask; b2 = b1;
  a1 = (int32) ( (ip[3]<(float)0.) ? 0 : (ip[3]<(float)2.) ? FromLT2[(int)(ip[3]*fltsize)] : (ip[3]>(float)24.2) ? 2047 : LogK1*log(ip[3]*LogK2) + 0.5 ); wp[3] = (a1-a2) & mask; a2 = a1;
     }
 } else {
     ip += n - 1;
     wp += n - 1;
     n -= stride;
     while (n > 0) {
  { int i; i=stride; do { i--; wp[0] = (uint16) ( (ip[0]<(float)0.) ? 0 : (ip[0]<(float)2.) ? FromLT2[(int)(ip[0]*fltsize)] : (ip[0]>(float)24.2) ? 2047 : LogK1*log(ip[0]*LogK2) + 0.5 ); wp[stride] -= wp[0]; wp[stride] &= mask; wp--; ip--; } while (i>0); }



  n -= stride;
     }
     { int i; i=stride; do { i--; wp[0] = (uint16) ( (ip[0]<(float)0.) ? 0 : (ip[0]<(float)2.) ? FromLT2[(int)(ip[0]*fltsize)] : (ip[0]>(float)24.2) ? 2047 : LogK1*log(ip[0]*LogK2) + 0.5 ); wp--; ip--; } while (i>0); }
 }
    }
}
 ...
 unsigned short *wp, uint16 *From14)
{
    ...
    if (n >= stride) {
 if (stride == 3) {
     r2 = wp[0] = From14[(ip[0]) >> 2]; g2 = wp[1] = From14[(ip[1]) >> 2];
     b2 = wp[2] = From14[(ip[2]) >> 2];
     n -= 3;
     while (n > 0) {
  n -= 3;
  wp += 3;
  ip += 3;
  r1 = From14[(ip[0]) >> 2]; wp[0] = (r1-r2) & mask; r2 = r1;
  g1 = From14[(ip[1]) >> 2]; wp[1] = (g1-g2) & mask; g2 = g1;
  b1 = From14[(ip[2]) >> 2]; wp[2] = (b1-b2) & mask; b2 = b1;
     }
 } else if (stride == 4) {
     r2 = wp[0] = From14[(ip[0]) >> 2]; g2 = wp[1] = From14[(ip[1]) >> 2];
     b2 = wp[2] = From14[(ip[2]) >> 2]; a2 = wp[3] = From14[(ip[3]) >> 2];
     n -= 4;
     while (n > 0) {
  n -= 4;
  wp += 4;
  ...
  g1 = From14[(ip[1]) >> 2]; wp[1] = (g1-g2) & mask; g2 = g1;
  b1 = From14[(ip[2]) >> 2]; wp[2] = (b1-b2) & mask; b2 = b1;
  a1 = From14[(ip[3]) >> 2]; wp[3] = (a1-a2) & mask; a2 = a1;
     }
 } else {
     ip += n - 1;
     wp += n - 1;
     n -= stride;
     while (n > 0) {
  { int i; i=stride; do { i--; wp[0] = From14[(ip[0]) >> 2]; wp[stride] -= wp[0]; wp[stride] &= mask; wp--; ip--; } while (i>0); }



  n -= stride;
     }
     { int i; i=stride; do { i--; wp[0] = From14[(ip[0]) >> 2]; wp--; ip--; } while (i>0); }
 }
    }
}
 ...
 unsigned short *wp, uint16 *From8)
{
 ...
 if (stride == 3) {
  ...
  ip += 3;
     ...
     r2 = wp[0] = (From8[(ip[0])]); g2 = wp[1] = (From8[(ip[1])]);
     b2 = wp[2] = (From8[(ip[2])]); a2 = wp[3] = (From8[(ip[3])]);
     n -= 4;
     while (n > 0) {
  n -= 4;
  ...
  ip += 4;
     ...
     n -= stride;
     while (n > 0) {
  { int i; i=stride; do { i--; wp[0] = (From8[(ip[0])]); wp[stride] -= wp[0]; wp[stride] &= mask; wp--; ip--; } while (i>0); }



  n -= stride;
     }
     { int i; i=stride; do { i--; wp[0] = (From8[(ip[0])]); wp--; ip--; } while (i>0); }
 }
    }
}
...
PixarLogEncode(TIFF* tif, uint8* bp, tmsize_t cc, uint16 s)
{
 ...
 ((sizeof(sp->stream.avail_in)==4) ? (void) (0) : __assert_fail ("sizeof(sp->stream.avail_in)==4", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 1145, __PRETTY_FUNCTION__));
...
{
 TIFFDirectory *td = &tif->tif_dir;
# 1222 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c"
...
PixarLogCleanup(TIFF* tif)
{
 ...
 ((sp != 0) ? (void) (0) : __assert_fail ("sp != 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 1231, __PRETTY_FUNCTION__));
...
PixarLogVSetField(TIFF* tif, uint32 tag, va_list ap)
{
    ...
    switch (tag) {
     case 65558:
  sp->quality = (int) __builtin_va_arg(ap, int);
  if (tif->tif_mode != 00 && (sp->state&1)) {
  ...
  return (1);
     case 65549:
 sp->user_datafmt = (int) __builtin_va_arg(ap, int);
 ...
 switch (sp->user_datafmt) {
  case 0:
  case 1:
     TIFFSetField(tif, 258, 8);
     TIFFSetField(tif, 339, 1);
     break;
  case 2:
     TIFFSetField(tif, 258, 16);
     TIFFSetField(tif, 339, 1);
     break;
  case 3:
     TIFFSetField(tif, 258, 16);
...
PixarLogVGetField(TIFF* tif, uint32 tag, va_list ap)
{
    ...
    switch (tag) {
     case 65558:
 *__builtin_va_arg(ap, int*) = sp->quality;
 break;
     case 65549:
...
static const TIFFField pixarlogFields[] = {
    {65549, 0, 0, TIFF_NOTYPE, 0, TIFF_SETGET_INT, TIFF_SETGET_UNDEFINED, 0, 0, 0, "", ((void*)0)},
    {65558, 0, 0, TIFF_NOTYPE, 0, TIFF_SETGET_INT, TIFF_SETGET_UNDEFINED, 0, 0, 0, "", ((void*)0)}
};
...
TIFFInitPixarLog(TIFF* tif, int scheme)
{
 ...
 ((scheme == 32909) ? (void) (0) : __assert_fail ("scheme == 32909", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_pixarlog.c", 1350, __PRETTY_FUNCTION__));
