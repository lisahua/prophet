# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c" 2
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
# 1 "./tiffiop.h" 1
# 33 "./tiffiop.h"
# 1 "./tif_config.h" 1
# 34 "./tiffiop.h" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c" 2
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
...
TIFFWriteEncodedStrip(TIFF* tif, uint32 strip, void* data, tmsize_t cc)
{
 ...
 if (!(((tif)->tif_flags&0x00040) || TIFFWriteCheck((tif),0,module)))
  return ((tmsize_t) -1);
# 201 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
...
TIFFWriteRawStrip(TIFF* tif, uint32 strip, void* data, tmsize_t cc)
{
 ...
 if (!(((tif)->tif_flags&0x00040) || TIFFWriteCheck((tif),0,module)))
  return ((tmsize_t) -1);
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
 if (strip >= td->td_nstrips) {
  if (td->td_planarconfig == 2) {
   TIFFErrorExt(tif->tif_clientdata, module,
       "Can not grow image by strips when using separate planes");
...
# 350 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
tmsize_t
...
# 450 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
tmsize_t
...
# 510 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
int
...
# 536 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c"
...
TIFFGrowStrips(TIFF* tif, uint32 delta, const char* module)
{
 ...
 ((td->td_planarconfig == 1) ? (void) (0) : __assert_fail ("td->td_planarconfig == 1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c", 630, __PRETTY_FUNCTION__));
...
TIFFAppendToStrip(TIFF* tif, uint32 strip, uint8* data, tmsize_t cc)
{
 ...
 if (td->td_stripoffset[strip] == 0 || tif->tif_curoff == 0) {
            ((td->td_nstrips > 0) ? (void) (0) : __assert_fail ("td->td_nstrips > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_write.c", 668, __PRETTY_FUNCTION__));
