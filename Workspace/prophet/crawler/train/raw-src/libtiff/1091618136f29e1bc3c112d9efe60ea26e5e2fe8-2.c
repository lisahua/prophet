# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c" 2
# 124 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c"
# 1 "./tiffiop.h" 1
# 33 "./tiffiop.h"
# 1 "./tif_config.h" 1
# 34 "./tiffiop.h" 2
...
# 125 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c" 2
# 177 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c"
...
extern void siglongjmp (sigjmp_buf __env, int __val)
     __attribute__ ((__nothrow__)) __attribute__ ((__noreturn__));
# 189 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c" 2
# 205 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c"
...
# 206 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c" 2
...
# 207 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c" 2
...
# 390 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c"
...
TIFFInitOJPEG(TIFF* tif, int scheme)
{
 ...
 ((scheme==6) ? (void) (0) : __assert_fail ("scheme==6", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 412, __PRETTY_FUNCTION__));
...
OJPEGPrintDir(TIFF* tif, FILE* fd, long flags)
{
 ...
 uint8 m;
 (void)flags;
 ((sp!=((void*)0)) ? (void) (0) : __assert_fail ("sp!=((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 599, __PRETTY_FUNCTION__));
...
OJPEGDecodeRaw(TIFF* tif, uint8* buf, tmsize_t cc)
{
 ...
 ((cc>0) ? (void) (0) : __assert_fail ("cc>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 804, __PRETTY_FUNCTION__));
 m=buf;
 n=cc;
 do
 {
...
OJPEGDecodeScanlines(TIFF* tif, uint8* buf, tmsize_t cc)
{
 ...
 ((cc>0) ? (void) (0) : __assert_fail ("cc>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 852, __PRETTY_FUNCTION__));
 m=buf;
 n=cc;
 do
 {
...
OJPEGPostDecode(TIFF* tif, uint8* buf, tmsize_t cc)
{
 ...
 {
  ((sp->libjpeg_session_active!=0) ? (void) (0) : __assert_fail ("sp->libjpeg_session_active!=0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 874, __PRETTY_FUNCTION__));
  OJPEGLibjpegSessionAbort(tif);
  sp->writeheader_done=0;
 }
}
...
OJPEGSubsamplingCorrect(TIFF* tif)
{
 ...
 uint8 mh;
 uint8 mv;
 ((sp->subsamplingcorrect_done==0) ? (void) (0) : __assert_fail ("sp->subsamplingcorrect_done==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 970, __PRETTY_FUNCTION__));
...
OJPEGReadHeaderInfo(TIFF* tif)
{
 ...
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 ((sp->readheader_done==0) ? (void) (0) : __assert_fail ("sp->readheader_done==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1021, __PRETTY_FUNCTION__));
...
OJPEGReadSecondarySos(TIFF* tif, uint16 s)
{
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 uint8 m;
 ((s>0) ? (void) (0) : __assert_fail ("s>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1083, __PRETTY_FUNCTION__));
 ((s<3) ? (void) (0) : __assert_fail ("s<3", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1084, __PRETTY_FUNCTION__));
 ((sp->sos_end[0].log!=0) ? (void) (0) : __assert_fail ("sp->sos_end[0].log!=0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1085, __PRETTY_FUNCTION__));
 ((sp->sos_end[s].log==0) ? (void) (0) : __assert_fail ("sp->sos_end[s].log==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1086, __PRETTY_FUNCTION__));
...
OJPEGWriteHeaderInfo(TIFF* tif)
{
 ...
 uint8** m;
 uint32 n;
 ((sp->libjpeg_session_active==0) ? (void) (0) : __assert_fail ("sp->libjpeg_session_active==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1135, __PRETTY_FUNCTION__));
 ...
 if ((sp->subsampling_force_desubsampling_inside_decompression==0) && (sp->samples_per_pixel_per_plane>1))
 {
  ...
  {
   ((sp->subsampling_convert_ycbcrbuf==0) ? (void) (0) : __assert_fail ("sp->subsampling_convert_ycbcrbuf==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1164, __PRETTY_FUNCTION__));
   ((sp->subsampling_convert_ycbcrimage==0) ? (void) (0) : __assert_fail ("sp->subsampling_convert_ycbcrimage==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1165, __PRETTY_FUNCTION__));
...
{
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 ((sp->libjpeg_session_active!=0) ? (void) (0) : __assert_fail ("sp->libjpeg_session_active!=0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1224, __PRETTY_FUNCTION__));
 ...
 do
 {
  ...
  switch(m)
  {
   ...
   case 0xDA:
    if (sp->subsamplingcorrect!=0)
     return(1);
    ((sp->plane_sample_offset==0) ? (void) (0) : __assert_fail ("sp->plane_sample_offset==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1326, __PRETTY_FUNCTION__));
    if (OJPEGReadHeaderInfoSecStreamSos(tif)==0)
     return(0);
    break;
   default:
...
OJPEGReadHeaderInfoSecStreamSos(TIFF* tif)
{
 ...
 uint8 n;
 uint8 o;
 ((sp->subsamplingcorrect==0) ? (void) (0) : __assert_fail ("sp->subsamplingcorrect==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1668, __PRETTY_FUNCTION__));
 if (sp->sof_log==0)
 {
...
OJPEGReadBufferFill(OJPEGState* sp)
{
 ...
 do
 {
  if (sp->in_buffer_file_togo!=0)
  {
   ...
   if (n==0)
    return(0);
   ((n>0) ? (void) (0) : __assert_fail ("n>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1911, __PRETTY_FUNCTION__));
   ((n<=2048) ? (void) (0) : __assert_fail ("n<=2048", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1912, __PRETTY_FUNCTION__));
   ((n<65536) ? (void) (0) : __assert_fail ("n<65536", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1913, __PRETTY_FUNCTION__));
   (((uint64)n<=sp->in_buffer_file_togo) ? (void) (0) : __assert_fail ("(uint64)n<=sp->in_buffer_file_togo", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1914, __PRETTY_FUNCTION__));
   m=(uint16)n;
   sp->in_buffer_togo=m;
...
OJPEGReadByte(OJPEGState* sp, uint8* byte)
{
 if (sp->in_buffer_togo==0)
 {
  if (OJPEGReadBufferFill(sp)==0)
   return(0);
  ((sp->in_buffer_togo>0) ? (void) (0) : __assert_fail ("sp->in_buffer_togo>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1977, __PRETTY_FUNCTION__));
 }
...
OJPEGReadBytePeek(OJPEGState* sp, uint8* byte)
{
 if (sp->in_buffer_togo==0)
 {
  if (OJPEGReadBufferFill(sp)==0)
   return(0);
  ((sp->in_buffer_togo>0) ? (void) (0) : __assert_fail ("sp->in_buffer_togo>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 1992, __PRETTY_FUNCTION__));
 }
 *byte=*(sp->in_buffer_cur);
 return(1);
}
...
{
 ((sp->in_buffer_togo>0) ? (void) (0) : __assert_fail ("sp->in_buffer_togo>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2001, __PRETTY_FUNCTION__));
 sp->in_buffer_cur++;
 sp->in_buffer_togo--;
}
...
OJPEGReadBlock(OJPEGState* sp, uint16 len, void* mem)
{
 ...
 uint8* mmem;
 uint16 n;
 ((len>0) ? (void) (0) : __assert_fail ("len>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2025, __PRETTY_FUNCTION__));
 mlen=len;
 mmem=mem;
 do
 {
  if (sp->in_buffer_togo==0)
  {
   if (OJPEGReadBufferFill(sp)==0)
    return(0);
   ((sp->in_buffer_togo>0) ? (void) (0) : __assert_fail ("sp->in_buffer_togo>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2034, __PRETTY_FUNCTION__));
  }
  n=mlen;
...
OJPEGReadSkip(OJPEGState* sp, uint16 len)
{
 ...
 if (m>0)
 {
  ((sp->in_buffer_togo==0) ? (void) (0) : __assert_fail ("sp->in_buffer_togo==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2062, __PRETTY_FUNCTION__));
  n=m;
 ...
 *len=0;
 do
 {
  ((sp->out_state<=ososEoi) ? (void) (0) : __assert_fail ("sp->out_state<=ososEoi", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2085, __PRETTY_FUNCTION__));
  switch(sp->out_state)
  {
   case ososSoi:
...
{
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 ((2048>=2) ? (void) (0) : __assert_fail ("2048>=2", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2155, __PRETTY_FUNCTION__));
 sp->out_buffer[0]=255;
...
{
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 ((2048>=6) ? (void) (0) : __assert_fail ("2048>=6", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2203, __PRETTY_FUNCTION__));
...
OJPEGWriteStreamSof(TIFF* tif, void** mem, uint32* len)
{
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 uint8 m;
 ((2048>=2+8+sp->samples_per_pixel_per_plane*3) ? (void) (0) : __assert_fail ("2048>=2+8+sp->samples_per_pixel_per_plane*3", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2223, __PRETTY_FUNCTION__));
 ((255>=8+sp->samples_per_pixel_per_plane*3) ? (void) (0) : __assert_fail ("255>=8+sp->samples_per_pixel_per_plane*3", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2224, __PRETTY_FUNCTION__));
 sp->out_buffer[0]=255;
...
OJPEGWriteStreamSos(TIFF* tif, void** mem, uint32* len)
{
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 uint8 m;
 ((2048>=2+6+sp->samples_per_pixel_per_plane*2) ? (void) (0) : __assert_fail ("2048>=2+6+sp->samples_per_pixel_per_plane*2", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2259, __PRETTY_FUNCTION__));
 ((255>=6+sp->samples_per_pixel_per_plane*2) ? (void) (0) : __assert_fail ("255>=6+sp->samples_per_pixel_per_plane*2", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2260, __PRETTY_FUNCTION__));
 sp->out_buffer[0]=255;
...
OJPEGWriteStreamCompressed(TIFF* tif, void** mem, uint32* len)
{
 ...
 if (sp->in_buffer_togo==0)
 {
  if (OJPEGReadBufferFill(sp)==0)
   return(0);
  ((sp->in_buffer_togo>0) ? (void) (0) : __assert_fail ("sp->in_buffer_togo>0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2294, __PRETTY_FUNCTION__));
 }
...
{
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 ((2048>=2) ? (void) (0) : __assert_fail ("2048>=2", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2323, __PRETTY_FUNCTION__));
 sp->out_buffer[0]=255;
...
{
 OJPEGState* sp=(OJPEGState*)tif->tif_data;
 ((2048>=2) ? (void) (0) : __assert_fail ("2048>=2", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_ojpeg.c", 2338, __PRETTY_FUNCTION__));
 sp->out_buffer[0]=255;
