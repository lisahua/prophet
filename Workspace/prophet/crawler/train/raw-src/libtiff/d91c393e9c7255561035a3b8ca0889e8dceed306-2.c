# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c"
# 1 "../libtiff/tif_config.h" 1
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
# 1 "/usr/include/time.h" 1 3 4
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c"
...
extern const TIFFFieldInfo* TIFFFindFieldInfoByName(TIFF* , const char *,
          TIFFDataType);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c" 2
...
int row;
int maxline = 512;
# 71 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c"
static void
...
# 113 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/fax2ps.c"
 l = 0;
 while (runlength > 6) {
...
emitFont(FILE* fd)
{
 ...
 ((void*)0)
    ...
    int i;
    for (i = 0; fontPrologue[i] != ((void*)0); i++)
 fprintf(fd, "%s\n", fontPrologue[i]);
}
...
printTIF(TIFF* tif, uint16 pageNumber)
{
    ...
    if (!TIFFGetField(tif, 259, &compression)
 || compression < 2
 || compression > 4)
 return;
    if (!TIFFGetField(tif, 282, &xres) || !xres) {
 TIFFWarning(TIFFFileName(tif),
     "No x-resolution, assuming %g dpi", defxres);
 xres = defxres;
    }
    if (!TIFFGetField(tif, 283, &yres) || !yres) {
 TIFFWarning(TIFFFileName(tif),
     "No y-resolution, assuming %g lpi", defyres);
 yres = defyres;
    }
    if (TIFFGetField(tif, 296, &unit) &&
      unit == 3) {
 xres *= 2.54F;
 yres *= 2.54F;
    }
 ...
 (int)(pageWidth * points), (int)(pageHeight * points));
    ...
    printf("0 setgray\n");
    TIFFSetField(tif, 65540, printruns);
    ns = TIFFNumberOfStrips(tif);
    row = 0;
    for (s = 0; s < ns; s++)
 (void) TIFFReadEncodedStrip(tif, s, (tdata_t) ((void*)0), (tsize_t) -1);
    printf("p\n");
...
findPage(TIFF* tif, uint16 pageNumber)
{
    ...
    if (TIFFGetField(tif, 297, &pn, &ptotal)) {
 while (pn != (pageNumber-1) && TIFFReadDirectory(tif) && TIFFGetField(tif, 297, &pn, &ptotal))
     ;
...
main(int argc, char** argv)
{
    extern int optind;
    extern char* optarg;
    uint16 *pages = ((void*)0), npages = 0, pageNumber;
    int c, dowarnings = 0;
    TIFF* tif;
