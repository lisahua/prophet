# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2


# 1 "../../libtiff/tif_config.h" 1
# 4 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2
...
# 6 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2
...
# 7 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2
...
# 8 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2
# 1 "/usr/include/memory.h" 1 3 4
# 9 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2
...
# 10 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2


# 1 "/usr/include/strings.h" 1 3 4
# 13 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2
...
# 21 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c" 2
...
void formatString(FILE *ofile, const char *s, int len)
{
  ...
  for (; len > 0; --len, ++s) {
    ...
    case '&':
      fputs("&amp;", ofile);
      break;
# 114 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c"
    case '"':
      fputs("&quot;", ofile);
      break;
    default:
      if (((*__ctype_b_loc ())[(int) ((c))] & (unsigned short int) _IScntrl))
        fprintf(ofile, "&#%d;", c);
      else
        _IO_putc (*s, ofile);
      break;
...
int formatIPTC(FILE *ifile, FILE *ofile)
{
  ...
  while (c != (-1))
  {
   if (c == 0x1c)
    ...
    dataset = _IO_getc (ifile);
   if ((char) dataset == (-1))
     return -1;
    recnum = _IO_getc (ifile);
   if ((char) recnum == (-1))
     return -1;
...
char *super_fgets(char *b, int *blen, FILE *file)
{
  ...
  *blen=0;
  if ((unsigned char *)b != (unsigned char *) ((void*)0))
    {
      int
        tlen;
  ...
  if (mode == 1)
    {
      ...
      token = (char *)((void*)0);
      while((line = super_fgets(line,&inputlen,ifile))!=((void*)0))
      {
        state=0;
        next=0;
...
# 765 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/contrib/iptcutil/iptcutil.c"
int _p_state;
unsigned _p_flag;
char _p_curquote;
int _p_tokpos;
...
void chstore(char *string,int max,char ch)
{
  ...
  if(_p_tokpos>=0&&_p_tokpos<max-1)
  {
    if(_p_state==2)
      ...
      {
     case 1:
       c=(__extension__ ({ int __res; if (sizeof (ch) > 1) { if (__builtin_constant_p (ch)) { int __c = (ch); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (ch); } else __res = (*__ctype_toupper_loc ())[(int) (ch)]; __res; }));
       break;

     case 2:
       c=(__extension__ ({ int __res; if (sizeof (ch) > 1) { if (__builtin_constant_p (ch)) { int __c = (ch); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (ch); } else __res = (*__ctype_tolower_loc ())[(int) (ch)]; __res; }));
       break;
