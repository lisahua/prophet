# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c" 2
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
# 1 "./tiffiop.h" 1
# 33 "./tiffiop.h"
# 1 "./tif_config.h" 1
# 34 "./tiffiop.h" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c" 2
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
...
TIFFRGBAImageEnd(TIFFRGBAImage* img)
{
 ...
 if (img->cielab)
  _TIFFfree(img->cielab), img->cielab = ((void*)0);
 if (img->UaToAa)
  _TIFFfree(img->UaToAa), img->UaToAa = ((void*)0);
 if (img->Bitdepth16To8)
  _TIFFfree(img->Bitdepth16To8), img->Bitdepth16To8 = ((void*)0);
  ...
  for (col = 0; col < w; col += tw)
  {
   ...
   if (col + tw > w)
   {
    ...
    (*put)(img, raster+y*w+col, col, y,
        ...
        p0 + pos, p1 + pos, p2 + pos, (alpha?(pa+pos):((void*)0)));
   } else {
    (*put)(img, raster+y*w+col, col, y,
        tw, nrow, 0, toskew, p0 + pos, p1 + pos, p2 + pos, (alpha?(pa+pos):((void*)0)));
   }
  }
...
# 1103 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
...
# 1466 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
...
# 1691 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
...
# 2149 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
static int
...
# 2285 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
static int
 ...
 switch (img->photometric) {
  ...
  case 6:
   if (img->bitspersample == 8)
   {
    ...
    {
# 2482 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
...
BuildMapUaToAa(TIFFRGBAImage* img)
{
 ...
 uint8* m;
 uint16 na,nv;
 ((img->UaToAa==((void*)0)) ? (void) (0) : __assert_fail ("img->UaToAa==((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c", 2595, __PRETTY_FUNCTION__));
...
BuildMapBitdepth16To8(TIFFRGBAImage* img)
{
 ...
 uint8* m;
 uint32 n;
 ((img->Bitdepth16To8==((void*)0)) ? (void) (0) : __assert_fail ("img->Bitdepth16To8==((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c", 2617, __PRETTY_FUNCTION__));
...
# 2639 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
int
...
# 2740 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
    ...
    TIFFRGBAImageEnd(&img);
# 2769 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_getimage.c"
