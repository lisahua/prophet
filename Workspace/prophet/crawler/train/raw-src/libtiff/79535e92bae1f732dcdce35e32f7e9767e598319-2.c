# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c" 2
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
# 1 "./tiffiop.h" 1
# 33 "./tiffiop.h"
# 1 "./tif_config.h" 1
# 34 "./tiffiop.h" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c" 2
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
 ...
 if (strip != tif->tif_curstrip) {
  ...
  if (strip >= td->td_stripsperimage && imagegrew)
   td->td_stripsperimage =
       (((uint32)td->td_imagelength < (0xffffffff - (uint32)(td->td_rowsperstrip-1))) ? ((((uint32)(td->td_imagelength))+(((uint32)(td->td_rowsperstrip))-1))/((uint32)(td->td_rowsperstrip))) : 0U);
  tif->tif_row =
...
TIFFWriteEncodedStrip(TIFF* tif, uint32 strip, void* data, tmsize_t cc)
{
 ...
 if (!(((tif)->tif_flags&0x00040) || TIFFWriteCheck((tif),0,module)))
  return ((tmsize_t) -1);
# 201 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
 ...
 if( td->td_stripbytecount[strip] > 0 )
        {
            ...
            if( tif->tif_rawdatasize <= (tmsize_t)td->td_stripbytecount[strip] )
            {
                if( !(TIFFWriteBufferSetup(tif, ((void*)0),
                    (tmsize_t)(((((uint64)((uint64)(td->td_stripbytecount[strip] + 1)))+(((uint64)(1024))-1))/((uint64)(1024)))*(1024)))) )
                    return ((tmsize_t)(-1));
            }
...
TIFFWriteRawStrip(TIFF* tif, uint32 strip, void* data, tmsize_t cc)
{
 ...
 if (!(((tif)->tif_flags&0x00040) || TIFFWriteCheck((tif),0,module)))
  return ((tmsize_t) -1);
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
 if (strip >= td->td_nstrips) {
  if (td->td_planarconfig == 2) {
   TIFFErrorExt(tif->tif_clientdata, module,
       "Can not grow image by strips when using separate planes");
...
# 350 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
tmsize_t
TIFFWriteEncodedTile(TIFF* tif, uint32 tile, void* data, tmsize_t cc)
{
 ...
 if( td->td_stripbytecount[tile] > 0 )
        {
            ...
            {
                if( !(TIFFWriteBufferSetup(tif, ((void*)0),
                    (tmsize_t)(((((uint64)((uint64)(td->td_stripbytecount[tile] + 1)))+(((uint64)(1024))-1))/((uint64)(1024)))*(1024)))) )
                    return ((tmsize_t)(-1));
            }
 ...
 tif->tif_row = (tile % (((uint32)td->td_imagelength < (0xffffffff - (uint32)(td->td_tilelength-1))) ? ((((uint32)(td->td_imagelength))+(((uint32)(td->td_tilelength))-1))/((uint32)(td->td_tilelength))) : 0U))
  * td->td_tilelength;
 tif->tif_col = (tile % (((uint32)td->td_imagewidth < (0xffffffff - (uint32)(td->td_tilewidth-1))) ? ((((uint32)(td->td_imagewidth))+(((uint32)(td->td_tilewidth))-1))/((uint32)(td->td_tilewidth))) : 0U))
  * td->td_tilewidth;
...
# 450 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
tmsize_t
...
# 510 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
int
...
# 536 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c"
...
TIFFGrowStrips(TIFF* tif, uint32 delta, const char* module)
{
 ...
 ((td->td_planarconfig == 1) ? (void) (0) : __assert_fail ("td->td_planarconfig == 1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c", 630, __PRETTY_FUNCTION__));
...
TIFFAppendToStrip(TIFF* tif, uint32 strip, uint8* data, tmsize_t cc)
{
 ...
 if (td->td_stripoffset[strip] == 0 || tif->tif_curoff == 0) {
            ((td->td_nstrips > 0) ? (void) (0) : __assert_fail ("td->td_nstrips > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/libtiff/tif_write.c", 668, __PRETTY_FUNCTION__));
...
{
 if (tif->tif_rawcc > 0 && tif->tif_flags & 0x100000 ) {
