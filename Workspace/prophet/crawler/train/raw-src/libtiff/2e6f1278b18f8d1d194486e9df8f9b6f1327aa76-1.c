# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 312 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c" 2
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
# 1 "./tiffiop.h" 1
# 33 "./tiffiop.h"
# 1 "./tif_config.h" 1
# 34 "./tiffiop.h" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c" 2
...
TIFFFillStripPartial( TIFF *tif, int strip, tmsize_t read_ahead, int restart )
{
 ...
 register TIFFDirectory *td = &tif->tif_dir;
        ...
        if (read_ahead*2 > tif->tif_rawdatasize) {
                ((restart) ? (void) (0) : __assert_fail ("restart", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c", 65, __PRETTY_FUNCTION__));

                tif->tif_curstrip = ((uint32)(-1));
                if ((tif->tif_flags & 0x00200) == 0) {
        ...
        if (!(((*((tif))->tif_seekproc)(((tif))->tif_clientdata,((read_offset)),(0)))==(read_offset))) {
                TIFFErrorExt(tif->tif_clientdata, module,
...
# 168 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
static int
...
# 205 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
        whole_strip = 1;
 ...
 if (strip != tif->tif_curstrip) {
        ...
        if (row < tif->tif_row) {
# 254 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
    ...
    const char* module)
{
 ...
 (((tif->tif_flags&0x20000)==0) ? (void) (0) : __assert_fail ("(tif->tif_flags&0x20000)==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c", 364, __PRETTY_FUNCTION__));
 if (!(((tif)->tif_flags & 0x00800) != 0)) {
  ...
  if (((uint64)ma!=td->td_stripoffset[strip])||(ma>tif->tif_size))
   ...
   n=size;
  if (n!=size) {
# 411 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
   TIFFErrorExt(tif->tif_clientdata, module,
...
# 520 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
   if ((tif->tif_flags & 0x00200) && tif->tif_rawdata)
    _TIFFfree(tif->tif_rawdata);
   tif->tif_flags &= ~0x00200;
# 532 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
   if (bytecount > (uint64)tif->tif_size ||
       td->td_stripoffset[strip] > (uint64)tif->tif_size - bytecount) {
# 548 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
    TIFFErrorExt(tif->tif_clientdata, module,
...
# 611 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
tmsize_t
...
TIFFReadRawTile1(TIFF* tif, uint32 tile, void* buf, tmsize_t size, const char* module)
{
 ...
 (((tif->tif_flags&0x20000)==0) ? (void) (0) : __assert_fail ("(tif->tif_flags&0x20000)==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c", 658, __PRETTY_FUNCTION__));
 if (!(((tif)->tif_flags & 0x00800) != 0)) {
  tmsize_t cc;

  if (!(((*((tif))->tif_seekproc)(((tif))->tif_clientdata,((td->td_stripoffset[tile])),(0)))==(td->td_stripoffset[tile]))) {
   TIFFErrorExt(tif->tif_clientdata, module,
  ...
  cc = ((*(tif)->tif_readproc)((tif)->tif_clientdata,(buf),(size)));
  if (cc != size) {
# 680 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
   TIFFErrorExt(tif->tif_clientdata, module,
 "Read error at row %lu, col %lu; got %llu bytes, expected %llu",
  ...
  if (((uint64)ma!=td->td_stripoffset[tile])||(ma>tif->tif_size))
   ...
   n=size;
  if (n!=size) {
# 710 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
   TIFFErrorExt(tif->tif_clientdata, module,
...
TIFFFillTile(TIFF* tif, uint32 tile)
{
 ...
 if ((tif->tif_flags&0x20000)==0)
 {
  ...
  if ((((tif)->tif_flags & 0x00800) != 0) &&
      ((((tif)->tif_flags & (td->td_fillorder)) != 0)
       || (tif->tif_flags & 0x00100))) {
# 805 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
   if ((tif->tif_flags & 0x00200) && tif->tif_rawdata)
    _TIFFfree(tif->tif_rawdata);
   tif->tif_flags &= ~0x00200;
# 817 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
   if (bytecount > (uint64)tif->tif_size ||
...
# 876 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c"
int
TIFFReadBufferSetup(TIFF* tif, void* bp, tmsize_t size)
{
 static const char module[] = "TIFFReadBufferSetup";

 (((tif->tif_flags&0x20000)==0) ? (void) (0) : __assert_fail ("(tif->tif_flags&0x20000)==0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c", 881, __PRETTY_FUNCTION__));
 if (tif->tif_rawdata) {
...
TIFFStartTile(TIFF* tif, uint32 tile)
{
 ...
 tif->tif_row =
     (tile % (((uint32)td->td_imagewidth < (0xffffffff - (uint32)(td->td_tilewidth-1))) ? ((((uint32)(td->td_imagewidth))+(((uint32)(td->td_tilewidth))-1))/((uint32)(td->td_tilewidth))) : 0U)) *
  td->td_tilelength;
 tif->tif_col =
     (tile % (((uint32)td->td_imagelength < (0xffffffff - (uint32)(td->td_tilelength-1))) ? ((((uint32)(td->td_imagelength))+(((uint32)(td->td_tilelength))-1))/((uint32)(td->td_tilelength))) : 0U)) *
  td->td_tilewidth;
        tif->tif_flags &= ~0x100000;
 if (tif->tif_flags&0x20000)
 {
...
{
    (void) tif;
    (((cc & 1) == 0) ? (void) (0) : __assert_fail ("(cc & 1) == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c", 1006, __PRETTY_FUNCTION__));
...
{
    (void) tif;
    (((cc % 3) == 0) ? (void) (0) : __assert_fail ("(cc % 3) == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c", 1014, __PRETTY_FUNCTION__));
...
{
    (void) tif;
    (((cc & 3) == 0) ? (void) (0) : __assert_fail ("(cc & 3) == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c", 1022, __PRETTY_FUNCTION__));
...
{
    (void) tif;
    (((cc & 7) == 0) ? (void) (0) : __assert_fail ("(cc & 7) == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/libtiff/tif_read.c", 1030, __PRETTY_FUNCTION__));
