# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c"
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
...
svn_client_move3(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 3936 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_propget3(apr_hash_t **props,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 4235 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_add_to_changelist(const apr_array_header_t *paths,
                             ...
                             svn_client_ctx_t *ctx,
                             apr_pool_t *pool);
# 4827 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_remove_from_changelists(const apr_array_header_t *paths,
                                   ...
                                   svn_client_ctx_t *ctx,
                                   apr_pool_t *pool);
# 4842 "./subversion/include/svn_client.h"
...
svn_info_dup(const svn_info_t *info,
             apr_pool_t *pool);
# 5152 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
...
svn_cl__revprop_prepare(const svn_opt_revision_t *revision,
                        ...
                        svn_client_ctx_t *ctx,
                        apr_pool_t *pool);
# 490 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__edit_file_externally(const char *path,
                             ...
                             apr_hash_t *config,
                             apr_pool_t *pool);
# 530 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
# 595 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__operation_str_human_readable(svn_wc_operation_t operation,
                                     apr_pool_t *pool);
# 685 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
void
...
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         ...
                         apr_pool_t *pool);
# 742 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
const char *
...
svn_cl__eat_peg_revisions(apr_array_header_t **true_targets_p,
                          const apr_array_header_t *targets,
                          apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
               ...
               apr_pool_t *pool)
{
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (svn_path_is_url(target))
        return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c",70), (svn_error_createf))(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0), dcgettext ("subversion", "'%s' is a URL, but URLs cannot be " "commit targets", 5), target));
  ...
  do { svn_error_t *svn_err__temp = (svn_path_condense_targets(&base_dir, &condensed_targets, targets, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (opt_state->depth < svn_depth_infinity)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "svn: warning: The depth of this commit " "is '%s', but copied directories will " "regardless be committed with depth '%s'. " "You must remove unwanted children of those " "directories in a separate commit.\n", 5), svn_depth_to_word(opt_state->depth), svn_depth_to_word(svn_depth_infinity))); if (svn_err__temp) return (svn_err__temp); } while (0);
# 115 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c"
