# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.h"
# 1 "./subversion/include/svn_fs.h" 1
# 30 "./subversion/include/svn_fs.h"
...
# 31 "./subversion/include/svn_fs.h" 2
...
# 32 "./subversion/include/svn_fs.h" 2
...
# 34 "./subversion/include/svn_fs.h" 2
...
# 35 "./subversion/include/svn_fs.h" 2
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.h" 2
...
svn_fs_fs__id_deserialize(void *buffer,
                          svn_fs_id_t **id);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.h" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
...
svn_fs_fs__deserialize_p2l_page(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
...
svn_fs_fs__write_rep_header(svn_fs_fs__rep_header_t *header,
                            svn_stream_t *stream,
                            apr_pool_t *scratch_pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
...
svn_fs_fs__use_log_addressing(svn_fs_t *fs,
                              svn_revnum_t rev);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
...
svn_stream__install_get_info(apr_finfo_t *finfo,
                             ...
                             apr_int32_t wanted,
                             apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rev_file.c" 2
...
set_read_only(void *baton)
{
  ...
  err = svn_io_set_file_read_only(ro_baton->file_path, (!0), ro_baton->pool);
  if (err)
    {
      status = err->apr_err;
      svn_error_clear(err);
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_stat(&finfo, path, (0x00700000 | 0x00030000), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_io__is_finfo_read_only(&is_read_only, &finfo, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (is_read_only)
    {


      set_read_only_baton_t *baton = memset(apr_palloc(result_pool, sizeof(*baton)), 0, sizeof(*baton));
      ...
      do { svn_error_t *svn_err__temp = (svn_io_set_file_read_write(path, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
}
  ...
  do
    {
      ...
      if (!err)
        err = svn_io_file_open(&apr_file, path, flags, 0x0FFF,
                               result_pool);

      if (!err)
        {
          file->file = apr_file;
          file->stream = svn_stream_from_aprfile2(apr_file, (!0),
                                                  result_pool);
                                 ...
                                 apr_pool_t *scratch_pool)
{
  *file = apr_palloc(result_pool, sizeof(**file));
  ...
  return (open_pack_or_rev_file(*file, fs, rev, 0, result_pool, scratch_pool));
  ...
  if (file->l2p_offset == -1)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_seek(file->file, 2, &filesize, file->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_io_file_aligned_seek(file->file, file->block_size, ((void*)0), filesize - 1, file->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(file->file, &footer_length, sizeof(footer_length), ((void*)0), ((void*)0), file->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




      footer = svn_stringbuf_create_ensure(footer_length, file->pool);
      do { svn_error_t *svn_err__temp = (svn_io_file_aligned_seek(file->file, file->block_size, ((void*)0), filesize - 1 - footer_length, file->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(file->file, footer->data, footer_length, &footer->len, ((void*)0), file->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      footer->data[footer->len] = '\0';


      do { svn_error_t *svn_err__temp = (svn_fs_fs__parse_footer(&file->l2p_offset, &file->p2l_offset, footer, file->start_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  apr_file_t *apr_file;
  do { svn_error_t *svn_err__temp = (svn_io_file_open(&apr_file, svn_fs_fs__path_txn_proto_rev(fs, txn_id, scratch_pool), 0x00001 | 0x00080, 0x0FFF, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





  *file = memset(apr_palloc(result_pool, sizeof(**file)), 0, sizeof(**file));
  (*file)->file = apr_file;
  (*file)->is_packed = 0;
  (*file)->start_revision = ((svn_revnum_t) -1);
  (*file)->stream = svn_stream_from_aprfile2(apr_file, (!0), result_pool);
...
{
  if (file->stream)
    do { svn_error_t *svn_err__temp = (svn_stream_close(file->stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (file->file)
    do { svn_error_t *svn_err__temp = (svn_io_file_close(file->file, file->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
