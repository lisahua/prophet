# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c" 2
...
svn_cl__path_join(const char *base,
                  const char *component,
                  apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c" 2
             ...
             apr_pool_t *pool)
{
  ...
  if (targets->nelts < 2)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c",59), (svn_error_create))(SVN_ERR_CL_INSUFFICIENT_ARGS, 0, ((void*)0));
  ...
  for (i = 0; i < (targets->nelts - 1); i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_opt_parse_path(peg_revision, &src, target, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      source->path = src;
  ...
  do { svn_error_t *svn_err__temp = (svn_opt_eat_peg_revisions(&targets, targets, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ((! srcs_are_urls) && (! dst_is_url))
    ...
    {
# 117 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c"
    }
  else if ((srcs_are_urls) && (! dst_is_url))
    {
  ...
  if (! dst_is_url)
    {
      ctx->log_msg_func3 = ((void*)0);
      if (opt_state->message || opt_state->filedata || opt_state->revprop_table)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/copy-cmd.c",131), (svn_error_create))
          (SVN_ERR_CL_UNNECESSARY_LOG_MESSAGE, ((void*)0),
           dcgettext ("subversion", "Local, non-commit operations do not take a log message " "or revision properties", 5));

    }

  if (ctx->log_msg_func3)
    do { svn_error_t *svn_err__temp = (svn_cl__make_log_msg_baton(&(ctx->log_msg_baton3), opt_state, ((void*)0), ctx->config, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  err = svn_client_copy5(&commit_info, sources, dst_path, (!0),
  ...
  if (commit_info && ! opt_state->quiet)
    do { svn_error_t *svn_err__temp = (svn_cl__print_commit_info(commit_info, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
