  ...
  if (cache->data_size / 4 > size && ensure_data_insertable(cache, size))
    {
      ...
      entry->size = size;
      entry->offset = cache->current_data;
# 1077 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
...
# 1163 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  entry->hit_count++;
  cache->hit_count++;
  cache->total_hits++;
                            ...
                            apr_pool_t *pool)
{
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      ...
      cache->hit_count++;
      cache->total_hits++;
# 1223 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1253 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
typedef struct svn_membuffer_cache_t
{
  ...
  int alloc_counter;
# 1299 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
} svn_membuffer_cache_t;
# 1310 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void
...
# 1369 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1628 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
