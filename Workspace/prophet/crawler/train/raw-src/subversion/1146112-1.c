...
svn_fs_type(const char **fs_type,
            const char *path,
            apr_pool_t *pool);
# 275 "./subversion/include/svn_fs.h"
const char *
...
svn_fs_delete_fs(const char *path,
                 apr_pool_t *pool);
# 297 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_hotcopy(const char *src_path,
               const char *dest_path,
               svn_boolean_t clean,
               apr_pool_t *pool);
# 338 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 492 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_access_add_lock_token(svn_fs_access_t *access_ctx,
                             const char *token);
# 598 "./subversion/include/svn_fs.h"
...
svn_fs_unparse_id(const svn_fs_id_t *id,
                  apr_pool_t *pool);
# 739 "./subversion/include/svn_fs.h"
...
svn_fs_begin_txn(svn_fs_txn_t **txn_p,
                 ...
                 svn_revnum_t rev,
                 apr_pool_t *pool);
# 830 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_change_txn_prop(svn_fs_txn_t *txn,
                       ...
                       const svn_string_t *value,
                       apr_pool_t *pool);
# 948 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_change_txn_props(svn_fs_txn_t *txn,
                        const apr_array_header_t *props,
                        apr_pool_t *pool);
# 968 "./subversion/include/svn_fs.h"
...
# 1069 "./subversion/include/svn_fs.h"
...
# 1095 "./subversion/include/svn_fs.h"
...
# 1156 "./subversion/include/svn_fs.h"
svn_fs_path_change2_t *
...
svn_fs_paths_changed(apr_hash_t **changed_paths_p,
                     svn_fs_root_t *root,
                     apr_pool_t *pool);
# 1203 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_node_id(const svn_fs_id_t **id_p,
               ...
               const char *path,
               apr_pool_t *pool);
# 1311 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_node_created_rev(svn_revnum_t *revision,
                        svn_fs_root_t *root,
                        const char *path,
                        apr_pool_t *pool);
# 1326 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_node_proplist(apr_hash_t **table_p,
                     ...
                     const char *path,
                     apr_pool_t *pool);
# 1378 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_validate_mergeinfo(svn_mergeinfo_t *validated_mergeinfo,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 1573 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_make_dir(svn_fs_root_t *root,
                const char *path,
                apr_pool_t *pool);
# 1641 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_change_rev_prop2(svn_fs_t *fs,
                        ...
                        const svn_string_t *value,
                        apr_pool_t *pool);
# 1975 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_generate_lock_token(const char **token,
                           svn_fs_t *fs,
                           apr_pool_t *pool);
# 2142 "./subversion/include/svn_fs.h"
svn_error_t *
...
typedef svn_error_t *(*svn_fs_get_locks_callback_t)(void *baton,
                                                    svn_lock_t *lock,
                                                    apr_pool_t *pool);
# 2193 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 61 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  *cache_txdeltas
...
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
static svn_error_t *
               ...
               apr_pool_t *pool)
{
  if (cache != ((void*)0))
    {
# 181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
      if (! no_handler)
...
# 200 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
static svn_error_t *
             ...
             apr_pool_t *pool)
{
    if (memcache)
      ...
      {
        do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache( cache_p, membuffer, serializer, deserializer, klen, prefix, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 271 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
...
# 281 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  ...
  do { svn_error_t *svn_err__temp = (create_cache(&(ffd->rev_node_cache), ((void*)0), membuffer, 1024, 16, svn_fs_fs__dag_serialize, svn_fs_fs__dag_deserialize, (-1), apr_pstrcat(pool, prefix, "DAG", ((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
...
# 308 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
...
# 323 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  ...
  if (cache_fulltexts)
    {
      do { svn_error_t *svn_err__temp = (create_cache(&(ffd->fulltext_cache), memcache, membuffer, 0, 0, ((void*)0), ((void*)0), (-1), apr_pstrcat(pool, prefix, "TEXT", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 338 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
    }
...
# 355 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
    }
  else
    {
...
# 480 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
