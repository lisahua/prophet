...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
svn_wc__entries_read_internal(apr_hash_t **entries,
                              ...
                              svn_boolean_t show_hidden,
                              apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2


# 1 "./subversion/svn_private_config.h" 1
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
                         ...
                         apr_pool_t *pool)
{
  ...
  if (kind != svn_node_none && kind != svn_node_dir)
    ...
    do { if (!(kind == svn_node_dir)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 68, "kind == svn_node_dir")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 197, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 216, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
  ...
  apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 237, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                                ...
                                apr_pool_t *result_pool)
{
  ...
  version = memset(apr_palloc(result_pool, sizeof(*version)), 0, sizeof(*version));
    ...
    do { if (!(svn_uri_is_canonical(repos_url, result_pool) && svn_relpath_is_canonical(repos_relpath) && ((revision) >= 0))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 266, "svn_uri_is_canonical(repos_url, result_pool) && svn_relpath_is_canonical(repos_relpath) && SVN_IS_VALID_REVNUM(revision)"); abort(); } } while (0);
