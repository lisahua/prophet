...
# 1137 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
  {
    int ignored_err = 0;
...
# 1172 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
  ...
  if (err)
    {
      ...
      if (err2 && err2->apr_err == SVN_ERR_SQLITE_BUSY)
        {
# 1307 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
