...
# 56 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
...
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c" 2
...
# 100 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
...
# 165 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
static svn_error_t *
...
svn_sqlite__exec_statements(svn_sqlite__db_t *db, int stmt_idx)
{
  do { if (!(stmt_idx < db->nbr_statements)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 201, "stmt_idx < db->nbr_statements")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_sqlite__get_statement(svn_sqlite__stmt_t **stmt, svn_sqlite__db_t *db,
                          int stmt_idx)
{
  do { if (!(stmt_idx < db->nbr_statements)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 211, "stmt_idx < db->nbr_statements")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                       ...
                       int stmt_idx)
{
  ...
  do { if (!(stmt_idx < 7)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 236, "stmt_idx < STMT_INTERNAL_LAST")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      switch (*fmt)
        {
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 377, ((void*)0))); } while (0);
        }
    }
...
{
  {
    ...
    if (mode == svn_sqlite__mode_readonly)
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 766, ((void*)0))); } while (0);
# 775 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
    flags |= 0x00008000;
...
# 895 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
  {
    int ignored_err = 0;
...
# 930 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
  ...
  if (err)
    {
      ...
      if (err2 && err2->apr_err == SVN_ERR_SQLITE_BUSY)
        {
# 1065 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
