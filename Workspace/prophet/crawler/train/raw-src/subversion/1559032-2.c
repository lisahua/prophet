...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_fnmatch.h" 1
# 45 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_fnmatch.h"
...
char * apr_strerror(apr_status_t statcode, char *buf,
                                 apr_size_t bufsize);
# 46 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_fnmatch.h" 2
...
apr_status_t apr_match_glob(const char *dir_pattern,
                                         ...
                                         apr_pool_t *p);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c" 2
...
svn_compat_wrap_log_receiver(svn_log_entry_receiver_t *receiver2,
                             ...
                             void *receiver_baton,
                             apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c" 2
...
# 325 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__get_conflict_func_interactive_baton(
  ...
  void *cancel_baton,
  apr_pool_t *result_pool);
# 393 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__conflict_func_interactive(svn_wc_conflict_result_t **result,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 409 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__time_cstring_to_human_cstring(const char **human_cstring,
                                      const char *data,
                                      apr_pool_t *pool);
# 448 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__print_status(const char *target_abspath,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 471 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__print_xml_lock(svn_stringbuf_t **outstr,
                       const svn_lock_t *lock,
                       apr_pool_t *pool);
# 503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
# 621 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__get_log_message(const char **log_msg,
                        ...
                        void *baton,
                        apr_pool_t *pool);
# 646 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__prop_use_t;
# 731 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__args_to_target_array_print_reserved(apr_array_header_t **targets_p,
                                            ...
                                            apr_pool_t *pool);
# 780 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
const char *
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         const char *wc_repos_root_URL,
                         apr_pool_t *pool);
# 801 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__deprecated_merge_reintegrate(const char *source_path_or_url,
                                     ...
                                     svn_client_ctx_t *ctx,
                                     apr_pool_t *pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-log.h" 1
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-log.h"
...
# 87 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-log.h"
svn_error_t *
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c" 2
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
static svn_error_t *
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_puts(outstream, "\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client_diff_peg6(diff_options, target_path_or_url, target_peg_revision, &start_revision, &end_revision, ((void*)0), depth, 0 , 0 , (!0) , 0 , 0 , 0 , 0 , 0 , svn_cmdline_output_encoding(pool), outstream, errstream, ((void*)0), ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 109 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
  do { svn_error_t *svn_err__temp = (svn_stream_puts(outstream, dcgettext ("subversion", "\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
  return 0;
}
                     ...
                     apr_pool_t *pool)
{
  ...
  if (author && apr_fnmatch(pattern, author, flags) == 0)
    return (!0);


  if (date && apr_fnmatch(pattern, date, flags) == 0)
    return (!0);


  if (log_message && apr_fnmatch(pattern, log_message, flags) == 0)
    return (!0);
  ...
  if (changed_paths)
    {
      ...
      for (hi = apr_hash_first(pool, changed_paths);
           ...
           hi = apr_hash_next(hi))
        {
          ...
          if (apr_fnmatch(pattern, path, flags) == 0)
            return (!0);
          ...
          if (log_item->copyfrom_path
              ...
              && apr_fnmatch(pattern,
                             log_item->copyfrom_path, flags) == 0)
            return (!0);
        }
    }
  ...
  for (i = 0; i < search_patterns->nelts; i++)
    {
      ...
      pattern_group = (((apr_array_header_t * *)(search_patterns)->elts)[i]);
      ...
      for (j = 0; j < pattern_group->nelts; j++)
        {
          ...
          pattern = (((const char * *)(pattern_group)->elts)[j]);
...
# 291 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
svn_error_t *
svn_cl__log_entry_receiver(void *baton,
                           svn_log_entry_t *log_entry,
                           apr_pool_t *pool)
  ...
  if (lb->show_diff)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_for_stderr(&errstream, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { svn_error_t *svn_err__temp = (display_diff(log_entry, lb->target_path_or_url, &lb->target_peg_revision, lb->depth, lb->diff_extensions, outstream, errstream, lb->ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_close(errstream)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 495 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
svn_error_t *
svn_cl__log_entry_receiver_xml(void *baton,
                               svn_log_entry_t *log_entry,
                               apr_pool_t *pool)
{
  ...
  if (lb->merge_stack && lb->merge_stack->nelts > 0) {
      ...
      svn_xml_make_open_tag(&sb, pool, svn_xml_normal, "logentry",
                            "revision", revstr, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
  }
  ...
  if (log_entry->revprops && apr_hash_count(log_entry->revprops) > 0)
    {
      svn_xml_make_open_tag(&sb, pool, svn_xml_normal, "revprops", ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
      do { svn_error_t *svn_err__temp = (svn_cmdline__print_xml_prop_hash(&sb, log_entry->revprops, 0, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            apr_pool_t *pool)
{
  ...
  if (opt_state->depth != svn_depth_unknown && (! opt_state->show_diff))
    return svn_error_create(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                            dcgettext ("subversion", "'depth' option requires 'diff' option", 5));

  do { svn_error_t *svn_err__temp = (svn_cl__args_to_target_array_print_reserved(&targets, os, opt_state->targets, ctx, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&lb.target_peg_revision, &lb.target_path_or_url, target, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (lb.target_peg_revision.kind == svn_opt_revision_unspecified)
    lb.target_peg_revision.kind = (svn_path_is_url(target)
                                     ? svn_opt_revision_head
                                     : svn_opt_revision_working);
  (((const char * *)(targets)->elts)[0]) = lb.target_path_or_url;
  ...
  if (opt_state->xml)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_client_log6(targets, &lb.target_peg_revision, opt_state->revision_ranges, opt_state->limit, opt_state->verbose, opt_state->stop_on_copy, opt_state->use_merge_history, move_behavior, revprops, svn_cl__log_entry_receiver_xml, &lb, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 847 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
      if (! opt_state->incremental)
  ...
  else
    {
      ...
      if (!opt_state->quiet)
        (*((const char * *)apr_array_push(revprops))) = "svn:" "log";
      do { svn_error_t *svn_err__temp = (svn_client_log6(targets, &lb.target_peg_revision, opt_state->revision_ranges, opt_state->limit, opt_state->verbose, opt_state->stop_on_copy, opt_state->use_merge_history, move_behavior, revprops, svn_cl__log_entry_receiver, &lb, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 871 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
      if (! opt_state->incremental)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "------------------------------------------------------------------------\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
