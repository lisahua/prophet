# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
svn_path_resolve_repos_relative_url(const char **absolute_url,
                                    ...
                                    const char *repos_root_url,
                                    apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
svn_wc__move2(svn_wc_context_t *wc_ctx,
              ...
              void *notify_baton,
              apr_pool_t *scratch_pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
                                  ...
                                  apr_pool_t *scratch_pool)
{
  ...
  do { if (!(((revision->kind) == svn_opt_revision_base || (revision->kind) == svn_opt_revision_working || (revision->kind) == svn_opt_revision_committed))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c", 68, "SVN_CLIENT__REVKIND_IS_LOCAL_TO_WC(revision->kind)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (kind != svn_node_file)
    return svn_error_createf(SVN_ERR_CLIENT_IS_DIRECTORY, ((void*)0),
                             dcgettext ("subversion", "'%s' refers to a directory", 5),
                             svn_dirent_local_style(local_abspath,
                                                    scratch_pool));

  if (revision->kind != svn_opt_revision_working)
    {
      do { svn_error_t *svn_err__temp = (svn_wc_get_pristine_contents2(&input, wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      if (input == ((void*)0))
        return svn_error_createf(SVN_ERR_ILLEGAL_TARGET, ((void*)0),
                 dcgettext ("subversion", "'%s' has no base revision until it is committed", 5),
                 svn_dirent_local_style(local_abspath, scratch_pool));

      do { svn_error_t *svn_err__temp = (svn_wc_get_pristine_props(&props, wc_ctx, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(&input, local_abspath, scratch_pool, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_wc_status3(&status, wc_ctx, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (keywords)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_changed_info(&changed_rev, &tm, &author, wc_ctx, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (! special)
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_io_file_affected_time(&tm, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_subst_build_keywords2(&kw, keywords->data, rev_str, url, tm, author, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (eol != ((void*)0) || kw != ((void*)0))
    input = svn_subst_stream_translated(
      input,
      (eol_style && normalize_eols) ? "\n" : eol,
      0, kw, expand_keywords, result_pool);
                ...
                apr_pool_t *pool)
{
  ...
  if (! svn_path_is_url(path_or_url)
      ...
      && ((revision->kind) == svn_opt_revision_base || (revision->kind) == svn_opt_revision_working || (revision->kind) == svn_opt_revision_committed))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_client__get_normalized_stream(&normal_stream, ctx->wc_ctx, local_abspath, revision, (!0), 0, ctx->cancel_func, ctx->cancel_baton, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      return (svn_stream_copy3(normal_stream, output, ctx->cancel_func, ctx->cancel_baton, pool));


    }


  do { svn_error_t *svn_err__temp = (svn_client__ra_session_from_path2(&ra_session, &loc, path_or_url, ((void*)0), peg_revision, revision, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  err = svn_ra_get_file(ra_session, "", loc->rev, ((void*)0), ((void*)0), &props, pool);
  if (err)
    {
      if (err->apr_err == SVN_ERR_FS_NOT_FILE)
        {
          return svn_error_createf(SVN_ERR_CLIENT_IS_DIRECTORY, err,
                                   dcgettext ("subversion", "URL '%s' refers to a directory", 5),
                                   loc->url);
        }
      else
        {
  ...
  eol_style = apr_hash_get(props, "svn:" "eol-style", (-1));
  keywords = apr_hash_get(props, "svn:" "keywords", (-1));
      ...
      if (keywords)
        {
          ...
          cmt_rev = apr_hash_get(props, "svn:" "entry:" "committed-rev",
                                 (-1));
          cmt_date = apr_hash_get(props, "svn:" "entry:" "committed-date",
                                  (-1));
          cmt_author = apr_hash_get(props, "svn:" "entry:" "last-author",
                                    (-1));
          if (cmt_date)
            do { svn_error_t *svn_err__temp = (svn_time_from_cstring(&when, cmt_date->data, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          do { svn_error_t *svn_err__temp = (svn_subst_build_keywords2 (&kw, keywords->data, cmt_rev->data, loc->url, when, cmt_author ? cmt_author->data : ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_get_file(ra_session, "", loc->rev, output, ((void*)0), ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (out != output)

    do { svn_error_t *svn_err__temp = (svn_stream_close(output)); if (svn_err__temp) return (svn_err__temp); } while (0);
