...
notify(void *baton, const svn_wc_notify_t *n, apr_pool_t *pool)
{
  ...
  switch (n->action)
      ...
      if (n->content_state == svn_wc_notify_state_missing)
        {
          if ((err = svn_cmdline_printf
               (pool, dcgettext ("subversion", "Skipped missing target: '%s'\n", 5),
                path_local)))
            goto print_error;
        }
        ...
        {
          if ((err = svn_cmdline_printf
               (pool, dcgettext ("subversion", "Skipped target: '%s' -- copy-source is missing\n", 5),
                path_local)))
            goto print_error;
        }
      else
        {
          if ((err = svn_cmdline_printf
               (pool, dcgettext ("subversion", "Skipped '%s'\n", 5), path_local)))
            goto print_error;
        }
      break;
    case svn_wc_notify_update_skip_obstruction:
      nb->conflict_stats->skipped_paths++;
      if ((err = svn_cmdline_printf(
            pool, dcgettext ("subversion", "Skipped '%s' -- An obstructing working copy was found\n", 5),
            path_local)))
        goto print_error;
      break;
    case svn_wc_notify_update_skip_working_only:
      nb->conflict_stats->skipped_paths++;
      if ((err = svn_cmdline_printf(
            pool, dcgettext ("subversion", "Skipped '%s' -- Has no versioned parent\n", 5),
            path_local)))
        goto print_error;
      break;
    case svn_wc_notify_update_skip_access_denied:
      nb->conflict_stats->skipped_paths++;
      if ((err = svn_cmdline_printf(
            pool, dcgettext ("subversion", "Skipped '%s' -- Access denied\n", 5),
            path_local)))
        goto print_error;
      break;
    case svn_wc_notify_skip_conflicted:
      nb->conflict_stats->skipped_paths++;
      if ((err = svn_cmdline_printf(
            pool, dcgettext ("subversion", "Skipped '%s' -- Node remains in conflict\n", 5),
            path_local)))
        goto print_error;
      break;
    ...
    case svn_wc_notify_update_external_removed:
      ...
      if (n->err && n->err->message)
        {
          if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Removed external '%s': %s\n", 5),
              path_local, n->err->message)))
            goto print_error;
        }
      else
        {
          if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Removed external '%s'\n", 5),
                                        path_local)))
            goto print_error;
        }
      break;
    ...
    case svn_wc_notify_left_local_modifications:
      if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Left local modifications as '%s'\n", 5),
                                        path_local)))
        goto print_error;
      break;
    ...
    case svn_wc_notify_restore:
      if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Restored '%s'\n", 5),
                                    path_local)))
        goto print_error;
      break;

    case svn_wc_notify_revert:
      if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Reverted '%s'\n", 5),
                                    path_local)))
        goto print_error;
      break;

    case svn_wc_notify_failed_revert:
      if (( err = svn_cmdline_printf(pool, dcgettext ("subversion", "Failed to revert '%s' -- " "try updating instead.\n", 5),
    ...
    case svn_wc_notify_resolved:
      if ((err = svn_cmdline_printf(pool,
                                    dcgettext ("subversion", "Resolved conflicted state of '%s'\n", 5),
                                    path_local)))
        goto print_error;
      break;
    ...
    case svn_wc_notify_patch_applied_hunk:
      ...
      if (n->hunk_original_start != n->hunk_matched_line)
      ...
      else if (n->hunk_fuzz)
        {
          if (n->prop_name)
            err = svn_cmdline_printf(pool,
                          dcgettext ("subversion", ">         applied hunk ## -%lu,%lu +%lu,%lu ## " "with fuzz %lu (%s)\n", 5),
            ...
            err = svn_cmdline_printf(pool,
                          dcgettext ("subversion", ">         applied hunk @@ -%lu,%lu +%lu,%lu @@ " "with fuzz %lu\n", 5),
    ...
    case svn_wc_notify_patch_rejected_hunk:
      ...
      if (n->prop_name)
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", ">         rejected hunk " "## -%lu,%lu +%lu,%lu ## (%s)\n", 5),
        ...
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", ">         rejected hunk " "@@ -%lu,%lu +%lu,%lu @@\n", 5),
    ...
    case svn_wc_notify_patch_hunk_already_applied:
      ...
      if (n->prop_name)
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", ">         hunk " "## -%lu,%lu +%lu,%lu ## " "already applied (%s)\n", 5),
        ...
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", ">         hunk " "@@ -%lu,%lu +%lu,%lu @@ " "already applied\n", 5),
      ...
      if (nb->in_external)
      ...
      else
        {
          svn_error_t *warn_err =
            svn_error_createf(SVN_ERR_BASE, ((void*)0),
    ...
    case svn_wc_notify_update_started:
      if (! (nb->in_external ||
             ...
             nb->is_export))
        {
          if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Updating '%s':\n", 5),
                                        path_local)))
            goto print_error;
        }
      break;
            ...
            if (nb->is_export)
              {
                if ((err = svn_cmdline_printf
                     (pool, nb->in_external
                      ? dcgettext ("subversion", "Exported external at revision %ld.\n", 5)
                      : dcgettext ("subversion", "Exported revision %ld.\n", 5),
                      n->revision)))
                  goto print_error;
              }
            else if (nb->is_checkout)
              {
                if ((err = svn_cmdline_printf
                     (pool, nb->in_external
                      ? dcgettext ("subversion", "Checked out external at revision %ld.\n", 5)
                      : dcgettext ("subversion", "Checked out revision %ld.\n", 5),
                      n->revision)))
                  goto print_error;
              }
            else
                ...
                if (nb->received_some_change)
                  {
                    ...
                    if ((err = svn_cmdline_printf
                         (pool, nb->in_external
                          ? dcgettext ("subversion", "Updated external to revision %ld.\n", 5)
                          : dcgettext ("subversion", "Updated to revision %ld.\n", 5),
                          n->revision)))
                      goto print_error;
                  }
                else
                  {
                    if ((err = svn_cmdline_printf
                         (pool, nb->in_external
                          ? dcgettext ("subversion", "External at revision %ld.\n", 5)
                          : dcgettext ("subversion", "At revision %ld.\n", 5),
                          n->revision)))
                      goto print_error;
                  }
              }
            ...
            if (nb->is_export)
              {
                if ((err = svn_cmdline_printf
                     (pool, nb->in_external
                      ? dcgettext ("subversion", "External export complete.\n", 5)
                      : dcgettext ("subversion", "Export complete.\n", 5))))
                  goto print_error;
              }
            else if (nb->is_checkout)
              {
                if ((err = svn_cmdline_printf
                     (pool, nb->in_external
                      ? dcgettext ("subversion", "External checkout complete.\n", 5)
                      : dcgettext ("subversion", "Checkout complete.\n", 5))))
                  goto print_error;
              }
            else
              {
                if ((err = svn_cmdline_printf
                     (pool, nb->in_external
                      ? dcgettext ("subversion", "External update complete.\n", 5)
                      : dcgettext ("subversion", "Update complete.\n", 5))))
                  goto print_error;
              }
          }
      }
    ...
    case svn_wc_notify_status_completed:
      if (((n->revision) >= 0))
        if ((err = svn_cmdline_printf(pool,
                                      dcgettext ("subversion", "Status against revision: %6ld\n", 5),
                                      n->revision)))
          goto print_error;
      break;
    ...
    case svn_wc_notify_commit_modified:
      ...
      if ((err = svn_cmdline_printf(pool,
                                    nb->is_wc_to_repos_copy
                                      ? dcgettext ("subversion", "Sending copy of       %s\n", 5)
                                      : dcgettext ("subversion", "Sending        %s\n", 5),
                                    path_local)))
        goto print_error;
      break;
      ...
      if (n->mime_type && svn_mime_type_is_binary(n->mime_type))
        {
          if ((err = svn_cmdline_printf(pool,
                                        nb->is_wc_to_repos_copy
                                          ? dcgettext ("subversion", "Adding copy of (bin)  %s\n", 5)
                                          : dcgettext ("subversion", "Adding  (bin)  %s\n", 5),
                                        path_local)))
          goto print_error;
        }
      else
        {
          if ((err = svn_cmdline_printf(pool,
                                        nb->is_wc_to_repos_copy
                                          ? dcgettext ("subversion", "Adding copy of        %s\n", 5)
                                          : dcgettext ("subversion", "Adding         %s\n", 5),
                                        path_local)))
            goto print_error;
        }
      break;
    ...
    case svn_wc_notify_commit_deleted:
      if ((err = svn_cmdline_printf(pool,
                                    nb->is_wc_to_repos_copy
                                      ? dcgettext ("subversion", "Deleting copy of      %s\n", 5)
                                      : dcgettext ("subversion", "Deleting       %s\n", 5),
                                    path_local)))
        goto print_error;
      break;
    ...
    case svn_wc_notify_commit_copied_replaced:
      if ((err = svn_cmdline_printf(pool,
                                    nb->is_wc_to_repos_copy
                                      ? dcgettext ("subversion", "Replacing copy of     %s\n", 5)
                                      : dcgettext ("subversion", "Replacing      %s\n", 5),
                                    path_local)))
        goto print_error;
      break;
      ...
      if (! nb->sent_first_txdelta)
        {
          ...
          if ((err = svn_cmdline_printf(pool,
                                        dcgettext ("subversion", "Transmitting file data ", 5))))
            goto print_error;
        }
    ...
    case svn_wc_notify_locked:
      if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "'%s' locked by user '%s'.\n", 5),
                                    path_local, n->lock->owner)))
        goto print_error;
      break;

    case svn_wc_notify_unlocked:
      if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "'%s' unlocked.\n", 5),
                                    path_local)))
        goto print_error;
      break;
    ...
    case svn_wc_notify_merge_begin:
      if (n->merge_range == ((void*)0))
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Merging differences between " "repository URLs into '%s':\n", 5),

                                 path_local);
      else if (n->merge_range->start == n->merge_range->end - 1
          || n->merge_range->start == n->merge_range->end)
        err = svn_cmdline_printf(pool, dcgettext ("subversion", "--- Merging r%ld into '%s':\n", 5),
                                 n->merge_range->end, path_local);
      else if (n->merge_range->start - 1 == n->merge_range->end)
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Reverse-merging r%ld into '%s':\n", 5),
                                 n->merge_range->start, path_local);
      else if (n->merge_range->start < n->merge_range->end)
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Merging r%ld through r%ld into " "'%s':\n", 5),

                                 n->merge_range->start + 1,
                                 n->merge_range->end, path_local);
      else
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Reverse-merging r%ld through r%ld " "into '%s':\n", 5),
    ...
    case svn_wc_notify_merge_record_info_begin:
      if (!n->merge_range)
        {
          err = svn_cmdline_printf(pool,
                                   dcgettext ("subversion", "--- Recording mergeinfo for merge " "between repository URLs into '%s':\n", 5),
      ...
      else
        {
          if (n->merge_range->start == n->merge_range->end - 1
            ...
            err = svn_cmdline_printf(
              pool,
              dcgettext ("subversion", "--- Recording mergeinfo for merge of r%ld into '%s':\n", 5),
              n->merge_range->end, path_local);
          else if (n->merge_range->start - 1 == n->merge_range->end)
            err = svn_cmdline_printf(
              pool,
              dcgettext ("subversion", "--- Recording mergeinfo for reverse merge of r%ld into '%s':\n", 5),
              n->merge_range->start, path_local);
           else if (n->merge_range->start < n->merge_range->end)
             err = svn_cmdline_printf(
               pool,
               dcgettext ("subversion", "--- Recording mergeinfo for merge of r%ld through r%ld into '%s':\n", 5),
               n->merge_range->start + 1, n->merge_range->end, path_local);
           else
             err = svn_cmdline_printf(
               pool,
               dcgettext ("subversion", "--- Recording mergeinfo for reverse merge of r%ld through r%ld into '%s':\n", 5),
    ...
    case svn_wc_notify_merge_elide_info:
      if ((err = svn_cmdline_printf(pool,
                                    dcgettext ("subversion", "--- Eliding mergeinfo from '%s':\n", 5),
                                    path_local)))
        goto print_error;
      break;
    ...
    case svn_wc_notify_foreign_merge_begin:
      if (n->merge_range == ((void*)0))
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Merging differences between " "foreign repository URLs into '%s':\n", 5),

                                 path_local);
      else if (n->merge_range->start == n->merge_range->end - 1
          || n->merge_range->start == n->merge_range->end)
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Merging (from foreign repository) " "r%ld into '%s':\n", 5),

                                 n->merge_range->end, path_local);
      else if (n->merge_range->start - 1 == n->merge_range->end)
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Reverse-merging (from foreign " "repository) r%ld into '%s':\n", 5),

                                 n->merge_range->start, path_local);
      else if (n->merge_range->start < n->merge_range->end)
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Merging (from foreign repository) " "r%ld through r%ld into '%s':\n", 5),

                                 n->merge_range->start + 1,
                                 n->merge_range->end, path_local);
      else
        err = svn_cmdline_printf(pool,
                                 dcgettext ("subversion", "--- Reverse-merging (from foreign " "repository) r%ld through r%ld into " "'%s':\n", 5),
    ...
    case svn_wc_notify_property_added:
      err = svn_cmdline_printf(pool,
                               dcgettext ("subversion", "property '%s' set on '%s'\n", 5),
    ...
    case svn_wc_notify_property_deleted:
      err = svn_cmdline_printf(pool,
                               dcgettext ("subversion", "property '%s' deleted from '%s'.\n", 5),
                               n->prop_name, path_local);
      if (err)
        goto print_error;
      break;
    ...
    case svn_wc_notify_property_deleted_nonexistent:
      err = svn_cmdline_printf(pool,
                               dcgettext ("subversion", "Attempting to delete nonexistent " "property '%s' on '%s'\n", 5), n->prop_name,
    ...
    case svn_wc_notify_revprop_set:
      err = svn_cmdline_printf(pool,
                           dcgettext ("subversion", "property '%s' set on repository revision %ld\n", 5),
    ...
    case svn_wc_notify_revprop_deleted:
      err = svn_cmdline_printf(pool,
                     dcgettext ("subversion", "property '%s' deleted from repository revision %ld\n", 5),
                     n->prop_name, n->revision);
      if (err)
        goto print_error;
      break;
    ...
    case svn_wc_notify_upgraded_path:
      err = svn_cmdline_printf(pool, dcgettext ("subversion", "Upgraded '%s'\n", 5), path_local);
      if (err)
        goto print_error;
      break;

    case svn_wc_notify_url_redirect:
      err = svn_cmdline_printf(pool, dcgettext ("subversion", "Redirecting to URL '%s':\n", 5),
                               n->url);
      if (err)
        goto print_error;
      break;
    ...
    case svn_wc_notify_path_nonexistent:
      err = svn_cmdline_printf(pool, "%s\n",
               apr_psprintf(pool, dcgettext ("subversion", "'%s' is not under version control", 5),
                            path_local));
      if (err)
        goto print_error;
      break;
      ...
      if (n->merge_range == ((void*)0))
        {
          err = svn_cmdline_printf(
                           pool,
                           dcgettext ("subversion", "--- Copying from foreign repository URL '%s':\n", 5),
                           n->url);
          if (err)
            goto print_error;
        }
    ...
    case svn_wc_notify_move_broken:
      err = svn_cmdline_printf(pool,
                               dcgettext ("subversion", "Breaking move with source path '%s'\n", 5),
                               path_local);
      if (err)
        goto print_error;
      break;
    ...
    case svn_wc_notify_cleanup_external:
      if ((err = svn_cmdline_printf
           (pool, dcgettext ("subversion", "Performing cleanup on external item at '%s'.\n", 5),
            path_local)))
        goto print_error;
      break;
