...
svn_fs_verify_rev(svn_fs_t *fs,
                  svn_revnum_t revision,
                  apr_pool_t *scratch_pool);
# 346 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_path(svn_fs_t *fs,
            apr_pool_t *pool);
# 371 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_berkeley_recover(const char *path,
                        apr_pool_t *pool);
# 611 "./subversion/include/svn_fs.h"
...
svn_fs_access_get_username(const char **username,
                           svn_fs_access_t *access_ctx);
# 662 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_access_add_lock_token(svn_fs_access_t *access_ctx,
                             const char *token);
# 726 "./subversion/include/svn_fs.h"
...
# 753 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_fs_id_t *
...
svn_fs_unparse_id(const svn_fs_id_t *id,
                  apr_pool_t *pool);
# 867 "./subversion/include/svn_fs.h"
typedef struct svn_fs_txn_t svn_fs_txn_t;
# 907 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_begin_txn(svn_fs_txn_t **txn_p,
                 ...
                 svn_revnum_t rev,
                 apr_pool_t *pool);
# 978 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_commit_txn(const char **conflict_p,
                  svn_revnum_t *new_rev,
                  svn_fs_txn_t *txn,
                  apr_pool_t *pool);
# 995 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_abort_txn(svn_fs_txn_t *txn,
                 apr_pool_t *pool);
# 1006 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 1035 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_change_txn_prop(svn_fs_txn_t *txn,
                       ...
                       const svn_string_t *value,
                       apr_pool_t *pool);
# 1096 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_change_txn_props(svn_fs_txn_t *txn,
                        const apr_array_header_t *props,
                        apr_pool_t *pool);
# 1116 "./subversion/include/svn_fs.h"
...
# 1304 "./subversion/include/svn_fs.h"
svn_fs_path_change2_t *
...
svn_fs_is_file(svn_boolean_t *is_file,
               ...
               const char *path,
               apr_pool_t *pool);
# 1446 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_node_id(const svn_fs_id_t **id_p,
               svn_fs_root_t *root,
               const char *path,
               apr_pool_t *pool);
# 1459 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 1747 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_dir_entries(apr_hash_t **entries_p,
                   svn_fs_root_t *root,
                   const char *path,
                   apr_pool_t *pool);
# 1760 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_delete(svn_fs_root_t *root,
              const char *path,
              apr_pool_t *pool);
# 1805 "./subversion/include/svn_fs.h"
svn_error_t *
...
(*svn_fs_process_contents_func_t)(const unsigned char *contents,
                                  ...
                                  void *baton,
                                  apr_pool_t *pool);
# 1947 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_generate_lock_token(const char **token,
                           svn_fs_t *fs,
                           apr_pool_t *pool);
# 2317 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_get_locks(svn_fs_t *fs,
                 ...
                 void *get_locks_baton,
                 apr_pool_t *pool);
# 2407 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_repos_authz_read(svn_authz_t **authz_p,
                     ...
                     svn_boolean_t must_exist,
                     apr_pool_t *pool);
# 3188 "./subversion/include/svn_repos.h"
svn_error_t *
svn_repos_authz_read2(svn_authz_t **authz_p,
                      ...
                      const char *repos_root,
                      apr_pool_t *pool);
# 3205 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_authz_check_access(svn_authz_t *authz,
                             ...
                             apr_pool_t *pool);
# 3296 "./subversion/include/svn_repos.h"
...
svn_repos_check_revision_access(svn_repos_revision_access_level_t *access_level,
                                ...
                                void *authz_read_baton,
                                apr_pool_t *pool);
# 3343 "./subversion/include/svn_repos.h"
svn_error_t *
svn_repos_fs_get_inherited_props(apr_array_header_t **inherited_props,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 3374 "./subversion/include/svn_repos.h"
svn_error_t *
           ...
           apr_pool_t *pool)
{
  ...
  apr_hash_set(fs_config, "fsfs-cache-fulltexts",
               (-1), "1");
  apr_hash_set(fs_config, "fsfs-cache-revprops",
               (-1), "2");
...
# 336 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/svnadmin.c"
  {'r', svnadmin__incremental, svnadmin__deltas, 'q', 'M'} },

  {"freeze", subcommand_freeze, {0}, "usage: svnadmin freeze REPOS_PATH PROGRAM [ARG...]\n\n" "Run PROGRAM passing ARGS while holding a write-lock on REPOS_PATH.\n",
...
# 431 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/svnadmin.c"
...
# 469 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/svnadmin.c"
   {0} },
...
# 569 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/svnadmin.c"
static svn_error_t *
           ...
           apr_pool_t *pool)
{
  ...
  if (min_expected || max_expected)
    do { if (!(args)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/svnadmin.c", 579, "args")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
subcommand_crashtest(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/svnadmin.c", 609, ((void*)0))); } while (0);
  ...
  if (opt_state->compatible_version)
    {
      ...
      if (! svn_version__at_least(opt_state->compatible_version, 1, 8, 0))
        apr_hash_set(fs_config, "pre-1.8-compatible",
                     (-1), "1");
    }
...
# 917 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/svnadmin.c"
...
subcommand_freeze(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_repos_freeze(opt_state->repository_path, freeze_body, &b, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1893 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/svnadmin.c"
static int
