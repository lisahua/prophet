  ...
  switch (notify->action)
  {
    ...
    case svn_repos_notify_verify_struc_rev:
      if (notify->revision == ((svn_revnum_t) -1))
        svn_error_clear(svn_stream_printf(feedback_stream, scratch_pool,
                                dcgettext ("subversion", "* Verifying global structure ...\n", 5)));
      else
        svn_error_clear(svn_stream_printf(feedback_stream, scratch_pool,
                        dcgettext ("subversion", "* Verifying structure at revision %ld ...\n", 5),
                        notify->revision));
      return;
...
# 917 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/svnadmin.c"
...
# 1893 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/svnadmin.c"
static int
