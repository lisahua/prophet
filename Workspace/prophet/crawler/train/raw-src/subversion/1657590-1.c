...
# 185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
typedef apr_uint64_t entry_key_t[2];
# 331 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 438 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 553 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  cache_level_t l1;
...
# 598 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 619 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 766 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
allocate_spare_group(svn_membuffer_t *cache)
{
  ...
  ((!group || !group->header.used) ? (void) (0) : __assert_fail ("!group || !group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 836, __PRETTY_FUNCTION__));
  return group;
}
...
free_spare_group(svn_membuffer_t *cache,
                 entry_group_t *group)
{
  ((group->header.used == 0) ? (void) (0) : __assert_fail ("group->header.used == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 846, __PRETTY_FUNCTION__));
  ((group->header.previous != (4294967295U)) ? (void) (0) : __assert_fail ("group->header.previous != (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 847, __PRETTY_FUNCTION__));
  ((group - cache->directory >= (apr_ssize_t)cache->group_count) ? (void) (0) : __assert_fail ("group - cache->directory >= (apr_ssize_t)cache->group_count", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 848, __PRETTY_FUNCTION__));
            ...
            apr_uint32_t idx)
{
  ...
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 932, __PRETTY_FUNCTION__));
...
unchain_entry(svn_membuffer_t *cache,
              ...
              apr_uint32_t idx)
{
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 979, __PRETTY_FUNCTION__));
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == level->current_data) ? (void) (0) : __assert_fail ("entry->offset == level->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1106, __PRETTY_FUNCTION__));
  ((idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used) ? (void) (0) : __assert_fail ("idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1107, __PRETTY_FUNCTION__));
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1124, __PRETTY_FUNCTION__));
}
...
# 1175 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
  ...
  while (1)
    {
      ...
      ((group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))) ? (void) (0) : __assert_fail ("group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1236, __PRETTY_FUNCTION__));
      group = &cache->directory[group->header.next];
    }
  ...
  if (find_empty)
    {
      ...
      if (group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t)))
        {
# 1275 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
move_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1354, __PRETTY_FUNCTION__));
}
...
promote_entry(svn_membuffer_t *cache, entry_t *entry)
{
  apr_uint32_t idx = get_index(cache, entry);
  apr_size_t size = (((entry->size) + 16 -1) & -16);
  ((get_cache_level(cache, entry) == &cache->l1) ? (void) (0) : __assert_fail ("get_cache_level(cache, entry) == &cache->l1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1364, __PRETTY_FUNCTION__));
  ((idx == cache->l1.next) ? (void) (0) : __assert_fail ("idx == cache->l1.next", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1365, __PRETTY_FUNCTION__));
...
# 1394 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1427 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
...
# 1540 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_boolean_t
...
# 1606 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
                                  ...
                                  apr_pool_t *pool)
{
  ...
  if (segment_count < 1)
    {
# 1676 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  ...
  ((spare_group_count > 0 && main_group_count > 0) ? (void) (0) : __assert_fail ("spare_group_count > 0 && main_group_count > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1742, __PRETTY_FUNCTION__));
...
# 1811 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      c[seg].lock = ((void*)0);
      if (thread_safe)
        {
          apr_status_t status =
...
# 1914 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 1950 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
  ...
  if (level)
    {
      ...
      entry->offset = level->current_data;
      entry->priority = priority;
# 1982 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 2047 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 2074 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 2121 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 2158 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  if (buffer == ((void*)0))
    {
      *item = ((void*)0);
      return 0;
...
# 2231 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                                     ...
                                     apr_pool_t *result_pool)
{
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      increment_hit_counters(cache, entry);
# 2274 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 2319 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry != ((void*)0))
    {
      ...
      increment_hit_counters(cache, entry);
      cache->total_writes++;
# 2364 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 2411 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
        }
    }
...
# 2461 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 2535 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void
combine_long_key(svn_membuffer_cache_t *cache,
                 const void *key,
                 apr_ssize_t key_len)
{
  ((cache->last_access) ? (void) (0) : __assert_fail ("cache->last_access", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 2540, __PRETTY_FUNCTION__));
...
# 2804 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 3001 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
