...
svn_wc__internal_node_get_schedule(svn_wc_schedule_t *schedule,
                                   ...
                                   const char *local_abspath,
                                   apr_pool_t *scratch_pool);
# 632 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
svn_error_t *
...
# 99 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c", 115, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
          if (node_checksum)
          ...
          if (compare_textbases && need_translation)
            {
              if (eol_style == svn_subst_eol_style_native)
                ...
                return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c",173), (svn_error_create))(SVN_ERR_IO_UNKNOWN_EOL, ((void*)0), ((void*)0));
      ...
      if (verify_checksum && node_checksum)
        {
          if (checksum && !svn_checksum_match(checksum, node_checksum))
            {
              return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c",202), (svn_error_createf))(SVN_ERR_WC_CORRUPT_TEXT_BASE, ((void*)0),
