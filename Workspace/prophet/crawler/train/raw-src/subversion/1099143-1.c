# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c"
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c" 2
...
svn_wc__write_check(svn_wc__db_t *db,
                    const char *local_abspath,
                    apr_pool_t *scratch_pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c" 2

# 1 "./subversion/svn_private_config.h" 1
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c" 2
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  if (kind == svn_node_none)
    {
      svn_wc__db_status_t status;
      svn_error_t *err = svn_wc__db_read_info(&status, ((void*)0), ((void*)0), ((void*)0), ((void*)0),
  ...
  tmpinfo->wc_info = memset(apr_palloc(result_pool, sizeof(*tmpinfo->wc_info)), 0, sizeof(*tmpinfo->wc_info));

  do { svn_error_t *svn_err__temp = (svn_wc__node_get_origin(&is_copy, &rev, &repos_relpath, &tmpinfo->repos_root_URL, &tmpinfo->repos_UUID, wc_ctx, local_abspath, (!0), result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!tmpinfo->repos_root_URL)
    {
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_repos_info(&tmpinfo->repos_root_URL, &tmpinfo->repos_UUID, wc_ctx, local_abspath, (!0), (!0), result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (repos_relpath)
    {
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_changed_info(&tmpinfo->last_changed_rev, &tmpinfo->last_changed_date, &tmpinfo->last_changed_author, wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (is_copy)
    do { svn_error_t *svn_err__temp = (svn_wc__node_get_commit_base_rev(&tmpinfo->rev, wc_ctx, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  else
    tmpinfo->rev = rev;
# 125 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c"
  if (! ((tmpinfo->rev) >= 0))
    tmpinfo->rev = 0;

  tmpinfo->wc_info->copyfrom_rev = ((svn_revnum_t) -1);

  if (is_copy)
    {
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_copyfrom_info(((void*)0), ((void*)0), ((void*)0), ((void*)0), &is_copy_target, wc_ctx, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!tmpinfo->URL)
    do { svn_error_t *svn_err__temp = (svn_wc__node_get_url(&tmpinfo->URL, wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (tmpinfo->kind == svn_node_file)
    {
      do { svn_error_t *svn_err__temp = (svn_wc__db_read_info(((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &tmpinfo->wc_info->checksum, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &tmpinfo->wc_info->changelist, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), wc_ctx->db, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (tmpinfo->kind == svn_node_dir)
    {
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_depth(&tmpinfo->wc_info->depth, wc_ctx, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__node_get_schedule(&tmpinfo->wc_info->schedule, ((void*)0), wc_ctx, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_wc_get_wc_root(&tmpinfo->wc_info->wcroot_abspath, wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_wc__node_get_recorded_info(&tmpinfo->wc_info->working_size, &tmpinfo->wc_info->text_time, wc_ctx, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (kind == svn_node_file)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_lock_info(&lock_token, &lock_owner, &lock_comment, &lock_date, wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
build_info_for_unversioned(svn_info2_t **info,
                           apr_pool_t *pool)
{
  svn_info2_t *tmpinfo = memset(apr_palloc(pool, sizeof(*tmpinfo)), 0, sizeof(*tmpinfo));
  tmpinfo->wc_info = memset(apr_palloc(pool, sizeof (*tmpinfo->wc_info)), 0, sizeof (*tmpinfo->wc_info));
                         ...
                         apr_pool_t *pool)
{
  ...
  do { if (!(info != ((void*)0) && info->wc_info != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c", 289, "info != NULL && info->wc_info != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (tree_conflict)
    {
      ...
      (*((const svn_wc_conflict_description2_t * *)apr_array_push(conflicts)))
        = tree_conflict;
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  err = svn_wc__internal_walk_children(wc_ctx->db, local_abspath, 0,
  ...
  if (err && err->apr_err == SVN_ERR_WC_PATH_NOT_FOUND)
    {
      ...
      do { svn_error_t *svn_err__temp = (info_found_node_callback(local_abspath, svn_node_none, &fe_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
