...
{
  apr_status_t status;
# 175 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c"
  apr_file_t *tmpfd;
...
# 255 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c"
...
# 274 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c"
static svn_error_t *
              ...
              svn_boolean_t can_erase, apr_pool_t *pool)
{
  apr_status_t status = 0;
  char ch;
# 350 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c"
...
# 427 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c"
static svn_error_t *
      ...
      if (saw_first_half_of_eol)
      ...
      else if (c == "\n"[0])
        {
          ...
          if (sizeof("\n") == 3)
            ...
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c", 509, ((void*)0))); } while (0);
        }
...
# 534 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c"
static svn_error_t *
...
# 830 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c"
...
# 859 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/prompt.c"
  return plaintext_prompt_helper(may_save_plaintext, realmstring,
                                 prompt_string, prompt_text, baton,
                                 pool);
}
