...
# 475 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
                }
              else
                {
                  s = dcgettext ("subversion", ">         applied hunk @@ -%lu,%lu +%lu,%lu @@ " "with offset %s", 5);
...
# 491 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
                }
            }
          else
            {
...
# 509 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
                }
              else
                {
                  s = dcgettext ("subversion", ">         applied hunk @@ -%lu,%lu +%lu,%lu @@ " "with offset %s", 5);
...
# 523 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
                }
            }
        }
      else if (n->hunk_fuzz)
...
# 538 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
          else
...
# 548 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
        }
      break;
...
# 585 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
      else
    ...
    case svn_wc_notify_commit_finalizing:
      ...
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Committing transaction...\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;
