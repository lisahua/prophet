# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c"
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.h" 1
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.h"
...
# 1815 "./subversion/include/svn_wc.h"
...
# 1978 "./subversion/include/svn_wc.h"
svn_wc_conflict_description2_t *
...
svn_wc_conflict_description_create_tree2(
  ...
  const svn_wc_conflict_version_t *src_right_version,
  apr_pool_t *result_pool);
# 2061 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_wc_conflict_description_t *
...
# 2411 "./subversion/include/svn_wc.h"
  svn_error_t *(*dir_props_changed)(svn_wc_notify_state_t *propstate,
                                    ...
                                    void *diff_baton,
                                    apr_pool_t *scratch_pool);
# 2427 "./subversion/include/svn_wc.h"
...
# 2873 "./subversion/include/svn_wc.h"
...
# 3096 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_ensure_adm3(const char *path,
                   ...
                   svn_depth_t depth,
                   apr_pool_t *pool);
# 3517 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
svn_wc_ensure_adm2(const char *path,
                   ...
                   svn_revnum_t revision,
                   apr_pool_t *pool);
# 3535 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
# 5123 "./subversion/include/svn_wc.h"
...
svn_wc_relocate4(svn_wc_context_t *wc_ctx,
                 ...
                 apr_pool_t *scratch_pool);
# 7422 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_revision_status2(svn_wc_revision_status_t **result_p,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 8059 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_set_changelist(const char *path,
                      ...
                      void *notify_baton,
                      apr_pool_t *pool);
# 8142 "./subversion/include/svn_wc.h"
...
svn_wc_exclude(svn_wc_context_t *wc_ctx,
               ...
               void *notify_baton,
               apr_pool_t *scratch_pool);
# 8281 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.h" 2
...
svn_token__from_mem(const svn_token_map_t *map,
                    const char *word,
                    apr_size_t len);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.h" 2
...
svn_skel__unparse_iproplist(svn_skel_t **skel_p,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.h" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h" 1
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h" 1
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
...
svn_sqlite__hotcopy(const char *src_path,
                    const char *dst_path,
                    apr_pool_t *scratch_pool);
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h" 2
...
svn_wc__diff7(const char **root_relpath,
              ...
              apr_pool_t *result_pool,
              apr_pool_t *scratch_pool);
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h" 2
...
svn_wc__required_lock_for_resolve(const char **required_abspath,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h" 2
...
svn_wc__mark_resolved_prop_conflicts(svn_wc__db_t *db,
                                     const char *local_abspath,
                                     apr_pool_t *scratch_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c" 2
...
svn_wc__node_has_local_mods(svn_boolean_t *modified,
                            ...
                            void *cancel_baton,
                            apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c" 2
...
# 1 "./subversion/svn_private_config.h" 1
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c" 2
                          ...
                          apr_pool_t *pool)
{
  ...
  do { if (!(is_valid_version_info_skel(skel))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c", 322, "is_valid_version_info_skel(skel)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  do { if (!(conflict->node_kind == svn_node_dir || conflict->node_kind == svn_node_file || conflict->node_kind == svn_node_none)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c", 371, "conflict->node_kind == svn_node_dir || conflict->node_kind == svn_node_file || conflict->node_kind == svn_node_none")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(victim_basename[0])) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c", 377, "victim_basename[0]")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(is_valid_conflict_skel(c_skel))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c", 382, "is_valid_conflict_skel(c_skel)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_wc__del_tree_conflict(svn_wc_context_t *wc_ctx,
                          ...
                          apr_pool_t *scratch_pool)
{
  do { if (!(svn_dirent_is_absolute(victim_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c", 395, "svn_dirent_is_absolute(victim_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { svn_error_t *svn_err__temp = (svn_wc__db_op_mark_resolved(wc_ctx->db, victim_abspath, 0, 0, (!0), ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *scratch_pool)
{
  ...
  do { if (!(conflict != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c", 413, "conflict != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(conflict->operation == svn_wc_operation_merge || (conflict->reason != svn_wc_conflict_reason_moved_away && conflict->reason != svn_wc_conflict_reason_moved_here))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c", 416, "conflict->operation == svn_wc_operation_merge || (conflict->reason != svn_wc_conflict_reason_moved_away && conflict->reason != svn_wc_conflict_reason_moved_here)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__conflict_skel_add_tree_conflict(conflict_skel, wc_ctx->db, conflict->local_abspath, conflict->reason, conflict->action, ((void*)0), scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  switch (conflict->operation)
    {
      ...
      default:
        do { svn_error_t *svn_err__temp = (svn_wc__conflict_skel_set_op_update(conflict_skel, conflict->src_left_version, conflict->src_right_version, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



        break;
      case svn_wc_operation_switch:
        do { svn_error_t *svn_err__temp = (svn_wc__conflict_skel_set_op_switch(conflict_skel, conflict->src_left_version, conflict->src_right_version, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



        break;
      case svn_wc_operation_merge:
        do { svn_error_t *svn_err__temp = (svn_wc__conflict_skel_set_op_merge(conflict_skel, conflict->src_left_version, conflict->src_right_version, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  return (svn_wc__db_op_mark_conflict(wc_ctx->db, conflict->local_abspath, conflict_skel, ((void*)0), scratch_pool));
                          ...
                          apr_pool_t *scratch_pool)
{
  const apr_array_header_t *conflicts;
  int i;
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/tree_conflicts.c", 485, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { svn_error_t *svn_err__temp = (svn_wc__read_conflicts(&conflicts, wc_ctx->db, local_abspath, 0, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < conflicts->nelts; i++)
    {
      ...
      desc = (((svn_wc_conflict_description2_t * *)(conflicts)->elts)[i]);
