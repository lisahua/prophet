...
svn_wc__internal_translated_file(const char **xlated_abspath,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c" 2


# 1 "./subversion/svn_private_config.h" 1
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c" 2
# 102 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c", 121, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 247 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
  if (!checksum
      || (kind != svn_kind_file)
  ...
  if (! exact_comparison)
    {
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
                              ...
                              apr_pool_t *scratch_pool)
{
  ...
  svn_boolean_t resolved_text = 0;
  svn_boolean_t resolved_props = 0;
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__conflict_read_info(((void*)0), ((void*)0), text_conflicted_p, prop_conflicted_p, tree_conflicted_p, db, local_abspath, conflicts, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 413 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
      do { svn_error_t *svn_err__temp = (svn_wc__conflict_read_text_conflict(&mine_abspath, &their_old_abspath, &their_abspath, db, local_abspath, conflicts, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (mine_abspath)
        {
          do { svn_error_t *svn_err__temp = (svn_io_check_path(mine_abspath, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (!done && their_abspath)
        {
          do { svn_error_t *svn_err__temp = (svn_io_check_path(their_abspath, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_io_check_path(their_old_abspath, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (prop_conflicted_p && *prop_conflicted_p)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__conflict_read_prop_conflict(&prej_abspath, ((void*)0), ((void*)0), ((void*)0), ((void*)0), db, local_abspath, conflicts, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (prej_abspath)
        {
          do { svn_error_t *svn_err__temp = (svn_io_check_path(prej_abspath, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (resolved_text || resolved_props)
    {
      ...
      if (own_lock)
        do { svn_error_t *svn_err__temp = (svn_wc__db_op_mark_resolved(db, local_abspath, resolved_text, resolved_props, 0 , ((void*)0) , scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
