# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c"
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
...
svn_fspath__basename(const char *fspath,
                     apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
...
svn_sort__array_insert(const void *new_element,
                       ...
                       int insert_index);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c" 2
         ...
         apr_pool_t *pool)
{
  ...
  do { if (!(db_stack && db_stack->nelts)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c", 62, "db_stack && db_stack->nelts")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  item = (((void * *)(db_stack)->elts)[db_stack->nelts - 1]);
  parent_db = item->dir_baton;



  subpool = svn_pool_create_ex(pool, ((void*)0));
  do { svn_error_t *svn_err__temp = (editor->open_directory(path, parent_db, revision, subpool, &db)); if (svn_err__temp) return (svn_err__temp); } while (0);


  item = memset(apr_palloc(subpool, sizeof(*item)), 0, sizeof(*item));
  item->dir_baton = db;
  item->pool = subpool;
  (*((dir_stack_t * *)apr_array_push(db_stack))) = item;
          ...
          const svn_delta_editor_t *editor)
{
  ...
  do { if (!(db_stack && db_stack->nelts)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c", 95, "db_stack && db_stack->nelts")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  item = (((dir_stack_t * *)(db_stack)->elts)[db_stack->nelts - 1]);
  (void) apr_array_pop(db_stack);
  do { svn_error_t *svn_err__temp = (editor->close_directory(item->dir_baton, item->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  apr_pool_destroy(item->pool);
...
count_components(const char *path)
{
  ...
  do
    {
      instance++;
      instance = (__extension__ (__builtin_constant_p ('/') && !__builtin_constant_p (instance) && ('/') == '\0' ? (char *) __rawmemchr (instance, '/') : __builtin_strchr (instance, '/')));
      if (instance)
        count++;
    }
  while (instance);
...
# 140 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/path_driver.c"
svn_error_t *
svn_delta_path_driver(const svn_delta_editor_t *editor,
                      void *edit_baton,
                      svn_revnum_t revision,
                      ...
                      apr_pool_t *pool)
{
  ...
  int i = 0;
  void *parent_db = ((void*)0), *db = ((void*)0);
  const char *path;
  ...
  path = (((const char * *)(paths)->elts)[0]);
  if (svn_path_is_empty(path))
    {
      do { svn_error_t *svn_err__temp = (callback_func(&db, ((void*)0), callback_baton, path, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      last_path = path;
      i++;
    }
  else
    {
      do { svn_error_t *svn_err__temp = (editor->open_root(edit_baton, revision, subpool, &db)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  item->pool = subpool;
  item->dir_baton = db;
  (*((void * *)apr_array_push(db_stack))) = item;
  ...
  for (; i < paths->nelts; i++)
    {
      ...
      if (i > 0)
        common = (last_path[0] == '/')
          ? apr_pstrcat((iterpool), "/", svn_relpath_get_longest_ancestor((last_path)+1, (path)+1, (iterpool)), ((void*)0))
      ...
      if ((i > 0) && (strlen(last_path) > common_len))
        {
          ...
          while (count--)
            {
              do { svn_error_t *svn_err__temp = (pop_stack(db_stack, editor)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
        }
          ...
          while (1)
            {
              ...
              piece = (__extension__ (__builtin_constant_p ('/') && !__builtin_constant_p (piece) && ('/') == '\0' ? (char *) __rawmemchr (piece, '/') : __builtin_strchr (piece, '/')));
              ...
              do { svn_error_t *svn_err__temp = (open_dir(db_stack, editor, rel, revision, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      parent_db = item->dir_baton;
      subpool = svn_pool_create_ex(pool, ((void*)0));
      do { svn_error_t *svn_err__temp = (callback_func(&db, parent_db, callback_baton, path, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (db)
        {
          item = memset(apr_palloc(subpool, sizeof(*item)), 0, sizeof(*item));
          item->dir_baton = db;
