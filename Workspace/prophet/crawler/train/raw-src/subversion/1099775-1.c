# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c"
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
  ...
  if ((! b->warned)
          ...
          (notify->action == svn_wc_notify_commit_copied_replaced)))
    {
      ...
      err = svn_cmdline_printf(pool,
                               dcgettext ("subversion", "svn: warning: The depth of this commit " "is '%s', but copied directories will " "regardless be committed with depth '%s'.  " "You must remove unwanted children of those " "directories in a separate commit.  " "(Suppressing additional instances of this " "warning.)\n", 5),
               ...
               apr_pool_t *pool)
{
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (svn_path_is_url(target))
        return (svn_error_createf(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0), dcgettext ("subversion", "'%s' is a URL, but URLs cannot be " "commit targets", 5), target));
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__eat_peg_revisions(&targets, targets, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_dirent_condense_targets(&base_dir, &condensed_targets, targets, (!0), pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ((! condensed_targets) || (! condensed_targets->nelts))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc_get_actual_target2(&parent_dir, &base_name, ctx->wc_ctx, base_dir, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  cfg = apr_hash_get(ctx->config, "config",
                     (-1));
  if (cfg)
    do { svn_error_t *svn_err__temp = (svn_config_get_bool(cfg, &no_unlock, "miscellany", "no-unlock", 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__make_log_msg_baton(&(ctx->log_msg_baton3), opt_state, base_dir, ctx->config, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  err = svn_client_commit5(targets,
                           ...
                           ! opt_state->quiet
                                ? svn_cl__print_commit_info : ((void*)0),
                           ((void*)0),
                           ctx,
                           pool);
  if (err)
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__cleanup_log_msg(ctx->log_msg_baton3, err, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
