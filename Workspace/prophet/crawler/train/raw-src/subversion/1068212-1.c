# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/caching.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/caching.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/caching.c"
# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_atomic.h" 1
# 25 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_atomic.h"
...
# 26 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_atomic.h" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/caching.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/caching.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/caching.c" 2
...
svn_cache__create_inprocess(svn_cache__t **cache_p,
                            ...
                            apr_pool_t *pool);
# 170 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__create_memcache(svn_cache__t **cache_p,
                           ...
                           const char *prefix,
                           apr_pool_t *pool);
# 189 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__make_memcache_from_config(svn_memcache_t **memcache_p,
                                     svn_config_t *config,
                                     apr_pool_t *pool);
# 210 "./subversion/include/private/svn_cache.h"
svn_error_t*
...
svn_cache__create_membuffer_cache(svn_cache__t **cache_p,
                                  ...
                                  const char *prefix,
                                  apr_pool_t *pool);
# 254 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__set_error_handler(svn_cache__t *cache,
                             svn_cache__error_handler_t handler,
                             void *baton,
                             apr_pool_t *pool);
# 269 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__get(void **value,
               ...
               const void *key,
               apr_pool_t *pool);
# 288 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
svn_cache__iter(svn_boolean_t *completed,
                ...
                void *baton,
                apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/caching.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/caching.c" 2
...
svn_fs__get_global_membuffer_cache(void)
{
  static svn_membuffer_t * volatile cache = ((void*)0);

  apr_uint64_t cache_size = cache_settings.cache_size;
  if (!cache && cache_size)
    {
      svn_membuffer_t *old_cache = ((void*)0);
      svn_membuffer_t *new_cache = ((void*)0);
      ...
      old_cache = apr_atomic_casptr((volatile void **)&cache, new_cache, ((void*)0));
      if (old_cache != ((void*)0))
