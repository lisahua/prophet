...
move_page_to_front(inprocess_cache_t *cache,
                   struct cache_page *page)
{
  do { if (!(page != cache->sentinel)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 155, "page != cache->sentinel")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (existing_entry && cache->items_per_page == 1)
    {
      ...
      do { if (!(page->next != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 312, "page->next != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      do { if (!(cache->partial_page == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 313, "cache->partial_page == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (cache->partial_page == ((void*)0))
    {
      ...
      do { if (!(oldest_page != cache->sentinel)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 361, "oldest_page != cache->sentinel")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


      erase_page(cache, oldest_page);
    }

  do { if (!(cache->partial_page != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 367, "cache->partial_page != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  do { if (!(pages >= 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 583, "pages >= 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  cache->total_pages = pages;
  cache->unallocated_pages = pages;
  do { if (!(items_per_page >= 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 586, "items_per_page >= 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
