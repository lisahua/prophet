                         ...
                         apr_pool_t *pool)
{
  ...
  do { if (!(info != ((void*)0) && info->wc_info != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/info.c", 286, "info != NULL && info->wc_info != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
