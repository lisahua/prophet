...
svn_stream_create(void *baton, apr_pool_t *pool)
{
  ...
  stream->line_filter_cb = ((void*)0);
  stream->line_transformer_cb = ((void*)0);
  return stream;
}
...
{
  do { if (!(stream->read_fn != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c", 152, "stream->read_fn != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  do { if (!(stream->write_fn != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c", 160, "stream->write_fn != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_stream_reset(svn_stream_t *stream)
{
  if (stream->reset_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",169), (svn_error_create))(SVN_ERR_STREAM_RESET_NOT_SUPPORTED, ((void*)0), ((void*)0));
                ...
                apr_pool_t *pool)
{
  if (stream->mark_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",179), (svn_error_create))(SVN_ERR_STREAM_SEEK_NOT_SUPPORTED, ((void*)0), ((void*)0));
...
svn_stream_seek(svn_stream_t *stream, svn_stream_mark_t *mark)
{
  if (stream->seek_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",188), (svn_error_create))(SVN_ERR_STREAM_SEEK_NOT_SUPPORTED, ((void*)0), ((void*)0));
            ...
            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (stream->line_filter_cb(filtered, line, stream->baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  *buf = ((void*)0);
  do { svn_error_t *svn_err__temp = (stream->line_transformer_cb(buf, line, stream->baton, pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { if (!(*buf)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c", 278, "*buf")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  *eof = 0;
  ...
  do
    {
      ...
      do { svn_error_t *svn_err__temp = (line_filter(stream, &filtered, str->data, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  while (filtered && ! *eof);
  ...
  if (filtered)
    *stringbuf = svn_stringbuf_create_ensure(0, pool);
    ...
    do { svn_error_t *svn_err__temp = (line_transformer(stream, stringbuf, str->data, pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
                         ...
                         apr_pool_t *pool)
{
  ...
  *same = (!0);
  while (bytes_read1 == 16384
         && bytes_read2 == 16384)
    {
      do { svn_error_t *svn_err__temp = (svn_stream_read(stream1, buf1, &bytes_read1)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_stream_read(stream2, buf2, &bytes_read2)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
mark_handler_apr(void *baton, svn_stream_mark_t **mark, apr_pool_t *pool)
{
  ...
  (*mark)->m.apr = 0;
  do { svn_error_t *svn_err__temp = (svn_io_file_seek(btn->file, 1, &(*mark)->m.apr, btn->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return 0;
}
...
{
  struct baton_apr *btn = baton;
  do { svn_error_t *svn_err__temp = (svn_io_file_seek(btn->file, 0, &mark->m.apr, btn->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return 0;
}
...
# 907 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c"
struct zbaton {
  z_stream *in;
  z_stream *out;
  svn_read_fn_t read;
...
zerr_to_svn_error(int zerr, const char *function, z_stream *stream)
{
  ...
  if (stream->msg != ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",984), (svn_error_createf))(status, ((void*)0), "zlib (%s): %s: %s", function,
                             message, stream->msg);
  else
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",987), (svn_error_createf))(status, ((void*)0), "zlib (%s): %s", function,
                             message);
}
...
svn_stream_compressed(svn_stream_t *stream, apr_pool_t *pool)
{
  ...
  ((stream != ((void*)0)) ? (void) (0) : __assert_fail ("stream != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c", 1164, __PRETTY_FUNCTION__));
...
svn_stream_for_stdout(svn_stream_t **out, apr_pool_t *pool)
{
  ...
  if (apr_err)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",1503), (svn_error_wrap_apr))(apr_err, "Can't open stdout");
