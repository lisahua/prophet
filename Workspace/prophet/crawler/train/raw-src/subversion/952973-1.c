# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c" 2
...
svn_cl__path_join(const char *base,
                  const char *component,
                  apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c" 2
             ...
             apr_pool_t *pool)
{
  ...
  if (targets->nelts < 2)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c",59), (svn_error_create))(SVN_ERR_CL_INSUFFICIENT_ARGS, 0, ((void*)0));
  ...
  if ((! srcs_are_urls) && (! dst_is_url))
    ...
    {
# 115 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c"
    }
  else if ((srcs_are_urls) && (! dst_is_url))
    {
  ...
  if (! dst_is_url)
    {
      ...
      if (opt_state->message || opt_state->filedata || opt_state->revprop_table)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c",129), (svn_error_create))
