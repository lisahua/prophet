# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
...
apr_status_t apr_uri_parse_hostinfo(apr_pool_t *p,
                                                 const char *hostinfo,
                                                 apr_uri_t *uptr);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
apr_status_t apr_password_validate(const char *passwd,
                                                const char *hash);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
# 1 "./subversion/include/svn_checksum.h" 1
# 33 "./subversion/include/svn_checksum.h"
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
...
svn_client__resolve_conflicts(svn_boolean_t *conflicts_remain,
                              ...
                              svn_client_ctx_t *ctx,
                              apr_pool_t *scratch_pool);
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
svn_config__shallow_replace_section(svn_config_t *target,
                                    svn_config_t *source,
                                    const char *section);
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
svn_wc__acquire_write_lock_for_resolve(const char **lock_root_abspath,
                                       ...
                                       apr_pool_t *result_pool,
                                       apr_pool_t *scratch_pool);
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
# 223 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
               ...
               apr_pool_t *result_pool)
{
  ...
  struct dir_baton *dir_baton = memset(apr_palloc(dir_pool, sizeof(*dir_baton)), 0, sizeof(*dir_baton));

  dir_baton->parent_baton = parent_baton;
  dir_baton->edit_baton = edit_baton;
  dir_baton->added = added;
  dir_baton->tree_conflicted = 0;
  dir_baton->skip = 0;
  dir_baton->skip_children = 0;
...
{
  ((db->users > 0) ? (void) (0) : __assert_fail ("db->users > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c", 256, __PRETTY_FUNCTION__));
...

  {
    ...
    if (pb != ((void*)0))
      do { svn_error_t *svn_err__temp = (release_dir(pb)); if (svn_err__temp) return (svn_err__temp); } while (0);
  }
                ...
                apr_pool_t *result_pool)
{
  ...
  struct file_baton *file_baton = memset(apr_palloc(file_pool, sizeof(*file_baton)), 0, sizeof(*file_baton));

  file_baton->parent_baton = parent_baton;
  file_baton->edit_baton = parent_baton->edit_baton;
  file_baton->added = added;
  file_baton->tree_conflicted = 0;
  file_baton->skip = 0;
...
# 317 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static svn_error_t *
  ...
  if (! props_only)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_open_unique(&fstream, &(fb->path_start_revision), ((void*)0), svn_io_file_del_on_pool_cleanup, fb->pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



      fstream = svn_stream_checksummed2(fstream, ((void*)0), &fb->start_md5_checksum,
                                        svn_checksum_md5, (!0), fb->pool);


      do { svn_error_t *svn_err__temp = (svn_ra_get_file(fb->edit_baton->ra_session, fb->path, fb->base_revision, fstream, ((void*)0), &(fb->pristine_props), fb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    {
      do { svn_error_t *svn_err__temp = (svn_ra_get_file(fb->edit_baton->ra_session, fb->path, fb->base_revision, ((void*)0), ((void*)0), &(fb->pristine_props), fb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 386 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static void
                        ...
                        apr_array_header_t *changes)
{
  ...
  for (i = 0; i < changes->nelts; i++)
    {
      svn_prop_t *change = &(((svn_prop_t *)(changes)->elts)[i]);

      if (change->value)
        {
          const svn_string_t *old_val = apr_hash_get(pristine_props, change->name, (-1));
          ...
          if (old_val && svn_string_compare(old_val, change->value))
            {
              ...
              for (j = i; j < changes->nelts - 1; j++)
                {
                  (((svn_prop_t *)(changes)->elts)[j])
                       = (((svn_prop_t *)(changes)->elts)[j+1]);
                }
              changes->nelts--;
            }
        }
               ...
               const char **empty_file_path)
{
  ...
  if (!eb->empty_file)
    do { svn_error_t *svn_err__temp = (svn_io_open_unique_file3(((void*)0), &(eb->empty_file), ((void*)0), svn_io_file_del_on_pool_cleanup, eb->pool, eb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  struct edit_baton *eb = edit_baton;
  struct dir_baton *db = make_dir_baton("", ((void*)0), eb, 0, base_revision,
                                        eb->pool);
  ...
  do { svn_error_t *svn_err__temp = (eb->processor->dir_opened(&db->pdb, &db->skip, &db->skip_children, "", db->left_source, db->right_source, ((void*)0), ((void*)0), eb->processor, db->pool, db->pool )); if (svn_err__temp) return (svn_err__temp); } while (0);
# 475 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  *root_baton = db;
  return 0;
}
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  struct file_baton *fb = make_file_baton(path, db, 0, scratch_pool);
  ...
  do { svn_error_t *svn_err__temp = (eb->processor->file_opened(&fb->pfb, &skip, path, left_source, ((void*)0) , ((void*)0) , db->pdb, eb->processor, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (get_file_from_ra(fb, ! eb->text_deltas, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (eb->processor->file_deleted(fb->path, left_source, fb->path_start_revision, fb->pristine_props, fb->pfb, eb->processor, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 531 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static svn_error_t *
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  svn_diff_source_t *left_source = svn_diff__source_create(eb->revision,
                                                           scratch_pool);
  db = make_dir_baton(path, pb, pb->edit_baton, 0, ((svn_revnum_t) -1),
                      scratch_pool);

  do { if (!(((eb->revision) >= 0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c", 548, "SVN_IS_VALID_REVNUM(eb->revision)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  if (eb->cancel_func)
    do { svn_error_t *svn_err__temp = (eb->cancel_func(eb->cancel_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (eb->processor->dir_opened(&db->pdb, &skip, &skip_children, path, left_source, ((void*)0) , ((void*)0) , pb->pdb, eb->processor, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 562 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  if (!skip || !skip_children)
    do { svn_error_t *svn_err__temp = (svn_ra_get_dir2(eb->ra_session, skip_children ? ((void*)0) : &dirents, ((void*)0), skip ? ((void*)0) : &left_props, path, eb->revision, 0x00001, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 576 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  if (! skip_children)
    {
      apr_hash_index_t *hi;
      ...
      for (hi = apr_hash_first(scratch_pool, dirents); hi;
           hi = apr_hash_next(hi))
        {
          ...
          if (dirent->kind == svn_node_file)
            {
              do { svn_error_t *svn_err__temp = (diff_deleted_file(child_path, db, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
          else if (dirent->kind == svn_node_dir)
            {
              do { svn_error_t *svn_err__temp = (diff_deleted_dir(child_path, db, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
        }
    }
  ...
  if (! skip)
    {
      do { svn_error_t *svn_err__temp = (eb->processor->dir_deleted(path, left_source, left_props, db->pdb, eb->processor, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (release_dir(db)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  scratch_pool = svn_pool_create_ex(eb->pool, ((void*)0));


  do { svn_error_t *svn_err__temp = (svn_ra_check_path(eb->ra_session, path, eb->revision, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  switch (kind)
    ...
    case svn_node_file:
      {
        do { svn_error_t *svn_err__temp = (diff_deleted_file(path, pb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        break;
      }
    case svn_node_dir:
      {
        do { svn_error_t *svn_err__temp = (diff_deleted_dir(path, pb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        break;
      }
    default:
      break;
              ...
              void **child_baton)
{
  ...
  db = make_dir_baton(path, pb, eb, (!0), ((svn_revnum_t) -1), pb->pool);
  *child_baton = db;
  ...
  do { svn_error_t *svn_err__temp = (eb->processor->dir_opened(&db->pdb, &db->skip, &db->skip_children, db->path, ((void*)0), db->right_source, ((void*)0) , pb->pdb, eb->processor, db->pool, db->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 702 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  return 0;
}
               ...
               void **child_baton)
{
  ...
  db = make_dir_baton(path, pb, eb, 0, base_revision, pb->pool);
  ...
  *child_baton = db;
  ...
  do { svn_error_t *svn_err__temp = (eb->processor->dir_opened(&db->pdb, &db->skip, &db->skip_children, path, db->left_source, db->right_source, ((void*)0) , pb ? pb->pdb : ((void*)0), eb->processor, db->pool, db->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 742 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  return 0;
}
         ...
         void **file_baton)
{
  ...
  fb = make_file_baton(path, pb, (!0), pb->pool);
  *file_baton = fb;
  ...
  do { svn_error_t *svn_err__temp = (eb->processor->file_opened(&fb->pfb, &fb->skip, path, ((void*)0), fb->right_source, ((void*)0) , pb->pdb, eb->processor, fb->pool, fb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 785 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  return 0;
}
          ...
          void **file_baton)
{
  ...
  *file_baton = fb;
  ...
  do { svn_error_t *svn_err__temp = (eb->processor->file_opened(&fb->pfb, &fb->skip, path, fb->left_source, fb->right_source, ((void*)0) , pb->pdb, eb->processor, fb->pool, fb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 824 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  return 0;
}
               ...
               void *window_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (fb->apply_handler(window, fb->apply_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(stream, fb->path_start_revision, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_open_unique(stream, &fb->path_end_revision, ((void*)0), svn_io_file_del_on_pool_cleanup, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                void **handler_baton)
{
  ...
  if (! fb->edit_baton->text_deltas)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_empty_file(fb->edit_baton, &fb->path_start_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (get_empty_file(fb->edit_baton, &fb->path_end_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!fb->added)
    do { svn_error_t *svn_err__temp = (get_file_from_ra(fb, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
    do { svn_error_t *svn_err__temp = (get_empty_file(fb->edit_baton, &(fb->path_start_revision))); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { if (!(fb->path_start_revision != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c", 917, "fb->path_start_revision != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  if (base_md5_digest != ((void*)0))
    {
      svn_checksum_t *base_md5_checksum;

      do { svn_error_t *svn_err__temp = (svn_checksum_parse_hex(&base_md5_checksum, svn_checksum_md5, base_md5_digest, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (!svn_checksum_match(base_md5_checksum, fb->start_md5_checksum))
        return (svn_checksum_mismatch_err( base_md5_checksum, fb->start_md5_checksum, scratch_pool, dcgettext ("subversion", "Base checksum mismatch for '%s'", 5), fb->path));
  ...
  src_stream = svn_stream_lazyopen_create(lazy_open_source, fb, (!0),
                                          scratch_pool);



  result_stream = svn_stream_lazyopen_create(lazy_open_result, fb, (!0),
                                             scratch_pool);
...
# 966 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static svn_error_t *
  ...
  if (expected_md5_digest && eb->text_deltas)
    {
      ...
      if (!svn_checksum_match(expected_md5_checksum, fb->result_md5_checksum))
        return (svn_checksum_mismatch_err( expected_md5_checksum, fb->result_md5_checksum, pool, dcgettext ("subversion", "Checksum mismatch for '%s'", 5), fb->path));
  ...
  if (fb->added || fb->path_end_revision || fb->has_propchange)
    {
      ...
      if (fb->added)
        do { svn_error_t *svn_err__temp = (eb->processor->file_added(fb->path, ((void*)0) , fb->right_source, ((void*)0) , fb->path_end_revision, ((void*)0) , right_props, fb->pfb, eb->processor, fb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1030 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
      else
        do { svn_error_t *svn_err__temp = (eb->processor->file_changed(fb->path, fb->left_source, fb->right_source, fb->path_end_revision ? fb->path_start_revision : ((void*)0), fb->path_end_revision, fb->pristine_props, right_props, (fb->path_end_revision != ((void*)0)), fb->propchanges, fb->pfb, eb->processor, fb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1045 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
    }
...
# 1061 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static svn_error_t *
  ...
  if ((db->has_propchange || db->added) && !db->skip)
    {
      if (db->added)
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_ra_get_dir2(eb->ra_session, ((void*)0), ((void*)0), &pristine_props, db->path, db->base_revision, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (db->propchanges->nelts > 0 || db->added)
        {
          ...
          if (db->added)
            {
              do { svn_error_t *svn_err__temp = (eb->processor->dir_added(db->path, ((void*)0) , db->right_source, ((void*)0) , right_props, db->pdb, eb->processor, db->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            {
              do { svn_error_t *svn_err__temp = (eb->processor->dir_changed(db->path, db->left_source, db->right_source, pristine_props, right_props, db->propchanges, db->pdb, eb->processor, db->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1119 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
            }
  ...
  if (! db->skip && !send_changed)
    {
      do { svn_error_t *svn_err__temp = (eb->processor->dir_closed(db->path, db->left_source, db->right_source, db->pdb, eb->processor, db->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (eb->processor->node_absent(path, pb->pdb, eb->processor, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_check_path(eb->ra_session, path, base_revision, kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_check_path(eb->ra_session, path, base_revision, &node_kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (node_kind == svn_node_file)
    {
      do { svn_error_t *svn_err__temp = (svn_ra_get_file(eb->ra_session, path, base_revision, ((void*)0), ((void*)0), props, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else if (node_kind == svn_node_dir)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_ra_get_dir2(eb->ra_session, ((void*)0), ((void*)0), props, path, base_revision, 0 , result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_client__get_diff_editor2(const svn_delta_editor_t **editor,
                             ...
                             apr_pool_t *result_pool)
{
  apr_pool_t *editor_pool = svn_pool_create_ex(result_pool, ((void*)0));
  svn_delta_editor_t *tree_editor = svn_delta_default_editor(editor_pool);
  struct edit_baton *eb = memset(apr_palloc(editor_pool, sizeof(*eb)), 0, sizeof(*eb));
  svn_delta_shim_callbacks_t *shim_callbacks =
  ...
  do { svn_error_t *svn_err__temp = (svn_delta_get_cancellation_editor(cancel_func, cancel_baton, tree_editor, eb, editor, edit_baton, eb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_editor__insert_shims(editor, edit_baton, *editor, *edit_baton, ((void*)0), ((void*)0), shim_callbacks, result_pool, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
