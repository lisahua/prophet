...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { if (!(((eb->revision) >= 0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/repos_diff.c", 548, "SVN_IS_VALID_REVNUM(eb->revision)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                ...
                void **handler_baton)
{
  ...
  do { if (!(fb->path_start_revision != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/repos_diff.c", 917, "fb->path_start_revision != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
