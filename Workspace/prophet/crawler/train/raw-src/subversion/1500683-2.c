...
# 127 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnauth/svnauth.c"
...
subcommand_list(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_config_walk_auth_data(config_path, list_credentials, ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  return 0;
}
# 224 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnauth/svnauth.c"
static int
