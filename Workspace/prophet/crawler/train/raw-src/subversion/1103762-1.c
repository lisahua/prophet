...
svn_wc__db_base_get_lock_tokens_recursive(apr_hash_t **lock_tokens,
                                          ...
                                          apr_pool_t *result_pool,
                                          apr_pool_t *scratch_pool);
# 879 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_pristine_get_future_path(const char **pristine_abspath,
                                    ...
                                    apr_pool_t *result_pool,
                                    apr_pool_t *scratch_pool);
# 909 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_external_read_props(apr_hash_t **props,
                               ...
                               apr_pool_t *result_pool,
                               apr_pool_t *scratch_pool);
# 1257 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_add_symlink(svn_wc__db_t *db,
                          ...
                          const svn_skel_t *work_items,
                          apr_pool_t *scratch_pool);
# 1408 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_revert_list_read(svn_boolean_t *reverted,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 1574 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_revert_list_notify(svn_wc_notify_func2_t notify_func,
                              ...
                              const char *local_abspath,
                              apr_pool_t *scratch_pool);
# 1588 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
# 1918 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_read_url(const char **url,
                    ...
                    apr_pool_t *result_pool,
                    apr_pool_t *scratch_pool);
# 1996 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_read_children(const apr_array_header_t **children,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2097 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_global_commit(svn_wc__db_t *db,
                         ...
                         const svn_skel_t *work_items,
                         apr_pool_t *scratch_pool);
# 2287 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_lock_remove(svn_wc__db_t *db,
                       const char *local_abspath,
                       apr_pool_t *scratch_pool);
# 2413 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_upgrade_apply_dav_cache(svn_sqlite__db_t *sdb,
                                   ...
                                   apr_pool_t *scratch_pool);
# 2623 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_upgrade_get_repos_id(apr_int64_t *repos_id,
                                ...
                                const char *repos_root_url,
                                apr_pool_t *scratch_pool);
# 2657 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_revision_status(svn_revnum_t *min_revision,
                           ...
                           void *cancel_baton,
                           apr_pool_t *scratch_pool);
# 2990 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_is_sparse_checkout(svn_boolean_t *is_sparse_checkout,
                              ...
                              const char *local_abspath,
                              apr_pool_t *scratch_pool);
# 3023 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
# 103 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c", 122, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (has_props)
    {
      do { svn_error_t *svn_err__temp = (svn_wc__get_translate_info(&eol_style, &eol_str, &keywords, &special, db, versioned_file_abspath, ((void*)0), !exact_comparison, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 174 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (need_translation)
    {
...
# 270 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (!checksum
  ...
  if (! exact_comparison)
    {
# 309 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
 ...
 compare_them:
  ...
  do { svn_error_t *svn_err__temp = (compare_and_verify(modified_p, db, local_abspath, dirent->filesize, pristine_stream, pristine_size, has_props, props_mod, exact_comparison, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!*modified_p)
    {
      ...
      if (own_lock)
        do { svn_error_t *svn_err__temp = (svn_wc__db_global_record_fileinfo(db, local_abspath, dirent->filesize, dirent->mtime, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
