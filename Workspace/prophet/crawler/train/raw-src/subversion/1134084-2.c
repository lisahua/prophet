...
svn_wc__db_read_pristine_info(svn_wc__db_status_t *status,
                              ...
                              apr_pool_t *result_pool,
                              apr_pool_t *scratch_pool);
# 1908 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_upgrade_get_repos_id(apr_int64_t *repos_id,
                                ...
                                const char *repos_root_url,
                                apr_pool_t *scratch_pool);
# 2627 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_wclock_owns_lock(svn_boolean_t *own_lock,
                            ...
                            svn_boolean_t exact,
                            apr_pool_t *scratch_pool);
# 2718 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_revision_status(svn_revnum_t *min_revision,
                           ...
                           void *cancel_baton,
                           apr_pool_t *scratch_pool);
# 2942 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (arg1->next->next)
  ...
  else
    {
      ...
      do { if (!(29 <= 28)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 257, "SVN_WC__VERSION <= 28")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 346 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  *overwrote_working = 0;
# 386 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
  {
...
# 408 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
...
# 457 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
  ...
  if (overwrote_working)
    ...
    {
      svn_boolean_t modified;
# 492 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
...
# 618 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  if (arg4 != ((void*)0))
    ...
    {
      do { if (!(checksum != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 672, "checksum != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 813 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
...
# 861 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(wri_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 910, "svn_dirent_is_absolute(wri_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(src_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 911, "svn_dirent_is_absolute(src_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(dst_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 912, "svn_dirent_is_absolute(dst_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 943 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                                      ...
                                      apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1004, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(src_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1005, "svn_dirent_is_absolute(src_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(dst_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1006, "svn_dirent_is_absolute(dst_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  if (arg1->next != ((void*)0))
    ...
    do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1108, ((void*)0))); } while (0);
  ...
  do { if (!(prejfile_abspath != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1119, "prejfile_abspath != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                              ...
                              apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(conflict_skel != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1142, "conflict_skel != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                 ...
                                 apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1224, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                               ...
                                               apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1317, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                                  ...
                                                  apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1399, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 1472 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
          break;
        }
    }
