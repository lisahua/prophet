...
svn_wc_crop_tree2(svn_wc_context_t *wc_ctx,
                  ...
                  void *notify_baton,
                  apr_pool_t *scratch_pool);
# 7922 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
svn_opt__revision_range_from_revnums(svn_revnum_t start_revnum,
                                     ...
                                     apr_pool_t *result_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
{
  return svn_opt_print_help4(((void*)0), "svnversion", (!0), quiet, 0,
...
# 88 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c"
...
# 169 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c"
  ...
  do { svn_error_t *svn_err__temp = (svn_opt__arg_canonicalize_path(&wc_path, wc_path, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  ...
  if (err && (err->apr_err == SVN_ERR_WC_PATH_NOT_FOUND
              || err->apr_err == SVN_ERR_WC_NOT_WORKING_COPY))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_check_special_path(local_abspath, &kind, &special, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);


      if (special)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Unversioned symlink%s", 5), no_newline ? "" : "\n")); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_fprintf(stderr, pool, kind == svn_node_none ? dcgettext ("subversion", "'%s' doesn't exist\n", 5) : dcgettext ("subversion", "'%s' is of unknown type\n", 5), svn_dirent_local_style(local_abspath, pool))); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
