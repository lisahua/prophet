...
# 86 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  ...
  do
    {
      if (ctx->ungotten_char != (-1))
      ...
      else
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_stream_read(ctx->stream, ctx->parser_buffer, &(ctx->buffer_size))); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 130 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
static __inline__ svn_error_t *
...
# 323 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
static svn_error_t *
...
{
  *path_p = ((void*)0);
# 391 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
...
# 607 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "###   http-library               Which library to use for http/https"
                                                                             "\n"
        "###                              connections." "\n"
        "###   bulk-updates               Whether to request bulk update" "\n"
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "# password-stores =" "\n"
# 1039 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
        "###" "\n"
...
# 1229 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  {
