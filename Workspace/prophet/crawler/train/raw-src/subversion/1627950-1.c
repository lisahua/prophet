...
# 211 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_initialize(apr_pool_t *pool);
# 222 "./subversion/include/svn_fs.h"
...
svn_fs_hotcopy(const char *src_path,
               ...
               svn_boolean_t clean,
               apr_pool_t *pool);
# 571 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_freeze(svn_fs_t *fs,
              ...
              void *freeze_baton,
              apr_pool_t *pool);
# 643 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_berkeley_logfiles(apr_array_header_t **logfiles,
                         ...
                         apr_pool_t *pool);
# 682 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_fs_t *
...
svn_fs_create_access(svn_fs_access_t **access_ctx,
                     const char *username,
                     apr_pool_t *pool);
# 770 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 923 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_fs_id_t *
...
svn_fs_unparse_id(const svn_fs_id_t *id,
                  apr_pool_t *pool);
# 1036 "./subversion/include/svn_fs.h"
...
svn_fs_begin_txn(svn_fs_txn_t **txn_p,
                 ...
                 svn_revnum_t rev,
                 apr_pool_t *pool);
# 1167 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_node_history(svn_fs_history_t **history_p,
                    ...
                    const char *path,
                    apr_pool_t *pool);
# 1612 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 2026 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_dir_entries(apr_hash_t **entries_p,
                   svn_fs_root_t *root,
                   const char *path,
                   apr_pool_t *pool);
# 2040 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_file_checksum(svn_checksum_t **checksum,
                     ...
                     svn_boolean_t force,
                     apr_pool_t *pool);
# 2180 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_apply_textdelta(svn_txdelta_window_handler_t *contents_p,
                       ...
                       apr_pool_t *pool);
# 2326 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_apply_text(svn_stream_t **contents_p,
                  ...
                  const char *result_checksum,
                  apr_pool_t *pool);
# 2344 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_lock_target_t *svn_fs_lock_target_create(const char *token,
                                                ...
                                                apr_pool_t *pool);
# 2607 "./subversion/include/svn_fs.h"
...
typedef svn_error_t *(*svn_fs_lock_callback_t)(void *baton,
                                               ...
                                               svn_error_t *fs_err,
                                               apr_pool_t *pool);
# 2678 "./subversion/include/svn_fs.h"
svn_error_t *
...
typedef svn_error_t *(*svn_fs_get_locks_callback_t)(void *baton,
                                                    svn_lock_t *lock,
                                                    apr_pool_t *pool);
# 2814 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_get_locks(svn_fs_t *fs,
                 ...
                 void *get_locks_baton,
                 apr_pool_t *pool);
# 2853 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 2944 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_verify(const char *path,
              ...
              void *cancel_baton,
              apr_pool_t *scratch_pool);
# 2979 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 3028 "./subversion/include/svn_fs.h"
...
# 3064 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_info(const svn_fs_info_placeholder_t **fs_info,
            svn_fs_t *fs,
            apr_pool_t *result_pool,
            apr_pool_t *scratch_pool);
# 3080 "./subversion/include/svn_fs.h"
void *
...
# 134 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/fs.h"
...
# 176 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/fs.h"
...
{
# 455 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/fs.h"
                       ...
                       apr_pool_t *pool)
{
  ...
  do { if (!(container->builder == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c", 434, "container->builder == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(container->paths)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c", 435, "container->paths")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
