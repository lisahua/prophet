# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/patch-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/patch-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/patch-cmd.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/patch-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/patch-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/patch-cmd.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/patch-cmd.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/patch-cmd.c" 2
              ...
              apr_pool_t *pool)
{
  ...
  patch_path = (((const char * *)(targets)->elts)[0]);

  if (svn_path_is_url(patch_path))
    return svn_error_createf(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                             dcgettext ("subversion", "'%s' is not a local path", 5), patch_path);

  do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&abs_patch_path, patch_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (targets->nelts == 1)
    target_path = "";
  else
    {
      target_path = (((const char * *)(targets)->elts)[1]);

      if (svn_path_is_url(target_path))
        return svn_error_createf(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                                 dcgettext ("subversion", "'%s' is not a local path", 5), target_path);
    }
  do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&abs_target_path, target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client_patch(abs_patch_path, abs_target_path, opt_state->dry_run, opt_state->strip, opt_state->reverse_diff, opt_state->ignore_whitespace, (!0), ((void*)0), ((void*)0), ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
