                  ...
                  apr_pool_t *pool)
{
  ...
  if (opt_state->show_revs == svn_cl__show_revs_merged)
    {
      do { svn_error_t *svn_err__temp = (svn_client_mergeinfo_log((!0), target, &tgt_peg_revision, source, &src_peg_revision, print_log_rev, ((void*)0), (!0), depth, ((void*)0), ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
