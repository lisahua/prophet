...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c"
            ...
            apr_pool_t *pool)
{
  ...
  do { if (!(lines > 0)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c", 172, "lines > 0"); abort(); } } while (0);
...
svn_diff__lcs(svn_diff__position_t *position_list1,
              ...
              apr_pool_t *pool)
{
# 234 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c"
  apr_off_t length[2];
  svn_diff__snake_t *fp;
  apr_off_t d;
  apr_off_t k;
...
# 288 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c"
  fp += length[1] + 1;
