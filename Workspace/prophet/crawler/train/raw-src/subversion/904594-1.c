...
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static void
  ...
  if (oldhash)
    {
      ...
      for (this = apr_hash_first(pool, oldhash); this;
           this = apr_hash_next(this))
        {
          ...
          apr_hash_this(this, &key, &keylen, ((void*)0));
...
# 135 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 173 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
struct edit_baton
{
...
# 247 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
               ...
               apr_pool_t *pool)
{
  ...
  do { if (!(!path || pb)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c", 262, "!path || pb"); abort(); } } while (0);
  ...
  new_db->cmp_path = cmp_path ? apr_pstrdup(pool, cmp_path) : ((void*)0);
...
# 300 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
      ...
      if (! is_copy)
      ...
      else
        {
          if (!eb->verify && cmp_rev < eb->oldest_dumped_rev)
            do { svn_error_t *svn_err__temp = (svn_stream_printf (eb->feedback_stream, pool, dcgettext ("subversion", "WARNING: Referencing data in revision %ld," " which is older than the oldest\n" "WARNING: dumped revision (%ld).  Loading this dump" " into an empty repository\n" "WARNING: will fail.\n", 5), cmp_rev, eb->oldest_dumped_rev)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 429 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
               ...
               void **child_baton)
{
  ...
  if (pb && ((pb->cmp_path) && ((pb->cmp_rev) >= 0)))
    {
...
# 896 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
                      ...
                      apr_pool_t *pool)
{
  ...
  write_hash_to_stringbuf(props, ((void*)0), &encoded_prophash, pool);
                   ...
                   apr_pool_t *pool)
{
  ...
  const char *uuid;
  int version;
  svn_boolean_t dumping = (stream != ((void*)0));
  ...
  if (start_rev > end_rev)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",992), (svn_error_createf))(SVN_ERR_REPOS_BAD_ARGS, ((void*)0),
                             dcgettext ("subversion", "Start revision %ld" " is greater than end revision %ld", 5),

                             start_rev, end_rev);
  if (end_rev > youngest)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",997), (svn_error_createf))(SVN_ERR_REPOS_BAD_ARGS, ((void*)0),
  ...
  for (i = start_rev; i <= end_rev; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor(&dump_editor, &dump_edit_baton, fs, to_rev, "/", stream, feedback_stream, start_rev, use_deltas_for_rev, 0, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1094 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
        }
      else
        {
    ...
    loop_end:
      do { svn_error_t *svn_err__temp = (svn_stream_printf(feedback_stream, pool, dumping ? dcgettext ("subversion", "* Dumped revision %ld.\n", 5) : dcgettext ("subversion", "* Verified revision %ld.\n", 5), to_rev)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1135 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
                       ...
                       void *val, apr_pool_t *pool)
{
  ...
  case svn_node_file:
    ...
    break;
  default:
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",1158), (svn_error_createf))(SVN_ERR_NODE_UNEXPECTED_KIND, ((void*)0),
                    ...
                    apr_pool_t *pool)
{
  ...
  if (start_rev > end_rev)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",1205), (svn_error_createf))(SVN_ERR_REPOS_BAD_ARGS, ((void*)0),
                             dcgettext ("subversion", "Start revision %ld" " is greater than end revision %ld", 5),

                             start_rev, end_rev);
  if (end_rev > youngest)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",1210), (svn_error_createf))(SVN_ERR_REPOS_BAD_ARGS, ((void*)0),
                             dcgettext ("subversion", "End revision %ld is invalid " "(youngest revision is %ld)", 5),
  ...
  for (rev = start_rev; rev <= end_rev; rev++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor((const svn_delta_editor_t **)&dump_editor, &dump_edit_baton, fs, rev, "", svn_stream_empty(pool), feedback_stream, start_rev, 0, (!0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_printf(feedback_stream, iterpool, dcgettext ("subversion", "* Verified revision %ld.\n", 5), rev)); if (svn_err__temp) return (svn_err__temp); } while (0);
