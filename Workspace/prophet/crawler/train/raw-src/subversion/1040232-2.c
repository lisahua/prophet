# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c"
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h" 1
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
...
svn_cl__opt_parse_path(svn_opt_revision_t *rev,
                       ...
                       const char *path,
                       apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c" 2
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&path_prefix, "", scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "Summary of updates:\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (! svn_path_is_url(path) && ! svn_dirent_is_absolute(path))
        do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&path, path, iter_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (i < result_revs->nelts)
        {
          svn_revnum_t rev = (((svn_revnum_t *)(result_revs)->elts)[i]);

          if (((rev) >= 0))
            do { svn_error_t *svn_err__temp = (svn_cmdline_printf(iter_pool, dcgettext ("subversion", "  Updated '%s' to r%ld.\n", 5), path_local, rev)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *scratch_pool)
{
    ...
    for (i = 0; i < targets->nelts; i++)
      {
        ...
        if (svn_path_is_url(target))
          ...
          (*((const char * *)apr_array_push(new_targets))) = target;
      }
    targets = new_targets;
  }
  ...
  if (opt_state->changelists)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cl__changelist_paths(&targets, opt_state->changelists, targets, cl_depth, ctx, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client_update4(&result_revs, targets, &(opt_state->start_revision), depth, depth_is_sticky, opt_state->ignore_externals, opt_state->force, opt_state->parents, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! opt_state->quiet)
    {
      do { svn_error_t *svn_err__temp = (print_update_summary(targets, result_revs, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (nwb.had_externals_error)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/update-cmd.c",197), (svn_error_create))(SVN_ERR_CL_ERROR_PROCESSING_EXTERNALS, ((void*)0),
                            dcgettext ("subversion", "Failure occured processing one or more " "externals definitions", 5));
