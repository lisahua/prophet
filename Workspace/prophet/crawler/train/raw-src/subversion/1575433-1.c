# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
apr_status_t apr_password_validate(const char *passwd,
                                                const char *hash);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache.h" 1
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache.h"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache.h" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
svn_mutex__unlock(svn_mutex__t *mutex,
                  svn_error_t *err);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
# 1 "./subversion/include/private/svn_pseudo_md5.h" 1
# 48 "./subversion/include/private/svn_pseudo_md5.h"
void svn__pseudo_md5_15(apr_uint32_t digest[4],
                        const apr_uint32_t x[4]);
# 62 "./subversion/include/private/svn_pseudo_md5.h"
void svn__pseudo_md5_31(apr_uint32_t digest[4],
                        const apr_uint32_t x[8]);
# 76 "./subversion/include/private/svn_pseudo_md5.h"
void svn__pseudo_md5_63(apr_uint32_t digest[4],
                        const apr_uint32_t x[16]);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
# 169 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
typedef apr_uint64_t entry_key_t[2];
# 326 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 416 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
typedef struct entry_group_t
{
  ...
  char padding[512 - sizeof(group_header_t)
               - sizeof(entry_t) * ((512 - sizeof(group_header_t)) / sizeof(entry_t))];


  entry_t entries[((512 - sizeof(group_header_t)) / sizeof(entry_t))];
...
# 531 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  cache_level_t l1;
...
# 604 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
read_lock_cache(svn_membuffer_t *cache)
{
  ...
  if (cache->lock)
  {
    ...
    if (status)
      return svn_error_wrap_apr(status, dcgettext ("subversion", "Can't lock cache mutex", 5));
  }
  ...
  if (cache->lock)
    {
      ...
      if (status)
        return svn_error_wrap_apr(status,
                                  dcgettext ("subversion", "Can't write-lock cache mutex", 5));
    }
...
unlock_cache(svn_membuffer_t *cache, svn_error_t *err)
{
  ...
  if (cache->lock)
  {
    ...
    if (status)
      return svn_error_wrap_apr(status, dcgettext ("subversion", "Can't unlock cache mutex", 5));
  }

  return err;
}
# 723 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static __inline__ unsigned char
is_group_initialized(svn_membuffer_t *cache, apr_uint32_t group_index)
{
  unsigned char flags
    = cache->group_initialized[group_index / (8 * 32)];
  unsigned char bit_mask
    = (unsigned char)(1 << ((group_index / 32) % 8));
...
initialize_group(svn_membuffer_t *cache, apr_uint32_t group_index)
{
  ...
  apr_uint32_t first_index =
      (group_index / 32) * 32;
  apr_uint32_t last_index = first_index + 32;
  ...
  for (i = first_index; i < last_index; ++i)
    {
      ...
      header->next = (4294967295U);
      header->previous = (4294967295U);
    }
...
allocate_spare_group(svn_membuffer_t *cache)
{
  ...
  if (cache->first_spare_group != (4294967295U))
    {
  ...
  ((!group || !group->header.used) ? (void) (0) : __assert_fail ("!group || !group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 793, __PRETTY_FUNCTION__));
  return group;
}
...
free_spare_group(svn_membuffer_t *cache,
                 entry_group_t *group)
{
  ((group->header.used == 0) ? (void) (0) : __assert_fail ("group->header.used == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 803, __PRETTY_FUNCTION__));
  ((group->header.previous != (4294967295U)) ? (void) (0) : __assert_fail ("group->header.previous != (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 804, __PRETTY_FUNCTION__));
  ((group - cache->directory >= (apr_ssize_t)cache->group_count) ? (void) (0) : __assert_fail ("group - cache->directory >= (apr_ssize_t)cache->group_count", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 805, __PRETTY_FUNCTION__));


  cache->directory[group->header.previous].header.next = (4294967295U);
  group->header.chain_length = 0;
  group->header.previous = (4294967295U);
...
last_group_in_chain(svn_membuffer_t *cache,
                    entry_group_t *group)
{
  while (group->header.next != (4294967295U))
...
static __inline__ entry_t *
get_entry(svn_membuffer_t *cache, apr_uint32_t idx)
{
  return &cache->directory[idx / ((512 - sizeof(group_header_t)) / sizeof(entry_t))].entries[idx % ((512 - sizeof(group_header_t)) / sizeof(entry_t))];
}



static __inline__ apr_uint32_t
get_index(svn_membuffer_t *cache, entry_t *entry)
{
  apr_size_t group_index
    = ((char *)entry - (char *)cache->directory) / sizeof(entry_group_t);

  return (apr_uint32_t)group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t))
            ...
            apr_uint32_t idx)
{
  ...
  entry_t *next = level->next == (4294967295U)
                ? ((void*)0)
                : get_entry(cache, level->next);
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 889, __PRETTY_FUNCTION__));



  entry->next = level->next;
  if (level->first == (4294967295U))
    {


      entry->previous = (4294967295U);
      level->last = idx;
      level->first = idx;
    }
  else if (next == ((void*)0))
...
unchain_entry(svn_membuffer_t *cache,
              ...
              apr_uint32_t idx)
{
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 936, __PRETTY_FUNCTION__));
...
drop_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  apr_uint32_t group_index = idx / ((512 - sizeof(group_header_t)) / sizeof(entry_t));
  entry_group_t *last_group
    = last_group_in_chain(cache, &cache->directory[group_index]);
  apr_uint32_t last_in_group
    = (apr_uint32_t) ((last_group - cache->directory) * ((512 - sizeof(group_header_t)) / sizeof(entry_t))
    ...
    if (entry->next == level->next)
      {
        ...
        if (entry->previous == (4294967295U))
        ...
        else
          {
            ...
            level->current_data = (((previous->offset + previous->size) + 16 -1) & -16);
  ...
  if (!last_group->header.used && last_group->header.previous != (4294967295U))
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == level->current_data) ? (void) (0) : __assert_fail ("entry->offset == level->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1064, __PRETTY_FUNCTION__));
  ((idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used) ? (void) (0) : __assert_fail ("idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1065, __PRETTY_FUNCTION__));
  level->current_data = (((entry->offset + entry->size) + 16 -1) & -16);
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1082, __PRETTY_FUNCTION__));
}
                ...
                entry_key_t key)
{
  ...
  *cache = &segment0[(key[1] % 2809637UL)
         & (segment0->segment_count - 1)];
  return (key[0] % 5030895599UL) % segment0->group_count;
}
...
# 1127 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
  ...
  while (1)
    {
      for (i = 0; i < group->header.used; ++i)
        if ( to_find[0] == group->entries[i].key[0]
            && to_find[1] == group->entries[i].key[1])
          {
            ...
            if (group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t)))
      ...
      if (group->header.next == (4294967295U))
        break;


      ((group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))) ? (void) (0) : __assert_fail ("group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1188, __PRETTY_FUNCTION__));
      group = &cache->directory[group->header.next];
    }
  ...
  if (find_empty)
    {
          ...
          if (new_group)
            {
              ...
              new_group->header.previous = (apr_uint32_t) (group -
                                                           cache->directory);
              new_group->header.next = (4294967295U);
      ...
      if (group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t)))
        {
# 1227 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
          cache_level_t *entry_level;
          int to_remove = rand() % (((512 - sizeof(group_header_t)) / sizeof(entry_t)) * group->header.chain_length);
          entry_group_t *to_shrink
            = get_group(cache, group_index, to_remove / ((512 - sizeof(group_header_t)) / sizeof(entry_t)));

          entry = &to_shrink->entries[to_remove % ((512 - sizeof(group_header_t)) / sizeof(entry_t))];
          entry_level = get_cache_level(cache, entry);
          for (i = 0; i < ((512 - sizeof(group_header_t)) / sizeof(entry_t)); ++i)
            {
...
{
  apr_size_t size = (((entry->size) + 16 -1) & -16);
  cache_level_t *level = get_cache_level(cache, entry);
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1306, __PRETTY_FUNCTION__));
}
...
promote_entry(svn_membuffer_t *cache, entry_t *entry)
{
  apr_uint32_t idx = get_index(cache, entry);
  apr_size_t size = (((entry->size) + 16 -1) & -16);
  ((get_cache_level(cache, entry) == &cache->l1) ? (void) (0) : __assert_fail ("get_cache_level(cache, entry) == &cache->l1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1316, __PRETTY_FUNCTION__));
  ((idx == cache->l1.next) ? (void) (0) : __assert_fail ("idx == cache->l1.next", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1317, __PRETTY_FUNCTION__));
...
# 1346 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1379 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {


      apr_uint64_t end = cache->l2.next == (4294967295U)
...
# 1512 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_boolean_t
  ...
  while (1)
    {
      ...
      apr_uint64_t end = cache->l1.next == (4294967295U)
...
# 1578 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void* secure_aligned_alloc(apr_pool_t *pool,
                                  apr_size_t size,
                                  svn_boolean_t zero)
{
  void* memory = apr_palloc(pool, size + 16);
  if (memory != ((void*)0))
    {
      memory = ((void*)((((apr_size_t)(char*)(memory)) + 16 -1) & -16));
      if (zero)
                                  ...
                                  apr_pool_t *pool)
{
  ...
  if (total_size > 0xffff0000UL * 0x10000)
    total_size = 0xffff0000UL * 0x10000;




  if (segment_count > 0x10000)
    segment_count = 0x10000;
  if (segment_count * 0x10000UL > total_size)
    segment_count = total_size / 0x10000UL;
  ...
  if (segment_count < 1)
    {
# 1648 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      apr_uint32_t segment_count_shift = 0;
      while (((2 * 0x2000000UL) << (2 * segment_count_shift))
             < total_size)
        ++segment_count_shift;
  ...
  while ( total_size / segment_count > 0xffff0000UL
         && segment_count < 0x10000)
    segment_count *= 2;
  ...
  data_size = (((total_size - directory_size + 1) + 16 -1) & -16) - 16;





  max_entry_size = data_size / 8 > ((apr_uint32_t)(0 - 16))
                 ? ((apr_uint32_t)(0 - 16))
                 : data_size / 8;
  ...
  group_count = directory_size / sizeof(entry_group_t)
                    >= ((4294967295U) / ((512 - sizeof(group_header_t)) / sizeof(entry_t)))
              ? ((4294967295U) / ((512 - sizeof(group_header_t)) / sizeof(entry_t))) - 1
              : (apr_uint32_t)(directory_size / sizeof(entry_group_t));


  spare_group_count = ((group_count / 4) < (1) ? (1) : (group_count / 4));
  main_group_count = group_count - spare_group_count;
  ((spare_group_count > 0 && main_group_count > 0) ? (void) (0) : __assert_fail ("spare_group_count > 0 && main_group_count > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1714, __PRETTY_FUNCTION__));

  group_init_size = 1 + group_count / (8 * 32);
  for (seg = 0; seg < segment_count; ++seg)
    {
      ...
      c[seg].first_spare_group = (4294967295U);
      c[seg].max_spare_used = 0;

      c[seg].directory = memset(apr_palloc(pool, group_count * sizeof(entry_group_t)), 0, group_count * sizeof(entry_group_t));




      c[seg].group_initialized = memset(apr_palloc(pool, group_init_size), 0, group_init_size);



      c[seg].l1.first = (4294967295U);
      c[seg].l1.last = (4294967295U);
      c[seg].l1.next = (4294967295U);
      c[seg].l1.start_offset = 0;
      c[seg].l1.size = (((data_size / 4) + 16 -1) & -16);
      c[seg].l1.current_data = 0;



      c[seg].l2.first = (4294967295U);
      c[seg].l2.last = (4294967295U);
      c[seg].l2.next = (4294967295U);
      c[seg].l2.start_offset = c[seg].l1.size;
      c[seg].l2.size = data_size - c[seg].l1.size;
      c[seg].l2.current_data = c[seg].l2.start_offset;

      c[seg].data = secure_aligned_alloc(pool, (apr_size_t)data_size, 0);
      c[seg].data_used = 0;
      ...
      if (c[seg].data == ((void*)0) || c[seg].directory == ((void*)0))
        {


          return svn_error_wrap_apr(12, "OOM");
        }
      ...
      if (thread_safe)
        {
          ...
          if (status)
            return svn_error_wrap_apr(status, dcgettext ("subversion", "Can't create cache mutex", 5));
        }
      ...
      do { svn_error_t *svn_err__temp = (svn_mutex__init(&c[seg].counter_mutex, thread_safe, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
entry_exists_internal(svn_membuffer_t *cache,
                      ...
                      svn_boolean_t *found)
{
  *found = find_entry(cache, group_index, to_find, 0) != ((void*)0);
  return 0;
}
...
entry_exists(svn_membuffer_t *cache,
             ...
             svn_boolean_t *found)
{
  do { do { svn_error_t *svn_err__temp = (read_lock_cache(cache)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (unlock_cache(cache, (entry_exists_internal(cache, group_index, to_find, found)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 1881 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                             ...
                             apr_pool_t *scratch_pool)
{
  ...
  entry_t *entry = find_entry(cache, group_index, to_find, 0);



  if (entry && (((entry->size) + 16 -1) & -16) >= size && buffer)
    {
...
# 1917 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
  ...
  level = buffer ? select_level(cache, size, priority) : ((void*)0);
  if (level)
    {
      ...
      entry = find_entry(cache, group_index, to_find, (!0));
      entry->size = (apr_uint32_t) size;
      entry->offset = level->current_data;
      entry->priority = priority;
# 1949 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1981 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  if (item)
    do { svn_error_t *svn_err__temp = (serializer(&buffer, &size, item, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_boolean_t got_lock = (!0); do { svn_error_t *svn_err__temp = (write_lock_cache(cache, &got_lock)); if (svn_err__temp) return (svn_err__temp); } while (0); if (!got_lock) { svn_boolean_t exists; do { svn_error_t *svn_err__temp = (entry_exists(cache, group_index, key, &exists)); if (svn_err__temp) return (svn_err__temp); } while (0); if (exists) do { svn_error_t *svn_err__temp = (force_write_lock_cache(cache)); if (svn_err__temp) return (svn_err__temp); } while (0); else break; } do { svn_error_t *svn_err__temp = (unlock_cache(cache, (membuffer_cache_set_internal(cache, key, group_index, buffer, size, priority, scratch_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 2014 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 2045 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                             ...
                             apr_pool_t *result_pool)
{
  ...
  size = (((entry->size) + 16 -1) & -16);
  *buffer = ((void*)((((apr_size_t)(char*)(apr_palloc(result_pool, size + 16 -1))) + 16 -1) & -16));
  memcpy(*buffer, (const char*)cache->data + entry->offset, size);
# 2092 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  do { svn_mutex__t *svn_mutex__m = (cache->counter_mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (increment_hit_counters(cache, entry)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                    ...
                    apr_pool_t *result_pool)
{
  ...
  group_index = get_group_index(&cache, key);
  do { do { svn_error_t *svn_err__temp = (read_lock_cache(cache)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (unlock_cache(cache, (membuffer_cache_get_internal(cache, group_index, key, &buffer, &size, result_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 2130 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  if (buffer == ((void*)0))
    {
      *item = ((void*)0);
      return 0;
                        ...
                        svn_boolean_t *found)
{
  ...
  do { do { svn_error_t *svn_err__temp = (read_lock_cache(cache)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (unlock_cache(cache, (membuffer_cache_has_key_internal(cache, group_index, key, found)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 2205 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      do { svn_mutex__t *svn_mutex__m = (cache->counter_mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (increment_hit_counters(cache, entry)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 2250 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
                            ...
                            apr_pool_t *result_pool)
{
  ...
  do { do { svn_error_t *svn_err__temp = (read_lock_cache(cache)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (unlock_cache(cache, (membuffer_cache_get_partial_internal (cache, group_index, key, item, found, deserializer, baton, result_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 2295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->total_writes++;
# 2341 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 2386 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
        }
    }
                            ...
                            apr_pool_t *scratch_pool)
{
  ...
  apr_uint32_t group_index = get_group_index(&cache, key);
  do { svn_boolean_t got_lock = (!0); do { svn_error_t *svn_err__temp = (write_lock_cache(cache, &got_lock)); if (svn_err__temp) return (svn_err__temp); } while (0); if (!got_lock) { svn_boolean_t exists; do { svn_error_t *svn_err__temp = (entry_exists(cache, group_index, key, &exists)); if (svn_err__temp) return (svn_err__temp); } while (0); if (exists) do { svn_error_t *svn_err__temp = (force_write_lock_cache(cache)); if (svn_err__temp) return (svn_err__temp); } while (0); else break; } do { svn_error_t *svn_err__temp = (unlock_cache(cache, (membuffer_cache_set_partial_internal (cache, group_index, key, func, baton, scratch_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 2436 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 2517 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void
combine_long_key(svn_membuffer_cache_t *cache,
                 const void *key,
                 apr_ssize_t key_len)
{
  ((cache->last_access) ? (void) (0) : __assert_fail ("cache->last_access", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 2522, __PRETTY_FUNCTION__));
            ...
            apr_ssize_t key_len)
{
  ...
  data[0] ^= data[1] & 0xffffffffffff0000UL;
                        ...
                        apr_pool_t *result_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_get(cache->membuffer, cache->combined_key, value_p, cache->deserializer, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                            ...
                            apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_has_key(cache->membuffer, cache->combined_key, found)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *scratch_pool)
{
  return svn_error_create(SVN_ERR_UNSUPPORTED_FEATURE, ((void*)0),
                          dcgettext ("subversion", "Can't iterate a membuffer-based cache", 5));
}
                                ...
                                apr_pool_t *result_pool)
{
  ...
  combine_key(cache, key, cache->key_len);
  do { svn_error_t *svn_err__temp = (membuffer_cache_get_partial(cache->membuffer, cache->combined_key, value_p, found, func, baton, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 2786 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
                                ...
                                apr_pool_t *scratch_pool)
{
  ...
  if (key != ((void*)0))
    {
      combine_key(cache, key, cache->key_len);
      do { svn_error_t *svn_err__temp = (membuffer_cache_set_partial(cache->membuffer, cache->combined_key, func, baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_membuffer_cache_is_cachable(void *cache_void, apr_size_t size)
{
  ...
  svn_membuffer_cache_t *cache = cache_void;
  return cache->priority >= 1000
       ? cache->membuffer->l2.size >= size && ((apr_uint32_t)(0 - 16)) >= size
                               ...
                               svn_boolean_t include_histogram)
{
  ...
  info->total_size += segment->l1.size + segment->l2.size +
      segment->group_count * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) * sizeof(entry_t);

  info->used_entries += segment->used_entries;
  info->total_entries += segment->group_count * ((512 - sizeof(group_header_t)) / sizeof(entry_t));
    ...
    for (i = 0; i < segment->group_count; ++i)
      {
        ...
        apr_size_t use
          = ((chain_end->header.used) < (sizeof(info->histogram) / sizeof(info->histogram[0]) - 1) ? (chain_end->header.used) : (sizeof(info->histogram) / sizeof(info->histogram[0]) - 1));
  ...
  for (i = 0; i < cache->membuffer->segment_count; ++i)
    {
      ...
      do { do { svn_error_t *svn_err__temp = (read_lock_cache(segment)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (unlock_cache(segment, (svn_membuffer_get_segment_info(segment, info, 0)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  svn_membuffer_cache_t *cache = cache_void;
  do { svn_mutex__t *svn_mutex__m = (cache->mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (svn_membuffer_cache_get(value_p, found, cache_void, key, result_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  svn_membuffer_cache_t *cache = cache_void;
  do { svn_mutex__t *svn_mutex__m = (cache->mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (svn_membuffer_cache_has_key(found, cache_void, key, result_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  svn_membuffer_cache_t *cache = cache_void;
  do { svn_mutex__t *svn_mutex__m = (cache->mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (svn_membuffer_cache_set(cache_void, key, value, scratch_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  svn_membuffer_cache_t *cache = cache_void;
  do { svn_mutex__t *svn_mutex__m = (cache->mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (svn_membuffer_cache_get_partial(value_p, found, cache_void, key, func, baton, result_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 2982 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
{
  svn_membuffer_cache_t *cache = cache_void;
  do { svn_mutex__t *svn_mutex__m = (cache->mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (svn_membuffer_cache_set_partial(cache_void, key, func, baton, scratch_pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                  ...
                                  apr_pool_t *pool)
{
  ...
  svn_cache__t *wrapper = memset(apr_palloc(pool, sizeof(*wrapper)), 0, sizeof(*wrapper));
  ...
  do { svn_error_t *svn_err__temp = (svn_mutex__init(&cache->mutex, thread_safe, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_checksum(&checksum, svn_checksum_md5, prefix, strlen(prefix), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ((klen == (-1)) || klen > sizeof(entry_key_t))
    {
      cache->last_access = memset(apr_palloc(pool, sizeof(*cache->last_access)), 0, sizeof(*cache->last_access));
      cache->last_access->key_len = (-1);
    }
  else
    {
      cache->last_access = ((void*)0);
    }
# 3122 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
svn_cache__membuffer_get_global_info(apr_pool_t *pool)
{
  ...
  svn_cache__info_t *info = memset(apr_palloc(pool, sizeof(*info)), 0, sizeof(*info));
