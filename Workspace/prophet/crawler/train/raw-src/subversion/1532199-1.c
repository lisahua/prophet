# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
svn_cmdline_setup_auth_baton(svn_auth_baton_t **ab,
                             ...
                             void *cancel_baton,
                             apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
svn_client_resolve(const char *path,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 4367 "./subversion/include/svn_client.h"
...
svn_client_copy(svn_client_commit_info_t **commit_info_p,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 4635 "./subversion/include/svn_client.h"
svn_error_t *
...
# 6080 "./subversion/include/svn_client.h"
typedef svn_error_t *(*svn_info_receiver_t)(
  void *baton,
  const char *path,
  const svn_info_t *info,
  apr_pool_t *pool);
# 6094 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_info_t *
...
typedef svn_error_t *(*svn_client_info_receiver2_t)(
                         ...
                         apr_pool_t *scratch_pool);
# 6221 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_get_wc_root(const char **wcroot_abspath,
                       ...
                       apr_pool_t *result_pool,
                       apr_pool_t *scratch_pool);
# 6294 "./subversion/include/svn_client.h"
svn_error_t *
...
typedef svn_error_t *(*svn_client_patch_func_t)(
  ...
  apr_pool_t *scratch_pool);
# 6387 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_url_from_path(const char **url,
                         const char *path_or_url,
                         apr_pool_t *pool);
# 6464 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_root_url_from_path(const char **url,
                              ...
                              svn_client_ctx_t *ctx,
                              apr_pool_t *pool);
# 6498 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
# 141 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/cl.h"
svn_error_t *
...
# 159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/cl.h"
svn_error_t *
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
...
svn_client__mergeinfo_log(svn_boolean_t finding_merged,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c" 2
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-info-cmd.c"
static svn_error_t *
              ...
              apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_get_dir2(ra_session, &tmpdirents, ((void*)0), ((void*)0), dir, pathrev->rev, (0x00001 | 0x00008 | 0x00010 | 0x00020), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(pool, tmpdirents); hi; hi = apr_hash_next(hi))
    {
      ...
      if (depth == svn_depth_infinity && the_ent->kind == svn_node_dir)
        do { svn_error_t *svn_err__temp = (push_dir_info(ra_session, child_pathrev, path, counter, depth, ctx, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_client__ra_session_from_path2(&ra_session, &pathrev, abspath_or_url, ((void*)0), peg_revision, revision, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_stat(ra_session, "", pathrev->rev, &the_ent, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (depth > svn_depth_empty && (the_ent->kind == svn_node_dir))
    {
      ...
      do { svn_error_t *svn_err__temp = (push_dir_info(ra_session, pathrev, "", counter, depth, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (err)
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Number of status notifications " "received: %d\n", 5), received_count)); if (svn_err__temp) return (svn_err__temp); } while (0);
