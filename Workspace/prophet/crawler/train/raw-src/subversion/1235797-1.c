...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/ssl_server_trust_providers.c" 2
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/ssl_server_trust_providers.c"
static svn_error_t *
  ...
  if (! error && creds_hash)
    {
      ...
      trusted_cert = apr_hash_get(creds_hash, "ascii_cert",
                                  (-1));
      this_cert = svn_string_create(cert_info->ascii_cert, pool);
      failstr = apr_hash_get(creds_hash, "failures",
                             (-1));
                                       ...
                                       apr_pool_t *pool)
{
  ...
  apr_hash_set(creds_hash, "ascii_cert", (-1),
               svn_string_create(cert_info->ascii_cert, pool));
  apr_hash_set(creds_hash, "failures", (-1),
...
# 185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/ssl_server_trust_providers.c"
                                   ...
                                   apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (pb->prompt_func((svn_auth_cred_ssl_server_trust_t **) credentials_p, pb->prompt_baton, realmstring, *failures, cert_info, ! no_auth_cache && ! (*failures & 0x40000000), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
