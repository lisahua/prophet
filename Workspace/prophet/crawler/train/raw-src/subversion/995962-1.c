                      ...
                      int base)
{
  ...
  if (endptr == str || str[0] == '\0' || *endptr != '\0')
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/svn_string.c",629), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Could not convert '%s' into a number", 5), str));
  ...
  if (((*__errno_location ()) == 34 && (val == (-9223372036854775807L -1) || val == (9223372036854775807L))) ||
    ...
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/svn_string.c",635), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Number '%s' is out of range '[%lu, %lu]'", 5), str, minval, maxval));
                     ...
                     int base)
{
  ...
  val = apr_strtoi64(str, &endptr, base);
  if (endptr == str || str[0] == '\0' || *endptr != '\0')
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/svn_string.c",673), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Could not convert '%s' into a number", 5), str));



  if (((*__errno_location ()) == 34 && (val == (-9223372036854775807L -1) || val == (9223372036854775807L))) ||
      val < minval || val > maxval)
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/svn_string.c",679), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Number '%s' is out of range '[%ld, %ld]'", 5), str, minval, maxval));
