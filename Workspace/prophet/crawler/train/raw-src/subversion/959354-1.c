...
svn_wc__db_repos_ensure(apr_int64_t *repos_id,
                        ...
                        const char *repos_uuid,
                        apr_pool_t *scratch_pool);
# 1053 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_op_copy(svn_wc__db_t *db,
                   ...
                   const svn_skel_t *work_items,
                   apr_pool_t *scratch_pool);
# 1068 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_set_props(svn_wc__db_t *db,
                        ...
                        const svn_skel_t *work_items,
                        apr_pool_t *scratch_pool);
# 1195 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_set_tree_conflict(svn_wc__db_t *db,
                                ...
                                const svn_wc_conflict_description2_t *tree_conflict,
                                apr_pool_t *scratch_pool);
# 1477 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_read_conflicts(const apr_array_header_t **conflicts,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 1630 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_is_wcroot(svn_boolean_t *is_root,
                     ...
                     const char *local_abspath,
                     apr_pool_t *scratch_pool);
# 1694 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_global_commit(svn_wc__db_t *db,
                         ...
                         const svn_skel_t *work_items,
                         apr_pool_t *scratch_pool);
# 1765 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_global_update(svn_wc__db_t *db,
                         ...
                         const svn_skel_t *work_items,
                         apr_pool_t *scratch_pool);
# 1796 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_scan_deletion(const char **base_del_abspath,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2049 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_wclock_remove(svn_wc__db_t *db,
                         const char *local_abspath,
                         apr_pool_t *scratch_pool);
# 2201 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_temp_get_all_access(svn_wc__db_t *db,
                               apr_pool_t *result_pool);
# 2331 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_temp_op_set_rev_and_repos_relpath(svn_wc__db_t *db,
                                             ...
                                             apr_pool_t *scratch_pool);
# 2503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
# 514 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  if (entry->repos == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",527), (svn_error_createf))(
  ...
  if (entry->uuid == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",534), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
   ...
   if (entry->url == ((void*)0))
     return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",541), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 814 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
...
migrate_props(const char *wcroot_abspath,
              ...
              apr_pool_t *scratch_pool)
{
# 970 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  const apr_array_header_t *children;
  apr_pool_t *iterpool = svn_pool_create_ex(scratch_pool, ((void*)0));
  int i;
  ...
  for (hi = apr_hash_first(scratch_pool, dirents); hi;
            hi = apr_hash_next(hi))
    {
      ...
      text_base_path = svn_dirent_join(text_base_dir, text_base_basename,
                                       iterpool);
# 1061 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
...
# 1131 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (logfile_on_disk == svn_node_file)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1154), (svn_error_create))(SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 1181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  do { svn_error_t *svn_err__temp = (svn_wc__read_entries_old(&entries, dir_abspath, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  this_dir = apr_hash_get(entries, "", (-1));
  do { svn_error_t *svn_err__temp = (ensure_repos_info(this_dir, dir_abspath, repos_info_func, repos_info_baton, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1238 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
...
{
  if (start_format < 12 )
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1266), (svn_error_createf))(SVN_ERR_WC_UPGRADE_REQUIRED, ((void*)0),
...
# 1295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
      ...
      case 13:
        ...
        do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_14, (void *)wcroot_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      case 14:
        ...
        do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_15, (void *)wcroot_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      case 15:
        ...
        do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_16, (void *)wcroot_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


        *result_format = 16;
# 1373 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
    }
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  if (old_format < 12)
    do { svn_error_t *svn_err__temp = (upgrade_to_wcng(db, dir_abspath, old_format, repos_info_func, repos_info_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < subdirs->nelts; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (upgrade_working_copy(db, child_abspath, repos_info_func, repos_info_baton, cancel_func, cancel_baton, notify_func, notify_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1474 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  do { svn_error_t *svn_err__temp = (upgrade_working_copy(db, local_abspath, repos_info_func, repos_info_baton, cancel_func, cancel_baton, notify_func, notify_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
