...
# 87 "./subversion/include/private/svn_subr_private.h"
...
svn_spillbuf__create(apr_size_t blocksize,
                     apr_size_t maxsize,
                     apr_pool_t *result_pool);
# 104 "./subversion/include/private/svn_subr_private.h"
svn_boolean_t
...
svn_spillbuf__process(svn_boolean_t *exhausted,
                      ...
                      void *read_baton,
                      apr_pool_t *scratch_pool);
# 157 "./subversion/include/private/svn_subr_private.h"
...
svn_spillbuf__is_empty(const svn_spillbuf_t *buf)
{
  return buf->head == ((void*)0) && buf->spill == ((void*)0);
}
          ...
          apr_pool_t *scratch_pool)
{
  ...
  *mem = get_buffer(buf);
  ...
  err = svn_io_file_read(buf->spill, (*mem)->data, &(*mem)->size,
                         scratch_pool);
  if (err != ((void*)0) && ((err->apr_err) == ((20000 + 50000) + 14)))
    {
