# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c"
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
# 5300 "./subversion/include/svn_client.h"
...
svn_info_dup(const svn_info_t *info,
             apr_pool_t *pool);
# 5358 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_url_from_path(const char **url,
                         const char *path_or_url,
                         apr_pool_t *pool);
# 5559 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_root_url_from_path(const char **url,
                              const char *path_or_url,
                              svn_client_ctx_t *ctx,
                              apr_pool_t *pool);
# 5576 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
# 510 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
svn_client__checkout_internal(svn_revnum_t *result_rev,
                              ...
                              svn_client_ctx_t *ctx,
                              apr_pool_t *pool);
# 550 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__get_diff_editor(const svn_delta_editor_t **editor,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 631 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
...
# 736 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
...
typedef svn_error_t *(*svn_client__check_url_kind_t)(void *baton,
                                                     ...
                                                     svn_revnum_t revision,
                                                     apr_pool_t *scratch_pool);
# 801 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__crawl_for_externals(apr_hash_t **externals_p,
                                ...
                                apr_pool_t *result_pool,
                                apr_pool_t *scratch_pool);
# 995 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
svn_client__create_status(svn_client_status_t **cst,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
svn_wc__get_info(svn_wc_context_t *wc_ctx,
                 ...
                 void *cancel_baton,
                 apr_pool_t *scratch_pool);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c" 2
                  ...
                  apr_pool_t *pool)
{
  ...
  if (status->node_status == svn_wc_status_obstructed)
    return svn_error_createf(SVN_ERR_NODE_UNEXPECTED_KIND, ((void*)0),
                             dcgettext ("subversion", "'%s' is in the way of the resource " "actually under version control", 5),
    ...
    return svn_error_createf(SVN_ERR_CLIENT_MODIFIED, ((void*)0),
                             dcgettext ("subversion", "'%s' has local modifications -- commit or " "revert them first", 5),
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__read_external_info(&external_kind, &defining_abspath, ((void*)0), ((void*)0), ((void*)0), ctx->wc_ctx, local_abspath, local_abspath, (!0), scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (external_kind != svn_node_none)
    return svn_error_createf(SVN_ERR_WC_CANNOT_DELETE_FILE_EXTERNAL, ((void*)0),
                             dcgettext ("subversion", "Cannot remove the external at '%s'; " "please edit or delete the svn:externals " "property on '%s'", 5),
  ...
  return (svn_client_status5(((void*)0), ctx, path, &revision, svn_depth_infinity, 0, 0, 0, 0, 0, ((void*)0), find_undeletables, ((void*)0), scratch_pool));
                    ...
                    apr_pool_t *pool)
{
  ...
  *dir_baton = ((void*)0);
  return editor->delete_entry(path, ((svn_revnum_t) -1), parent_baton, pool);
}
                    ...
                    apr_pool_t *pool)
{
  ...
  if (((ctx)->log_msg_func3 || (ctx)->log_msg_func2 || (ctx)->log_msg_func))
    {
      ...
      for (i = 0; i < relpaths->nelts; i++)
        {
          const char *relpath = (((const char * *)(relpaths)->elts)[i]);
  ...
  if (err)
    {
      return (svn_error_compose_create(err, editor->abort_edit(edit_baton, pool)));
                        ...
                        apr_pool_t *pool)
{
  ...
  for (i = 0; i < uris->nelts; i++)
    {
      const char *uri = (((const char * *)(uris)->elts)[i]);
      svn_ra_session_t *ra_session = ((void*)0);
      const char *repos_root = ((void*)0);
          ...
          if (repos_relpath)
            {
              ...
              (*((const char * *)apr_array_push(relpaths_list))) = repos_relpath;
              break;
            }
        }
      ...
      if (!ra_session)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_client__open_ra_session_internal(&ra_session, ((void*)0), uri, ((void*)0), ((void*)0), 0, (!0), ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          do { svn_error_t *svn_err__temp = (svn_ra_reparent(ra_session, repos_root, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          apr_hash_set(sessions, repos_root, (-1), ra_session);
          repos_relpath = svn_uri_is_child(repos_root, uri, pool);

          relpaths_list = apr_array_make(pool, 1, sizeof(const char *));
          apr_hash_set(relpaths, repos_root, (-1),
                       relpaths_list);
          (*((const char * *)apr_array_push(relpaths_list))) = repos_relpath;
        }


      do { svn_error_t *svn_err__temp = (svn_ra_check_path(ra_session, repos_relpath, ((svn_revnum_t) -1), &kind, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(pool, sessions); hi; hi = apr_hash_next(hi))
    {
      ...
      const apr_array_header_t *relpaths_list =
        apr_hash_get(relpaths, repos_root, (-1));

      do { svn_error_t *svn_err__temp = (single_repos_delete(ra_session, repos_root, relpaths_list, revprop_table, commit_callback, commit_baton, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                      ...
                      apr_pool_t *pool)
{
  ...
  if (!force && !keep_local)
    ...
    do { svn_error_t *svn_err__temp = (svn_client__can_delete(local_abspath, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (!dry_run)

    return (svn_wc_delete4(ctx->wc_ctx, local_abspath, keep_local, (!0), ctx->cancel_func, ctx->cancel_baton, notify_func, notify_baton, pool));
                   ...
                   apr_pool_t *pool)
{
  ...
  is_url = svn_path_is_url((((const char * *)(paths)->elts)[0]));

  if (is_url)
    {
      do { svn_error_t *svn_err__temp = (delete_urls_multi_repos(paths, revprop_table, commit_callback, commit_baton, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (i = 0; i < paths->nelts; i++)
        {
          ...
          dwwlb.ctx = ctx;
          do { svn_error_t *svn_err__temp = (svn_wc__call_with_write_lock(delete_with_write_lock_func, &dwwlb, ctx->wc_ctx, local_abspath, (!0), pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
