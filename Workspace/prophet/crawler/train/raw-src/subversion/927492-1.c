...
{
  do { if (!(stream->read_fn != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 152, "stream->read_fn != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  do { if (!(stream->write_fn != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 160, "stream->write_fn != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_stream_reset(svn_stream_t *stream)
{
  if (stream->reset_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c",169), (svn_error_create))(SVN_ERR_STREAM_RESET_NOT_SUPPORTED, ((void*)0), ((void*)0));
                ...
                apr_pool_t *pool)
{
  if (stream->mark_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c",179), (svn_error_create))(SVN_ERR_STREAM_SEEK_NOT_SUPPORTED, ((void*)0), ((void*)0));
...
svn_stream_seek(svn_stream_t *stream, svn_stream_mark_t *mark)
{
  if (stream->seek_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c",188), (svn_error_create))(SVN_ERR_STREAM_SEEK_NOT_SUPPORTED, ((void*)0), ((void*)0));
                 ...
                 const char *line, apr_pool_t *pool, apr_pool_t *scratch_pool)
{
  *buf = ((void*)0);
  ...
  do { if (!(*buf)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 278, "*buf")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 907 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
struct zbaton {
  z_stream *in;
  z_stream *out;
  svn_read_fn_t read;
...
zerr_to_svn_error(int zerr, const char *function, z_stream *stream)
{
  ...
  if (stream->msg != ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c",984), (svn_error_createf))(status, ((void*)0), "zlib (%s): %s: %s", function,
                             message, stream->msg);
  else
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c",987), (svn_error_createf))(status, ((void*)0), "zlib (%s): %s", function,
                             message);
}
...
svn_stream_compressed(svn_stream_t *stream, apr_pool_t *pool)
{
  ...
  ((stream != ((void*)0)) ? (void) (0) : __assert_fail ("stream != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 1164, __PRETTY_FUNCTION__));
...
svn_stream_for_stdout(svn_stream_t **out, apr_pool_t *pool)
{
  ...
  if (apr_err)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c",1503), (svn_error_wrap_apr))(apr_err, "Can't open stdout");
