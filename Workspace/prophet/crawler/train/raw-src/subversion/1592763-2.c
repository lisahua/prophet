# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c"
# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_portable.h" 1
# 28 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_portable.h"
...
# 29 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_portable.h" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c" 2
...
svn_atomic__init_once(volatile apr_uint32_t *global_status,
                      ...
                      void *baton,
                      apr_pool_t* pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c" 2
...
svn_mutex__unlock(svn_mutex__t *mutex,
                  svn_error_t *err);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c" 2
...
struct svn_mutex__t
{
  ...
  apr_thread_mutex_t *mutex;
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c"
  volatile void *owner;
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c"
};
                ...
                apr_pool_t *result_pool)
{
  ...
  *mutex_p = ((void*)0);
  ...
  if (mutex_required)
    {
      svn_mutex__t *mutex = memset(apr_palloc(result_pool, sizeof(*mutex)), 0, sizeof(*mutex));
      ...
      apr_status_t status =
          apr_thread_mutex_create(&mutex->mutex,
                                  ...
                                  result_pool);
      if (status)
        return svn_error_wrap_apr(status, dcgettext ("subversion", "Can't create mutex", 5));
  ...
  if (mutex)
    {
      ...
      if (mutex->checked)
        {
          ...
          lock_owner = apr_atomic_casptr(&mutex->owner, ((void*)0), ((void*)0));
          ...
          if (lock_owner &&
            ...
            return svn_error_create(SVN_ERR_RECURSIVE_LOCK, ((void*)0),
                                    dcgettext ("subversion", "Recursive locks are not supported", 5));
        }
      ...
      if (status)
        return svn_error_wrap_apr(status, dcgettext ("subversion", "Can't lock mutex", 5));
      ...
      if (mutex->checked)
        {
          ...
          do { if (!(apr_atomic_casptr(&mutex->owner, ((void*)0), ((void*)0)) == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c", 142, "apr_atomic_casptr(&mutex->owner, NULL, NULL) == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


          apr_atomic_casptr(&mutex->owner, current_thread, ((void*)0));
        }
# 160 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/mutex.c"
    }
      ...
      if (mutex->checked)
        {
          ...
          void *lock_owner = apr_atomic_casptr(&mutex->owner, ((void*)0), ((void*)0));


          apr_atomic_casptr(&mutex->owner, ((void*)0), lock_owner);
        }


      status = apr_thread_mutex_unlock(mutex->mutex);
      if (status && !err)
        return svn_error_wrap_apr(status, dcgettext ("subversion", "Can't unlock mutex", 5));
