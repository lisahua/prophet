...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
...
# 88 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
...
encode_int(unsigned char *p, svn_filesize_t val)
{
  ...
  do { if (!(val >= 0)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 95, "val >= 0"); abort(); } } while (0);
  ...
  do { if (!(n <= 10)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 106, "n <= MAX_ENCODED_INT_LEN"); abort(); } } while (0);
...
# 213 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
...
# 373 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
              ...
              unsigned int version)
{
  ...
  do { if (!(data == insend)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 667, "data == insend")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 720 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
  while (1)
    {
      apr_pool_t *newpool;
