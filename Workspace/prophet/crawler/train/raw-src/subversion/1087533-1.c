...
char * apr_strerror(apr_status_t statcode, char *buf,
                                 apr_size_t bufsize);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
svn_dso_load(apr_dso_handle_t **dso,
             const char *libname);
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
svn_utf__cstring_from_utf8_fuzzy(const char *src,
                                 ...
                                 svn_error_t *(*convert_from_utf8)
                                              (const char **,
                                               const char *,
                                               apr_pool_t *));
# 60 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
  if (!setlocale(6, "")
      && !setlocale(0, ""))
    {
      if (error_stream)
...
svn_cmdline_printf(apr_pool_t *pool, const char *fmt, ...)
{
  const char *message;
  va_list ap;
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
  ...
  if (fputs(out, stream) == (-1))
    {
      if (((*__errno_location ())))
        ...
        return svn_error_create
          (SVN_ERR_IO_WRITE_ERROR, ((void*)0), ((void*)0));
    }
...
# 420 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
static svn_error_t *
