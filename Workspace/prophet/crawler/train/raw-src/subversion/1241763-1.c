...
struct svn_editor_t
{
  ...
  apr_pool_t *scratch_pool;
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
};
# 184 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
svn_error_t *
svn_editor_create(svn_editor_t **editor,
                  void *editor_baton,
                  svn_cancel_func_t cancel_func,
...
# 206 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  return 0;
}
                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  if (many->cb_alter_directory) editor->funcs.cb_alter_directory = many->cb_alter_directory;
  if (many->cb_alter_file) editor->funcs.cb_alter_file = many->cb_alter_file;
  if (many->cb_alter_symlink) editor->funcs.cb_alter_symlink = many->cb_alter_symlink;
  ...
  if (many->cb_rotate) editor->funcs.cb_rotate = many->cb_rotate;
                         ...
                         svn_revnum_t replaces_rev)
{
  ...
  do { if (!(children != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 376, "children != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 377, "props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                   ;
                                      ;
  ...
  if (editor->funcs.cb_add_directory)
    err = editor->funcs.cb_add_directory(editor->baton, relpath, children,
                                 ...
                                 ;
                                   ;
# 408 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
                    ...
                    svn_revnum_t replaces_rev)
{
  ...
  do { if (!(checksum != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 423, "checksum != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(contents != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 424, "contents != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 425, "props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                   ;
                                      ;
                       ...
                       svn_revnum_t replaces_rev)
{
  ...
  do { if (!(props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 455, "props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                   ;
                                      ;
                           ...
                           apr_hash_t *props)
{
  ...
  do { if (!(props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 510, "props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                     ;
                      ...
                      svn_stream_t *contents)
{
  ...
  do { if (!((checksum != ((void*)0) && contents != ((void*)0)) || (checksum == ((void*)0) && contents == ((void*)0)))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 540, "(checksum != NULL && contents != NULL) || (checksum == NULL && contents == NULL)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { if (!(props != ((void*)0) || checksum != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 541, "props != NULL || checksum != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                     ;
                         ...
                         const char *target)
{
  ...
  do { if (!(props != ((void*)0) || target != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 570, "props != NULL || target != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                     ;
                  ...
                  const apr_array_header_t *revisions)
{
  svn_error_t *err = 0;
                                ...
                                ;
# 689 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  if (editor->cancel_func)
    do { svn_error_t *svn_err__temp = (editor->cancel_func(editor->cancel_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (editor->funcs.cb_rotate)
    err = editor->funcs.cb_rotate(editor->baton, relpaths, revisions,
                                  editor->scratch_pool);
# 707 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  apr_pool_clear(editor->scratch_pool);
  return err;
}
