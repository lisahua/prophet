...
svn_client__do_commit(const char *base_url,
                      ...
                      svn_client_ctx_t *ctx,
                      apr_pool_t *pool);
# 980 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
svn_client__handle_externals(apr_hash_t *externals_old,
                             ...
                             svn_client_ctx_t *ctx,
                             apr_pool_t *pool);
# 1011 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
                       ...
                       apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__node_is_file_external(&file_external, ctx->wc_ctx, local_abspath, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  return (svn_client_status5(((void*)0), path, &revision, find_undeletables, ((void*)0), svn_depth_infinity, 0, 0, 0, 0, ((void*)0), ctx, pool));
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (! ra_session)
        {
          do { svn_error_t *svn_err__temp = (svn_client__open_ra_session_internal(&ra_session, item_url, ((void*)0), ((void*)0), 0, (!0), ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (kind == svn_node_none)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/delete.c",229), (svn_error_createf))(SVN_ERR_FS_NOT_FOUND, ((void*)0),
                   ...
                   apr_pool_t *pool)
{
  ...
  if (svn_path_is_url((((const char * *)(paths)->elts)[0])))
    {
      do { svn_error_t *svn_err__temp = (delete_urls(commit_info_p, paths, revprop_table, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
    {
      apr_pool_t *subpool = svn_pool_create_ex(pool, ((void*)0));
      ...
      for (i = 0; i < paths->nelts; i++)
        {
          ...
          dwwlb.ctx = ctx;
          do { svn_error_t *svn_err__temp = (svn_wc__call_with_write_lock(delete_with_write_lock_func, &dwwlb, ctx->wc_ctx, local_abspath, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
