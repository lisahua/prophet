                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  if (smode != svn_sqlite__mode_rwcreate)
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_open(&f, sdb_abspath, (0x00001 | 0x00002 | 0x00004), 0x0FFF, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_io_file_close(f, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db_util.c"
