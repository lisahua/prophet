...
svn_opt_print_help(apr_getopt_t *os,
                   ...
                   const char *footer,
                   apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/util.c" 2
...
svn_client__youngest_common_ancestor(const char **ancestor_url,
                                     ...
                                     apr_pool_t *result_pool,
                                     apr_pool_t *scratch_pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/util.c" 2
  ...
  if (! svn_path_is_url(abspath_or_url))
    {
      ...
      do { if (!(repos_relpath != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/util.c", 103, "repos_relpath != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
    }
  ...
  else
    {
      ...
      do { if (!(ra_session != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/util.c", 119, "ra_session != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
