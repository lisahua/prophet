# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c" 2

# 1 "./subversion/include/private/svn_subr_private.h" 1
# 27 "./subversion/include/private/svn_subr_private.h"
...
# 28 "./subversion/include/private/svn_subr_private.h" 2
...
svn_config__shallow_replace_section(svn_config_t *target,
                                    svn_config_t *source,
                                    const char *section);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.h"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c" 2
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c"
static apr_uint32_t
                    ...
                    apr_size_t len)
{
  ...
  apr_size_t i;
  ((len < SCALING) ? (void) (0) : __assert_fail ("len < SCALING", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/fnv1a.c", 101, __PRETTY_FUNCTION__));

  for (i = 0; i < SCALING; ++i)
    hashes[i] = (__extension__ ({ unsigned int __v, __x = (hashes[i]); if (__builtin_constant_p (__x)) __v = ((((__x) & 0xff000000) >> 24) | (((__x) & 0x00ff0000) >> 8) | (((__x) & 0x0000ff00) << 8) | (((__x) & 0x000000ff) << 24)); else __asm__ ("bswap %0" : "=r" (__v) : "0" (__x)); __v; }));
...
svn__fnv1a_32(const void *input, apr_size_t len)
{
  return fnv1a_32(2166136261U, input, len);
}
...
svn_fnv1a_32__finalize(svn_fnv1a_32__context_t *context)
{
  return (__extension__ ({ unsigned int __v, __x = (context->hash); if (__builtin_constant_p (__x)) __v = ((((__x) & 0xff000000) >> 24) | (((__x) & 0x00ff0000) >> 8) | (((__x) & 0x0000ff00) << 8) | (((__x) & 0x000000ff) << 24)); else __asm__ ("bswap %0" : "=r" (__v) : "0" (__x)); __v; }));
}
...
svn_fnv1a_32x4__context_create(apr_pool_t *pool)
{
  ...
  context->hashes[0] = 2166136261U;
  context->hashes[1] = 2166136261U;
  context->hashes[2] = 2166136261U;
  context->hashes[3] = 2166136261U;
