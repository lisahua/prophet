...
# 85 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
...
# 129 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
static __inline__ svn_error_t *
...
# 321 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
static svn_error_t *
...
{
  *path_p = ((void*)0);
# 388 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
...
# 614 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "# password-stores =" "\n"
# 1048 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
        "###" "\n"
        ...
        "### Third-party clients may also support this option." "\n"
        "# exclusive-locking-clients =" "\n"
        "### Set to true to enable exclusive SQLite locking of working" "\n"
        "### copies by all clients.  Enabling this may cause some clients" "\n"
        "### to fail to work properly. This does not have to be set for" "\n"
        "### exclusive-locking-clients to work." "\n"
...
# 1248 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
  {
