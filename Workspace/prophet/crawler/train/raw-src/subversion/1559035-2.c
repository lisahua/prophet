...
# 848 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
      if (! opt_state->incremental)
...
# 872 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
      if (! opt_state->incremental)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "------------------------------------------------------------------------\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
