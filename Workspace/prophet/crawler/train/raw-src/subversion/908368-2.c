                            ...
                            apr_pool_t *pool)
{
  ...
  do { if (!(path)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/update.c", 128, "path")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  if (svn_path_is_url(path))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/update.c",131), (svn_error_createf))(SVN_ERR_WC_NOT_WORKING_COPY, ((void*)0),
  ...
  if (! anchor_url)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/update.c",168), (svn_error_createf))(SVN_ERR_ENTRY_MISSING_URL, ((void*)0),
...
# 264 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/update.c"
