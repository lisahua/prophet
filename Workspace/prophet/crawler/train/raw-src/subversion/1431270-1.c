...
# 74 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
...
# 75 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 76 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 78 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 79 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c" 2
...
svn_wc__conflict_skel_resolve(svn_boolean_t *completely_resolved,
                              ...
                              apr_pool_t *result_pool,
                              apr_pool_t *scratch_pool);
# 276 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h"
svn_error_t *
svn_wc__conflict_read_info(svn_wc_operation_t *operation,
                           ...
                           apr_pool_t *result_pool,
                           apr_pool_t *scratch_pool);
# 298 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h"
svn_error_t *
svn_wc__conflict_read_text_conflict(const char **mine_abspath,
                                    ...
                                    apr_pool_t *result_pool,
                                    apr_pool_t *scratch_pool);
# 317 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h"
svn_error_t *
svn_wc__conflict_read_prop_conflict(const char **marker_abspath,
                                    ...
                                    apr_pool_t *result_pool,
                                    apr_pool_t *scratch_pool);
# 338 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h"
svn_error_t *
...
svn_wc__conflict_read_markers(const apr_array_header_t **markers,
                              ...
                              apr_pool_t *result_pool,
                              apr_pool_t *scratch_pool);
# 370 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h"
svn_error_t *
svn_wc__conflict_create_markers(svn_skel_t **work_item,
                                ...
                                apr_pool_t *result_pool,
                                apr_pool_t *scratch_pool);
# 385 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/conflicts.h"
svn_error_t *
...
# 107 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
...
# 126 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
static svn_error_t *
...
# 188 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
...
# 223 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
  version = svn_wc_conflict_version_create2(b->old_version->repos_url,
                                            b->old_version->repos_uuid,
                                            relpath ,
                                            b->old_version->peg_rev,
...
# 340 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
  do { svn_error_t *svn_err__temp = (svn_wc__db_wq_add(b->db, b->wcroot->abspath, work_item, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *scratch_pool)
{
  ...
  do { if (!(expected_move_dst_revision == b->old_version->peg_rev)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c", 472, "expected_move_dst_revision == b->old_version->peg_rev")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(move_dst_revision == expected_move_dst_revision)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c", 487, "move_dst_revision == expected_move_dst_revision")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(move_dst_kind == svn_kind_dir)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c", 488, "move_dst_kind == svn_kind_dir")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 559 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
static svn_error_t *
...
# 630 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
  if (conflict_skel)
    {
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  do { if (!(move_dst_revision == expected_move_dst_revision)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c", 711, "move_dst_revision == expected_move_dst_revision")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(move_dst_kind == svn_kind_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c", 712, "move_dst_kind == svn_kind_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 880 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
static svn_error_t *
            ...
            apr_pool_t *scratch_pool)
{
  ...
  if (locations)
    {
      do { if (!(locations->nelts >= 2)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c", 919, "locations->nelts >= 2")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 1182 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
static svn_error_t *
...
# 1317 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c"
  return 0;
}
                                             ...
                                             apr_pool_t *scratch_pool)
{
  ...
  do { if (!((wcroot) != ((void*)0) && (wcroot)->format == 31)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_update_move.c", 1348, "(wcroot) != NULL && (wcroot)->format == SVN_WC__VERSION")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
