...
# 5148 "./subversion/include/svn_client.h"
...
typedef svn_error_t *(*svn_info_receiver2_t)(void *baton,
                                             ...
                                             apr_pool_t *scratch_pool);
# 5189 "./subversion/include/svn_client.h"
...
svn_client_info2(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 5283 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_patch(const char *patch_abspath,
                 ...
                 apr_pool_t *result_pool,
                 apr_pool_t *scratch_pool);
# 5422 "./subversion/include/svn_client.h"
svn_error_t *
      ...
      if (nb->in_external)
      ...
      else
        {
          svn_error_t *warn_err =
            (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c",541), (svn_error_createf))(SVN_ERR_BASE, ((void*)0),
