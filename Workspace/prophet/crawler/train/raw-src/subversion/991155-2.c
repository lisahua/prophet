...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
{
  void *new_area;
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c"
...
string_first_non_whitespace(const char *str, apr_size_t len)
{
  ...
  for (i = 0; i < len; i++)
    {
      if (! (((*__ctype_b_loc ())[(int) ((((unsigned char)(str[i]))))] & (unsigned short int) _ISspace)))
        return i;
    }
...
svn_stringbuf_strip_whitespace(svn_stringbuf_t *str)
{
  ...
  while ((str->len > 0) && (((*__ctype_b_loc ())[(int) ((((unsigned char)(str->data[str->len - 1]))))] & (unsigned short int) _ISspace)))
    str->len--;
  str->data[str->len] = '\0';
}
      ...
      if (chop_whitespace)
        {
          ...
          {
            char *e = p + (strlen(p) - 1);
            while ((e >= p) && ((((*__ctype_b_loc ())[(int) ((((unsigned char)(*e))))] & (unsigned short int) _ISspace))))
              e--;
            *(++e) = '\0';
          }
        }
