# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/ssl_server_trust_providers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/ssl_server_trust_providers.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/ssl_server_trust_providers.c"
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/ssl_server_trust_providers.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/ssl_server_trust_providers.c" 2
...
svn_auth_get_ssl_client_cert_pw_prompt_provider(
  ...
  int retry_limit,
  apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/ssl_server_trust_providers.c" 2
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/ssl_server_trust_providers.c"
static svn_error_t *
ssl_server_trust_file_first_credentials(void **credentials,
                                        ...
                                        apr_pool_t *pool)
{
  apr_uint32_t *failures = apr_hash_get(parameters, "svn:auth:" "ssl:failures", strlen("svn:auth:" "ssl:failures"));

  const svn_auth_ssl_server_cert_info_t *cert_info =
    apr_hash_get(parameters, "svn:auth:" "ssl:cert-info", strlen("svn:auth:" "ssl:cert-info"));
  ...
  *iter_baton = ((void*)0);
  ...
  config_dir = apr_hash_get(parameters, "svn:auth:" "config-dir", strlen("svn:auth:" "config-dir"));
  error =
    svn_config_read_auth_data(&creds_hash, "svn.ssl.server",
  ...
  if (! error && creds_hash)
    {
      ...
      trusted_cert = apr_hash_get(creds_hash, "ascii_cert", strlen("ascii_cert"));
      this_cert = svn_string_create(cert_info->ascii_cert, pool);
      failstr = apr_hash_get(creds_hash, "failures", strlen("failures"));

      if (failstr)
        do { svn_error_t *svn_err__temp = (svn_cstring_atoui(&last_failures, failstr->data)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! *failures)
    {
      svn_auth_cred_ssl_server_trust_t *creds =
        memset(apr_palloc(pool, sizeof(*creds)), 0, sizeof(*creds));
      creds->may_save = 0;
      *credentials = creds;
    }
                                       ...
                                       apr_pool_t *pool)
{
  ...
  cert_info = apr_hash_get(parameters, "svn:auth:" "ssl:cert-info", strlen("svn:auth:" "ssl:cert-info"));

  creds_hash = apr_hash_make(pool);
  apr_hash_set(creds_hash, "ascii_cert", strlen("ascii_cert"), svn_string_create(cert_info->ascii_cert, pool));

  apr_hash_set(creds_hash, "failures", strlen("failures"), svn_string_createf(pool, "%lu", (unsigned long)creds->accepted_failures));




  do { svn_error_t *svn_err__temp = (svn_config_write_auth_data(creds_hash, "svn.ssl.server", realmstring, config_dir, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 170 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/ssl_server_trust_providers.c"
                                   ...
                                   apr_pool_t *pool)
{
  ...
  const char *no_auth_cache = apr_hash_get(parameters, "svn:auth:" "no-auth-cache", strlen("svn:auth:" "no-auth-cache"));
  ...
  do { svn_error_t *svn_err__temp = (pb->prompt_func((svn_auth_cred_ssl_server_trust_t **)credentials_p, pb->prompt_baton, realmstring, *failures, cert_info, may_save, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
