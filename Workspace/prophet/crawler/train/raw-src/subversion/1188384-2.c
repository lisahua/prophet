...
svn_delta_from_editor(const svn_delta_editor_t **deditor,
                      ...
                      void *fetch_props_baton,
                      apr_pool_t *pool);
# 1163 "./subversion/include/svn_delta.h"
svn_error_t *
...
typedef svn_error_t *(*svn_delta_path_driver_cb_func_t)(
  ...
  const char *path,
  apr_pool_t *pool);
# 1315 "./subversion/include/svn_delta.h"
svn_error_t *
...
typedef svn_error_t *(*svn_file_rev_handler_t)(
  ...
  apr_pool_t *pool);
# 1376 "./subversion/include/svn_delta.h"
      ...
      switch (action->action)
        {
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 237, ((void*)0))); } while (0);
        }
    }
...
# 641 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 660, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (action == ACTION_RM)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 740, ((void*)0))); } while (0);
    }
...
# 1147 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
  return 0;
}
