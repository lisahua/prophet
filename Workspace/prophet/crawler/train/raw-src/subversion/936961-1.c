                              ...
                              apr_pool_t *scratch_pool)
{
  ...
  do { if (!(repos_root_url != ((void*)0) && repos_relpath != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/node.c", 321, "repos_root_url != NULL && repos_relpath != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 432 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/node.c"
                               ...
                               apr_pool_t *scratch_pool)
{
  ...
  return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/node.c",497), (svn_error_createf))(SVN_ERR_NODE_UNKNOWN_KIND, ((void*)0),
...
# 644 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/node.c"
  if (((*base_revision) >= 0))
    return 0;
...
# 681 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/node.c"
      ...
      if (work_del_abspath != ((void*)0))
        {
          ...
          do { if (!(parent_status == svn_wc__db_status_added || parent_status == svn_wc__db_status_obstructed_add)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/node.c", 726, "parent_status == svn_wc__db_status_added || parent_status == svn_wc__db_status_obstructed_add")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
