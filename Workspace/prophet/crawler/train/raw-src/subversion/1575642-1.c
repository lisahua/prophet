# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2
# 1 "./subversion/include/private/svn_packed_data.h" 1
# 26 "./subversion/include/private/svn_packed_data.h"
# 1 "./subversion/include/svn_string.h" 1
# 79 "./subversion/include/svn_string.h"
...
# 27 "./subversion/include/private/svn_packed_data.h" 2
...
svn_io_file_readline(apr_file_t *file,
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 28 "./subversion/include/private/svn_packed_data.h" 2
# 94 "./subversion/include/private/svn_packed_data.h"
...
svn_packed__data_read(svn_packed__data_root_t **root_p,
                      ...
                      apr_pool_t *result_pool,
                      apr_pool_t *scratch_pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2
...
svn_config__shallow_replace_section(svn_config_t *target,
                                    svn_config_t *source,
                                    const char *section);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.h" 1
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.h"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.h" 2
...
svn_fs_x__mergeinfo_count_get_func(void **out,
                                   ...
                                   void *baton,
                                   apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/string_table.h" 1
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/string_table.h"
...
svn_fs_x__string_table_get_func(const string_table_t *table,
                                ...
                                apr_size_t *length,
                                apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2
...
svn_fs_x__deserialize_mergeinfo(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c" 2
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c"
...
# 93 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c"
...
# 150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c"
         ...
         const svn_fs_id_t *id)
{
  ...
  if (idx == 0)
    {
      (*((binary_id_t *)apr_array_push(ids))) = bin_id;
      idx = ids->nelts;
                     ...
                     const representation_t *rep)
{
  ...
  if (idx == 0)
    {
      (*((binary_representation_t *)apr_array_push(reps))) = binary_rep;
      idx = reps->nelts;
                       ...
                       node_revision_t *noderev)
{
  ...
  binary_noderev.flags = (noderev->has_mergeinfo ? 0x00008 : 0)
                       | (noderev->copyfrom_path ? 0x00010 : 0)
                       | (noderev->copyroot_path ? 0x00020 : 0)
                       | (noderev->created_path ? 0x00040 : 0)
                       | (int)noderev->kind;
  ...
  (*((binary_noderev_t *)apr_array_push(container->noderevs))) = binary_noderev;
       ...
       apr_pool_t *pool)
{
  ...
  if (idx < 0 || idx > ids->nelts)
    return svn_error_createf(SVN_ERR_FS_CONTAINER_INDEX, ((void*)0),
                             dcgettext ("subversion", "Node revision ID index %d" " exceeds container size %d", 5),

                             idx, ids->nelts);


  binary_id = &(((binary_id_t *)(ids)->elts)[idx - 1]);
                   ...
                   apr_pool_t *pool)
{
  ...
  binary_rep = &(((binary_representation_t *)(reps)->elts)[idx - 1]);
                       ...
                       apr_pool_t *pool)
{
  ...
  do { if (!(container->builder == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c", 431, "container->builder == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(container->paths)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/noderevs.c", 432, "container->paths")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  if (idx >= (apr_size_t)container->noderevs->nelts)
    return svn_error_createf(SVN_ERR_FS_CONTAINER_INDEX, ((void*)0),
                             apr_psprintf(pool,
                                          dcgettext ("subversion", "Node revision index %%%s" " exceeds container size %%d", 5),
  ...
  binary_noderev = &(((binary_noderev_t *)(container->noderevs)->elts)[idx]);

  noderev->kind = (svn_node_kind_t)(binary_noderev->flags & 0x00007);
  do { svn_error_t *svn_err__temp = (get_id(&noderev->id, container->ids, binary_noderev->id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (get_id(&noderev->predecessor_id, container->ids, binary_noderev->predecessor_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (binary_noderev->flags & 0x00010)
    {
      noderev->copyfrom_path
  ...
  if (binary_noderev->flags & 0x00020)
    {
      noderev->copyroot_path
        = svn_fs_x__string_table_get(container->paths,
                                     binary_noderev->copyroot_path,
    ...
    {
      noderev->copyroot_path = ((void*)0);
      noderev->copyroot_rev = 0;
    }

  noderev->predecessor_count = binary_noderev->predecessor_count;

  do { svn_error_t *svn_err__temp = (get_representation(&noderev->prop_rep, container->prop_reps, binary_noderev->prop_rep, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (get_representation(&noderev->data_rep, container->data_reps, binary_noderev->data_rep, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (binary_noderev->flags & 0x00040)
    noderev->created_path
      = svn_fs_x__string_table_get(container->paths,
                                   binary_noderev->created_path,
                                   ((void*)0),
  ...
  noderev->has_mergeinfo = (binary_noderev->flags & 0x00008) ? 1 : 0;
  *noderev_p = noderev;
...
create_rep_stream(svn_packed__int_stream_t *parent)
{
  svn_packed__int_stream_t *stream
    = svn_packed__create_int_substream(parent, 0, 0);



  svn_packed__create_int_substream(stream, 0, 0);
  ...
  for (i = 0; i < reps->nelts; ++i)
    {
      binary_representation_t *rep
        = &(((binary_representation_t *)(reps)->elts)[i]);
                                   ...
                                   apr_pool_t *pool)
{
  ...
  svn_packed__int_stream_t *structs_stream
    = svn_packed__create_int_stream(root, 0, 0);
  svn_packed__int_stream_t *ids_stream
    = svn_packed__create_int_substream(structs_stream, 0, 0);
  ...
  for (i = 0; i < 3 * 2; ++i)
    svn_packed__create_int_substream(ids_stream, (!0), 0);

  svn_packed__create_int_substream(noderevs_stream, 0, 0);
  for (i = 0; i < 12; ++i)
    svn_packed__create_int_substream(noderevs_stream, (!0), 0);
  ...
  for (i = 0; i < container->ids->nelts; ++i)
    {
      binary_id_t *id = &(((binary_id_t *)(container->ids)->elts)[i]);
  ...
  for (i = 0; i < container->noderevs->nelts; ++i)
    {
      const binary_noderev_t *noderev
        = &(((binary_noderev_t *)(container->noderevs)->elts)[i]);
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__write_string_table(stream, paths, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_packed__data_write(stream, root, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < count; ++i)
    {
      ...
      if (len != sizeof(rep.md5_digest))
        return svn_error_createf(SVN_ERR_FS_CONTAINER_INDEX, ((void*)0),
                                 apr_psprintf(pool,
                                              dcgettext ("subversion", "Unexpected MD5" " digest size %%%s", 5),
      ...
      if (rep.has_sha1)
        {
          ...
          if (len != sizeof(rep.sha1_digest))
            return svn_error_createf(SVN_ERR_FS_CONTAINER_INDEX, ((void*)0),
                                     apr_psprintf(pool,
                                                  dcgettext ("subversion", "Unexpected SHA1" " digest size %%%s", 5),
      ...
      (*((binary_representation_t *)apr_array_push(reps))) = rep;
    }
                                  ...
                                  apr_pool_t *scratch_pool)
{
  ...
  svn_fs_x__noderevs_t *noderevs
    = memset(apr_palloc(result_pool, sizeof(*noderevs)), 0, sizeof(*noderevs));
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__read_string_table(&noderevs->paths, stream, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_packed__data_read(&root, stream, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < count; ++i)
    {
      ...
      (*((binary_id_t *)apr_array_push(noderevs->ids))) = id;
    }


  do { svn_error_t *svn_err__temp = (read_reps(&noderevs->data_reps, data_reps_stream, digests_stream, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (read_reps(&noderevs->prop_reps, prop_reps_stream, digests_stream, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < count; ++i)
    {
      ...
      (*((binary_noderev_t *)apr_array_push(noderevs->noderevs))) = noderev;
    }
                            ...
                            apr_pool_t *pool)
{
  ...
  noderev = memset(apr_palloc(pool, sizeof(*noderev)), 0, sizeof(*noderev));
  binary_noderev = &(((binary_noderev_t *)(&noderevs)->elts)[idx]);

  noderev->kind = (svn_node_kind_t)(binary_noderev->flags & 0x00007);
  do { svn_error_t *svn_err__temp = (get_id(&noderev->id, &ids, binary_noderev->id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (get_id(&noderev->predecessor_id, &ids, binary_noderev->predecessor_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (get_representation(&noderev->prop_rep, &prop_reps, binary_noderev->prop_rep, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (get_representation(&noderev->data_rep, &data_reps, binary_noderev->data_rep, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
