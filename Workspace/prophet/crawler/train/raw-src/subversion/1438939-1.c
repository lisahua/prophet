...
svn_client_export4(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 5376 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_list3(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 5551 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_ls2(apr_hash_t **dirents,
               ...
               svn_client_ctx_t *ctx,
               apr_pool_t *pool);
# 5639 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_cat2(svn_stream_t *out,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 5698 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_lock(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 5874 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_unlock(const apr_array_header_t *targets,
                  svn_boolean_t break_lock,
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 5908 "./subversion/include/svn_client.h"
...
typedef svn_error_t *(*svn_info_receiver_t)(
  ...
  apr_pool_t *pool);
# 6035 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_info_t *
...
typedef svn_error_t *(*svn_client_info_receiver2_t)(
                         ...
                         apr_pool_t *scratch_pool);
# 6162 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_info2(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 6200 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_get_wc_root(const char **wcroot_abspath,
                       ...
                       apr_pool_t *result_pool,
                       apr_pool_t *scratch_pool);
# 6235 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_url_from_path(const char **url,
                         const char *path_or_url,
                         apr_pool_t *pool);
# 6405 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_get_repos_root(const char **repos_root_url,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 6422 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
# 209 "./subversion/include/private/svn_diff_tree.h"
svn_diff_tree_processor_t *
...
svn_wc__wrap_diff_callbacks(svn_diff_tree_processor_t **diff_processor,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 1775 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__resolve_conflicts(svn_wc_context_t *wc_ctx,
                          ...
                          void *notify_baton,
                          apr_pool_t *scratch_pool);
# 1825 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__move2(svn_wc_context_t *wc_ctx,
              ...
              void *notify_baton,
              apr_pool_t *scratch_pool);
# 1849 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
# 229 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
...
# 294 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static svn_error_t *
...
# 363 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static void
...
diff_deleted_file(const char *path,
                  ...
                  apr_pool_t *scratch_pool)
{
  struct file_baton *fb = make_file_baton(path, 0, eb, scratch_pool);
  ...
  do { svn_error_t *svn_err__temp = (eb->processor->file_opened(&fb->pfb, &skip, path, left_source, ((void*)0) , ((void*)0) , ppdb, eb->processor, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 534 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static svn_error_t *
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { if (!(((eb->revision) >= 0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c", 549, "SVN_IS_VALID_REVNUM(eb->revision)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  if (eb->cancel_func)
    do { svn_error_t *svn_err__temp = (eb->cancel_func(eb->cancel_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (eb->processor->dir_opened(&pdb, &skip, &skip_children, path, left_source, ((void*)0) , ((void*)0) , ppdb, eb->processor, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 563 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
...
# 577 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
      ...
      for (hi = apr_hash_first(scratch_pool, dirents); hi;
           hi = apr_hash_next(hi))
        {
          ...
          if (dirent->kind == svn_node_file)
            {
              do { svn_error_t *svn_err__temp = (diff_deleted_file(child_path, pdb, eb, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
          else if (dirent->kind == svn_node_dir)
            {
              do { svn_error_t *svn_err__temp = (diff_deleted_dir(child_path, pdb, eb, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
        }
    }
  ...
  if (! skip)
    {
      do { svn_error_t *svn_err__temp = (eb->processor->dir_deleted(path, left_source, left_props, pdb, eb->processor, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  switch (kind)
    ...
    case svn_node_file:
      {
        do { svn_error_t *svn_err__temp = (diff_deleted_file(path, pb->pdb, eb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        break;
      }
    case svn_node_dir:
      {
        do { svn_error_t *svn_err__temp = (diff_deleted_dir(path, pb->pdb, eb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        break;
      }
    default:
      break;
              ...
              void **child_baton)
{
  ...
  db = make_dir_baton(path, pb, eb, (!0), ((svn_revnum_t) -1), pool);
  *child_baton = db;
...
# 701 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  return 0;
}
               ...
               void **child_baton)
{
  ...
  db = make_dir_baton(path, pb, eb, 0, base_revision, pool);
...
# 741 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  return 0;
}
         ...
         void **file_baton)
{
  ...
  fb = make_file_baton(path, (!0), pb->edit_baton, pool);
  *file_baton = fb;
...
# 784 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  return 0;
}
...
# 823 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
  return 0;
}
                ...
                void **handler_baton)
{
  ...
  do { if (!(fb->path_start_revision != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c", 885, "fb->path_start_revision != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(&src_stream, fb->path_start_revision, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_stream_open_unique(&result_stream, &fb->path_end_revision, ((void*)0), svn_io_file_del_on_pool_cleanup, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 935 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static svn_error_t *
...
# 997 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
      else
...
# 1012 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
    }
...
# 1026 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
static svn_error_t *
...
# 1084 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c"
            }
  ...
  if (for_delete)
    {
      ...
      dpn = memset(apr_palloc(eb->pool, sizeof(*dpn)), 0, sizeof(*dpn));
  ...
  if (tree_conflicted)
    {
      ...
      dpn = apr_hash_get(eb->deleted_paths, relpath, (-1));
      if (dpn)
        {
...
{
  struct edit_baton *eb = state_baton;
  do { svn_error_t *svn_err__temp = (send_delete_notify(eb, relpath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                            ...
                            apr_pool_t *result_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__wrap_diff_callbacks(&eb->processor, diff_callbacks, diff_cmd_baton, diff_state_handle, diff_state_close, eb, result_pool, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
