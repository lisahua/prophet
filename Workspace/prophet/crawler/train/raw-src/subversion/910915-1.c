# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.c"
...
apr_status_t apr_password_validate(const char *passwd,
                                                const char *hash);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.h" 1
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.h"
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.h" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.c" 2
# 1 "./subversion/include/svn_md5.h" 1
# 45 "./subversion/include/svn_md5.h"
__attribute__((deprecated))
const unsigned char *
svn_md5_empty_string_digest(void);
# 56 "./subversion/include/svn_md5.h"
__attribute__((deprecated))
const char *
svn_md5_digest_to_cstring_display(const unsigned char digest[],
                                  apr_pool_t *pool);
# 69 "./subversion/include/svn_md5.h"
__attribute__((deprecated))
const char *
svn_md5_digest_to_cstring(const unsigned char digest[],
                          apr_pool_t *pool);
# 82 "./subversion/include/svn_md5.h"
__attribute__((deprecated))
svn_boolean_t
svn_md5_digests_match(const unsigned char d1[],
                      const unsigned char d2[]);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/md5.c" 2
                                   ...
                                   apr_pool_t *pool)
{
  ...
  char *str = apr_palloc(pool, (16 * 2) + 1);
  int i;
...
{
  static const unsigned char zeros_digest[16] = { 0 };

  if (memcmp(digest, zeros_digest, 16) != 0)
...
svn_md5__digests_match(const unsigned char d1[], const unsigned char d2[])
{
  ...
  return ((memcmp(d1, zeros, 16) == 0)
          || (memcmp(d2, zeros, 16) == 0)
          || (memcmp(d1, d2, 16) == 0));
}
