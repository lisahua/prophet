# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
svn_client__resolve_conflicts(svn_boolean_t *conflicts_remain,
                              ...
                              svn_client_ctx_t *ctx,
                              apr_pool_t *scratch_pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
svn_sort__array_reverse(apr_array_header_t *array,
                        apr_pool_t *scratch_pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
svn_wc__acquire_write_lock_for_resolve(const char **lock_root_abspath,
                                       ...
                                       apr_pool_t *result_pool,
                                       apr_pool_t *scratch_pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c" 2
                     ...
                     apr_off_t latest_length)
{
  ...
  if (original_length)
    do { svn_error_t *svn_err__temp = (blame_delete_range(db->chain, modified_start, original_length)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (modified_length)
    do { svn_error_t *svn_err__temp = (blame_insert_range(db->chain, db->rev, modified_start, modified_length)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *pool)
{
  if (!last_file)
    {
      do { if (!(chain->blame == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c", 287, "chain->blame == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_diff_file_diff_2(&diff, last_file, cur_file, diff_options, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { svn_error_t *svn_err__temp = (svn_diff_output(diff, &diff_baton, &output_fns)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }

  return 0;
}
# 314 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c"
static svn_error_t *
window_handler(svn_txdelta_window_t *window, void *baton)
{
  ...
  do { svn_error_t *svn_err__temp = (dbaton->wrapped_handler(window, dbaton->wrapped_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (add_file_blame(frb->last_filename, dbaton->filename, chain, frb->rev, frb->diff_options, frb->currpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (frb->include_merged_revisions && ! frb->merged_revision)
    {
      ...
      do { svn_error_t *svn_err__temp = (add_file_blame(frb->last_original_filename, dbaton->filename, frb->chain, frb->rev, frb->diff_options, frb->currpool)); if (svn_err__temp) return (svn_err__temp); } while (0);





      apr_pool_clear(frb->prevfilepool);
...
# 387 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c"
static svn_error_t *
                 ...
                 apr_pool_t *pool)
{
  ...
  if (frb->ctx->cancel_func)
    do { svn_error_t *svn_err__temp = (frb->ctx->cancel_func(frb->ctx->cancel_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (frb->last_filename)
    do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(&last_stream, frb->last_filename, frb->currpool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_open_unique(&cur_stream, &delta_baton->filename, ((void*)0), svn_io_file_del_on_pool_cleanup, filepool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  *content_delta_baton = delta_baton;
  ...
  frb->rev = memset(apr_palloc(frb->mainpool, sizeof(struct rev)), 0, sizeof(struct rev));

  if (revnum < ((frb->start_rev) < (frb->end_rev) ? (frb->start_rev) : (frb->end_rev)))
    {


      do { if (!((frb->last_filename == ((void*)0)) || frb->include_merged_revisions)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c", 474, "(frb->last_filename == NULL) || frb->include_merged_revisions")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);




      frb->rev->revision = ((svn_revnum_t) -1);
    }
  else
    {

      do { if (!(revnum <= 1 + ((frb->end_rev) < (frb->start_rev) ? (frb->start_rev) : (frb->end_rev)))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c", 483, "revnum <= 1 + MAX(frb->end_rev, frb->start_rev)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                 ...
                 apr_pool_t *pool)
{
  ...
  for (walk = chain->blame, walk_merged = chain_merged->blame;
       ...
       walk = walk->next, walk_merged = walk_merged->next)
    {
      ...
      ((walk->start == walk_merged->start) ? (void) (0) : __assert_fail ("walk->start == walk_merged->start", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c", 514, __PRETTY_FUNCTION__));
                  ...
                  apr_pool_t *pool)
{
  ...
  if (svn_path_is_url(target))
    ...
    do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&target_abspath_or_url, target, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__ra_session_from_path2(&ra_session, &end_loc, target, ((void*)0), peg_revision, end, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  end_revnum = end_loc->rev;

  do { svn_error_t *svn_err__temp = (svn_client__get_revision_number(&start_revnum, ((void*)0), ctx->wc_ctx, target_abspath_or_url, ra_session, start, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!ignore_mime_type)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_client_propget5(&props, ((void*)0), "svn:" "mime-type", target_abspath_or_url, peg_revision, end, ((void*)0), svn_depth_empty, ((void*)0), ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (hi)
        {
          ...
          do { if (!(apr_hash_count(props) == 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c", 624, "apr_hash_count(props) == 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

          value = svn__apr_hash_index_val(hi);
          if (value && svn_mime_type_is_binary(value->data))
            return svn_error_createf
              (SVN_ERR_CLIENT_IS_BINARY_FILE, 0,
               dcgettext ("subversion", "Cannot calculate blame information for binary file '%s'", 5),
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_get_repos_root2(ra_session, &frb.repos_root_url, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  frb.mainpool = pool;



  frb.lastpool = svn_pool_create_ex(pool, ((void*)0));
  frb.currpool = svn_pool_create_ex(pool, ((void*)0));
  if (include_merged_revisions)
    {
      frb.filepool = svn_pool_create_ex(pool, ((void*)0));
      frb.prevfilepool = svn_pool_create_ex(pool, ((void*)0));
    }
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_get_latest_revnum(ra_session, &youngest, frb.currpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_ra_get_file_revs2(ra_session, "", start_revnum - (0 < start_revnum && start_revnum <= end_revnum ? 1 : 0) + (youngest > start_revnum && start_revnum > end_revnum ? 1 : 0), end_revnum, include_merged_revisions, file_rev_handler, &frb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (end->kind == svn_opt_revision_working)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc_status3(&status, ctx->wc_ctx, target_abspath_or_url, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (status->text_status != svn_wc_status_normal
              ...
              && status->prop_status != svn_wc_status_none))
        {
          ...
          svn_boolean_t normalize_eols = 0;
          const char *temppath;

          if (status->prop_status != svn_wc_status_none)
            {
              const svn_string_t *eol_style;
              do { svn_error_t *svn_err__temp = (svn_wc_prop_get2(&eol_style, ctx->wc_ctx, target_abspath_or_url, "svn:" "eol-style", pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          do { svn_error_t *svn_err__temp = (svn_client__get_normalized_stream(&wcfile, ctx->wc_ctx, target_abspath_or_url, &rev, 0, normalize_eols, ctx->cancel_func, ctx->cancel_baton, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          do { svn_error_t *svn_err__temp = (svn_stream_open_unique(&tempfile, &temppath, ((void*)0), svn_io_file_del_on_pool_cleanup, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



          do { svn_error_t *svn_err__temp = (svn_stream_copy3(wcfile, tempfile, ctx->cancel_func, ctx->cancel_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


          do { svn_error_t *svn_err__temp = (add_file_blame(frb.last_filename, temppath, frb.chain, ((void*)0), frb.diff_options, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { if (!(frb.last_filename != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/blame.c", 745, "frb.last_filename != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  iterpool = svn_pool_create_ex(pool, ((void*)0));


  do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(&last_stream, frb.last_filename, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (line_no = walk->start;
           ...
           ++line_no)
        {
          ...
          if (!eof || sb->len)
            {
              if (walk->rev)
                do { svn_error_t *svn_err__temp = (receiver(receiver_baton, start_revnum, end_revnum, line_no, walk->rev->revision, walk->rev->rev_props, merged_rev, merged_rev_props, merged_path, sb->data, 0, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);




              else
                do { svn_error_t *svn_err__temp = (receiver(receiver_baton, start_revnum, end_revnum, line_no, ((svn_revnum_t) -1), ((void*)0), ((svn_revnum_t) -1), ((void*)0), ((void*)0), sb->data, (!0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  apr_pool_destroy(frb.lastpool);
  apr_pool_destroy(frb.currpool);
  if (include_merged_revisions)
    {
      apr_pool_destroy(frb.filepool);
      apr_pool_destroy(frb.prevfilepool);
    }
