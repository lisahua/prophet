# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_opt_print_help(apr_getopt_t *os,
                   ...
                   const char *footer,
                   apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_client__create_status(svn_client_status_t **cst,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_wc__get_info(svn_wc_context_t *wc_ctx,
                 ...
                 void *cancel_baton,
                 apr_pool_t *scratch_pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
                                  ...
                                  apr_pool_t *scratch_pool)
{
  ...
  if (! svn_path_is_url(abspath_or_url))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_repos_relpath(&repos_relpath, wc_ctx, abspath_or_url, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





      do { if (!(repos_relpath != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c", 138, "repos_relpath != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
    }

  else if (repos_root != ((void*)0))
    {
  ...
  else
    {
      ...
      do { if (!(ra_session != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c", 158, "ra_session != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      if (err)
        {
          if (err->apr_err == SVN_ERR_RA_ILLEGAL_URL)
            return svn_error_createf(SVN_ERR_CLIENT_UNRELATED_RESOURCES, err,
                                     dcgettext ("subversion", "URL '%s' is not inside repository", 5),
                                     abspath_or_url);
  ...
  if (include_leading_slash)
    *rel_path = apr_pstrcat(result_pool, "/", repos_relpath, ((void*)0));
  else
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  if (!svn_path_is_url(abspath_or_url))
    {
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_repos_info(repos_root, ((void*)0), ctx->wc_ctx, abspath_or_url, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__open_ra_session_internal(&ra_session, ((void*)0), abspath_or_url, ((void*)0), ((void*)0), 0, (!0), ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
