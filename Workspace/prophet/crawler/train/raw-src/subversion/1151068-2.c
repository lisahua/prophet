...
# 217 "./subversion/svn_private_config.h"
...
# 155 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
  if (!setlocale(6, "")
      && !setlocale(0, ""))
    {
      if (error_stream)
...
svn_cmdline_printf(apr_pool_t *pool, const char *fmt, ...)
{
  const char *message;
  va_list ap;
# 295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
...
# 418 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
static svn_error_t *
