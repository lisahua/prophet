...
# 374 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
static rep_stats_t *
      ...
      if (!svn_fs_fs__use_log_addressing(query->fs))
        {
          ...
          do { if (!(revision_info->rev_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c", 456, "revision_info->rev_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
read_noderev(query_t *query,
             ...
             apr_pool_t *result_pool,
             apr_pool_t *scratch_pool);
# 490 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  do { if (!(revision_info->rev_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c", 505, "revision_info->rev_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 538 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
...
# 583 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
read_noderev(query_t *query,
             svn_stringbuf_t *noderev_str,
             revision_info_t *revision_info,
...
# 1188 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
