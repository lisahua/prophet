...
# 315 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 422 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 537 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  cache_level_t l1;
...
# 610 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 729 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
allocate_spare_group(svn_membuffer_t *cache)
{
  ...
  ((!group || !group->header.used) ? (void) (0) : __assert_fail ("!group || !group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 799, __PRETTY_FUNCTION__));
  return group;
}
...
free_spare_group(svn_membuffer_t *cache,
                 entry_group_t *group)
{
  ((group->header.used == 0) ? (void) (0) : __assert_fail ("group->header.used == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 809, __PRETTY_FUNCTION__));
  ((group->header.previous != (4294967295U)) ? (void) (0) : __assert_fail ("group->header.previous != (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 810, __PRETTY_FUNCTION__));
  ((group - cache->directory >= (apr_ssize_t)cache->group_count) ? (void) (0) : __assert_fail ("group - cache->directory >= (apr_ssize_t)cache->group_count", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 811, __PRETTY_FUNCTION__));
            ...
            apr_uint32_t idx)
{
  ...
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 895, __PRETTY_FUNCTION__));
...
unchain_entry(svn_membuffer_t *cache,
              ...
              apr_uint32_t idx)
{
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 942, __PRETTY_FUNCTION__));
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == level->current_data) ? (void) (0) : __assert_fail ("entry->offset == level->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1070, __PRETTY_FUNCTION__));
  ((idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used) ? (void) (0) : __assert_fail ("idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1071, __PRETTY_FUNCTION__));
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1088, __PRETTY_FUNCTION__));
}
...
# 1140 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
  ...
  while (1)
    {
      ...
      ((group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))) ? (void) (0) : __assert_fail ("group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1201, __PRETTY_FUNCTION__));
      group = &cache->directory[group->header.next];
    }
  ...
  if (find_empty)
    {
      ...
      if (group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t)))
        {
# 1240 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
move_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1319, __PRETTY_FUNCTION__));
}
...
promote_entry(svn_membuffer_t *cache, entry_t *entry)
{
  apr_uint32_t idx = get_index(cache, entry);
  apr_size_t size = (((entry->size) + 16 -1) & -16);
  ((get_cache_level(cache, entry) == &cache->l1) ? (void) (0) : __assert_fail ("get_cache_level(cache, entry) == &cache->l1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1329, __PRETTY_FUNCTION__));
  ((idx == cache->l1.next) ? (void) (0) : __assert_fail ("idx == cache->l1.next", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1330, __PRETTY_FUNCTION__));
...
# 1359 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 1392 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
...
# 1505 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_boolean_t
...
# 1571 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
                                  ...
                                  apr_pool_t *pool)
{
  ...
  if (segment_count < 1)
    {
# 1641 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  ...
  ((spare_group_count > 0 && main_group_count > 0) ? (void) (0) : __assert_fail ("spare_group_count > 0 && main_group_count > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1707, __PRETTY_FUNCTION__));
...
# 1874 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 1910 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
  ...
  if (level)
    {
      ...
      entry->offset = level->current_data;
      entry->priority = priority;
# 1942 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 1974 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 2007 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 2038 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 2085 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2123 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  if (buffer == ((void*)0))
    {
      *item = ((void*)0);
      return 0;
...
# 2198 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      do { svn_mutex__t *svn_mutex__m = (cache->counter_mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (increment_hit_counters(cache, entry)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 2243 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2288 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->total_writes++;
# 2334 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2379 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
        }
    }
...
# 2429 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static void
combine_long_key(svn_membuffer_cache_t *cache,
                 const void *key,
                 apr_ssize_t key_len)
{
  ((cache->last_access) ? (void) (0) : __assert_fail ("cache->last_access", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 2508, __PRETTY_FUNCTION__));
...
# 2772 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 2969 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
                                  ...
                                  apr_pool_t *scratch_pool)
{
  ...
  svn_cache__t *wrapper = memset(apr_palloc(result_pool, sizeof(*wrapper)), 0, sizeof(*wrapper));
  ...
  do { svn_error_t *svn_err__temp = (svn_mutex__init(&cache->mutex, thread_safe, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_checksum(&checksum, svn_checksum_md5, prefix, strlen(prefix), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ((klen == (-1)) || klen > sizeof(entry_key_t))
    {
      cache->last_access = memset(apr_palloc(result_pool, sizeof(*cache->last_access)), 0, sizeof(*cache->last_access));
