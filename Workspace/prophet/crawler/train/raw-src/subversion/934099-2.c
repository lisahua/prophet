...
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
...
# 108 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
static svn_error_t *
exec_sql(svn_sqlite__db_t *db, const char *sql)
{
  ...
  if (sqlite_err != 0)
    {
      svn_error_t *err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",116), (svn_error_create))(((sqlite_err) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0),
                                          err_msg);
...
svn_sqlite__exec_statements(svn_sqlite__db_t *db, int stmt_idx)
{
  do { if (!(stmt_idx < db->nbr_statements)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 129, "stmt_idx < db->nbr_statements")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_sqlite__get_statement(svn_sqlite__stmt_t **stmt, svn_sqlite__db_t *db,
                          int stmt_idx)
{
  do { if (!(stmt_idx < db->nbr_statements)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 139, "stmt_idx < db->nbr_statements")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  if (db->prepared_stmts[stmt_idx] == ((void*)0))
    do { svn_error_t *svn_err__temp = (svn_sqlite__prepare(&db->prepared_stmts[stmt_idx], db, db->statement_strings[stmt_idx], db->result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    const char *text, apr_pool_t *result_pool)
{
  *stmt = apr_palloc(result_pool, sizeof(**stmt));
  ...
  do { int sqlite_err__temp = (sqlite3_prepare_v2(db->db3, text, -1, &(*stmt)->s3stmt, ((void*)0))); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",162), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((db)->db3)); } while (0);
                      ...
                      svn_boolean_t expecting_row)
{
  ...
  if ((got_row && !expecting_row)
    ...
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",177), (svn_error_create))(SVN_ERR_SQLITE_ERROR, ((void*)0),
                            expecting_row
  ...
  if (sqlite_result != 101 && sqlite_result != 100)
    {
      ...
      err1 = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",208), (svn_error_create))(((sqlite_result) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0),
      ...
      switch (*fmt)
        {
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 279, ((void*)0))); } while (0);
        }
    }
...
svn_sqlite__bind_int(svn_sqlite__stmt_t *stmt,
                     ...
                     int val)
{
  do { int sqlite_err__temp = (sqlite3_bind_int(stmt->s3stmt, slot, val)); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",303), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  return 0;
}
...
svn_sqlite__bind_int64(svn_sqlite__stmt_t *stmt,
                       ...
                       apr_int64_t val)
{
  do { int sqlite_err__temp = (sqlite3_bind_int64(stmt->s3stmt, slot, val)); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",312), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  return 0;
}
...
svn_sqlite__bind_text(svn_sqlite__stmt_t *stmt,
                      ...
                      const char *val)
{
  do { int sqlite_err__temp = (sqlite3_bind_text(stmt->s3stmt, slot, val, -1, ((sqlite3_destructor_type)-1))); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",322), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
...
svn_sqlite__bind_blob(svn_sqlite__stmt_t *stmt,
                      ...
                      apr_size_t len)
{
  do { int sqlite_err__temp = (sqlite3_bind_blob(stmt->s3stmt, slot, val, (int) len, ((sqlite3_destructor_type)-1))); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",334), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
                       ...
                       int value)
{
  ...
  do { int sqlite_err__temp = (sqlite3_bind_text(stmt->s3stmt, slot, word, -1, ((sqlite3_destructor_type)0))); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",347), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
...
svn_sqlite__finalize(svn_sqlite__stmt_t *stmt)
{
  do { int sqlite_err__temp = (sqlite3_finalize(stmt->s3stmt)); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",503), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  return 0;
}
...
svn_sqlite__reset(svn_sqlite__stmt_t *stmt)
{
  do { int sqlite_err__temp = (sqlite3_reset(stmt->s3stmt)); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",510), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  do { int sqlite_err__temp = (sqlite3_clear_bindings(stmt->s3stmt)); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",511), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  stmt->needs_reset = 0;
  return 0;
}
...
# 581 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
             ...
             apr_pool_t *scratch_pool)
{
  ...
  return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",665), (svn_error_createf))(SVN_ERR_SQLITE_UNSUPPORTED_SCHEMA, ((void*)0),
                           dcgettext ("subversion", "Schema format %d not recognized", 5),
                           current_schema);
}

static volatile apr_uint32_t sqlite_init_state;
...
init_sqlite(apr_pool_t *pool)
{
  if (sqlite3_libversion_number() < 3008002)
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",680), (svn_error_createf))(
  ...
  if (! sqlite3_threadsafe())
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",693), (svn_error_create))(SVN_ERR_SQLITE_ERROR, ((void*)0),
...

  {
    ...
    if (err != 0 && err != 21)
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",703), (svn_error_create))(((err) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0),
                              dcgettext ("subversion", "Could not configure SQLite", 5));
  }
  do { int sqlite_err__temp = (sqlite3_initialize()); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",706), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), dcgettext ("subversion", "Could not initialize SQLite", 5)); } while (0);
  ...
  do { int sqlite_err__temp = (sqlite3_enable_shared_cache((!0))); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",715), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), dcgettext ("subversion", "Could not initialize SQLite shared cache", 5)); } while (0);
              ...
              apr_pool_t *scratch_pool)
{

  {
    ...
    if (mode == svn_sqlite__mode_readonly)
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 736, ((void*)0))); } while (0);
# 745 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
    flags |= 0x00008000;
      ...
      if (err_code != 0)
        {
          ...
          msg = apr_pstrcat(scratch_pool, msg, ": '", path, "'", ((void*)0));
          return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",766), (svn_error_create))(((err_code) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), msg);
        }
    }
  }
# 814 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
  do { int sqlite_err__temp = (sqlite3_busy_timeout(*db3, 10000)); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",815), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg(*db3)); } while (0);
                               ...
                               apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_atomic__init_once(&sqlite_init_state, init_sqlite, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { int sqlite_err__temp = (sqlite3_close(db.db3)); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",831), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((&db)->db3)); } while (0);
...
close_apr(void *data)
{
  ...
  if (result != 0)
    return ((result) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR );
                 ...
                 apr_pool_t *result_pool, apr_pool_t *scratch_pool)
{
  ...
  *db = memset(apr_palloc(result_pool, sizeof(**db)), 0, sizeof(**db));
  ...
  do { svn_error_t *svn_err__temp = (exec_sql(*db, "PRAGMA case_sensitive_like=1;" "PRAGMA synchronous=OFF;")); if (svn_err__temp) return (svn_err__temp); } while (0);
# 916 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
...
svn_sqlite__close(svn_sqlite__db_t *db)
{
  ...
  return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",949), (svn_error_wrap_apr))(result, ((void*)0));
}
                    ...
                    apr_pool_t *scratch_pool)
{
...

  {
    ...
    if (!backup)
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",994), (svn_error_createf))(SVN_ERR_SQLITE_ERROR, ((void*)0),
    ...
    if (rc1 != 101)
      do { int sqlite_err__temp = (rc1); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",1016), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((dst_db)->db3)); } while (0);
    do { int sqlite_err__temp = (rc2); if (sqlite_err__temp != 0) return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c",1017), (svn_error_create))(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : SVN_ERR_SQLITE_ERROR ), ((void*)0), sqlite3_errmsg((dst_db)->db3)); } while (0);
    do { svn_error_t *svn_err__temp = (svn_sqlite__close(dst_db)); if (svn_err__temp) return (svn_err__temp); } while (0);
  }
# 1033 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
