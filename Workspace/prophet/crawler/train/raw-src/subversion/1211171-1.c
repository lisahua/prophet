      ...
      switch (action->action)
        {
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 315, ((void*)0))); } while (0);
        }
    }
  ...
  if (need_add)
    {
      if (kind == svn_kind_dir)
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_editor_add_file(eb->editor, path, checksum, contents, props, ((svn_revnum_t) -1))); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (contents)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_editor_set_text(eb->editor, path, ((svn_revnum_t) -1), checksum, contents)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 882 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 901, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (action == ACTION_DELETE)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 1008, ((void*)0))); } while (0);
    }
...
# 1574 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
  return 0;
}
