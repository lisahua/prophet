# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c" 2
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c" 2
...
{ 0, ((void*)0) } };
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-code-test.c" 2
...
check_error_codes_unique(apr_pool_t *pool)
{
  ...
  for (i = 1; i < (sizeof(error_table)/sizeof(error_table[0])); i++)
    {
      struct err_defn e2 = error_table[i++];



      if (i == (sizeof(error_table)/sizeof(error_table[0])) - 1 && e2.errcode == 0)
        break;
...
struct svn_test_descriptor_t test_funcs[] =
  {
    {0},
    {svn_test_pass, check_error_codes_unique, ((void*)0), "check that error codes are unique"},
