# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/spillbuf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/spillbuf.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/spillbuf.c"
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/spillbuf.c" 2
...
svn_io_write_version_file(const char *path,
                          int version,
                          apr_pool_t *pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/spillbuf.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/spillbuf.c" 2
...
svn_stream__from_spillbuf(apr_size_t blocksize,
                          apr_size_t maxsize,
                          apr_pool_t *result_pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/spillbuf.c" 2
...
svn_spillbuf__create(apr_size_t blocksize,
                     ...
                     apr_pool_t *result_pool)
{
  svn_spillbuf_t *buf = memset(apr_palloc(result_pool, sizeof(*buf)), 0, sizeof(*buf));
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  if (buf->spill == ((void*)0)
    ...
    {
      do { svn_error_t *svn_err__temp = (svn_io_open_unique_file3(&buf->spill, ((void*)0) , ((void*)0) , svn_io_file_del_on_close, buf->pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (buf->spill != ((void*)0))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_write_full(buf->spill, data, len, ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          apr_pool_t *scratch_pool)
{
  ...
  *mem = get_buffer(buf);
  ...
  if ((buf->spill_size -= (*mem)->size) == 0)
    {
      do { svn_error_t *svn_err__temp = (svn_io_file_close(buf->spill, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      buf->spill = ((void*)0);
    }
  ...
  if (buf->head == ((void*)0) && buf->spill != ((void*)0))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_seek(buf->spill, 0, &output_unused, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (maybe_seek(((void*)0), buf, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (read_data(&mem, buf, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (mem == ((void*)0))
    {
      *data = ((void*)0);
      *len = 0;
  ...
  while ((!0))
    {
      ...
      if (!has_seeked)
        do { svn_error_t *svn_err__temp = (maybe_seek(&has_seeked, buf, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (read_data(&mem, buf, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (mem == ((void*)0))
        {
          *exhausted = (!0);
          break;
...
svn_spillbuf__reader_create(apr_size_t blocksize,
                            ...
                            apr_pool_t *result_pool)
{
  svn_spillbuf_reader_t *sbr = memset(apr_palloc(result_pool, sizeof(*sbr)), 0, sizeof(*sbr));
  ...
  while (len > 0)
    {
      ...
      if (reader->save_len > 0)
      ...
      else
        {
          ...
          if (reader->sb_len == 0)
            {
              do { svn_error_t *svn_err__temp = (svn_spillbuf__read(&reader->sb_ptr, &reader->sb_len, &reader->buf, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_spillbuf__reader_read(&amt, reader, c, 1, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (amt == 0)
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  return (svn_spillbuf__write(&reader->buf, data, len, scratch_pool));
...
read_handler_spillbuf(void *baton, char *buffer, apr_size_t *len)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_spillbuf__reader_read(len, sb->reader, buffer, *len, sb->scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  apr_pool_clear(sb->scratch_pool);
  return 0;
}
...
write_handler_spillbuf(void *baton, const char *data, apr_size_t *len)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_spillbuf__reader_write(sb->reader, data, *len, sb->scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  svn_stream_t *stream;
  struct spillbuf_baton *sb = memset(apr_palloc(result_pool, sizeof(*sb)), 0, sizeof(*sb));

  sb->reader = svn_spillbuf__reader_create(blocksize, maxsize, result_pool);
  sb->scratch_pool = svn_pool_create_ex(result_pool, ((void*)0));
