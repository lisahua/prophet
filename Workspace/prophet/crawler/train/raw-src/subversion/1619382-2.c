...
svn_wc__create_prejfile(const char **tmp_prejfile_abspath,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff.h" 1
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff.h"
svn_error_t *
svn_wc__diff_local_only_file(svn_wc__db_t *db,
                             ...
                             void *cancel_baton,
                             apr_pool_t *scratch_pool);
# 80 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff.h"
svn_error_t *
...
svn_wc__diff_base_only_file(svn_wc__db_t *db,
                            ...
                            void *processor_parent_baton,
                            apr_pool_t *scratch_pool);
# 115 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff.h"
svn_error_t *
...
# 1 "./subversion/svn_private_config.h" 1
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c" 2
             ...
             apr_pool_t *scratch_pool)
{
  ...
  if (!eb->cur)
    {
      ...
      if (*relpath)
        do { svn_error_t *svn_err__temp = (ensure_state(eb, svn_dirent_dirname(local_abspath, scratch_pool), 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  ns_pool = svn_pool_create_ex(eb->cur ? eb->cur->pool : eb->pool, ((void*)0));
  ns = memset(apr_palloc(ns_pool, sizeof(*ns)), 0, sizeof(*ns));
...

  {
    ...
    ns->right_src = svn_diff__source_create(((svn_revnum_t) -1), ns->pool);

    do { svn_error_t *svn_err__temp = (eb->processor->dir_opened(&ns->baton, &ns->skip, &ns->skip_children, ns->relpath, ns->left_src, ns->right_src, ((void*)0) , ns->parent ? ns->parent->baton : ((void*)0), eb->processor, ns->pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
  }
  ...
  while (eb->cur
         && !svn_dirent_is_ancestor(eb->cur->local_abspath, local_abspath))
    {
      ...
      if (!ns->skip)
        {
          if (ns->propchanges)
            do { svn_error_t *svn_err__temp = (eb->processor->dir_changed(ns->relpath, ns->left_src, ns->right_src, ns->left_props, ns->right_props, ns->propchanges, ns->baton, eb->processor, ns->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 235 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
          else
            do { svn_error_t *svn_err__temp = (eb->processor->dir_closed(ns->relpath, ns->left_src, ns->right_src, ns->baton, eb->processor, ns->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (eb->changelist_hash != ((void*)0)
      && (!status->changelist
          || ! apr_hash_get(eb->changelist_hash, status->changelist, (-1))))
    return 0;
...

  {
    ...
    do { svn_error_t *svn_err__temp = (svn_wc__db_read_info(&db_status, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &have_base, ((void*)0), ((void*)0), eb->db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    if (!have_base)
    ...
    else if (db_status == svn_wc__db_status_deleted)
      {
        ...
        repos_only = (!0);
        do { svn_error_t *svn_err__temp = (svn_wc__db_base_get_info(&base_status, &base_kind, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), eb->db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    if (repos_only)
      {
        ...
        if (base_kind == svn_node_file)
          do { svn_error_t *svn_err__temp = (svn_wc__diff_base_only_file(db, child_abspath, child_relpath, ((svn_revnum_t) -1), eb->processor, eb->cur ? eb->cur->baton : ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__diff_base_only_dir(db, child_abspath, child_relpath, ((svn_revnum_t) -1), depth_below_here, eb->processor, eb->cur ? eb->cur->baton : ((void*)0), eb->cancel_func, eb->cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 352 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
      }
    else if (!local_only)
      {
        ...
        if (db_kind == svn_node_file)
          {
            do { svn_error_t *svn_err__temp = (svn_wc__diff_base_working_diff(db, child_abspath, child_relpath, ((svn_revnum_t) -1), eb->changelist_hash, eb->processor, eb->cur ? eb->cur->baton : ((void*)0), 0, eb->cancel_func, eb->cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 370 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
          }
        else if (db_kind == svn_node_dir)
          {
            do { svn_error_t *svn_err__temp = (ensure_state(eb, local_abspath, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

            if (status->prop_status != svn_wc_status_none
                && status->prop_status != svn_wc_status_normal)
              {
                apr_array_header_t *propchanges;
                do { svn_error_t *svn_err__temp = (svn_wc__db_base_get_props(&eb->cur->left_props, eb->db, local_abspath, eb->cur->pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



                do { svn_error_t *svn_err__temp = (svn_wc__db_read_props(&eb->cur->right_props, eb->db, local_abspath, eb->cur->pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




                do { svn_error_t *svn_err__temp = (svn_prop_diffs(&propchanges, eb->cur->right_props, eb->cur->left_props, eb->cur->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    if (local_only && (db_status != svn_wc__db_status_deleted))
      {
        if (db_kind == svn_node_file)
          do { svn_error_t *svn_err__temp = (svn_wc__diff_local_only_file(db, child_abspath, child_relpath, eb->processor, eb->cur ? eb->cur->baton : ((void*)0), eb->changelist_hash, 0, eb->cancel_func, eb->cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 410 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
        else if (db_kind == svn_node_dir)
          do { svn_error_t *svn_err__temp = (svn_wc__diff_local_only_dir(db, child_abspath, child_relpath, depth_below_here, eb->processor, eb->cur ? eb->cur->baton : ((void*)0), eb->changelist_hash, 0, eb->cancel_func, eb->cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 420 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
      }
              ...
              apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c", 449, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { svn_error_t *svn_err__temp = (svn_wc__db_read_kind(&kind, wc_ctx->db, local_abspath, 0 , (!0) , 0 , scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (root_relpath)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__db_is_wcroot(&is_wcroot, wc_ctx->db, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (changelist_filter && changelist_filter->nelts)
    do { svn_error_t *svn_err__temp = (svn_hash_from_cstring_keys(&eb.changelist_hash, changelist_filter, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__internal_walk_status(wc_ctx->db, local_abspath, depth, get_all, (!0) , 0 , ((void*)0) , diff_status_callback, &eb, cancel_func, cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
  while (eb.cur)
    {
      struct node_state_t *ns = eb.cur;
      ...
      if (!ns->skip)
        {
          if (ns->propchanges)
            do { svn_error_t *svn_err__temp = (diff_processor->dir_changed(ns->relpath, ns->left_src, ns->right_src, ns->left_props, ns->right_props, ns->propchanges, ns->baton, diff_processor, ns->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 519 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
          else
            do { svn_error_t *svn_err__temp = (diff_processor->dir_closed(ns->relpath, ns->left_src, ns->right_src, ns->baton, diff_processor, ns->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__wrap_diff_callbacks(&processor, callbacks, callback_baton, (!0), scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  return (svn_wc__diff7(((void*)0), ((void*)0), wc_ctx, local_abspath, depth, ignore_ancestry, changelist_filter, processor, cancel_func, cancel_baton, scratch_pool, scratch_pool));
