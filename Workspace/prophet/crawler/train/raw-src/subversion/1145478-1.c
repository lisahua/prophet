...
# 850 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c"
...
subcommand_crashtest(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (open_repos(&repos, opt_state->repository_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c", 1984, ((void*)0))); } while (0);
