...
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         ...
                         apr_pool_t *pool);
# 786 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
# 159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
static svn_error_t *
  ...
  if (lb->show_diff)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_client_diff6(diff_options, lb->target_url, &start_revision, lb->target_url, &end_revision, ((void*)0), lb->depth, 0, (!0), 0, 0, 0, svn_cmdline_output_encoding(pool), outstream, errstream, ((void*)0), lb->ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 318 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 367 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
static svn_error_t *
...
# 673 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
      if (! opt_state->incremental)
...
# 696 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
      if (! opt_state->incremental)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "------------------------------------------------------------------------\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
