...
svn_fs__prop_lists_equal(apr_hash_t *a,
                         apr_hash_t *b,
                         apr_pool_t *pool);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
fs_serialized_init(svn_fs_t *fs, apr_pool_t *common_pool, apr_pool_t *pool)
{
  ...
  apr_status_t status;
# 94 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
  do { if (!(fs->uuid)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c", 94, "fs->uuid")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(ffd->instance_id)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c", 95, "ffd->instance_id")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 318 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
fs_open(svn_fs_t *fs,
        const char *path,
        svn_mutex__t *common_pool_lock,
                     ...
                     apr_pool_t *common_pool)
{
  ...
  apr_pool_t * subpool = svn_pool_create_ex(pool, ((void*)0));
# 366 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
...
# 460 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
