# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
...
# 39 "./subversion/include/svn_ra.h" 2
...
svn_ra_get_ra_library(svn_ra_plugin_t **library,
                      ...
                      const char *url,
                      apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
...
svn_client_export5(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 4614 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_unlock(const apr_array_header_t *targets,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 5113 "./subversion/include/svn_client.h"
...
# 5184 "./subversion/include/svn_client.h"
  apr_size_t size;
...
typedef svn_error_t *(*svn_info_receiver2_t)(void *baton,
                                             ...
                                             apr_pool_t *scratch_pool);
# 5244 "./subversion/include/svn_client.h"
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
...
svn_wc__node_get_commit_status(svn_node_kind_t *kind,
                               ...
                               apr_pool_t *result_pool,
                               apr_pool_t *scratch_pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c" 2
                                ...
                                apr_pool_t *scratch_pool)
{
  switch (revision->kind)
    ...
    case svn_opt_revision_head:
      ...
      if (youngest_rev && ((*youngest_rev) >= 0))
        {
          *revnum = *youngest_rev;
        }
      else
        {
          if (! ra_session)
            return svn_error_create(SVN_ERR_CLIENT_RA_ACCESS_REQUIRED,
                                    ((void*)0), ((void*)0));
          do { svn_error_t *svn_err__temp = (svn_ra_get_latest_revnum(ra_session, revnum, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          if (youngest_rev)
            *youngest_rev = *revnum;
        }
      break;
    ...
    case svn_opt_revision_base:
      {
        ...
        if (! ((*revnum) >= 0))
          return svn_error_createf(SVN_ERR_CLIENT_BAD_REVISION, ((void*)0),
                                   dcgettext ("subversion", "Path '%s' has no committed " "revision", 5), local_abspath);
    ...
    case svn_opt_revision_previous:
      {
        ...
        do { svn_error_t *svn_err__temp = (svn_wc__node_get_changed_info(revnum, ((void*)0), ((void*)0), wc_ctx, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 154 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/revisions.c"
      if (! ra_session)
        return svn_error_create(SVN_ERR_CLIENT_RA_ACCESS_REQUIRED, ((void*)0), ((void*)0));
      do { svn_error_t *svn_err__temp = (svn_ra_get_dated_revision(ra_session, revnum, revision->value.date, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    default:
      return svn_error_createf(SVN_ERR_CLIENT_BAD_REVISION, ((void*)0),
                               dcgettext ("subversion", "Unrecognized revision type requested for " "'%s'", 5),
