...
# 218 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/client-side/svn-bench/null-log-cmd.c"
  if (!opt_state->quiet)
    {
...
# 232 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/client-side/svn-bench/null-log-cmd.c"
      else
