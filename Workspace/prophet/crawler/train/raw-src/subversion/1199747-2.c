# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c" 2
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c"
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c" 2
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/relocate-cmd.c" 2
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__args_to_target_array_print_reserved(&targets, os, opt_state->targets, ctx, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ((targets->nelts == 1) ||
    ...
    {
      to = (((const char * *)(targets)->elts)[0]);
      path = (targets->nelts == 2) ? (((const char * *)(targets)->elts)[1])
                                   : "";

      do { svn_error_t *svn_err__temp = (svn_client_url_from_path2(&from, path, ctx, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { svn_error_t *svn_err__temp = (svn_client_relocate2(path, from, to, ignore_externals, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else
    {
      ...
      if (targets->nelts == 2)
        {
          do { svn_error_t *svn_err__temp = (svn_client_relocate2("", from, to, ignore_externals, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      else
        {
          ...
          for (i = 2; i < targets->nelts; i++)
            {
              path = (((const char * *)(targets)->elts)[i]);
              do { svn_error_t *svn_err__temp = (svn_cl__check_target_is_local_path(path)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
          ...
          for (i = 2; i < targets->nelts; i++)
            {
              ...
              path = (((const char * *)(targets)->elts)[i]);
              do { svn_error_t *svn_err__temp = (svn_client_relocate2(path, from, to, ignore_externals, ctx, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
