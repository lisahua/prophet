# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c"
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c" 2


# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff.h" 1
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff.h"
# 1 "./subversion/include/svn_diff.h" 1
# 53 "./subversion/include/svn_diff.h"
...
# 54 "./subversion/include/svn_diff.h" 2
...
# 59 "./subversion/include/svn_diff.h" 2
...
svn_diff_close_patch_file(svn_patch_file_t *patch_file,
                          apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff.h" 2
...
svn_diff__unified_write_hunk_header(svn_stream_t *output_stream,
                                    ...
                                    apr_pool_t *scratch_pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c" 2
# 73 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c"
            ...
            apr_pool_t *pool)
{
  ...
  do { if (!(lines > 0)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c", 216, "lines > 0"); abort(); } } while (0);

  new_lcs = apr_palloc(pool, sizeof(*new_lcs));
  new_lcs->position[0] = memset(apr_palloc(pool, sizeof(*new_lcs->position[0])), 0, sizeof(*new_lcs->position[0]));
  new_lcs->position[0]->offset = pos0_offset;
  new_lcs->position[1] = memset(apr_palloc(pool, sizeof(*new_lcs->position[1])), 0, sizeof(*new_lcs->position[1]));
              ...
              apr_pool_t *pool)
{
  ...
  lcs = apr_palloc(pool, sizeof(*lcs));
  lcs->position[0] = memset(apr_palloc(pool, sizeof(*lcs->position[0])), 0, sizeof(*lcs->position[0]));
  lcs->position[0]->offset = position_list1
                             ? position_list1->offset + suffix_lines + 1
                             : prefix_lines + suffix_lines + 1;
  lcs->position[1] = memset(apr_palloc(pool, sizeof(*lcs->position[1])), 0, sizeof(*lcs->position[1]));
  ...
  fp = memset(apr_palloc(pool, sizeof(*fp) * (apr_size_t)(length[0] + length[1] + 3)), 0, sizeof(*fp) * (apr_size_t)(length[0] + length[1] + 3));
# 311 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/lcs.c"
  fp += length[1] + 1;
