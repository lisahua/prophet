# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/home/ubuntu/Workspace/utils/llvm-build/bin/../lib/clang/3.5.0/include/stddef.h" 1 3 4
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
svn_wc__db_get_not_present_descendants(const apr_array_header_t **descendants,
                                       ...
                                       apr_pool_t *result_pool,
                                       apr_pool_t *scratch_pool);
# 3317 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_revision_status(svn_revnum_t *min_revision,
                           ...
                           void *cancel_baton,
                           apr_pool_t *scratch_pool);
# 3345 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_min_max_revisions(svn_revnum_t *min_revision,
                             ...
                             svn_boolean_t committed,
                             apr_pool_t *scratch_pool);
# 3365 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_has_switched_subtrees(svn_boolean_t *is_switched,
                                 ...
                                 const char *trail_url,
                                 apr_pool_t *scratch_pool);
# 3379 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_resolve_delete_raise_moved_away(svn_wc__db_t *db,
                                           ...
                                           void *notify_baton,
                                           apr_pool_t *scratch_pool);
# 3479 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__node_has_local_mods(svn_boolean_t *modified,
                            ...
                            void *cancel_baton,
                            apr_pool_t *scratch_pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
svn_wc__adm_cleanup_tmp_area(svn_wc__db_t *db,
                             ...
                             apr_pool_t *scratch_pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
svn_wc__wq_build_postupgrade(svn_skel_t **work_item,
                             apr_pool_t *scratch_pool);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2

# 1 "./subversion/svn_private_config.h" 1
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
svn_stream__install_get_info(apr_finfo_t *finfo,
                             ...
                             apr_int32_t wanted,
                             apr_pool_t *scratch_pool);
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
...
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c" 2
# 102 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c"
static svn_error_t *
...
# 149 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c"
static svn_error_t *
...
revert_wc_data(svn_boolean_t *run_wq,
               ...
               void *cancel_baton,
               apr_pool_t *scratch_pool);
# 280 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c"
static svn_error_t *
               ...
               apr_pool_t *scratch_pool)
{
  ...
  if (!metadata_only)
    {
      do { svn_error_t *svn_err__temp = (revert_wc_data(run_wq, &notify_required, db, local_abspath, status, kind, reverted_kind, recorded_size, recorded_time, copied_here, use_commit_times, cancel_func, cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (depth == svn_depth_infinity && kind == svn_node_dir)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__db_read_children_info(&children, &conflicts, db, local_abspath, 0, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (hi = apr_hash_first(scratch_pool, children);
           ...
           hi = apr_hash_next(hi))
        {
          ...
          do { svn_error_t *svn_err__temp = (revert_restore(run_wq, db, child_abspath, depth, metadata_only, use_commit_times, 0 , apr_hash_this_val(hi), cancel_func, cancel_baton, notify_func, notify_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (notify_func)
        do { svn_error_t *svn_err__temp = (svn_wc__db_revert_list_notify(notify_func, notify_baton, db, local_abspath, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      && status != svn_wc__db_status_not_present)
    {
      if (on_disk == svn_node_dir && kind != svn_node_dir)
      ...
      else if (on_disk == svn_node_file)
        {
          ...
          special_prop = apr_hash_get(props, "svn:" "special", (-1));
          ...
          if ((special_prop != ((void*)0)) != special)
            ...
            {
# 596 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c"
              ...
              else
                {
                  if (status == svn_wc__db_status_normal)
                    {
                      ...
                      needs_lock_prop = apr_hash_get(props, "svn:" "needs-lock", (-1));
                  ...
                  if (!special)

                    {
                      ...
                      executable_prop = apr_hash_get(props, "svn:" "executable", (-1));
       ...
       apr_pool_t *scratch_pool)
{
  ...
  svn_boolean_t run_queue = 0;

  do { if (!(depth == svn_depth_empty || depth == svn_depth_infinity)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c", 721, "depth == svn_depth_empty || depth == svn_depth_infinity")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  err = (svn_wc__db_op_revert(db, local_abspath, depth, clear_changelists, scratch_pool, scratch_pool));



  if (!err)
    {
      err = (svn_wc__db_read_single_info(&info, db, local_abspath, 0, scratch_pool, scratch_pool));
  ...
  if (!err)
    err = (revert_restore(&run_queue, db, local_abspath, depth, metadata_only, use_commit_times, (!0) , info, cancel_func, cancel_baton, notify_func, notify_baton, scratch_pool));
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  if (svn_wc__internal_changelist_match(db, local_abspath, changelist_hash,
                                        scratch_pool))
    do { svn_error_t *svn_err__temp = (revert(db, local_abspath, svn_depth_empty, use_commit_times, clear_changelists, metadata_only, cancel_func, cancel_baton, notify_func, notify_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < children->nelts; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (revert_changelist(db, child_abspath, depth, use_commit_times, changelist_hash, clear_changelists, metadata_only, cancel_func, cancel_baton, notify_func, notify_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 863 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c"
static svn_error_t *
               ...
               apr_pool_t *scratch_pool)
{
  ...
  do { if (!(depth == svn_depth_files || depth == svn_depth_immediates)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c", 880, "depth == svn_depth_files || depth == svn_depth_immediates")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (revert(db, local_abspath, svn_depth_empty, use_commit_times, clear_changelists, metadata_only, cancel_func, cancel_baton, notify_func, notify_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < children->nelts; ++i)
    {
      ...
      if (depth == svn_depth_files)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__db_read_kind(&kind, db, child_abspath, 0 , (!0) , 0 , iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (revert(db, child_abspath, svn_depth_empty, use_commit_times, clear_changelists, metadata_only, cancel_func, cancel_baton, notify_func, notify_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *scratch_pool)
{
  if (changelist_filter && changelist_filter->nelts)
    {
      ...
      return (revert_changelist(wc_ctx->db, local_abspath, depth, use_commit_times, changelist_hash, clear_changelists, metadata_only, cancel_func, cancel_baton, notify_func, notify_baton, scratch_pool));
  ...
  if (depth == svn_depth_empty || depth == svn_depth_infinity)
    return (revert(wc_ctx->db, local_abspath, depth, use_commit_times, clear_changelists, metadata_only, cancel_func, cancel_baton, notify_func, notify_baton, scratch_pool));
# 981 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/revert.c"
  if (depth == svn_depth_files || depth == svn_depth_immediates)
    return (revert_partial(wc_ctx->db, local_abspath, depth, use_commit_times, clear_changelists, metadata_only, cancel_func, cancel_baton, notify_func, notify_baton, scratch_pool));
