# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
...
svn_io_file_readline(apr_file_t *file,
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
...
svn_mutex__unlock(svn_mutex__t *mutex,
                  svn_error_t *err);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.h" 1
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.h"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/server.h" 1
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/server.h"
...
apr_status_t apr_mcast_interface(apr_socket_t *sock,
                                              apr_sockaddr_t *iface);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/server.h" 2
...
svn_config_copy_config(apr_hash_t **cfg_hash,
                       apr_hash_t *src_hash,
                       apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/server.h" 2
...
svn_repos_check_revision_access(svn_repos_revision_access_level_t *access_level,
                                ...
                                void *authz_read_baton,
                                apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/server.h" 2
...
svn_ra_svn_write_cmd_failure(svn_ra_svn_conn_t *conn,
                             apr_pool_t *pool,
                             svn_error_t *err);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/server.h" 2
...
apr_size_t escape_errorlog_item(char *dest, const char *source,
                                apr_size_t buflen);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.h" 2
...
logger__log_error(logger_t *logger,
                  ...
                  repository_t *repository,
                  client_info_t *client_info);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/logger.c" 2
...
logger__create_for_stderr(logger_t **logger,
                          apr_pool_t *pool)
{
  logger_t *result = memset(apr_palloc(pool, sizeof(*result)), 0, sizeof(*result));
  result->pool = svn_pool_create_ex(pool, ((void*)0));

  do { svn_error_t *svn_err__temp = (svn_stream_for_stderr(&result->stream, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_mutex__init(&result->mutex, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_open(&file, filename, 0x00002 | 0x00004 | 0x00008, 0x0FFF, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_mutex__init(&result->mutex, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  result->stream = svn_stream_from_aprfile2(file, 0, pool);
  result->pool = svn_pool_create_ex(pool, ((void*)0));
  ...
  if (logger && err)
    {
      ...
      apr_pool_clear(logger->pool);

      svn_error_clear(svn_mutex__unlock(logger->mutex, 0));
    }
}
...
logger__write(logger_t *logger,
              ...
              apr_size_t len)
{
  do { svn_mutex__t *svn_mutex__m = (logger->mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (svn_stream_write(logger->stream, errstr, &len)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
