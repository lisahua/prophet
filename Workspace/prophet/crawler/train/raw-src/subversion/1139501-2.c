# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
# 1 "./subversion/include/svn_delta.h" 1
# 34 "./subversion/include/svn_delta.h"
...
# 35 "./subversion/include/svn_delta.h" 2
...
# 36 "./subversion/include/svn_delta.h" 2
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/delta.h" 1
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/delta.h"
...
void svn_txdelta__xdelta(svn_txdelta__ops_baton_t *build_baton,
                         ...
                         apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
...
# 88 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
...
encode_int(unsigned char *p, svn_filesize_t val)
{
  ...
  do { if (!(val >= 0)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 95, "val >= 0"); abort(); } } while (0);
  ...
  do { if (!(n <= 10)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 106, "n <= MAX_ENCODED_INT_LEN"); abort(); } } while (0);
  ...
  else
    {
      ...
      if (compress2((unsigned char *)out->data + intlen, &endlen,
        ...
        return svn_error_create(SVN_ERR_SVNDIFF_INVALID_COMPRESSED_DATA,
                                ((void*)0),
                                dcgettext ("subversion", "Compression of svndiff data failed", 5));
...
window_handler(svn_txdelta_window_t *window, void *baton)
{
  ...
  apr_pool_t *pool = svn_pool_create_ex(eb->pool, ((void*)0));
  ...
  if (eb->header_done == 0)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_write(eb->output, svnver, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
      eb->header_done = (!0);
    }
...
# 219 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
  ...
  if (eb->version == 1)
    {
      do { svn_error_t *svn_err__temp = (zlib_encode(instructions->data, instructions->len, i1, eb->compression_level)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (eb->version == 1)
    {
      ...
      do { svn_error_t *svn_err__temp = (zlib_encode(window->new_data->data, window->new_data->len, temp, eb->compression_level)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  len = header->len;
  do { svn_error_t *svn_err__temp = (svn_stream_write(eb->output, header->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (instructions->len > 0)
    {
      len = instructions->len;
      do { svn_error_t *svn_err__temp = (svn_stream_write(eb->output, instructions->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  if (newdata->len > 0)
    {
      len = newdata->len;
      do { svn_error_t *svn_err__temp = (svn_stream_write(eb->output, newdata->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 379 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
...
zlib_decode(svn_stringbuf_t *in, svn_stringbuf_t *out, apr_size_t limit)
{
  ...
  if (in->data == ((void*)0))
    return svn_error_create(SVN_ERR_SVNDIFF_INVALID_COMPRESSED_DATA, ((void*)0),
                            dcgettext ("subversion", "Decompression of svndiff data failed: no size", 5));
  if (len > limit)
    return svn_error_create(SVN_ERR_SVNDIFF_INVALID_COMPRESSED_DATA, ((void*)0),
                            dcgettext ("subversion", "Decompression of svndiff data failed: " "size too large", 5));
  ...
  if (in->len == len)
  ...
  else
    {
      ...
      if (uncompress ((unsigned char *)out->data, &zliblen,
                       (const unsigned char *)in->data, in->len) != 0)
        return svn_error_create(SVN_ERR_SVNDIFF_INVALID_COMPRESSED_DATA,
                                ((void*)0),
                                dcgettext ("subversion", "Decompression of svndiff data failed", 5));
      ...
      if (zliblen != len)
        return svn_error_create(SVN_ERR_SVNDIFF_INVALID_COMPRESSED_DATA,
                                ((void*)0),
                                dcgettext ("subversion", "Size of uncompressed data " "does not match stored original length", 5));
                              ...
                              apr_size_t new_len)
{
      ...
      if (p == ((void*)0))
        return svn_error_createf
          (SVN_ERR_SVNDIFF_INVALID_OPS, ((void*)0),
           dcgettext ("subversion", "Invalid diff stream: insn %d cannot be decoded", 5), n);
      else if (op.length == 0)
        return svn_error_createf
          (SVN_ERR_SVNDIFF_INVALID_OPS, ((void*)0),
           dcgettext ("subversion", "Invalid diff stream: insn %d has length zero", 5), n);
      else if (op.length > tview_len - tpos)
        return svn_error_createf
          (SVN_ERR_SVNDIFF_INVALID_OPS, ((void*)0),
           dcgettext ("subversion", "Invalid diff stream: insn %d overflows the target view", 5), n);
      ...
      switch (op.action_code)
        ...
        case svn_txdelta_source:
          if (op.length > sview_len - op.offset ||
            ...
            return svn_error_createf
              (SVN_ERR_SVNDIFF_INVALID_OPS, ((void*)0),
               dcgettext ("subversion", "Invalid diff stream: " "[src] insn %d overflows the source view", 5), n);
        ...
        case svn_txdelta_target:
          if (op.offset >= tpos)
            return svn_error_createf
              (SVN_ERR_SVNDIFF_INVALID_OPS, ((void*)0),
               dcgettext ("subversion", "Invalid diff stream: " "[tgt] insn %d starts beyond the target view position", 5), n);
        ...
        case svn_txdelta_new:
          if (op.length > new_len - npos)
            return svn_error_createf
              (SVN_ERR_SVNDIFF_INVALID_OPS, ((void*)0),
               dcgettext ("subversion", "Invalid diff stream: " "[new] insn %d overflows the new data section", 5), n);
  ...
  if (tpos != tview_len)
    return svn_error_create(SVN_ERR_SVNDIFF_INVALID_OPS, ((void*)0),
                            dcgettext ("subversion", "Delta does not fill the target window", 5));
  if (npos != new_len)
    return svn_error_create(SVN_ERR_SVNDIFF_INVALID_OPS, ((void*)0),
                            dcgettext ("subversion", "Delta does not contain enough new data", 5));
              ...
              unsigned int version)
{
  ...
  if (version == 1)
    {
      ...
      do { svn_error_t *svn_err__temp = (zlib_decode(instin, instout, (102400*(2*10 +1)))); if (svn_err__temp) return (svn_err__temp); } while (0);

      ndin = svn_stringbuf_ncreate((const char *)insend, newlen, pool);
      ndout = svn_stringbuf_create("", pool);
      do { svn_error_t *svn_err__temp = (zlib_decode(ndin, ndout, 102400)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (count_and_verify_instructions(&ninst, data, insend, sview_len, tview_len, newlen)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { if (!(data == insend)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 673, "data == insend")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (db->header_bytes < 4)
    {
      ...
      if (memcmp(buffer, "SVN\0" + db->header_bytes, nheader) == 0)
        ...
        return svn_error_create(SVN_ERR_SVNDIFF_INVALID_HEADER, ((void*)0),
                                dcgettext ("subversion", "Svndiff has invalid header", 5));
      buflen -= nheader;
      buffer += nheader;
...
# 726 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
  while (1)
    {
      apr_pool_t *newpool;
      ...
      if (tview_len > 102400 ||
          ...
          newlen > 102400 + 10 ||
          inslen > (102400*(2*10 +1)))
        return svn_error_create(SVN_ERR_SVNDIFF_CORRUPT_WINDOW, ((void*)0),
                                dcgettext ("subversion", "Svndiff contains a too-large window", 5));
      ...
      if (sview_offset < 0 || inslen + newlen < inslen
        ...
        return svn_error_create(SVN_ERR_SVNDIFF_CORRUPT_WINDOW, ((void*)0),
                                dcgettext ("subversion", "Svndiff contains corrupt window header", 5));
      ...
      if (sview_len > 0
        ...
        return svn_error_create
          (SVN_ERR_SVNDIFF_BACKWARD_VIEW, ((void*)0),
           dcgettext ("subversion", "Svndiff has backwards-sliding source views", 5));
      ...
      do { svn_error_t *svn_err__temp = (decode_window(&window, sview_offset, sview_len, tview_len, inslen, newlen, p, db->subpool, db->version)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (db->consumer_func(&window, db->consumer_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);



      newpool = svn_pool_create_ex(db->pool, ((void*)0));
      p += inslen + newlen;
...
close_handler(void *baton)
{
  ...
  if ((db->error_on_early_close)
    ...
    return svn_error_create(SVN_ERR_SVNDIFF_UNEXPECTED_END, ((void*)0),
                            dcgettext ("subversion", "Unexpected end of svndiff input", 5));
                          ...
                          apr_pool_t *pool)
{
  ...
  db->pool = subpool;
  db->subpool = svn_pool_create_ex(subpool, ((void*)0));
...
read_one_size(apr_size_t *size, svn_stream_t *stream)
{
  ...
  *size = 0;
  while (1)
    {
      do { svn_error_t *svn_err__temp = (read_one_byte(&c, stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
      *size = (*size << 7) | (c & 0x7f);
      if (!(c & 0x80))
        break;
    }
                   ...
                   apr_size_t *inslen, apr_size_t *newlen)
{
  ...
  *sview_offset = 0;
  ...
  do { svn_error_t *svn_err__temp = (read_one_size(sview_len, stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (read_one_size(tview_len, stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (read_one_size(inslen, stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (read_one_size(newlen, stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                ...
                                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (read_window_header(stream, &sview_offset, &sview_len, &tview_len, &inslen, &newlen)); if (svn_err__temp) return (svn_err__temp); } while (0);

  len = inslen + newlen;
  buf = apr_palloc(pool, len);
  do { svn_error_t *svn_err__temp = (svn_stream_read(stream, (char*)buf, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_txdelta_skip_svndiff_window(apr_file_t *file,
                                ...
                                apr_pool_t *pool)
{
  svn_stream_t *stream = svn_stream_from_aprfile2(file, (!0), pool);
  svn_filesize_t sview_offset;
  ...
  return svn_io_file_seek(file, 1, &offset, pool);
}
