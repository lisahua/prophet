...
# 186 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__create_inprocess(svn_cache__t **cache_p,
                            ...
                            const char *id,
                            apr_pool_t *pool);
# 217 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
svn_cache__make_memcache_from_config(svn_memcache_t **memcache_p,
                                     svn_config_t *config,
                                     apr_pool_t *pool);
# 257 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__membuffer_cache_create(svn_membuffer_t **cache,
                                  ...
                                  svn_boolean_t thread_safe,
                                  apr_pool_t *pool);
# 283 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__create_membuffer_cache(svn_cache__t **cache_p,
                                  ...
                                  const char *prefix,
                                  apr_pool_t *pool);
# 301 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__set_error_handler(svn_cache__t *cache,
                             svn_cache__error_handler_t handler,
                             void *baton,
                             apr_pool_t *pool);
# 314 "./subversion/include/private/svn_cache.h"
svn_boolean_t
svn_cache__is_cachable(svn_cache__t *cache,
                       apr_size_t size);
# 326 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
svn_cache__set(svn_cache__t *cache,
               ...
               void *value,
               apr_pool_t *pool);
# 371 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
# 313 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.h"
  ...
  const char *txn_id;
# 339 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.h"
...
svn_error_t *svn_fs_fs__set_entry(svn_fs_t *fs,
                                  ...
                                  svn_node_kind_t kind,
                                  apr_pool_t *pool);
# 265 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs_fs.h"
...
svn_error_t *svn_fs_fs__move_into_place(const char *old_filename,
                                        ...
                                        apr_pool_t *pool);
# 416 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs_fs.h"
svn_error_t *
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
               ...
               apr_pool_t *pool)
{
  if (cache != ((void*)0))
    {
# 135 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
      if (! no_handler)
...
# 168 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  if (svn_fs__get_global_membuffer_cache())
      do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->rev_root_id_cache), svn_fs__get_global_membuffer_cache(), svn_fs_fs__serialize_id, svn_fs_fs__deserialize_id, sizeof(svn_revnum_t), apr_pstrcat(pool, prefix, "RRI", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  ...
  if (svn_fs__get_global_membuffer_cache())
    do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->rev_node_cache), svn_fs__get_global_membuffer_cache(), svn_fs_fs__dag_serialize, svn_fs_fs__dag_deserialize, (-1), apr_pstrcat(pool, prefix, "DAG", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 210 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  ...
  if (svn_fs__get_global_membuffer_cache())
    do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->dir_cache), svn_fs__get_global_membuffer_cache(), svn_fs_fs__serialize_dir_entries, svn_fs_fs__deserialize_dir_entries, (-1), apr_pstrcat(pool, prefix, "DIR", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 232 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
...
# 255 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  ...
  if (memcache)
    ...
    {
      do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->fulltext_cache), svn_fs__get_global_membuffer_cache(), ((void*)0), ((void*)0), (-1), apr_pstrcat(pool, prefix, "TEXT", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (svn_fs__get_global_membuffer_cache() &&
    ...
    {
      do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache (&(ffd->txdelta_window_cache), svn_fs__get_global_membuffer_cache(), svn_fs_fs__serialize_txdelta_window, svn_fs_fs__deserialize_txdelta_window, (-1), apr_pstrcat(pool, prefix, "TXDELTA_WINDOW", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (svn_fs__get_global_membuffer_cache())
    {
      do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->node_revision_cache), svn_fs__get_global_membuffer_cache(), svn_fs_fs__serialize_node_revision, svn_fs_fs__deserialize_node_revision, (-1), apr_pstrcat(pool, prefix, "NODEREVS", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 321 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
    }
  else
    {
