# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/compat_providers.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/compat_providers.c" 2
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/compat_providers.c"
# 1 "./subversion/include/svn_auth.h" 1
# 30 "./subversion/include/svn_auth.h"
...
# 31 "./subversion/include/svn_auth.h" 2
...
# 32 "./subversion/include/svn_auth.h" 2
...
svn_auth_get_ssl_client_cert_pw_prompt_provider(
  ...
  int retry_limit,
  apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/compat_providers.c" 2
...
svn_ra_get_commit_editor2(svn_ra_session_t *session,
                          ...
                          svn_boolean_t keep_locks,
                          apr_pool_t *pool);
# 1055 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_ra_do_update3(svn_ra_session_t *session,
                  ...
                  apr_pool_t *result_pool,
                  apr_pool_t *scratch_pool);
# 1272 "./subversion/include/svn_ra.h"
svn_error_t *
svn_ra_do_update2(svn_ra_session_t *session,
                  ...
                  void *update_baton,
                  apr_pool_t *pool);
# 1293 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_ra_do_switch2(svn_ra_session_t *session,
                  ...
                  void *switch_baton,
                  apr_pool_t *pool);
# 1363 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_ra_do_status2(svn_ra_session_t *session,
                  ...
                  void *status_baton,
                  apr_pool_t *pool);
# 1438 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_ra_do_diff3(svn_ra_session_t *session,
                ...
                void *diff_baton,
                apr_pool_t *pool);
# 1530 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_ra_get_repos_root2(svn_ra_session_t *session,
                       const char **url,
                       apr_pool_t *pool);
# 1762 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_wc_conflict_version_create2(const char *repos_root_url,
                                ...
                                svn_node_kind_t kind,
                                apr_pool_t *result_pool);
# 1732 "./subversion/include/svn_wc.h"
svn_wc_conflict_version_t *
...
svn_wc_conflict_description_create_prop3(const char *local_abspath,
                                         ...
                                         const char *property_name,
                                         apr_pool_t *result_pool);
# 2117 "./subversion/include/svn_wc.h"
svn_wc_conflict_description2_t *
...
svn_wc_conflict_description_create_tree2(
  ...
  const svn_wc_conflict_version_t *src_right_version,
  apr_pool_t *result_pool);
# 2186 "./subversion/include/svn_wc.h"
svn_wc_conflict_description_t *
...
svn_wc_walk_entries3(const char *path,
                     ...
                     void *cancel_baton,
                     apr_pool_t *pool);
# 3541 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_status_editor5(const svn_delta_editor_t **editor,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 4391 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_update_editor4(const svn_delta_editor_t **editor,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 5948 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_create_tmp_file2(apr_file_t **fp,
                        ...
                        svn_io_file_del_t delete_when,
                        apr_pool_t *pool);
# 7773 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_translated_file(const char **xlated_p,
                       ...
                       apr_pool_t *pool);
# 7864 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_ignores2(apr_array_header_t **patterns,
                    ...
                    apr_pool_t *result_pool,
                    apr_pool_t *scratch_pool);
# 8034 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_set_changelist2(svn_wc_context_t *wc_ctx,
                       ...
                       void *notify_baton,
                       apr_pool_t *scratch_pool);
# 8248 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_read_kind2(svn_node_kind_t *kind,
                  ...
                  svn_boolean_t show_hidden,
                  apr_pool_t *scratch_pool);
# 8423 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_diff_file_output_unified4(svn_stream_t *output_stream,
                              ...
                              void *cancel_baton,
                              apr_pool_t *scratch_pool);
# 638 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_file_output_merge2(svn_stream_t *output_stream,
                            ...
                            apr_pool_t *pool);
# 724 "./subversion/include/svn_diff.h"
svn_error_t *
...
# 616 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_commit_item3_dup(const svn_client_commit_item3_t *item,
                            apr_pool_t *pool);
# 638 "./subversion/include/svn_client.h"
svn_client_commit_item2_t *
...
svn_client_args_to_target_array2(apr_array_header_t **targets_p,
                                 ...
                                 apr_pool_t *pool);
# 1150 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_update2(apr_array_header_t **result_revs,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 1409 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_add5(const char *path,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *scratch_pool);
# 1621 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_add4(const char *path,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 1638 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_add3(const char *path,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 1653 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_mkdir3(svn_commit_info_t **commit_info_p,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 1751 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_mkdir2(svn_commit_info_t **commit_info_p,
                  const apr_array_header_t *paths,
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 1764 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_import3(svn_commit_info_t **commit_info_p,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2051 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_import2(svn_commit_info_t **commit_info_p,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2068 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_commit6(const apr_array_header_t *targets,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2188 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_status2(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2639 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_log4(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 2773 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_diff6(const apr_array_header_t *diff_options,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 3115 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_mergeinfo_log2(svn_boolean_t finding_merged,
                          ...
                          svn_client_ctx_t *ctx,
                          apr_pool_t *scratch_pool);
# 4024 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_copy6(const apr_array_header_t *sources,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4502 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_propset2(const char *propname,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 4966 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_list3(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 5654 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_cat3(apr_hash_t **props,
                ...
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 5803 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_info4(const char *abspath_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *scratch_pool);
# 6306 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_info3(const char *abspath_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *scratch_pool);
# 6326 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_info2(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 6345 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_get_repos_root(const char **repos_root_url,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 6567 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_root_url_from_path(const char **url,
                              const char *path_or_url,
                              svn_client_ctx_t *ctx,
                              apr_pool_t *pool);
# 6584 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_open_ra_session2(svn_ra_session_t **session,
                           ...
                           apr_pool_t *result_pool,
                           apr_pool_t *scratch_pool);
# 6653 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_open_ra_session(svn_ra_session_t **session,
                           const char *url,
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/compat_providers.c" 2
...
# 78 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/compat_providers.c"
