# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/atomic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/atomic.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/atomic.c"
# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_time.h" 1
# 25 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_time.h"
...
# 26 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_time.h" 2
...
# 27 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_time.h" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/atomic.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/atomic.c" 2
                      ...
                      svn_error_t *(*init_func)(apr_pool_t*), apr_pool_t* pool)
{
  ...
  apr_uint32_t status = apr_atomic_cas32((global_status), (1), (0));
  ...
  if (status == 0)
      ...
      if (err)
        {
          ...
          apr_atomic_cas32((global_status), (2), (1));



          return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/atomic.c",54), (svn_error_create))(SVN_ERR_ATOMIC_INIT_FAILURE, err,
                                  "Couldn't perform atomic initialization");
        }
      apr_atomic_cas32((global_status), (3), (1));
    ...
    {
      if (status == 2)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/atomic.c",68), (svn_error_create))(SVN_ERR_ATOMIC_INIT_FAILURE, ((void*)0),
                                "Couldn't perform atomic initialization");

      apr_sleep(1000000L / 1000);
      status = apr_atomic_cas32((global_status), (0), (0));
