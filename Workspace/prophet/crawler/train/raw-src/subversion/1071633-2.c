# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/blame-cmd.c" 2
                   ...
                   apr_pool_t *pool)
{
  ...
  if (opt_state->use_merge_history && ((merged_revision) >= 0))
    {

      svn_xml_make_open_tag(&sb, pool, svn_xml_normal, "merged",
                            "path", merged_path, ((void*)0));
  ...
  if (verbose)
    {
      if (date)
        {
          do { svn_error_t *svn_err__temp = (svn_cl__time_cstring_to_human_cstring(&time_utf8, date, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          do { svn_error_t *svn_err__temp = (svn_cmdline_cstring_from_utf8(&time_stdout, time_utf8, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_printf(out, pool, "%s %10s %s ", rev_str, author ? author : "         -", time_stdout)); if (svn_err__temp) return (svn_err__temp); } while (0);



      if (path)
        do { svn_error_t *svn_err__temp = (svn_stream_printf(out, pool, "%-14s ", path)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
    {
               ...
               apr_pool_t *pool)
{
  ...
  if (opt_state->use_merge_history)
    {
      ...
      if (merged_revision < revision)
        {
          do { svn_error_t *svn_err__temp = (svn_stream_printf(out, pool, "G ")); if (svn_err__temp) return (svn_err__temp); } while (0);
          use_merged = (!0);
        }
      else
        do { svn_error_t *svn_err__temp = (svn_stream_printf(out, pool, "  ")); if (svn_err__temp) return (svn_err__temp); } while (0);
    }

  if (use_merged)
    do { svn_error_t *svn_err__temp = (print_line_info(out, merged_revision, svn_prop_get_value(merged_rev_props, "svn:" "author"), svn_prop_get_value(merged_rev_props, "svn:" "date"), merged_path, opt_state->verbose, end_revnum, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (print_line_info(out, revision, svn_prop_get_value(rev_props, "svn:" "author"), svn_prop_get_value(rev_props, "svn:" "date"), ((void*)0), opt_state->verbose, end_revnum, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  return svn_stream_printf(out, pool, "%s%s", line, "\n");
}
              ...
              apr_pool_t *pool)
{
  ...
  blame_baton_t bl;
  int i;
  svn_boolean_t end_revision_unspecified = 0;
  ...
  if (! opt_state->xml)
    do { svn_error_t *svn_err__temp = (svn_stream_for_stdout(&bl.out, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
  ...
  if (opt_state->extensions)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_diff_file_options_parse(diff_options, opts, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  ...
  if (opt_state->xml)
    {
      ...
      if (! opt_state->incremental)
        do { svn_error_t *svn_err__temp = (svn_cl__xml_print_header("blame", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
    {
      if (opt_state->incremental)
      ...
      if (err)
        {
          if (err->apr_err == SVN_ERR_CLIENT_IS_BINARY_FILE)
            {
              svn_error_clear(err);
              do { svn_error_t *svn_err__temp = (svn_cmdline_fprintf(stderr, subpool, dcgettext ("subversion", "Skipping binary file: '%s'\n", 5), target)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      else if (opt_state->xml)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_cl__error_checked_fputs(bl.sbuf->data, stdout)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
  ...
  if (opt_state->xml && ! opt_state->incremental)
    do { svn_error_t *svn_err__temp = (svn_cl__xml_print_footer("blame", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (seen_nonexistent_target)
    return svn_error_create(
      SVN_ERR_ILLEGAL_TARGET, ((void*)0),
      dcgettext ("subversion", "Could not perform blame on all targets because some " "targets don't exist", 5));
