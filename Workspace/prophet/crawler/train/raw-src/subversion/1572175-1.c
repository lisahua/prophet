# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/home/ubuntu/Workspace/utils/llvm-build/bin/../lib/clang/3.5.0/include/stddef.h" 1 3 4
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c" 2
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c"
int
svn_sort_compare_items_as_paths(const svn_sort__item_t *a,
                                const svn_sort__item_t *b)
{
  ...
  astr = a->key;
  bstr = b->key;
  ((astr[a->klen] == '\0') ? (void) (0) : __assert_fail ("astr[a->klen] == '\\0'", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c", 76, __PRETTY_FUNCTION__));
  ((bstr[b->klen] == '\0') ? (void) (0) : __assert_fail ("bstr[b->klen] == '\\0'", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c", 77, __PRETTY_FUNCTION__));
...
# 192 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c"
static int
                    ...
                    int (*compare_func)(const void *, const void *))
{
  ...
  ((lower == upper + 1) ? (void) (0) : __assert_fail ("lower == upper + 1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c", 213, __PRETTY_FUNCTION__));
                       ...
                       int insert_index)
{
  ...
  ((0 <= insert_index && insert_index <= array->nelts) ? (void) (0) : __assert_fail ("0 <= insert_index && insert_index <= array->nelts", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c", 270, __PRETTY_FUNCTION__));
      ...
      for (i = 0; i < array->nelts / 2; i++)
        {
          ...
          void *tmp = (((void * *)(array)->elts)[i]);

          (((void * *)(array)->elts)[i]) =
            (((void * *)(array)->elts)[swap_index]);
          (((void * *)(array)->elts)[swap_index]) = tmp;
        }
    }
  else
    {
             ...
             apr_size_t rhs)
{
  ...
  ((lhs < (apr_size_t)queue->elements->nelts) ? (void) (0) : __assert_fail ("lhs < (apr_size_t)queue->elements->nelts", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c", 372, __PRETTY_FUNCTION__));
  ((rhs < (apr_size_t)queue->elements->nelts) ? (void) (0) : __assert_fail ("rhs < (apr_size_t)queue->elements->nelts", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c", 373, __PRETTY_FUNCTION__));
                           ...
                           int (*compare_func)(const void *, const void *))
{
  ...
  svn_priority_queue__t *queue = memset(apr_palloc(elements->pool, sizeof(*queue)), 0, sizeof(*queue));
                         ...
                         const void *element)
{
  ...
  ((element && element != queue->elements->elts) ? (void) (0) : __assert_fail ("element && element != queue->elements->elts", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sorts.c", 488, __PRETTY_FUNCTION__));
