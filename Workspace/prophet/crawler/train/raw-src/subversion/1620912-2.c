# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/home/ubuntu/Workspace/utils/llvm-build/bin/../lib/clang/3.5.0/include/stddef.h" 1 3 4
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c" 2
...
# 29 "./subversion/include/private/svn_fs_fs_private.h"
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 30 "./subversion/include/private/svn_fs_fs_private.h" 2
...
svn_atomic__init_once(volatile apr_uint32_t *global_status,
                      ...
                      void *baton,
                      apr_pool_t* pool);
# 32 "./subversion/include/private/svn_fs_fs_private.h" 2
...
# 33 "./subversion/include/private/svn_fs_fs_private.h" 2
...
svn_mutex__unlock(svn_mutex__t *mutex,
                  svn_error_t *err);
# 34 "./subversion/include/private/svn_fs_fs_private.h" 2
...
svn_named_atomic__cmpxchg(apr_int64_t *old_value,
                          ...
                          svn_named_atomic__t *atomic);
# 35 "./subversion/include/private/svn_fs_fs_private.h" 2
...
svn_sqlite__hotcopy(const char *src_path,
                    const char *dst_path,
                    apr_pool_t *scratch_pool);
# 36 "./subversion/include/private/svn_fs_fs_private.h" 2
# 54 "./subversion/include/private/svn_fs_fs_private.h"
...
# 114 "./subversion/include/private/svn_fs_fs_private.h"
...
# 350 "./subversion/include/private/svn_fs_fs_private.h"
...
svn_fs_fs__open_pack_or_rev_file(svn_fs_fs__revision_file_t **file,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 420 "./subversion/include/private/svn_fs_fs_private.h"
svn_error_t *
...
# 471 "./subversion/include/private/svn_fs_fs_private.h"
...
# 500 "./subversion/include/private/svn_fs_fs_private.h"
svn_error_t *
...
svn_fs_fs__p2l_get_max_offset(apr_off_t *offset,
                              ...
                              svn_revnum_t revision,
                              apr_pool_t *pool);
# 531 "./subversion/include/private/svn_fs_fs_private.h"
svn_error_t *
svn_fs_fs__l2p_index_from_p2l_entries(const char **protoname,
                                      ...
                                      apr_pool_t *result_pool,
                                      apr_pool_t *scratch_pool);
# 545 "./subversion/include/private/svn_fs_fs_private.h"
svn_error_t *
...
svn_fs_fs__add_index_data(svn_fs_t *fs,
                          ...
                          svn_revnum_t revision,
                          apr_pool_t *pool);
# 575 "./subversion/include/private/svn_fs_fs_private.h"
svn_error_t *
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.h"
...
svn_fs_fs__id_deserialize(void *buffer,
                          svn_fs_id_t **id);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/index.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/index.h"
...
# 187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.h"
...
# 248 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.h"
  ...
  svn_fs_fs__id_part_t txn_id;
# 279 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.h"
  struct
    {
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/index.h" 2
...
svn_fs_fs__p2l_index_append(svn_fs_t *fs,
                            ...
                            svn_revnum_t revision,
                            apr_pool_t *pool);
# 120 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/index.h"
svn_error_t *
svn_fs_fs__p2l_entry_lookup(svn_fs_fs__p2l_entry_t **entry,
                            ...
                            apr_off_t offset,
                            apr_pool_t *pool);
# 139 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/index.h"
svn_error_t *
...
svn_fs_fs__deserialize_p2l_page(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c" 2
...
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c"
                    ...
                    apr_pool_t *pool)
{
  ...
  id->generic_id.vtable = &id_vtable;
  id->generic_id.fsap_data = id;
# 517 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/id.c"
