...
# 32 "./subversion/include/svn_base64.h"
...
# 33 "./subversion/include/svn_base64.h" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-memcache.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-memcache.c" 2
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-memcache.c"
...
# 80 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-memcache.c"
static svn_error_t *
...
# 112 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-memcache.c"
             ...
             apr_pool_t *pool)
{
  ...
  if (cache->deserialize_func)
    {
      do { svn_error_t *svn_err__temp = ((cache->deserialize_func)(value_p, data, data_len, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
    {
      svn_string_t *value = memset(apr_palloc(pool, sizeof(*value)), 0, sizeof(*value));
      value->data = data;
      value->len = data_len;
      *value_p = value;
    }
...
# 443 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-memcache.c"
static svn_boolean_t
