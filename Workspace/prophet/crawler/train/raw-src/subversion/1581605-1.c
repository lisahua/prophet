...
# 2124 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
svn_error_t *
svn_stream__create_for_install(svn_stream_t **install_stream,
                               const char *tmp_abspath,
                               apr_pool_t *result_pool,
                               apr_pool_t *scratch_pool)
{
  ...
  const char *tmp_path;
# 2161 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
  do { if (!(svn_dirent_is_absolute(tmp_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 2161, "svn_dirent_is_absolute(tmp_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  *install_stream = svn_stream_from_aprfile2(file, 0, result_pool);
  ...
  (((void*)&ib->baton_apr == (void*)ib) ? (void) (0) : __assert_fail ("(void*)&ib->baton_apr == (void*)ib", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 2172, __PRETTY_FUNCTION__));

  (*install_stream)->baton = ib;

  ib->tmp_path = tmp_path;
# 2185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
  return 0;
}
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(final_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 2197, "svn_dirent_is_absolute(final_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 2291 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
...
{
  struct install_baton_t *ib = install_stream->baton;
# 2335 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
...
{
  struct install_baton_t *ib = install_stream->baton;
# 2381 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
