# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
...
svn_compat_wrap_log_receiver(svn_log_entry_receiver_t *receiver2,
                             ...
                             void *receiver_baton,
                             apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
...
# 140 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/cl.h"
svn_error_t *
...
# 161 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/cl.h"
svn_error_t *
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c" 2
                 ...
                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&target_peg_revision, &target_path_or_url, target, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (target_peg_revision.kind == svn_opt_revision_unspecified)
    target_peg_revision.kind = (svn_path_is_url(target)
                                     ? svn_opt_revision_head
                                     : svn_opt_revision_working);
  (((const char * *)(targets)->elts)[0]) = target_path_or_url;
      ...
      for (i = 1; i < targets->nelts; i++)
        {
          ...
          if (svn_path_is_url(target) || target[0] == '/')
            return svn_error_createf(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                                     dcgettext ("subversion", "Only relative paths can be specified" " after a URL for 'svn-bench log', " "but '%s' is not a relative path", 5),
  ...
  do { svn_error_t *svn_err__temp = (svn_client_log5(targets, &target_peg_revision, opt_state->revision_ranges, opt_state->limit, opt_state->verbose, opt_state->stop_on_copy, opt_state->use_merge_history, revprops, log_entry_receiver, &lb, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 217 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c"
  if (!opt_state->quiet)
    if (opt_state->use_merge_history)
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "%15s revisions, %15s merged in %s merges\n" "%15s msg lines, %15s in merged revisions\n" "%15s changes,   %15s in merged revisions\n", 5), svn__ui64toa_sep(lb.revisions, ',', pool), svn__ui64toa_sep(lb.merged_revs, ',', pool), svn__ui64toa_sep(lb.merges, ',', pool), svn__ui64toa_sep(lb.message_lines, ',', pool), svn__ui64toa_sep(lb.merged_message_lines, ',', pool), svn__ui64toa_sep(lb.changes, ',', pool), svn__ui64toa_sep(lb.merged_changes, ',', pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
# 230 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/client-side/svn-bench/null-log-cmd.c"
    else
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "%15s revisions\n" "%15s msg lines\n" "%15s changes\n", 5), svn__ui64toa_sep(lb.revisions, ',', pool), svn__ui64toa_sep(lb.message_lines, ',', pool), svn__ui64toa_sep(lb.changes, ',', pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
