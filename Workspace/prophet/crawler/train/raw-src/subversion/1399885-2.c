# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
svn_repos__replay_ev2(svn_fs_root_t *root,
                      ...
                      void *authz_read_baton,
                      apr_pool_t *scratch_pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
...
svn__decompress(svn_string_t *in,
                svn_stringbuf_t *out,
                apr_size_t limit);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c" 2
# 114 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
struct copy_info
{
...
# 161 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
static svn_error_t *
  ...
  for (hi = apr_hash_first(pool, dirents); hi; hi = apr_hash_next(hi))
    {
      ...
      if (dent->kind == svn_node_dir)
        ...
        do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c", 338, ((void*)0))); } while (0);
    }
             ...
             apr_pool_t *scratch_pool)
{
  ...
  if (info && (relpath = svn_relpath_skip_ancestor(info->path, path)))
  ...
  else
    {
      ...
      do { if (!(((inquire_rev) >= 0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c", 393, "SVN_IS_VALID_REVNUM(inquire_rev)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 416 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
static svn_error_t *
...
# 569 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
      if (copyfrom_path
          && ((! src_readable)
              || (svn_relpath_skip_ancestor(base_path, copyfrom_path + 1) == ((void*)0))
      ...
      if (copyfrom_path)
        {
          ...
          if (change->node_kind == svn_node_dir)
            {
              struct copy_info *info = memset(apr_palloc(cb->pool, sizeof(*info)), 0, sizeof(*info));
              ...
              (*((struct copy_info * *)apr_array_push(cb->copies))) = info;
            }
          ...
          if (info->copyfrom_path)
            {
              const char *relpath = svn_relpath_skip_ancestor(info->path,
                                                              edit_path);
              do { if (!(relpath && *relpath)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c", 680, "relpath && *relpath")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 837 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
svn_error_t *
svn_repos_replay2(svn_fs_root_t *root,
                  const char *base_path,
                  svn_revnum_t low_water_mark,
      ...
      if (allowed)
        {
          ...
          if (svn_relpath_skip_ancestor(base_path, path) != ((void*)0))
            {
          ...
          else if (svn_relpath_skip_ancestor(path, base_path) != ((void*)0))
            {
              (*((const char * *)apr_array_push(paths))) = path;
              apr_hash_set(changed_paths, path, keylen, change);
            }
...
# 1011 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
}
# 1175 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
static svn_error_t *
...
{
  return svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c", 1189, "Not implemented.");
}
# 1476 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
svn_error_t *
svn_repos__replay_ev2(svn_fs_root_t *root,
                      const char *base_repos_relpath,
                      svn_revnum_t low_water_mark,
                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  do { if (!(!svn_dirent_is_absolute(base_repos_relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c", 1494, "!svn_dirent_is_absolute(base_repos_relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_paths_changed2(&fs_changes, root, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(scratch_pool, fs_changes); hi;
        hi = apr_hash_next(hi))
    {
      ...
      if (authz_read_func)
        do { svn_error_t *svn_err__temp = (authz_read_func(&allowed, root, path, authz_read_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (allowed)
        {
          ...
          if (svn_relpath_skip_ancestor(base_repos_relpath, path) != ((void*)0))
            {
              (*((const char * *)apr_array_push(paths))) = path;
              apr_hash_set(changed_paths, path, keylen, change);
            }
          ...
          else if (svn_relpath_skip_ancestor(path, base_repos_relpath) != ((void*)0))
            {
              (*((const char * *)apr_array_push(paths))) = path;
              apr_hash_set(changed_paths, path, keylen, change);
            }
  ...
  for (i = 0; i < paths->nelts; i++)
    {
      const char *repos_relpath = (((const char * *)(paths)->elts)[i]);
  ...
  if (err)
    ...
    do { svn_error_t *svn_err__temp = (svn_editor_complete(editor)); if (svn_err__temp) return (svn_err__temp); } while (0);
