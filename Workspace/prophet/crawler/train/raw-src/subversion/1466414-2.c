...
svn_config_write_auth_data(apr_hash_t *hash,
                           ...
                           const char *config_dir,
                           apr_pool_t *pool);
# 680 "./subversion/include/svn_config.h"
typedef svn_error_t *
(*svn_config_auth_walk_func_t)(svn_boolean_t *delete_cred,
                               ...
                               apr_hash_t *hash,
                               apr_pool_t *scratch_pool);
# 702 "./subversion/include/svn_config.h"
svn_error_t *
...
svn_client_mergeinfo_get_merged(apr_hash_t **mergeinfo,
                                ...
                                svn_client_ctx_t *ctx,
                                apr_pool_t *pool);
# 4025 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_upgrade(const char *wcroot_dir,
                   svn_client_ctx_t *ctx,
                   apr_pool_t *scratch_pool);
# 4173 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_revert2(const apr_array_header_t *paths,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 4258 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_copy5(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4470 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_copy4(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4491 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_export4(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 5428 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_export3(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 5452 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_ls3(apr_hash_t **dirents,
               ...
               svn_client_ctx_t *ctx,
               apr_pool_t *pool);
# 5674 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_remove_from_changelists(const apr_array_header_t *paths,
                                   ...
                                   svn_client_ctx_t *ctx,
                                   apr_pool_t *pool);
# 5848 "./subversion/include/svn_client.h"
svn_error_t *
...
# 6050 "./subversion/include/svn_client.h"
...
typedef svn_error_t *(*svn_info_receiver_t)(
  ...
  apr_pool_t *pool);
# 6087 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_info_t *
...
svn_client_info2_dup(const svn_client_info2_t *info,
                     apr_pool_t *pool);
# 6161 "./subversion/include/svn_client.h"
...
svn_client_info2(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 6252 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_min_max_revisions(svn_revnum_t *min_revision,
                             ...
                             svn_client_ctx_t *ctx,
                             apr_pool_t *scratch_pool);
# 6331 "./subversion/include/svn_client.h"
...
svn_client_root_url_from_path(const char **url,
                              ...
                              svn_client_ctx_t *ctx,
                              apr_pool_t *pool);
# 6491 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_uuid_from_path(const char **uuid,
                          ...
                          svn_client_ctx_t *ctx,
                          apr_pool_t *pool);
# 6545 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_cl__operation_str_human_readable(svn_wc_operation_t operation,
                                     apr_pool_t *pool);
# 687 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         ...
                         apr_pool_t *pool);
# 755 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 792 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
{
  apr_hash_set(hash, apr_pstrdup(nb->stats_pool, path), (-1), "");
}
...
svn_cl__notifier_print_conflict_stats(void *baton, apr_pool_t *scratch_pool)
{
  ...
  if (n_text_r == 0 && n_prop_r == 0 && n_tree_r == 0)
    ...
    {
      if (n_text > 0 || n_text_r > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Text conflicts: %d remaining (and %d already resolved)\n", 5), n_text, n_text_r)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (n_prop > 0 || n_prop_r > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Property conflicts: %d remaining (and %d already resolved)\n", 5), n_prop, n_prop_r)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (n_tree > 0 || n_tree_r > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Tree conflicts: %d remaining (and %d already resolved)\n", 5), n_tree, n_tree_r)); if (svn_err__temp) return (svn_err__temp); } while (0);


    }
  if (nb->skipped_paths > 0)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Skipped paths: %d\n", 5), nb->skipped_paths)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
notify(void *baton, const svn_wc_notify_t *n, apr_pool_t *pool)
{
  ...
  switch (n->action)
    ...
    case svn_wc_notify_resolved:
      ...
      if (apr_hash_get(nb->text_conflicts, path_local, (-1)))
        {
          apr_hash_set(nb->text_conflicts, path_local, (-1), ((void*)0));
          nb->text_conflicts_resolved++;
        }
      if (apr_hash_get(nb->prop_conflicts, path_local, (-1)))
        {
          apr_hash_set(nb->prop_conflicts, path_local, (-1), ((void*)0));
          nb->prop_conflicts_resolved++;
        }
      if (apr_hash_get(nb->tree_conflicts, path_local, (-1)))
        {
          apr_hash_set(nb->tree_conflicts, path_local, (-1), ((void*)0));
