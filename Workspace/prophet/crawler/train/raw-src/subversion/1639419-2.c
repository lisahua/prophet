# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
svn_fs_fs__delete_revprops_shard(const char *shard_path,
                                 ...
                                 void *cancel_baton,
                                 apr_pool_t *scratch_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c" 2
  ...
  for (shard = 0; shard < first_unpacked_shard; ++shard)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__pack_revprops_shard(revprops_pack_file_dir, revprops_shard_path, shard, ffd->max_files_per_dir, (int)(0.9 * ffd->revprop_pack_size), compression_level, cancel_func, cancel_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (shard = 0; shard < first_unpacked_shard; ++shard)
    {
      ...
      revprops_shard_path = svn_dirent_join(revsprops_dir,
                       apr_psprintf(iterpool, "%" "ld", shard),
                       iterpool);
      do { svn_error_t *svn_err__temp = (svn_fs_fs__delete_revprops_shard(revprops_shard_path, shard, ffd->max_files_per_dir, cancel_func, cancel_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 199 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
static svn_error_t *
...
# 225 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
static svn_error_t *
                        ...
                        apr_pool_t *pool)
{
  ...
  for (i = 0;
    ...
    {
      apr_pool_clear(iterpool);
      do { svn_error_t *svn_err__temp = (svn_fs_fs__try_stringbuf_from_file(&content, &missing, svn_fs_fs__path_revprops(fs, rev, iterpool), i + 1 < 10 , iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  manifest_file_path
    = svn_dirent_join(revprops->folder, "manifest", pool);

  do { svn_error_t *svn_err__temp = (svn_fs_fs__read_content(&content, manifest_file_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 335 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
...
# 399 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
static svn_error_t *
                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__read_number_from_stream(&first_rev, ((void*)0), stream, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_fs_fs__read_number_from_stream(&count, ((void*)0), stream, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0, offset = 0, revprops->total_size = 0; i < count; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__read_number_from_stream(&size, ((void*)0), stream, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  if (!svn_fs_fs__is_packed_revprop(fs, rev))
     do { svn_error_t *svn_err__temp = (svn_fs_fs__update_min_unpacked_rev(fs, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0;
       ...
       ++i)
    {
      ...
      file_path = svn_dirent_join(result->folder,
                                   result->filename,
                                   iterpool);
      do { svn_error_t *svn_err__temp = (svn_fs_fs__try_stringbuf_from_file(&result->packed_revprops, &missing, file_path, i + 1 < 10, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 650 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
static svn_error_t *
...
# 681 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
static svn_error_t *
switch_to_new_revprop(svn_fs_t *fs,
                      ...
                      apr_pool_t *pool)
{
  do { svn_error_t *svn_err__temp = (svn_fs_fs__move_into_place(tmp_path, final_path, perms_reference, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *pool)
{
  ...
  do { if (!(start < end)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c", 725, "start < end")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 761 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/revprops.c"
static svn_error_t *
                                 ...
                                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (switch_to_new_revprop(fs, final_path, tmp_path, perms_reference, files_to_delete, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (rev = start_rev; rev <= end_rev; rev++)
    {
      ...
      if (sizes->nelts != 0 &&
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_fs_fs__copy_revprops(pack_file_dir, pack_filename, shard_path, start_rev, rev-1, sizes, (apr_size_t)total_size, compression_level, cancel_func, cancel_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
