...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
svn_client__arbitrary_nodes_diff(const char **root_relpath,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
...
svn_wc__diff7(const char **root_relpath,
              ...
              apr_pool_t *result_pool,
              apr_pool_t *scratch_pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c" 2
                                  ...
                                  apr_pool_t *scratch_pool)
{
  ...
  do { if (!(((revision->kind) == svn_opt_revision_base || (revision->kind) == svn_opt_revision_working || (revision->kind) == svn_opt_revision_committed))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cat.c", 69, "SVN_CLIENT__REVKIND_IS_LOCAL_TO_WC(revision->kind)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { svn_error_t *svn_err__temp = (svn_wc_read_kind2(&kind, wc_ctx, local_abspath, (revision->kind != svn_opt_revision_working), 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  special = apr_hash_get(props, "svn:" "special", (-1));
  ...
  if (keywords)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_repos_info(((void*)0), &repos_relpath, &repos_root_url, ((void*)0), wc_ctx, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_subst_build_keywords3(&kw, keywords->data, rev_str, url, repos_root_url, tm, author, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (! svn_path_is_url(path_or_url)
      ...
      && ((revision->kind) == svn_opt_revision_base || (revision->kind) == svn_opt_revision_working || (revision->kind) == svn_opt_revision_committed))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_client__get_normalized_stream(&normal_stream, ctx->wc_ctx, local_abspath, revision, expand_keywords, 0, ctx->cancel_func, ctx->cancel_baton, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (props)
        do { svn_error_t *svn_err__temp = (svn_wc_prop_list2(props, ctx->wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      return (svn_stream_copy3(normal_stream, output, ctx->cancel_func, ctx->cancel_baton, scratch_pool));
      ...
      if (keywords && expand_keywords)
        {
          ...
          cmt_rev = apr_hash_get(*props, "svn:" "entry:" "committed-rev", (-1));
          cmt_date = apr_hash_get(*props, "svn:" "entry:" "committed-date", (-1));
          cmt_author = apr_hash_get(*props, "svn:" "entry:" "last-author", (-1));
          if (cmt_date)
            do { svn_error_t *svn_err__temp = (svn_time_from_cstring(&when, cmt_date->data, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          do { svn_error_t *svn_err__temp = (svn_subst_build_keywords3(&kw, keywords->data, cmt_rev->data, loc->url, repos_root_url, when, cmt_author ? cmt_author->data : ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_get_file(ra_session, "", loc->rev, output, ((void*)0), ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
