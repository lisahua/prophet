...
# 284 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 427 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
drop_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset != (18446744073709551615UL)) ? (void) (0) : __assert_fail ("entry->offset != (18446744073709551615UL)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 489, __PRETTY_FUNCTION__));
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == cache->current_data) ? (void) (0) : __assert_fail ("entry->offset == cache->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 551, __PRETTY_FUNCTION__));
...
# 657 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
...
# 789 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
      ...
      if (end - cache->current_data >= size)
        return (!0);
# 810 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (2 * drop_size > size)
        return 0;
...
# 875 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 899 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
svn_error_t *
svn_cache__membuffer_cache_create(svn_membuffer_t **cache,
                                  apr_size_t total_size,
                                  apr_size_t directory_size,
                                  ...
                                  apr_pool_t *pool)
{
  ...
  svn_membuffer_t *c = apr_palloc(pool, 16 * sizeof(*c));
  apr_uint32_t seg;
  apr_uint32_t group_count;
  apr_uint64_t data_size;
  ...
  for (seg = 0; seg < 16; ++seg)
    {
      ...
      ((c[seg].directory[0][0].offset == -1) ? (void) (0) : __assert_fail ("c[seg].directory[0][0].offset == -1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 986, __PRETTY_FUNCTION__));
...
# 1025 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                    ...
                    apr_pool_t *pool)
{
  ...
  if ( item != ((void*)0)
      ...
      && ensure_data_insertable(cache, size))
    {
      ...
      entry->size = size;
      entry->offset = cache->current_data;
# 1080 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
...
# 1166 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  entry->hit_count++;
  cache->hit_count++;
  cache->total_hits++;
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      cache->hit_count++;
      cache->total_hits++;
# 1236 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->hit_count++;
      cache->total_writes++;
# 1306 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      ...
      if (data != orig_data)
        {
          ...
          if ( (cache->data_size / 4 > size)
              && ensure_data_insertable(cache, size))
            {
              ...
              insert_entry(cache, entry);
# 1338 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
            }
        }
    }
...
typedef struct svn_membuffer_cache_t
{
  ...
  int alloc_counter;
# 1411 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
} svn_membuffer_cache_t;
# 1422 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void
...
# 1481 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1621 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 1776 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
