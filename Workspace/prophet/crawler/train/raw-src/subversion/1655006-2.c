...
svn_rdump__normalize_prop(const char *name,
                          const svn_string_t **value,
                          apr_pool_t *result_pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c" 2
...
# 157 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
                ...
                apr_pool_t *pool)
{
  ...
  new_fb->copyfrom_rev = ((svn_revnum_t) -1);
...
# 261 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
static svn_error_t *
                 ...
                 apr_pool_t *pool)
{
  ...
  ((svn_relpath_is_canonical(node_relpath)) ? (void) (0) : __assert_fail ("svn_relpath_is_canonical(node_relpath)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c", 268, __PRETTY_FUNCTION__));


  svn_repos__dumpfile_header_push(
    headers, "Node-path", node_relpath);


  svn_repos__dumpfile_header_push(
    headers, "Node-action", "delete");

  do { svn_error_t *svn_err__temp = (svn_repos__dump_headers(stream, headers, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return 0;
}
# 295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
static svn_error_t *
          ...
          apr_pool_t *pool)
{
  ...
  ((svn_relpath_is_canonical(repos_relpath)) ? (void) (0) : __assert_fail ("svn_relpath_is_canonical(repos_relpath)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c", 309, __PRETTY_FUNCTION__));
  ((!copyfrom_path || svn_relpath_is_canonical(copyfrom_path)) ? (void) (0) : __assert_fail ("!copyfrom_path || svn_relpath_is_canonical(copyfrom_path)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c", 310, __PRETTY_FUNCTION__));
  ((! (db && fb)) ? (void) (0) : __assert_fail ("! (db && fb)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c", 311, __PRETTY_FUNCTION__));
  ...
  if (fb)
    svn_repos__dumpfile_header_push(
      headers, "Node-kind", "file");
  else if (db)
    svn_repos__dumpfile_header_push(
      headers, "Node-kind", "dir");
  ...
  switch (action)
    ...
    case svn_node_action_delete:
      ...
      do { svn_error_t *svn_err__temp = (svn_repos__dump_headers(eb->stream, headers, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_node_action_replace:
      if (! is_copy)
      ...
      else
        {
          ...
          do { svn_error_t *svn_err__temp = (dump_node_delete(eb->stream, repos_relpath, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_node_action_add:
      ...
      svn_repos__dumpfile_header_push(
        headers, "Node-action", "add");

      if (is_copy)
        {

          svn_repos__dumpfile_header_pushf(
            headers, "Node-copyfrom-rev", "%ld", copyfrom_rev);
          svn_repos__dumpfile_header_push(
            headers, "Node-copyfrom-path", copyfrom_path);
# 407 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
          if (db)
            db->dump_newlines = (!0);
        }
      else
        {
# 428 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
          if (fb)
            fb->dump_props = (!0);
          else if (db)
            db->dump_props = (!0);
           ...
           apr_pool_t *pool)
{
  ...
  svn_repos__dumpfile_header_push(
    headers, "Node-path", repos_relpath);
  ...
  do { svn_error_t *svn_err__temp = (get_props_content(headers, &prop_content, apr_hash_make(pool), apr_hash_make(pool), pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  len = prop_content->len;
  svn_repos__dumpfile_header_pushf(headers, "Content-length",
                                   "%" "lu", len);
  do { svn_error_t *svn_err__temp = (svn_repos__dump_headers(eb->stream, headers, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_write(eb->stream, prop_content->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (db->dump_props)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_props_content(headers, &content, db->props, db->deleted_props, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_repos__dump_headers(eb->stream, headers, (!0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      len = content->len;
      do { svn_error_t *svn_err__temp = (svn_stream_write(eb->stream, content->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  struct dump_edit_baton *eb = edit_baton;
  struct dir_baton *new_db = ((void*)0);
  ...
  if (eb->update_anchor_relpath)
    {
      ...
      while (! svn_path_is_empty(parent_path))
        {
          (*((const char * *)apr_array_push(dirs_to_add))) = parent_path;
      ...
      for (i = dirs_to_add->nelts; i; --i)
        {
          const char *dir_to_add =
            (((const char * *)(dirs_to_add)->elts)[i - 1]);
          ...
          if (i > 1)
            {
              do { svn_error_t *svn_err__temp = (dump_mkdir(eb, dir_to_add, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
          else
            {


              new_db = make_dir_baton(((void*)0), ((void*)0), ((svn_revnum_t) -1),
                                      edit_baton, ((void*)0), pool);
              do { svn_error_t *svn_err__temp = (dump_node(eb, new_db->repos_relpath, new_db, ((void*)0), svn_node_action_add, 0, ((void*)0), ((svn_revnum_t) -1), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_pending_dir(pb->eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





  apr_hash_set(pb->deleted_entries, apr_pstrdup(pb->pool, path), (-1), pb);
              ...
              void **child_baton)
{
  ...
  was_deleted = apr_hash_get(pb->deleted_entries, path, (-1));


  is_copy = ((copyfrom_path) && ((copyfrom_rev) >= 0));


  do { svn_error_t *svn_err__temp = (dump_node(pb->eb, new_db->repos_relpath, new_db, ((void*)0), was_deleted ? svn_node_action_replace : svn_node_action_add, is_copy, is_copy ? new_db->copyfrom_path : ((void*)0), is_copy ? copyfrom_rev : ((svn_revnum_t) -1), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_pending_dir(db->eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 724 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
  if ((! this_pending) && (db->dump_props))
    {
      do { svn_error_t *svn_err__temp = (dump_node(db->eb, db->repos_relpath, db, ((void*)0), svn_node_action_change, 0, ((void*)0), ((svn_revnum_t) -1), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(pool, db->deleted_entries); hi;
       hi = apr_hash_next(hi))
    {
      ...
      do { svn_error_t *svn_err__temp = (dump_node(db->eb, path, ((void*)0), ((void*)0), svn_node_action_delete, 0, ((void*)0), ((svn_revnum_t) -1), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  if (value)
    apr_hash_set(db->props, apr_pstrdup(db->pool, name), (-1), svn_string_dup(value, db->pool));


  else
    apr_hash_set(db->deleted_props, apr_pstrdup(db->pool, name), (-1), "");
                 ...
                 apr_pool_t *pool)
{
  ...
  if (value)
    apr_hash_set(fb->props, apr_pstrdup(fb->pool, name), (-1), svn_string_dup(value, fb->pool));


  else
    apr_hash_set(fb->deleted_props, apr_pstrdup(fb->pool, name), (-1), "");
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_pending_dir(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (dump_node(eb, fb->repos_relpath, ((void*)0), fb, fb->action, fb->is_copy, fb->copyfrom_path, fb->copyfrom_rev, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (fb->dump_props)
    {
      do { svn_error_t *svn_err__temp = (get_props_content(headers, &propstring, fb->props, fb->deleted_props, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (fb->dump_text)
    {
      ...
      if (fb->base_checksum)
        ...
        svn_repos__dumpfile_header_push(
          headers, "Text-delta-base-md5", fb->base_checksum);
      ...
      svn_repos__dumpfile_header_push(
        headers, "Text-content-md5", text_checksum);
    }
  ...
  if (fb->dump_props)
    {
      do { svn_error_t *svn_err__temp = (svn_stream_write(eb->stream, propstring->data, &(propstring->len))); if (svn_err__temp) return (svn_err__temp); } while (0);
