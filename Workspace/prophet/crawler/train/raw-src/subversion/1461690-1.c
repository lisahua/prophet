...
svn_error_t *
svn_nls_init(void);
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 57 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c" 2
...
# 163 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
  if (!setlocale(6, "")
      && !setlocale(0, ""))
    {
      if (error_stream)
...
svn_cmdline_printf(apr_pool_t *pool, const char *fmt, ...)
{
  const char *message;
  va_list ap;
# 309 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
...
# 432 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
static svn_error_t *
                   ...
                   apr_hash_t *config)
{
  ...
  if (! e)
    e = getenv("EDITOR");
# 995 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
  if (e)
    {
      const char *c;
