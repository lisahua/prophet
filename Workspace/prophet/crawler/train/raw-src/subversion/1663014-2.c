...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c" 2
...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c" 2
...
# 173 "./subversion/include/private/svn_utf_private.h"
svn_error_t *
svn_utf__encode_ucs4_string(svn_membuf_t *buffer,
                            const apr_int32_t *ucs4str,
                            apr_size_t length,
                            apr_size_t *result_length);
# 197 "./subversion/include/private/svn_utf_private.h"
svn_error_t *
...
# 225 "./subversion/include/private/svn_utf_private.h"
svn_error_t *
svn_utf__utf16_to_utf8(const svn_string_t **result,
                       ...
                       apr_pool_t *result_pool,
                       apr_pool_t *scratch_pool);
# 244 "./subversion/include/private/svn_utf_private.h"
svn_error_t *
...
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c" 2
...
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c" 2
# 94 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
int
...
# 183 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
  if (!setlocale(6, "")
      && !setlocale(0, ""))
    {
      if (error_stream)
...
# 293 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
  return 0;
}
...
svn_cmdline_printf(apr_pool_t *pool, const char *fmt, ...)
{
  const char *message;
  va_list ap;
# 358 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
...
svn_cmdline_fputs(const char *string, FILE* stream, apr_pool_t *pool)
{
  svn_error_t *err;
  const char *out;
# 425 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
...
# 530 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
static svn_error_t *
                   ...
                   apr_hash_t *config)
{
  ...
  if (! e)
    e = getenv("EDITOR");
# 1111 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
  if (e)
    {
      const char *c;
                                    ...
                                    apr_pool_t *pool)
{
  ...
  err = svn_io_stat(&finfo_before, tmpfile_name, 0x00000010, pool);
  if (err)
    goto cleanup;
  ...
  if (remove_file)
    {
      ...
      err = svn_error_compose_create(
              err,
              svn_io_remove_file2(tmpfile_name, 0, pool));
    }
