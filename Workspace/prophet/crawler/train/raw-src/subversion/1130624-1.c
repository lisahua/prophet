...
svn_stringbuf_from_aprfile(svn_stringbuf_t **result,
                           apr_file_t *file,
                           apr_pool_t *pool);
# 1355 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_remove_file(const char *path,
                   apr_pool_t *pool);
# 1378 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_get_dir_filenames(apr_hash_t **dirents,
                         const char *path,
                         apr_pool_t *pool);
# 1426 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_dir_walk(const char *dirname,
                ...
                void *walk_baton,
                apr_pool_t *pool);
# 1548 "./subversion/include/svn_io.h"
...
svn_io_run_cmd(const char *path,
               ...
               apr_file_t *errfile,
               apr_pool_t *pool);
# 1639 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_parse_mimetypes_file(apr_hash_t **type_map,
                            ...
                            apr_pool_t *pool);
# 1788 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_file_read(apr_file_t *file,
                 ...
                 apr_size_t *nbytes,
                 apr_pool_t *pool);
# 1861 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_dir_make_hidden(const char *path,
                       apr_fileperms_t perm,
                       apr_pool_t *pool);
# 1996 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_file_name_get(const char **filename,
                     apr_file_t *file,
                     apr_pool_t *pool);
# 2057 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_error_t *svn_fs_fs__txn_changes_fetch(apr_hash_t **changes,
                                          ...
                                          const char *txn_id,
                                          apr_pool_t *pool);
# 395 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs_fs.h"
svn_error_t *
...
svn_error_t *svn_fs_fs__change_rev_prop(svn_fs_t *fs, svn_revnum_t rev,
                                        ...
                                        const svn_string_t *value,
                                        apr_pool_t *pool);
# 448 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs_fs.h"
...
svn_error_t *svn_fs_fs__ensure_dir_exists(const char *path,
                                          const char *fs_path,
                                          apr_pool_t *pool);
# 480 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs_fs.h"
svn_error_t *
svn_fs_fs__set_node_origin(svn_fs_t *fs,
                           const char *node_id,
                           const svn_fs_id_t *node_rev_id,
                           apr_pool_t *pool);
# 493 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs_fs.h"
svn_error_t *
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c" 2
...
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  *cache_txdeltas
...
# 157 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
static svn_error_t *
               ...
               apr_pool_t *pool)
{
  if (cache != ((void*)0))
    {
# 182 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
      if (! no_handler)
...
# 223 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
...
# 242 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
...
# 265 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
...
# 287 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
...
# 310 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
...
# 374 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
    }
  else
    {
...
# 485 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
