# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c" 2
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c"
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c" 2
...
# 160 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/../svn_test.h"
int svn_test_main(int argc, const char *argv[], int max_threads,
                  struct svn_test_descriptor_t *test_funcs);
# 212 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/../svn_test.h"
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c" 2
...
svn_packed__data_read(svn_packed__data_root_t **root_p,
                      ...
                      apr_pool_t *result_pool,
                      apr_pool_t *scratch_pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c" 2
              ...
              apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_packed__data_write(stream, write_root, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_close(stream)); if (svn_err__temp) return (svn_err__temp); } while (0);

  stream = svn_stream_from_stringbuf(stream_buffer, pool);
  do { svn_error_t *svn_err__temp = (svn_packed__data_read(read_root, stream, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_close(stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
test_empty_container(apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_read_root(&root, root, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { if (!(svn_packed__first_int_stream(root) == ((void*)0))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__first_int_stream(root) == NULL", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 71); } while (0);
  do { if (!(svn_packed__first_byte_stream(root) == ((void*)0))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__first_byte_stream(root) == NULL", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 72); } while (0);
                   ...
                   apr_pool_t *pool)
{
  ...
  svn_packed__int_stream_t *stream
    = svn_packed__create_int_stream(root, diff, 0);
  ...
  do { if (!(stream)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "stream", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 99); } while (0);
  do { if (!(!svn_packed__next_int_stream(stream))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "!svn_packed__next_int_stream(stream)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 100); } while (0);
  do { if (!(!svn_packed__first_byte_stream(root))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "!svn_packed__first_byte_stream(root)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 101); } while (0);


  do { if (!(svn_packed__int_count(stream) == count)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__int_count(stream) == count", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 104); } while (0);
  for (i = 0; i < count; ++i)
    do { if (!(svn_packed__get_uint(stream) == values[i])) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__get_uint(stream) == values[i]", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 106); } while (0);


  do { if (!(svn_packed__get_uint(stream) == 0)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__get_uint(stream) == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 109); } while (0);
...
test_uint_stream(apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (verify_uint_stream(values, COUNT, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (verify_uint_stream(values, COUNT, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  stream = svn_packed__first_int_stream(root);
  do { if (!(stream)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "stream", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 158); } while (0);
  do { if (!(!svn_packed__next_int_stream(stream))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "!svn_packed__next_int_stream(stream)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 159); } while (0);
  do { if (!(!svn_packed__first_byte_stream(root))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "!svn_packed__first_byte_stream(root)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 160); } while (0);


  do { if (!(svn_packed__int_count(stream) == count)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__int_count(stream) == count", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 163); } while (0);
  for (i = 0; i < count; ++i)
    do { if (!(svn_packed__get_int(stream) == values[i])) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__get_int(stream) == values[i]", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 165); } while (0);


  do { if (!(svn_packed__get_int(stream) == 0)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__get_int(stream) == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 168); } while (0);
...
test_int_stream(apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (verify_int_stream(values, COUNT, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (verify_int_stream(values, COUNT, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
test_byte_stream(apr_pool_t *pool)
{
  ...
  do { if (!(stream)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "stream", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 220); } while (0);
  do { if (!(!svn_packed__next_byte_stream(stream))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "!svn_packed__next_byte_stream(stream)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 221); } while (0);


  do { if (!(svn_packed__byte_count(stream) == 20)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__byte_count(stream) == 20", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 224); } while (0);
  for (i = 0; i < COUNT; ++i)
    {
      svn_string_t string;
      string.data = svn_packed__get_bytes(stream, &string.len);

      do { if (!(string.len == values[i].len)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "string.len == values[i].len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 230); } while (0);
      do { if (!(!memcmp(string.data, values[i].data, string.len))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "!memcmp(string.data, values[i].data, string.len)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 231); } while (0);
    }


  do { if (!(svn_packed__byte_count(stream) == 0)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "svn_packed__byte_count(stream) == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 235); } while (0);
     ...
     apr_pool_t *pool)
{
  ...
  svn_packed__create_int_substream(base_stream, (!0), (!0));
  svn_packed__create_int_substream(base_stream, (!0), 0);
  svn_packed__create_int_substream(base_stream, 0, 0);
  svn_packed__create_int_substream(base_stream, (!0), (!0));
  svn_packed__create_int_substream(base_stream, 0, (!0));
...
unpack_subs(svn_packed__int_stream_t *int_stream,
            ...
            apr_pool_t *pool)
{
  sub_record_t *records = memset(apr_palloc(pool, (count + 1) * sizeof(*records)), 0, (count + 1) * sizeof(*records));
       ...
       apr_pool_t *pool)
{
  ...
  *count = svn_packed__int_count(sub_count_stream) / 2;
  data = memset(apr_palloc(pool, *count * sizeof(*data)), 0, *count * sizeof(*data));
...
{
  do { if (!(lhs->len == rhs->len)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs->len == rhs->len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 466); } while (0);
  do { if (!(!memcmp(lhs->data, rhs->data, rhs->len))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "!memcmp(lhs->data, rhs->data, rhs->len)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 467); } while (0);
             ...
             const sub_record_t *rhs)
{
  for (; lhs->sub_counter; ++lhs, ++rhs)
    {
      do { if (!(lhs->sub_counter == rhs->sub_counter)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs->sub_counter == rhs->sub_counter", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 481); } while (0);
      do { svn_error_t *svn_err__temp = (compare_binary(&lhs->text, &rhs->text)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }

  do { if (!(lhs->sub_counter == rhs->sub_counter)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs->sub_counter == rhs->sub_counter", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 485); } while (0);
  return 0;
}
        ...
        apr_size_t count)
{
  ...
  for (i = 0; i < count; ++i)
    {
      do { if (!(lhs[i].counter == rhs[i].counter)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs[i].counter == rhs[i].counter", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 499); } while (0);
      do { svn_error_t *svn_err__temp = (compare_binary(&lhs[i].description, &rhs[i].description)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { if (!(lhs[i].large_unsigned1 == rhs[i].large_unsigned1)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs[i].large_unsigned1 == rhs[i].large_unsigned1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 501); } while (0);
      do { if (!(lhs[i].large_unsigned2 == rhs[i].large_unsigned2)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs[i].large_unsigned2 == rhs[i].large_unsigned2", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 502); } while (0);
      do { svn_error_t *svn_err__temp = (compare_subs(lhs[i].left_subs, rhs[i].left_subs)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { if (!(lhs[i].counter == rhs[i].counter)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs[i].counter == rhs[i].counter", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 504); } while (0);
      do { if (!(lhs[i].large_signed1 == rhs[i].large_signed1)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs[i].large_signed1 == rhs[i].large_signed1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 505); } while (0);
      do { if (!(lhs[i].large_signed2 == rhs[i].large_signed2)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs[i].large_signed2 == rhs[i].large_signed2", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 506); } while (0);
      do { if (!(lhs[i].prime == rhs[i].prime)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "lhs[i].prime == rhs[i].prime", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 507); } while (0);
      do { svn_error_t *svn_err__temp = (compare_subs(lhs[i].right_subs, rhs[i].right_subs)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (compare_binary(&lhs[i].binary, &rhs[i].binary)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
test_empty_structure(apr_pool_t *pool)
{
  ...
  do { if (!(count == 0)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "count == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 526); } while (0);
  do { svn_error_t *svn_err__temp = (compare(unpacked, test_data, count)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
test_full_structure(apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_read_root(&root, root, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  unpacked = unpack(&count, root, pool);
  do { if (!(count == BASE_RECORD_COUNT)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "count == BASE_RECORD_COUNT", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/packed-data-test.c", 543); } while (0);
  do { svn_error_t *svn_err__temp = (compare(unpacked, test_data, count)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
static struct svn_test_descriptor_t test_funcs[] =
  {
    {0},
    {svn_test_pass, test_empty_container, ((void*)0), "test empty container"},

    {svn_test_pass, test_uint_stream, ((void*)0), "test a single uint stream"},

    {svn_test_pass, test_int_stream, ((void*)0), "test a single int stream"},

    {svn_test_pass, test_byte_stream, ((void*)0), "test a single bytes stream"},

    {svn_test_pass, test_empty_structure, ((void*)0), "test empty, nested structure"},

    {svn_test_pass, test_full_structure, ((void*)0), "test nested structure"},
