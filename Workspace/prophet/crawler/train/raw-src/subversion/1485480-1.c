# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c" 2
...
apr_status_t apr_password_validate(const char *passwd,
                                                const char *hash);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c" 2
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c" 2
...
void svn_txdelta__xdelta(svn_txdelta__ops_baton_t *build_baton,
                         ...
                         apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c" 2
                       ...
                       apr_pool_t *pool)
{
  ...
  switch (opcode)
    ...
    case svn_txdelta_new:
      ...
      break;
    default:
      ((!"unknown delta op.") ? (void) (0) : __assert_fail ("!\"unknown delta op.\"", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 274, __PRETTY_FUNCTION__));
    }
...
# 509 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c"
static svn_error_t *
  ...
  if (view_len > *buf_size)
    {
      *buf_size *= 2;
      if (*buf_size < view_len)
        *buf_size = view_len;
      do { if (!((((*buf_size) + ((8) - 1)) & ~((8) - 1)) >= *buf_size)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 619, "APR_ALIGN_DEFAULT(*buf_size) >= *buf_size")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      *buf = apr_palloc(pool, *buf_size);
    }

  return 0;
}
# 640 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c"
                               ...
                               apr_size_t *tlen)
{
  ...
  for (op = window->ops; op < window->ops + window->num_ops; op++)
    {
      ...
      ((tpos + op->length <= window->tview_len) ? (void) (0) : __assert_fail ("tpos + op->length <= window->tview_len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 706, __PRETTY_FUNCTION__));

      switch (op->action_code)
        {
        case svn_txdelta_source:

          ((sbuf) ? (void) (0) : __assert_fail ("sbuf", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 712, __PRETTY_FUNCTION__));
          ((op->offset + op->length <= window->sview_len) ? (void) (0) : __assert_fail ("op->offset + op->length <= window->sview_len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 713, __PRETTY_FUNCTION__));
        ...
        case svn_txdelta_target:
          ...
          ((op->offset < tpos) ? (void) (0) : __assert_fail ("op->offset < tpos", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 724, __PRETTY_FUNCTION__));
          patterning_copy(tbuf + tpos, tbuf + op->offset, buf_len);
          break;

        case svn_txdelta_new:

          ((op->offset + op->length <= window->new_data->len) ? (void) (0) : __assert_fail ("op->offset + op->length <= window->new_data->len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 730, __PRETTY_FUNCTION__));
        ...
        default:
          ((!"Invalid delta instruction code") ? (void) (0) : __assert_fail ("!\"Invalid delta instruction code\"", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 737, __PRETTY_FUNCTION__));
        }
  ...
  ((tpos == window->tview_len) ? (void) (0) : __assert_fail ("tpos == window->tview_len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 746, __PRETTY_FUNCTION__));
  *tlen = tpos;
}
...
apply_window(svn_txdelta_window_t *window, void *baton)
{
  ...
  do { if (!(window->sview_len == 0 || (window->sview_offset >= ab->sbuf_offset && (window->sview_offset + window->sview_len >= ab->sbuf_offset + ab->sbuf_len)))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 788, "window->sview_len == 0 || (window->sview_offset >= ab->sbuf_offset && (window->sview_offset + window->sview_len >= ab->sbuf_offset + ab->sbuf_len))")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(len == window->tview_len)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c", 835, "len == window->tview_len")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 846 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/text_delta.c"
  if (ab->result_digest)
