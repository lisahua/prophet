# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c"
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.h"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.h" 2
...
svn_error_t *svn_fs_fs__verify(svn_fs_t *fs,
                               ...
                               void *cancel_baton,
                               apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
svn_fs_fs__get_changes(apr_array_header_t **changes,
                       ...
                       svn_revnum_t rev,
                       apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
svn_fs_fs__lock_rep_cache(svn_fs_t *fs,
                          apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
svn_fs_fs__deserialize_p2l_page(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c" 2
                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_seek(file, 0, &start, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  while (size > 0)
    {
      apr_size_t to_read = size > sizeof(buffer)
                         ? sizeof(buffer)
                         : (apr_size_t)size;
      do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(file, buffer, to_read, ((void*)0), ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_checksum_final(&actual, context, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!svn_checksum_match(expected, actual))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_name_get(&file_name, file, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_checksum_mismatch_err(expected, actual, scratch_pool, dcgettext ("subversion", "%s checksum mismatch in file %s", 5), name, file_name)); if (svn_err__temp) return (svn_err__temp); } while (0);
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open_pack_or_rev_file(&rev_file, fs, start, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_fs_fs__auto_read_footer(rev_file)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (verify_index_checksum(rev_file->file, "L2P index", rev_file->l2p_offset, rev_file->p2l_offset, rev_file->l2p_checksum, cancel_func, cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (verify_index_checksum(rev_file->file, "P2L index", rev_file->p2l_offset, rev_file->footer_offset, rev_file->p2l_checksum, cancel_func, cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 340 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c"
static svn_error_t *
...
# 450 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c"
static svn_error_t *
                  ...
                  apr_pool_t *pool)
{
  ...
  apr_size_t i;
  do { if (!(size <= 4096)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c", 462, "size <= STREAM_THRESHOLD")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  unsigned char buffer[4096];
  do { if (!(entry->size <= 4096)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c", 545, "entry->size <= STREAM_THRESHOLD")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 597 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c"
static svn_error_t *
  ...
  for (revision = start; revision < end; ++revision)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__revision_prop(&date, fs, revision, "svn:" "date", iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);




      if (date)
        do { svn_error_t *svn_err__temp = (svn_time_from_cstring(&timetemp, date->data, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 766 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.c"
static svn_error_t *
                  ...
                  apr_pool_t *pool)
{
  ...
  if (svn_fs_fs__use_log_addressing(fs))
    do { svn_error_t *svn_err__temp = (verify_f7_metadata_consistency(fs, start, end, notify_func, notify_baton, cancel_func, cancel_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
