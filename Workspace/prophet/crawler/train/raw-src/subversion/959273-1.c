...
svn_wc__internal_node_get_schedule(svn_wc_schedule_t *schedule,
                                   ...
                                   const char *local_abspath,
                                   apr_pool_t *scratch_pool);
# 610 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc.h"
svn_error_t *
...
svn_wc__check_wc_root(svn_boolean_t *wc_root,
                      ...
                      const char *local_abspath,
                      apr_pool_t *scratch_pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
  ...
  if (kind != svn_node_none && kind != svn_node_dir)
    {
      ...
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c",57), (svn_error_createf))(20, ((void*)0),
          ...
          if (shorter[0] == '\0')
            {
              ...
              return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c",88), (svn_error_create))(0, ((void*)0),
                                      dcgettext ("subversion", "Unable to make any directories", 5));
            }
          else
            {
              do { svn_error_t *svn_err__temp = (svn_wc__ensure_directory(shorter, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { if (!(kind == svn_node_dir)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 101, "kind == svn_node_dir")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 256, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 275, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
  ...
  apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 296, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                               ...
                               apr_pool_t *pool)
{
  ...
  do { if (!(svn_uri_is_canonical(repos_url, pool) && svn_relpath_is_canonical(path_in_repos, pool) && ((peg_rev) >= 0))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 394, "svn_uri_is_canonical(repos_url, pool) && svn_relpath_is_canonical(path_in_repos, pool) && SVN_IS_VALID_REVNUM(peg_rev)"); abort(); } } while (0);
  ...
  *status = memset(apr_palloc(result_pool, sizeof(**status)), 0, sizeof(**status));
  ...
  if (old_status->versioned
      ...
      && old_status->kind == svn_node_file)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__internal_is_file_external(&file_external, wc_ctx->db, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
