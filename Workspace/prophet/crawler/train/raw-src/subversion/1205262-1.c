# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c" 2
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
struct svn_editor_t
{
  void *baton;
  ...
  apr_pool_t *scratch_pool;
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
};
...
svn_editor_create(svn_editor_t **editor,
                  ...
                  apr_pool_t *scratch_pool)
{
  *editor = memset(apr_palloc(result_pool, sizeof(**editor)), 0, sizeof(**editor));

  (*editor)->baton = editor_baton;
  (*editor)->cancel_func = cancel_func;
  (*editor)->cancel_baton = cancel_baton;
  (*editor)->scratch_pool = svn_pool_create_ex(result_pool, ((void*)0));
# 90 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  return 0;
}
                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  if (many->cb_add_directory) editor->funcs.cb_add_directory = many->cb_add_directory;
  if (many->cb_add_file) editor->funcs.cb_add_file = many->cb_add_file;
  if (many->cb_add_symlink) editor->funcs.cb_add_symlink = many->cb_add_symlink;
  if (many->cb_add_absent) editor->funcs.cb_add_absent = many->cb_add_absent;
  if (many->cb_set_props) editor->funcs.cb_set_props = many->cb_set_props;
  if (many->cb_set_text) editor->funcs.cb_set_text = many->cb_set_text;
  if (many->cb_set_target) editor->funcs.cb_set_target = many->cb_set_target;
  if (many->cb_delete) editor->funcs.cb_delete = many->cb_delete;
  if (many->cb_copy) editor->funcs.cb_copy = many->cb_copy;
  if (many->cb_move) editor->funcs.cb_move = many->cb_move;
  if (many->cb_complete) editor->funcs.cb_complete = many->cb_complete;
  if (many->cb_abort) editor->funcs.cb_abort = many->cb_abort;
                         ...
                         svn_revnum_t replaces_rev)
{
  ...
  do { if (!(editor->funcs.cb_add_directory != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 249, "editor->funcs.cb_add_directory != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (editor->cancel_func)
    do { svn_error_t *svn_err__temp = (editor->cancel_func(editor->cancel_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);

  err = editor->funcs.cb_add_directory(editor->baton, relpath, children,
                                       props, replaces_rev,
                                       editor->scratch_pool);
# 281 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  apr_pool_clear(editor->scratch_pool);
  return err;
}
                    ...
                    svn_revnum_t replaces_rev)
{
  ...
  do { if (!(editor->funcs.cb_add_file != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 296, "editor->funcs.cb_add_file != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                       ...
                       svn_revnum_t replaces_rev)
{
  ...
  do { if (!(editor->funcs.cb_add_symlink != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 330, "editor->funcs.cb_add_symlink != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                      ...
                      svn_revnum_t replaces_rev)
{
  ...
  do { if (!(editor->funcs.cb_add_absent != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 362, "editor->funcs.cb_add_absent != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                     ...
                     svn_boolean_t complete)
{
  ...
  do { if (!(editor->funcs.cb_set_props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 395, "editor->funcs.cb_set_props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 423 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  apr_pool_clear(editor->scratch_pool);
  return err;
}
                    ...
                    svn_stream_t *contents)
{
  ...
  do { if (!(editor->funcs.cb_set_text != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 437, "editor->funcs.cb_set_text != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                      ...
                      const char *target)
{
  ...
  do { if (!(editor->funcs.cb_set_target != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 469, "editor->funcs.cb_set_target != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                  ...
                  svn_revnum_t revision)
{
  ...
  do { if (!(editor->funcs.cb_delete != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 500, "editor->funcs.cb_delete != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                ...
                svn_revnum_t replaces_rev)
{
  ...
  do { if (!(editor->funcs.cb_copy != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 531, "editor->funcs.cb_copy != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                ...
                svn_revnum_t replaces_rev)
{
  ...
  do { if (!(editor->funcs.cb_move != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 558, "editor->funcs.cb_move != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 567 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  if (editor->cancel_func)
    do { svn_error_t *svn_err__temp = (editor->cancel_func(editor->cancel_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  err = editor->funcs.cb_move(editor->baton, src_relpath, src_revision,
                              dst_relpath, replaces_rev,
                              editor->scratch_pool);
# 589 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  apr_pool_clear(editor->scratch_pool);
  return err;
}
...
svn_editor_complete(svn_editor_t *editor)
{
  ...
  do { if (!(editor->funcs.cb_complete != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 599, "editor->funcs.cb_complete != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_editor_abort(svn_editor_t *editor)
{
  ...
  do { if (!(editor->funcs.cb_abort != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 620, "editor->funcs.cb_abort != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
