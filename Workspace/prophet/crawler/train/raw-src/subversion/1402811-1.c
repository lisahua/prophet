...
# 39 "./subversion/include/private/svn_cache.h" 2
...
# 162 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
typedef apr_uint64_t entry_key_t[2];
# 318 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 488 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 606 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
drop_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((idx <= last_in_group) ? (void) (0) : __assert_fail ("idx <= last_in_group", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 639, __PRETTY_FUNCTION__));
    ...
    if (entry->next == cache->next)
      {
        ...
        if (entry->previous == (4294967295U))
        ...
        else
          {
            ...
            cache->current_data = (((previous->offset + previous->size) + 16 -1) & -16);
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  apr_uint32_t group_index = idx / 16;
  entry_group_t *group = &cache->directory[group_index];
  entry_t *next = cache->next == (4294967295U)
                ? ((void*)0)
  ...
  ((entry->offset == cache->current_data) ? (void) (0) : __assert_fail ("entry->offset == cache->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 732, __PRETTY_FUNCTION__));
  ((idx == group_index * 16 + group->used) ? (void) (0) : __assert_fail ("idx == group_index * 16 + group->used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 733, __PRETTY_FUNCTION__));
  cache->current_data = (((entry->offset + entry->size) + 16 -1) & -16);
  ...
  ((cache->current_data <= cache->data_size) ? (void) (0) : __assert_fail ("cache->current_data <= cache->data_size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 780, __PRETTY_FUNCTION__));
}
...
# 861 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
...
move_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((cache->current_data <= cache->data_size) ? (void) (0) : __assert_fail ("cache->current_data <= cache->data_size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 982, __PRETTY_FUNCTION__));
}
...
# 1014 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {


      apr_uint64_t end = cache->next == (4294967295U)
                       ? cache->data_size
      ...
      if (end >= size + cache->current_data)
        return (!0);
# 1035 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (2 * drop_size > size)
        return 0;



      if (cache->next == (4294967295U))
        {
...
# 1116 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
                                  ...
                                  apr_pool_t *pool)
{
  ...
  if (total_size > 0xffff0000ull * 0x10000)
    total_size = 0xffff0000ull * 0x10000;
  ...
  if (segment_count * 0x10000ull > total_size)
    segment_count = total_size / 0x10000ull;
...
# 1184 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      ...
      while (((2 * 0x2000000ull) << (2 * segment_count_shift))
             < total_size)
        ++segment_count_shift;
  ...
  while ( total_size / segment_count > 0xffff0000ull
         && segment_count < 0x10000)
    segment_count *= 2;
  ...
  max_entry_size = data_size / 4 > ((apr_uint32_t)(0 - 16))
                 ? ((apr_uint32_t)(0 - 16))
                 : data_size / 4;
  ...
  for (seg = 0; seg < segment_count; ++seg)
    {
      ...
      c[seg].first = (4294967295U);
      c[seg].last = (4294967295U);
      c[seg].next = (4294967295U);
      ...
      if (c[seg].data == ((void*)0) || c[seg].directory == ((void*)0))
        {
          ...
          return svn_error_wrap_apr(12, dcgettext ("subversion", "OOM", 5));
        }
...
# 1361 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (buffer && entry && entry->size >= size)
    {
      ...
      entry->size = size;
# 1389 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
  ...
  if ( buffer != ((void*)0)
      ...
      && ensure_data_insertable(cache, size))
    {
      ...
      entry->size = size;
      entry->offset = cache->current_data;
# 1421 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1450 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 1493 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 1580 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  if (buffer == ((void*)0))
    {
      *item = ((void*)0);
      return 0;
...
# 1600 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      cache->hit_count++;
      cache->total_hits++;
# 1646 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1691 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->hit_count++;
      cache->total_writes++;
# 1737 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1782 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
        }
    }
...
# 1833 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1897 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void
...
# 2079 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 2246 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 2373 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
