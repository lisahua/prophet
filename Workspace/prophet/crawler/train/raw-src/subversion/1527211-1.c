...
# 1200 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
      ...
      switch (handling_mode)
        ...
        case connection_mode_thread:
          ...
          status = apr_thread_pool_push(threads, serve_thread, thread_data,
                                        0, ((void*)0));
# 1300 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
          if (status)
            {
