# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c" 2
...
apr_status_t apr_password_validate(const char *passwd,
                                                const char *hash);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c" 2
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c" 2
...
void svn_txdelta__xdelta(svn_txdelta__ops_baton_t *build_baton,
                         ...
                         apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c" 2
                       ...
                       apr_pool_t *pool)
{
  ...
  switch (opcode)
    ...
    case svn_txdelta_new:
      ...
      break;
    default:
      ((!"unknown delta op.") ? (void) (0) : __assert_fail ("!\"unknown delta op.\"", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 274, __PRETTY_FUNCTION__));
    }
                    ...
                    apr_pool_t *pool)
{
  ...
  apr_size_t source_len = 102400;
  apr_size_t target_len = 102400;


  if (b->more_source)
    {
      do { svn_error_t *svn_err__temp = (svn_stream_read(b->source, b->buf, &source_len)); if (svn_err__temp) return (svn_err__temp); } while (0);
      b->more_source = (source_len == 102400);
    }
  else
    source_len = 0;


  do { svn_error_t *svn_err__temp = (svn_stream_read(b->target, b->buf + source_len, &target_len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  b->pos += source_len;
  ...
  if (target_len == 0)
    {
      ...
      if (b->context != ((void*)0))
        do { svn_error_t *svn_err__temp = (svn_checksum_final(&b->checksum, b->context, b->result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_checksum_update(b->context, b->buf + source_len, target_len)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  tb.more = (!0);
  tb.pos = 0;
  tb.buf = apr_palloc(scratch_pool, 2 * 102400);
  ...
  do
    {
      ...
      do { svn_error_t *svn_err__temp = (txdelta_next_window(&window, &tb, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = ((*handler)(window, handler_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_txdelta2(svn_txdelta_stream_t **stream,
             ...
             apr_pool_t *pool)
{
  struct txdelta_baton *b = memset(apr_palloc(pool, sizeof(*b)), 0, sizeof(*b));

  b->source = source;
  b->target = target;
  b->more_source = (!0);
  b->more = (!0);
  b->buf = apr_palloc(pool, 2 * 102400);
...
svn_txdelta(svn_txdelta_stream_t **stream,
            ...
            apr_pool_t *pool)
{
  svn_txdelta2(stream, source, target, (!0), pool);
}
# 509 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c"
static svn_error_t *
tpush_write_handler(void *baton, const char *data, apr_size_t *len)
{
  ...
  apr_pool_t *pool = svn_pool_create_ex(tb->pool, ((void*)0));
  svn_txdelta_window_t *window;
  ...
  while (data_len > 0)
    {
      ...
      if (tb->source_len == 0 && !tb->source_done)
        {
          tb->source_len = 102400;
          do { svn_error_t *svn_err__temp = (svn_stream_read(tb->source, tb->buf, &tb->source_len)); if (svn_err__temp) return (svn_err__temp); } while (0);
          if (tb->source_len < 102400)
            tb->source_done = (!0);
        }


      chunk_len = 102400 - tb->target_len;
      ...
      if (tb->target_len == 102400)
        {
          window = compute_window(tb->buf, tb->source_len, tb->target_len,
                                  tb->source_offset, pool);
          do { svn_error_t *svn_err__temp = (tb->wh(window, tb->whb)); if (svn_err__temp) return (svn_err__temp); } while (0);
                        ...
                        apr_pool_t *pool)
{
  ...
  tb->pool = pool;
  tb->buf = apr_palloc(pool, 2 * 102400);
  tb->source_offset = 0;
  tb->source_len = 0;
  tb->source_done = 0;
  tb->target_len = 0;
  ...
  if (view_len > *buf_size)
    {
      *buf_size *= 2;
      if (*buf_size < view_len)
        *buf_size = view_len;
      do { if (!((((*buf_size) + ((8) - 1)) & ~((8) - 1)) >= *buf_size)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 619, "APR_ALIGN_DEFAULT(*buf_size) >= *buf_size")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      *buf = apr_palloc(pool, *buf_size);
    }

  return 0;
}
# 640 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c"
                               ...
                               apr_size_t *tlen)
{
  ...
  for (op = window->ops; op < window->ops + window->num_ops; op++)
    {
      ...
      ((tpos + op->length <= window->tview_len) ? (void) (0) : __assert_fail ("tpos + op->length <= window->tview_len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 706, __PRETTY_FUNCTION__));

      switch (op->action_code)
        {
        case svn_txdelta_source:

          ((sbuf) ? (void) (0) : __assert_fail ("sbuf", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 712, __PRETTY_FUNCTION__));
          ((op->offset + op->length <= window->sview_len) ? (void) (0) : __assert_fail ("op->offset + op->length <= window->sview_len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 713, __PRETTY_FUNCTION__));
        ...
        case svn_txdelta_target:
          ...
          ((op->offset < tpos) ? (void) (0) : __assert_fail ("op->offset < tpos", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 724, __PRETTY_FUNCTION__));
          patterning_copy(tbuf + tpos, tbuf + op->offset, buf_len);
          break;

        case svn_txdelta_new:

          ((op->offset + op->length <= window->new_data->len) ? (void) (0) : __assert_fail ("op->offset + op->length <= window->new_data->len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 730, __PRETTY_FUNCTION__));
        ...
        default:
          ((!"Invalid delta instruction code") ? (void) (0) : __assert_fail ("!\"Invalid delta instruction code\"", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 737, __PRETTY_FUNCTION__));
        }
  ...
  ((tpos == window->tview_len) ? (void) (0) : __assert_fail ("tpos == window->tview_len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 746, __PRETTY_FUNCTION__));
  *tlen = tpos;
}
...
apply_window(svn_txdelta_window_t *window, void *baton)
{
  ...
  do { if (!(window->sview_len == 0 || (window->sview_offset >= ab->sbuf_offset && (window->sview_offset + window->sview_len >= ab->sbuf_offset + ab->sbuf_len)))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 788, "window->sview_len == 0 || (window->sview_offset >= ab->sbuf_offset && (window->sview_offset + window->sview_len >= ab->sbuf_offset + ab->sbuf_len))")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);





  do { svn_error_t *svn_err__temp = (size_buffer(&ab->tbuf, &ab->tbuf_size, window->tview_len, ab->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (window->sview_offset != ab->sbuf_offset
      || window->sview_len > ab->sbuf_size)
    {
      ...
      do { svn_error_t *svn_err__temp = (size_buffer(&ab->sbuf, &ab->sbuf_size, window->sview_len, ab->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (ab->sbuf_len < window->sview_len)
    {
      ...
      if (err == 0 && len != window->sview_len - ab->sbuf_len)
        err = svn_error_create(SVN_ERR_INCOMPLETE_DATA, ((void*)0),
  ...
  do { if (!(len == window->tview_len)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c", 835, "len == window->tview_len")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 846 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/text_delta.c"
  if (ab->result_digest)
                        ...
                        apr_pool_t *pool)
{
  ...
  return (*handler)(((void*)0), handler_baton);
}
                                     ...
                                     apr_pool_t *pool)
{
  ...
  while (1)
    {
      apr_size_t read_len = 16384;

      do { svn_error_t *svn_err__temp = (svn_stream_read(stream, read_buf, &read_len)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (read_len == 0)
        break;
      ...
      do { svn_error_t *svn_err__temp = (handler(&delta_window, handler_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);

      if (digest)
        do { svn_error_t *svn_err__temp = (svn_checksum_update(md5_checksum_ctx, read_buf, read_len)); if (svn_err__temp) return (svn_err__temp); } while (0);

      if (read_len < 16384)
        break;
    }
  do { svn_error_t *svn_err__temp = (handler(((void*)0), handler_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (digest)
    {
      svn_checksum_t *md5_checksum;

      do { svn_error_t *svn_err__temp = (svn_checksum_final(&md5_checksum, md5_checksum_ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      memcpy(digest, md5_checksum->digest, 16);
    }
                                       ...
                                       apr_pool_t *pool)
{
  ...
  apr_pool_t *wpool = svn_pool_create_ex(pool, ((void*)0));

  do
    {

      apr_pool_clear(wpool);


      do { svn_error_t *svn_err__temp = (svn_txdelta_next_window(&window, txstream, wpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
