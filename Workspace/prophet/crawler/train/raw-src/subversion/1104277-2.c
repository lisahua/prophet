...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c" 2
...
svn_ctype_casecmp(int a,
                  int b);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c" 2
...
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c"
...
# 86 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c"
...
# 200 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c"
}
# 211 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c"
static svn_error_t *
...
put_xlate_handle_node(xlate_handle_node_t *node,
                      ...
                      apr_pool_t *pool)
{
  ((node->next == ((void*)0)) ? (void) (0) : __assert_fail ("node->next == ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c", 375, __PRETTY_FUNCTION__));
  if (!userdata_key)
    return;
  ...
  if (xlate_handle_hash)
    {
      ...
      if (apr_thread_mutex_lock(xlate_handle_mutex) != 0)
        do { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c", 394, ((void*)0)); abort(); } while (1);
      ...
      *node_p = node;
      ...
      if (apr_thread_mutex_unlock(xlate_handle_mutex) != 0)
        do { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c", 412, ((void*)0)); abort(); } while (1);
  ...
  for (; len > 0; --len, data++)
    {
      if ((! (0 != (svn_ctype_table[(unsigned char)((*data))] & (0x0080))))
        ...
        {
# 610 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/utf.c"
          if (data - data_start)
            {
