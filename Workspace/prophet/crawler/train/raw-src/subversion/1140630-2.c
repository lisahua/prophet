...
typedef struct svn_client_status_t
{
  ...
  svn_depth_t depth;
# 2168 "./subversion/include/svn_client.h"
  svn_node_kind_t ood_kind;
...
typedef svn_error_t *(*svn_client_status_func_t)(
                                            ...
                                            apr_pool_t *scratch_pool);
# 2287 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_cleanup(const char *dir,
                   svn_client_ctx_t *ctx,
                   apr_pool_t *scratch_pool);
# 3586 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_resolve(const char *path,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 3779 "./subversion/include/svn_client.h"
...
svn_client_cat2(svn_stream_t *out,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 5006 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_unlock(const apr_array_header_t *targets,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 5210 "./subversion/include/svn_client.h"
...
svn_client_info2(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 5495 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_url_from_path(const char **url,
                         const char *path_or_url,
                         apr_pool_t *pool);
# 5690 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_root_url_from_path(const char **url,
                              const char *path_or_url,
                              svn_client_ctx_t *ctx,
                              apr_pool_t *pool);
# 5707 "./subversion/include/svn_client.h"
svn_error_t *
...
notify(void *baton, const svn_wc_notify_t *n, apr_pool_t *pool)
{
  ...
  switch (n->action)
    ...
    case svn_wc_notify_commit_modified:
      ...
      if ((err = svn_cmdline_printf(pool,
                                    dcgettext ("subversion", "Sending %s       %s\n", 5),
                                    nb->is_wc_to_repos_copy
                                      ? dcgettext ("subversion", "copy of", 5) : "",
                                    path_local)))
        goto print_error;
      break;
    ...
    case svn_wc_notify_commit_copied:
      if (n->mime_type && svn_mime_type_is_binary(n->mime_type))
        {
          if ((err = svn_cmdline_printf(pool,
                                        dcgettext ("subversion", "Adding %s (bin)  %s\n", 5),
                                        nb->is_wc_to_repos_copy
                                          ? dcgettext ("subversion", "copy of", 5) : "",
                                        path_local)))
          goto print_error;
        ...
        {
          if ((err = svn_cmdline_printf(pool,
                                        dcgettext ("subversion", "Adding %s        %s\n", 5),
                                        nb->is_wc_to_repos_copy
                                          ? dcgettext ("subversion", "copy of", 5) : "",
                                        path_local)))
            goto print_error;
    ...
    case svn_wc_notify_commit_deleted:
      if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Deleting %s      %s\n", 5),
                                    nb->is_wc_to_repos_copy
                                      ? dcgettext ("subversion", "copy of", 5) : "",
                                    path_local)))
        goto print_error;
    ...
    case svn_wc_notify_commit_copied_replaced:
      if ((err = svn_cmdline_printf(pool,
                                    dcgettext ("subversion", "Replacing %s     %s\n", 5),
                                    nb->is_wc_to_repos_copy
                                      ? dcgettext ("subversion", "copy of", 5) : "",
                                    path_local)))
        goto print_error;
