# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c" 2
...
svn_config_copy_config(apr_hash_t **cfg_hash,
                       apr_hash_t *src_hash,
                       apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h" 1
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h" 2
...
svn_cl__check_related_source_and_target(const char *path_or_url1,
                                        ...
                                        svn_client_ctx_t *ctx,
                                        apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c" 2
...
svn_cl__help(apr_getopt_t *os,
             ...
             apr_pool_t *pool)
{
  svn_cl__opt_state_t *opt_state = ((void*)0);
  svn_stringbuf_t *version_footer = ((void*)0);


  char help_header_template[] =
  "usage: svn <subcommand> [options] [args]\n" "Subversion command-line client, version %s.\n" "Type 'svn help <subcommand>' for help on a specific subcommand.\n" "Type 'svn --version' to see the program version and RA modules\n" "  or 'svn --version --quiet' to see just the version number.\n" "\n" "Most subcommands take file and/or directory arguments, recursing\n" "on the directories.  If no arguments are supplied to such a\n" "command, it recurses on the current directory (inclusive) by default.\n" "\n" "Available subcommands:\n";
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c"
  char help_footer[] =
  "Subversion is a tool for version control.\n" "For additional information, see http://subversion.apache.org/\n";


  char *help_header =
    apr_psprintf(pool, dcgettext ("subversion", help_header_template, 5), "1" "." "8" "." "0" "-dev");
...
# 89 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/help-cmd.c"
      svn_boolean_t store_auth_creds =
        (!0);
      svn_boolean_t store_passwords =
        (!0);
      svn_boolean_t store_plaintext_passwords = 0;
      svn_config_t *cfg;
      ...
      if (cmd_baton->ctx->config)
        {
          ...
          if (cfg)
            {
              do { svn_error_t *svn_err__temp = (svn_config_get_bool(cfg, &store_auth_creds, "auth", "store-auth-creds", store_auth_creds)); if (svn_err__temp) return (svn_err__temp); } while (0);



              do { svn_error_t *svn_err__temp = (svn_config_get_bool(cfg, &store_passwords, "auth", "store-passwords", store_passwords)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (cfg)
            {
              const char *value;
              do { svn_error_t *svn_err__temp = (svn_config_get_yes_no_ask (cfg, &value, "global", "store-plaintext-passwords", "ASK")); if (svn_err__temp) return (svn_err__temp); } while (0);




              if (0 == svn_cstring_casecmp(value, "TRUE"))
                store_plaintext_passwords = (!0);
            }
        }
      ...
      if (store_plaintext_passwords && store_auth_creds && store_passwords)
        {
          version_footer = svn_stringbuf_create(
              dcgettext ("subversion", "WARNING: Plaintext password storage is enabled!\n\n", 5),
              pool);
