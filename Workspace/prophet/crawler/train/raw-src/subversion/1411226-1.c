...
svn_version__at_least(svn_version_t *version,
                      ...
                      int minor,
                      int patch);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
svn_rdump__get_dump_editor(const svn_delta_editor_t **editor,
                           ...
                           void *cancel_baton,
                           apr_pool_t *pool);
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/svnrdump.h"
svn_error_t *
svn_rdump__load_dumpstream(svn_stream_t *stream,
                           ...
                           void *cancel_baton,
                           apr_pool_t *pool);
# 85 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/svnrdump.h"
svn_error_t *
svn_rdump__normalize_props(apr_hash_t **normal_props,
                           apr_hash_t *props,
                           apr_pool_t *result_pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
struct dir_baton
{
...
# 143 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  *header = svn_stringbuf_create_empty(result_pool);
  ...
  do { svn_error_t *svn_err__temp = (svn_rdump__normalize_props(&normal_props, props, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_hash_write_incremental(normal_props, deleted_props, content_stream, "PROPS-END", scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_stream_close(content_stream)); if (svn_err__temp) return (svn_err__temp); } while (0);


  *header = svn_stringbuf_createf(result_pool, "Prop-delta"
                                  ": true\n");


  buf = apr_psprintf(scratch_pool, "Prop-content-length"
                     ": %" "lu" "\n", (*content)->len);
              ...
              apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_props_content(&header, &content, props, deleted_props, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  *propstring = content;
  ...
  len = header->len;
  do { svn_error_t *svn_err__temp = (svn_stream_write(stream, header->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (dump_data_too)
    {

      do { svn_error_t *svn_err__temp = (svn_stream_printf(stream, scratch_pool, "Content-length" ": %" "lu" "\n\n", content->len)); if (svn_err__temp) return (svn_err__temp); } while (0);




      len = content->len;
      do { svn_error_t *svn_err__temp = (svn_stream_write(stream, content->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);



      do { svn_error_t *svn_err__temp = (svn_stream_puts(stream, "\n\n")); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_hash__clear(props, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_hash__clear(deleted_props, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (trigger_var)
        *trigger_var = 0;
    }
                 ...
                 apr_pool_t *pool)
{
  if (trigger_var && *trigger_var)
    {
      do { svn_error_t *svn_err__temp = (svn_stream_puts(eb->stream, "\n\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
      *trigger_var = 0;
    }
  return 0;
}
# 299 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
static svn_error_t *
          ...
          apr_pool_t *pool)
{
  ...
  switch (action)
    ...
    case svn_node_action_add:
      ...
      if (!is_copy)
        {
# 394 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
          eb->dump_props = (!0);
          break;
        }
...
# 412 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
             ...
             apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (do_dump_props(&pb->eb->propstring, pb->eb->stream, pb->eb->props, pb->eb->deleted_props, &(pb->eb->dump_props), (!0), pb->pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





  do { svn_error_t *svn_err__temp = (do_dump_newlines(pb->eb, &(pb->eb->dump_newlines), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_pending(pb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_pending(db, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (do_dump_props(&eb->propstring, eb->stream, eb->props, eb->deleted_props, &(eb->dump_props), 0, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
