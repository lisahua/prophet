                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  if (svn_path_is_url(path))
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c",133), (svn_error_createf))(SVN_ERR_ILLEGAL_TARGET, ((void*)0), dcgettext ("subversion", "'%s' is not a local path", 5), path));
...
# 148 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c"
