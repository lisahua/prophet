...
svn_io_detect_mimetype2(const char **mimetype,
                        ...
                        apr_pool_t *pool);
# 1708 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_ra_get_log2(svn_ra_session_t *session,
                ...
                void *receiver_baton,
                apr_pool_t *pool);
# 1407 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_ra_get_repos_root2(svn_ra_session_t *session,
                       const char **url,
                       apr_pool_t *pool);
# 1496 "./subversion/include/svn_ra.h"
svn_error_t *
...
typedef svn_error_t *(*svn_ra_init_func_t)(int abi_version,
                                           apr_pool_t *pool,
                                           apr_hash_t *hash);
# 2210 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_ra_serf_init(int abi_version,
                 apr_pool_t *pool,
                 apr_hash_t *hash);
# 2251 "./subversion/include/svn_ra.h"
svn_error_t *
...
svn_wc_conflict_description_create_text2(const char *local_abspath,
                                         apr_pool_t *result_pool);
# 1968 "./subversion/include/svn_wc.h"
svn_wc_conflict_description_t *
...
svn_wc_conflict_description_create_prop2(const char *local_abspath,
                                         ...
                                         const char *property_name,
                                         apr_pool_t *result_pool);
# 2000 "./subversion/include/svn_wc.h"
svn_wc_conflict_description_t *
...
svn_wc_conflicted_p2(svn_boolean_t *text_conflicted_p,
                     ...
                     svn_wc_adm_access_t *adm_access,
                     apr_pool_t *pool);
# 3176 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_ensure_adm(const char *path,
                  ...
                  svn_revnum_t revision,
                  apr_pool_t *pool);
# 3438 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_status_editor5(const svn_delta_editor_t **editor,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 4092 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_get_status_editor4(const svn_delta_editor_t **editor,
                          ...
                          svn_wc_traversal_info_t *traversal_info,
                          apr_pool_t *pool);
# 4118 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_get_status_editor3(const svn_delta_editor_t **editor,
                          ...
                          svn_wc_traversal_info_t *traversal_info,
                          apr_pool_t *pool);
# 4147 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_process_committed_queue2(svn_wc_committed_queue_t *queue,
                                ...
                                apr_pool_t *scratch_pool);
# 4983 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_crawl_revisions4(const char *path,
                        ...
                        svn_wc_traversal_info_t *traversal_info,
                        apr_pool_t *pool);
# 5184 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_update_editor2(svn_revnum_t *target_revision,
                          ...
                          svn_wc_traversal_info_t *ti,
                          apr_pool_t *pool);
# 5491 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_prop_set4(svn_wc_context_t *wc_ctx,
                 ...
                 void *notify_baton,
                 apr_pool_t *scratch_pool);
# 5798 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_diff_editor5(svn_wc_adm_access_t *anchor,
                        ...
                        void **edit_baton,
                        apr_pool_t *pool);
# 6014 "./subversion/include/svn_wc.h"
svn_error_t *
...
# 115 "./subversion/include/svn_client.h"
void
svn_client_get_simple_prompt_provider(
  ...
  int retry_limit,
  apr_pool_t *pool);
# 140 "./subversion/include/svn_client.h"
void
...
svn_client_get_ssl_server_trust_prompt_provider(
  ...
  void *prompt_baton,
  apr_pool_t *pool);
# 298 "./subversion/include/svn_client.h"
void
svn_client_get_ssl_client_cert_prompt_provider(
  ...
  int retry_limit,
  apr_pool_t *pool);
# 320 "./subversion/include/svn_client.h"
void
...
typedef svn_error_t *(*svn_proplist_receiver_t)(
  ...
  apr_hash_t *prop_hash,
  apr_pool_t *pool);
# 376 "./subversion/include/svn_client.h"
svn_client_proplist_item_t *
...
svn_client_add3(const char *path,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 1433 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_mkdir2(svn_commit_info_t **commit_info_p,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 1539 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_delete2(svn_commit_info_t **commit_info_p,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 1643 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_status3(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2225 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_blame5(const char *path_or_url,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 2487 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_blame2(const char *path_or_url,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 2548 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_diff3(const apr_array_header_t *diff_options,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 2728 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_merge2(const char *source1,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 3118 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_revert(const apr_array_header_t *paths,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 3517 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_move(svn_client_commit_info_t **commit_info_p,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 4007 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_revprop_get(const char *propname,
                       ...
                       svn_client_ctx_t *ctx,
                       apr_pool_t *pool);
# 4263 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_proplist(apr_array_header_t **props,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 4323 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_list(const char *path_or_url,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 4607 "./subversion/include/svn_client.h"
svn_error_t *
...
# 4981 "./subversion/include/svn_client.h"
  apr_size_t size;
...
svn_client_patch(const char *patch_abspath,
                 ...
                 apr_pool_t *result_pool,
                 apr_pool_t *scratch_pool);
# 5268 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client__get_normalized_stream(svn_stream_t **normal_stream,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 1084 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
...
svn_client__get_wc_mergeinfo_catalog(svn_mergeinfo_catalog_t *mergeinfo_cat,
                                     ...
                                     apr_pool_t *result_pool,
                                     apr_pool_t *scratch_pool);
# 159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/mergeinfo.h"
svn_error_t *
svn_client__get_repos_mergeinfo(svn_ra_session_t *ra_session,
                                ...
                                apr_pool_t *pool);
# 178 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/mergeinfo.h"
svn_error_t *
...
svn_client__get_wc_or_repos_mergeinfo(svn_mergeinfo_t *target_mergeinfo,
                                      ...
                                      svn_client_ctx_t *ctx,
                                      apr_pool_t *pool);
# 233 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/mergeinfo.h"
svn_error_t *
...
svn_client__parse_mergeinfo(svn_mergeinfo_t *mergeinfo,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 288 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/mergeinfo.h"
svn_error_t *
svn_client__record_wc_mergeinfo(const char *local_abspath,
                                ...
                                svn_client_ctx_t *ctx,
                                apr_pool_t *scratch_pool);
# 328 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/mergeinfo.h"
svn_error_t *
...
# 319 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
                   ...
                   apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_client_commit5(targets, depth, keep_locks, keep_changelists, changelists, revprop_table, &shadow_ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  if (src_revision->kind != svn_opt_revision_unspecified
    ...
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c",753), (svn_error_create))
                   ...
                   apr_pool_t *pool)
{
  return svn_client_export5(result_rev, from, to, peg_revision, revision,
                            overwrite, ignore_externals, 0, depth,
                            native_eol, ctx, pool);
}
...
svn_client_export(svn_revnum_t *result_rev,
                  ...
                  apr_pool_t *pool)
{
  return svn_client_export2(result_rev, from, to, revision, force, ((void*)0), ctx,
                            pool);
}
               ...
               apr_pool_t *pool)
{
  ...
  err = svn_client_log2(targets, start, end, 0, discover_changed_paths,
                        ...
                        pool);
# 1360 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
  if (err && (err->apr_err == SVN_ERR_FS_NO_SUCH_REVISION)
      && (start->kind == svn_opt_revision_head)
      && ((end->kind == svn_opt_revision_number)
          && (end->value.number == 1)))
    {
# 1373 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
      svn_error_clear(err);
      err = 0;
...
# 1957 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
  return 0;
}
