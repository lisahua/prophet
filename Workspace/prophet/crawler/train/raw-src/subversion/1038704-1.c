...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
...
# 120 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
...
# 240 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
static svn_error_t *
          ...
          apr_pool_t *pool)
{
  ...
  switch (action)
    ...
    case svn_node_action_add:
      ...
      if (!is_copy)
        {
# 339 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
          eb->dump_props = (!0);
          break;
        }
...
# 357 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
  ...
  if (eb->dump_text)
    {
      ...
      if (err)
        do { svn_error_t *svn_err__temp = ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c",763), (svn_error_wrap_apr))(err, ((void*)0))); if (svn_err__temp) return (svn_err__temp); } while (0);
