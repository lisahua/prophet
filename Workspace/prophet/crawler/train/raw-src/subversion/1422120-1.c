# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c" 2
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c"
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c" 2
...
svn_sqlite__hotcopy(const char *src_path,
                    const char *dst_path,
                    apr_pool_t *scratch_pool);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c" 2
...
svn_wc__externals_find_target_dups(apr_array_header_t **duplicate_targets,
                                   ...
                                   apr_pool_t *pool,
                                   apr_pool_t *scratch_pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c" 2
...
svn_wc__adm_cleanup_tmp_area(svn_wc__db_t *db,
                             ...
                             apr_pool_t *scratch_pool);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c" 2
...
svn_wc__db_pdh_create_wcroot(svn_wc__db_wcroot_t **wcroot,
                             ...
                             apr_pool_t *result_pool,
                             apr_pool_t *scratch_pool);
# 137 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_private.h"
svn_error_t *
svn_wc__db_wcroot_parse_local_abspath(svn_wc__db_wcroot_t **wcroot,
                                      ...
                                      apr_pool_t *result_pool,
                                      apr_pool_t *scratch_pool);
# 152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_private.h"
...
svn_wc__db_util_fetch_wc_id(apr_int64_t *wc_id,
                            svn_sqlite__db_t *sdb,
                            apr_pool_t *scratch_pool);
# 186 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_private.h"
svn_error_t *
...
svn_wc__db_base_get_info_internal(svn_wc__db_status_t *status,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 278 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_private.h"
svn_error_t *
                            ...
                            apr_pool_t *scratch_pool)
{
  ...
  do { if (!(!svn_sqlite__column_is_null(stmt, 0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c", 71, "!svn_sqlite__column_is_null(stmt, 0)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  if (exclusive)
    do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(*sdb, 135)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_sqlite__create_scalar_function(*sdb, "relpath_depth", 1, relpath_depth_sqlite, ((void*)0))); if (svn_err__temp) return (svn_err__temp); } while (0);


  return 0;
}
# 165 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_util.c"
