...
svn_cl__resolve_postponed_conflicts(void *baton,
                                    ...
                                    svn_client_ctx_t *ctx,
                                    apr_pool_t *scratch_pool);
# 400 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__print_commit_info(const svn_commit_info_t *commit_info,
                          void *baton,
                          apr_pool_t *pool);
# 412 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__print_status(const char *cwd_abspath,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 463 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__revprop_prepare(const svn_opt_revision_t *revision,
                        ...
                        svn_client_ctx_t *ctx,
                        apr_pool_t *pool);
# 513 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
# 608 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__args_to_target_array_print_reserved(apr_array_header_t **targets_p,
                                            ...
                                            apr_pool_t *pool);
# 754 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
const char *
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 812 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
             ...
             apr_pool_t *pool)
{
  ...
  if (! opt_state->old_target && ! opt_state->new_target
      ...
      && opt_state->end_revision.kind == svn_opt_revision_unspecified)
    {
      ...
      if (svn_path_is_url((((const char * *)(targets)->elts)[0]))
          && svn_path_is_url((((const char * *)(targets)->elts)[1])))
        {
      ...
      else if (svn_path_is_url((((const char * *)(targets)->elts)[0])))
        {
...
# 413 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
            }
          else
...
# 436 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
        }
      else
        {
          const char *truepath;
...
# 464 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
            }
          else
...
# 487 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
        }
    }
