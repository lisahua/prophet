...
# 184 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
typedef apr_uint64_t entry_key_t[2];
# 330 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 437 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 552 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  cache_level_t l1;
...
# 602 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 629 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 776 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
allocate_spare_group(svn_membuffer_t *cache)
{
  ...
  ((!group || !group->header.used) ? (void) (0) : __assert_fail ("!group || !group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 846, __PRETTY_FUNCTION__));
  return group;
}
...
free_spare_group(svn_membuffer_t *cache,
                 entry_group_t *group)
{
  ((group->header.used == 0) ? (void) (0) : __assert_fail ("group->header.used == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 856, __PRETTY_FUNCTION__));
  ((group->header.previous != (4294967295U)) ? (void) (0) : __assert_fail ("group->header.previous != (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 857, __PRETTY_FUNCTION__));
  ((group - cache->directory >= (apr_ssize_t)cache->group_count) ? (void) (0) : __assert_fail ("group - cache->directory >= (apr_ssize_t)cache->group_count", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 858, __PRETTY_FUNCTION__));
...
unchain_entry(svn_membuffer_t *cache,
              ...
              apr_uint32_t idx)
{
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 989, __PRETTY_FUNCTION__));
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == level->current_data) ? (void) (0) : __assert_fail ("entry->offset == level->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1117, __PRETTY_FUNCTION__));
  ((idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used) ? (void) (0) : __assert_fail ("idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1118, __PRETTY_FUNCTION__));
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1135, __PRETTY_FUNCTION__));
}
...
# 1187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
  ...
  while (1)
    {
      ...
      ((group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))) ? (void) (0) : __assert_fail ("group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1248, __PRETTY_FUNCTION__));
      group = &cache->directory[group->header.next];
    }
  ...
  if (find_empty)
    {
      ...
      if (group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t)))
        {
# 1287 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
move_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1366, __PRETTY_FUNCTION__));
}
...
promote_entry(svn_membuffer_t *cache, entry_t *entry)
{
  apr_uint32_t idx = get_index(cache, entry);
  apr_size_t size = (((entry->size) + 16 -1) & -16);
  ((get_cache_level(cache, entry) == &cache->l1) ? (void) (0) : __assert_fail ("get_cache_level(cache, entry) == &cache->l1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1376, __PRETTY_FUNCTION__));
  ((idx == cache->l1.next) ? (void) (0) : __assert_fail ("idx == cache->l1.next", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1377, __PRETTY_FUNCTION__));
...
# 1406 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 1439 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
...
# 1552 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_boolean_t
...
# 1618 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
                                  ...
                                  apr_pool_t *pool)
{
  ...
  if (segment_count < 1)
    {
# 1688 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  ...
  ((spare_group_count > 0 && main_group_count > 0) ? (void) (0) : __assert_fail ("spare_group_count > 0 && main_group_count > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1754, __PRETTY_FUNCTION__));
...
# 1824 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      c[seg].lock = ((void*)0);
      if (thread_safe)
        {
          apr_status_t status =
      ...
      do { svn_error_t *svn_err__temp = (svn_mutex__init(&c[seg].counter_mutex, thread_safe && !0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1932 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 1968 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
  ...
  if (level)
    {
      ...
      entry->offset = level->current_data;
      entry->priority = priority;
# 2000 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2032 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 2065 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 2096 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 2143 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  if (buffer == ((void*)0))
    {
      *item = ((void*)0);
      return 0;
...
# 2256 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      do { svn_mutex__t *svn_mutex__m = (cache->counter_mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (increment_hit_counters(cache, entry)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 2301 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2346 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->total_writes++;
# 2392 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2437 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
        }
    }
...
# 2487 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2561 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static void
combine_long_key(svn_membuffer_cache_t *cache,
                 const void *key,
                 apr_ssize_t key_len)
{
  ((cache->last_access) ? (void) (0) : __assert_fail ("cache->last_access", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 2566, __PRETTY_FUNCTION__));
...
# 2830 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 3027 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
