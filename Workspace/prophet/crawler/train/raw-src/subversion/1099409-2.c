...
svn_wc_conflict_description_create_prop2(const char *local_abspath,
                                         ...
                                         const char *property_name,
                                         apr_pool_t *result_pool);
# 1880 "./subversion/include/svn_wc.h"
svn_wc_conflict_description_t *
...
svn_wc_check_wc2(int *wc_format,
                 ...
                 const char *local_abspath,
                 apr_pool_t *scratch_pool);
# 2539 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_entries_read(apr_hash_t **entries,
                    ...
                    svn_boolean_t show_hidden,
                    apr_pool_t *pool);
# 2990 "./subversion/include/svn_wc.h"
svn_wc_entry_t *
...
# 3194 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_walk_entries3(const char *path,
                     ...
                     void *cancel_baton,
                     apr_pool_t *pool);
# 3214 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_walk_entries(const char *path,
                    ...
                    svn_boolean_t show_hidden,
                    apr_pool_t *pool);
# 3250 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_dup_status3(const svn_wc_status3_t *orig_stat,
                   apr_pool_t *pool);
# 3736 "./subversion/include/svn_wc.h"
svn_wc_status2_t *
svn_wc_dup_status2(const svn_wc_status2_t *orig_stat,
                   apr_pool_t *pool);
# 3747 "./subversion/include/svn_wc.h"
svn_wc_status_t *
...
svn_wc_status3(svn_wc_status3_t **status,
               ...
               apr_pool_t *result_pool,
               apr_pool_t *scratch_pool);
# 3790 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_status2(svn_wc_status2_t **status,
               const char *path,
               svn_wc_adm_access_t *adm_access,
               apr_pool_t *pool);
# 3803 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_add4(svn_wc_context_t *wc_ctx,
            ...
            void *notify_baton,
            apr_pool_t *scratch_pool);
# 4408 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_remove_from_revision_control2(svn_wc_context_t *wc_ctx,
                                     ...
                                     void *cancel_baton,
                                     apr_pool_t *pool);
# 4622 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_resolved_conflict5(svn_wc_context_t *wc_ctx,
                          ...
                          void *notify_baton,
                          apr_pool_t *scratch_pool);
# 4708 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_update_editor4(const svn_delta_editor_t **editor,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 5454 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_update_editor2(svn_revnum_t *target_revision,
                          ...
                          svn_wc_traversal_info_t *ti,
                          apr_pool_t *pool);
# 5512 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_client_commit5(const apr_array_header_t *targets,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 1973 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_commit(svn_client_commit_info_t **commit_info_p,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 2056 "./subversion/include/svn_client.h"
...
svn_client_status_dup(const svn_client_status_t *status,
                      apr_pool_t *result_pool);
# 2214 "./subversion/include/svn_client.h"
...
svn_client_status5(svn_revnum_t *result_rev,
                   ...
                   void *status_baton,
                   apr_pool_t *scratch_pool);
# 2289 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_status4(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2312 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_status3(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2337 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_status2(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2362 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_log2(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 2529 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_blame3(const char *path_or_url,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 2643 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_blame2(const char *path_or_url,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 2660 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_diff3(const apr_array_header_t *diff_options,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 2837 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_diff_peg4(const apr_array_header_t *diff_options,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 2943 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_diff_summarize(const char *path1,
                          ...
                          svn_client_ctx_t *ctx,
                          apr_pool_t *pool);
# 3076 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_merge3(const char *source1,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 3235 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_relocate2(const char *wcroot_dir,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 3609 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_relocate(const char *dir,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 3654 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_resolved(const char *path,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 3732 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_copy2(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 3927 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_move5(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4065 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_move2(svn_client_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4117 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_revprop_set2(const char *propname,
                        ...
                        svn_client_ctx_t *ctx,
                        apr_pool_t *pool);
# 4352 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_propget3(apr_hash_t **props,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 4423 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_proplist2(apr_array_header_t **props,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 4545 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_revprop_list(apr_hash_t **props,
                        ...
                        svn_client_ctx_t *ctx,
                        apr_pool_t *pool);
# 4642 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_get_changelists(const char *path,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 5084 "./subversion/include/svn_client.h"
svn_error_t *
...
# 5236 "./subversion/include/svn_client.h"
...
svn_client_info(const char *path_or_url,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 5404 "./subversion/include/svn_client.h"
...
svn_client__handle_externals(apr_hash_t *externals_old,
                             ...
                             svn_client_ctx_t *ctx,
                             apr_pool_t *pool);
# 971 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__get_normalized_stream(svn_stream_t **normal_stream,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 1113 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
...
svn_wc__get_not_present_descendants(const apr_array_header_t **descendants,
                                    ...
                                    apr_pool_t *result_pool,
                                    apr_pool_t *scratch_pool);
# 944 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
                 ...
                 apr_pool_t *pool)
{
  return svn_client_diff5(options, path1, revision1, path2,
                          ...
                          0, ignore_content_type, header_encoding,
               ...
               apr_pool_t *pool)
{
  ...
  err = svn_client_log2(targets, start, end, 0, discover_changed_paths,
                        ...
                        pool);
# 1369 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
                   ...
                   apr_pool_t *pool)
{
  return svn_client_update4(result_revs, paths, revision,
                            ...
                            allow_unver_obstructions, (!0), 0, 0,
                            ctx, pool);
}
                   ...
                   apr_pool_t *pool)
{
  return svn_client_switch3(result_rev, path, switch_url, peg_revision,
                            ...
                            allow_unver_obstructions, (!0), 0, ctx, pool);
}
                              ...
                              apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (rb->info_receiver(rb->info_baton, path, info_from_info2(info2, scratch_pool), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 2168 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
  return 0;
}
