...
# 319 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/deprecated.c"
                ...
                apr_pool_t *pool)
{
  ...
  if (src_revision->kind != svn_opt_revision_unspecified
    ...
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/deprecated.c",753), (svn_error_create))
               ...
               apr_pool_t *pool)
{
  ...
  err = svn_client_log2(targets, start, end, 0, discover_changed_paths,
                        ...
                        pool);
# 1360 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/deprecated.c"
  if (err && (err->apr_err == SVN_ERR_FS_NO_SUCH_REVISION)
      && (start->kind == svn_opt_revision_head)
      && ((end->kind == svn_opt_revision_number)
          && (end->value.number == 1)))
    {
# 1373 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/deprecated.c"
      svn_error_clear(err);
      err = 0;
...
# 1957 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/deprecated.c"
  return 0;
}
