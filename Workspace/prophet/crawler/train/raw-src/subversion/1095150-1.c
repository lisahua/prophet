...
exec_sql(svn_sqlite__db_t *db, const char *sql)
{
  ...
  if (sqlite_err != 0)
    {
      svn_error_t *err = svn_error_create(((sqlite_err) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0),
                                          err_msg);
...
svn_sqlite__exec_statements(svn_sqlite__db_t *db, int stmt_idx)
{
  do { if (!(stmt_idx < db->nbr_statements)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c", 145, "stmt_idx < db->nbr_statements")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  return (exec_sql(db, db->statement_strings[stmt_idx]));
}
...
svn_sqlite__get_statement(svn_sqlite__stmt_t **stmt, svn_sqlite__db_t *db,
                          int stmt_idx)
{
  do { if (!(stmt_idx < db->nbr_statements)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c", 155, "stmt_idx < db->nbr_statements")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  if (db->prepared_stmts[stmt_idx] == ((void*)0))
    do { svn_error_t *svn_err__temp = (svn_sqlite__prepare(&db->prepared_stmts[stmt_idx], db, db->statement_strings[stmt_idx], db->state_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    const char *text, apr_pool_t *result_pool)
{
  *stmt = apr_palloc(result_pool, sizeof(**stmt));
  ...
  do { int sqlite_err__temp = (sqlite3_prepare_v2(db->db3, text, -1, &(*stmt)->s3stmt, ((void*)0))); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((db)->db3)); } while (0);
  ...
  if (sqlite_result != 101 && sqlite_result != 100)
    {
      ...
      err1 = svn_error_create(((sqlite_result) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_result) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0),
      ...
      switch (*fmt)
        {
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c", 305, ((void*)0))); } while (0);
        }
    }
...
svn_sqlite__bind_int(svn_sqlite__stmt_t *stmt,
                     ...
                     int val)
{
  do { int sqlite_err__temp = (sqlite3_bind_int(stmt->s3stmt, slot, val)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  return 0;
}
...
svn_sqlite__bind_int64(svn_sqlite__stmt_t *stmt,
                       ...
                       apr_int64_t val)
{
  do { int sqlite_err__temp = (sqlite3_bind_int64(stmt->s3stmt, slot, val)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  return 0;
}
...
svn_sqlite__bind_text(svn_sqlite__stmt_t *stmt,
                      ...
                      const char *val)
{
  do { int sqlite_err__temp = (sqlite3_bind_text(stmt->s3stmt, slot, val, -1, ((sqlite3_destructor_type)-1))); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
...
svn_sqlite__bind_blob(svn_sqlite__stmt_t *stmt,
                      ...
                      apr_size_t len)
{
  do { int sqlite_err__temp = (sqlite3_bind_blob(stmt->s3stmt, slot, val, (int) len, ((sqlite3_destructor_type)-1))); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
                       ...
                       int value)
{
  ...
  do { int sqlite_err__temp = (sqlite3_bind_text(stmt->s3stmt, slot, word, -1, ((sqlite3_destructor_type)0))); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
...
{
  if (((value) >= 0))
    do { int sqlite_err__temp = (sqlite3_bind_int64(stmt->s3stmt, slot, (sqlite_int64)value)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);

  else
    do { int sqlite_err__temp = (sqlite3_bind_null(stmt->s3stmt, slot)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
...
svn_sqlite__finalize(svn_sqlite__stmt_t *stmt)
{
  do { int sqlite_err__temp = (sqlite3_finalize(stmt->s3stmt)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  return 0;
}
...
svn_sqlite__reset(svn_sqlite__stmt_t *stmt)
{
  do { int sqlite_err__temp = (sqlite3_reset(stmt->s3stmt)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  do { int sqlite_err__temp = (sqlite3_clear_bindings(stmt->s3stmt)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((stmt->db)->db3)); } while (0);
  stmt->needs_reset = 0;
  return 0;
}
                               ...
                               apr_pool_t *scratch_pool)
{
  ...
  return (exec_sql(db, pragma_cmd));
}
# 626 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c"
  ...
  while (current_schema < ub->latest_schema)
    {
      ...
      if (ub->upgrade_sql[current_schema])
        do { svn_error_t *svn_err__temp = (exec_sql(db, ub->upgrade_sql[current_schema])); if (svn_err__temp) return (svn_err__temp); } while (0);
                                ...
                                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_sqlite__prepare(&stmt, db, "PRAGMA user_version;", scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
init_sqlite(void *baton, apr_pool_t *pool)
{
...

  {
    ...
    if (err != 0 && err != 21)
      return svn_error_create(((err) == 8 ? SVN_ERR_SQLITE_READONLY : ((err) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0),
                              dcgettext ("subversion", "Could not configure SQLite", 5));
  }
  do { int sqlite_err__temp = (sqlite3_initialize()); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), dcgettext ("subversion", "Could not initialize SQLite", 5)); } while (0);
  ...
  do { int sqlite_err__temp = (sqlite3_enable_shared_cache((!0))); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), dcgettext ("subversion", "Could not initialize SQLite shared cache", 5)); } while (0);
...
{
  {
    ...
    if (mode == svn_sqlite__mode_readonly)
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c", 777, ((void*)0))); } while (0);
# 787 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c"
    flags |= 0x00008000;
      ...
      if (err_code != 0)
        {
          ...
          return svn_error_create(((err_code) == 8 ? SVN_ERR_SQLITE_READONLY : ((err_code) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), msg);
        }
    }
  }


  do { int sqlite_err__temp = (sqlite3_busy_timeout(*db3, 10000)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg(*db3)); } while (0);
                               ...
                               apr_pool_t *scratch_pool)
{
  ...
  do { int sqlite_err__temp = (sqlite3_close(db.db3)); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((&db)->db3)); } while (0);
...
close_apr(void *data)
{
  ...
  if (result != 0)
    return ((result) == 8 ? SVN_ERR_SQLITE_READONLY : ((result) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) );
...
# 897 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c"
  do { svn_error_t *svn_err__temp = (exec_sql(*db, "PRAGMA case_sensitive_like=1;" "PRAGMA synchronous=OFF;" "PRAGMA recursive_triggers=ON;")); if (svn_err__temp) return (svn_err__temp); } while (0);
# 927 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c"
  ...
  if (err)
    {
      ...
      if (err2 && err2->apr_err == SVN_ERR_SQLITE_BUSY)
        {
# 1026 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sqlite.c"
...
svn_sqlite__with_transaction(svn_sqlite__db_t *db,
                             ...
                             apr_pool_t *scratch_pool )
{
  do { svn_error_t *svn_err__temp = (exec_sql(db, "BEGIN TRANSACTION;")); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_sqlite__with_immediate_transaction(
  ...
  apr_pool_t *scratch_pool )
{
  do { svn_error_t *svn_err__temp = (exec_sql(db, "BEGIN IMMEDIATE TRANSACTION;")); if (svn_err__temp) return (svn_err__temp); } while (0);
  return (with_transaction(db, cb_func, cb_baton, scratch_pool));
                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (exec_sql(db, buf)); if (svn_err__temp) return (svn_err__temp); } while (0);
  err = cb_func(cb_baton, db, scratch_pool);
                    ...
                    apr_pool_t *scratch_pool)
{
...

  {
    ...
    if (rc1 != 101)
      do { int sqlite_err__temp = (rc1); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((dst_db)->db3)); } while (0);
    do { int sqlite_err__temp = (rc2); if (sqlite_err__temp != 0) return svn_error_create(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : SVN_ERR_SQLITE_ERROR) ), ((void*)0), sqlite3_errmsg((dst_db)->db3)); } while (0);
