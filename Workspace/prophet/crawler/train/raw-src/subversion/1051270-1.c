# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
...
apr_status_t apr_mcast_interface(apr_socket_t *sock,
                                              apr_sockaddr_t *iface);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2

# 1 "./subversion/include/svn_error_codes.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
...
svn_fspath__get_longest_ancestor(const char *fspath1,
                                 const char *fspath2,
                                 apr_pool_t *result_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
...
svn_ra_get_ra_library(svn_ra_plugin_t **library,
                      ...
                      const char *url,
                      apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
...
typedef svn_error_t *(*svn_ra__lock_retry_func_t)(void *baton,
                                                  ...
                                                  apr_pool_t *pool);
# 107 "./subversion/include/private/svn_ra_private.h"
svn_error_t *
svn_ra__get_operational_lock(const svn_string_t **lock_string_p,
                             ...
                             void *cancel_baton,
                             apr_pool_t *pool);
# 131 "./subversion/include/private/svn_ra_private.h"
svn_error_t *
svn_ra__release_operational_lock(svn_ra_session_t *session,
                                 const char *lock_revprop_name,
                                 const svn_string_t *mylocktoken,
                                 apr_pool_t *scratch_pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c" 2
                                        ...
                                        apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_has_capability(ra_session, &mergeinfo_capable, "mergeinfo", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! mergeinfo_capable)
    {
      ...
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c",67), (svn_error_createf))(SVN_ERR_UNSUPPORTED_FEATURE, ((void*)0),
                               dcgettext ("subversion", "Retrieval of mergeinfo unsupported by '%s'", 5),
                                 ...
                                 apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_has_capability(session, &be_atomic, "atomic-revprops", scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_ra_rev_prop(session, 0, lock_revprop_name, &reposlocktoken, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (reposlocktoken && !svn_string_compare(reposlocktoken, mylocktoken))
    {
      ...
      if (is_atomicity_error(err))
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c",106), (svn_error_createf))(err->apr_err, err,
                                 dcgettext ("subversion", "Lock was stolen by '%s'; unable to " "remove it", 5), reposlocktoken->data);
                             ...
                             apr_pool_t *pool)
{
  ...
  *lock_string_p = ((void*)0);
  if (stolen_lock_p)
    *stolen_lock_p = ((void*)0);
  ...
  if (apr_err)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c",144), (svn_error_wrap_apr))(apr_err,
                              dcgettext ("subversion", "Unable to determine local hostname", 5));
  ...
  for (i = 0; i < num_retries; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_ra_rev_prop(session, 0, lock_revprop_name, &reposlocktoken, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (reposlocktoken)
        {
          if (svn_string_compare(reposlocktoken, mylocktoken))
            ...
            {
              if (retry_func)
                do { svn_error_t *svn_err__temp = (retry_func(retry_baton, reposlocktoken, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_ra/util.c",239), (svn_error_createf))(22, ((void*)0),
                           dcgettext ("subversion", "Couldn't get lock on destination repos " "after %d attempts", 5), i);
