...
svn_io__is_finfo_read_only(svn_boolean_t *read_only,
                           apr_finfo_t *file_info,
                           apr_pool_t *pool);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c" 2
# 109 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c", 129, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
...
# 333 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
  if (!checksum
  ...
  if (! force_comparison)
    {
# 372 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
