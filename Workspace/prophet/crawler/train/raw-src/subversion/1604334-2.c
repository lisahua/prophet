...
svn_wc_translated_file(const char **xlated_p,
                       ...
                       apr_pool_t *pool);
# 7872 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
svn_wc_translated_stream(svn_stream_t **stream,
                         ...
                         apr_uint32_t flags,
                         apr_pool_t *pool);
# 7915 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_transmit_text_deltas3(const svn_checksum_t **new_text_base_md5_checksum,
                             ...
                             apr_pool_t *result_pool,
                             apr_pool_t *scratch_pool);
# 7941 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_transmit_prop_deltas(const char *path,
                            ...
                            const char **tempfile,
                            apr_pool_t *pool);
# 8015 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_get_default_ignores(apr_array_header_t **patterns,
                           apr_hash_t *config,
                           apr_pool_t *pool);
# 8028 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_match_ignore_list(const char *str,
                         ...
                         apr_pool_t *pool);
# 8073 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_add_lock2(svn_wc_context_t *wc_ctx,
                 const char *abspath,
                 const svn_lock_t *lock,
                 apr_pool_t *scratch_pool);
# 8086 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
# 8177 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_revision_status(svn_wc_revision_status_t **result_p,
                       ...
                       void *cancel_baton,
                       apr_pool_t *pool);
# 8238 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_crop_tree2(svn_wc_context_t *wc_ctx,
                  ...
                  void *notify_baton,
                  apr_pool_t *scratch_pool);
# 8349 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
svn_wc_crop_tree(svn_wc_adm_access_t *anchor,
                 ...
                 void *cancel_baton,
                 apr_pool_t *pool);
# 8379 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_exclude(svn_wc_context_t *wc_ctx,
               ...
               void *notify_baton,
               apr_pool_t *scratch_pool);
# 8417 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_client_relocate(const char *dir,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 4282 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_revert2(const apr_array_header_t *paths,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 4316 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_revert(const apr_array_header_t *paths,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 4340 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_resolve(const char *path,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 4418 "./subversion/include/svn_client.h"
...
svn_client_move6(const apr_array_header_t *src_paths,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4728 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_move4(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4772 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_proplist4(const char *target,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *scratch_pool);
# 5304 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_list(const char *path_or_url,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 5715 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_ls(apr_hash_t **dirents,
              ...
              svn_client_ctx_t *ctx,
              apr_pool_t *pool);
# 5798 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_cat3(apr_hash_t **props,
                ...
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 5816 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_cat2(svn_stream_t *out,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 5832 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_cat(svn_stream_t *out,
               ...
               svn_client_ctx_t *ctx,
               apr_pool_t *pool);
# 5880 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_lock(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 6008 "./subversion/include/svn_client.h"
svn_error_t *
...
# 6113 "./subversion/include/svn_client.h"
  apr_size_t size;
# 6122 "./subversion/include/svn_client.h"
...
typedef svn_error_t *(*svn_info_receiver_t)(
  ...
  apr_pool_t *pool);
# 6169 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_info_t *
...
svn_client_info2(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 6358 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_patch(const char *patch_abspath,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *scratch_pool);
# 6527 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_url_from_path(const char **url,
                         const char *path_or_url,
                         apr_pool_t *pool);
# 6563 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_get_repos_root(const char **repos_root_url,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 6580 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_root_url_from_path(const char **url,
                              ...
                              svn_client_ctx_t *ctx,
                              apr_pool_t *pool);
# 6597 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_uuid_from_url(const char **uuid,
                         ...
                         svn_client_ctx_t *ctx,
                         apr_pool_t *pool);
# 6615 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_uuid_from_path(const char **uuid,
                          ...
                          svn_client_ctx_t *ctx,
                          apr_pool_t *pool);
# 6651 "./subversion/include/svn_client.h"
svn_error_t *
