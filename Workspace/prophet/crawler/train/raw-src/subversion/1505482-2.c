# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c"
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c" 2
...
# 396 "/usr/include/x86_64-linux-gnu/zconf.h" 2 3 4
# 406 "/usr/include/x86_64-linux-gnu/zconf.h" 3 4
   typedef unsigned z_crc_t;
# 421 "/usr/include/x86_64-linux-gnu/zconf.h" 3 4
...
# 422 "/usr/include/x86_64-linux-gnu/zconf.h" 2 3 4
...
# 428 "/usr/include/x86_64-linux-gnu/zconf.h" 2 3 4
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c" 2
...
svn__decompress(svn_stringbuf_t *in,
                svn_stringbuf_t *out,
                apr_size_t limit);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c" 2
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c"
unsigned char *
svn__encode_uint(unsigned char *p, apr_uint64_t val)
{
  int n;
            ...
            int compression_level)
{
  ...
  if (len < 512 || compression_level == 0)
    {
  ...
  else
    {
      ...
      zerr = compress2((unsigned char *)out->data + intlen, &endlen,
                       ...
                       compression_level);
      if (zerr != 0)
        return (svn_error__wrap_zlib( zerr, "compress2", dcgettext ("subversion", "Compression of svndiff data failed", 5)));
...
# 166 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/compress.c"
static svn_error_t *
            ...
            apr_size_t limit)
{
  ...
  if (in == ((void*)0) || len != size)
    return svn_error_create(SVN_ERR_SVNDIFF_INVALID_COMPRESSED_DATA, ((void*)0),
                            dcgettext ("subversion", "Decompression of zlib compressed data failed: no size", 5));
  if (len > limit)
    return svn_error_create(SVN_ERR_SVNDIFF_INVALID_COMPRESSED_DATA, ((void*)0),
                            dcgettext ("subversion", "Decompression of zlib compressed data failed: " "size too large", 5));
  ...
  if (inLen == len)
  ...
  else
    {
      ...
      if (zerr != 0)
        return (svn_error__wrap_zlib( zerr, "uncompress", dcgettext ("subversion", "Decompression of svndiff data failed", 5)));
              ...
              int compression_method)
{
  if ( compression_method < 0
    ...
    return svn_error_createf(SVN_ERR_BAD_COMPRESSION_METHOD, ((void*)0),
                             dcgettext ("subversion", "Unsupported compression method %d", 5),
                             compression_method);
