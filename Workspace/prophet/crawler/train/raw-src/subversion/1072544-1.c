...
# 90 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  ...
  if (memcache)
    ...
    {
      do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->fulltext_cache), svn_fs__get_global_membuffer_cache(), ((void*)0), ((void*)0), (-1), apr_pstrcat(pool, prefix, "TEXT", ((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
