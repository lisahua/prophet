                         ...
                         apr_pool_t *pool)
{
  ...
  if (kind != svn_node_none && kind != svn_node_dir)
    ...
    do { if (!(kind == svn_node_dir)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 67, "kind == svn_node_dir")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 222, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 241, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
  ...
  apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 262, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                               ...
                               apr_pool_t *pool)
{
  ...
  do { if (!(svn_uri_is_canonical(repos_url, pool) && svn_relpath_is_canonical(path_in_repos, pool) && ((peg_rev) >= 0))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 360, "svn_uri_is_canonical(repos_url, pool) && svn_relpath_is_canonical(path_in_repos, pool) && SVN_IS_VALID_REVNUM(peg_rev)"); abort(); } } while (0);
