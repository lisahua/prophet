...
svn_fs__prop_lists_equal(apr_hash_t *a,
                         apr_hash_t *b,
                         apr_pool_t *pool);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c" 2
...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c" 2
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
fs_serialized_init(svn_fs_t *fs, apr_pool_t *common_pool, apr_pool_t *pool)
{
  ...
  apr_status_t status;
# 94 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
  do { if (!(fs->uuid)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c", 94, "fs->uuid")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(ffd->instance_id)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c", 95, "ffd->instance_id")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  key = apr_pstrcat(pool, "svn-fsfs-shared-",
...
{
  struct fs_freeze_baton_t *b = baton;
  do { svn_error_t *svn_err__temp = (svn_fs_fs__with_write_lock(b->fs, fs_freeze_body, baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          apr_pool_t *pool)
{
  ...
  if (ffd->format >= 7)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__with_pack_lock(fs, fs_freeze_body2, &b, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
    do { svn_error_t *svn_err__temp = (fs_freeze_body2(&b, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            apr_pool_t *pool)
{
  ...
  return (svn_fs_fs__set_uuid(fs, uuid, ((void*)0), pool));
}
...
# 318 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
fs_open(svn_fs_t *fs,
        const char *path,
        svn_mutex__t *common_pool_lock,
                     ...
                     apr_pool_t *common_pool)
{
  ...
  apr_pool_t * subpool = svn_pool_create_ex(pool, ((void*)0));
# 366 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
  fs->path = apr_pstrdup(fs->pool, path);

  do { svn_error_t *svn_err__temp = (initialize_fs_struct(fs)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_fs_fs__read_format_file(fs, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 387 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
      svn_error_clear(err);
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__write_current(fs, 0, 1, 1, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 466 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
           ...
           apr_pool_t *common_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__hotcopy_prepare_target(src_fs, dst_fs, dst_path, incremental, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  uninitialize_fs_struct(dst_fs);


  do { svn_error_t *svn_err__temp = (fs_open(dst_fs, dst_path, common_pool_lock, pool, common_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (cancel_func)
    do { svn_error_t *svn_err__temp = (cancel_func(cancel_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
