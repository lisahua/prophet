                         ...
                         apr_pool_t *scratch_pool)
{
  ...
  do { if (!(strlen(data) > 6)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/checksum.c", 181, "strlen(data) > 6")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
