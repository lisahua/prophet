# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
svn_io_write_version_file(const char *path,
                          int version,
                          apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
svn_wc__write_check(svn_wc__db_t *db,
                    const char *local_abspath,
                    apr_pool_t *scratch_pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
svn_wc__nonexistent_path(svn_wc__db_t *db,
                         const char *adm_abspath,
                         apr_pool_t *scratch_pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
svn_wc__internal_translated_file(const char **xlated_abspath,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2


# 1 "./subversion/svn_private_config.h" 1
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
...
svn_io__is_finfo_read_only(svn_boolean_t *read_only,
                           apr_finfo_t *file_info,
                           apr_pool_t *pool);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
# 109 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c", 129, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (has_props)
    {
      do { svn_error_t *svn_err__temp = (svn_wc__get_translate_info(&eol_style, &eol_str, &keywords, &special, db, versioned_file_abspath, ((void*)0), scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! need_translation
      ...
      && (versioned_file_size != pristine_size))
    {
      *modified_p = (!0);
      ...
      return (svn_stream_close(pristine_stream));
    }
# 181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (verify_checksum || need_translation)
    {
      ...
      if (special)
        {
          do { svn_error_t *svn_err__temp = (svn_subst_read_specialfile(&v_stream, versioned_file_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

        }
      else
        {
          do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(&v_stream, versioned_file_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_contents_same2(&same, pristine_stream, v_stream, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (checksum && !svn_checksum_match(checksum, verify_checksum))
            return svn_error_create(SVN_ERR_WC_CORRUPT_TEXT_BASE,
                    svn_checksum_mismatch_err(verify_checksum, checksum,
                                              scratch_pool,
                                dcgettext ("subversion", "Checksum mismatch indicates corrupt " "text base for file: '%s'", 5),
                                 ...
                                 apr_pool_t *scratch_pool)
{
  ...
  apr_finfo_t finfo;
  apr_int32_t wanted
    = 0x00000100 | 0x00000010 | 0x00008000 | 0x00000001;

  if (executable_p)
    wanted |= (0x00700000);
  if (read_only_p)
    wanted |= (0x00700000 | 0x00030000);
  ...
  if (executable_p)
    do { svn_error_t *svn_err__temp = (svn_io__is_finfo_executable(executable_p, &finfo, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (read_only_p)
    do { svn_error_t *svn_err__temp = (svn_io__is_finfo_read_only(read_only_p, &finfo, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_wc__db_read_info(&status, &kind, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &checksum, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &recorded_size, &recorded_mod_time, ((void*)0), ((void*)0), ((void*)0), &has_props, &props_mod, ((void*)0), ((void*)0), ((void*)0), db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 333 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (!checksum
  ...
  if (! force_comparison)
    {
# 372 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
 ...
 compare_them:
  do { svn_error_t *svn_err__temp = (svn_wc__db_pristine_read(&pristine_stream, &pristine_size, db, local_abspath, checksum, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (compare_and_verify(modified_p, db, local_abspath, finfo.size, pristine_stream, pristine_size, has_props, props_mod, compare_textbases, force_comparison ? checksum : ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!*modified_p)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__db_wclock_owns_lock(&own_lock, db, local_abspath, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_wc_text_modified_p2(svn_boolean_t *modified_p,
                        ...
                        apr_pool_t *scratch_pool)
{
  return svn_wc__internal_file_modified_p(modified_p, ((void*)0), ((void*)0), wc_ctx->db,
                              ...
                              apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__db_read_info(((void*)0), &node_kind, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &conflicted, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      switch (cd->kind)
        {
          case svn_wc_conflict_kind_text:
            ...
            if (cd->base_abspath)
              {
                do { svn_error_t *svn_err__temp = (svn_io_check_path(cd->base_abspath, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            if (cd->their_abspath)
              {
                do { svn_error_t *svn_err__temp = (svn_io_check_path(cd->their_abspath, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            if (cd->my_abspath)
              {
                do { svn_error_t *svn_err__temp = (svn_io_check_path(cd->my_abspath, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_wc_conflicted_p3(svn_boolean_t *text_conflicted_p,
                     ...
                     apr_pool_t *scratch_pool)
{
  return (svn_wc__internal_conflicted_p(text_conflicted_p, prop_conflicted_p, tree_conflicted_p, wc_ctx->db, local_abspath, scratch_pool));
                         ...
                         apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__internal_propget(&value, db, local_abspath, "svn:" "mime-type", scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_wc__min_max_revisions(svn_revnum_t *min_revision,
                          ...
                          apr_pool_t *scratch_pool)
{
  return (svn_wc__db_min_max_revisions(min_revision, max_revision, wc_ctx->db, local_abspath, committed, scratch_pool));
...
svn_wc__is_sparse_checkout(svn_boolean_t *is_sparse_checkout,
                           ...
                           apr_pool_t *scratch_pool)
{
  return (svn_wc__db_is_sparse_checkout(is_sparse_checkout, wc_ctx->db, local_abspath, scratch_pool));
...
svn_wc__has_switched_subtrees(svn_boolean_t *is_switched,
                              ...
                              apr_pool_t *scratch_pool)
{
  return (svn_wc__db_has_switched_subtrees(is_switched, wc_ctx->db, local_abspath, trail_url, scratch_pool));
...
svn_wc__has_local_mods(svn_boolean_t *is_modified,
                       ...
                       apr_pool_t *scratch_pool)
{
  return (svn_wc__db_has_local_mods(is_modified, wc_ctx->db, local_abspath, cancel_func, cancel_baton, scratch_pool));
