...
svn_client_import2(svn_commit_info_t **commit_info_p,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 1756 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_commit3(svn_commit_info_t **commit_info_p,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 1862 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_status2(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2207 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_log5(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 2293 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_log4(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 2318 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_log3(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 2340 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_diff5(const apr_array_header_t *diff_options,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 2630 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_diff_summarize(const char *path1,
                          ...
                          svn_client_ctx_t *ctx,
                          apr_pool_t *pool);
# 2925 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_merge_peg3(const char *source,
                      ...
                      svn_client_ctx_t *ctx,
                      apr_pool_t *pool);
# 3156 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_suggest_merge_sources(apr_array_header_t **suggestions,
                                 ...
                                 svn_client_ctx_t *ctx,
                                 apr_pool_t *pool);
# 3231 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_resolved(const char *path,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 3508 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_copy5(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 3626 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_move4(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 3814 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_move(svn_client_commit_info_t **commit_info_p,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 3926 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_propset2(const char *propname,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 3965 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_proplist2(apr_array_header_t **props,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 4222 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_list(const char *path_or_url,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 4526 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_cat2(svn_stream_t *out,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 4617 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_add_to_changelist(const apr_array_header_t *paths,
                             ...
                             svn_client_ctx_t *ctx,
                             apr_pool_t *pool);
# 4687 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_uuid_from_url(const char **uuid,
                         ...
                         svn_client_ctx_t *ctx,
                         apr_pool_t *pool);
# 5245 "./subversion/include/svn_client.h"
svn_error_t *
...
# 315 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
                ...
                apr_pool_t *pool)
{
  ...
  if (src_revision->kind != svn_opt_revision_unspecified
    ...
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c",635), (svn_error_create))
               ...
               apr_pool_t *pool)
{
  ...
  err = svn_client_log2(targets, start, end, 0, discover_changed_paths,
                        ...
                        pool);
# 1242 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
  if (err && (err->apr_err == SVN_ERR_FS_NO_SUCH_REVISION)
      && (start->kind == svn_opt_revision_head)
      && ((end->kind == svn_opt_revision_number)
          && (end->value.number == 1)))
    {
# 1255 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
      svn_error_clear(err);
      err = 0;
...
# 1839 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/deprecated.c"
  return 0;
}
