...
# 1479 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c"
svn_error_t *
svn_repos__replay_ev2(svn_fs_root_t *root,
                      const char *base_repos_relpath,
                      svn_revnum_t low_water_mark,
                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  do { if (!(!svn_dirent_is_absolute(base_repos_relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/replay.c", 1497, "!svn_dirent_is_absolute(base_repos_relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
