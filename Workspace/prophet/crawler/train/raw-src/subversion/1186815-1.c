# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c" 2
...
svn_cl__print_status_xml(const char *path,
                         ...
                         svn_client_ctx_t *ctx,
                         apr_pool_t *pool);
# 428 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__edit_string_externally(svn_string_t **edited_contents,
                               ...
                               const char *encoding,
                               apr_pool_t *pool);
# 521 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
svn_cl__edit_file_externally(const char *path,
                             const char *editor_cmd,
                             apr_hash_t *config,
                             apr_pool_t *pool);
# 539 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
svn_cl__merge_file_externally(const char *base_path,
                              ...
                              apr_pool_t *pool);
# 559 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__operation_str_human_readable(svn_wc_operation_t operation,
                                     apr_pool_t *pool);
# 718 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
void
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c" 2
                   ...
                   apr_pool_t *pool)
{
  ...
  if (opt_state->quiet)
# 93 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/changelist-cmd.c"
      ...
      for (i = 0; i < errors->nelts; i++)
        {
          ...
          if (status == SVN_ERR_WC_PATH_NOT_FOUND)
            err = svn_error_quick_wrap(err,
                                       dcgettext ("subversion", "Could not display changelists of " "all targets because some targets " "don't exist", 5));


          else if (status == SVN_ERR_UNVERSIONED_RESOURCE)
            err = svn_error_quick_wrap(err,
                                       dcgettext ("subversion", "Could not display changelists of " "all targets because some targets " "are not versioned", 5));
