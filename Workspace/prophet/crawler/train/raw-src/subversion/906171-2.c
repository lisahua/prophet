...
# 304 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__conflict_handler(svn_wc_conflict_result_t **result,
                         ...
                         void *baton,
                         apr_pool_t *pool);
# 355 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__print_xml_commit(svn_stringbuf_t **outstr,
                         ...
                         const char *date,
                         apr_pool_t *pool);
# 437 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__revprop_prepare(const svn_opt_revision_t *revision,
                        ...
                        svn_client_ctx_t *ctx,
                        apr_pool_t *pool);
# 470 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__edit_string_externally(svn_string_t **edited_contents,
                               ...
                               const char *encoding,
                               apr_pool_t *pool);
# 492 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__edit_file_externally(const char *path,
                             const char *editor_cmd,
                             apr_hash_t *config,
                             apr_pool_t *pool);
# 510 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__merge_file_externally(const char *base_path,
                              ...
                              apr_pool_t *pool);
# 538 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__operation_str_human_readable(svn_wc_operation_t operation,
                                     apr_pool_t *pool);
# 663 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
void
...
svn_cl__indent_string(const char *str,
                      const char *indent,
                      apr_pool_t *pool);
# 705 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
const char *
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         const char *wc_repos_root_URL,
                         apr_pool_t *pool);
# 717 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
const char *
...
svn_cl__print_conflict_stats(void *notify_baton, apr_pool_t *pool)
{
  ...
  if (nb->in_external)
    {
      header = dcgettext ("subversion", "Summary of conflicts in external item:\n", 5);
    ...
    {
      header = dcgettext ("subversion", "Summary of conflicts:\n", 5);
  ...
  if (text_conflicts > 0 || prop_conflicts > 0
    || tree_conflicts > 0 || skipped_paths > 0)
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%s", header)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
notify(void *baton, const svn_wc_notify_t *n, apr_pool_t *pool)
{
  ...
  switch (n->action)
      ...
      if (nb->in_external)
      ...
      else
        {
          svn_error_t *warn_err =
            (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c",467), (svn_error_createf))(SVN_ERR_BASE, ((void*)0),
    ...
    case svn_wc_notify_changelist_set:
      if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Path '%s' is now a member of " "changelist '%s'.\n", 5),
    ...
    case svn_wc_notify_changelist_clear:
      if ((err = svn_cmdline_printf(pool,
                                    dcgettext ("subversion", "Path '%s' is no longer a member of " "a changelist.\n", 5),
