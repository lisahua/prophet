                  ...
                  apr_pool_t *pool)
{
  ...
  if (status->node_status == svn_wc_status_obstructed)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c",58), (svn_error_createf))(SVN_ERR_NODE_UNEXPECTED_KIND, ((void*)0),
                             dcgettext ("subversion", "'%s' is in the way of the resource " "actually under version control", 5),

                             svn_dirent_local_style(path, pool));
  else if (! status->versioned)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c",63), (svn_error_createf))(SVN_ERR_UNVERSIONED_RESOURCE, ((void*)0),
    ...
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c",73), (svn_error_createf))(SVN_ERR_CLIENT_MODIFIED, ((void*)0),
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  if (file_external)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c",103), (svn_error_createf))(SVN_ERR_WC_CANNOT_DELETE_FILE_EXTERNAL, ((void*)0),
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (kind == svn_node_none)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c",231), (svn_error_createf))(SVN_ERR_FS_NOT_FOUND, ((void*)0),
  ...
  for (i = 1; i < paths->nelts; i++)
    {
      ...
      if (is_url != svn_path_is_url(path))
        return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c",338), (svn_error_create))(SVN_ERR_ILLEGAL_TARGET, ((void*)0), dcgettext ("subversion", "Cannot mix repository and working copy " "targets", 5)));
