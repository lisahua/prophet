# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.c"
...
svn_io_file_readline(apr_file_t *file,
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.h"
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.h" 2
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.h"
svn_error_t *
svn_delta__get_debug_editor(const svn_delta_editor_t **editor,
                            ...
                            void *wrapped_baton,
                            apr_pool_t *pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/debug_editor.c" 2
...
write_indent(struct edit_baton *eb, apr_pool_t *pool)
{
  ...
  for (i = 0; i < eb->indent_level; ++i)
    do { svn_error_t *svn_err__temp = (svn_stream_puts(eb->out, " ")); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "set_target_revision : %ld\n", target_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          void **root_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "open_root : %ld\n", base_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);

  eb->indent_level++;

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->open_root(eb->wrapped_edit_baton, base_revision, pool, &dir_baton->wrapped_dir_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "delete_entry : %s:%ld\n", path, base_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              void **child_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "add_directory : '%s' [from '%s':%ld]\n", path, copyfrom_path, copyfrom_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);


  eb->indent_level++;

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->add_directory(path, pb->wrapped_dir_baton, copyfrom_path, copyfrom_revision, pool, &b->wrapped_dir_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               void **child_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "open_directory : '%s':%ld\n", path, base_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);

  eb->indent_level++;

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->open_directory(path, pb->wrapped_dir_baton, base_revision, pool, &db->wrapped_dir_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
         ...
         void **file_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "add_file : '%s' [from '%s':%ld]\n", path, copyfrom_path, copyfrom_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);



  eb->indent_level++;

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->add_file(path, pb->wrapped_dir_baton, copyfrom_path, copyfrom_revision, pool, &fb->wrapped_file_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          void **file_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "open_file : '%s':%ld\n", path, base_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);


  eb->indent_level++;

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->open_file(path, pb->wrapped_dir_baton, base_revision, pool, &fb->wrapped_file_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                void **handler_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "apply_textdelta : %s\n", base_checksum)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->apply_textdelta(fb->wrapped_file_baton, base_checksum, pool, handler, handler_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "close_file : %s\n", text_checksum)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->close_file(fb->wrapped_file_baton, text_checksum, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "absent_file : %s\n", path)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->absent_file(path, fb->wrapped_file_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  eb->indent_level--;
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "close_directory\n")); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->close_directory(db->wrapped_dir_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "absent_directory : %s\n", path)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->absent_directory(path, db->wrapped_dir_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "change_file_prop : %s\n", name)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->change_file_prop(fb->wrapped_file_baton, name, value, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "change_dir_prop : %s\n", name)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->change_dir_prop(db->wrapped_dir_baton, name, value, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (write_indent(eb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->out, pool, "close_edit\n")); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (eb->wrapped_editor->close_edit(eb->wrapped_edit_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  out = svn_stream_from_aprfile2(errfp, (!0), pool);
