  ...
  while (1729)
    {
      ...
      if (eof)
        {
          if (line->len > 0)
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",252), (svn_error_createf))
...
wipe_obsolete_files(const char *wcroot_abspath, apr_pool_t *scratch_pool)
{
  ...
  svn_error_clear(svn_io_remove_file2(
                     svn_wc__adm_child(wcroot_abspath,
                                      ...
                                      scratch_pool),
                     (!0), scratch_pool));
# 503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  svn_error_clear(svn_io_remove_file2(
...
# 566 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  if (entry->repos == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",602), (svn_error_createf))(
  ...
  if (entry->uuid == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",609), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
   ...
   if (entry->url == ((void*)0))
     return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",616), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 889 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
...
migrate_props(const char *dir_abspath,
              ...
              apr_pool_t *scratch_pool)
{
# 1056 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  const apr_array_header_t *children;
  apr_pool_t *iterpool = svn_pool_create_ex(scratch_pool, ((void*)0));
  const char *old_wcroot_abspath
    = svn_dirent_get_longest_ancestor(dir_abspath, new_wcroot_abspath,
  ...
  for (hi = apr_hash_first(scratch_pool, dirents); hi;
            hi = apr_hash_next(hi))
    {
      ...
      text_base_path = svn_dirent_join(text_base_dir, text_base_basename,
                                       iterpool);
# 1153 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1220 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1240 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (logfile_on_disk == svn_node_file)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1262), (svn_error_create))(SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 1289 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1337 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1352 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  if (old_format != 12)
    {
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  if (start_format < 12 )
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1401), (svn_error_createf))(SVN_ERR_WC_UPGRADE_REQUIRED, ((void*)0),
...
# 1429 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
        *result_format = 13;
      ...
      case 18:
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1490), (svn_error_createf))(SVN_ERR_UNSUPPORTED_FEATURE, ((void*)0),
               ...
               apr_pool_t *scratch_pool)
{
  ...
  if (!is_old_wcroot(local_abspath, scratch_pool))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1665), (svn_error_createf))(
      SVN_ERR_WC_INVALID_OP_ON_CWD, ((void*)0),
      dcgettext ("subversion", "Cannot upgrade '%s' as it is not a pre-1.7 working copy root", 5),
      svn_dirent_local_style(local_abspath, scratch_pool));
# 1679 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
