# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c" 2

# 1 "./subversion/include/svn_path.h" 1
# 52 "./subversion/include/svn_path.h"
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c" 2
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c" 2
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cl__try (svn_client_add4(target, opt_state->depth, opt_state->force, opt_state->no_ignore, opt_state->parents, ctx, iterpool), errors, opt_state->quiet, SVN_ERR_ENTRY_EXISTS, SVN_ERR_WC_PATH_NOT_FOUND, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 86 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/add-cmd.c"
    }
      ...
      for (i = 0; i < errors->nelts; i++)
        {
          ...
          if (status == SVN_ERR_WC_PATH_NOT_FOUND)
            err = svn_error_quick_wrap(err,
                                       dcgettext ("subversion", "Could not add all targets because " "some targets don't exist", 5));

          else if (status == SVN_ERR_ENTRY_EXISTS)
            err = svn_error_quick_wrap(err,
                                       dcgettext ("subversion", "Could not add all targets because " "some targets are already versioned", 5));
