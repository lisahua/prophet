...
# 73 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/winservice.h" 1
# 74 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c" 2
...
# 77 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c" 2
...
# 80 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c" 2
...
# 218 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 281 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 314 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
apr_array_header_t *connection_pools = ((void*)0);


svn_mutex__t *connection_pools_mutex = ((void*)0);
...
{
  apr_size_t i;
# 386 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 441 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
{
  do { svn_error_t *svn_err__temp = (svn_mutex__init(&connection_pools_mutex, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  do { svn_error_t *svn_err__temp = (svn_mutex__lock(connection_pools_mutex)); if (svn_err__temp) return (svn_err__temp); } while (0);
  *pool = connection_pools->nelts
        ? *(apr_pool_t **)apr_array_pop(connection_pools)
        : apr_allocator_owner_get(svn_pool_create_allocator(0));
  do { svn_error_t *svn_err__temp = (svn_mutex__unlock(connection_pools_mutex, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
release_connection_pool(apr_pool_t *pool)
{
  ...
  if (err)
    ...
    {
      (*((apr_pool_t * *)apr_array_push(connection_pools))) = pool;
      svn_error_clear(svn_mutex__unlock(connection_pools_mutex,
                                        0));
    }
}
# 531 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
             ...
             apr_pool_t *pool)
{
  ...
  svn_ra_svn_conn_t *conn;
  svn_error_t *err;
# 575 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 269:
          ...
          break;
# 915 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
        case 263:
...
# 1097 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 1191 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
  {
    ...
    if (handling_mode == connection_mode_thread)
      {
        ...
        settings.single_threaded = 0;
# 1210 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
      }
  ...
  while (1)
    {
# 1253 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
      ...
      switch (handling_mode)
        ...
        case connection_mode_thread:
          ...
          status = apr_thread_pool_push(threads, serve_thread, thread_data,
                                        0, ((void*)0));
# 1353 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
          if (status)
            {
