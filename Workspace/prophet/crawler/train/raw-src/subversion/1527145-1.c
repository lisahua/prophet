...
# 132 "./subversion/include/svn_types.h"
...
# 213 "./subversion/include/svn_types.h"
const void *
...
# 285 "./subversion/include/svn_types.h"
const char *
...
# 306 "./subversion/include/svn_types.h"
...
# 375 "./subversion/include/svn_types.h"
...
svn_revnum_parse(svn_revnum_t *rev,
                 const char *str,
                 const char **endptr);
# 422 "./subversion/include/svn_types.h"
typedef apr_int64_t svn_filesize_t;
# 440 "./subversion/include/svn_types.h"
enum svn_recurse_kind
{
  svn_nonrecursive = 1,
  svn_recursive
};
# 453 "./subversion/include/svn_types.h"
typedef enum svn_depth_t
{
  ...
  svn_depth_unknown = -2,
# 473 "./subversion/include/svn_types.h"
  svn_depth_exclude = -1,
...
# 599 "./subversion/include/svn_types.h"
...
# 725 "./subversion/include/svn_types.h"
...
# 922 "./subversion/include/svn_types.h"
  apr_hash_t *changed_paths2;
# 934 "./subversion/include/svn_types.h"
...
# 1055 "./subversion/include/svn_types.h"
...
# 1183 "./subversion/include/svn_types.h"
svn_lock_t *
...
# 1201 "./subversion/include/svn_types.h"
const char *
...
svn_location_segment_dup(const svn_location_segment_t *segment,
                         apr_pool_t *pool);
# 1299 "./subversion/include/svn_types.h"
typedef unsigned long svn_linenum_t;
# 1325 "./subversion/include/svn_types.h"
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 1326 "./subversion/include/svn_types.h" 2
...
__attribute__((warning("experimental function used")))
svn_error_t *
...
svn_fs_file_length(svn_filesize_t *length_p,
                   ...
                   const char *path,
                   apr_pool_t *pool);
# 2021 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_file_md5_checksum(unsigned char digest[],
                         ...
                         const char *path,
                         apr_pool_t *pool);
# 2059 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_change_rev_prop2(svn_fs_t *fs,
                        ...
                        const svn_string_t *value,
                        apr_pool_t *pool);
# 2333 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_lock(svn_lock_t **lock,
            ...
            apr_pool_t *pool);
# 2479 "./subversion/include/svn_fs.h"
svn_error_t *
...
typedef svn_error_t *(*svn_fs_get_locks_callback_t)(void *baton,
                                                    svn_lock_t *lock,
                                                    apr_pool_t *pool);
# 2551 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_get_locks2(svn_fs_t *fs,
                  ...
                  apr_pool_t *pool);
# 2573 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
svn_fs_get_locks(svn_fs_t *fs,
                 ...
                 void *get_locks_baton,
                 apr_pool_t *pool);
# 2590 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 2681 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_verify_root(svn_fs_root_t *root,
                   apr_pool_t *scratch_pool);
# 2737 "./subversion/include/svn_fs.h"
...
# 2765 "./subversion/include/svn_fs.h"
...
# 2801 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_info(const svn_fs_info_placeholder_t **fs_info,
            svn_fs_t *fs,
            apr_pool_t *result_pool,
            apr_pool_t *scratch_pool);
# 2817 "./subversion/include/svn_fs.h"
void *
...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
svn__decompress(svn_stringbuf_t *in,
                svn_stringbuf_t *out,
                apr_size_t limit);
# 443 "./subversion/include/private/svn_subr_private.h"
...
apr_status_t apr_thread_pool_task_owner_get(apr_thread_t *thd,
                                                         void **owner);
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
# 74 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/winservice.h" 1
# 75 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
# 78 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
# 81 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
# 219 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
# 282 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
# 315 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
{
  apr_size_t i;
# 379 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
# 456 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
                   ...
                   svn_root_pools__t *root_pools)
{
  ...
  apr_atomic_set32((&shared->count), (2));
...
{
  if (apr_atomic_dec32(&shared->count) == 0)
             ...
             apr_pool_t *pool)
{
  ...
  svn_ra_svn_conn_t *conn;
  svn_error_t *err;
# 503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
  status = apr_socket_opt_set(usock, 2, 1);
  if (status)
    {
  ...
  conn = svn_ra_svn_create_conn3(usock, ((void*)0), ((void*)0),
  ...
  if (err)
    log_error(err, params->log_file, params->log_file_mutex,
              svn_ra_svn_conn_remote_host(conn), ((void*)0), ((void*)0), pool);
...
int main(int argc, const char *argv[])
{
  ...
  params.log_file = ((void*)0);
  params.log_file_mutex = ((void*)0);
  params.vhost = 0;
  params.username_case = CASE_ASIS;
  params.memory_cache_size = (apr_uint64_t)-1;
  params.cache_fulltexts = (!0);
  params.cache_txdeltas = (!0);
  params.cache_revprops = 0;
  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 'r':
          do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8(&params.root, arg, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
          ...
          if (kind != svn_node_dir)
            {
              svn_error_clear
                (svn_cmdline_fprintf
                   (stderr, pool,
                    dcgettext ("subversion", "svnserve: Root path '%s' does not exist " "or is not a directory.\n", 5), params.root));

              return 1;
            }

          params.root = svn_dirent_internal_style(params.root, pool);
          do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&params.root, params.root, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
          break;
        ...
        case 269:
          ...
          break;
# 851 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
        case 263:
          do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8(&config_filename, arg, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
          config_filename = svn_dirent_internal_style(config_filename, pool);
          do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&config_filename, config_filename, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);

          break;

        case 261:
          do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8(&pid_filename, arg, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
          pid_filename = svn_dirent_internal_style(pid_filename, pool);
          do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&pid_filename, pid_filename, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
         ...
         case 264:
          do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8(&log_filename, arg, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
          log_filename = svn_dirent_internal_style(log_filename, pool);
          do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&log_filename, log_filename, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  ...
  if (is_version)
    {
      do { svn_error_t *svn_err__temp = (version(quiet, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
      exit(0);
    }
  ...
  if (config_filename)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_config_read3(&params.cfg, config_filename, (!0), 0, 0, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  ...
  if (log_filename)
    {
      do { svn_error_t *svn_err__temp = (svn_io_file_open(&params.log_file, log_filename, 0x00002 | 0x00004 | 0x00008, 0x0FFF, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);


      do { svn_error_t *svn_err__temp = (svn_mutex__init(&params.log_file_mutex, (!0), pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
    }
  ...
  if (params.tunnel_user && run_mode != run_mode_tunnel)
    {
      svn_error_clear
        (svn_cmdline_fprintf
           (stderr, pool,
            dcgettext ("subversion", "Option --tunnel-user is only valid in tunnel mode.\n", 5)));
      exit(1);
    }
  ...
  if (run_mode == run_mode_inetd || run_mode == run_mode_tunnel)
    {
      ...
      if (status)
        {
          err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't open stdin", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
      ...
      if (status)
        {
          err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't open stdout", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
...
# 1034 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
  ...
  if (status)
    {
      err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't get address info", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
  ...
  if (status)
    {
      err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't create server socket", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }



  apr_socket_opt_set(sock, 16, 1);

  status = apr_socket_bind(sock, sa);
  if (status)
    {
      err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't bind server socket", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }

  apr_socket_listen(sock, 128);
  ...
  if (pid_filename)
    do { svn_error_t *svn_err__temp = (write_pid_file(pid_filename, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
# 1128 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
  {
    ...
    if (handling_mode == connection_mode_thread)
      {
        ...
        settings.single_threaded = 0;
# 1147 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
      }
  ...
  if (handling_mode == connection_mode_thread)
    {
      ...
      if (status)
        {
          err = svn_error_wrap_apr (status, dcgettext ("subversion", "Can't create thread pool", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
  ...
  while (1)
    {
      ...
      static int run = 0;
# 1201 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
      ...
      if (status)
        {
          err = svn_error_wrap_apr
            (status, dcgettext ("subversion", "Can't accept client connection", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
      ...
      if (run_mode == run_mode_listen_once)
        {
          ...
          if (err)
            svn_handle_error2(err, stdout, 0, "svnserve: ");
          svn_error_clear(err);
      ...
      switch (handling_mode)
        ...
        case connection_mode_thread:
          ...
          status = apr_thread_pool_push(threads, serve_thread, thread_data,
                                        0, ((void*)0));
# 1301 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
          if (status)
            {
              err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't push task", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
