# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/home/ubuntu/Workspace/utils/llvm-build/bin/../lib/clang/3.5.0/include/stddef.h" 1 3 4
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.h"
...
svn_fs_upgrade2(const char *path,
                ...
                void *cancel_baton,
                apr_pool_t *pool);
# 382 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_type(const char **fs_type,
            const char *path,
            apr_pool_t *pool);
# 427 "./subversion/include/svn_fs.h"
const char *
...
svn_fs_hotcopy3(const char *src_path,
                ...
                void *cancel_baton,
                apr_pool_t *scratch_pool);
# 508 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_freeze(svn_fs_t *fs,
              ...
              void *freeze_baton,
              apr_pool_t *pool);
# 639 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_berkeley_logfiles(apr_array_header_t **logfiles,
                         ...
                         apr_pool_t *pool);
# 678 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_fs_t *
...
svn_fs_berkeley_recover(const char *path,
                        apr_pool_t *pool);
# 743 "./subversion/include/svn_fs.h"
typedef struct svn_fs_access_t svn_fs_access_t;
# 752 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_access_get_username(const char **username,
                           svn_fs_access_t *access_ctx);
# 794 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_unparse_id(const svn_fs_id_t *id,
                  apr_pool_t *pool);
# 1032 "./subversion/include/svn_fs.h"
typedef struct svn_fs_txn_t svn_fs_txn_t;
# 1080 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_change_txn_props(svn_fs_txn_t *txn,
                        ...
                        apr_pool_t *pool);
# 1301 "./subversion/include/svn_fs.h"
...
# 1402 "./subversion/include/svn_fs.h"
...
# 1466 "./subversion/include/svn_fs.h"
...
svn_fs_node_relation(svn_fs_node_relation_t *relation,
                     ...
                     const char *path_b,
                     apr_pool_t *pool);
# 1700 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_change_node_prop(svn_fs_root_t *root,
                        ...
                        const svn_string_t *value,
                        apr_pool_t *pool);
# 1785 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 2022 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_delete(svn_fs_root_t *root,
              const char *path,
              apr_pool_t *pool);
# 2093 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_contents_different(svn_boolean_t *different_p,
                          ...
                          const char *path2,
                          apr_pool_t *pool);
# 2363 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_contents_changed(svn_boolean_t *changed_p,
                        ...
                        const char *path2,
                        apr_pool_t *pool);
# 2381 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_youngest_rev(svn_revnum_t *youngest_p,
                    svn_fs_t *fs,
                    apr_pool_t *pool);
# 2401 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_revision_proplist(apr_hash_t **table_p,
                         ...
                         svn_revnum_t rev,
                         apr_pool_t *pool);
# 2481 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_change_rev_prop(svn_fs_t *fs,
                       ...
                       const svn_string_t *value,
                       apr_pool_t *pool);
# 2518 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_set_uuid(svn_fs_t *fs,
                const char *uuid,
                apr_pool_t *pool);
# 2582 "./subversion/include/svn_fs.h"
...
svn_fs_lock_target_t *svn_fs_lock_target_create(const char *token,
                                                ...
                                                apr_pool_t *pool);
# 2603 "./subversion/include/svn_fs.h"
void svn_fs_lock_target_set_token(svn_fs_lock_target_t *target,
                                  const char *token);
# 2618 "./subversion/include/svn_fs.h"
...
typedef svn_error_t *(*svn_fs_get_locks_callback_t)(void *baton,
                                                    svn_lock_t *lock,
                                                    apr_pool_t *pool);
# 2810 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_get_locks2(svn_fs_t *fs,
                  ...
                  apr_pool_t *pool);
# 2832 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
svn_fs_get_locks(svn_fs_t *fs,
                 ...
                 void *get_locks_baton,
                 apr_pool_t *pool);
# 2849 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 2940 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_verify(const char *path,
              ...
              void *cancel_baton,
              apr_pool_t *scratch_pool);
# 2975 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 3024 "./subversion/include/svn_fs.h"
...
svn_fs_info(const svn_fs_info_placeholder_t **fs_info,
            ...
            apr_pool_t *result_pool,
            apr_pool_t *scratch_pool);
# 3076 "./subversion/include/svn_fs.h"
void *
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.h" 2
...
svn_fs_x__id_deserialize(void *buffer,
                         svn_fs_id_t **id,
                         apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.h"
...
# 134 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/fs.h"
...
# 176 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/fs.h"
...
{
# 455 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/fs.h"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.h" 2
...
svn_fs_x__l2p_proto_index_add_revision(apr_file_t *proto_index,
                                       apr_pool_t *pool);
# 114 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.h"
svn_error_t *
...
svn_fs_x__p2l_index_create(svn_fs_t *fs,
                           ...
                           svn_revnum_t revision,
                           apr_pool_t *pool);
# 182 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.h"
svn_error_t *
...
svn_fs_x__deserialize_p2l_page(void **out,
                               ...
                               apr_size_t data_len,
                               apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
...
svn_fs_x__write_current(svn_fs_t *fs,
                        svn_revnum_t rev,
                        apr_pool_t *pool);
# 295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/util.h"
svn_error_t *
...
svn_fs_x__read_number_from_stream(apr_int64_t *result,
                                  ...
                                  svn_stream_t *stream,
                                  apr_pool_t *scratch_pool);
# 334 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/util.h"
svn_error_t *
svn_fs_x__move_into_place(const char *old_filename,
                          const char *new_filename,
                          const char *perms_reference,
                          apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c" 2
...
{
  return change_set < ((svn_fs_x__change_set_t)(-1));
}
...
svn_fs_x__get_txn_id(svn_fs_x__change_set_t change_set)
{
  return svn_fs_x__is_txn(change_set)
       ? -change_set + ((svn_fs_x__change_set_t)(-1)) -1
       : ((svn_fs_x__txn_id_t)(-1));
}
...
{
  ((revnum >= ((svn_fs_x__change_set_t)(-1))) ? (void) (0) : __assert_fail ("revnum >= ((svn_fs_x__change_set_t)(-1))", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c", 83, __PRETTY_FUNCTION__));
  return revnum;
}
...
{
  ((txn_id >= ((svn_fs_x__change_set_t)(-1))) ? (void) (0) : __assert_fail ("txn_id >= ((svn_fs_x__change_set_t)(-1))", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c", 90, __PRETTY_FUNCTION__));
  return -txn_id + ((svn_fs_x__change_set_t)(-1)) -1;
}
...
svn_fs_x__id_txn_create_root(svn_fs_x__txn_id_t txn_id,
                             apr_pool_t *pool)
{
  fs_x__id_t *id = memset(apr_palloc(pool, sizeof(*id)), 0, sizeof(*id));



  id->noderev_id.change_set = svn_fs_x__change_set_by_txn(txn_id);
  id->noderev_id.number = 2;
                   ...
                   apr_pool_t *pool)
{
  ...
  id->generic_id.fsap_data = id;
  id->pool = pool;
# 422 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/id.c"
