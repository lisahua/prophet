...
svn_cl__print_xml_commit(svn_stringbuf_t **outstr,
                         ...
                         const char *date,
                         apr_pool_t *pool);
# 457 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__edit_file_externally(const char *path,
                             ...
                             apr_hash_t *config,
                             apr_pool_t *pool);
# 530 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
svn_cl__merge_file_externally(const char *base_path,
                              ...
                              apr_pool_t *pool);
# 550 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
...
# 595 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__operation_str_human_readable(svn_wc_operation_t operation,
                                     apr_pool_t *pool);
# 685 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
void
...
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         ...
                         apr_pool_t *pool);
# 742 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
const char *
...
svn_cl__eat_peg_revisions(apr_array_header_t **true_targets_p,
                          const apr_array_header_t *targets,
                          apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c" 2
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (svn_path_is_url(target))
        return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/commit-cmd.c",70), (svn_error_createf))(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0), dcgettext ("subversion", "'%s' is a URL, but URLs cannot be " "commit targets", 5), target));
