# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c" 2
...
svn_io_write_version_file(const char *path,
                          int version,
                          apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c" 2
...
svn_base64_from_md5(unsigned char digest[],
                    apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c" 2
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c"
static const char base64tab[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ" "abcdefghijklmnopqrstuvwxyz0123456789+/";
...
# 93 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c"
static void
...
# 119 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c"
static void
...
encode_data(void *baton, const char *data, apr_size_t *len)
{
  ...
  encode_bytes(encoded, data, *len, eb->buf, &eb->buflen, &eb->linelen, (!0));
  enclen = encoded->len;
  if (enclen != 0)
    err = svn_stream_write(eb->output, encoded->data, &enclen);
  apr_pool_clear(eb->scratch_pool);
  return err;
}
...
finish_encoding_data(void *baton)
{
  ...
  encode_partial_group(encoded, eb->buf, eb->buflen, eb->linelen, (!0));
  enclen = encoded->len;
  if (enclen != 0)
    err = svn_stream_write(eb->output, encoded->data, &enclen);
  ...
  apr_pool_destroy(eb->scratch_pool);
  return err;
}
...
svn_base64_encode(svn_stream_t *output, apr_pool_t *pool)
{
  ...
  eb->buflen = 0;
  eb->linelen = 0;
  eb->scratch_pool = svn_pool_create_ex(pool, ((void*)0));
                          ...
                          apr_pool_t *pool)
{
  ...
  svn_string_t *retval = memset(apr_palloc(pool, sizeof(*retval)), 0, sizeof(*retval));
  unsigned char ingroup[3];
  size_t ingrouplen = 0;
  size_t linelen = 0;
...
{
  return svn_base64_encode_string2(str, (!0), pool);
}
...
# 369 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c"
...
# 403 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c"
static void
...
decode_data(void *baton, const char *data, apr_size_t *len)
{
  ...
  apr_pool_clear(db->scratch_pool);
  return err;
}
...
finish_decoding_data(void *baton)
{
  ...
  apr_pool_destroy(db->scratch_pool);
  return err;
}
...
svn_base64_decode(svn_stream_t *output, apr_pool_t *pool)
{
  ...
  db->buflen = 0;
  db->done = 0;
  db->scratch_pool = svn_pool_create_ex(pool, ((void*)0));
...
# 532 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_base64.c"
...
base64_from_checksum(const svn_checksum_t *checksum, apr_pool_t *pool)
{
  ...
  encode_bytes(checksum_str, checksum->digest,
               ...
               &linelen, (!0));
  encode_partial_group(checksum_str, ingroup, ingrouplen, linelen, (!0));
