...
# 530 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
static svn_error_t *
                   ...
                   apr_hash_t *config)
{
  ...
  if (! e)
    e = getenv("EDITOR");
# 1111 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cmdline.c"
  if (e)
    {
      const char *c;
                                    ...
                                    apr_pool_t *pool)
{
  ...
  err = svn_io_set_file_affected_time(finfo_before.mtime - 2000,
                                      tmpfile_name, pool);
  if (err)
    goto cleanup;
