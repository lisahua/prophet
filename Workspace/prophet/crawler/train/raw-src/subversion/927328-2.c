                      ...
                      svn_error_t *(*init_func)(apr_pool_t*), apr_pool_t* pool)
{
  ...
  if (status == 0)
      ...
      if (err)
        {
          ...
          return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/atomic.c",58), (svn_error_create))(SVN_ERR_ATOMIC_INIT_FAILURE, err,
    ...
    {
      if (status == 2)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/atomic.c",72), (svn_error_create))(SVN_ERR_ATOMIC_INIT_FAILURE, ((void*)0),
                                "Couldn't perform atomic initialization");
