# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.h" 1
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.h"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.h" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.h" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.h" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.h" 2
...
svn_cl__append_conflict_info_xml(
  ...
  const svn_wc_conflict_description2_t *conflict,
  apr_pool_t *pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
...
svn_token__from_mem(const svn_token_map_t *map,
                    const char *word,
                    apr_size_t len);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
...
svn_cl__deprecated_merge_reintegrate(const char *source_path_or_url,
                                     ...
                                     svn_client_ctx_t *ctx,
                                     apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c" 2
      ...
      case svn_node_file:
        switch (reason)
          ...
          case svn_wc_conflict_reason_edited:
            return dcgettext ("subversion", "local file edit", 5);
          case svn_wc_conflict_reason_obstructed:
            return dcgettext ("subversion", "local file obstruction", 5);
          case svn_wc_conflict_reason_deleted:
            return dcgettext ("subversion", "local file delete", 5);
          case svn_wc_conflict_reason_missing:
            if (operation == svn_wc_operation_merge)
              return dcgettext ("subversion", "local file missing or deleted or moved away", 5);
            else
              return dcgettext ("subversion", "local file missing", 5);
          case svn_wc_conflict_reason_unversioned:
            return dcgettext ("subversion", "local file unversioned", 5);
          case svn_wc_conflict_reason_added:
            return dcgettext ("subversion", "local file add", 5);
          case svn_wc_conflict_reason_replaced:
            return dcgettext ("subversion", "local file replace", 5);
          case svn_wc_conflict_reason_moved_away:
            return dcgettext ("subversion", "local file moved away", 5);
          case svn_wc_conflict_reason_moved_here:
            return dcgettext ("subversion", "local file moved here", 5);
          }
        break;
      case svn_node_dir:
        switch (reason)
          {
          case svn_wc_conflict_reason_edited:
            return dcgettext ("subversion", "local dir edit", 5);
          case svn_wc_conflict_reason_obstructed:
            return dcgettext ("subversion", "local dir obstruction", 5);
          case svn_wc_conflict_reason_deleted:
            return dcgettext ("subversion", "local dir delete", 5);
          case svn_wc_conflict_reason_missing:
            if (operation == svn_wc_operation_merge)
              return dcgettext ("subversion", "local dir missing or deleted or moved away", 5);
            else
              return dcgettext ("subversion", "local dir missing", 5);
          case svn_wc_conflict_reason_unversioned:
            return dcgettext ("subversion", "local dir unversioned", 5);
          case svn_wc_conflict_reason_added:
            return dcgettext ("subversion", "local dir add", 5);
          case svn_wc_conflict_reason_replaced:
            return dcgettext ("subversion", "local dir replace", 5);
          case svn_wc_conflict_reason_moved_away:
            return dcgettext ("subversion", "local dir moved away", 5);
          case svn_wc_conflict_reason_moved_here:
            return dcgettext ("subversion", "local dir moved here", 5);
          }
        break;
        ...
        switch (action)
          {
            case svn_wc_conflict_action_edit:
              return dcgettext ("subversion", "incoming file edit", 5);
            case svn_wc_conflict_action_add:
              return dcgettext ("subversion", "incoming file add", 5);
            case svn_wc_conflict_action_delete:
              return dcgettext ("subversion", "incoming file delete or move", 5);
            case svn_wc_conflict_action_replace:
              return dcgettext ("subversion", "incoming file replace", 5);
          }
        break;
      case svn_node_dir:
        switch (action)
          {
            case svn_wc_conflict_action_edit:
              return dcgettext ("subversion", "incoming dir edit", 5);
            case svn_wc_conflict_action_add:
              return dcgettext ("subversion", "incoming dir add", 5);
            case svn_wc_conflict_action_delete:
              return dcgettext ("subversion", "incoming dir delete or move", 5);
            case svn_wc_conflict_action_replace:
              return dcgettext ("subversion", "incoming dir replace", 5);
          }
        break;
      case svn_node_symlink:
      case svn_node_none:
...
operation_str(svn_wc_operation_t operation)
{
  switch (operation)
    {
    case svn_wc_operation_update: return dcgettext ("subversion", "upon update", 5);
    case svn_wc_operation_switch: return dcgettext ("subversion", "upon switch", 5);
    case svn_wc_operation_merge: return dcgettext ("subversion", "upon merge", 5);
    case svn_wc_operation_none: return dcgettext ("subversion", "upon none", 5);
    }
  do { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c", 190, ((void*)0)); abort(); } while (1);
  return ((void*)0);
}
  ...
  apr_pool_t *pool)
{
  ...
  switch (conflict->reason)
    {
      case svn_wc_conflict_reason_edited:
        reason_str = dcgettext ("subversion", "local edit", 5);
        break;
      case svn_wc_conflict_reason_added:
        reason_str = dcgettext ("subversion", "local add", 5);
        break;
      case svn_wc_conflict_reason_deleted:
        reason_str = dcgettext ("subversion", "local delete", 5);
        break;
      case svn_wc_conflict_reason_obstructed:
        reason_str = dcgettext ("subversion", "local obstruction", 5);
        break;
      default:
        reason_str = apr_psprintf(pool, dcgettext ("subversion", "local %s", 5),
  ...
  switch (conflict->action)
    {
      case svn_wc_conflict_action_edit:
        action_str = dcgettext ("subversion", "incoming edit", 5);
        break;
      case svn_wc_conflict_action_add:
        action_str = dcgettext ("subversion", "incoming add", 5);
        break;
      case svn_wc_conflict_action_delete:
        action_str = dcgettext ("subversion", "incoming delete", 5);
        break;
      default:
        action_str = apr_psprintf(pool, dcgettext ("subversion", "incoming %s", 5),
                                  svn_token__to_word(map_conflict_action_xml,
                                                     conflict->action));
        break;
    }
  do { if (!(reason_str && action_str)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c", 241, "reason_str && action_str")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  *desc = apr_psprintf(pool, dcgettext ("subversion", "%s, %s %s", 5),
  ...
  apr_pool_t *pool)
{
  ...
  do { if (!(operation)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c", 281, "operation")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (action && reason)
  ...
  else
    {
      ...
      *desc = apr_psprintf(pool, dcgettext ("subversion", "local: %s %s incoming: %s %s %s", 5),
                         ...
                         apr_pool_t *pool)
{
  ...
  if (version->repos_url)
    apr_hash_set(att_hash, "repos-url", (-1), version->repos_url);

  if (version->path_in_repos)
    apr_hash_set(att_hash, "path-in-repos", (-1), version->path_in_repos);

  if (((version->peg_rev) >= 0))
    apr_hash_set(att_hash, "revision", (-1), apr_ltoa(pool, version->peg_rev));

  if (version->node_kind != svn_node_unknown)
    apr_hash_set(att_hash, "kind", (-1), svn_cl__node_kind_str_xml(version->node_kind));
                              ...
                              apr_pool_t *pool)
{
  ...
  apr_hash_set(att_hash, "victim", (-1), svn_dirent_basename(conflict->local_abspath, pool));


  apr_hash_set(att_hash, "kind", (-1), svn_cl__node_kind_str_xml(conflict->node_kind));


  apr_hash_set(att_hash, "operation", (-1), svn_cl__operation_str_xml(conflict->operation, pool));
                                 ...
                                 apr_pool_t *scratch_pool)
{
  ...
  if (conflict->kind == svn_wc_conflict_kind_tree)
    {
      ...
      return (append_tree_conflict_info_xml(str, conflict, scratch_pool));

    }

  att_hash = apr_hash_make(scratch_pool);

  apr_hash_set(att_hash, "operation", (-1), svn_cl__operation_str_xml(conflict->operation, scratch_pool));



  kind = svn_token__to_word(map_conflict_kind_xml, conflict->kind);
  apr_hash_set(att_hash, "type", (-1), kind);
  ...
  if (conflict->src_left_version)
    do { svn_error_t *svn_err__temp = (add_conflict_version_xml(&str, "source-left", conflict->src_left_version, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  if (conflict->src_right_version)
    do { svn_error_t *svn_err__temp = (add_conflict_version_xml(&str, "source-right", conflict->src_right_version, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  switch (conflict->kind)
    {
      ...
      case svn_wc_conflict_kind_tree:
        do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl-conflicts.c", 454, ((void*)0))); } while (0);
        break;
    }
