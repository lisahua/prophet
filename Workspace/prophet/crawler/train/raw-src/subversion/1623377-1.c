...
# 1073 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
...
# 1147 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  *end = 0;
  ...
  ((revision <= (4294967295U)) ? (void) (0) : __assert_fail ("revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1177, __PRETTY_FUNCTION__));
                 ...
                 apr_pool_t *pool)
{
  ...
  ((revision <= (4294967295U)) ? (void) (0) : __assert_fail ("revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1316, __PRETTY_FUNCTION__));
  key.revision = (apr_uint32_t)revision;
  ...
  while (!eof)
    {
      ...
      do { if (!(eof || read == sizeof(entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1420, "eof || read == sizeof(entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                     ...
                                     apr_pool_t *pool)
{
  ...
  do { if (!(written == sizeof(*entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1596, "written == sizeof(*entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  while (!eof)
    {
      ...
      do { if (!(eof || read == sizeof(entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1686, "eof || read == sizeof(entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 2096 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
...
# 2162 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  *end = 0;
  ...
  ((baton->first_revision <= (4294967295U)) ? (void) (0) : __assert_fail ("baton->first_revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2188, __PRETTY_FUNCTION__));
...
# 2217 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
             ...
             apr_pool_t *pool)
{
  ...
  if (key_p)
    {
      svn_fs_fs__page_cache_key_t key = { 0 };
      ((page_info.first_revision <= (4294967295U)) ? (void) (0) : __assert_fail ("page_info.first_revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2258, __PRETTY_FUNCTION__));
                 ...
                 apr_pool_t *pool)
{
  ...
  do { if (!(block_start < block_end)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2375, "block_start < block_end")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(entries->nelts > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2458, "entries->nelts > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  while (block_start < block_end)
    {
      ...
      do { if (!(result->nelts > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2518, "result->nelts > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      if (last_count > 0 && last_count < result->nelts)
        {
           ...
           do { if (!((((svn_fs_fs__p2l_entry_t *)(result)->elts)[last_count]).offset >= entry->offset + entry->size)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2532, "APR_ARRAY_IDX(result, last_count, svn_fs_fs__p2l_entry_t).offset >= entry->offset + entry->size")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
