...
fs_serialized_init(svn_fs_t *fs, apr_pool_t *common_pool, apr_pool_t *pool)
{
  ...
  apr_status_t status;
# 83 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
  do { if (!(fs->uuid)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c", 83, "fs->uuid")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
fs_open_for_recovery(svn_fs_t *fs,
                     ...
                     apr_pool_t *common_pool)
{
# 308 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
...
# 377 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
