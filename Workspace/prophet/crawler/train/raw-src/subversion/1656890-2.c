# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c" 2
...
svn_client_copy5(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4548 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_propget5(apr_hash_t **props,
                    ...
                    apr_pool_t *result_pool,
                    apr_pool_t *scratch_pool);
# 5161 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_export2(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 5550 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_list3(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 5683 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c" 2
...
svn_client__mtcc_commit(apr_hash_t *revprop_table,
                        ...
                        svn_client__mtcc_t *mtcc,
                        apr_pool_t *scratch_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c" 2
...
# 119 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/../svn_test.h"
...
# 187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/../svn_test.h"
int svn_test_main(int argc, const char *argv[], int max_threads,
                  struct svn_test_descriptor_t *test_funcs);
# 239 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/../svn_test.h"
...
svn_test__init_auth_baton(svn_auth_baton_t **baton,
                          apr_pool_t *result_pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/../svn_test_fs.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/../svn_test_fs.h"
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/../svn_test_fs.h" 2
...
svn_repos_check_revision_access(svn_repos_revision_access_level_t *access_level,
                                ...
                                void *authz_read_baton,
                                apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/../svn_test_fs.h" 2
...
svn_test__get_file_contents(svn_fs_root_t *root,
                            ...
                            svn_stringbuf_t **str,
                            apr_pool_t *pool);
# 131 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/../svn_test_fs.h"
svn_error_t *
...
svn_test__create_blame_repository(svn_repos_t **out_repos,
                                  ...
                                  const svn_test_opts_t *opts,
                                  apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c" 2
                   ...
                   apr_pool_t *pool)
{
  ...
  vcb.commit_info = ((void*)0);
  vcb.result_pool = pool;

  do { svn_error_t *svn_err__temp = (svn_client__mtcc_commit(((void*)0), verify_commit_callback, &vcb, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { if (!(vcb.commit_info != ((void*)0))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "vcb.commit_info != NULL", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c", 70); } while (0);
  do { if (!(vcb.commit_info->revision == expected_rev)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "vcb.commit_info->revision == expected_rev", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c", 71); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__init_auth_baton(&ctx->auth_baton, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, repos_url, 0, ctx, subpool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  for (i = 0; svn_test__greek_tree_nodes[i].path; i++)
    {
      if (svn_test__greek_tree_nodes[i].contents)
        {
          do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_add_file( svn_test__greek_tree_nodes[i].path, cstr_stream( svn_test__greek_tree_nodes[i].contents, subpool), ((void*)0) , mtcc, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir( svn_test__greek_tree_nodes[i].path, mtcc, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


        }
    }

  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 1, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__create_repos2(((void*)0), &repos_url, ((void*)0), "mtcc-mkdir", opts, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client_create_context2(&ctx, ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_test__init_auth_baton(&ctx->auth_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, repos_url, 0, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("branches", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("trunk", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("branches/1.x", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("tags", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("tags/1.0", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("tags/1.1", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 1, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__create_repos2(((void*)0), &repos_url, ((void*)0), "mtcc-mkgreek", opts, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (make_greek_tree(repos_url, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client_create_context2(&ctx, ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_test__init_auth_baton(&ctx->auth_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, repos_url, 1, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_copy("A", 1, "greek_A", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 2, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__create_repos2(((void*)0), &repos_url, ((void*)0), "mtcc-swap", opts, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_move("A/B", "B", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_move("A/D", "A/B", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_copy("A/B", 1, "A/D", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__create_repos2(((void*)0), &repos_url, ((void*)0), "mtcc-propset", opts, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("iota", "key", svn_string_create("val", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("A", "A-key", svn_string_create("val-A", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("A/B", "B-key", svn_string_create("val-B", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("A/D", "D-key", ((void*)0), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 2, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, repos_url, 2, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *err__ = (svn_client__mtcc_add_propset("A", "svn:" "mime-type", svn_string_create("text/plain", pool), 0, mtcc, pool)); do { if (!((SVN_ERR_ILLEGAL_TARGET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c", 240, "( SVN_ERR_ILLEGAL_TARGET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0); if (err__ == 0 || err__->apr_err != (SVN_ERR_ILLEGAL_TARGET)) return err__ ? svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_ILLEGAL_TARGET), svn_error_symbolic_name( err__->apr_err)) : svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_ILLEGAL_TARGET), "SVN_NO_ERROR"); svn_error_clear(err__); } while (0);





  do { svn_error_t *err__ = (svn_client__mtcc_add_propset("iota", "svn:" "ignore", svn_string_create("iota", pool), 0, mtcc, pool)); do { if (!((SVN_ERR_ILLEGAL_TARGET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c", 246, "( SVN_ERR_ILLEGAL_TARGET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0); if (err__ == 0 || err__->apr_err != (SVN_ERR_ILLEGAL_TARGET)) return err__ ? svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_ILLEGAL_TARGET), svn_error_symbolic_name( err__->apr_err)) : svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_ILLEGAL_TARGET), "SVN_NO_ERROR"); svn_error_clear(err__); } while (0);





  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("iota", "svn:" "eol-style", svn_string_create("LF", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_add_file("ok", cstr_stream("line\nline\n", pool), ((void*)0), mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_add_file("bad", cstr_stream("line\nno\r\n", pool), ((void*)0), mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("ok", "svn:" "eol-style", svn_string_create("LF", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *err__ = (svn_client__mtcc_add_propset("bad", "svn:" "eol-style", svn_string_create("LF", pool), 0, mtcc, pool)); do { if (!((SVN_ERR_ILLEGAL_TARGET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c", 265, "( SVN_ERR_ILLEGAL_TARGET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0); if (err__ == 0 || err__->apr_err != (SVN_ERR_ILLEGAL_TARGET)) return err__ ? svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_ILLEGAL_TARGET), svn_error_symbolic_name( err__->apr_err)) : svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_ILLEGAL_TARGET), "SVN_NO_ERROR"); svn_error_clear(err__); } while (0);





  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 3, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__create_repos2(((void*)0), &repos_url, ((void*)0), "mtcc-update-files", opts, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_update_file(svn_test__greek_tree_nodes[0].path, cstr_stream("new-iota", pool), ((void*)0), cstr_stream( svn_test__greek_tree_nodes[0] .contents, pool), ((void*)0), mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 300 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c"
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_update_file("A/mu", cstr_stream("new-MU", pool), ((void*)0), ((void*)0), ((void*)0), mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("A/mu", "mu-key", svn_string_create("mu-A", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__create_repos2(((void*)0), &repos_url, ((void*)0), "mtcc-overwrite", opts, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_copy("A", 1, "AA", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *err__ = (svn_client__mtcc_add_mkdir("AA/B", mtcc, pool)); do { if (!((SVN_ERR_FS_ALREADY_EXISTS))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c", 340, "( SVN_ERR_FS_ALREADY_EXISTS)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0); if (err__ == 0 || err__->apr_err != (SVN_ERR_FS_ALREADY_EXISTS)) return err__ ? svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_FS_ALREADY_EXISTS), svn_error_symbolic_name( err__->apr_err)) : svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_FS_ALREADY_EXISTS), "SVN_NO_ERROR"); svn_error_clear(err__); } while (0);


  do { svn_error_t *err__ = (svn_client__mtcc_add_mkdir("AA/D/H/chi", mtcc, pool)); do { if (!((SVN_ERR_FS_ALREADY_EXISTS))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_client/mtcc-test.c", 343, "( SVN_ERR_FS_ALREADY_EXISTS)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0); if (err__ == 0 || err__->apr_err != (SVN_ERR_FS_ALREADY_EXISTS)) return err__ ? svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_FS_ALREADY_EXISTS), svn_error_symbolic_name( err__->apr_err)) : svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_FS_ALREADY_EXISTS), "SVN_NO_ERROR"); svn_error_clear(err__); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("AA/BB", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__create_repos2(((void*)0), &repos_url, ((void*)0), "mtcc-anchoring", opts, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, svn_path_url_add_component2(repos_url, "iota", pool), 1, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_update_file("", cstr_stream("new-iota", pool), ((void*)0), ((void*)0), ((void*)0), mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("", "key", svn_string_create("value", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, svn_path_url_add_component2(repos_url, "BB", pool), 2, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 3, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, svn_path_url_add_component2(repos_url, "new", pool), 3, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_add_file("", cstr_stream("new", pool), ((void*)0), mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 4, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, svn_path_url_add_component2(repos_url, "new", pool), 4, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_delete("", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 5, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, svn_path_url_add_component2(repos_url, "A/mu", pool), 5, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("", "key", svn_string_create("val", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 6, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, svn_path_url_add_component2(repos_url, "A", pool), 6, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 7, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_client__mtcc_create(&mtcc, repos_url, 7, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_propset("", "key", svn_string_create("val", pool), 0, mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (verify_mtcc_commit(mtcc, 8, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_test__create_repos2(((void*)0), &repos_url, ((void*)0), "mtcc-replace_tree", opts, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_delete("A", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_delete("iota", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("A", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("A/B", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("A/B/C", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("M", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("M/N", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__mtcc_add_mkdir("M/N/O", mtcc, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
static struct svn_test_descriptor_t test_funcs[] =
  {
    {0},
    {svn_test_pass, ((void*)0), test_mkdir, "test mtcc mkdir"},

    {svn_test_pass, ((void*)0), test_mkgreek, "test making greek tree"},

    {svn_test_pass, ((void*)0), test_swap, "swapping some trees"},

    {svn_test_pass, ((void*)0), test_propset, "test propset and propdel"},

    {svn_test_pass, ((void*)0), test_update_files, "test update files"},

    {svn_test_pass, ((void*)0), test_overwrite, "test overwrite"},

    {svn_test_pass, ((void*)0), test_anchoring, "test mtcc anchoring for root operations"},

    {svn_test_pass, ((void*)0), test_replace_tree, "test mtcc replace tree"},
