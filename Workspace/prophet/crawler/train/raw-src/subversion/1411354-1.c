# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c"
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
svn_wc_get_actual_target(const char *path,
                         ...
                         const char **target,
                         apr_pool_t *pool);
# 5506 "./subversion/include/svn_wc.h"
typedef svn_error_t *(*svn_wc_get_file_t)(void *baton,
                                          ...
                                          apr_hash_t **props,
                                          apr_pool_t *pool);
# 5528 "./subversion/include/svn_wc.h"
...
typedef svn_error_t *(*svn_wc_canonicalize_svn_prop_get_file_t)(
  ...
  void *baton,
  apr_pool_t *pool);
# 6163 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_revision_status(svn_wc_revision_status_t **result_p,
                       ...
                       void *cancel_baton,
                       apr_pool_t *pool);
# 7814 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_crop_tree2(svn_wc_context_t *wc_ctx,
                  ...
                  void *notify_baton,
                  apr_pool_t *scratch_pool);
# 7925 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2

# 1 "./subversion/include/svn_error_codes.h" 1
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
svn_cl__check_related_source_and_target(const char *path_or_url1,
                                        ...
                                        svn_client_ctx_t *ctx,
                                        apr_pool_t *pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c" 2
             ...
             apr_size_t len)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_write(out, data, &write_len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (write_len != len)
    return svn_error_create(SVN_ERR_STREAM_UNEXPECTED_EOF, ((void*)0),
                            dcgettext ("subversion", "Error writing to stream", 5));
  return 0;
}
                     ...
                     apr_pool_t *pool)
{
      ...
      for (i = 0; i < inherited_props->nelts; i++)
        {
          ...
          svn_xml_make_open_tag(&sb, iterpool, svn_xml_normal, "target",
                            "path", name_local, ((void*)0));

          svn_cmdline__print_xml_prop(&sb, pname, propval, (!0), iterpool);
  ...
  if (iterpool == ((void*)0))
    iterpool = svn_pool_create_ex(iterpool, ((void*)0));
...
# 148 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c"
static svn_error_t *
  ...
  if (print_filenames)
    {
      ...
      if (inherited_property)
        header = apr_psprintf(scratch_pool, like_proplist
                              ? dcgettext ("subversion", "Properties inherited from '%s':\n", 5)
                              : "%s - ", abspath_or_URL);
      else
        header = apr_psprintf(scratch_pool, like_proplist
                              ? dcgettext ("subversion", "Properties on '%s':\n", 5)
                              : "%s - ", abspath_or_URL);
      do { svn_error_t *svn_err__temp = (svn_cmdline_cstring_from_utf8(&header, header, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_subst_translate_cstring2(header, &header, "\n", 0, ((void*)0), 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





      do { svn_error_t *svn_err__temp = (stream_write(out, header, strlen(header))); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  ...
  if (like_proplist)
    {
      ...
      apr_hash_set(hash, pname_utf8, (-1), propval);
      do { svn_error_t *svn_err__temp = (svn_cl__print_prop_hash(out, hash, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
    {
      ...
      if (svn_prop_needs_translation(pname_utf8))
        do { svn_error_t *svn_err__temp = (svn_subst_detranslate_string(&propval, propval, (!0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (stream_write(out, propval->data, propval->len)); if (svn_err__temp) return (svn_err__temp); } while (0);

      if (! omit_newline)
        do { svn_error_t *svn_err__temp = (stream_write(out, "\n", strlen("\n"))); if (svn_err__temp) return (svn_err__temp); } while (0);

    }
  return 0;
}
# 235 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c"
static svn_error_t *
      ...
      for (i = 0; i < inherited_props->nelts; i++)
        {
          ...
          svn_string_t *propval = svn__apr_hash_index_val(apr_hash_first(pool,
                                                          iprop->prop_hash));
          do { svn_error_t *svn_err__temp = (print_single_prop(propval, iprop->path_or_url, path_prefix, out, pname_utf8, print_filenames, omit_newline, like_proplist, (!0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < sorted_props->nelts; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (print_single_prop(propval, filename, path_prefix, out, pname_utf8, print_filenames, omit_newline, like_proplist, 0, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  if (opt_state->verbose && (opt_state->revprop || opt_state->strict
                             || opt_state->xml))
    return svn_error_create(SVN_ERR_CL_MUTUALLY_EXCLUSIVE_ARGS, ((void*)0),
                            dcgettext ("subversion", "--verbose cannot be used with --revprop or " "--strict or --xml", 5));




  do { svn_error_t *svn_err__temp = (svn_opt_parse_num_args(&args, os, 1, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  pname = (((const char * *)(args)->elts)[0]);
  do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8(&pname_utf8, pname, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (opt_state->revprop)
    {
      ...
      if (opt_state->show_inherited_props)
        return svn_error_create(
          ...
          dcgettext ("subversion", "--show-inherited-props can't be used with --revprop", 5));

      do { svn_error_t *svn_err__temp = (svn_cl__revprop_prepare(&opt_state->start_revision, targets, &URL, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



      do { svn_error_t *svn_err__temp = (svn_client_revprop_get(pname_utf8, &propval, URL, &(opt_state->start_revision), &rev, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (opt_state->xml)
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_cl__xml_print_header("properties", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

              svn_xml_make_open_tag(&sb, pool, svn_xml_normal,
                                    "revprops",
                                    "rev", revstr, ((void*)0));

              svn_cmdline__print_xml_prop(&sb, pname_utf8, propval, 0,
                                          pool);

              svn_xml_make_close_tag(&sb, pool, "revprops");

              do { svn_error_t *svn_err__temp = (svn_cl__error_checked_fputs(sb->data, stdout)); if (svn_err__temp) return (svn_err__temp); } while (0);
              do { svn_error_t *svn_err__temp = (svn_cl__xml_print_footer("properties", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
          else
            {
              ...
              if (svn_prop_needs_translation(pname_utf8))
                do { svn_error_t *svn_err__temp = (svn_subst_detranslate_string(&printable_val, propval, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


              do { svn_error_t *svn_err__temp = (stream_write(out, printable_val->data, printable_val->len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else
    {
      ...
      if (opt_state->xml)
        do { svn_error_t *svn_err__temp = (svn_cl__xml_print_header("properties", subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (opt_state->strict
        ...
        return svn_error_create
          (SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
           dcgettext ("subversion", "Strict output of property values only available for single-" "target, non-recursive propget operations", 5));
      ...
      for (i = 0; i < targets->nelts; i++)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_client_propget5( &props, opt_state->show_inherited_props ? &inherited_props : ((void*)0), pname_utf8, truepath, &peg_revision, &(opt_state->start_revision), ((void*)0), opt_state->depth, opt_state->changelists, ctx, subpool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 443 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/propget-cmd.c"
          ...
          if (opt_state->xml)
            do { svn_error_t *svn_err__temp = (print_properties_xml( pname_utf8, props, opt_state->show_inherited_props ? inherited_props : ((void*)0), subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);



          else
            do { svn_error_t *svn_err__temp = (print_properties( out, pname_utf8, props, opt_state->show_inherited_props ? inherited_props : ((void*)0), print_filenames, omit_newline, like_proplist, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (opt_state->xml)
        do { svn_error_t *svn_err__temp = (svn_cl__xml_print_footer("properties", subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
