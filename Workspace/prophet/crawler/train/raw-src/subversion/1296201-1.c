...
svn_opt_print_help(apr_getopt_t *os,
                   ...
                   const char *footer,
                   apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_client__youngest_common_ancestor(const char **ancestor_url,
                                     ...
                                     apr_pool_t *result_pool,
                                     apr_pool_t *scratch_pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
svn_client__update_internal(svn_revnum_t *result_rev,
                            ...
                            svn_client_ctx_t *ctx,
                            apr_pool_t *pool);
# 532 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__get_shim_callbacks(svn_wc_context_t *wc_ctx,
                               const char *anchor_abspath,
                               apr_pool_t *result_pool);
# 1100 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c" 2
  ...
  if (! svn_path_is_url(abspath_or_url))
    {
      ...
      do { if (!(repos_relpath != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c", 103, "repos_relpath != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
    }
  ...
  else
    {
      ...
      do { if (!(ra_session != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/util.c", 119, "ra_session != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                          ...
                          apr_pool_t *scratch_pool)
{
  ...
  if (!svn_path_is_url(abspath_or_url))
    {
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_repos_info(repos_root, repos_uuid, ctx->wc_ctx, abspath_or_url, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  if (svn_path_is_url(path))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__get_wc_root(&wcroot_abspath, scb->wc_ctx, scb->anchor_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_wc__node_get_url(&wcroot_url, scb->wc_ctx, wcroot_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc_get_pristine_props(props, scb->wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc_read_kind(&node_kind, scb->wc_ctx, local_abspath, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_open_unique(&temp_stream, filename, ((void*)0), svn_io_file_del_on_pool_cleanup, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_stream_copy3(pristine_stream, temp_stream, ((void*)0), ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                               ...
                               apr_pool_t *result_pool)
{
  ...
  struct shim_callbacks_baton *scb = memset(apr_palloc(result_pool, sizeof(*scb)), 0, sizeof(*scb));
