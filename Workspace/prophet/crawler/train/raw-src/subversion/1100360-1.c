# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
svn_client__crawl_for_externals(apr_hash_t **externals_p,
                                ...
                                apr_pool_t *result_pool,
                                apr_pool_t *scratch_pool);
# 1030 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__external_info_gatherer(void *baton,
                                   ...
                                   svn_depth_t depth,
                                   apr_pool_t *scratch_pool);
# 1071 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__get_normalized_stream(svn_stream_t **normal_stream,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 1124 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
svn_wc__get_info(svn_wc_context_t *wc_ctx,
                 ...
                 void *cancel_baton,
                 apr_pool_t *scratch_pool);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
  ...
  if (err && err->apr_err == SVN_ERR_WC_LOCKED)
    {
      ...
      if (err2)
        ...
        err = svn_error_createf(SVN_ERR_WC_LOCKED, err,
                                dcgettext ("subversion", "Working copy locked; trying running " "'svn cleanup' on the root of the working " "copy (%s) instead.", 5),
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  if (ri->last_repos && svn_uri_is_child(ri->last_repos, url, ((void*)0)))
    {
  ...
  do { svn_error_t *svn_err__temp = (svn_client_open_ra_session(&ra_session, url, ri->ctx, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_get_uuid2(ra_session, repos_uuid, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&local_abspath, path, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_wc_upgrade(ctx->wc_ctx, local_abspath, fetch_repos_info, &info_baton, ctx->cancel_func, ctx->cancel_baton, ctx->notify_func2, ctx->notify_baton2, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 164 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c"
  do { svn_error_t *svn_err__temp = (svn_client_propget3(&externals, "svn:" "externals", path, &rev, &rev, ((void*)0), svn_depth_infinity, ((void*)0), ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(scratch_pool, externals); hi;
       hi = apr_hash_next(hi))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc_parse_externals_description3( &externals_p, svn_dirent_dirname(path, iterpool), external_desc->data, (!0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (i = 0; i < externals_p->nelts; i++)
        {
          ...
          item = (((svn_wc_external_item2_t* *)(externals_p)->elts)[i]);

          external_path = svn_dirent_join(externals_parent, item->target_dir,
                                          iterpool);

          do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&external_abspath, external_path, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          err = svn_wc_read_kind(&kind, ctx->wc_ctx, external_abspath, 0,
                                 iterpool);
          ...
          if (err && err->apr_err == SVN_ERR_WC_UPGRADE_REQUIRED)
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_wc_upgrade(ctx->wc_ctx, external_abspath, fetch_repos_info, &info_baton, ctx->cancel_func, ctx->cancel_baton, ctx->notify_func2, ctx->notify_baton2, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
