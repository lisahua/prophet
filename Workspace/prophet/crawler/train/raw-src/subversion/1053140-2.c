...
test_error_purge_tracing(apr_pool_t *pool)
{
  ...
  if (! svn_error__is_tracing_link(err))
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-test.c",96), (svn_error_create))(SVN_ERR_TEST_FAILED, err,
                              "The top error is not a tracing link:");
    }
  err = ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-test.c",99), (svn_error_create))(SVN_ERR_BASE, err, "other error"));
  if (! svn_error__is_tracing_link(err))
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-test.c",102), (svn_error_create))(SVN_ERR_TEST_FAILED, err,
                              "The top error is not a tracing link:");
    }
  ...
  for (child = err2; child; child = child->child)
    if (svn_error__is_tracing_link(child))
      {
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-test.c",110), (svn_error_create))(SVN_ERR_TEST_FAILED, err,
                                "Tracing link found after purging the "
                                "following chain:");
      }
  svn_error_clear(err);
# 162 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/error-test.c"
  return 0;
}
