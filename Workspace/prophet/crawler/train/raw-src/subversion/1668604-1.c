...
svn_io_file_create(const char *file,
                   const char *contents,
                   apr_pool_t *pool);
# 714 "./subversion/include/svn_io.h"
svn_error_t *
svn_io_file_create_bytes(const char *file,
                         const void *contents,
                         apr_size_t length,
                         apr_pool_t *pool);
# 729 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_file_lock2(const char *lock_file,
                  ...
                  apr_pool_t *pool);
# 779 "./subversion/include/svn_io.h"
svn_error_t *
svn_io_lock_open_file(apr_file_t *lockfile_handle,
                      svn_boolean_t exclusive,
                      svn_boolean_t nonblocking,
                      apr_pool_t *pool);
# 793 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_file_flush_to_disk(apr_file_t *file,
                          apr_pool_t *pool);
# 821 "./subversion/include/svn_io.h"
svn_error_t *
svn_io_dir_file_copy(const char *src_path,
                     const char *dest_path,
                     const char *file,
                     apr_pool_t *pool);
# 863 "./subversion/include/svn_io.h"
...
svn_stream_disown(svn_stream_t *stream,
                  apr_pool_t *pool);
# 1021 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_stream_read(svn_stream_t *stream,
                char *buffer,
                apr_size_t *len);
# 1289 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_stream_data_available(svn_stream_t *stream,
                          svn_boolean_t *data_available);
# 1369 "./subversion/include/svn_io.h"
svn_stream_t *
...
(*svn_stream_lazyopen_func_t)(svn_stream_t **stream,
                              ...
                              apr_pool_t *result_pool,
                              apr_pool_t *scratch_pool);
# 1563 "./subversion/include/svn_io.h"
svn_stream_t *
...
svn_stringbuf_from_aprfile(svn_stringbuf_t **result,
                           apr_file_t *file,
                           apr_pool_t *pool);
# 1625 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_remove_dir(const char *path,
                  apr_pool_t *pool);
# 1675 "./subversion/include/svn_io.h"
__attribute__((deprecated))
svn_error_t *
svn_io_get_dir_filenames(apr_hash_t **dirents,
                         const char *path,
                         apr_pool_t *pool);
# 1696 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_dir_walk(const char *dirname,
                ...
                void *walk_baton,
                apr_pool_t *pool);
# 1847 "./subversion/include/svn_io.h"
...
svn_io_start_cmd(apr_proc_t *cmd_proc,
                 ...
                 apr_file_t *errfile,
                 apr_pool_t *pool);
# 1917 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_parse_mimetypes_file(apr_hash_t **type_map,
                            ...
                            apr_pool_t *pool);
# 2109 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_detect_mimetype(const char **mimetype,
                       const char *file,
                       apr_pool_t *pool);
# 2134 "./subversion/include/svn_io.h"
svn_boolean_t
...
svn_io_file_seek(apr_file_t *file,
                 ...
                 apr_off_t *offset,
                 apr_pool_t *pool);
# 2239 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_file_write_full(apr_file_t *file,
                       ...
                       apr_size_t *bytes_written,
                       apr_pool_t *pool);
# 2286 "./subversion/include/svn_io.h"
svn_error_t *
svn_io_write_atomic(const char *final_path,
                    ...
                    apr_pool_t *scratch_pool);
# 2307 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_stat(apr_finfo_t *finfo,
            ...
            apr_int32_t wanted,
            apr_pool_t *pool);
# 2338 "./subversion/include/svn_io.h"
svn_error_t *
svn_io_file_rename(const char *from_path,
                   const char *to_path,
                   apr_pool_t *pool);
# 2352 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_dir_make_hidden(const char *path,
                       apr_fileperms_t perm,
                       apr_pool_t *pool);
# 2381 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_file_name_get(const char **filename,
                     apr_file_t *file,
                     apr_pool_t *pool);
# 2442 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_io_write_version_file(const char *path,
                          int version,
                          apr_pool_t *pool);
# 2478 "./subversion/include/svn_io.h"
svn_error_t *
...
svn_config_write_auth_data(apr_hash_t *hash,
                           ...
                           const char *config_dir,
                           apr_pool_t *pool);
# 800 "./subversion/include/svn_config.h"
typedef svn_error_t *
(*svn_config_auth_walk_func_t)(svn_boolean_t *delete_cred,
                               ...
                               apr_hash_t *hash,
                               apr_pool_t *scratch_pool);
# 836 "./subversion/include/svn_config.h"
svn_error_t *
...
svn_cl__similarity_check(const char *key,
                         ...
                         apr_pool_t *scratch_pool);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/diff-cmd.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/diff-cmd.c" 2
             ...
             apr_pool_t *pool)
{
  ...
  if (opt_state->xml)
    {
      ...
      svn_xml_make_open_tag(&sb, pool, svn_xml_normal, "paths", ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
  ...
  if (opt_state->diff.summarize)
    {
      if (opt_state->diff.use_git_diff_format)
        return svn_error_createf(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                                 dcgettext ("subversion", "'%s' not valid with '--summarize' option", 5),
                                 "--git");
  ...
  if (! opt_state->old_target && ! opt_state->new_target
  ...
  else if (opt_state->old_target)
    {
      ...
      if (tmp2->nelts < 2)
        return svn_error_create(SVN_ERR_CL_INSUFFICIENT_ARGS, ((void*)0), ((void*)0));
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cl__assert_homogeneous_target_type(targets)); if (svn_err__temp) return svn_error_quick_wrap(svn_err__temp, dcgettext ("subversion", "'svn diff [-r N[:M]] [TARGET[@REV]...]' does not support mixed " "target types. Try using the --old and --new options or one of " "the shorthand invocations listed in 'svn help diff'.", 5)); } while (0);
  ...
  if (opt_state->force)
    ...
    {
      do { svn_error_t *svn_err__temp = (svn_config_get_bool(apr_hash_get(ctx->config, "config", (-1)), &ignore_content_type, "miscellany", "diff-ignore-content-type", 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (opt_state->diff.summarize)
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_client_diff_summarize2( target1, &opt_state->start_revision, target2, &opt_state->end_revision, opt_state->depth, ! opt_state->diff.notice_ancestry, opt_state->changelists, summarize_func, &summarize_baton, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 446 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/diff-cmd.c"
            }
          else
            do { svn_error_t *svn_err__temp = (svn_client_diff6( options, target1, &(opt_state->start_revision), target2, &(opt_state->end_revision), ((void*)0), opt_state->depth, ! opt_state->diff.notice_ancestry, opt_state->diff.no_diff_added, opt_state->diff.no_diff_deleted, show_copies_as_adds, ignore_content_type, ignore_properties, opt_state->diff.properties_only, opt_state->diff.use_git_diff_format, svn_cmdline_output_encoding(pool), outstream, errstream, opt_state->changelists, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 469 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/diff-cmd.c"
        }
      else
        {
          const char *truepath;
          ...
          if (opt_state->diff.summarize)
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_client_diff_summarize_peg2( truepath, &peg_revision, &opt_state->start_revision, &opt_state->end_revision, opt_state->depth, ! opt_state->diff.notice_ancestry, opt_state->changelists, summarize_func, &summarize_baton, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 497 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/diff-cmd.c"
            }
          else
            do { svn_error_t *svn_err__temp = (svn_client_diff_peg6( options, truepath, &peg_revision, &opt_state->start_revision, &opt_state->end_revision, ((void*)0), opt_state->depth, ! opt_state->diff.notice_ancestry, opt_state->diff.no_diff_added, opt_state->diff.no_diff_deleted, show_copies_as_adds, ignore_content_type, ignore_properties, opt_state->diff.properties_only, opt_state->diff.use_git_diff_format, svn_cmdline_output_encoding(pool), outstream, errstream, opt_state->changelists, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 520 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/diff-cmd.c"
        }
    }
