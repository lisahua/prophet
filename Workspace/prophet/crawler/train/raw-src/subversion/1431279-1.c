...
# 591 "./subversion/include/svn_types.h"
...
{
# 863 "./subversion/include/svn_types.h"
...
# 906 "./subversion/include/svn_types.h"
...
# 952 "./subversion/include/svn_types.h"
svn_log_entry_t *
svn_log_entry_dup(const svn_log_entry_t *log_entry, apr_pool_t *pool);
# 987 "./subversion/include/svn_types.h"
...
typedef svn_error_t *(*svn_log_message_receiver_t)(
  ...
  const char *message,
  apr_pool_t *pool);
# 1017 "./subversion/include/svn_types.h"
...
# 1124 "./subversion/include/svn_types.h"
...
svn_location_segment_dup(const svn_location_segment_t *segment,
                         apr_pool_t *pool);
# 1261 "./subversion/include/svn_types.h"
typedef unsigned long svn_linenum_t;
# 1287 "./subversion/include/svn_types.h"
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 1288 "./subversion/include/svn_types.h" 2
...
svn_wc__get_not_present_descendants(const apr_array_header_t **descendants,
                                    ...
                                    apr_pool_t *result_pool,
                                    apr_pool_t *scratch_pool);
# 1121 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__check_for_obstructions(svn_wc_notify_state_t *obstruction_state,
                               ...
                               apr_pool_t *scratch_pool);
# 1142 "./subversion/include/private/svn_wc_private.h"
...
svn_wc__get_info(svn_wc_context_t *wc_ctx,
                 ...
                 void *cancel_baton,
                 apr_pool_t *scratch_pool);
# 1222 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__delete_many(svn_wc_context_t *wc_ctx,
                    ...
                    void *notify_baton,
                    apr_pool_t *scratch_pool);
# 1265 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__node_was_moved_away(const char **moved_to_abspath,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 1284 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__upgrade_add_external_info(svn_wc_context_t *wc_ctx,
                                  ...
                                  apr_pool_t *scratch_pool);
# 1328 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__resolve_relative_external_url(const char **resolved_url,
                                      ...
                                      apr_pool_t *result_pool,
                                      apr_pool_t *scratch_pool);
# 1400 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__get_update_editor(const svn_delta_editor_t **editor,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 1549 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__get_switch_editor(const svn_delta_editor_t **editor,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 1658 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__get_diff_editor(const svn_delta_editor_t **editor,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 1734 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__resolve_conflicts(svn_wc_context_t *wc_ctx,
                          ...
                          void *notify_baton,
                          apr_pool_t *scratch_pool);
# 1784 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__db_external_remove(svn_wc__db_t *db,
                           ...
                           const svn_skel_t *work_items,
                           apr_pool_t *scratch_pool);
# 1181 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_committable_externals_below(apr_array_header_t **externals,
                                       ...
                                       apr_pool_t *result_pool,
                                       apr_pool_t *scratch_pool);
# 1238 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_externals_defined_below(apr_hash_t **externals,
                                   ...
                                   apr_pool_t *result_pool,
                                   apr_pool_t *scratch_pool);
# 1254 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_externals_gather_definitions(apr_hash_t **externals,
                                        ...
                                        apr_pool_t *result_pool,
                                        apr_pool_t *scratch_pool);
# 1280 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_copy_symlink(svn_wc__db_t *db,
                           ...
                           const svn_skel_t *work_items,
                           apr_pool_t *scratch_pool);
# 1381 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_add_symlink(svn_wc__db_t *db,
                          ...
                          const svn_skel_t *work_items,
                          apr_pool_t *scratch_pool);
# 1443 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_revert_list_done(svn_wc__db_t *db,
                            const char *local_abspath,
                            apr_pool_t *scratch_pool);
# 1829 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
# 1925 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
# 1960 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_read_pristine_info(svn_wc__db_status_t *status,
                              ...
                              apr_pool_t *result_pool,
                              apr_pool_t *scratch_pool);
# 1986 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_read_url(const char **url,
                    ...
                    apr_pool_t *result_pool,
                    apr_pool_t *scratch_pool);
# 2031 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_read_children(const apr_array_header_t **children,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2198 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_node_hidden(svn_boolean_t *hidden,
                       ...
                       const char *local_abspath,
                       apr_pool_t *scratch_pool);
# 2276 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_is_wcroot(svn_boolean_t *is_wcroot,
                     ...
                     const char *local_abspath,
                     apr_pool_t *scratch_pool);
# 2312 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_global_commit(svn_wc__db_t *db,
                         ...
                         const svn_skel_t *work_items,
                         apr_pool_t *scratch_pool);
# 2423 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_bump_revisions_post_update(svn_wc__db_t *db,
                                         ...
                                         apr_hash_t *wcroot_iprops,
                                         apr_pool_t *scratch_pool);
# 2500 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_global_record_fileinfo(svn_wc__db_t *db,
                                  ...
                                  apr_time_t recorded_time,
                                  apr_pool_t *scratch_pool);
# 2525 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_lock_remove(svn_wc__db_t *db,
                       const char *local_abspath,
                       apr_pool_t *scratch_pool);
# 2560 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_scan_base_repos(const char **repos_relpath,
                           ...
                           apr_pool_t *result_pool,
                           apr_pool_t *scratch_pool);
# 2624 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_scan_addition(svn_wc__db_status_t *status,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2735 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_scan_deletion(const char **base_del_abspath,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2759 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_upgrade_insert_external(svn_wc__db_t *db,
                                   ...
                                   svn_revnum_t def_revision,
                                   apr_pool_t *scratch_pool);
# 2819 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_bump_format(int *result_format,
                       ...
                       svn_wc__db_t *db,
                       apr_pool_t *scratch_pool);
# 2851 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_wq_add(svn_wc__db_t *db,
                  const char *wri_abspath,
                  const svn_skel_t *work_item,
                  apr_pool_t *scratch_pool);
# 2874 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_wq_fetch_next(apr_uint64_t *id,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2895 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_wclock_owns_lock(svn_boolean_t *own_lock,
                            ...
                            svn_boolean_t exact,
                            apr_pool_t *scratch_pool);
# 2954 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_temp_get_all_access(svn_wc__db_t *db,
                               apr_pool_t *result_pool);
# 3021 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_revision_status(svn_revnum_t *min_revision,
                           ...
                           void *cancel_baton,
                           apr_pool_t *scratch_pool);
# 3152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_min_max_revisions(svn_revnum_t *min_revision,
                             ...
                             svn_boolean_t committed,
                             apr_pool_t *scratch_pool);
# 3172 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_has_switched_subtrees(svn_boolean_t *is_switched,
                                 ...
                                 const char *trail_url,
                                 apr_pool_t *scratch_pool);
# 3186 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_with_txn(svn_wc__db_wcroot_t *wcroot,
                    ...
                    void *cb_baton,
                    apr_pool_t *scratch_pool);
# 348 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db_private.h"
svn_error_t *
