# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
svn_cmdline_setup_auth_baton(svn_auth_baton_t **ab,
                             ...
                             void *cancel_baton,
                             apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
# 1965 "./subversion/include/svn_wc.h"
...
svn_wc_conflict_description_create_text2(const char *local_abspath,
                                         apr_pool_t *result_pool);
# 2087 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_wc_conflict_description_t *
...
svn_wc_conflict_description_create_tree2(
  ...
  const svn_wc_conflict_version_t *src_right_version,
  apr_pool_t *result_pool);
# 2188 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_wc_conflict_description_t *
...
# 2297 "./subversion/include/svn_wc.h"
svn_wc_conflict_result_t *
svn_wc_create_conflict_result(svn_wc_conflict_choice_t choice,
                              const char *merged_file,
                              apr_pool_t *pool);
# 2329 "./subversion/include/svn_wc.h"
typedef svn_error_t *(*svn_wc_conflict_resolver_func3_t)(
  ...
  apr_pool_t *result_pool,
  apr_pool_t *scratch_pool);
# 2343 "./subversion/include/svn_wc.h"
typedef svn_error_t *(*svn_wc_conflict_resolver_func2_t)(
  ...
  apr_pool_t *result_pool,
  apr_pool_t *scratch_pool);
# 2358 "./subversion/include/svn_wc.h"
...
# 2484 "./subversion/include/svn_wc.h"
  ...
  svn_error_t *(*dir_deleted)(svn_wc_notify_state_t *state,
                              ...
                              void *diff_baton,
                              apr_pool_t *scratch_pool);
# 2513 "./subversion/include/svn_wc.h"
...
# 2552 "./subversion/include/svn_wc.h"
  svn_error_t *(*dir_props_changed)(svn_wc_notify_state_t *propstate,
                                    ...
                                    void *diff_baton,
                                    apr_pool_t *scratch_pool);
# 2568 "./subversion/include/svn_wc.h"
...
# 2586 "./subversion/include/svn_wc.h"
...
svn_wc_has_binary_prop(svn_boolean_t *has_binary_prop,
                       ...
                       svn_wc_adm_access_t *adm_access,
                       apr_pool_t *pool);
# 2881 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_props_modified_p(svn_boolean_t *modified_p,
                        ...
                        svn_wc_adm_access_t *adm_access,
                        apr_pool_t *pool);
# 2933 "./subversion/include/svn_wc.h"
...
# 2969 "./subversion/include/svn_wc.h"
...
# 3005 "./subversion/include/svn_wc.h"
...
# 3153 "./subversion/include/svn_wc.h"
  svn_depth_t depth;
...
svn_wc_walk_entries3(const char *path,
                     ...
                     void *cancel_baton,
                     apr_pool_t *pool);
# 3549 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_dup_status(const svn_wc_status_t *orig_stat,
                  apr_pool_t *pool);
# 4155 "./subversion/include/svn_wc.h"
svn_error_t *
...
# 4284 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_move(svn_wc_context_t *wc_ctx,
            ...
            void *notify_baton,
            apr_pool_t *scratch_pool);
# 4672 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_add_from_disk2(svn_wc_context_t *wc_ctx,
                      ...
                      void *notify_baton,
                      apr_pool_t *scratch_pool);
# 4796 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_relocate4(svn_wc_context_t *wc_ctx,
                 ...
                 apr_pool_t *scratch_pool);
# 7563 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_translated_stream(svn_stream_t **stream,
                         ...
                         apr_uint32_t flags,
                         apr_pool_t *pool);
# 7920 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_transmit_text_deltas3(const svn_checksum_t **new_text_base_md5_checksum,
                             ...
                             apr_pool_t *result_pool,
                             apr_pool_t *scratch_pool);
# 7946 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_transmit_text_deltas(const char *path,
                            ...
                            const char **tempfile,
                            apr_pool_t *pool);
# 7978 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_transmit_prop_deltas2(svn_wc_context_t *wc_ctx,
                             ...
                             void *baton,
                             apr_pool_t *scratch_pool);
# 7998 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_match_ignore_list(const char *str,
                         ...
                         apr_pool_t *pool);
# 8078 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_remove_lock(const char *path,
                   svn_wc_adm_access_t *adm_access,
                   apr_pool_t *pool);
# 8136 "./subversion/include/svn_wc.h"
...
# 8182 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_revision_status2(svn_wc_revision_status_t **result_p,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 8200 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
svn_wc_revision_status(svn_wc_revision_status_t **result_p,
                       ...
                       void *cancel_baton,
                       apr_pool_t *pool);
# 8243 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_get_changelists(svn_wc_context_t *wc_ctx,
                       ...
                       void *cancel_baton,
                       apr_pool_t *scratch_pool);
# 8334 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_crop_tree2(svn_wc_context_t *wc_ctx,
                  ...
                  void *notify_baton,
                  apr_pool_t *scratch_pool);
# 8354 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
svn_wc_crop_tree(svn_wc_adm_access_t *anchor,
                 ...
                 void *cancel_baton,
                 apr_pool_t *pool);
# 8384 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_exclude(svn_wc_context_t *wc_ctx,
               ...
               void *notify_baton,
               apr_pool_t *scratch_pool);
# 8422 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_diff_file_output_merge2(svn_stream_t *output_stream,
                            ...
                            apr_pool_t *pool);
# 739 "./subversion/include/svn_diff.h"
__attribute__((deprecated))
svn_error_t *
svn_diff_file_output_merge(svn_stream_t *output_stream,
                           ...
                           apr_pool_t *pool);
# 766 "./subversion/include/svn_diff.h"
svn_error_t *
svn_diff_output_binary(svn_stream_t *output_stream,
                       ...
                       void *cancel_baton,
                       apr_pool_t *scratch_pool);
# 781 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_mem_string_diff4(svn_diff_t **diff,
                          ...
                          const svn_diff_file_options_t *options,
                          apr_pool_t *pool);
# 836 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_mem_string_output_unified(svn_stream_t *output_stream,
                                   ...
                                   const svn_string_t *modified,
                                   apr_pool_t *pool);
# 876 "./subversion/include/svn_diff.h"
svn_error_t *
...
# 979 "./subversion/include/svn_diff.h"
...
svn_diff_hunk_readline_diff_text(svn_diff_hunk_t *hunk,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 1023 "./subversion/include/svn_diff.h"
svn_error_t *
svn_diff_hunk_readline_original_text(svn_diff_hunk_t *hunk,
                                     ...
                                     apr_pool_t *result_pool,
                                     apr_pool_t *scratch_pool);
# 1038 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_open_patch_file(svn_patch_file_t **patch_file,
                         const char *local_abspath,
                         apr_pool_t *result_pool);
# 1180 "./subversion/include/svn_diff.h"
svn_error_t *
...
# 326 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__get_conflict_func_interactive_baton(
  ...
  void *cancel_baton,
  apr_pool_t *result_pool);
# 394 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__conflict_func_interactive(svn_wc_conflict_result_t **result,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 410 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__print_commit_info(const svn_commit_info_t *commit_info,
                          void *baton,
                          apr_pool_t *pool);
# 422 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__time_cstring_to_human_cstring(const char **human_cstring,
                                      const char *data,
                                      apr_pool_t *pool);
# 449 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__print_status(const char *target_abspath,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 472 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__print_xml_lock(svn_stringbuf_t **outstr,
                       const svn_lock_t *lock,
                       apr_pool_t *pool);
# 504 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__revprop_prepare(const svn_opt_revision_t *revision,
                        ...
                        svn_client_ctx_t *ctx,
                        apr_pool_t *pool);
# 523 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
# 624 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__get_log_message(const char **log_msg,
                        ...
                        void *baton,
                        apr_pool_t *pool);
# 649 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__args_to_target_array_print_reserved(apr_array_header_t **targets_p,
                                            ...
                                            apr_pool_t *pool);
# 783 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
const char *
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         const char *wc_repos_root_URL,
                         apr_pool_t *pool);
# 804 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__deprecated_merge_reintegrate(const char *source_path_or_url,
                                     ...
                                     svn_client_ctx_t *ctx,
                                     apr_pool_t *pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c" 2
...
{
  apr_hash_set(hash, apr_pstrdup(nb->conflict_stats->stats_pool, path), (-1), "");
}
  ...
  switch (conflict_kind)
    {
      case svn_wc_conflict_kind_text:
        if (apr_hash_get(conflict_stats->text_conflicts, path_local, (-1)))
          {
            apr_hash_set(conflict_stats->text_conflicts, path_local, (-1), ((void*)0));
            conflict_stats->text_conflicts_resolved++;
          }
        break;
      case svn_wc_conflict_kind_property:
        if (apr_hash_get(conflict_stats->prop_conflicts, path_local, (-1)))
          {
            apr_hash_set(conflict_stats->prop_conflicts, path_local, (-1), ((void*)0));
            conflict_stats->prop_conflicts_resolved++;
          }
        break;
      case svn_wc_conflict_kind_tree:
        if (apr_hash_get(conflict_stats->tree_conflicts, path_local, (-1)))
          {
            apr_hash_set(conflict_stats->tree_conflicts, path_local, (-1), ((void*)0));
...
{
  return apr_psprintf(pool, dcngettext ("subversion", "%d remaining", "%d remaining", n_remaining, 5),
...
{
  return apr_psprintf(pool, dcngettext ("subversion", "and %d already resolved", "and %d already resolved", n_resolved, 5),
                             ...
                             apr_pool_t *scratch_pool)
{
  ...
  if (n_text > 0 || n_text_r > 0
      ...
      || n_tree > 0 || n_tree_r > 0
      || conflict_stats->skipped_paths > 0)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "Summary of conflicts:\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (n_text_r == 0 && n_prop_r == 0 && n_tree_r == 0)
    {
      if (n_text > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Text conflicts: %d\n", 5), n_text)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (n_prop > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Property conflicts: %d\n", 5), n_prop)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (n_tree > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Tree conflicts: %d\n", 5), n_tree)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    {
      if (n_text > 0 || n_text_r > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Text conflicts: %s (%s)\n", 5), remaining_str(scratch_pool, n_text), resolved_str(scratch_pool, n_text_r))); if (svn_err__temp) return (svn_err__temp); } while (0);



      if (n_prop > 0 || n_prop_r > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Property conflicts: %s (%s)\n", 5), remaining_str(scratch_pool, n_prop), resolved_str(scratch_pool, n_prop_r))); if (svn_err__temp) return (svn_err__temp); } while (0);



      if (n_tree > 0 || n_tree_r > 0)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Tree conflicts: %s (%s)\n", 5), remaining_str(scratch_pool, n_tree), resolved_str(scratch_pool, n_tree_r))); if (svn_err__temp) return (svn_err__temp); } while (0);



    }
  if (conflict_stats->skipped_paths > 0)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "  Skipped paths: %d\n", 5), conflict_stats->skipped_paths)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_cl__notifier_print_conflict_stats(void *baton, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__print_conflict_stats(nb->conflict_stats, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return 0;
}
  ...
  switch (n->action)
    ...
    case svn_wc_notify_skip:
      ...
      if (n->content_state == svn_wc_notify_state_missing)
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Skipped missing target: '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


        }
      else if (n->content_state == svn_wc_notify_state_source_missing)
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "Skipped target: '%s' -- copy-source is missing\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Skipped '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      break;
    case svn_wc_notify_update_skip_obstruction:
      nb->conflict_stats->skipped_paths++;
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "Skipped '%s' -- An obstructing working copy was found\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_update_skip_working_only:
      nb->conflict_stats->skipped_paths++;
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "Skipped '%s' -- Has no versioned parent\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;
    case svn_wc_notify_update_skip_access_denied:
      nb->conflict_stats->skipped_paths++;
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "Skipped '%s' -- Access denied\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;
    case svn_wc_notify_skip_conflicted:
      nb->conflict_stats->skipped_paths++;
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "Skipped '%s' -- Node remains in conflict\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;
    case svn_wc_notify_update_delete:
    case svn_wc_notify_exclude:
      nb->received_some_change = (!0);
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "D    %s\n", path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;
    case svn_wc_notify_update_broken_lock:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "B    %s\n", path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;
    ...
    case svn_wc_notify_update_external_removed:
      ...
      if (n->err && n->err->message)
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Removed external '%s': %s\n", 5), path_local, n->err->message)); if (svn_err__temp) return (svn_err__temp); } while (0);

        }
      else
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Removed external '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);

        }
      break;

    case svn_wc_notify_left_local_modifications:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Left local modifications as '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case svn_wc_notify_update_replace:
      nb->received_some_change = (!0);
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "R    %s\n", path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;
      ...
      if (n->content_state == svn_wc_notify_state_conflicted)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "C    %s\n", path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      else
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "A    %s\n", path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      break;
    ...
    case svn_wc_notify_exists:
      ...
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%s %s\n", statchar_buf, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case svn_wc_notify_restore:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Restored '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case svn_wc_notify_revert:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Reverted '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case svn_wc_notify_failed_revert:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Failed to revert '%s' -- " "try updating instead.\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;

    case svn_wc_notify_resolved:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Resolved conflicted state of '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_add:
      ...
      if (n->mime_type && (svn_mime_type_is_binary(n->mime_type)))
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "A  (bin)  %s\n", path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (n->hunk_fuzz)
            {
              ...
              if (n->prop_name)
                {
                  s = dcgettext ("subversion", ">         applied hunk ## -%lu,%lu +%lu,%lu ## " "with offset %s", 5);


                  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, apr_pstrcat(pool, s, "%""lu" " and fuzz %lu (%s)\n", ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0)), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length, minus, off, n->hunk_fuzz, n->prop_name)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 473 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
                }
              else
                {
                  s = dcgettext ("subversion", ">         applied hunk @@ -%lu,%lu +%lu,%lu @@ " "with offset %s", 5);
                  ...
                  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, apr_pstrcat(pool, s, "%""lu" " and fuzz %lu\n", ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0)), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length, minus, off, n->hunk_fuzz)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 489 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
                }
            }
          else
            {
              ...
              if (n->prop_name)
                {
                  ...
                  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, apr_pstrcat(pool, s, "%""lu"" (%s)\n", ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0)), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length, minus, off, n->prop_name)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 507 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
                }
              else
                {
                  s = dcgettext ("subversion", ">         applied hunk @@ -%lu,%lu +%lu,%lu @@ " "with offset %s", 5);

                  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, apr_pstrcat(pool, s, "%""lu""\n", ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0)), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length, minus, off)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 521 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
                }
            }
        }
      else if (n->hunk_fuzz)
        {
          if (n->prop_name)
            do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", ">         applied hunk ## -%lu,%lu +%lu,%lu ## " "with fuzz %lu (%s)\n", 5), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length, n->hunk_fuzz, n->prop_name)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 536 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
          else
            do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", ">         applied hunk @@ -%lu,%lu +%lu,%lu @@ " "with fuzz %lu\n", 5), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length, n->hunk_fuzz)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 546 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
        }
      break;
    ...
    case svn_wc_notify_patch_rejected_hunk:
      ...
      if (n->prop_name)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", ">         rejected hunk " "## -%lu,%lu +%lu,%lu ## (%s)\n", 5), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length, n->prop_name)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", ">         rejected hunk " "@@ -%lu,%lu +%lu,%lu @@\n", 5), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_patch_hunk_already_applied:
      nb->received_some_change = (!0);
      if (n->prop_name)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", ">         hunk " "## -%lu,%lu +%lu,%lu ## " "already applied (%s)\n", 5), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length, n->prop_name)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 583 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/notify.c"
      else
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", ">         hunk " "@@ -%lu,%lu +%lu,%lu @@ " "already applied\n", 5), n->hunk_original_start, n->hunk_original_length, n->hunk_modified_start, n->hunk_modified_length)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (nb->in_external)
      ...
      else
        {
          svn_error_t *warn_err =
            svn_error_createf(SVN_ERR_CL_ERROR_PROCESSING_EXTERNALS, ((void*)0),
                              dcgettext ("subversion", "Error handling externals definition for '%s':", 5),
                              path_local);
    ...
    case svn_wc_notify_update_started:
      if (! (nb->in_external ||
             ...
             nb->is_export))
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Updating '%s':\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        if (((n->revision) >= 0))
          {
            if (nb->is_export)
              {
                do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, nb->in_external ? dcgettext ("subversion", "Exported external at revision %ld.\n", 5) : dcgettext ("subversion", "Exported revision %ld.\n", 5), n->revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              {
                do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, nb->in_external ? dcgettext ("subversion", "Checked out external at revision %ld.\n", 5) : dcgettext ("subversion", "Checked out revision %ld.\n", 5), n->revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            else
              {
                if (nb->received_some_change)
                  {
                    nb->received_some_change = 0;
                    do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, nb->in_external ? dcgettext ("subversion", "Updated external to revision %ld.\n", 5) : dcgettext ("subversion", "Updated to revision %ld.\n", 5), n->revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  {
                    do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, nb->in_external ? dcgettext ("subversion", "External at revision %ld.\n", 5) : dcgettext ("subversion", "At revision %ld.\n", 5), n->revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        else
          {
            if (nb->is_export)
              {
                do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, nb->in_external ? dcgettext ("subversion", "External export complete.\n", 5) : dcgettext ("subversion", "Export complete.\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              {
                do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, nb->in_external ? dcgettext ("subversion", "External checkout complete.\n", 5) : dcgettext ("subversion", "Checkout complete.\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              {
                do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, nb->in_external ? dcgettext ("subversion", "External update complete.\n", 5) : dcgettext ("subversion", "Update complete.\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_status_completed:
      if (((n->revision) >= 0))
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Status against revision: %6ld\n", 5), n->revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_commit_modified:
      ...
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, nb->is_wc_to_repos_copy ? dcgettext ("subversion", "Sending copy of       %s\n", 5) : dcgettext ("subversion", "Sending        %s\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_commit_copied:
      if (n->mime_type && svn_mime_type_is_binary(n->mime_type))
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, nb->is_wc_to_repos_copy ? dcgettext ("subversion", "Adding copy of (bin)  %s\n", 5) : dcgettext ("subversion", "Adding  (bin)  %s\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, nb->is_wc_to_repos_copy ? dcgettext ("subversion", "Adding copy of        %s\n", 5) : dcgettext ("subversion", "Adding         %s\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_commit_deleted:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, nb->is_wc_to_repos_copy ? dcgettext ("subversion", "Deleting copy of      %s\n", 5) : dcgettext ("subversion", "Deleting       %s\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_commit_copied_replaced:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, nb->is_wc_to_repos_copy ? dcgettext ("subversion", "Replacing copy of     %s\n", 5) : dcgettext ("subversion", "Replacing      %s\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (! nb->sent_first_txdelta)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Transmitting file data ", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);

        }

      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, ".")); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case svn_wc_notify_locked:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "'%s' locked by user '%s'.\n", 5), path_local, n->lock->owner)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case svn_wc_notify_unlocked:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "'%s' unlocked.\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_changelist_set:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "A [%s] %s\n", n->changelist_name, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case svn_wc_notify_changelist_clear:
    case svn_wc_notify_changelist_moved:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "D [%s] %s\n", n->changelist_name, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;

    case svn_wc_notify_merge_begin:
      if (n->merge_range == ((void*)0))
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Merging differences between " "repository URLs into '%s':\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);



      else if (n->merge_range->start == n->merge_range->end - 1
          || n->merge_range->start == n->merge_range->end)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Merging r%ld into '%s':\n", 5), n->merge_range->end, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);

      else if (n->merge_range->start - 1 == n->merge_range->end)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Reverse-merging r%ld into '%s':\n", 5), n->merge_range->start, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      else if (n->merge_range->start < n->merge_range->end)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Merging r%ld through r%ld into " "'%s':\n", 5), n->merge_range->start + 1, n->merge_range->end, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);




      else
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Reverse-merging r%ld through r%ld " "into '%s':\n", 5), n->merge_range->start, n->merge_range->end + 1, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_merge_record_info_begin:
      if (!n->merge_range)
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Recording mergeinfo for merge " "between repository URLs into '%s':\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      else
        {
          if (n->merge_range->start == n->merge_range->end - 1
              || n->merge_range->start == n->merge_range->end)
            do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "--- Recording mergeinfo for merge of r%ld into '%s':\n", 5), n->merge_range->end, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);



          else if (n->merge_range->start - 1 == n->merge_range->end)
            do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "--- Recording mergeinfo for reverse merge of r%ld into '%s':\n", 5), n->merge_range->start, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);



           else if (n->merge_range->start < n->merge_range->end)
             do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "--- Recording mergeinfo for merge of r%ld through r%ld into '%s':\n", 5), n->merge_range->start + 1, n->merge_range->end, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);



           else
             do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "--- Recording mergeinfo for reverse merge of r%ld through r%ld into '%s':\n", 5), n->merge_range->start, n->merge_range->end + 1, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_merge_elide_info:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Eliding mergeinfo from '%s':\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_foreign_merge_begin:
      if (n->merge_range == ((void*)0))
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Merging differences between " "foreign repository URLs into '%s':\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);



      else if (n->merge_range->start == n->merge_range->end - 1
          || n->merge_range->start == n->merge_range->end)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Merging (from foreign repository) " "r%ld into '%s':\n", 5), n->merge_range->end, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);



      else if (n->merge_range->start - 1 == n->merge_range->end)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Reverse-merging (from foreign " "repository) r%ld into '%s':\n", 5), n->merge_range->start, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);



      else if (n->merge_range->start < n->merge_range->end)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Merging (from foreign repository) " "r%ld through r%ld into '%s':\n", 5), n->merge_range->start + 1, n->merge_range->end, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);




      else
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "--- Reverse-merging (from foreign " "repository) r%ld through r%ld into " "'%s':\n", 5), n->merge_range->start, n->merge_range->end + 1, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_update_shadowed_update:
      nb->received_some_change = (!0);
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "   U %s\n", path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;
    ...
    case svn_wc_notify_property_added:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "property '%s' set on '%s'\n", 5), n->prop_name, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;

    case svn_wc_notify_property_deleted:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "property '%s' deleted from '%s'.\n", 5), n->prop_name, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;

    case svn_wc_notify_property_deleted_nonexistent:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Attempting to delete nonexistent " "property '%s' on '%s'\n", 5), n->prop_name, path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_revprop_set:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "property '%s' set on repository revision %ld\n", 5), n->prop_name, n->revision)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;

    case svn_wc_notify_revprop_deleted:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "property '%s' deleted from repository revision %ld\n", 5), n->prop_name, n->revision)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;

    case svn_wc_notify_upgraded_path:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Upgraded '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case svn_wc_notify_url_redirect:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Redirecting to URL '%s':\n", 5), n->url)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case svn_wc_notify_path_nonexistent:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%s\n", apr_psprintf(pool, dcgettext ("subversion", "'%s' is not under version control", 5), path_local))); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_foreign_copy_begin:
      if (n->merge_range == ((void*)0))
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf( pool, dcgettext ("subversion", "--- Copying from foreign repository URL '%s':\n", 5), n->url)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_move_broken:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Breaking move with source path '%s'\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);


      break;

    case svn_wc_notify_cleanup_external:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf (pool, dcgettext ("subversion", "Performing cleanup on external item at '%s'.\n", 5), path_local)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_wc_notify_commit_finalizing:
      if (nb->sent_first_txdelta)
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "done\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Committing transaction...", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;
...
svn_cl__get_notifier(svn_wc_notify_func2_t *notify_func_p,
                     ...
                     apr_pool_t *pool)
{
  struct notify_baton *nb = memset(apr_palloc(pool, sizeof(*nb)), 0, sizeof(*nb));

  nb->received_some_change = 0;
  nb->sent_first_txdelta = 0;
  nb->is_checkout = 0;
  nb->is_export = 0;
  nb->is_wc_to_repos_copy = 0;
  nb->in_external = 0;
  nb->had_print_error = 0;
  nb->conflict_stats = conflict_stats;
  do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&nb->path_prefix, "", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
