# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
svn_fspath__get_longest_ancestor(const char *fspath1,
                                 const char *fspath2,
                                 apr_pool_t *result_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
svn_wc__read_entries_old(apr_hash_t **entries,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c" 2
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
static svn_error_t *
  ...
  if (lb->base_path)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&local_abspath, svn_dirent_join(lb->base_path, path, pool), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (do_lock)
        {
          if (!ra_err)
            {
              do { svn_error_t *svn_err__temp = (svn_wc_add_lock2(lb->ctx->wc_ctx, local_abspath, lock, lb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      else
        {
          ...
          if (!ra_err ||
            ...
            {
              do { svn_error_t *svn_err__temp = (svn_wc_remove_lock2(lb->ctx->wc_ctx, local_abspath, lb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 169 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
static svn_error_t *
                      ...
                      apr_pool_t *pool)
{
  ...
  url_mode = ((targets->nelts >= 1) &&
              svn_path_is_url((((const char * *)(targets)->elts)[0])));


  if (url_mode)
      do { svn_error_t *svn_err__temp = (svn_uri_condense_targets(common_parent_url, &rel_targets, targets, (!0), pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  else
      do { svn_error_t *svn_err__temp = (svn_dirent_condense_targets(common_parent_url, &rel_targets, targets, (!0), pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (apr_is_empty_array(rel_targets))
    {
      ...
      *common_parent_url = parent;
      (*((const char * *)apr_array_push(rel_targets))) = base;
    }

  if (*common_parent_url == ((void*)0) || (*common_parent_url)[0] == '\0')
    return svn_error_create
      (SVN_ERR_UNSUPPORTED_FEATURE, ((void*)0),
       dcgettext ("subversion", "No common parent found, unable to operate on disjoint arguments", 5));

  if (url_mode)
    {
      svn_revnum_t *invalid_revnum;
      invalid_revnum = apr_palloc(pool, sizeof(*invalid_revnum));
      *invalid_revnum = ((svn_revnum_t) -1);
      *base_dir = ((void*)0);
      ...
      for (i = 0; i < rel_targets->nelts; i++)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__node_get_url(&url, ctx->wc_ctx, local_abspath, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          (*((const char * *)apr_array_push(urls))) = url;
        }


      do { svn_error_t *svn_err__temp = (svn_uri_condense_targets(&common_url, &rel_urls, urls, 0, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (apr_is_empty_array(rel_urls))
        {
          ...
          (*((const char * *)apr_array_push(rel_urls))) = base_name;
        }


      if (common_url == ((void*)0) || (common_url)[0] == '\0')
        return svn_error_create
          (SVN_ERR_UNSUPPORTED_FEATURE, ((void*)0),
           dcgettext ("subversion", "Unable to lock/unlock across multiple repositories", 5));
          ...
          if (do_lock)
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_wc__node_get_base_rev(revnum, ctx->wc_ctx, abs_path, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              if (! force)
                {
                  ...
                  do { svn_error_t *svn_err__temp = (svn_wc__node_get_lock_info(&lock_token, ((void*)0), ((void*)0), ((void*)0), ctx->wc_ctx, abs_path, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


                  if (! lock_token)
                    return svn_error_createf
                      (SVN_ERR_CLIENT_MISSING_LOCK_TOKEN, ((void*)0),
                       dcgettext ("subversion", "'%s' is not locked in this working copy", 5), target);
  ...
  for (hi = apr_hash_first(pool, path_tokens); hi; hi = apr_hash_next(hi))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_ra_get_lock(ra_session, &lock, path, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      if (! lock)
        return svn_error_createf
          (SVN_ERR_CLIENT_MISSING_LOCK_TOKEN, ((void*)0),
           dcgettext ("subversion", "'%s' is not locked", 5), path);

      apr_hash_set(path_tokens, path, (-1),
...
{
  const char *base_dir;
  const char *base_dir_abspath = ((void*)0);
  ...
  do { svn_error_t *svn_err__temp = (organize_lock_targets(&common_parent_url, &base_dir, &path_revs, &urls_to_paths, targets, (!0), steal_lock, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__open_ra_session_internal(&ra_session, ((void*)0), common_parent_url, base_dir, ((void*)0), 0, 0, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_lock(ra_session, path_revs, comment, steal_lock, store_locks_callback, &cb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (organize_lock_targets(&common_parent_url, &base_dir, &path_tokens, &urls_to_paths, targets, 0, break_lock, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (base_dir)
    do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&base_dir_abspath, base_dir, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_client__open_ra_session_internal(&ra_session, ((void*)0), common_parent_url, base_dir_abspath, ((void*)0), 0, 0, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 465 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
  if (! base_dir && !break_lock)
    do { svn_error_t *svn_err__temp = (fetch_tokens(ra_session, path_tokens, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_ra_unlock(ra_session, path_tokens, break_lock, store_locks_callback, &cb, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
