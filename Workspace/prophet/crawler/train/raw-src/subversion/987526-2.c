...
migrate_props(const char *wcroot_abspath,
              ...
              apr_pool_t *scratch_pool)
{
# 1014 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  const apr_array_header_t *children;
  apr_pool_t *iterpool = svn_pool_create_ex(scratch_pool, ((void*)0));
  int i;
  ...
  for (hi = apr_hash_first(scratch_pool, dirents); hi;
            hi = apr_hash_next(hi))
    {
      ...
      text_base_path = svn_dirent_join(text_base_dir, text_base_basename,
                                       iterpool);
# 1104 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (logfile_on_disk == svn_node_file)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1203), (svn_error_create))(SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 1230 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  do { svn_error_t *svn_err__temp = (svn_wc__read_entries_old(&entries, dir_abspath, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1260 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  if (start_format < 12 )
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1326), (svn_error_createf))(SVN_ERR_WC_UPGRADE_REQUIRED, ((void*)0),
...
# 1354 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
      ...
      case 17:
        ...
        *result_format = 18;
# 1435 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
    }
# 1449 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1549 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
