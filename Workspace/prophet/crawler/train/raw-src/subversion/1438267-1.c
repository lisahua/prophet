# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/diff_summarize.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/diff_summarize.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/diff_summarize.c"
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/diff_summarize.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/diff_summarize.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/diff_summarize.c" 2
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/diff_summarize.c" 2
...
send_summary(struct summarize_baton_t *b,
             ...
             apr_pool_t *scratch_pool)
{
  svn_client_diff_summarize_t *sum = memset(apr_palloc(scratch_pool, sizeof(*sum)), 0, sizeof(*sum));

  do { if (!(summarize_kind != svn_client_diff_summarize_kind_normal || prop_changed)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/diff_summarize.c", 68, "summarize_kind != svn_client_diff_summarize_kind_normal || prop_changed")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (b->summarize_func(sum, b->summarize_func_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return 0;
}
               ...
               apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (send_summary(b, path, svn_client_diff_summarize_kind_deleted, 0, svn_node_dir, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (send_summary(b, path, svn_client_diff_summarize_kind_deleted, 0, svn_node_file, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              apr_pool_t *scratch_pool)
{
  ...
  prop_change = apr_hash_get(b->prop_changes, path, (-1)) != ((void*)0);
  if (dir_was_added || prop_change)
    do { svn_error_t *svn_err__temp = (send_summary(b, path, dir_was_added ? svn_client_diff_summarize_kind_added : svn_client_diff_summarize_kind_normal, prop_change, svn_node_dir, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (send_summary(b, path, svn_client_diff_summarize_kind_added, props_changed(propchanges, scratch_pool), svn_node_file, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  struct summarize_baton_t *b = diff_baton;
  svn_boolean_t text_change = (tmpfile2 != ((void*)0));
  svn_boolean_t prop_change = props_changed(propchanges, scratch_pool);

  if (text_change || prop_change)
    do { svn_error_t *svn_err__temp = (send_summary(b, path, text_change ? svn_client_diff_summarize_kind_modified : svn_client_diff_summarize_kind_normal, prop_change, svn_node_file, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  if (props_changed(propchanges, scratch_pool))
    apr_hash_set(b->prop_changes, path, (-1), path);
