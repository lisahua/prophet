...
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 90 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
struct edit_baton
{
               ...
               apr_pool_t *pool)
{
  ...
  do { if (!(!path || pb)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c", 188, "!path || pb"); abort(); } } while (0);
...
# 226 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
          ...
          if (!eb->verify && cmp_rev < eb->oldest_dumped_rev
              && eb->notify_func)
            {
              ...
              notify->warning = apr_psprintf(
                     pool,
                     dcgettext ("subversion", "WARNING: Referencing data in revision %ld," " which is older than the oldest\n" "WARNING: dumped revision (%ld).  Loading this dump" " into an empty repository\n" "WARNING: will fail.\n", 5),
              ...
              if (apr_hash_count(old_mergeinfo))
                {
                  ...
                  notify->warning = apr_psprintf(
                    pool,
                    dcgettext ("subversion", "WARNING: Mergeinfo referencing revision(s) prior " "to the oldest dumped revision (%ld).\n" "WARNING: Loading this dump may result in invalid " "mergeinfo.\n", 5),
...
# 877 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
                   ...
                   apr_pool_t *pool)
{
  ...
  if (start_rev > end_rev)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",978), (svn_error_createf))(SVN_ERR_REPOS_BAD_ARGS, ((void*)0),
                             dcgettext ("subversion", "Start revision %ld" " is greater than end revision %ld", 5),

                             start_rev, end_rev);
  if (end_rev > youngest)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",983), (svn_error_createf))(SVN_ERR_REPOS_BAD_ARGS, ((void*)0),
...
# 1085 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
        }
      else
        {
  ...
  if (notify_func)
    {
      ...
      if (found_old_reference)
        {
          notify->warning = dcgettext ("subversion", "WARNING: The range of revisions dumped " "contained references to\n" "WARNING: copy sources outside that " "range.\n", 5);
      ...
      if (found_old_mergeinfo)
        {
          notify->warning = dcgettext ("subversion", "WARNING: The range of revisions dumped " "contained mergeinfo\n" "WARNING: which reference revisions outside " "that range.\n", 5);
...
# 1164 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
                       ...
                       void *val, apr_pool_t *pool)
{
  ...
  case svn_node_file:
    ...
    break;
  default:
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",1187), (svn_error_createf))(SVN_ERR_NODE_UNEXPECTED_KIND, ((void*)0),
                     ...
                     apr_pool_t *pool)
{
  ...
  if (start_rev > end_rev)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",1234), (svn_error_createf))(SVN_ERR_REPOS_BAD_ARGS, ((void*)0),
                             dcgettext ("subversion", "Start revision %ld" " is greater than end revision %ld", 5),

                             start_rev, end_rev);
  if (end_rev > youngest)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c",1239), (svn_error_createf))(SVN_ERR_REPOS_BAD_ARGS, ((void*)0),
                             dcgettext ("subversion", "End revision %ld is invalid " "(youngest revision is %ld)", 5),
