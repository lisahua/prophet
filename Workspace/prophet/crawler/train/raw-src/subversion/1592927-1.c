# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c" 2
...
svn_diff_close_patch_file(svn_patch_file_t *patch_file,
                          apr_pool_t *scratch_pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c" 2
...
svn_opt_print_help(apr_getopt_t *os,
                   ...
                   const char *footer,
                   apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c" 2
...
svn_token__from_mem(const svn_token_map_t *map,
                    const char *word,
                    apr_size_t len);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c" 2
         ...
         apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_diff_file_diff3_2(&diff, original, modified, latest, svn_diff_file_options_create(pool), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  *has_changes = svn_diff_contains_diffs(diff);

  do { svn_error_t *svn_err__temp = (svn_diff_file_output_merge2(ostream, diff, original, modified, latest, conflict_original, conflict_modified, conflict_latest, "=======", conflict_style, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 63 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/diff/diff3.c"
  return ((void*)0);
}
...
int main(int argc, const char *argv[])
{
  ...
  apr_getopt_t *opts;
  svn_boolean_t help = 0;

  enum {
    conflict_style_opt = 256
  };
  ...
  const char *conflict_original = ((void*)0);
  const char *conflict_modified = ((void*)0);
  const char *conflict_latest = ((void*)0);
      ...
      switch (opt)
        ...
        case 'L':
          if (!conflict_modified)
            conflict_modified = apr_pstrcat(pool, "<<<<<<< ", arg, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
          else if (!conflict_original)
            conflict_original = apr_pstrcat(pool, "||||||| ", arg, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
          else if (!conflict_latest)
            conflict_latest = apr_pstrcat(pool, ">>>>>>> ", arg, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
          else
            svn_err = svn_error_create(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                                       "too many lables");
          break;
        case 'E':
        case 'm':
  ...
  if (svn_err)
    {
      svn_handle_error2(svn_err, stdout, 0, "diff3: ");
