# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c"
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2
...
apr_status_t apr_password_validate(const char *passwd,
                                                const char *hash);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2
...
svn_checksum__from_digest(const unsigned char *digest,
                          svn_checksum_kind_t kind,
                          apr_pool_t *result_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2
...
svn_ctype_casecmp(int a,
                  int b);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sha1.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/sha1.h"
const unsigned char *
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2
...
svn_md5__digests_match(const unsigned char d1[],
                        const unsigned char d2[]);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c" 2
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c"
static svn_error_t *
  ...
  switch (kind)
    {
      ...
      case svn_checksum_sha1:
        checksum = memset(apr_palloc(pool, sizeof(*checksum) + ((kind) == svn_checksum_md5 ? 16 : (kind) == svn_checksum_sha1 ? 20 : 0)), 0, sizeof(*checksum) + ((kind) == svn_checksum_md5 ? 16 : (kind) == svn_checksum_sha1 ? 20 : 0));
                          ...
                          apr_pool_t *result_pool)
{
  ...
  memcpy((unsigned char *)checksum->digest, digest, ((kind) == svn_checksum_md5 ? 16 : (kind) == svn_checksum_sha1 ? 20 : 0));
  return checksum;
}
...
svn_checksum_clear(svn_checksum_t *checksum)
{
  do { svn_error_t *svn_err__temp = (validate_kind(checksum->kind)); if (svn_err__temp) return (svn_err__temp); } while (0);

  memset((unsigned char *) checksum->digest, 0, ((checksum->kind) == svn_checksum_md5 ? 16 : (checksum->kind) == svn_checksum_sha1 ? 20 : 0));
  return 0;
}
                         ...
                         apr_pool_t *scratch_pool)
{
  ...
  do { if (!(strlen(data) > 6)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/checksum.c", 181, "strlen(data) > 6")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  ckind = (data[1] == 'm' ? svn_checksum_md5 : svn_checksum_sha1);
  do { svn_error_t *svn_err__temp = (svn_checksum_parse_hex(&parsed_checksum, ckind, data + 6, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                       ...
                       apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (validate_kind(kind)); if (svn_err__temp) return (svn_err__temp); } while (0);

  *checksum = svn_checksum_create(kind, pool);
  digest = (char *)(*checksum)->digest;
  len = ((kind) == svn_checksum_md5 ? 16 : (kind) == svn_checksum_sha1 ? 20 : 0);
...
svn_checksum_size(const svn_checksum_t *checksum)
{
  return ((checksum->kind) == svn_checksum_md5 ? 16 : (checksum->kind) == svn_checksum_sha1 ? 20 : 0);
}
