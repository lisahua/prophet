...
svn_wc__run_xml_log(svn_wc__db_t *db,
                    ...
                    apr_size_t log_len,
                    apr_pool_t *scratch_pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c" 2
...
# 120 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  ...
  *all_wcprops = apr_hash_make(result_pool);
  ...
  for (hi = apr_hash_first(scratch_pool, dirents);
       ...
       hi = apr_hash_next(hi))
    {
      ...
      do { if (!(wcprops != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c", 190, "wcprops != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  while (1729)
    {
      ...
      if (eof)
        {
          if (line->len > 0)
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",241), (svn_error_createf))
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  if (entry->repos == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",551), (svn_error_createf))(
  ...
  if (entry->uuid == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",558), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
   ...
   if (entry->url == ((void*)0))
     return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",565), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 838 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
...
migrate_props(const char *wcroot_abspath,
              ...
              apr_pool_t *scratch_pool)
{
# 997 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  const apr_array_header_t *children;
  apr_pool_t *iterpool = svn_pool_create_ex(scratch_pool, ((void*)0));
  int i;
  ...
  for (hi = apr_hash_first(scratch_pool, dirents); hi;
            hi = apr_hash_next(hi))
    {
      ...
      text_base_path = svn_dirent_join(text_base_dir, text_base_basename,
                                       iterpool);
# 1088 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1163 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (logfile_on_disk == svn_node_file)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1187), (svn_error_create))(SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 1214 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  do { svn_error_t *svn_err__temp = (svn_wc__read_entries_old(&entries, dir_abspath, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1244 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1283 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  if (start_format < 12 )
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1313), (svn_error_createf))(SVN_ERR_WC_UPGRADE_REQUIRED, ((void*)0),
...
# 1341 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
        *result_format = 13;
      ...
      case 15:
        ...
        *result_format = 16;
# 1414 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
    }
...
# 1517 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
