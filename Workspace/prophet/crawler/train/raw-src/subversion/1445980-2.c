...
# 55 "./subversion/include/svn_path.h"
...
svn_path_resolve_repos_relative_url(const char **absolute_url,
                                    ...
                                    apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sorts.c" 2
...
# 64 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sorts.c"
int
svn_sort_compare_items_as_paths(const svn_sort__item_t *a,
                                const svn_sort__item_t *b)
{
  ...
  astr = a->key;
  bstr = b->key;
  ((astr[a->klen] == '\0') ? (void) (0) : __assert_fail ("astr[a->klen] == '\\0'", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sorts.c", 72, __PRETTY_FUNCTION__));
  ((bstr[b->klen] == '\0') ? (void) (0) : __assert_fail ("bstr[b->klen] == '\\0'", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sorts.c", 73, __PRETTY_FUNCTION__));
...
# 188 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sorts.c"
static int
                    ...
                    int (*compare_func)(const void *, const void *))
{
  ...
  ((lower == upper + 1) ? (void) (0) : __assert_fail ("lower == upper + 1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sorts.c", 209, __PRETTY_FUNCTION__));
                       ...
                       int insert_index)
{
  ...
  ((0 <= insert_index && insert_index <= array->nelts) ? (void) (0) : __assert_fail ("0 <= insert_index && insert_index <= array->nelts", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sorts.c", 232, __PRETTY_FUNCTION__));
