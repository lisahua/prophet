# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c" 2
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c" 2
...
svn_error_t *svn_io_start_cmd2(apr_proc_t *cmd_proc,
                               ...
                               apr_file_t *errfile,
                               apr_pool_t *pool);
# 1535 "./subversion/include/svn_io.h"
svn_error_t *
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c" 2
...
test_error_root_cause(apr_pool_t *pool)
{
  ...
  err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",44), (svn_error_create))(root_cause_err_code, ((void*)0), "root cause");
  for (i = 0; i < 2; i++)
    err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",46), (svn_error_create))(secondary_err_codes[i], err, ((void*)0));
  ...
  if (root_err == ((void*)0))
    {
      svn_error_clear(err);
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",54), (svn_error_createf))(SVN_ERR_TEST_FAILED, ((void*)0),
  ...
  for (i = 0; i < 2; i++)
    {
      if (root_err->apr_err == secondary_err_codes[i])
        {
          svn_error_clear(err);
          return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",64), (svn_error_createf))(SVN_ERR_TEST_FAILED, ((void*)0),
  ...
  if (root_err->apr_err != root_cause_err_code)
    {
      svn_error_clear(err);
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",73), (svn_error_createf))(SVN_ERR_TEST_FAILED, ((void*)0),
...
test_error_purge_tracing(apr_pool_t *pool)
{
  ...
  if (0 != svn_error_purge_tracing(0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",88), (svn_error_create))(SVN_ERR_TEST_FAILED, ((void*)0),
                            "svn_error_purge_tracing() didn't return "
                            "SVN_NO_ERROR after being passed a "
                            "SVN_NO_ERROR.");

  err = ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",93), (svn_error_create))(SVN_ERR_BASE, ((void*)0), "root error"));
  if (! svn_error__is_tracing_link(err))
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",96), (svn_error_create))(SVN_ERR_TEST_FAILED, err,
                              "The top error is not a tracing link:");
    }
  err = ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",99), (svn_error_create))(SVN_ERR_BASE, err, "other error"));
  if (! svn_error__is_tracing_link(err))
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",102), (svn_error_create))(SVN_ERR_TEST_FAILED, err,
                              "The top error is not a tracing link:");
    }
  ...
  for (child = err2; child; child = child->child)
    if (svn_error__is_tracing_link(child))
      {
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",110), (svn_error_create))(SVN_ERR_TEST_FAILED, err,
...
struct svn_test_descriptor_t test_funcs[] =
  {
    {0},
    {svn_test_pass, test_error_root_cause, ((void*)0), "test svn_error_root_cause"},

    {svn_test_pass, test_error_purge_tracing, ((void*)0), "test svn_error_purge_tracing"},
