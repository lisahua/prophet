...
svn_fs_fs__get_rep_reference(representation_t **rep,
                             ...
                             svn_checksum_t *checksum,
                             apr_pool_t *pool);
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.h"
svn_error_t *
...
static const char * const statements[] = { "PRAGMA AUTO_VACUUM = 1; " "CREATE TABLE rep_cache ( " "  hash TEXT NOT NULL PRIMARY KEY, " "  revision INTEGER NOT NULL, " "  offset INTEGER NOT NULL, " "  size INTEGER NOT NULL, " "  expanded_size INTEGER NOT NULL " "  ); " "PRAGMA USER_VERSION = 1; " "", "SELECT revision, offset, size, expanded_size " "FROM rep_cache " "WHERE hash = ?1 " "", "INSERT OR FAIL INTO rep_cache (hash, revision, offset, size, expanded_size) " "VALUES (?1, ?2, ?3, ?4, ?5) " "", "SELECT hash, revision, offset, size, expanded_size " "FROM rep_cache " "", ((void*)0) };
                  ...
                  apr_pool_t *pool)
{
  ...
  do { if (!(rep)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 57, "rep")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 83 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c"
static svn_error_t *
               ...
               apr_pool_t *pool)
{
  ...
  db_path = svn_dirent_join(fs->path, "rep-cache.db", pool);
                              ...
                              apr_pool_t *pool)
{
  ...
  do { if (!(ffd->format >= 4)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 137, "ffd->format >= SVN_FS_FS__MIN_REP_SHARING_FORMAT")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  while (have_row)
    {
      ...
      do { svn_error_t *svn_err__temp = (walker(rep, fs, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                             ...
                             apr_pool_t *pool)
{
  ...
  do { if (!(ffd->rep_sharing_allowed)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 195, "ffd->rep_sharing_allowed")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  if (! ffd->rep_cache_db)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__open_rep_cache(fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                             ...
                             apr_pool_t *pool)
{
  ...
  do { if (!(ffd->rep_sharing_allowed)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 238, "ffd->rep_sharing_allowed")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  if (! ffd->rep_cache_db)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__open_rep_cache(fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
