...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
...
# 87 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
...
# 131 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
static __inline__ svn_error_t *
  ...
  if (ch == 0xEF)
    {
      ...
      do { if (!(ctx->buffer_size > ctx->buffer_pos + 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c", 227, "ctx->buffer_size > ctx->buffer_pos + 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 367 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
static svn_error_t *
...
{
  *path_p = ((void*)0);
# 436 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
...
# 746 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "###                              Pipelining is enabled by default." "\n"
        "###                              The only known case where it should"
                                                                             "\n"
        "###                              be disabled is when the server" "\n"
        "###                              triggers SSL renegotiations in the""\n"
        "###                              middle of HTTP traffic, resulting" "\n"
        "###                              in SSL communication errors." "\n"
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "# password-stores =" "\n"
# 1191 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
        "###" "\n"
...
# 1418 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  {
