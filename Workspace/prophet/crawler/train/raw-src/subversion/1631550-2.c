# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c"
# 1 "./subversion/include/svn_sorts.h" 1
# 31 "./subversion/include/svn_sorts.h"
...
# 32 "./subversion/include/svn_sorts.h" 2
...
# 33 "./subversion/include/svn_sorts.h" 2
...
# 34 "./subversion/include/svn_sorts.h" 2
...
# 35 "./subversion/include/svn_sorts.h" 2
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.h"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.h" 2
...
svn_error_t *svn_fs_fs__verify(svn_fs_t *fs,
                               ...
                               void *cancel_baton,
                               apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
svn_fs_fs__get_changes(apr_array_header_t **changes,
                       ...
                       svn_revnum_t rev,
                       apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
svn_fs_fs__lock_rep_cache(svn_fs_t *fs,
                          apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
svn_fs_fs__use_log_addressing(svn_fs_t *fs,
                              svn_revnum_t rev);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
svn_fs_fs__deserialize_p2l_page(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c" 2
              ...
              apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__check_rep(rep, fs, &walker_baton->hint, walker_baton->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                         ...
                         apr_pool_t *pool)
{
  ...
  svn_fs_fs__revision_file_t *rev_file;
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open_pack_or_rev_file(&rev_file, fs, start, pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_fs_fs__l2p_get_max_ids(&max_ids, fs, start, count, pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < max_ids->nelts; ++i)
    {
      apr_uint64_t k;
      apr_uint64_t max_id = (((apr_uint64_t *)(max_ids)->elts)[i]);
      ...
      for (k = 0; k < max_id; ++k)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_fs_fs__item_offset(&offset, fs, rev_file, revision, ((void*)0), k, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          if (offset == -1)
            continue;


          do { svn_error_t *svn_err__temp = (svn_fs_fs__p2l_entry_lookup(&p2l_entry, fs, rev_file, revision, offset, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (p2l_entry == ((void*)0))
            return svn_error_createf(SVN_ERR_FS_INDEX_INCONSISTENT,
                                     ((void*)0),
                                     dcgettext ("subversion", "p2l index entry not found for " "PHYS %s returned by " "l2p index for LOG r%ld:i%ld", 5),
          ...
          if ( p2l_entry->item.number != k
            ...
            return svn_error_createf(SVN_ERR_FS_INDEX_INCONSISTENT,
                                     ((void*)0),
                                     dcgettext ("subversion", "p2l index info LOG r%ld:i%ld" " does not match " "l2p index for LOG r%ld:i%ld", 5),
...
# 252 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c"
static svn_error_t *
                         ...
                         apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__p2l_get_max_offset(&max_offset, fs, rev_file, start, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (offset = 0; offset < max_offset; )
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__p2l_index_lookup(&entries, fs, rev_file, start, offset, ffd->p2l_page_size, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (entries->nelts == 0)
        return svn_error_createf(SVN_ERR_FS_INDEX_CORRUPTION,
                                 ((void*)0),
                                 dcgettext ("subversion", "p2l does not cover offset %s" " for revision %ld", 5),
          ...
          if (entry->type == 0)
            {
              ...
              if ( entry->item.revision != ((svn_revnum_t) -1)
                ...
                return svn_error_createf(SVN_ERR_FS_INDEX_INCONSISTENT,
                                         ((void*)0),
                                         dcgettext ("subversion", "Empty P2L entry for PHYS %s " "refers to revision %ld outside " "the rev / pack file (%ld-%ld)", 5),
            ...
            {
              apr_off_t l2p_offset;
              do { svn_error_t *svn_err__temp = (svn_fs_fs__item_offset(&l2p_offset, fs, rev_file, entry->item.revision, ((void*)0), entry->item.number, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              if (l2p_offset != entry->offset)
                return svn_error_createf(SVN_ERR_FS_INDEX_INCONSISTENT,
                                         ((void*)0),
                                         dcgettext ("subversion", "l2p index entry PHYS %s" "does not match p2l index value " "LOG r%ld:i%ld for PHYS %s", 5),
...
# 362 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c"
static svn_error_t *
                  ...
                  apr_pool_t *pool)
{
  union
  {
    ...
    apr_uint64_t chunks[4096 / sizeof(apr_uint64_t)];
  } data;

  apr_size_t i;
  do { if (!(size <= 4096)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c", 374, "size <= STREAM_THRESHOLD")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  data.chunks[(size - 1)/ sizeof(apr_uint64_t)] = 0;
  do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(file, data.buffer, size, ((void*)0), ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    if (data.buffer[i] != 0)
      {
        ...
        do { svn_error_t *svn_err__temp = (svn_io_file_name_get(&file_name, file, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        return svn_error_createf(SVN_ERR_FS_CORRUPT, ((void*)0),
                                 dcgettext ("subversion", "Empty section in file %s contains " "non-NUL data at offset %s", 5),
             ...
             apr_pool_t *pool)
{
  for (; size >= 4096; size -= 4096)
    do { svn_error_t *svn_err__temp = (expect_buffer_nul(file, 4096, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (size)
    do { svn_error_t *svn_err__temp = (expect_buffer_nul(file, size, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (actual != entry->fnv1_checksum)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_name_get(&file_name, file, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      return svn_error_createf(SVN_ERR_FS_CORRUPT, ((void*)0),
                               dcgettext ("subversion", "Checksum mismatch in item at offset %s of " "length %s bytes in file %s", 5),
...
{
  unsigned char buffer[4096];
  do { if (!(entry->size <= 4096)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c", 457, "entry->size <= STREAM_THRESHOLD")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(file, buffer, (apr_size_t)entry->size, ((void*)0), ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (expected_checksum(file, entry, svn__fnv1a_32x4(buffer, (apr_size_t)entry->size), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *pool)
{
  ...
  while (size > 0)
    {
      apr_size_t to_read = size > sizeof(buffer)
                         ? sizeof(buffer)
                         : (apr_size_t)size;
      do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(file, buffer, to_read, ((void*)0), ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (expected_checksum(file, entry, (__extension__ ({ unsigned int __v, __x = (*(const apr_uint32_t *)checksum->digest); if (__builtin_constant_p (__x)) __v = ((((__x) & 0xff000000) >> 24) | (((__x) & 0x00ff0000) >> 8) | (((__x) & 0x0000ff00) << 8) | (((__x) & 0x000000ff) << 24)); else __asm__ ("bswap %0" : "=r" (__v) : "0" (__x)); __v; })), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  return 0;
}
# 509 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c"
static svn_error_t *
                   ...
                   apr_pool_t *pool)
{
  ...
  if (rev_file->l2p_offset != max_offset)
    return svn_error_createf(SVN_ERR_FS_INDEX_INCONSISTENT, ((void*)0),
                             dcgettext ("subversion", "File size of %s for revision r%ld does " "not match p2l index size of %s", 5),

                             apr_off_t_toa(pool, rev_file->l2p_offset), start,
                             apr_off_t_toa(pool, max_offset));

  do { svn_error_t *svn_err__temp = (svn_io_file_aligned_seek(rev_file->file, ffd->block_size, ((void*)0), 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (offset = 0; offset < max_offset; )
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_aligned_seek(rev_file->file, ffd->block_size, ((void*)0), offset, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (i = 0; i < entries->nelts; ++i)
        {
          ...
          if (entry->offset != offset)
            return svn_error_createf(SVN_ERR_FS_INDEX_INCONSISTENT,
                                     ((void*)0),
                                     dcgettext ("subversion", "p2l index entry for revision r%ld" " is non-contiguous between offsets " " %s and %s", 5),
          ...
          if (entry->type == 0)
            {
              ...
              if (entry->offset != max_offset)
                do { svn_error_t *svn_err__temp = (read_all_nul(rev_file->file, entry->size, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
          else
            {
              if (entry->size < 4096)
                do { svn_error_t *svn_err__temp = (expected_buffered_checksum(rev_file->file, entry, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

              else
                do { svn_error_t *svn_err__temp = (expected_streamed_checksum(rev_file->file, entry, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 633 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/verify.c"
static svn_error_t *
  ...
  for (revision = start; revision <= end; revision = next_revision)
    {
      ...
      if (err)
        do { svn_error_t *svn_err__temp = (svn_fs_fs__read_min_unpacked_rev(&ffd->min_unpacked_rev, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__ensure_revision_exists(start, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_fs_fs__ensure_revision_exists(end, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  if (svn_fs_fs__use_log_addressing(fs, end))
    do { svn_error_t *svn_err__temp = (verify_index_consistency(fs, ((start) < (ffd->min_log_addressing_rev) ? (ffd->min_log_addressing_rev) : (start)), end, notify_func, notify_baton, cancel_func, cancel_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (ffd->format >= 4)
    do { svn_error_t *svn_err__temp = (verify_rep_cache(fs, start, end, notify_func, notify_baton, cancel_func, cancel_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
