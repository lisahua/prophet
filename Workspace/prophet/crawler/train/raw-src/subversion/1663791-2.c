  ...
  return apr_pstrcat(pool, "^/",
                     svn_path_uri_encode(
                         svn_uri_skip_ancestor(info->repos_root_URL,
                                               info->URL, pool),
                         pool), ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
}
...
static const info_item_map_t info_item_map[] =
  {
    { { "kind", sizeof("kind") - 1 }, info_item_kind },
    { { "url", sizeof("url") - 1 }, info_item_url },
    { { "relative-url", sizeof("relative-url") - 1 }, info_item_relative_url },
    { { "repos-root-url", sizeof("repos-root-url") - 1 }, info_item_repos_root_url },
    { { "repos-uuid", sizeof("repos-uuid") - 1 }, info_item_repos_uuid },
    { { "revision", sizeof("revision") - 1 }, info_item_revision },
    { { "last-changed-revision", sizeof("last-changed-revision") - 1 },
                                          info_item_last_changed_rev },
    { { "last-changed-date", sizeof("last-changed-date") - 1 }, info_item_last_changed_date },
    { { "last-changed-author", sizeof("last-changed-author") - 1 }, info_item_last_changed_author },
    { { "wc-root", sizeof("wc-root") - 1 }, info_item_wc_root }
  };
  ...
  switch (svn_cl__similarity_check(keyword, keywords,
    ...
    case 1:
      ...
      return svn_error_createf(
          ...
          dcgettext ("subversion", "'%s' is not a valid value for --show-item", 5),
          keyword);
    ...
    case 2:
      ...
      return svn_error_createf(
          SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
          dcgettext ("subversion", "'%s' is not a valid value for --show-item;" " did you mean '%s'?", 5),
    ...
    case 3:
      ...
      return svn_error_createf(
          SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
          dcgettext ("subversion", "'%s' is not a valid value for --show-item;" " did you mean '%s' or '%s'?", 5),
    ...
    default:
      ...
      return svn_error_createf(
          SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
          dcgettext ("subversion", "'%s' is not a valid value for --show-item;" " did you mean '%s', '%s' or '%s'?", 5),
      ...
      for (i = 0; i < info->wc_info->conflicts->nelts; i++)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_cl__append_conflict_info_xml(sb, conflict, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
    }
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Path: %s\n", 5), svn_cl__local_style_skip_ancestor( receiver_baton->path_prefix, target, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (info->wc_info)
    {
      ...
      if (info->wc_info->moved_from_abspath)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Moved From: %s\n", 5), svn_cl__local_style_skip_ancestor( receiver_baton->path_prefix, info->wc_info->moved_from_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (info->wc_info->moved_to_abspath)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Moved To: %s\n", 5), svn_cl__local_style_skip_ancestor( receiver_baton->path_prefix, info->wc_info->moved_to_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (info->wc_info)
    {
      ...
      if (info->wc_info->conflicts)
        {
          svn_boolean_t printed_prop_conflict_file = 0;
          svn_boolean_t printed_tc = 0;
          int i;
              ...
              switch (conflict->kind)
                {
                  case svn_wc_conflict_kind_text:
                    if (conflict->base_abspath)
                      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Conflict Previous Base File: %s\n", 5), svn_cl__local_style_skip_ancestor( receiver_baton->path_prefix, conflict->base_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    if (conflict->my_abspath)
                      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Conflict Previous Working File: %s\n", 5), svn_cl__local_style_skip_ancestor( receiver_baton->path_prefix, conflict->my_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    if (conflict->their_abspath)
                      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Conflict Current Base File: %s\n", 5), svn_cl__local_style_skip_ancestor( receiver_baton->path_prefix, conflict->their_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  case svn_wc_conflict_kind_property:
                    if (! printed_prop_conflict_file)
                      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Conflict Properties File: %s\n", 5), svn_cl__local_style_skip_ancestor( receiver_baton->path_prefix, conflict->prop_reject_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);





                    printed_prop_conflict_file = (!0);
                  break;
...

          {
            ...
            const svn_wc_conflict_description2_t *conflict =
                  (((const svn_wc_conflict_description2_t * *)(info->wc_info->conflicts)->elts)[0]);
            ...
            if (!printed_tc)
              {
                ...
                do { svn_error_t *svn_err__temp = (svn_cl__get_human_readable_action_description(&desc, svn_wc_conflict_action_edit, conflict->operation, conflict->node_kind, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




                do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%s: %s\n", dcgettext ("subversion", "Conflict Details", 5), desc)); if (svn_err__temp) return (svn_err__temp); } while (0);
                       ...
                       apr_pool_t *pool)
{
  if (text)
    {
      if (target_path)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%-10s %s", text, target_path)); if (svn_err__temp) return (svn_err__temp); } while (0);
      else
        do { svn_error_t *svn_err__temp = (svn_cmdline_fputs(text, stdout, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else if (target_path)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%-10s %s", "", target_path)); if (svn_err__temp) return (svn_err__temp); } while (0);
                         ...
                         apr_pool_t *pool)
{
  if (((rev) >= 0))
    {
      if (target_path)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%-10ld %s", rev, target_path)); if (svn_err__temp) return (svn_err__temp); } while (0);
      else
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%-10ld", rev)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else if (target_path)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%-10s %s", "", target_path)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  switch (receiver_baton->print_what)
    {
    case info_item_kind:
      do { svn_error_t *svn_err__temp = (print_info_item_string(svn_node_kind_to_word(info->kind), target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case info_item_url:
      do { svn_error_t *svn_err__temp = (print_info_item_string(info->URL, target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case info_item_relative_url:
      do { svn_error_t *svn_err__temp = (print_info_item_string(relative_url(info, pool), target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case info_item_repos_root_url:
      do { svn_error_t *svn_err__temp = (print_info_item_string(info->repos_root_URL, target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case info_item_repos_uuid:
      do { svn_error_t *svn_err__temp = (print_info_item_string(info->repos_UUID, target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case info_item_revision:
      do { svn_error_t *svn_err__temp = (print_info_item_revision(info->rev, target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case info_item_last_changed_rev:
      do { svn_error_t *svn_err__temp = (print_info_item_revision(info->last_changed_rev, target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case info_item_last_changed_date:
      do { svn_error_t *svn_err__temp = (print_info_item_string( (!info->last_changed_date ? ((void*)0) : svn_time_to_cstring(info->last_changed_date, pool)), target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case info_item_last_changed_author:
      do { svn_error_t *svn_err__temp = (print_info_item_string(info->last_changed_author, target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      break;

    case info_item_wc_root:
      do { svn_error_t *svn_err__temp = (print_info_item_string( (info->wc_info && info->wc_info->wcroot_abspath ? info->wc_info->wcroot_abspath : ((void*)0)), target_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    default:
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c", 845, ((void*)0))); } while (0);
    }

  receiver_baton->start_new_line = (!0);
  return 0;
}
  ...
  if (opt_state->xml)
    {
      ...
      if (opt_state->show_item)
        return svn_error_create(
            SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
            dcgettext ("subversion", "--show-item is not valid in --xml mode", 5));
      if (opt_state->no_newline)
        return svn_error_create(
            SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
            dcgettext ("subversion", "--no-newline is not valid in --xml mode", 5));
  ...
  else if (opt_state->show_item)
    {
      ...
      if (opt_state->incremental)
        return svn_error_create(
            SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
            dcgettext ("subversion", "--incremental is only valid in --xml mode", 5));
      ...
      if (receiver_baton.multiple_targets && opt_state->no_newline)
        return svn_error_create(
            SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
            dcgettext ("subversion", "--no-newline is only available for single-target," " non-recursive info operations", 5));


      do { svn_error_t *svn_err__temp = (find_print_what(opt_state->show_item, &receiver_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      receiver_baton.start_new_line = 0;
    }
  else
    {
      ...
      if (opt_state->no_newline)
        return svn_error_create(
            SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
            dcgettext ("subversion", "--no-newline' is only valid with --show-item", 5));
    }

  if (opt_state->depth == svn_depth_unknown)
    opt_state->depth = svn_depth_empty;

  do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&receiver_baton.path_prefix, "", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (svn_path_is_url(truepath))
        {
          ...
          receiver_baton.target_is_path = 0;
        }
      else
        {
