...
struct svn_editor_t
{
  ...
  apr_pool_t *scratch_pool;
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
};
# 256 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
svn_error_t *
svn_editor_create(svn_editor_t **editor,
                  void *editor_baton,
                  svn_cancel_func_t cancel_func,
...
# 278 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  return 0;
}
                         ...
                         svn_revnum_t replaces_rev)
{
  ...
  do { if (!(svn_relpath_is_canonical(relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 471, "svn_relpath_is_canonical(relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(children != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 472, "children != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 473, "props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (check_cancel(editor)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      err = editor->funcs.cb_add_directory(editor->baton, relpath, children,
                          ...
                          ;
                                 ...
                                 ;
                                     ;
                                   ;
# 510 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
                    ...
                    svn_revnum_t replaces_rev)
{
  ...
  do { if (!(svn_relpath_is_canonical(relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 525, "svn_relpath_is_canonical(relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(checksum != ((void*)0) && checksum->kind == svn_checksum_sha1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 527, "checksum != NULL && checksum->kind == SVN_EDITOR_CHECKSUM_KIND")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { if (!(contents != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 528, "contents != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 529, "props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                   ;
                                          ;
                                      ;
                       ...
                       svn_revnum_t replaces_rev)
{
  ...
  do { if (!(svn_relpath_is_canonical(relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 564, "svn_relpath_is_canonical(relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 565, "props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                   ;
                                          ;
                                      ;
                      ...
                      svn_revnum_t replaces_rev)
{
  ...
  do { if (!(svn_relpath_is_canonical(relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 598, "svn_relpath_is_canonical(relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                   ;
                                          ;
                                      ;
                           ...
                           apr_hash_t *props)
{
  ...
  do { if (!(svn_relpath_is_canonical(relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 632, "svn_relpath_is_canonical(relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(children != ((void*)0) || props != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 633, "children != NULL || props != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (editor->funcs.cb_alter_directory)
    {
      ...
      err = editor->funcs.cb_alter_directory(editor->baton,
                          ...
                          ;
                                 ...
                                 ;
                                     ;
# 673 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  apr_pool_clear(editor->scratch_pool);
  return (err);
}
                      ...
                      svn_stream_t *contents)
{
  ...
  do { if (!(svn_relpath_is_canonical(relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 688, "svn_relpath_is_canonical(relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!((checksum != ((void*)0) && contents != ((void*)0)) || (checksum == ((void*)0) && contents == ((void*)0)))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 690, "(checksum != NULL && contents != NULL) || (checksum == NULL && contents == NULL)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { if (!(props != ((void*)0) || checksum != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 691, "props != NULL || checksum != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  if (checksum)
    do { if (!(checksum->kind == svn_checksum_sha1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 693, "checksum->kind == SVN_EDITOR_CHECKSUM_KIND")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                     ;
                                          ;
                         ...
                         const char *target)
{
  ...
  do { if (!(svn_relpath_is_canonical(relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 727, "svn_relpath_is_canonical(relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(props != ((void*)0) || target != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 728, "props != NULL || target != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                     ;
                                          ;
                  ...
                  svn_revnum_t revision)
{
  ...
  do { if (!(svn_relpath_is_canonical(relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 760, "svn_relpath_is_canonical(relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                          ;
                                          ;
                                          ;
                ...
                svn_revnum_t replaces_rev)
{
  ...
  do { if (!(svn_relpath_is_canonical(src_relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 793, "svn_relpath_is_canonical(src_relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_relpath_is_canonical(dst_relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 794, "svn_relpath_is_canonical(dst_relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                       ;
                                              ;
                                              ;
                ...
                svn_revnum_t replaces_rev)
{
  ...
  do { if (!(svn_relpath_is_canonical(src_relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 829, "svn_relpath_is_canonical(src_relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_relpath_is_canonical(dst_relpath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c", 830, "svn_relpath_is_canonical(dst_relpath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                ;
                                              ;
                                       ;
                                              ;
                  ...
                  const apr_array_header_t *revisions)
{
  svn_error_t *err = 0;
                                ...
                                ;
# 883 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  do { svn_error_t *svn_err__temp = (check_cancel(editor)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 905 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/editor.c"
  apr_pool_clear(editor->scratch_pool);
  return (err);
}
