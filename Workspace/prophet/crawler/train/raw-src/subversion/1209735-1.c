      ...
      switch (action->action)
        {
          ...
          case ACTION_DELETE:
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_editor_delete(eb->editor, path, *revnum)); if (svn_err__temp) return (svn_err__temp); } while (0);
              break;
            }
          ...
          case ACTION_SET_TEXT:
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(&contents, src_path, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 305, ((void*)0))); } while (0);
        }
    }
  ...
  if (need_add)
    {
      if (kind == svn_kind_dir)
        {
          do { svn_error_t *svn_err__temp = (svn_editor_add_directory(eb->editor, path, children, props, ((svn_revnum_t) -1))); if (svn_err__temp) return (svn_err__temp); } while (0);

        }
      else
        {
          do { svn_error_t *svn_err__temp = (svn_editor_add_file(eb->editor, path, ((void*)0), contents, props, ((svn_revnum_t) -1))); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (props)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_editor_set_props(eb->editor, path, ((svn_revnum_t) -1), props, contents == ((void*)0))); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (contents)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_editor_set_text(eb->editor, path, ((svn_revnum_t) -1), ((void*)0), contents)); if (svn_err__temp) return (svn_err__temp); } while (0);
                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (eb->target_revision_func(eb->target_revision_baton, target_revision, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              void **root_baton)
{
  ...
  *root_baton = db;
  ...
  if (eb->start_edit)
    do { svn_error_t *svn_err__temp = (eb->start_edit(eb->start_edit_baton, base_revision, result_pool, &eb->root_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    void **handler_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_open_unique(&target, &target_path, ((void*)0), svn_io_file_del_on_pool_cleanup, fb->eb->edit_pool, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  *handler = window_handler;
  ...
  do { svn_error_t *svn_err__temp = (add_action(fb->eb, fb->path, ACTION_SET_TEXT, (void *)target_path)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                void **root_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (seb->deditor->open_root(seb->dedit_baton, base_revision, result_pool, root_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (seb->deditor->set_target_revision(seb->dedit_baton, target_revision, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 866 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 885, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (action == ACTION_DELETE)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 992, ((void*)0))); } while (0);
    }
...
ensure_root_opened(struct editor_baton *eb)
{
  if (!eb->root_opened)
    {
      do { svn_error_t *svn_err__temp = (eb->deditor->open_root(eb->dedit_baton, ((svn_revnum_t) -1), eb->edit_pool, &eb->root.baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (build(eb, ACTION_PROPSET, relpath, svn_kind_unknown, ((void*)0), ((svn_revnum_t) -1), props, ((void*)0), ((svn_revnum_t) -1), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            ...
            apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (build(eb, ACTION_PUT, relpath, svn_kind_file, ((void*)0), ((svn_revnum_t) -1), ((void*)0), tmp_filename, ((svn_revnum_t) -1), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(scratch_pool, operation->children);
       hi; hi = apr_hash_next(hi))
    {
      ...
      if (child->operation == OP_OPEN || child->operation == OP_PROPSET)
        {
          if (child->kind == svn_kind_dir)
            do { svn_error_t *svn_err__temp = (editor->open_directory(path, operation->baton, ((svn_revnum_t) -1), iterpool, &child->baton)); if (svn_err__temp) return (svn_err__temp); } while (0);


          else
            do { svn_error_t *svn_err__temp = (editor->open_file(path, operation->baton, ((svn_revnum_t) -1), iterpool, &file_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1556 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
  return 0;
}
