# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c"
...
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c" 2
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c" 2
...
# 35 "./subversion/include/svn_dso.h" 2
...
svn_dso_load(apr_dso_handle_t **dso,
             const char *libname);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c" 2
...
svn_mutex__unlock(svn_mutex__t *mutex,
                  svn_error_t *err);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/dso.c" 2


static svn_mutex__t *dso_mutex = ((void*)0);
...
svn_dso_initialize2(void)
{
  ...
  dso_pool = svn_pool_create_ex(((void*)0), ((void*)0));

  do { svn_error_t *svn_err__temp = (svn_mutex__init(&dso_mutex, 1, dso_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  *dso = apr_hash_get(dso_cache, fname, (-1));




  if (*dso == ((void *) &not_there_sentinel))
    {
      *dso = ((void*)0);
      return 0;
    }
...
{
  if (! dso_pool)
    do { svn_error_t *svn_err__temp = (svn_dso_initialize2()); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_mutex__t *m = (dso_mutex); svn_error_t *e = svn_mutex__lock(m); if (e) return (e); e = svn_mutex__unlock(m, (svn_dso_load_internal(dso, fname))); if (e) return (e); } while (0);;
