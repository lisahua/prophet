...
# 281 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 429 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
drop_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset != (18446744073709551615UL)) ? (void) (0) : __assert_fail ("entry->offset != (18446744073709551615UL)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 491, __PRETTY_FUNCTION__));
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == cache->current_data) ? (void) (0) : __assert_fail ("entry->offset == cache->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 553, __PRETTY_FUNCTION__));
...
# 659 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
...
# 791 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
      ...
      if (end - cache->current_data >= size)
        return (!0);
# 812 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (2 * drop_size > size)
        return 0;
...
# 877 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void* secure_aligned_alloc(apr_pool_t *pool,
                                  apr_size_t size,
                                  svn_boolean_t zero)
{
  char* memory = apr_palloc(pool, (apr_size_t)size + 16);
  if (memory != ((void*)0))
    {
      memory = (char *)((void*)(((apr_size_t)memory + 16 -1) & -16));
      if (zero)
...
# 901 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
svn_error_t *
svn_cache__membuffer_cache_create(svn_membuffer_t **cache,
                                  apr_size_t total_size,
                                  apr_size_t directory_size,
                                  ...
                                  apr_pool_t *pool)
{
  ...
  apr_uint32_t group_count;
  apr_uint64_t data_size;
# 928 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  ...
  for (seg = 0; seg < segment_count; ++seg)
    {
      ...
      ((c[seg].directory[0][0].offset == -1) ? (void) (0) : __assert_fail ("c[seg].directory[0][0].offset == -1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 1012, __PRETTY_FUNCTION__));
...
# 1051 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                    ...
                    apr_pool_t *pool)
{
  ...
  if ( item != ((void*)0)
      ...
      && ensure_data_insertable(cache, size))
    {
      ...
      entry->size = size;
      entry->offset = cache->current_data;
# 1106 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
                    ...
                    apr_pool_t *pool)
{
  ...
  buffer = (char *)((void*)(((apr_size_t)apr_palloc(pool, size + 16 -1) + 16 -1) & -16));
  memcpy(buffer, (const char*)cache->data + entry->offset, size);
# 1192 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  entry->hit_count++;
  cache->hit_count++;
  cache->total_hits++;
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      cache->hit_count++;
      cache->total_hits++;
# 1262 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->hit_count++;
      cache->total_writes++;
# 1332 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      ...
      if (data != orig_data)
        {
          ...
          if ( (cache->data_size / 4 > size)
              && ensure_data_insertable(cache, size))
            {
              ...
              insert_entry(cache, entry);
# 1364 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
            }
        }
    }
...
# 1391 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
typedef struct svn_membuffer_cache_t
{
  ...
  int alloc_counter;
# 1437 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
} svn_membuffer_cache_t;
# 1448 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void
...
# 1507 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 1613 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 1801 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
