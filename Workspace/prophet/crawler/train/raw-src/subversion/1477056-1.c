# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h" 2
...
svn_error_t *svn_config__parse_stream(svn_config_t *cfg,
                                      ...
                                      apr_pool_t *result_pool,
                                      apr_pool_t *scratch_pool);
# 151 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h"
svn_error_t *
svn_config__sys_config_path(const char **path_p,
                            const char *fname,
                            apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2

# 1 "./subversion/svn_private_config.h" 1
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c" 2
                 ...
                 apr_pool_t *result_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_config_create2(&cfg, section_names_case_sensitive, option_names_case_sensitive, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 126 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
...
# 176 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
static svn_error_t *
...
# 196 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
  if (sys_file_path)
    {
      if (red_config)
        do { svn_error_t *svn_err__temp = (svn_config_merge(*cfgp, sys_file_path, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
      else
        {
          do { svn_error_t *svn_err__temp = (svn_config_read3(cfgp, sys_file_path, 0, 0, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          red_config = (!0);
        }
    }
# 224 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
  if (usr_file_path)
    {
      if (red_config)
        do { svn_error_t *svn_err__temp = (svn_config_merge(*cfgp, usr_file_path, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
      else
        {
          do { svn_error_t *svn_err__temp = (svn_config_read3(cfgp, usr_file_path, 0, 0, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! red_config)
    do { svn_error_t *svn_err__temp = (svn_config_create2(cfgp, 0, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *pool)
{
  ...
  *cfg = ((void*)0);
  ...
  do { svn_error_t *svn_err__temp = (svn_config_get_user_config_path(&usr_cfg_path, config_dir, category, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                      ...
                      apr_pool_t *pool)
{
  ...
  *cfg_hash = apr_hash_make(pool);
  ...
  do { svn_error_t *svn_err__temp = (get_category_config(&cfg, config_dir, "servers", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (get_category_config(&cfg, config_dir, "config", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 svn_boolean_t must_exist)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_config_read3(&merge_cfg, file, must_exist, cfg->section_names_case_sensitive, cfg->option_names_case_sensitive, cfg->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (sec_ptr != ((void*)0) && option != ((void*)0))
    {
      ...
      if (opt == ((void*)0)
          && apr_strnatcasecmp(section, "DEFAULT") != 0)
  ...
  if (!opt->expanded)
    {
      ...
      if (opt->value && (__extension__ (__builtin_constant_p ('%') && !__builtin_constant_p (opt->value) && ('%') == '\0' ? (char *) __rawmemchr (opt->value, '%') : __builtin_strchr (opt->value, '%'))))
        {
...
# 525 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
static void
expand_option_value(svn_config_t *cfg, cfg_section_t *section,
                    const char *opt_value, const char **opt_x_valuep,
                    apr_pool_t *x_pool)
{
  ...
  while (parse_from != ((void*)0)
         && *parse_from != '\0'
         && (name_start = strstr(parse_from, "%(")) != ((void*)0))
    {
      name_start += (sizeof("%(") - 1);
      if (*name_start == '\0')
  ...
  if (cfg)
    {
      ...
      if (opt != ((void*)0))
        ...
        if (default_value && (__extension__ (__builtin_constant_p ('%') && !__builtin_constant_p (default_value) && ('%') == '\0' ? (char *) __rawmemchr (default_value, '%') : __builtin_strchr (default_value, '%'))))
          {
...
# 724 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
static svn_error_t *
  ...
  if (value == svn_tristate_true)
    ...
    *boolp = default_value;
    ...
    return svn_error_createf(SVN_ERR_BAD_CONFIG_VALUE, ((void*)0),
                             dcgettext ("subversion", "Config error: invalid boolean " "value '%s' for '[%s] %s'", 5),

                             input, section, option);
  else
    return svn_error_createf(SVN_ERR_BAD_CONFIG_VALUE, ((void*)0),
                             dcgettext ("subversion", "Config error: invalid boolean " "value '%s' for '%s'", 5),
                     ...
                     apr_int64_t default_value)
{
  ...
  if (tmp_value)
    return svn_cstring_strtoi64(valuep, tmp_value,
                                (-9223372036854775807L -1), (9223372036854775807L), 10);
...
{
  svn_config_set(cfg, section, option,
                 apr_psprintf(cfg->pool, "%" "ld", value));
}
                          ...
                          const char* default_value)
{
  ...
  if (tmp_value && (0 == svn_cstring_casecmp(tmp_value, "ASK")))
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (get_bool(&bool_val, tmp_value, 0, section, option)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  const char *retval;
  svn_config_get(cfg, &retval, "global",
                       ...
                       apr_pool_t *pool)
{
  ...
  *cfg_hash = apr_hash_make(pool);
       ...
       cidx = apr_hash_next(cidx))
  {
    ...
    do { svn_error_t *svn_err__temp = (svn_config_dup(&destconfig, srcconfig, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (*end_pos != 0)
        {
          return svn_error_createf
            (SVN_ERR_BAD_CONFIG_VALUE, ((void*)0),
             dcgettext ("subversion", "Config error: invalid integer value '%s'", 5),
             tmp_value);
        }
    }
