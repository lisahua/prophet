...
svn_fs_x__l2p_proto_index_add_revision(apr_file_t *proto_index,
                                       apr_pool_t *pool);
# 114 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/index.h"
svn_error_t *
...
svn_fs_x__p2l_index_create(svn_fs_t *fs,
                           ...
                           svn_revnum_t revision,
                           apr_pool_t *pool);
# 182 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/index.h"
svn_error_t *
                   ...
                   apr_pool_t *pool)
{
  ...
  id->generic_id.fsap_data = id;
  id->pool = pool;
# 422 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/id.c"
