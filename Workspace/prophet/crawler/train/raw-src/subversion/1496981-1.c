  ...
  switch (kind_on_disk)
    {
      ...
      case svn_node_symlink:
        ...
        break;
      case svn_node_dir:
        do { svn_error_t *svn_err__temp = (svn_io_remove_dir2(local_abspath, 0, b->cancel_func, b->cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (remove_unversioned_children)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc_walk_status(ctx->wc_ctx, local_abspath, svn_depth_infinity, (!0), no_ignore, (!0), ((void*)0), remove_unversioned_items, &b, ctx->cancel_func, ctx->cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 138 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c"
    }
