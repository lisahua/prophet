...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
...
svn__decompress(svn_string_t *in,
                svn_stringbuf_t *out,
                apr_size_t limit);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c" 2
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
...
# 91 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
...
encode_int(unsigned char *p, svn_filesize_t val)
{
  ...
  do { if (!(val >= 0)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 98, "val >= 0"); abort(); } } while (0);
  ...
  do { if (!(n <= 10)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 109, "n <= MAX_ENCODED_INT_LEN"); abort(); } } while (0);
                             ...
                             struct encoder_baton *eb)
{
  ...
  ((window->ops[0].action_code == svn_txdelta_new) ? (void) (0) : __assert_fail ("window->ops[0].action_code == svn_txdelta_new", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 201, __PRETTY_FUNCTION__));
  ((window->ops[0].length == window->tview_len) ? (void) (0) : __assert_fail ("window->ops[0].length == window->tview_len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 202, __PRETTY_FUNCTION__));
  ((window->ops[0].offset == 0) ? (void) (0) : __assert_fail ("window->ops[0].offset == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 203, __PRETTY_FUNCTION__));
...
# 297 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
...
# 463 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
...
# 527 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
static svn_error_t *
              ...
              unsigned int version)
{
  ...
  do { if (!(data == insend)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c", 765, "data == insend")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 818 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/svndiff.c"
  while (1)
    {
      apr_pool_t *newpool;
