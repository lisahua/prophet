# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c" 2
...
svn_client__mtcc_commit(apr_hash_t *revprop_table,
                        ...
                        svn_client__mtcc_t *mtcc,
                        apr_pool_t *scratch_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c" 2
...
# 119 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/../svn_test.h"
...
# 187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/../svn_test.h"
int svn_test_main(int argc, const char *argv[], int max_threads,
                  struct svn_test_descriptor_t *test_funcs);
# 239 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/../svn_test.h"
...
svn_test__init_auth_baton(svn_auth_baton_t **baton,
                          apr_pool_t *result_pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/../svn_test_fs.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/../svn_test_fs.h"
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/../svn_test_fs.h" 2
...
svn_repos_check_revision_access(svn_repos_revision_access_level_t *access_level,
                                ...
                                void *authz_read_baton,
                                apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/../svn_test_fs.h" 2
...
svn_test__get_file_contents(svn_fs_root_t *root,
                            ...
                            svn_stringbuf_t **str,
                            apr_pool_t *pool);
# 131 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/../svn_test_fs.h"
svn_error_t *
...
svn_test__create_blame_repository(svn_repos_t **out_repos,
                                  ...
                                  const svn_test_opts_t *opts,
                                  apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c" 2
                   ...
                   apr_pool_t *pool)
{
  ...
  do { if (!(vcb.commit_info != ((void*)0))) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "vcb.commit_info != NULL", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c", 70); } while (0);
  do { if (!(vcb.commit_info->revision == expected_rev)) return svn_error_createf(SVN_ERR_TEST_FAILED, ((void*)0), "assertion '%s' failed at %s:%d", "vcb.commit_info->revision == expected_rev", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c", 71); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *err__ = (svn_client__mtcc_add_propset("bad", "svn:" "eol-style", svn_string_create("LF", pool), 0, mtcc, pool)); do { if (!((SVN_ERR_ILLEGAL_TARGET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c", 265, "( SVN_ERR_ILLEGAL_TARGET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0); if (err__ == 0 || err__->apr_err != (SVN_ERR_ILLEGAL_TARGET)) return err__ ? svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_ILLEGAL_TARGET), svn_error_symbolic_name( err__->apr_err)) : svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_ILLEGAL_TARGET), "SVN_NO_ERROR"); svn_error_clear(err__); } while (0);
...
# 300 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c"
               ...
               apr_pool_t *pool)
{
  ...
  do { svn_error_t *err__ = (svn_client__mtcc_add_mkdir("AA/B", mtcc, pool)); do { if (!((SVN_ERR_FS_ALREADY_EXISTS))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c", 340, "( SVN_ERR_FS_ALREADY_EXISTS)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0); if (err__ == 0 || err__->apr_err != (SVN_ERR_FS_ALREADY_EXISTS)) return err__ ? svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_FS_ALREADY_EXISTS), svn_error_symbolic_name( err__->apr_err)) : svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_FS_ALREADY_EXISTS), "SVN_NO_ERROR"); svn_error_clear(err__); } while (0);


  do { svn_error_t *err__ = (svn_client__mtcc_add_mkdir("AA/D/H/chi", mtcc, pool)); do { if (!((SVN_ERR_FS_ALREADY_EXISTS))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_client/mtcc-test.c", 343, "( SVN_ERR_FS_ALREADY_EXISTS)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0); if (err__ == 0 || err__->apr_err != (SVN_ERR_FS_ALREADY_EXISTS)) return err__ ? svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_FS_ALREADY_EXISTS), svn_error_symbolic_name( err__->apr_err)) : svn_error_createf(SVN_ERR_TEST_FAILED, err__, "Expected error %s but got %s", svn_error_symbolic_name(SVN_ERR_FS_ALREADY_EXISTS), "SVN_NO_ERROR"); svn_error_clear(err__); } while (0);
