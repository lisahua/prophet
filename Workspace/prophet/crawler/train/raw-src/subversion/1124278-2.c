# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c" 2

# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_thread_mutex.h" 1
# 25 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_thread_mutex.h"
...
# 26 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_thread_mutex.h" 2
...
char * apr_strerror(apr_status_t statcode, char *buf,
                                 apr_size_t bufsize);
# 27 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_thread_mutex.h" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c" 2
...
move_page_to_front(inprocess_cache_t *cache,
                   struct cache_page *page)
{
  do { if (!(page != cache->sentinel)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 155, "page != cache->sentinel")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                    ...
                    apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (move_page_to_front(cache, entry->page)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *pool)
{
  ...
  if (existing_entry && cache->items_per_page == 1)
    {
      ...
      do { if (!(page->next != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 312, "page->next != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      do { if (!(cache->partial_page == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 313, "cache->partial_page == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (existing_entry)
    {
      ...
      do { svn_error_t *svn_err__temp = (move_page_to_front(cache, page)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (cache->partial_page == ((void*)0) && cache->unallocated_pages > 0)
    {
      cache->partial_page = memset(apr_palloc(cache->cache_pool, sizeof(*(cache->partial_page))), 0, sizeof(*(cache->partial_page)));

      cache->partial_page->page_pool = svn_pool_create_ex(cache->cache_pool, ((void*)0));
      cache->partial_page_number_filled = 0;
  ...
  if (cache->partial_page == ((void*)0))
    {
      ...
      do { if (!(oldest_page != cache->sentinel)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 361, "oldest_page != cache->sentinel")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


      erase_page(cache, oldest_page);
    }

  do { if (!(cache->partial_page != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 367, "cache->partial_page != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  {
    struct cache_page *page = cache->partial_page;
    struct cache_entry *new_entry = memset(apr_palloc(page->page_pool, sizeof(*new_entry)), 0, sizeof(*new_entry));
...
inprocess_cache_is_cachable(void *cache_void, apr_size_t size)
{
  ...
  inprocess_cache_t *cache = cache_void;
  return size < (4096 * 1024) / cache->items_per_page;
}
                            ...
                            apr_pool_t *pool)
{
  ...
  inprocess_cache_t *cache = memset(apr_palloc(pool, sizeof(*cache)), 0, sizeof(*cache));
  ...
  do { if (!(pages >= 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 583, "pages >= 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  cache->total_pages = pages;
  cache->unallocated_pages = pages;
  do { if (!(items_per_page >= 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 586, "items_per_page >= 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  cache->items_per_page = items_per_page;

  cache->sentinel = memset(apr_palloc(pool, sizeof(*(cache->sentinel))), 0, sizeof(*(cache->sentinel)));
  ...
  if (thread_safe)
    {
      ...
      if (status)
        return svn_error_wrap_apr(status,
                                  dcgettext ("subversion", "Can't create cache mutex", 5));
    }
