# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c" 2
...
svn_packed__data_read(svn_packed__data_root_t **root_p,
                      ...
                      apr_pool_t *result_pool,
                      apr_pool_t *scratch_pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.h" 1
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.h"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.h" 2
...
svn_fs_x__changes_get_list_func(void **out,
                                ...
                                void *baton,
                                apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c" 2
...
svn_fs_x__string_table_get_func(const string_table_t *table,
                                ...
                                apr_size_t *length,
                                apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c" 2
...
svn_fs_x__deserialize_mergeinfo(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c" 2
# 67 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c"
...
changes_create_body(apr_size_t initial_count,
                    apr_pool_t *pool)
{
  svn_fs_x__changes_t *changes = memset(apr_palloc(pool, sizeof(*changes)), 0, sizeof(*changes));
  ...
  (*((int *)apr_array_push(changes->offsets))) = 0;
              ...
              change_t *change)
{
  ...
  do { if (!(change)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c", 146, "change")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(change->path.data)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c", 147, "change->path.data")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  info = &change->info;
  is_txn_id = info->node_rev_id && svn_fs_x__id_is_txn(info->node_rev_id);
  binary_change.flags = (info->text_mod ? 0x00001 : 0)
                      | (info->prop_mod ? 0x00002 : 0)
                      | (is_txn_id ? 0x00004 : 0)
                      | ((int)info->change_kind << 0x00005)
                      | ((int)info->node_kind << 0x00003);
  ...
  if (((info->copyfrom_rev) >= 0))
    ...
    {
      binary_change.copyfrom_rev = ((svn_revnum_t) -1);
  ...
  if (info->node_rev_id)
  ...
  else
    {
      ...
      binary_change.noderev_id.change_set = ((svn_fs_x__change_set_t)(-1));
    }

  (*((binary_change_t *)apr_array_push(changes->changes))) = binary_change;
                              ...
                              apr_array_header_t *list)
{
  ...
  do { if (!(changes->builder)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c", 205, "changes->builder")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(changes->paths == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c", 206, "changes->paths == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  for (i = 0; i < list->nelts; ++i)
    append_change(changes, (((change_t * *)(list)->elts)[i]));


  (*((int *)apr_array_push(changes->offsets))) = changes->changes->nelts;
                           ...
                           apr_pool_t *pool)
{
  ...
  do { if (!(changes->builder == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c", 245, "changes->builder == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(changes->paths)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/changes.c", 246, "changes->paths")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  if (idx + 1 >= (apr_size_t)changes->offsets->nelts)
    return svn_error_createf(SVN_ERR_FS_CONTAINER_INDEX, ((void*)0),
                             apr_psprintf(pool,
                                          dcgettext ("subversion", "Changes list index %%%s" " exceeds container size %%d", 5),

                                          "lu"),
                             idx, changes->offsets->nelts - 1);


  first = (((int *)(changes->offsets)->elts)[(int)idx]);
  last = (((int *)(changes->offsets)->elts)[(int)idx + 1]);
  ...
  for (i = first; i < last; ++i)
    {
      const binary_change_t *binary_change
        = &(((binary_change_t *)(changes->changes)->elts)[i]);


      change_t *change = memset(apr_palloc(pool, sizeof(*change)), 0, sizeof(*change));
      ...
      if (binary_change->noderev_id.change_set != ((svn_fs_x__change_set_t)(-1)))
      ...
      info->change_kind = (svn_fs_path_change_kind_t)
        ((binary_change->flags & 0x000E0) >> 0x00005);
      info->text_mod = (binary_change->flags & 0x00001) != 0;
      info->prop_mod = (binary_change->flags & 0x00002) != 0;
      info->node_kind = (svn_node_kind_t)
        ((binary_change->flags & 0x00018) >> 0x00003);

      info->copyfrom_rev = binary_change->copyfrom_rev;
      info->copyfrom_known = (!0);
      if (((binary_change->copyfrom_rev) >= 0))
        info->copyfrom_path
      ...
      (*((change_t* *)apr_array_push(*list))) = change;
    }
                                  ...
                                  apr_pool_t *pool)
{
  ...
  svn_packed__create_int_substream(changes_stream, (!0), 0);
  svn_packed__create_int_substream(changes_stream, (!0), 0);
  svn_packed__create_int_substream(changes_stream, (!0), (!0));
  svn_packed__create_int_substream(changes_stream, (!0), 0);
  svn_packed__create_int_substream(changes_stream, (!0), (!0));
                                 ...
                                 apr_pool_t *scratch_pool)
{
  ...
  svn_fs_x__changes_t *changes = memset(apr_palloc(result_pool, sizeof(*changes)), 0, sizeof(*changes));
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__read_string_table(&changes->paths, stream, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < count; ++i)
    (*((int *)apr_array_push(changes->offsets)))
  ...
  for (i = 0; i < count; ++i)
    {
      ...
      (*((binary_change_t *)apr_array_push(changes->changes))) = change;
    }
                                ...
                                apr_pool_t *pool)
{
  ...
  if (idx + 1 >= (apr_size_t)serialized_offsets->nelts)
    return svn_error_createf(SVN_ERR_FS_CONTAINER_INDEX, ((void*)0),
                             dcgettext ("subversion", "Changes list index %u exceeds container " "size %d", 5),
