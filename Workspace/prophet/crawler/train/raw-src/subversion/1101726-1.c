...
svn_wc__node_get_children(const apr_array_header_t **children,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 251 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__node_get_url(const char **url,
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 323 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
typedef svn_error_t *(*svn_wc__proplist_receiver_t)(void *baton,
                                                    ...
                                                    apr_hash_t *props,
                                                    apr_pool_t *scratch_pool);
# 699 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__node_get_lock_tokens_recursive(apr_hash_t **lock_tokens,
                                       ...
                                       apr_pool_t *result_pool,
                                       apr_pool_t *scratch_pool);
# 753 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__is_sparse_checkout(svn_boolean_t *is_sparse_checkout,
                           ...
                           const char *local_abspath,
                           apr_pool_t *scratch_pool);
# 787 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__get_absent_subtrees(apr_hash_t **absent_subtrees,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 814 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__db_external_remove(svn_wc__db_t *db,
                           ...
                           const svn_skel_t *work_items,
                           apr_pool_t *scratch_pool);
# 1140 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_external_read_pristine_props(apr_hash_t **props,
                                        ...
                                        apr_pool_t *result_pool,
                                        apr_pool_t *scratch_pool);
# 1203 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_set_props(svn_wc__db_t *db,
                        ...
                        const svn_skel_t *work_items,
                        apr_pool_t *scratch_pool);
# 1432 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_mark_resolved(svn_wc__db_t *db,
                            ...
                            apr_pool_t *scratch_pool);
# 1511 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_read_props_streamily(svn_wc__db_t *db,
                                ...
                                void *cancel_baton,
                                apr_pool_t *scratch_pool);
# 2013 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_wclock_owns_lock(svn_boolean_t *own_lock,
                            ...
                            svn_boolean_t exact,
                            apr_pool_t *scratch_pool);
# 2725 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_min_max_revisions(svn_revnum_t *min_revision,
                             ...
                             svn_boolean_t committed,
                             apr_pool_t *scratch_pool);
# 2972 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__internal_file_modified_p(svn_boolean_t *modified_p,
                                 ...
                                 apr_pool_t *scratch_pool);
# 447 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc.h"
svn_error_t *
...
svn_wc__wipe_postupgrade(const char *dir_abspath,
                         ...
                         void *cancel_baton,
                         apr_pool_t *scratch_pool);
# 717 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc.h"
svn_error_t *
...
svn_wc__write_check(svn_wc__db_t *db,
                    const char *local_abspath,
                    apr_pool_t *scratch_pool);
# 743 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/wc.h"
svn_error_t *
...
# 104 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c", 123, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 175 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (need_translation)
    {
...
# 303 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (!checksum
  ...
  if (! exact_comparison)
    {
# 342 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
 ...
 compare_them:
  ...
  do { svn_error_t *svn_err__temp = (compare_and_verify(modified_p, db, local_abspath, finfo.size, pristine_stream, pristine_size, has_props, props_mod, exact_comparison, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
