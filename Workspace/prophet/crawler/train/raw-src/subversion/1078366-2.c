...
svn_cache__set_error_handler(svn_cache__t *cache,
                             ...
                             void *baton,
                             apr_pool_t *pool);
# 268 "./subversion/include/private/svn_cache.h"
svn_boolean_t
svn_cache__is_cachable(svn_cache__t *cache,
                       apr_size_t size);
# 280 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__get(void **value,
               ...
               const void *key,
               apr_pool_t *pool);
# 299 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__set(svn_cache__t *cache,
               const void *key,
               void *value,
               apr_pool_t *pool);
# 325 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
move_page_to_front(inprocess_cache_t *cache,
                   struct cache_page *page)
{
  ((page != cache->sentinel) ? (void) (0) : __assert_fail ("page != cache->sentinel", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 144, __PRETTY_FUNCTION__));
  ...
  if (existing_entry && cache->items_per_page == 1)
    {
      ...
      do { if (!(page->next != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 299, "page->next != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      do { if (!(cache->partial_page == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 300, "cache->partial_page == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (cache->partial_page == ((void*)0))
    {
      ...
      do { if (!(oldest_page != cache->sentinel)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 346, "oldest_page != cache->sentinel")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


      erase_page(cache, oldest_page);
    }

  do { if (!(cache->partial_page != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 352, "cache->partial_page != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  do { if (!(pages >= 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 508, "pages >= 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  cache->unallocated_pages = pages;
  do { if (!(items_per_page >= 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-inprocess.c", 510, "items_per_page >= 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
