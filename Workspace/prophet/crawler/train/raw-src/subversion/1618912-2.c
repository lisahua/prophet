                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  do { if (!(conflict->node_kind == svn_node_dir || conflict->node_kind == svn_node_file || conflict->node_kind == svn_node_none)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 371, "conflict->node_kind == svn_node_dir || conflict->node_kind == svn_node_file || conflict->node_kind == svn_node_none")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(victim_basename[0])) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 377, "victim_basename[0]")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(is_valid_conflict_skel(c_skel))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 382, "is_valid_conflict_skel(c_skel)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_wc__del_tree_conflict(svn_wc_context_t *wc_ctx,
                          ...
                          apr_pool_t *scratch_pool)
{
  do { if (!(svn_dirent_is_absolute(victim_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 395, "svn_dirent_is_absolute(victim_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                          ...
                          apr_pool_t *scratch_pool)
{
  ...
  do { if (!(conflict != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 413, "conflict != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(conflict->operation == svn_wc_operation_merge || (conflict->reason != svn_wc_conflict_reason_moved_away && conflict->reason != svn_wc_conflict_reason_moved_here))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 416, "conflict->operation == svn_wc_operation_merge || (conflict->reason != svn_wc_conflict_reason_moved_away && conflict->reason != svn_wc_conflict_reason_moved_here)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                          ...
                          apr_pool_t *scratch_pool)
{
  const apr_array_header_t *conflicts;
  int i;
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 485, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
