...
svn_dirent_skip_ancestor(const char *parent_dirent,
                         const char *child_dirent);
# 629 "./subversion/include/svn_dirent_uri.h"
const char *
...
svn_uri_skip_ancestor(const char *parent_uri,
                      const char *child_uri,
                      apr_pool_t *result_pool);
# 678 "./subversion/include/svn_dirent_uri.h"
svn_error_t *
      ...
      switch (action->action)
        {
              ...
              if (*kind == svn_kind_dir)
                {
                  ...
                  do { svn_error_t *svn_err__temp = (svn_editor_add_directory(eb->editor, path, children, ((void*)0), ((svn_revnum_t) -1))); if (svn_err__temp) return (svn_err__temp); } while (0);

                }
              else
                {
                  svn_stream_t *contents = svn_stream_empty(scratch_pool);
                  do { svn_error_t *svn_err__temp = (svn_editor_add_file(eb->editor, path, ((void*)0), contents, ((void*)0), ((svn_revnum_t) -1))); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 250, ((void*)0))); } while (0);
        }
    }
  ...
  if (props)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_editor_set_props(eb->editor, path, eb->target_revision, props, (!0))); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (add_action(db->eb, db->path, ACTION_SET_PROP, p_args)); if (svn_err__temp) return (svn_err__temp); } while (0);
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (add_action(fb->eb, fb->path, ACTION_SET_PROP, p_args)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  eb->target_revision = ((svn_revnum_t) -1);
  eb->edit_pool = pool;
...
# 690 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 709, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (action == ACTION_RM)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 809, ((void*)0))); } while (0);
    }
             ...
             apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (build(eb, ACTION_PROPSET, relpath, svn_kind_none, ((void*)0), ((svn_revnum_t) -1), props, ((void*)0), ((svn_revnum_t) -1), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      apr_pool_t *scratch_pool)
{
  ...
  for (hi = apr_hash_first(scratch_pool, operation->children);
       hi; hi = apr_hash_next(hi))
    {
      ...
      if (path[0] != '/')
        {
          char *tmp = memset(apr_palloc(iterpool, strlen(path)), 0, strlen(path));
          tmp[0] = '/';
          strcpy(tmp+1, path);
          path = tmp;
        }
      ...
      if (child->kind == svn_kind_dir)
        {
          do { svn_error_t *svn_err__temp = (drive(child, editor, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1313 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
  return 0;
}
