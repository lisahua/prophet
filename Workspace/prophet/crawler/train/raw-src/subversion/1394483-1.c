...
{
# 393 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.h"
  ...
  const char *txn_id;
# 420 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.h"
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c" 2
...
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  *cache_txdeltas
...
# 186 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
static svn_error_t *
               ...
               apr_pool_t *pool)
{
  if (cache != ((void*)0))
    {
# 211 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
      if (error_handler)
...
# 233 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
static svn_error_t *
...
# 317 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  do { svn_error_t *svn_err__temp = (create_cache(&(ffd->rev_root_id_cache), ((void*)0), membuffer, 1, 100, svn_fs_fs__serialize_id, svn_fs_fs__deserialize_id, sizeof(svn_revnum_t), apr_pstrcat(pool, prefix, "RRI", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 331 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  do { svn_error_t *svn_err__temp = (create_cache(&(ffd->rev_node_cache), ((void*)0), membuffer, 1024, 16, svn_fs_fs__dag_serialize, svn_fs_fs__dag_deserialize, (-1), apr_pstrcat(pool, prefix, "DAG", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 344 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  ffd->dag_node_cache = svn_fs_fs__create_dag_cache(pool);


  do { svn_error_t *svn_err__temp = (create_cache(&(ffd->dir_cache), ((void*)0), membuffer, 1024, 8, svn_fs_fs__serialize_dir_entries, svn_fs_fs__deserialize_dir_entries, (-1), apr_pstrcat(pool, prefix, "DIR", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 361 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  do { svn_error_t *svn_err__temp = (create_cache(&(ffd->packed_offset_cache), ((void*)0), membuffer, 32, 1, svn_fs_fs__serialize_manifest, svn_fs_fs__deserialize_manifest, sizeof(svn_revnum_t), apr_pstrcat(pool, prefix, "PACK-MANIFEST", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 375 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  ffd->fulltext_cache = ((void*)0);
  if (cache_fulltexts)
    {
      do { svn_error_t *svn_err__temp = (create_cache(&(ffd->fulltext_cache), memcache, membuffer, 0, 0, ((void*)0), ((void*)0), sizeof(pair_cache_key_t), apr_pstrcat(pool, prefix, "TEXT", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 389 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
    }


  if (cache_fulltexts)
    {
      do { svn_error_t *svn_err__temp = (create_cache(&(ffd->properties_cache), ((void*)0), membuffer, 0, 0, svn_fs_fs__serialize_properties, svn_fs_fs__deserialize_properties, sizeof(pair_cache_key_t), apr_pstrcat(pool, prefix, "PROP", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 406 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
    }
  else
    {
  ...
  if (cache_revprops)
    {
      do { svn_error_t *svn_err__temp = (create_cache(&(ffd->revprop_cache), ((void*)0), membuffer, 0, 0, svn_fs_fs__serialize_properties, svn_fs_fs__deserialize_properties, sizeof(pair_cache_key_t), apr_pstrcat(pool, prefix, "REVPROP", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 427 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
    }
  else
    {
  ...
  if (cache_txdeltas)
    {
      do { svn_error_t *svn_err__temp = (create_cache(&(ffd->txdelta_window_cache), ((void*)0), membuffer, 0, 0, svn_fs_fs__serialize_txdelta_window, svn_fs_fs__deserialize_txdelta_window, (-1), apr_pstrcat(pool, prefix, "TXDELTA_WINDOW", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 448 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
    }
  else
    {
  ...
  if (cache_txdeltas)
    {
      do { svn_error_t *svn_err__temp = (create_cache(&(ffd->combined_window_cache), ((void*)0), membuffer, 0, 0, ((void*)0), ((void*)0), (-1), apr_pstrcat(pool, prefix, "COMBINED_WINDOW", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 471 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
    }
  else
    {
  ...
  do { svn_error_t *svn_err__temp = (create_cache(&(ffd->node_revision_cache), ((void*)0), membuffer, 0, 0, svn_fs_fs__serialize_node_revision, svn_fs_fs__deserialize_node_revision, (-1), apr_pstrcat(pool, prefix, "NODEREVS", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 491 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  do { svn_error_t *svn_err__temp = (create_cache(&(ffd->changes_cache), ((void*)0), membuffer, 0, 0, svn_fs_fs__serialize_changes, svn_fs_fs__deserialize_changes, sizeof(svn_revnum_t), apr_pstrcat(pool, prefix, "CHANGES", (char *)((void*)0)), fs, no_handler, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
                                 ...
                                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (create_cache(&ffd->txn_dir_cache, ((void*)0), svn_cache__get_global_membuffer_cache(), 1024, 8, svn_fs_fs__serialize_dir_entries, svn_fs_fs__deserialize_dir_entries, (-1), apr_pstrcat(pool, prefix, "TXNDIR", (char *)((void*)0)), fs, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 603 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
