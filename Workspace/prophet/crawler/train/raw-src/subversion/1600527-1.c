# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/revert-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/revert-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/revert-cmd.c"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/revert-cmd.c" 2
...
# 510 "./subversion/include/svn_diff.h"
svn_error_t *
svn_diff_file_options_parse(svn_diff_file_options_t *options,
                            const apr_array_header_t *args,
                            apr_pool_t *pool);
# 526 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_file_diff(svn_diff_t **diff,
                   ...
                   const char *modified,
                   apr_pool_t *pool);
# 555 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_file_diff3(svn_diff_t **diff,
                    ...
                    const char *latest,
                    apr_pool_t *pool);
# 586 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_file_diff4(svn_diff_t **diff,
                    ...
                    const char *ancestor,
                    apr_pool_t *pool);
# 631 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_file_output_unified(svn_stream_t *output_stream,
                             ...
                             const char *modified_header,
                             apr_pool_t *pool);
# 710 "./subversion/include/svn_diff.h"
svn_error_t *
svn_diff_file_output_merge2(svn_stream_t *output_stream,
                            ...
                            apr_pool_t *pool);
# 738 "./subversion/include/svn_diff.h"
__attribute__((deprecated))
svn_error_t *
svn_diff_file_output_merge(svn_stream_t *output_stream,
                           ...
                           apr_pool_t *pool);
# 765 "./subversion/include/svn_diff.h"
svn_error_t *
svn_diff_output_binary(svn_stream_t *output_stream,
                       ...
                       void *cancel_baton,
                       apr_pool_t *scratch_pool);
# 780 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_mem_string_output_merge2(svn_stream_t *output_stream,
                                  ...
                                  apr_pool_t *pool);
# 902 "./subversion/include/svn_diff.h"
__attribute__((deprecated))
svn_error_t *
...
svn_diff_hunk_readline_diff_text(svn_diff_hunk_t *hunk,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 1022 "./subversion/include/svn_diff.h"
svn_error_t *
svn_diff_hunk_readline_original_text(svn_diff_hunk_t *hunk,
                                     ...
                                     apr_pool_t *result_pool,
                                     apr_pool_t *scratch_pool);
# 1037 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_open_patch_file(svn_patch_file_t **patch_file,
                         const char *local_abspath,
                         apr_pool_t *result_pool);
# 1179 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_client_cat2(svn_stream_t *out,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 5828 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_cat(svn_stream_t *out,
               ...
               svn_client_ctx_t *ctx,
               apr_pool_t *pool);
# 5876 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_add_to_changelist(const apr_array_header_t *paths,
                             ...
                             svn_client_ctx_t *ctx,
                             apr_pool_t *pool);
# 5903 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_info2(const char *path_or_url,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 6354 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
typedef svn_error_t *(*svn_client_patch_func_t)(
  ...
  apr_pool_t *scratch_pool);
# 6482 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_patch(const char *patch_abspath,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *scratch_pool);
# 6523 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_url_from_path(const char **url,
                         const char *path_or_url,
                         apr_pool_t *pool);
# 6559 "./subversion/include/svn_client.h"
svn_error_t *
svn_client_get_repos_root(const char **repos_root_url,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 6576 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_root_url_from_path(const char **url,
                              ...
                              svn_client_ctx_t *ctx,
                              apr_pool_t *pool);
# 6593 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_open_ra_session2(svn_ra_session_t **session,
                           ...
                           apr_pool_t *result_pool,
                           apr_pool_t *scratch_pool);
# 6662 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/revert-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/revert-cmd.c" 2
...
svn_cl__deprecated_merge_reintegrate(const char *source_path_or_url,
                                     ...
                                     svn_client_ctx_t *ctx,
                                     apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/revert-cmd.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/revert-cmd.c" 2
               ...
               apr_pool_t *scratch_pool)
{
  ...
  if (err
      ...
      && (! ((opt_state->depth) == svn_depth_infinity || (opt_state->depth) == svn_depth_unknown)))
    {
      err = svn_error_quick_wrap
        (err, dcgettext ("subversion", "Try 'svn revert --depth infinity' instead?", 5));
    }
