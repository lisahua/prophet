               ...
               apr_pool_t *pool)
{
  ...
  do { if (!(!path || pb)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c", 192, "!path || pb"); abort(); } } while (0);
...
# 230 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 1022 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 1232 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
        }
      else
        {
...
# 1314 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
  ...
  for (rev = start_rev; rev <= end_rev; rev++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor((const svn_delta_editor_t **)&dump_editor, &dump_edit_baton, fs, rev, "", svn_stream_empty(pool), ((void*)0), ((void*)0), verify_close_directory, notify_func, notify_baton, start_rev, 0, (!0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1425 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
