...
# 62 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c" 2
...
# 159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 222 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 255 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 369 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 391 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 269:
          ...
          break;
# 730 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
        case 263:
...
# 907 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 1001 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
  {
    ...
    if (handling_mode == connection_mode_thread)
      {
        ...
        settings.single_threaded = 0;
# 1020 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
      }
  ...
  while (1)
    {
# 1036 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
      connection_pool
...
# 1069 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
      ...
      switch (handling_mode)
        ...
        case connection_mode_thread:
          ...
          if (status)
            {
              err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't create threadattr", 5));
          ...
          if (status)
            {
              err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't set detached state", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
          ...
          if (status)
            {
              err = svn_error_wrap_apr(status, dcgettext ("subversion", "Can't create thread", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
