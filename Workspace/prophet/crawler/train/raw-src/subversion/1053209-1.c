...
test_error_purge_tracing(apr_pool_t *pool)
{
  ...
  err = ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",101), (svn_error_create))(SVN_ERR_BASE, err, "other error"));
# 110 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c"
  err2 = svn_error_purge_tracing(err);
  for (child = err2; child; child = child->child)
    if (svn_error__is_tracing_link(child))
      {
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c",114), (svn_error_create))(SVN_ERR_TEST_FAILED, err,
                                "Tracing link found after purging the "
                                "following chain:");
      }
  svn_error_clear(err);
# 166 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c"
  return 0;
}
