# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
svn_wc_prop_set(const char *name,
                ...
                svn_wc_adm_access_t *adm_access,
                apr_pool_t *pool);
# 5817 "./subversion/include/svn_wc.h"
svn_boolean_t
...
svn_wc_merge4(enum svn_wc_merge_outcome_t *merge_outcome,
              ...
              void *cancel_baton,
              apr_pool_t *scratch_pool);
# 6385 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
svn_client_ls3(apr_hash_t **dirents,
               ...
               svn_client_ctx_t *ctx,
               apr_pool_t *pool);
# 4833 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_unlock(const apr_array_header_t *targets,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 5122 "./subversion/include/svn_client.h"
...
# 5193 "./subversion/include/svn_client.h"
  apr_size_t size;
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
...
svn_wc__node_get_commit_status(svn_node_kind_t *kind,
                               ...
                               apr_pool_t *result_pool,
                               apr_pool_t *scratch_pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c" 2
      ...
      switch(status->node_status)
        {
          case svn_wc_status_replaced:
            ...
            do { svn_error_t *svn_err__temp = (svn_wc__node_get_pre_ng_status_data(&twks->revision, ((void*)0), ((void*)0), ((void*)0), sb->ctx->wc_ctx, local_abspath, sb->cl_pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          case svn_wc_status_deleted:
            ...
            do { svn_error_t *svn_err__temp = (svn_wc__node_get_pre_ng_status_data(&twks->revision, &twks->changed_rev, &twks->changed_date, &twks->changed_author, sb->ctx->wc_ctx, local_abspath, sb->cl_pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (status->changelist)
    {
      ...
      struct status_cache *scache = memset(apr_palloc(sb->cl_pool, sizeof(*scache)), 0, sizeof(*scache));
      scache->path = apr_pstrdup(sb->cl_pool, path);
      scache->status = svn_client_status_dup(status, sb->cl_pool);

      path_array =
        apr_hash_get(sb->cached_changelists, cl_key, (-1));
      if (path_array == ((void*)0))
        {
               ...
               apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__args_to_target_array_print_reserved(&targets, os, opt_state->targets, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (opt_state->xml)
    {
      ...
      if (! opt_state->incremental)
        do { svn_error_t *svn_err__temp = (svn_cl__xml_print_header("status", scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
    {
      if (opt_state->incremental)
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__eat_peg_revisions(&targets, targets, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  iterpool = svn_pool_create_ex(scratch_pool, ((void*)0));
  for (i = 0; i < targets->nelts; i++)
    {
      const char *target = (((const char * *)(targets)->elts)[i]);
      svn_revnum_t repos_rev = ((svn_revnum_t) -1);
      ...
      if (opt_state->xml)
        do { svn_error_t *svn_err__temp = (print_start_target_xml(svn_dirent_local_style(target, iterpool), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);




      do { svn_error_t *svn_err__temp = (svn_cl__try(svn_client_status5(&repos_rev, ctx, target, &rev, opt_state->depth, opt_state->verbose, opt_state->update, opt_state->no_ignore, opt_state->ignore_externals, 0 , opt_state->changelists, print_status, &sb, iterpool), ((void*)0), opt_state->quiet, SVN_ERR_WC_NOT_WORKING_COPY, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 353 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/status-cmd.c"
      if (opt_state->xml)
        do { svn_error_t *svn_err__temp = (print_finish_target_xml(repos_rev, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
          ...
          if (opt_state->xml)
            {
              ...
              svn_xml_make_open_tag(&buf, scratch_pool, svn_xml_normal,
                                    ...
                                    ((void*)0));
              do { svn_error_t *svn_err__temp = (svn_cl__error_checked_fputs(buf->data, stdout)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
          else
            do { svn_error_t *svn_err__temp = (svn_cmdline_printf(scratch_pool, dcgettext ("subversion", "\n--- Changelist '%s':\n", 5), changelist_name)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          for (j = 0; j < path_array->nelts; j++)
            {
              ...
              do { svn_error_t *svn_err__temp = (print_status_normal_or_xml(&sb, scache->path, scache->status, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (opt_state->xml && (! opt_state->incremental))
    do { svn_error_t *svn_err__temp = (svn_cl__xml_print_footer("status", scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (! opt_state->quiet && ! opt_state->xml)
      do { svn_error_t *svn_err__temp = (print_conflict_stats(&sb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
