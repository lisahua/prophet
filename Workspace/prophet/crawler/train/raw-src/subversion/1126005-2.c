# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
...
svn_cache__create_inprocess(svn_cache__t **cache_p,
                            ...
                            const char *id,
                            apr_pool_t *pool);
# 236 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
svn_cache__make_memcache_from_config(svn_memcache_t **memcache_p,
                                     svn_config_t *config,
                                     apr_pool_t *pool);
# 276 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
svn_cache__create_membuffer_cache(svn_cache__t **cache_p,
                                  ...
                                  const char *prefix,
                                  apr_pool_t *pool);
# 320 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__set_error_handler(svn_cache__t *cache,
                             svn_cache__error_handler_t handler,
                             void *baton,
                             apr_pool_t *pool);
# 333 "./subversion/include/private/svn_cache.h"
svn_boolean_t
svn_cache__is_cachable(svn_cache__t *cache,
                       apr_size_t size);
# 345 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__get(void **value,
               ...
               const void *key,
               apr_pool_t *pool);
# 364 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__set(svn_cache__t *cache,
               const void *key,
               void *value,
               apr_pool_t *pool);
# 390 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
svn_cache__get_partial(void **value,
                       ...
                       void *baton,
                       apr_pool_t *scratch_pool);
# 419 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
svn_fs_fs__pack(svn_fs_t *fs,
                ...
                void *cancel_baton,
                apr_pool_t *pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
svn_fs_fs__id_deserialize(void *buffer,
                          svn_fs_id_t **id);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
svn_error_t *svn_fs_fs__dag_get_copyfrom_path(const char **path,
                                              dag_node_t *node,
                                              apr_pool_t *pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
svn_fs_fs__replace_dir_entry(char **data,
                             ...
                             void *baton,
                             apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
...
svn_hash_get_bool(apr_hash_t *hash,
                  const char *key,
                  svn_boolean_t default_value);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
# 1 "./subversion/include/private/svn_debug.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c" 2
            ...
            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__make_memcache_from_config(memcache_p, ffd->config, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 144 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
static svn_error_t *
               ...
               apr_pool_t *pool)
{
  if (cache != ((void*)0))
    {
# 169 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
      if (! no_handler)
        do { svn_error_t *svn_err__temp = (svn_cache__set_error_handler(cache, warn_on_cache_errors, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                             ...
                             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (read_config(&memcache, &no_handler, &cache_txdeltas, &cache_fulltexts, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 216 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  if (svn_cache__get_global_membuffer_cache())
      do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->rev_root_id_cache), svn_cache__get_global_membuffer_cache(), svn_fs_fs__serialize_id, svn_fs_fs__deserialize_id, sizeof(svn_revnum_t), apr_pstrcat(pool, prefix, "RRI", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->rev_root_id_cache), svn_fs_fs__serialize_id, svn_fs_fs__deserialize_id, sizeof(svn_revnum_t), 1, 100, 0, apr_pstrcat(pool, prefix, "RRI", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 235 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  do { svn_error_t *svn_err__temp = (init_callbacks(ffd->rev_root_id_cache, fs, no_handler, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  if (svn_cache__get_global_membuffer_cache())
    do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->rev_node_cache), svn_cache__get_global_membuffer_cache(), svn_fs_fs__dag_serialize, svn_fs_fs__dag_deserialize, (-1), apr_pstrcat(pool, prefix, "DAG", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->rev_node_cache), svn_fs_fs__dag_serialize, svn_fs_fs__dag_deserialize, (-1), 1024, 16, 0, apr_pstrcat(pool, prefix, "DAG", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 258 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  do { svn_error_t *svn_err__temp = (init_callbacks(ffd->rev_node_cache, fs, no_handler, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (svn_cache__get_global_membuffer_cache())
    do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->dir_cache), svn_cache__get_global_membuffer_cache(), svn_fs_fs__serialize_dir_entries, svn_fs_fs__deserialize_dir_entries, (-1), apr_pstrcat(pool, prefix, "DIR", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->dir_cache), svn_fs_fs__serialize_dir_entries, svn_fs_fs__deserialize_dir_entries, (-1), 1024, 8, 0, apr_pstrcat(pool, prefix, "DIR", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 280 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  do { svn_error_t *svn_err__temp = (init_callbacks(ffd->dir_cache, fs, no_handler, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  if (svn_cache__get_global_membuffer_cache())
    do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->packed_offset_cache), svn_cache__get_global_membuffer_cache(), svn_fs_fs__serialize_manifest, svn_fs_fs__deserialize_manifest, sizeof(svn_revnum_t), apr_pstrcat(pool, prefix, "PACK-MANIFEST", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->packed_offset_cache), svn_fs_fs__serialize_manifest, svn_fs_fs__deserialize_manifest, sizeof(svn_revnum_t), 32, 1, 0, apr_pstrcat(pool, prefix, "PACK-MANIFEST", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 303 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  do { svn_error_t *svn_err__temp = (init_callbacks(ffd->packed_offset_cache, fs, no_handler, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (cache_fulltexts)
    {
      if (memcache)
        {
          do { svn_error_t *svn_err__temp = (svn_cache__create_memcache(&(ffd->fulltext_cache), memcache, ((void*)0), ((void*)0), (-1), apr_pstrcat(pool, prefix, "TEXT", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->fulltext_cache), svn_cache__get_global_membuffer_cache(), ((void*)0), ((void*)0), (-1), apr_pstrcat(pool, prefix, "TEXT", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (init_callbacks(ffd->fulltext_cache, fs, no_handler, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (svn_cache__get_global_membuffer_cache() && cache_txdeltas)
    {
      do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache (&(ffd->txdelta_window_cache), svn_cache__get_global_membuffer_cache(), svn_fs_fs__serialize_txdelta_window, svn_fs_fs__deserialize_txdelta_window, (-1), apr_pstrcat(pool, prefix, "TXDELTA_WINDOW", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (init_callbacks(ffd->txdelta_window_cache, fs, no_handler, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (svn_cache__get_global_membuffer_cache())
    {
      do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->node_revision_cache), svn_cache__get_global_membuffer_cache(), svn_fs_fs__serialize_node_revision, svn_fs_fs__deserialize_node_revision, (-1), apr_pstrcat(pool, prefix, "NODEREVS", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 367 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
    }
  else
    {
      ffd->node_revision_cache = ((void*)0);
    }

  do { svn_error_t *svn_err__temp = (init_callbacks(ffd->node_revision_cache, fs, no_handler, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 435 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
svn_error_t *
svn_fs_fs__initialize_txn_caches(svn_fs_t *fs,
                                 const char *txn_id,
                                 apr_pool_t *pool)
{
  ...
  if (svn_cache__get_global_membuffer_cache())
    do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&(ffd->txn_dir_cache), svn_cache__get_global_membuffer_cache(), svn_fs_fs__serialize_dir_entries, svn_fs_fs__deserialize_dir_entries, (-1), apr_pstrcat(pool, prefix, "TXNDIR", (char *)((void*)0)), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->txn_dir_cache), svn_fs_fs__serialize_dir_entries, svn_fs_fs__deserialize_dir_entries, (-1), 1024, 8, 0, apr_pstrcat(pool, prefix, "TXNDIR", (char *)((void*)0)), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 485 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
