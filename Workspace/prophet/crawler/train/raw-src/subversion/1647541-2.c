...
# 370 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static rep_stats_t *
      ...
      if (!svn_fs_fs__use_log_addressing(query->fs))
        {
          ...
          do { if (!(revision_info->rev_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c", 452, "revision_info->rev_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
read_noderev(query_t *query,
             ...
             apr_pool_t *result_pool,
             apr_pool_t *scratch_pool);
# 486 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  do { if (!(revision_info->rev_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c", 501, "revision_info->rev_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 534 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
          ...
          apr_pool_t *scratch_pool)
{
  ...
  int i;
  apr_array_header_t *entries;
  do { svn_error_t *svn_err__temp = (svn_fs_fs__rep_contents_dir(&entries, query->fs, noderev, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 577 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
read_noderev(query_t *query,
             svn_stringbuf_t *noderev_str,
             revision_info_t *revision_info,
             ...
             apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__read_noderev(&noderev, stream, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (noderev->data_rep)
    {
      do { svn_error_t *svn_err__temp = (parse_representation(&text, query, noderev->data_rep, revision_info, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (noderev->prop_rep)
    {
      do { svn_error_t *svn_err__temp = (parse_representation(&props, query, noderev->prop_rep, revision_info, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ( noderev->kind == svn_node_dir && text && text->ref_count == 1
    ...
    do { svn_error_t *svn_err__temp = (parse_dir(query, noderev, revision_info, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open_pack_or_rev_file(&rev_file, query->fs, base, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (get_file_size(&file_size, rev_file, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < query->shard_size; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (read_phys_revision(query, info, result_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
read_phys_revision_file(query_t *query,
                        ...
                        apr_pool_t *scratch_pool)
{
  revision_info_t *info = memset(apr_palloc(result_pool, sizeof(*info)), 0, sizeof(*info));
  apr_off_t file_size = 0;
  svn_fs_fs__revision_file_t *rev_file;
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open_pack_or_rev_file(&rev_file, query->fs, revision, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (read_phys_revision(query, info, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_aligned_seek(rev_file->file, rev_file->block_size, ((void*)0), entry->offset, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(rev_file->file, item->data, item->len, ((void*)0), ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                         ...
                         apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open_pack_or_rev_file(&rev_file, query->fs, base, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_fs_fs__p2l_get_max_offset(&max_offset, query->fs, rev_file, base, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (entry->type == 5)
            {
              ...
              do { svn_error_t *svn_err__temp = (read_item(&item, rev_file, entry, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              do { svn_error_t *svn_err__temp = (read_noderev(query, item, info, result_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
...
read_log_pack_file(query_t *query,
                   ...
                   apr_pool_t *scratch_pool)
{
  do { svn_error_t *svn_err__temp = (read_log_rev_or_packfile(query, base, query->shard_size, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
read_log_revision_file(query_t *query,
                       ...
                       apr_pool_t *scratch_pool)
{
  do { svn_error_t *svn_err__temp = (read_log_rev_or_packfile(query, revision, 1, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *scratch_pool)
{
  ...
  for ( revision = 0
      ...
      ; revision += query->shard_size)
    {
      ...
      if (svn_fs_fs__use_log_addressing(query->fs))
        do { svn_error_t *svn_err__temp = (read_log_pack_file(query, revision, result_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      else
        do { svn_error_t *svn_err__temp = (read_phys_pack_file(query, revision, result_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  ...
  for ( ; revision <= query->head; ++revision)
    {
      ...
      if (svn_fs_fs__use_log_addressing(query->fs))
        do { svn_error_t *svn_err__temp = (read_log_revision_file(query, revision, result_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      else
        do { svn_error_t *svn_err__temp = (read_phys_revision_file(query, revision, result_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1219 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  *stats = create_stats(result_pool);
  do { svn_error_t *svn_err__temp = (create_query(&query, fs, *stats, progress_func, progress_baton, cancel_func, cancel_baton, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (read_revisions(query, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
