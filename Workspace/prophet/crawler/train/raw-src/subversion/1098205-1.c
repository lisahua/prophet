# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h" 2
...
svn_error_t *svn_fs_fs__dag_get_copyfrom_path(const char **path,
                                              dag_node_t *node,
                                              apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
svn_fs_fs__pack(svn_fs_t *fs,
                ...
                void *cancel_baton,
                apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
svn_fs_fs__id_deserialize(void *buffer,
                          svn_fs_id_t **id);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
# 1 "./subversion/include/private/svn_temp_serializer.h" 1
# 35 "./subversion/include/private/svn_temp_serializer.h"
...
# 66 "./subversion/include/private/svn_temp_serializer.h"
svn_temp_serializer__context_t *
svn_temp_serializer__init(const void *source_struct,
                          apr_size_t struct_size,
                          apr_size_t suggested_buffer_size,
                          apr_pool_t *pool);
# 92 "./subversion/include/private/svn_temp_serializer.h"
svn_temp_serializer__context_t *
...
# 178 "./subversion/include/private/svn_temp_serializer.h"
void
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
svn_fs_fs__replace_dir_entry(char **data,
                             ...
                             void *baton,
                             apr_pool_t *pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c" 2
...
struct dag_node_t
{
  ...
  svn_node_kind_t kind;
# 71 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c"
...
copy_node_revision(node_revision_t *noderev,
                   apr_pool_t *pool)
{
  node_revision_t *nr = memset(apr_palloc(pool, sizeof(*nr)), 0, sizeof(*nr));
...
# 152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c"
static svn_error_t *
                  ...
                  apr_pool_t *pool)
{
  ...
  if (! node->node_revision)
    {
      do { svn_error_t *svn_err__temp = (svn_fs_fs__get_node_revision(&noderev, node->fs, node->id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_boolean_t svn_fs_fs__dag_check_mutable(const dag_node_t *node)
{
  return (svn_fs_fs__id_txn_id(svn_fs_fs__dag_get_id(node)) != ((void*)0));
}
                        ...
                        apr_pool_t *pool)
{
  ...
  new_node = memset(apr_palloc(pool, sizeof(*new_node)), 0, sizeof(*new_node));
  new_node->fs = fs;
  new_node->id = svn_fs_fs__id_copy(id, pool);


  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, new_node, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                  ...
                                  apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, node, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 309 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c"
static svn_error_t *
                       ...
                       apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__dag_dir_entry(&dirent, parent, name, subpool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  *id_p = dirent ? svn_fs_fs__id_copy(dirent->id, pool) : ((void*)0);

  apr_pool_destroy(subpool);

  return 0;
}
# 335 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c"
static svn_error_t *
          ...
          apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&parent_noderev, parent, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  return svn_fs_fs__set_entry(parent->fs, txn_id, parent_noderev, name, id,
                              kind, pool);
}
# 361 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c"
static svn_error_t *
           ...
           apr_pool_t *pool)
{
  ...
  if (! svn_path_is_single_path_component(name))
    return svn_error_createf
      (SVN_ERR_FS_NOT_SINGLE_PATH_COMPONENT, ((void*)0),
       dcgettext ("subversion", "Attempted to create a node with an illegal name '%s'", 5), name);


  if (parent->kind != svn_node_dir)
    return svn_error_create
      (SVN_ERR_FS_NOT_DIRECTORY, ((void*)0),
       dcgettext ("subversion", "Attempted to create entry in non-directory parent", 5));


  if (! svn_fs_fs__dag_check_mutable(parent))
    return svn_error_createf
      (SVN_ERR_FS_NOT_MUTABLE, ((void*)0),
       dcgettext ("subversion", "Attempted to clone child of non-mutable node", 5));
  ...
  new_noderev.copyfrom_rev = ((svn_revnum_t) -1);
  new_noderev.copyfrom_path = ((void*)0);

  do { svn_error_t *svn_err__temp = (svn_fs_fs__create_node (&new_node_id, svn_fs_fs__dag_get_fs(parent), &new_noderev, svn_fs_fs__id_copy_id(svn_fs_fs__dag_get_id(parent)), txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





  do { svn_error_t *svn_err__temp = (svn_fs_fs__dag_get_node(child_p, svn_fs_fs__dag_get_fs(parent), new_node_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *node_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, node, node_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (noderev->kind != svn_node_dir)
    return svn_error_create(SVN_ERR_FS_NOT_DIRECTORY, ((void*)0),
                            dcgettext ("subversion", "Can't get entries of non-directory", 5));
                         ...
                         apr_pool_t *pool)
{
  ...
  if (node->kind != svn_node_dir)
    return svn_error_create
      (SVN_ERR_FS_NOT_DIRECTORY, ((void*)0),
       dcgettext ("subversion", "Attempted to set entry in non-directory node", 5));


  if (! svn_fs_fs__dag_check_mutable(node))
    return svn_error_create
      (SVN_ERR_FS_NOT_MUTABLE, ((void*)0),
       dcgettext ("subversion", "Attempted to set entry in immutable node", 5));
                            ...
                            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__get_proplist(&proplist, node->fs, noderev, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (noderev->mergeinfo_count < 0)
    {
      ...
      return svn_error_createf
        (SVN_ERR_FS_CORRUPT, ((void*)0),
         apr_psprintf(pool,
                      dcgettext ("subversion", "Can't increment mergeinfo count on node-revision %%s " "to negative value %%%s", 5),
  ...
  if (noderev->mergeinfo_count > 1 && noderev->kind == svn_node_file)
    {
      ...
      return svn_error_createf
        (SVN_ERR_FS_CORRUPT, ((void*)0),
         apr_psprintf(pool,
                      dcgettext ("subversion", "Can't increment mergeinfo count on *file* " "node-revision %%s to %%%s (> 1)", 5),
                        ...
                        apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__get_txn_ids(&root_id, &ignored, fs, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return svn_fs_fs__dag_get_node(node_p, fs, root_id, pool);
}
                             ...
                             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__get_txn_ids(&ignored, &base_root_id, fs, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__dag_open(&cur_entry, parent, name, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (svn_fs_fs__dag_check_mutable(cur_entry))
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, cur_entry, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__create_successor(&new_node_id, fs, cur_entry->id, noderev, copy_id, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




      do { svn_error_t *svn_err__temp = (set_entry(parent, name, new_node_id, noderev->kind, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__get_txn_ids(&root_id, &base_root_id, fs, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { if (!(!svn_fs_fs__id_eq(root_id, base_root_id))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.c", 738, "!svn_fs_fs__id_eq(root_id, base_root_id)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                      ...
                      apr_pool_t *pool)
{
  ...
  dirent = apr_hash_get(entries, name, (-1));
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__dag_delete_if_mutable(parent->fs, id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__dag_get_node(&node, fs, id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (node->kind == svn_node_dir)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__dag_dir_entries(&entries, node, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (entries)
        {
          for (hi = apr_hash_first(pool, entries);
               ...
               hi = apr_hash_next(hi))
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_fs_fs__dag_delete_if_mutable(fs, dirent->id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                         ...
                         apr_pool_t *pool)
{
  ...
  return make_entry(child_p, parent, parent_path, name, 0, txn_id, pool);
}
                            ...
                            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, file, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_fs_fs__get_contents(&contents, file->fs, noderev, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                     ...
                                     apr_pool_t *pool)
{
  ...
  if (source)
    do { svn_error_t *svn_err__temp = (get_node_revision(&src_noderev, source, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
    src_noderev = ((void*)0);
  do { svn_error_t *svn_err__temp = (get_node_revision(&tgt_noderev, target, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                               ...
                               apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__set_contents(&ws, file->fs, noderev, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (checksum)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__dag_file_checksum(&file_checksum, file, checksum->kind, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   apr_pool_t *pool)
{
  ...
  dag_node_t *new_node = memset(apr_palloc(pool, sizeof(*new_node)), 0, sizeof(*new_node));
                           ...
                           apr_pool_t *pool)
{
  ...
  if (data_len == 0)
    return svn_error_create(SVN_ERR_FS_CORRUPT, ((void*)0),
                            dcgettext ("subversion", "Empty noderev in cache", 5));
                    ...
                    apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dir_entry_id_from_node(&node_id, parent, name, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (! node_id)
    return svn_error_createf
  ...
  if (preserve_history)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_node_revision(&from_noderev, from_node, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      to_noderev = copy_node_revision(from_noderev, pool);


      do { svn_error_t *svn_err__temp = (svn_fs_fs__reserve_copy_id(&copy_id, fs, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__create_successor(&id, fs, src_id, to_noderev, copy_id, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                ...
                                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev1, node1, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev2, node2, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
