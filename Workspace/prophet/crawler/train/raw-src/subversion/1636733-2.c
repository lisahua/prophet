# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_fs__prop_lists_equal(apr_hash_t *a,
                         apr_hash_t *b,
                         apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h" 1
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h" 2
...
svn_mutex__unlock(svn_mutex__t *mutex,
                  svn_error_t *err);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h" 2
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
...
# 175 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
typedef svn_error_t *(*fs_init_func_t)(const svn_version_t *loader_version,
                                       fs_library_vtable_t **vtable,
                                       apr_pool_t* common_pool);
# 187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
...
# 298 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
...
# 455 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
struct svn_fs_t
{
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_util/fs-util.c" 2
  ...
  for (hi = apr_hash_first(pool, input); hi; hi = apr_hash_next(hi))
    {
      ...
      apr_hash_set(*output, svn_fspath__join(path, rel_path, pool), (-1), svn_rangelist_dup(rangelist, pool));
                           ...
                           apr_pool_t *pool)
{
  ...
  compatible = apr_hash_get(config, "compatible-version", (-1));
  if (compatible)
    {
      do { svn_error_t *svn_err__temp = (svn_version__parse_version_string(&version, compatible, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (apr_hash_get(config, "pre-1.4-compatible", (-1)))
    add_compatility(version, 1, 3);
  else if (apr_hash_get(config, "pre-1.5-compatible", (-1)))
    add_compatility(version, 1, 4);
  else if (apr_hash_get(config, "pre-1.6-compatible", (-1)))
    add_compatility(version, 1, 5);
  else if (apr_hash_get(config, "pre-1.8-compatible", (-1)))
