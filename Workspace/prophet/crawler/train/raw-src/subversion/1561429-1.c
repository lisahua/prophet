...
# 247 "./subversion/svn_private_config.h"
...
apr_status_t apr_thread_pool_task_owner_get(apr_thread_t *thd,
                                                         void **owner);
# 65 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
# 75 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/winservice.h" 1
# 76 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
# 79 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
apr_size_t escape_errorlog_item(char *dest, const char *source,
                                apr_size_t buflen);
# 82 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
logger__log_error(logger_t *logger,
                  ...
                  repository_t *repository,
                  client_info_t *client_info);
# 83 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c" 2
...
# 221 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
# 284 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
# 317 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
{
  apr_size_t i;
# 380 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
# 434 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
                  ...
                  enum connection_handling_mode handling_mode)
{
  ...
  *connection = memset(apr_palloc(pool, sizeof(**connection)), 0, sizeof(**connection));
...
# 615 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 269:
          ...
          break;
# 896 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
        case 263:
  ...
  apr_hash_set(fs_config, "fsfs-cache-deltas", (-1), cache_txdeltas ? "1" :"0");

  apr_hash_set(fs_config, "fsfs-cache-fulltexts", (-1), cache_fulltexts ? "1" :"0");

  apr_hash_set(fs_config, "fsfs-cache-revprops", (-1), cache_revprops ? "2" :"0");
  ...
  do { svn_error_t *svn_err__temp = (svn_repos__repos_pool_create(&params.repos_pool, fs_config, is_multi_threaded, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (run_mode == run_mode_inetd || run_mode == run_mode_tunnel)
    {
      ...
      if (status)
        {
          return svn_error_wrap_apr(status, dcgettext ("subversion", "Can't open stdin", 5));
        }
...
# 1104 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
...
# 1204 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
  {
    ...
    if (handling_mode == connection_mode_thread)
      {
        ...
        settings.single_threaded = 0;
# 1223 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
      }
  ...
  do { svn_error_t *svn_err__temp = (svn_root_pools__create(&socket_pools)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  while (1)
    {
      ...
      do { svn_error_t *svn_err__temp = (accept_connection(&connection, sock, socket_pools, &params, handling_mode)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      switch (handling_mode)
        ...
        case connection_mode_thread:
          ...
          status = apr_thread_pool_push(threads, serve_thread, connection,
                                        0, ((void*)0));
# 1322 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/svnserve.c"
          if (status)
            {
