# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c"
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
svn_opt_print_help(apr_getopt_t *os,
                   ...
                   const char *footer,
                   apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 40 "./subversion/include/svn_utf.h" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
# 1 "./subversion/include/svn_subst.h" 1
# 38 "./subversion/include/svn_subst.h"
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 84 "./subversion/include/svn_cache_config.h"
void
svn_set_cache_config(const svn_cache_config_t *settings);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
svn_opt__revision_to_string(const svn_opt_revision_t *revision,
                            apr_pool_t *result_pool);
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c" 2
...
open_repos(svn_repos_t **repos,
           ...
           apr_pool_t *pool)
{
  do { svn_error_t *svn_err__temp = (svn_repos_open(repos, path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 334 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c"
...
# 413 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c"
...
# 444 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c"
   {0} },
...
struct svnadmin_opt_state
{
  ...
  svn_boolean_t pre_1_7_compatible;
...
# 545 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c"
static svn_error_t *
           ...
           apr_pool_t *pool)
{
  ...
  if (min_expected || max_expected)
    do { if (!(args)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c", 555, "args")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
subcommand_create(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  apr_hash_set(fs_config, "bdb-txn-nosync",
               (-1),
               (opt_state->bdb_txn_nosync ? "1" : "0"));

  apr_hash_set(fs_config, "bdb-log-autoremove",
               (-1),
               (opt_state->bdb_log_keep ? "0" : "1"));

  if (opt_state->fs_type)
    apr_hash_set(fs_config, "fs-type",
                 (-1),
                 opt_state->fs_type);

  if (opt_state->pre_1_4_compatible)
    apr_hash_set(fs_config, "pre-1.4-compatible",
                 (-1),
                 "1");

  if (opt_state->pre_1_5_compatible)
    apr_hash_set(fs_config, "pre-1.5-compatible",
                 (-1),
                 "1");

  if (opt_state->pre_1_6_compatible)
    apr_hash_set(fs_config, "pre-1.6-compatible",
                 (-1),
                 "1");

  if (opt_state->pre_1_7_compatible)
    apr_hash_set(fs_config, "pre-1.7-compatible",
                 (-1),
                 "1");

  do { svn_error_t *svn_err__temp = (svn_config_get_config(&config, opt_state->config_dir, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_cmdline__apply_config_options(config, opt_state->config_options, "svnadmin: ", "--config-option")); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_repos_create(&repos, opt_state->repository_path, ((void*)0), ((void*)0), config, fs_config, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 857 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnadmin/main.c"
...
subcommand_help(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_opt_print_help3(os, "svnadmin", opt_state ? opt_state->version : 0, opt_state ? opt_state->quiet : 0, version_footer->data, header, cmd_table, options_table, ((void*)0), ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
subcommand_load(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  err = svn_repos_load_fs3(repos, stdin_stream,
                           ...
                           opt_state->bypass_prop_validation ? 0 : (!0),
  ...
  while (1)
    {
      ...
      case svnadmin__pre_1_7_compatible:
        opt_state.pre_1_7_compatible = (!0);
        break;
