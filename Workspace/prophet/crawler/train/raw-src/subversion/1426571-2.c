...
svn_path_resolve_repos_relative_url(const char **absolute_url,
                                    ...
                                    apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/tools/server-side/svnauthz-validate.c" 2
...
main(int argc, const char **argv)
{
  ...
  err = svn_repos_authz_read2(&authz, opts.authz_file, (!0), ((void*)0), pool);
