...
svn_error_t *svn_wc__open_adm_stream(svn_stream_t **stream,
                                     ...
                                     apr_pool_t *result_pool,
                                     apr_pool_t *scratch_pool);
# 135 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/adm_files.h"
svn_error_t *
...
# 92 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c", 108, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { svn_error_t *svn_err__temp = (svn_wc__get_eol_style(&eol_style, &eol_str, db, versioned_file_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_wc__get_keywords(&keywords, db, versioned_file_abspath, ((void*)0), scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_wc__get_special(&special, db, versioned_file_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 145 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
          if (node_checksum)
          ...
          if (compare_textbases && need_translation)
            {
              if (eol_style == svn_subst_eol_style_native)
                ...
                return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c",168), (svn_error_create))(SVN_ERR_IO_UNKNOWN_EOL, ((void*)0), ((void*)0));
      ...
      if (verify_checksum && node_checksum)
        {
          if (checksum && !svn_checksum_match(checksum, node_checksum))
            {
              return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c",195), (svn_error_createf))(SVN_ERR_WC_CORRUPT_TEXT_BASE, ((void*)0),
                                         ...
                                         apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(base_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c", 233, "svn_dirent_is_absolute(base_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(&pristine_stream, base_file_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_wc__versioned_file_modcheck(svn_boolean_t *modified_p,
                                ...
                                apr_pool_t *scratch_pool)
{
  return (svn_wc__internal_versioned_file_modcheck( modified_p, wc_ctx->db, versioned_file_abspath, base_file_abspath, (!0) , scratch_pool));
  ...
  if (! force_comparison)
    {
      svn_filesize_t translated_size;
      apr_time_t last_mod_time;
# 322 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
...
# 583 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (base_shadowed)
