...
svn_wc__db_temp_op_set_property_conflict_marker_file(svn_wc__db_t *db,
                                                     ...
                                                     apr_pool_t *scratch_pool);
# 2453 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_temp_op_set_rev_and_repos_relpath(svn_wc__db_t *db,
                                             ...
                                             apr_pool_t *scratch_pool);
# 2485 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
# 75 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
...
# 123 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  *props = apr_hash_make(result_pool);
  ...
  *all_wcprops = apr_hash_make(result_pool);
  ...
  for (hi = apr_hash_first(scratch_pool, dirents);
       ...
       hi = apr_hash_next(hi))
    {
      ...
      do { if (!(wcprops != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c", 194, "wcprops != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  while (1729)
    {
      ...
      if (eof)
        {
          if (line->len > 0)
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",245), (svn_error_createf))
...
# 354 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
...
wipe_obsolete_files(const char *wcroot_abspath, apr_pool_t *scratch_pool)
{
  ...
  svn_error_clear(svn_io_remove_file2(
                     svn_wc__adm_child(wcroot_abspath,
                                      ...
                                      scratch_pool),
                     (!0), scratch_pool));
# 516 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  svn_error_clear(svn_io_remove_file2(
                    build_lockfile_path(wcroot_abspath, scratch_pool),
                    (!0), scratch_pool));
}
# 531 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  if (entry->repos == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",567), (svn_error_createf))(
  ...
  if (entry->uuid == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",574), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
   ...
   if (entry->url == ((void*)0))
     return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",581), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 854 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
...
migrate_props(const char *old_wcroot_abspath,
              ...
              apr_pool_t *scratch_pool)
{
# 1018 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  const apr_array_header_t *children;
  apr_pool_t *iterpool = svn_pool_create_ex(scratch_pool, ((void*)0));
  const char *dir_relpath = svn_dirent_skip_ancestor(new_wcroot_abspath,
                                                     old_wcroot_abspath);
  ...
  for (hi = apr_hash_first(scratch_pool, dirents); hi;
            hi = apr_hash_next(hi))
    {
      ...
      text_base_path = svn_dirent_join(text_base_dir, text_base_basename,
                                       iterpool);
# 1112 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1179 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1199 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { if (!(!data->sdb)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c", 1217, "!data->sdb")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (logfile_on_disk == svn_node_file)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1225), (svn_error_create))(SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 1252 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1287 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1303 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  if (old_format != 12)
    {
  ...
  data->sdb = ((void*)0);
# 1348 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  wipe_obsolete_files(dir_abspath, scratch_pool);
# 1358 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
  return 0;
}
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  if (start_format < 12 )
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c",1373), (svn_error_createf))(SVN_ERR_WC_UPGRADE_REQUIRED, ((void*)0),
...
# 1401 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
        *result_format = 13;
      ...
      case 17:
        ...
        *result_format = 18;
# 1478 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
    }
# 1492 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1594 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
...
# 1605 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/upgrade.c"
