...
# 136 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
static svn_error_t *
          ...
          apr_pool_t *scratch_pool)
{
  ...
  svn_boolean_t base_replace = 0;
  svn_wc__db_status_t base_status;
  svn_revnum_t base_revision = ((svn_revnum_t) -1);
  const svn_checksum_t *base_checksum;
  const char *pristine_abspath;

  do { svn_error_t *svn_err__temp = (svn_wc__db_read_info(&status, &kind, &revision, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &checksum, ((void*)0), &original_repos_relpath, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &op_root, &had_props, &props_mod, &have_base, &have_more_work, ((void*)0), db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ((status == svn_wc__db_status_added) && (have_base || have_more_work))
    {
      do { svn_error_t *svn_err__temp = (svn_wc__db_node_check_replace(&replaced, &base_replace, ((void*)0), db, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (replaced && base_replace )
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__db_base_get_info(&base_status, &base_kind, &base_revision, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &base_checksum, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        ...
        {
# 203 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
          replaced = 0;
          base_replace = 0;
        }
    }
...
# 226 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
  if (status == svn_wc__db_status_deleted ||
      (base_replace && ! eb->ignore_ancestry))
    {
      ...
      if (base_replace && ! eb->ignore_ancestry)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__db_base_get_props(&del_props, db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      else
        {
          ...
          do { if (!(status == svn_wc__db_status_deleted)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c", 245, "status == svn_wc__db_status_deleted")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

          do { svn_error_t *svn_err__temp = (svn_wc__get_pristine_props(&del_props, db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


          do { svn_error_t *svn_err__temp = (svn_wc__db_read_pristine_info(((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), &del_checksum, ((void*)0), ((void*)0), db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



        }

      do { if (!(del_checksum != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c", 256, "del_checksum != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

      do { svn_error_t *svn_err__temp = (svn_wc__db_pristine_get_path(&del_text_abspath, db, local_abspath, del_checksum, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (eb->callbacks->file_deleted(((void*)0), ((void*)0), path, del_text_abspath, empty_file, del_mimetype, ((void*)0), del_props, eb->callback_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 276 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
      if (status == svn_wc__db_status_deleted)
        {
  ...
  if (checksum != ((void*)0))
    do { svn_error_t *svn_err__temp = (svn_wc__db_pristine_get_path(&pristine_abspath, db, local_abspath, checksum, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  else if (base_replace && eb->ignore_ancestry)
    do { svn_error_t *svn_err__temp = (svn_wc__db_pristine_get_path(&pristine_abspath, db, local_abspath, base_checksum, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  else
    pristine_abspath = empty_file;
# 302 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
  if ((! base_replace && status == svn_wc__db_status_added) ||
         ...
         (eb->show_copies_as_adds || eb->use_git_diff_format)))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_prop_diffs(&propchanges, actual_props, pristine_props, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (eb->callbacks->file_added(((void*)0), ((void*)0), ((void*)0), path, (! eb->show_copies_as_adds && eb->use_git_diff_format && status != svn_wc__db_status_added) ? pristine_abspath : empty_file, translated, 0, revision, ((void*)0), actual_mimetype, original_repos_relpath, ((svn_revnum_t) -1), propchanges, pristine_props, eb->callback_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 345 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
    }
  else
    {
      const char *translated = ((void*)0);
      ...
      if (base_replace
          && eb->ignore_ancestry)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__db_base_get_props(&pristine_props, db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      else
        {
          ...
          do { if (!(!replaced || status == svn_wc__db_status_copied || status == svn_wc__db_status_moved_here)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c", 391, "!replaced || status == svn_wc__db_status_copied || status == svn_wc__db_status_moved_here")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      if (modified || propchanges->nelts > 0)
        {
          do { svn_error_t *svn_err__temp = (eb->callbacks->file_changed(((void*)0), ((void*)0), ((void*)0), path, modified ? pristine_abspath : ((void*)0), translated, revision, ((svn_revnum_t) -1), pristine_mimetype, actual_mimetype, propchanges, pristine_props, eb->callback_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 425 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
        }
    }
             ...
             apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c", 530, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__internal_walk_status(wc_ctx->db, local_abspath, depth, get_all, (!0) , 0 , ((void*)0) , diff_status_callback, &eb, ((void*)0), ((void*)0), cancel_func, cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 569 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/diff_local.c"
  return 0;
}
