  ...
  while (1729)
    {
      ...
      if (eof)
        {
          if (line->len > 0)
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",252), (svn_error_createf))
...
wipe_obsolete_files(const char *wcroot_abspath, apr_pool_t *scratch_pool)
{
  ...
  svn_error_clear(svn_io_remove_file2(
                     svn_wc__adm_child(wcroot_abspath,
                                      ...
                                      scratch_pool),
                     (!0), scratch_pool));
# 499 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  svn_error_clear(svn_io_remove_file2(
...
# 562 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  if (entry->repos == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",598), (svn_error_createf))(
  ...
  if (entry->uuid == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",605), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
   ...
   if (entry->url == ((void*)0))
     return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",612), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
{
  do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(sdb, 101)); if (svn_err__temp) return (svn_err__temp); } while (0);

  return 0;
}
# 885 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
              ...
              apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_check_path(lockfile_abspath, &kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
bump_to_14(void *baton, svn_sqlite__db_t *sdb, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(sdb, 102)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (migrate_locks(wcroot_abspath, sdb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(sdb, 104)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
migrate_props(const char *dir_abspath,
              ...
              apr_pool_t *scratch_pool)
{
# 1052 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  const apr_array_header_t *children;
  apr_pool_t *iterpool = svn_pool_create_ex(scratch_pool, ((void*)0));
  const char *old_wcroot_abspath
    = svn_dirent_get_longest_ancestor(dir_abspath, new_wcroot_abspath,
...
bump_to_18(void *baton, svn_sqlite__db_t *sdb, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (migrate_props(b18->wcroot_abspath, b18->wcroot_abspath, sdb, b18->original_format, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(scratch_pool, dirents); hi;
            hi = apr_hash_next(hi))
    {
      ...
      text_base_path = svn_dirent_join(text_base_dir, text_base_basename,
                                       iterpool);
# 1149 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
...
bump_to_17(void *baton, svn_sqlite__db_t *sdb, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(sdb, 105)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (migrate_text_bases(wcroot_abspath, wcroot_abspath, sdb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1226 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
...
# 1246 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (logfile_on_disk == svn_node_file)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1268), (svn_error_create))(SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 1295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
...
# 1343 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
      do { svn_error_t *svn_err__temp = (svn_wc__db_temp_reset_format(20, db, data->root_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__write_upgraded_entries(db, data->sdb, data->repos_id, data->wc_id, dir_abspath, data->root_abspath, entries, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1358 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  if (old_format != 12)
    {
  ...
  do { svn_error_t *svn_err__temp = (migrate_text_bases(dir_abspath, data->root_abspath, data->sdb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__db_upgrade_finish(dir_abspath, data->sdb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  if (start_format < 12 )
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1407), (svn_error_createf))(SVN_ERR_WC_UPGRADE_REQUIRED, ((void*)0),
  ...
  switch (start_format)
    {
      case 12:
        do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_13, &bb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1435 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
        *result_format = 13;


      case 13:

        do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_14, &bb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      case 14:
        ...
        do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_15, &bb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      case 15:
        ...
        do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_16, &bb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      case 16:
        {
          ...
          pristine_dir = svn_wc__adm_child(wcroot_abspath,
                                           "pristine",
                                           scratch_pool);
          do { svn_error_t *svn_err__temp = (svn_wc__ensure_directory(pristine_dir, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


          do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_17, &bb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      case 17:
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_sqlite__with_transaction(sdb, bump_to_18, &b18, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      case 18:
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1496), (svn_error_createf))(SVN_ERR_UNSUPPORTED_FEATURE, ((void*)0),
                                 dcgettext ("subversion", "The working copy '%s' is at format 18; " "use 'tools/dev/wc-ng/bump-to-19.py' to " "upgrade it", 5), wcroot_abspath);
      ...
      case 19:
        ...
        *result_format = 20;
# 1518 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
    }
# 1532 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (upgrade_to_wcng(db, dir_abspath, old_format, repos_info_func, repos_info_baton, repos_cache, data, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < subdirs->nelts; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (upgrade_working_copy(db, child_abspath, repos_info_func, repos_info_baton, repos_cache, data, cancel_func, cancel_baton, notify_func, notify_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *scratch_pool)
{
  ...
  if (!is_old_wcroot(local_abspath, scratch_pool))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1679), (svn_error_createf))(
      SVN_ERR_WC_INVALID_OP_ON_CWD, ((void*)0),
      dcgettext ("subversion", "Cannot upgrade '%s' as it is not a pre-1.7 working copy root", 5),
      svn_dirent_local_style(local_abspath, scratch_pool));
# 1693 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  ...
  do { svn_error_t *svn_err__temp = (upgrade_working_copy(db, local_abspath, repos_info_func, repos_info_baton, apr_hash_make(scratch_pool), &data, cancel_func, cancel_baton, notify_func, notify_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  pristine_to = svn_wc__adm_child(local_abspath, "pristine",
                                  scratch_pool);
  do { svn_error_t *svn_err__temp = (svn_wc__wq_build_file_move(&work_item, db, pristine_from, pristine_to, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
