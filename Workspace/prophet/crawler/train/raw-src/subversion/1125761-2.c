# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2

# 1 "./subversion/include/private/svn_cache.h" 1
# 32 "./subversion/include/private/svn_cache.h"
...
# 33 "./subversion/include/private/svn_cache.h" 2
...
# 35 "./subversion/include/private/svn_cache.h" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c" 2
                   ...
                   apr_pool_t *pool)
{
  ...
  if (data_len != sizeof(*in_rev))
    return svn_error_create(SVN_ERR_REVNUM_PARSE_FAILURE, ((void*)0),
                            dcgettext ("subversion", "Bad size for revision number in cache", 5));
                 ...
                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__get((void **) &answer, &found, cache, "twenty", subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (found)
    return svn_error_create(SVN_ERR_TEST_FAILED, ((void*)0),
                            "cache found an entry that wasn't there");
  apr_pool_clear(subpool);

  do { svn_error_t *svn_err__temp = (svn_cache__set(cache, "twenty", &twenty, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  apr_pool_clear(subpool);
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__set(cache, "thirty", &thirty, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  apr_pool_clear(subpool);

  do { svn_error_t *svn_err__temp = (svn_cache__get((void **) &answer, &found, cache, "thirty", subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (! found)
    return svn_error_create(SVN_ERR_TEST_FAILED, ((void*)0),
...
test_inprocess_cache_basic(apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&cache, serialize_revnum, deserialize_revnum, (-1), 1, 1, (!0), "", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 142 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/cache-test.c"
  return basic_cache_test(cache, (!0), pool);
}
                    ...
                    apr_pool_t *pool)
{
  svn_cache__t *cache;
  svn_config_t *config;
  svn_memcache_t *memcache = ((void*)0);
  const char *prefix = apr_psprintf(pool,
                                    "test_memcache_basic-%" "ld",
                                    apr_time_now());

  if (opts->config_file)
    {
      do { svn_error_t *svn_err__temp = (svn_config_read2(&config, opts->config_file, (!0), 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { svn_error_t *svn_err__temp = (svn_cache__make_memcache_from_config(&memcache, config, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__create_memcache(&cache, memcache, serialize_revnum, deserialize_revnum, (-1), prefix, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
test_membuffer_cache_basic(apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__membuffer_cache_create(&membuffer, 10*1024, 1, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache(&cache, membuffer, serialize_revnum, deserialize_revnum, (-1), "cache:", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                       ...
                       apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__set(cache, long_key, &fifty, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_cache__get((void **) &answer, &found, cache, long_key, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
struct svn_test_descriptor_t test_funcs[] =
  {
    {0},
    {svn_test_pass, test_inprocess_cache_basic, ((void*)0), "basic inprocess svn_cache test"},

    {svn_test_pass, ((void*)0), test_memcache_basic, "basic memcache svn_cache test"},

    {svn_test_pass, ((void*)0), test_memcache_long_key, "memcache svn_cache with very long keys"},


    {svn_test_pass, test_membuffer_cache_basic, ((void*)0), "basic membuffer svn_cache test"},
