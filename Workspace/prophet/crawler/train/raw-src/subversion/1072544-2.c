...
# 90 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/caching.c"
  if (svn_fs__get_global_membuffer_cache())
      ...
      do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->rev_root_id_cache), svn_fs_fs__serialize_id, svn_fs_fs__deserialize_id, sizeof(svn_revnum_t), 1, 100, 0, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  if (! no_handler)
      do { svn_error_t *svn_err__temp = (svn_cache__set_error_handler(ffd->rev_root_id_cache, warn_on_cache_errors, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (svn_fs__get_global_membuffer_cache())
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->rev_node_cache), svn_fs_fs__dag_serialize, svn_fs_fs__dag_deserialize, (-1), 1024, 16, 0, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  if (! no_handler)
    do { svn_error_t *svn_err__temp = (svn_cache__set_error_handler(ffd->rev_node_cache, warn_on_cache_errors, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (svn_fs__get_global_membuffer_cache())
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->dir_cache), svn_fs_fs__serialize_dir_entries, svn_fs_fs__deserialize_dir_entries, (-1), 1024, 8, 0, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! no_handler)
    do { svn_error_t *svn_err__temp = (svn_cache__set_error_handler(ffd->dir_cache, warn_on_cache_errors, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (svn_fs__get_global_membuffer_cache())
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->packed_offset_cache), svn_fs_fs__serialize_manifest, svn_fs_fs__deserialize_manifest, sizeof(svn_revnum_t), 32, 1, 0, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! no_handler)
    do { svn_error_t *svn_err__temp = (svn_cache__set_error_handler(ffd->packed_offset_cache, warn_on_cache_errors, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (ffd->fulltext_cache && ! no_handler)
    do { svn_error_t *svn_err__temp = (svn_cache__set_error_handler(ffd->fulltext_cache, warn_on_cache_errors, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
