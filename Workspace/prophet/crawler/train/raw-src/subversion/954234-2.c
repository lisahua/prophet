...
svn_error_t *svn_config__parse_file(svn_config_t *cfg,
                                    ...
                                    svn_boolean_t must_exist,
                                    apr_pool_t *pool);
# 135 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h"
svn_error_t *
...
# 1 "./subversion/svn_private_config.h" 1
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
# 76 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
...
parse_option(int *pch, parse_context_t *ctx, apr_pool_t *pool)
{
  ...
  if (ch != ':' && ch != '=')
    {
      ch = (-1);
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c",256), (svn_error_createf))(SVN_ERR_MALFORMED_FILE, ((void*)0),
...
# 281 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
static svn_error_t *
parse_section_name(int *pch, parse_context_t *ctx, apr_pool_t *pool)
{
  ...
  if (ch != ']')
    {
      ch = (-1);
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c",299), (svn_error_createf))(SVN_ERR_MALFORMED_FILE, ((void*)0),
...
{
  *path_p = ((void*)0);
# 336 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
      ...
      switch (ch)
        ...
        case '[':
          if (count == 0)
            ...
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c",386), (svn_error_createf))(SVN_ERR_MALFORMED_FILE, ((void*)0),
                                     "%s:%d: Section header"
        ...
        case '#':
          if (count == 0)
            ...
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c",400), (svn_error_createf))(SVN_ERR_MALFORMED_FILE, ((void*)0),
                                     "%s:%d: Comment"
                                     " must start in the first column",
                                     svn_dirent_local_style(file, pool),
                                     ctx.line);
        ...
        default:
          if (svn_stringbuf_isempty(ctx.section))
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c",416), (svn_error_createf))(SVN_ERR_MALFORMED_FILE, ((void*)0),
                                     "%s:%d: Section header expected",
                                     svn_dirent_local_style(file, pool),
                                     ctx.line);
          else if (count != 0)
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c",421), (svn_error_createf))(SVN_ERR_MALFORMED_FILE, ((void*)0),
                                     "%s:%d: Option expected",
                                     svn_dirent_local_style(file, pool),
                                     ctx.line);
          else
...
# 542 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "# password-stores =" "\n"
# 961 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
        "###" "\n"
...
# 1121 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  {
