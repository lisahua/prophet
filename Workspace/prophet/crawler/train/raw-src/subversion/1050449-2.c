# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
# 22 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c"
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
svn_fspath__get_longest_ancestor(const char *fspath1,
                                 const char *fspath2,
                                 apr_pool_t *result_pool);
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c" 2
...
{
  return svn_opt_print_help3(((void*)0), "svnversion", (!0), 0, ((void*)0), ((void*)0),
                             ((void*)0), ((void*)0), ((void*)0), ((void*)0), pool);
}
...
usage(apr_pool_t *pool)
{
  svn_error_clear(svn_cmdline_fprintf
                  (stderr, pool, dcgettext ("subversion", "Type 'svnversion --help' for usage.\n", 5)));
  exit(1);
}
...
main(int argc, const char *argv[])
{
  ...
  svn_boolean_t no_newline = 0, committed = 0;
  svn_error_t *err;
  apr_getopt_t *os;
  svn_node_kind_t kind;
  svn_wc_context_t *wc_ctx;
  ...
  if (svn_cmdline_init("svnversion", stderr) != 0)
    return 1;
...
# 171 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnversion/main.c"
  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 'h':
          ...
          break;
        case 256:
          do { svn_error_t *svn_err__temp = (version(pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
          exit(0);
          break;
        default:
          usage(pool);
  ...
  do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8 (&wc_path, (os->ind < argc) ? os->argv[os->ind] : ".", pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);


  wc_path = svn_dirent_internal_style(wc_path, pool);
  do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&local_abspath, wc_path, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  do { svn_error_t *svn_err__temp = (svn_wc_context_create(&wc_ctx, ((void*)0), pool, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);

  if (os->ind+1 < argc)
    do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8 (&trail_url, os->argv[os->ind+1], pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);

  else
    trail_url = ((void*)0);

  do { svn_error_t *svn_err__temp = (svn_io_check_path(wc_path, &kind, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  if (kind == svn_node_dir)
    {
      do { svn_error_t *svn_err__temp = (svn_wc_check_wc2(&wc_format, wc_ctx, local_abspath, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
      if (wc_format == 0)
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Unversioned directory%s", 5), no_newline ? "" : "\n")); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);

          apr_pool_destroy(pool);
          return 0;
        }
      do { svn_error_t *svn_err__temp = (svn_wc_revision_status2(&res, wc_ctx, local_abspath, trail_url, committed, ((void*)0), ((void*)0), pool, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);


    }
  else if (kind == svn_node_file)
    {
      do { svn_error_t *svn_err__temp = (svn_wc_check_wc2(&wc_format, wc_ctx, svn_dirent_dirname(local_abspath, pool), pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
      ...
      if (wc_format == 0)
        {
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Unversioned file%s", 5), no_newline ? "" : "\n")); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
      ...
      err = svn_wc_revision_status2(&res, wc_ctx, local_abspath,
                                    trail_url, committed, ((void*)0), ((void*)0),
                                    pool, pool);
          ...
          if (err->apr_err == SVN_ERR_WC_PATH_NOT_FOUND)
            {
              ...
              do { svn_error_t *svn_err__temp = (err); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
        }
  ...
  else if (kind == svn_node_none)
    {
      svn_error_clear(svn_cmdline_fprintf(stderr, pool,
                                          dcgettext ("subversion", "'%s' doesn't exist\n", 5),
    ...
    {
      svn_error_clear(svn_cmdline_fprintf(stderr, pool,
                                          dcgettext ("subversion", "'%s' is of unknown type\n", 5),
                                          svn_dirent_local_style(wc_path, pool)));
      apr_pool_destroy(pool);
      return 1;
    }
  ...
  if (! ((res->min_rev) >= 0))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Uncommitted local addition, " "copy or move%s", 5), no_newline ? "" : "\n")); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%ld", res->min_rev)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  if (res->min_rev != res->max_rev)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, ":%ld", res->max_rev)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  if (res->modified)
    do { svn_error_t *svn_err__temp = (svn_cmdline_fputs("M", stdout, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  if (res->switched)
    do { svn_error_t *svn_err__temp = (svn_cmdline_fputs("S", stdout, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  if (res->sparse_checkout)
    do { svn_error_t *svn_err__temp = (svn_cmdline_fputs("P", stdout, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);

  if (! no_newline)
    do { svn_error_t *svn_err__temp = (svn_cmdline_fputs("\n", stdout, pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
