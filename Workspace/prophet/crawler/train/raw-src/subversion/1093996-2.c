  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      cache->hit_count++;
      cache->total_hits++;
# 1236 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->hit_count++;
      cache->total_writes++;
# 1306 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      ...
      if (data != orig_data)
        {
          ...
          if ( (cache->data_size / 4 > size)
              && ensure_data_insertable(cache, size))
            {
              ...
              insert_entry(cache, entry);
# 1338 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
            }
        }
    }
...
typedef struct svn_membuffer_cache_t
{
  ...
  int alloc_counter;
# 1411 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
} svn_membuffer_cache_t;
# 1422 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static void
...
# 1481 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 1775 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
