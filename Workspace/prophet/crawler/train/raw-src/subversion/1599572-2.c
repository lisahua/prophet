# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/binary_diff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/binary_diff.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/binary_diff.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/binary_diff.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/binary_diff.c" 2
...
svn_diff_file_output_merge(svn_stream_t *output_stream,
                           ...
                           apr_pool_t *pool);
# 764 "./subversion/include/svn_diff.h"
svn_error_t *
svn_diff_output_binary(svn_stream_t *output_stream,
                       ...
                       void *cancel_baton,
                       apr_pool_t *scratch_pool);
# 779 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_mem_string_output_merge2(svn_stream_t *output_stream,
                                  ...
                                  apr_pool_t *pool);
# 901 "./subversion/include/svn_diff.h"
__attribute__((deprecated))
svn_error_t *
svn_diff_mem_string_output_merge(svn_stream_t *output_stream,
                                 ...
                                 svn_boolean_t display_resolved_conflicts,
                                 apr_pool_t *pool);
# 926 "./subversion/include/svn_diff.h"
...
svn_diff_hunk_readline_diff_text(svn_diff_hunk_t *hunk,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 1021 "./subversion/include/svn_diff.h"
svn_error_t *
svn_diff_hunk_readline_original_text(svn_diff_hunk_t *hunk,
                                     ...
                                     apr_pool_t *result_pool,
                                     apr_pool_t *scratch_pool);
# 1036 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_open_patch_file(svn_patch_file_t **patch_file,
                         ...
                         apr_pool_t *result_pool);
# 1170 "./subversion/include/svn_diff.h"
svn_error_t *
...
svn_diff_close_patch_file(svn_patch_file_t *patch_file,
                          apr_pool_t *scratch_pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/binary_diff.c" 2
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_open_uniquely_named(result, ((void*)0), ((void*)0), "diffgz", ((void*)0), svn_io_file_del_on_pool_cleanup, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  compressed = svn_stream_compressed(
                  svn_stream_from_aprfile2(*result, (!0), scratch_pool),
                  scratch_pool);
  ...
  if (original_stream)
    do
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_read_full(original_stream, buffer, &rd)); if (svn_err__temp) return (svn_err__temp); } while (0);

      bytes_read += rd;
      do { svn_error_t *svn_err__temp = (svn_stream_write(compressed, buffer, &rd)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
    while(rd == 102400);
  else
    {
      apr_size_t zero = 0;
      do { svn_error_t *svn_err__temp = (svn_stream_write(compressed, ((void*)0), &zero)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }

  do { svn_error_t *svn_err__temp = (svn_stream_close(compressed)); if (svn_err__temp) return (svn_err__temp); } while (0);

  *full_size = bytes_read;
  do { svn_error_t *svn_err__temp = (svn_io_file_info_get(&finfo, 0x00000100, *result, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  apr_size_t rd;
  do { svn_error_t *svn_err__temp = (svn_stream_seek(compressed_data, ((void*)0))); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_stream_printf(output_stream, scratch_pool, "literal %" "ld" "\n", uncompressed_size)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_read_full(compressed_data, chunk, &rd)); if (svn_err__temp) return (svn_err__temp); } while (0);

      {
        apr_size_t one = 1;
        do { svn_error_t *svn_err__temp = (svn_stream_write(output_stream, &b85lenstr[rd-1], &one)); if (svn_err__temp) return (svn_err__temp); } while (0);
      }
      ...
      while (left)
      {
        ...
        five_sz = 5;
        do { svn_error_t *svn_err__temp = (svn_stream_write(output_stream, five, &five_sz)); if (svn_err__temp) return (svn_err__temp); } while (0);
      }

      do { svn_error_t *svn_err__temp = (svn_stream_puts(output_stream, "\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  while (rd == 52);
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (create_compressed(&original_apr, &original_full, &original_deflated, original, cancel_func, cancel_baton, scratch_pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  apr_pool_clear(subpool);

  do { svn_error_t *svn_err__temp = (create_compressed(&latest_apr, &latest_full, &latest_deflated, latest, cancel_func, cancel_baton, scratch_pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  apr_pool_clear(subpool);

  do { svn_error_t *svn_err__temp = (svn_stream_puts(output_stream, "GIT binary patch" "\n")); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (write_literal(original_full, svn_stream_from_aprfile2(original_apr, 0, subpool), output_stream, cancel_func, cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (write_literal(latest_full, svn_stream_from_aprfile2(latest_apr, 0, subpool), output_stream, cancel_func, cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
