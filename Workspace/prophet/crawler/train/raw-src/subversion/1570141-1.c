# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/delta.h" 1
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/delta.h"
...
void svn_txdelta__xdelta(svn_txdelta__ops_baton_t *build_baton,
                         ...
                         apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c" 2
# 69 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c"
static __inline__ apr_uint32_t
adler32_replace(apr_uint32_t adler32, const char c_out, const char c_in)
{
  adler32 -= (64 * 0x10000u * ((unsigned char) c_out));
...
init_adler32(const char *data)
{
  ...
  const unsigned char *last = input + 64;
...
struct blocks
{
  ...
  const char* data;
# 142 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c"
  char flags[(32 * 1024) / 8];
...
add_block(struct blocks *blocks, apr_uint32_t adlersum, apr_uint32_t pos)
{
  ...
  for (; blocks->slots[h].pos != ((apr_uint32_t)-1); h = (h + 1) & blocks->max)
                  ...
                  apr_pool_t *pool)
{
  ...
  nblocks = datalen / 64 + 1;

  while (wnslots <= nblocks)
    wnslots *= 2;

  wnslots *= 2;
# 239 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c"
  nslots = (apr_uint32_t) wnslots;
  do { if (!(wnslots == nslots)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c", 240, "wnslots == nslots"); abort(); } } while (0);
  blocks->max = nslots - 1;
  blocks->data = data;
  ...
  for (i = 0; i < nslots; ++i)
    {
      ...
      blocks->slots[i].pos = ((apr_uint32_t)-1);
    }
  ...
  for (i = 0; i + 64 <= datalen; i += 64)
    add_block(blocks, init_adler32(data + i), i);
}
# 270 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c"
static apr_size_t
           ...
           apr_size_t pending_insert_start)
{
  ...
  if (apos == ((apr_uint32_t)-1))
    return 0;


  max_delta = asize - apos - 64 < bsize - bpos - 64
            ? asize - apos - 64
            : bsize - bpos - 64;
  delta = svn_cstring__match_length(a + apos + 64,
                                    b + bpos + 64,
                                    max_delta);
...
# 371 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c"
static void
  ...
  while (lo < bsize)
    {
      ...
      while (!(blocks.flags[hash_flags(rolling)] & (1 << (rolling & 7)))
             && lo < upper)
        {
          rolling = adler32_replace(rolling, b[lo], b[lo+64]);
          lo++;
        }
                    ...
                    apr_pool_t *pool)
{
  ...
  ((source_len != 0) ? (void) (0) : __assert_fail ("source_len != 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/xdelta.c", 493, __PRETTY_FUNCTION__));
