# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cleanup-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cleanup-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cleanup-cmd.c"
...
svn_client_patch(const char *patch_abspath,
                 ...
                 apr_pool_t *result_pool,
                 apr_pool_t *scratch_pool);
# 5650 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cleanup-cmd.c" 2
...
svn_uri_skip_ancestor(const char *parent_uri,
                      const char *child_uri,
                      apr_pool_t *result_pool);
# 700 "./subversion/include/svn_dirent_uri.h"
svn_error_t *
svn_dirent_condense_targets(const char **pcommon,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 741 "./subversion/include/svn_dirent_uri.h"
svn_error_t *
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cleanup-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cleanup-cmd.c" 2
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cleanup-cmd.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cleanup-cmd.c" 2
          ...
          else
            {
              ...
              if (err2)
                ...
                err = svn_error_createf(SVN_ERR_WC_LOCKED, err,
                                        dcgettext ("subversion", "Working copy locked; try running " "'svn cleanup' on the root of the " "working copy ('%s') instead.", 5),
