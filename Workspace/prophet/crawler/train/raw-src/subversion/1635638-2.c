# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
svn_io_file_readline(apr_file_t *file,
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
svn_fs_x__deserialize_p2l_page(void **out,
                               ...
                               apr_size_t data_len,
                               apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
svn_fs_x__move_into_place(const char *old_filename,
                          ...
                          apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
svn_fs_x__order_dir_entries(svn_fs_t *fs,
                            ...
                            apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
svn_fs_x__deserialize_mergeinfo(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
svn_error_t *svn_fs_x__file_checksum(svn_checksum_t **checksum,
                                     ...
                                     svn_checksum_kind_t kind,
                                     apr_pool_t *pool);
# 122 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/fs_x.h"
svn_error_t *
...
svn_error_t *svn_fs_x__set_uuid(svn_fs_t *fs,
                                ...
                                const char *instance_id,
                                apr_pool_t *pool);
# 154 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/fs_x.h"
const char *
...
# 172 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/fs_x.h"
svn_error_t *
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c" 2
...
# 226 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c"
                           ...
                           apr_pool_t *pool)
{
  ...
  do { if (!(written == sizeof(entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 446, "written == sizeof(entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                    ...
                                    apr_pool_t *pool)
{
  ...
  do { if (!(offset >= -1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 470, "offset >= -1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(item_index < (2147483647 *2U +1U) / 2)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 477, "item_index < UINT_MAX / 2")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  for (i = start; i < end; ++i)
    {
      ...
      ((value > 0) ? (void) (0) : __assert_fail ("value > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 527, __PRETTY_FUNCTION__));
  ...
  for (entry = 0; !eof; ++entry)
    {
      ...
      do { if (!(eof || read == sizeof(proto_entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 732, "eof || read == sizeof(proto_entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 1387 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c"
static svn_error_t *
...
# 1420 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  *end = 0;
  ...
  ((revision <= (4294967295U)) ? (void) (0) : __assert_fail ("revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1450, __PRETTY_FUNCTION__));
                 ...
                 apr_pool_t *pool)
{
  ...
  ((revision <= (4294967295U)) ? (void) (0) : __assert_fail ("revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1527, __PRETTY_FUNCTION__));
  key.revision = (apr_uint32_t)revision;
  key.is_packed = svn_fs_x__is_packed_rev(fs, revision);
  ...
  while (!eof)
    {
      ...
      do { if (!(eof || read == sizeof(entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1630, "eof || read == sizeof(entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                    ...
                                    apr_pool_t *pool)
{
  ...
  do { if (!(written == sizeof(*entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1750, "written == sizeof(*entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (entry->item_count)
    {
      ...
      do { if (!(written == entry->item_count * sizeof(*entry->items))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1759, "written == entry->item_count * sizeof(*entry->items)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      written_total += written;
    }
  ...
  do { if (!(written == sizeof(written_total))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1767, "written == sizeof(written_total)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  while (!eof)
    {
      ...
      do { if (!(eof || read == sizeof(entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1865, "eof || read == sizeof(entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      if (entry.item_count && !eof)
        {
          ...
          do { if (!(eof || read == to_read)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1874, "eof || read == to_read")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
        }
      ...
      if (!eof)
        {
          ...
          do { if (!(eof || read == to_read)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 1884, "eof || read == to_read")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
        }
...
# 2286 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c"
static svn_error_t *
...
# 2347 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  *end = 0;
  ...
  ((baton->first_revision <= (4294967295U)) ? (void) (0) : __assert_fail ("baton->first_revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 2373, __PRETTY_FUNCTION__));
...
# 2402 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c"
             ...
             apr_pool_t *pool)
{
  ...
  if (key_p)
    {
      svn_fs_x__page_cache_key_t key = { 0 };
      ((page_info.first_revision <= (4294967295U)) ? (void) (0) : __assert_fail ("page_info.first_revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 2444, __PRETTY_FUNCTION__));
                 ...
                 apr_pool_t *pool)
{
  ...
  do { if (!(block_start < block_end)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 2579, "block_start < block_end")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(entries->nelts > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 2652, "entries->nelts > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  while (block_start < block_end)
    {
      ...
      do { if (!(result->nelts > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 2712, "result->nelts > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      if (last_count > 0 && last_count < result->nelts)
        {
           ...
           do { if (!((((svn_fs_x__p2l_entry_t *)(result)->elts)[last_count]).offset >= entry->offset + entry->size)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 2726, "APR_ARRAY_IDX(result, last_count, svn_fs_x__p2l_entry_t).offset >= entry->offset + entry->size")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                     ...
                     const sub_item_ordered_t * rhs)
{
  ...
  ((lhs != rhs) ? (void) (0) : __assert_fail ("lhs != rhs", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 3129, __PRETTY_FUNCTION__));
  ...
  for (i = 0; i < entries->nelts; ++i)
    {
      ...
      ((entry) ? (void) (0) : __assert_fail ("entry", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/index.c", 3193, __PRETTY_FUNCTION__));
      ordered->entry = entry;
