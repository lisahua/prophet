...
# 92 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c", 108, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 145 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
          if (node_checksum)
          ...
          if (compare_textbases && need_translation)
            {
              if (eol_style == svn_subst_eol_style_native)
                ...
                return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c",168), (svn_error_create))(SVN_ERR_IO_UNKNOWN_EOL, ((void*)0), ((void*)0));
      ...
      if (verify_checksum && node_checksum)
        {
          if (checksum && !svn_checksum_match(checksum, node_checksum))
            {
              return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c",195), (svn_error_createf))(SVN_ERR_WC_CORRUPT_TEXT_BASE, ((void*)0),
                                         ...
                                         apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(base_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c", 233, "svn_dirent_is_absolute(base_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (! force_comparison)
    {
      svn_filesize_t translated_size;
      apr_time_t last_mod_time;
# 322 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
...
# 583 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/questions.c"
  if (base_shadowed)
