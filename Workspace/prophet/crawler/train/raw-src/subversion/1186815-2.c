# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c" 2
...
svn_cl__print_status_xml(const char *path,
                         ...
                         svn_client_ctx_t *ctx,
                         apr_pool_t *pool);
# 428 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__print_xml_lock(svn_stringbuf_t **outstr,
                       const svn_lock_t *lock,
                       apr_pool_t *pool);
# 466 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__edit_string_externally(svn_string_t **edited_contents,
                               ...
                               const char *encoding,
                               apr_pool_t *pool);
# 521 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__edit_file_externally(const char *path,
                             const char *editor_cmd,
                             apr_hash_t *config,
                             apr_pool_t *pool);
# 539 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__merge_file_externally(const char *base_path,
                              ...
                              apr_pool_t *pool);
# 559 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__operation_str_human_readable(svn_wc_operation_t operation,
                                     apr_pool_t *pool);
# 718 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
void
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c" 2
...
svn_cl__changelist(apr_getopt_t *os,
                   ...
                   apr_pool_t *pool)
{
  const char *changelist_name = ((void*)0);
  ...
  if (! opt_state->remove)
    {
      ...
      changelist_name = (((const char * *)(args)->elts)[0]);
      do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8(&changelist_name, changelist_name, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__check_targets_are_local_paths(targets)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (opt_state->quiet)
# 93 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/changelist-cmd.c"
  ...
  if (changelist_name)
    {
      do { svn_error_t *svn_err__temp = (svn_cl__try( svn_client_add_to_changelist(targets, changelist_name, depth, opt_state->changelists, ctx, pool), errors, opt_state->quiet, SVN_ERR_UNVERSIONED_RESOURCE, SVN_ERR_WC_PATH_NOT_FOUND, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    {
      do { svn_error_t *svn_err__temp = (svn_cl__try( svn_client_remove_from_changelists(targets, depth, opt_state->changelists, ctx, pool), errors, opt_state->quiet, SVN_ERR_UNVERSIONED_RESOURCE, SVN_ERR_WC_PATH_NOT_FOUND, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (errors->nelts > 0)
    {
      ...
      err = svn_error_create(SVN_ERR_ILLEGAL_TARGET, ((void*)0), ((void*)0));
      for (i = 0; i < errors->nelts; i++)
        {
          apr_status_t status = (((apr_status_t *)(errors)->elts)[i]);

          if (status == SVN_ERR_WC_PATH_NOT_FOUND)
            err = svn_error_quick_wrap(err,
                                       dcgettext ("subversion", "Could not set changelists on " "all targets because some targets " "don't exist", 5));


          else if (status == SVN_ERR_UNVERSIONED_RESOURCE)
            err = svn_error_quick_wrap(err,
                                       dcgettext ("subversion", "Could not set changelists on " "all targets because some targets " "are not versioned", 5));
