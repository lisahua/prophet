# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
...
void svn_txdelta__xdelta(svn_txdelta__ops_baton_t *build_baton,
                         ...
                         apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
...
svn__decompress(svn_string_t *in,
                svn_stringbuf_t *out,
                apr_size_t limit);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c" 2
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
...
# 91 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
...
encode_int(unsigned char *p, svn_filesize_t val)
{
  ...
  do { if (!(val >= 0)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 98, "val >= 0"); abort(); } } while (0);
  ...
  do { if (!(n <= 10)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 109, "n <= MAX_ENCODED_INT_LEN"); abort(); } } while (0);
...
{
  unsigned char headers[4 + 5 * 10 + (2*10 +1)];
  unsigned char ibuf[(2*10 +1)];
  ...
  ((window->ops[0].action_code == svn_txdelta_new) ? (void) (0) : __assert_fail ("window->ops[0].action_code == svn_txdelta_new", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 201, __PRETTY_FUNCTION__));
  ((window->ops[0].length == window->tview_len) ? (void) (0) : __assert_fail ("window->ops[0].length == window->tview_len", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 202, __PRETTY_FUNCTION__));
  ((window->ops[0].offset == 0) ? (void) (0) : __assert_fail ("window->ops[0].offset == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 203, __PRETTY_FUNCTION__));
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_write(eb->output, (const char *)headers, &header_len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (len)
    do { svn_error_t *svn_err__temp = (svn_stream_write(eb->output, window->new_data->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
window_handler(svn_txdelta_window_t *window, void *baton)
{
  ...
  if (window && !window->src_ops && window->num_ops == 1 && !eb->version)
    return (send_simple_insertion_window(window, eb));
...
# 297 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
  ...
  pool = svn_pool_create_ex(eb->pool, ((void*)0));
...
# 463 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
...
# 527 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
static svn_error_t *
              ...
              unsigned int version)
{
  ...
  if (version == 1)
    {
      ...
      do { svn_error_t *svn_err__temp = (zlib_decode(insend, newlen, ndout, 102400)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { svn_error_t *svn_err__temp = (zlib_decode(data, insend - data, instout, (102400*(2*10 +1)))); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { if (!(data == insend)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c", 765, "data == insend")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 818 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/svndiff.c"
  while (1)
    {
      apr_pool_t *newpool;
