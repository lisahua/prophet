              ...
              apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_info_get(&finfo, 0x00000100, rev_file->file, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 372 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static rep_stats_t *
      ...
      if (!svn_fs_fs__use_log_addressing(query->fs))
        {
          ...
          do { if (!(revision_info->rev_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c", 454, "revision_info->rev_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
read_noderev(query_t *query,
             ...
             apr_pool_t *pool,
             apr_pool_t *scratch_pool);
# 488 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  do { if (!(revision_info->rev_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c", 503, "revision_info->rev_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      if (svn_fs_fs__id_rev(dirent->id) == revision_info->revision)
        {
          ...
          do { svn_error_t *svn_err__temp = (read_noderev(query, noderev_str, revision_info, pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *scratch_pool)
{
  ...
  if (noderev->data_rep)
    {
      do { svn_error_t *svn_err__temp = (parse_representation(&text, query, noderev->data_rep, revision_info, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (noderev->prop_rep)
    {
      do { svn_error_t *svn_err__temp = (parse_representation(&props, query, noderev->prop_rep, revision_info, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ( noderev->kind == svn_node_dir && text && text->ref_count == 1
    ...
    do { svn_error_t *svn_err__temp = (parse_dir(query, noderev, revision_info, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1185 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
