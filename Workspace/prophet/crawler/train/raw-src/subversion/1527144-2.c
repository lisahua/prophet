# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c" 2
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 34 "./subversion/include/private/svn_atomic.h" 2
...
svn_atomic__init_once(volatile apr_uint32_t *global_status,
                      ...
                      void *baton,
                      apr_pool_t* pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c" 2
...
do_some_allocations(apr_pool_t *pool)
{
  ...
  for (i = 0; i < 25; ++i)
    {
      memset(apr_palloc(pool, fib1), 0, fib1);
      fib2 = fib1;
      fib1 = fib;
      fib += fib2;
    }
...
static void *
                thread_func(apr_thread_t *tid, void *data)
{
...
{
  svn_root_pools__t *pools;
  do { svn_error_t *svn_err__temp = (svn_root_pools__create(&pools)); if (svn_err__temp) return (svn_err__temp); } while (0);
  use_root_pool(pools);

  return 0;
}
# 90 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/tests/libsvn_subr/root-pools-test.c"
static svn_error_t *
test_root_pool_concurrency(apr_pool_t *pool)
{
  ...
  for (i = 0; i < THREAD_COUNT; ++i)
    do { apr_status_t status = (apr_thread_create(&threads[i], ((void*)0), thread_func, pools, pool)); if (status) return svn_error_wrap_apr(status, ((void*)0)); } while (0);


  for (i = 0; i < THREAD_COUNT; ++i)
    {
      apr_status_t retval;
      do { apr_status_t status = (apr_thread_join(&retval, threads[i])); if (status) return svn_error_wrap_apr(status, ((void*)0)); } while (0);
      do { apr_status_t status = (retval); if (status) return svn_error_wrap_apr(status, ((void*)0)); } while (0);
    }
...
struct svn_test_descriptor_t test_funcs[] =
  {
    {0},
    {svn_test_pass, test_root_pool, ((void*)0), "test root pool recycling"},

    {(! 1) ? svn_test_skip : svn_test_pass, test_root_pool_concurrency, ((void*)0), "test concurrent root pool recycling"},
