# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c"
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c" 2
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svn-populate-node-origins-index.c" 2
                    ...
                    svn_revnum_t revision, apr_pool_t *pool)
{
  ...
  *count = 0;
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_paths_changed(&changes, root, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if ((change->change_kind == svn_fs_path_change_add)
          || (change->change_kind == svn_fs_path_change_replace))
        {
          ...
          if (! (copyfrom_path && ((copyfrom_rev) >= 0)))
            {
              svn_revnum_t origin;
              do { svn_error_t *svn_err__temp = (svn_fs_node_origin_rev(&origin, root, path, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              (*count)++;
            }
        }
    }
...
build_index(const char *repos_path, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_repos_open(&repos, repos_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < youngest_rev; i++)
    {
      int count;
      apr_pool_clear(subpool);
      do { svn_error_t *svn_err__temp = (index_revision_adds(&count, fs, i + 1, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
main(int argc, const char **argv)
{
  ...
  if (svn_cmdline_init(argv[0], stderr) == 1)
    return 1;
 ...
 cleanup:
  ...
  if (err)
    {
      svn_handle_error2(err, stderr, 0,
