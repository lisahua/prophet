# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_opt_print_help(apr_getopt_t *os,
                   ...
                   const char *footer,
                   apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_wc_revision_status(svn_wc_revision_status_t **result_p,
                       ...
                       void *cancel_baton,
                       apr_pool_t *pool);
# 7426 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_wc__node_get_lock_tokens_recursive(apr_hash_t **lock_tokens,
                                       ...
                                       apr_pool_t *result_pool,
                                       apr_pool_t *scratch_pool);
# 828 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__min_max_revisions(svn_revnum_t *min_revision,
                          ...
                          svn_boolean_t committed,
                          apr_pool_t *scratch_pool);
# 843 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__node_get_commit_status(svn_node_kind_t *kind,
                               ...
                               apr_pool_t *result_pool,
                               apr_pool_t *scratch_pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
svn_client__crawl_for_externals(apr_hash_t **externals_p,
                                ...
                                apr_pool_t *result_pool,
                                apr_pool_t *scratch_pool);
# 1036 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__get_normalized_stream(svn_stream_t **normal_stream,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 1130 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/url.c" 2
  ...
  if (!svn_path_is_url(path_or_url))
    {
      ...
      return (svn_wc__node_get_url(url, ctx->wc_ctx, path_or_url, result_pool, scratch_pool));
                              ...
                              apr_pool_t *pool)
{
  ...
  return (svn_client__get_repos_root(url, path_or_url, ctx, pool, pool));
                            ...
                            apr_pool_t *scratch_pool)
{
  ...
  if (! svn_path_is_url(abspath_or_url))
    {
      ...
      if (peg_revision->kind == svn_opt_revision_date
        ...
        do { svn_error_t *svn_err__temp = (svn_wc__node_get_url(url, ctx->wc_ctx, abspath_or_url, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      else
        do { svn_error_t *svn_err__temp = (svn_client__entry_location(url, peg_revnum, ctx->wc_ctx, abspath_or_url, peg_revision->kind, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (peg_revnum && !((*peg_revnum) >= 0))
    {
      if (ra_session == ((void*)0))
        {
      ...
      do { svn_error_t *svn_err__temp = (svn_client__get_revision_number(peg_revnum, ((void*)0), ctx->wc_ctx, ((void*)0), ra_session, peg_revision, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__node_get_copyfrom_info(((void*)0), ((void*)0), &copyfrom_url, &copyfrom_rev, ((void*)0), wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (copyfrom_url && peg_rev_kind == svn_opt_revision_working)
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_url(&node_url, wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (revnum)
            {
              if ((peg_rev_kind == svn_opt_revision_committed) ||
                ...
                {
                  do { svn_error_t *svn_err__temp = (svn_wc__node_get_changed_info(revnum, ((void*)0), ((void*)0), wc_ctx, local_abspath, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              else
                {
                  ...
                  do { svn_error_t *svn_err__temp = (svn_wc__node_get_base_rev(revnum, wc_ctx, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
