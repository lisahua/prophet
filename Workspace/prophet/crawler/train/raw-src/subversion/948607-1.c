...
# 1163 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_checksum2(&md5_checksum, text_base_path, svn_checksum_sha1, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
