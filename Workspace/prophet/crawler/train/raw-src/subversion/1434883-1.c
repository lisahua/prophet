...
svn_wc__internal_translated_file(const char **xlated_abspath,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2


# 1 "./subversion/svn_private_config.h" 1
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c" 2
# 102 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(versioned_file_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c", 121, "svn_dirent_is_absolute(versioned_file_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 173 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (need_translation)
    {
...
# 266 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
  if (!checksum
      || (kind != svn_kind_file)
  ...
  if (! exact_comparison)
    {
# 315 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
...
# 432 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/questions.c"
