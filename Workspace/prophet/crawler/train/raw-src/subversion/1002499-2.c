...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
  ...
  for (hi = apr_hash_first(pool, props); hi; hi = apr_hash_next(hi))
    {
      ...
      if (svn_prop_needs_translation(key))
        {
          do { svn_error_t *svn_err__temp = (svn_subst_translate_cstring2(value->data, &cstring, "\n", (!0), ((void*)0), 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 117 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (normalize_props(eb->props, eb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 238 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
static svn_error_t *
          ...
          apr_pool_t *pool)
{
  ...
  switch (action)
    ...
    case svn_node_action_add:
      ...
      if (!is_copy)
        {
# 337 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
          eb->dump_props = (!0);
          break;
        }
...
# 355 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnrdump/dump_editor.c"
          ...
          void **root_baton)
{
  ...
  if (eb->pool)
    ...
    eb->pool = svn_pool_create_ex(((void*)0), ((void*)0));
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_props(pb->eb, &(pb->eb->dump_props), (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (dump_newlines(pb->eb, &(pb->eb->dump_newlines), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_newlines(eb, &(eb->dump_newlines), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
