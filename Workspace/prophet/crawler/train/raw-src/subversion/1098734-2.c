# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c"
# 1 "./subversion/include/svn_string.h" 1
# 78 "./subversion/include/svn_string.h"
...
# 79 "./subversion/include/svn_string.h" 2
...
# 80 "./subversion/include/svn_string.h" 2
...
# 81 "./subversion/include/svn_string.h" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h" 1
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
...
svn_cl__append_tree_conflict_info_xml(
  ...
  const svn_wc_conflict_description2_t *conflict,
  apr_pool_t *pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/info-cmd.c" 2
               ...
               apr_pool_t *pool)
{
  ...
  if (((info->rev) >= 0))
    ...
    rev_str = apr_pstrdup(pool, dcgettext ("subversion", "Resource is not under version control.", 5));
  ...
  if (info->repos_root_URL || info->repos_UUID)
    {
      ...
      svn_xml_make_open_tag(&sb, pool, svn_xml_normal, "repository", ((void*)0));
  ...
  if (info->wc_info)
    {
      ...
      svn_xml_make_open_tag(&sb, pool, svn_xml_normal, "wc-info", ((void*)0));
      ...
      if (((info->wc_info->copyfrom_rev) >= 0))
  ...
  if (info->wc_info && info->wc_info->conflicts)
    {
      ...
      for (i = 0; i < info->wc_info->conflicts->nelts; i++)
        {
          const svn_wc_conflict_description2_t *conflict =
                      (((const svn_wc_conflict_description2_t * *)(info->wc_info->conflicts)->elts)[i]);
          ...
          switch (conflict->kind)
            {
              ...
              case svn_wc_conflict_kind_tree:
                do { svn_error_t *svn_err__temp = (svn_cl__append_tree_conflict_info_xml(sb, conflict, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Path: %s\n", 5), svn_dirent_local_style(target, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);




  if (info->kind != svn_node_dir)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Name: %s\n", 5), svn_dirent_basename(target, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (info->wc_info && info->wc_info->wcroot_abspath)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Working Copy Root Path: %s\n", 5), svn_dirent_local_style( info->wc_info->wcroot_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);




  if (info->URL)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "URL: %s\n", 5), info->URL)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (info->repos_root_URL)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Repository Root: %s\n", 5), info->repos_root_URL)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (info->repos_UUID)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Repository UUID: %s\n", 5), info->repos_UUID)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (((info->rev) >= 0))
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Revision: %ld\n", 5), info->rev)); if (svn_err__temp) return (svn_err__temp); } while (0);

  switch (info->kind)
    {
    case svn_node_file:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Node Kind: file\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case svn_node_dir:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Node Kind: directory\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case svn_node_none:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Node Kind: none\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;

    case svn_node_unknown:
    default:
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Node Kind: unknown\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
      break;
    }
  ...
  if (info->wc_info)
    {
      switch (info->wc_info->schedule)
        {
        case svn_wc_schedule_normal:
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Schedule: normal\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;

        case svn_wc_schedule_add:
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Schedule: add\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;

        case svn_wc_schedule_delete:
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Schedule: delete\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;

        case svn_wc_schedule_replace:
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Schedule: replace\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;
      ...
      switch (info->wc_info->depth)
        ...
        case svn_depth_empty:
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Depth: empty\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;

        case svn_depth_files:
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Depth: files\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;

        case svn_depth_immediates:
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Depth: immediates\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;

        case svn_depth_exclude:
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Depth: exclude\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;
        ...
        default:
          ...
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Depth: INVALID\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);
        }

      if (info->wc_info->copyfrom_url)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Copied From URL: %s\n", 5), info->wc_info->copyfrom_url)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (((info->wc_info->copyfrom_rev) >= 0))
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Copied From Rev: %ld\n", 5), info->wc_info->copyfrom_rev)); if (svn_err__temp) return (svn_err__temp); } while (0);

    }

  if (info->last_changed_author)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Last Changed Author: %s\n", 5), info->last_changed_author)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (((info->last_changed_rev) >= 0))
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Last Changed Rev: %ld\n", 5), info->last_changed_rev)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (info->last_changed_date)
    do { svn_error_t *svn_err__temp = (svn_cl__info_print_time(info->last_changed_date, dcgettext ("subversion", "Last Changed Date", 5), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (info->wc_info)
    {
      if (info->wc_info->text_time)
        do { svn_error_t *svn_err__temp = (svn_cl__info_print_time(info->wc_info->text_time, dcgettext ("subversion", "Text Last Updated", 5), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (info->wc_info->checksum)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Checksum: %s\n", 5), svn_checksum_to_cstring( info->wc_info->checksum, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          for (i = 0; i < info->wc_info->conflicts->nelts; i++)
            {
              ...
              switch (conflict->kind)
                {
                  case svn_wc_conflict_kind_text:
                    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Conflict Previous Base File: %s\n", 5), svn_dirent_local_style(conflict->base_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);




                    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Conflict Previous Working File: %s\n", 5), svn_dirent_local_style(conflict->my_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);




                    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Conflict Current Base File: %s\n", 5), svn_dirent_local_style(conflict->their_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  case svn_wc_conflict_kind_property:
                    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Conflict Properties File: %s\n", 5), svn_dirent_local_style(conflict->their_abspath, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  case svn_wc_conflict_kind_tree:
                    do { svn_error_t *svn_err__temp = (svn_cl__get_human_readable_tree_conflict_description( &desc, conflict, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%s: %s\n", dcgettext ("subversion", "Tree conflict", 5), desc)); if (svn_err__temp) return (svn_err__temp); } while (0);


                    if (src_left_version)
                        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "  %s: %s\n", dcgettext ("subversion", "Source  left", 5), src_left_version)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    if (src_right_version)
                        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "  %s: %s\n", dcgettext ("subversion", "Source right", 5), src_right_version)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (info->lock)
    {
      if (info->lock->token)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Lock Token: %s\n", 5), info->lock->token)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (info->lock->owner)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Lock Owner: %s\n", 5), info->lock->owner)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (info->lock->creation_date)
        do { svn_error_t *svn_err__temp = (svn_cl__info_print_time(info->lock->creation_date, dcgettext ("subversion", "Lock Created", 5), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (info->lock->expiration_date)
        do { svn_error_t *svn_err__temp = (svn_cl__info_print_time(info->lock->expiration_date, dcgettext ("subversion", "Lock Expires", 5), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (info->lock->comment)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcngettext ("subversion", "Lock Comment (%i line):\n%s\n", "Lock Comment (%i lines):\n%s\n", comment_lines, 5), comment_lines, info->lock->comment)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (info->wc_info && info->wc_info->changelist)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, dcgettext ("subversion", "Changelist: %s\n", 5), info->wc_info->changelist)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  int i;
  svn_error_t *err;
  svn_boolean_t seen_nonexistent_target = 0;
  svn_opt_revision_t peg_revision;
  svn_info_receiver2_t receiver;
  const char *path_prefix;
  ...
  if (opt_state->xml)
    {
      ...
      if (! opt_state->incremental)
        do { svn_error_t *svn_err__temp = (svn_cl__xml_print_header("info", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
    {
      receiver = print_info;
      ...
      if (opt_state->incremental)
        return svn_error_create(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                                dcgettext ("subversion", "'incremental' option only valid in XML " "mode", 5));
  ...
  do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&path_prefix, "", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cl__check_cancel(ctx->cancel_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&peg_revision, &truepath, target, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (svn_path_is_url(truepath))
      ...
      else
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&truepath, truepath, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      ...
      if (err)
        {
          ...
          svn_error_clear(err);
          err = ((void*)0);
          seen_nonexistent_target = (!0);
        }
    }
  apr_pool_destroy(subpool);

  if (opt_state->xml && (! opt_state->incremental))
    do { svn_error_t *svn_err__temp = (svn_cl__xml_print_footer("info", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (seen_nonexistent_target)
    return svn_error_create(
      SVN_ERR_ILLEGAL_TARGET, ((void*)0),
      dcgettext ("subversion", "Could not display info for all targets because some " "targets don't exist", 5));
