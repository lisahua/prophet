# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2
# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_want.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2

# 1 "./subversion/include/svn_diff.h" 1
# 55 "./subversion/include/svn_diff.h"
...
# 56 "./subversion/include/svn_diff.h" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2
...
# 150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff.h"
void
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c" 2
  ...
  if (src->tokens->nelts > src->next_token)
    {
      ...
      svn_string_t *tok = (*token)
        = (((svn_string_t * *)(src->tokens)->elts)[src->next_token]);
...
# 206 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c"
static void
                   ...
                   apr_pool_t *pool)
{
  ...
  for (startp = curp = text->data, endp = curp + text->len;
       curp != endp; curp++)
    {
      ...
      if (*curp == '\r' || *curp == '\n')
        {
          (*((svn_string_t * *)apr_array_push(src->tokens))) =
        ...
        for (idx = 0; idx < tokens->nelts; idx++)
          {
            apr_size_t token_len
              = (((svn_string_t * *)(tokens)->elts)[idx])->len;
                           ...
                           apr_off_t past_last)
{
  ...
  for (idx = first; idx < past_last; idx++)
    {
      svn_string_t *token
        = (((svn_string_t * *)(source->tokens)->elts)[idx]);
  ...
  if (past_last == source->tokens->nelts && source->ends_without_eol)
    {
      const char *out_str;
      do { svn_error_t *svn_err__temp = (svn_utf_cstring_from_utf8_ex2 (&out_str, "\n" "\\ No newline at end of file" "\n", btn->header_encoding, btn->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          const char *hunk_delimiter)
{
  ...
  apr_pool_clear(baton->pool);


  target_token = baton->hunk_start[0] + baton->hunk_length[0]
    + 3;
  do { svn_error_t *svn_err__temp = (output_unified_token_range(baton, 0 , unified_output_context, baton->next_token, target_token)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (baton->hunk_length[0] > 0)
    ...
    baton->hunk_start[0]++;
  do { svn_error_t *svn_err__temp = (svn_stream_printf_from_utf8( baton->output_stream, baton->header_encoding, baton->pool, (baton->hunk_length[0] == 1) ? ("%s -%" "ld") : ("%s -%" "ld" ",%" "ld"), hunk_delimiter, baton->hunk_start[0], baton->hunk_length[0])); if (svn_err__temp) return (svn_err__temp); } while (0);
# 466 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c"
  ...
  if (baton->hunk_length[1] == 1)
    {
      do { svn_error_t *svn_err__temp = (svn_stream_printf_from_utf8( baton->output_stream, baton->header_encoding, baton->pool, " +%" "ld" " %s" "\n", baton->hunk_start[1], hunk_delimiter)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    {
      do { svn_error_t *svn_err__temp = (svn_stream_printf_from_utf8( baton->output_stream, baton->header_encoding, baton->pool, " +%" "ld" ",%" "ld" " %s" "\n", baton->hunk_start[1], baton->hunk_length[1], hunk_delimiter)); if (svn_err__temp) return (svn_err__temp); } while (0);
                             ...
                             apr_off_t latest_length)
{
  ...
  targ_orig = original_start - 3;
  targ_orig = (targ_orig < 0) ? 0 : targ_orig;
  targ_mod = modified_start;

  if (btn->next_token + 3 < targ_orig)
    do { svn_error_t *svn_err__temp = (output_unified_flush_hunk(btn, ((void*)0))); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (output_unified_token_range(btn, 0 , unified_output_context, targ_orig, original_start)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (output_unified_token_range(btn, 0 , unified_output_delete, original_start, original_start + original_length)); if (svn_err__temp) return (svn_err__temp); } while (0);



  return output_unified_token_range(btn, 1 , unified_output_insert,
                                    modified_start,
  ...
  if (svn_diff_contains_diffs(diff))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_utf_cstring_from_utf8_ex2 (&(baton.prefix_str[unified_output_context]), " ", header_encoding, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_utf_cstring_from_utf8_ex2 (&(baton.prefix_str[unified_output_delete]), "-", header_encoding, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_utf_cstring_from_utf8_ex2 (&(baton.prefix_str[unified_output_insert]), "+", header_encoding, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_diff_output(diff, &baton, &mem_output_unified_vtable)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (output_unified_flush_hunk(&baton, hunk_delimiter)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_diff_mem_string_output_unified(svn_stream_t *output_stream,
                                   ...
                                   apr_pool_t *pool)
{
  do { svn_error_t *svn_err__temp = (svn_diff_mem_string_output_unified2(output_stream, diff, (!0), ((void*)0), original_header, modified_header, header_encoding, original, modified, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 627 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c"
  return 0;
}
# 637 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c"
typedef struct {
  svn_stream_t *stream;
  const char *data[3];
  apr_size_t len[3];
...
make_context_saver(merge_output_baton_t *mob)
{
  ...
  apr_pool_clear(mob->pool);
  cs = memset(apr_palloc(mob->pool, sizeof(*cs)), 0, sizeof(*cs));
                               ...
                               apr_size_t *len)
{
  ...
  do { if (!(tcp->lines_to_print > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c", 738, "tcp->lines_to_print > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_write(tcp->mob->real_output_stream, data, len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  tcp->lines_to_print--;
                         ...
                         apr_off_t length)
{
  ...
  for (; length > 0 && first < tokens->nelts; length--, first++)
    {
      svn_string_t *token = (((svn_string_t * *)(tokens)->elts)[first]);
      apr_size_t len = token->len;



      do { svn_error_t *svn_err__temp = (svn_stream_write(btn->output_stream, token->data, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
      lines_printed++;
    }
...
output_merge_marker(merge_output_baton_t *btn, int idx)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_write(btn->output_stream, btn->markers[idx], &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  return output_merge_token_range(((void*)0), baton, 1 ,
                                  modified_start, modified_length);
}
...
output_latest(void *baton,
              ...
              apr_off_t latest_start, apr_off_t latest_length)
{
  return output_merge_token_range(((void*)0), baton, 2 ,
                ...
                svn_diff_t *diff)
{
  ...
  if (style == svn_diff_conflict_display_modified_latest ||
    ...
    {
      do { svn_error_t *svn_err__temp = (output_merge_marker(btn, 1 )); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (output_merge_token_range(((void*)0), btn, 1 , modified_start, modified_length)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (style == svn_diff_conflict_display_modified_original_latest)
        {
          do { svn_error_t *svn_err__temp = (output_merge_marker(btn, 0 )); if (svn_err__temp) return (svn_err__temp); } while (0);
          do { svn_error_t *svn_err__temp = (output_merge_token_range(((void*)0), btn, 0 , original_start, original_length)); if (svn_err__temp) return (svn_err__temp); } while (0);

        }

      do { svn_error_t *svn_err__temp = (output_merge_marker(btn, 2 )); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (output_merge_token_range(((void*)0), btn, 2 , latest_start, latest_length)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { svn_error_t *svn_err__temp = (output_merge_marker(btn, 3 )); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
    ...
    do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/diff_memory.c", 887, ((void*)0))); } while (0);
                             ...
                             svn_diff_t *diff)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_printf(btn->output_stream, btn->pool, (modified_length == 1 ? "%s (%" "ld" ")" : "%s (%" "ld" ",%" "ld" ")"), btn->markers[1], modified_start + 1, modified_length)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_printf(btn->output_stream, btn->pool, (original_length == 1 ? "%s (%" "ld" ")" : "%s (%" "ld" ",%" "ld" ")"), btn->markers[0], original_start + 1, original_length)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_printf(btn->output_stream, btn->pool, (latest_length == 1 ? "%s (%" "ld" ")" : "%s (%" "ld" ",%" "ld" ")"), btn->markers[3], latest_start + 1, latest_length)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                  ...
                                  apr_pool_t *pool)
{
  ...
  if (conflicts_only)
    {
      btn.pool = svn_pool_create_ex(pool, ((void*)0));
  ...
  if (btn.sources[1].tokens->nelts > 0)
    {
      eol = detect_eol((((svn_string_t * *)(btn.sources[1].tokens)->elts)[0]));
      if (!eol)
        eol = "\n";
    }
  else
  ...
  do { svn_error_t *svn_err__temp = (svn_utf_cstring_from_utf8(&btn.markers[1], conflict_modified ? conflict_modified : "<<<<<<< (modified)", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_utf_cstring_from_utf8(&btn.markers[0], conflict_original ? conflict_original : "||||||| (original)", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_utf_cstring_from_utf8(&btn.markers[2], conflict_separator ? conflict_separator : "=======", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_utf_cstring_from_utf8(&btn.markers[3], conflict_latest ? conflict_latest : ">>>>>>> (latest)", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





  do { svn_error_t *svn_err__temp = (svn_diff_output(diff, &btn, vtable)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (conflicts_only)
    apr_pool_destroy(btn.pool);
