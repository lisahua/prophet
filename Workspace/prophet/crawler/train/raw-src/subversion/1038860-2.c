  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 256:
          {
            ...
            if (err)
              return svn_cmdline_handle_exit_error(
                       (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",486), (svn_error_createf))(SVN_ERR_CL_ARG_PARSING_ERROR, err,
        ...
        case 'T':
          ...
          break;
# 555 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
        case 263:
  ...
  if (run_mode == run_mode_inetd || run_mode == run_mode_tunnel)
    {
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",625), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't open stdin", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",632), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't open stdout", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
...
# 701 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",728), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't get address info", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",742), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create server socket", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",753), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't bind server socket", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
...
# 791 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
  while (1)
    {
# 803 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",830), (svn_error_wrap_apr))
            (status, dcgettext ("subversion", "Can't accept client connection", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
# 843 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
      ...
      switch (handling_mode)
        ...
        case connection_mode_fork:
          ...
          if (status == ((20000 + 50000) + 1))
            ...
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",887), (svn_error_wrap_apr))(status, "apr_proc_fork");
              log_error(err, params.log_file,
                        svn_ra_svn_conn_remote_host(conn),
                        ((void*)0), ((void*)0),
                        connection_pool);
        ...
        case connection_mode_thread:
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",907), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create threadattr", 5));
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",915), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't set detached state", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",928), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create thread", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
