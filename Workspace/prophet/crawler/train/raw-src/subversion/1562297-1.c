...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/nls.c" 2
...
svn_nls_init(void)
{
  ...
  if (getenv("SVN_LOCALE_DIR"))
    ...
    {
# 92 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/nls.c"
