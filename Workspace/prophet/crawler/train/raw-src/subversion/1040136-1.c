...
svn_fs_fs__set_node_origin(svn_fs_t *fs,
                           ...
                           const svn_fs_id_t *node_rev_id,
                           apr_pool_t *pool);
# 520 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs_fs.h"
svn_error_t *
...
# 136 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
svn_error_t *svn_fs_fs__dag_get_predecessor_id(const svn_fs_id_t **id_p,
                                               dag_node_t *node,
                                               apr_pool_t *pool);
# 147 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
...
svn_error_t *svn_fs_fs__dag_get_mergeinfo_count(apr_int64_t *count,
                                                dag_node_t *node,
                                                apr_pool_t *pool);
# 168 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
svn_error_t *
...
# 201 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
...
svn_error_t *svn_fs_fs__dag_set_has_mergeinfo(dag_node_t *node,
                                              svn_boolean_t has_mergeinfo,
                                              apr_pool_t *pool);
# 242 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
svn_error_t *svn_fs_fs__dag_revision_root(dag_node_t **node_p,
                                          svn_fs_t *fs,
                                          svn_revnum_t rev,
                                          apr_pool_t *pool);
# 255 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
...
svn_error_t *svn_fs_fs__dag_clone_root(dag_node_t **root_p,
                                       ...
                                       const char *txn_id,
                                       apr_pool_t *pool);
# 290 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
svn_error_t *svn_fs_fs__dag_open(dag_node_t **child_p,
                                 dag_node_t *parent,
                                 const char *name,
                                 apr_pool_t *pool);
# 302 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
svn_error_t *svn_fs_fs__dag_dir_entries(apr_hash_t **entries_p,
                                        dag_node_t *node,
                                        apr_pool_t *pool,
                                        apr_pool_t *node_pool);
# 317 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
...
svn_error_t *svn_fs_fs__dag_clone_child(dag_node_t **child_p,
                                        ...
                                        apr_pool_t *pool);
# 368 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
...
svn_error_t *svn_fs_fs__dag_delete_if_mutable(svn_fs_t *fs,
                                              const svn_fs_id_t *id,
                                              apr_pool_t *pool);
# 410 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
...
svn_error_t *svn_fs_fs__dag_get_contents(svn_stream_t **contents,
                                         dag_node_t *file,
                                         apr_pool_t *pool);
# 442 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
svn_error_t *
...
svn_error_t *svn_fs_fs__dag_get_edit_stream(svn_stream_t **contents,
                                            dag_node_t *file,
                                            apr_pool_t *pool);
# 474 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
...
svn_fs_fs__dag_file_checksum(svn_checksum_t **checksum,
                             ...
                             svn_checksum_kind_t kind,
                             apr_pool_t *pool);
# 514 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
svn_error_t *svn_fs_fs__dag_make_file(dag_node_t **child_p,
                                      ...
                                      const char *txn_id,
                                      apr_pool_t *pool);
# 540 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
svn_error_t *svn_fs_fs__dag_copy(dag_node_t *to_node,
                                 ...
                                 const char *txn_id,
                                 apr_pool_t *pool);
# 572 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/dag.h"
               ...
               apr_pool_t *pool)
{
  ...
  if (id == ((void*)0))
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c",74), (svn_error_create))(SVN_ERR_FS_NOT_ID, ((void*)0),
                              dcgettext ("subversion", "Bad ID in cache", 5));
    }
  ...
  for (hi = apr_hash_first(pool, entries); hi; hi = apr_hash_next(hi))
    {
      ...
      apr_hash_set(new_entries, new_dirent->name, (-1),
                   new_dirent);
    }
...
# 215 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/caching.c"
  if (memcache)
    do { svn_error_t *svn_err__temp = (svn_cache__create_memcache(&(ffd->rev_root_id_cache), memcache, serialize_id, deserialize_id, sizeof(svn_revnum_t), apr_pstrcat(pool, prefix, "RRI", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->rev_root_id_cache), dup_id, sizeof(svn_revnum_t), 1, 100, 0, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (memcache)
    do { svn_error_t *svn_err__temp = (svn_cache__create_memcache(&(ffd->rev_node_cache), memcache, svn_fs_fs__dag_serialize, svn_fs_fs__dag_deserialize, (-1), apr_pstrcat(pool, prefix, "DAG", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->rev_node_cache), svn_fs_fs__dag_dup_for_cache, (-1), 1024, 16, 0, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (memcache)
    do { svn_error_t *svn_err__temp = (svn_cache__create_memcache(&(ffd->dir_cache), memcache, svn_fs_fs__dir_entries_serialize, svn_fs_fs__dir_entries_deserialize, (-1), apr_pstrcat(pool, prefix, "DIR", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->dir_cache), dup_dir_listing, (-1), 1024, 8, 0, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (memcache)
    do { svn_error_t *svn_err__temp = (svn_cache__create_memcache(&(ffd->packed_offset_cache), memcache, manifest_serialize, manifest_deserialize, sizeof(svn_revnum_t), apr_pstrcat(pool, prefix, "PACK-MANIFEST", (char *)((void*)0)), fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    do { svn_error_t *svn_err__temp = (svn_cache__create_inprocess(&(ffd->packed_offset_cache), dup_pack_manifest, sizeof(svn_revnum_t), 32, 1, 0, fs->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
