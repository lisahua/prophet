...
# 481 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
static rep_stats_t *
...
# 528 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
      ...
      if (!svn_fs_fs__use_log_addressing(query->fs, rep->revision))
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_fs_fs__read_rep_header(&header, stream, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (svn_fs_fs__id_rev(dirent->id) == revision_info->revision)
        {
          ...
          do { svn_error_t *svn_err__temp = (read_noderev(query, file_content, (apr_size_t)svn_fs_fs__id_item(dirent->id), revision_info, pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 640 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
read_noderev(query_t *query,
             svn_stringbuf_t *file_content,
             apr_size_t offset,
             ...
             apr_pool_t *scratch_pool)
{
  ...
  if (noderev->data_rep)
    {
      do { svn_error_t *svn_err__temp = (parse_representation(&text, query, file_content, noderev->data_rep, revision_info, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (noderev->prop_rep)
    {
      do { svn_error_t *svn_err__temp = (parse_representation(&props, query, file_content, noderev->prop_rep, revision_info, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ( noderev->kind == svn_node_dir && text && text->ref_count == 1
    ...
    do { svn_error_t *svn_err__temp = (parse_dir(query, file_content, noderev, revision_info, pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1202 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/stats.c"
