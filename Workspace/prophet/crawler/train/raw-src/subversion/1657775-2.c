# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h" 2
...
svn_fs_x__dag_set_has_mergeinfo(dag_node_t *node,
                                svn_boolean_t has_mergeinfo,
                                apr_pool_t *scratch_pool);
# 258 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
...
svn_fs_x__dag_txn_root(dag_node_t **node_p,
                       ...
                       apr_pool_t *result_pool,
                       apr_pool_t *scratch_pool);
# 284 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
...
svn_fs_x__dag_dir_entries(apr_array_header_t **entries_p,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 309 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
svn_fs_x__dag_set_entry(dag_node_t *node,
                        ...
                        svn_fs_x__txn_id_t txn_id,
                        apr_pool_t *scratch_pool);
# 337 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
...
svn_fs_x__dag_delete(dag_node_t *parent,
                     ...
                     svn_fs_x__txn_id_t txn_id,
                     apr_pool_t *scratch_pool);
# 379 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
svn_fs_x__dag_make_dir(dag_node_t **child_p,
                       ...
                       apr_pool_t *result_pool,
                       apr_pool_t *scratch_pool);
# 398 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
...
svn_fs_x__dag_try_process_file_contents(svn_boolean_t *success,
                                        ...
                                        void* baton,
                                        apr_pool_t *scratch_pool);
# 423 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
...
svn_fs_x__dag_get_edit_stream(svn_stream_t **contents,
                              dag_node_t *file,
                              apr_pool_t *result_pool);
# 453 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
...
svn_fs_x__dag_file_checksum(svn_checksum_t **checksum,
                            ...
                            svn_checksum_kind_t kind,
                            apr_pool_t *result_pool);
# 487 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
svn_fs_x__dag_make_file(dag_node_t **child_p,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 513 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
svn_fs_x__dag_copy(dag_node_t *to_node,
                   ...
                   svn_fs_x__txn_id_t txn_id,
                   apr_pool_t *scratch_pool);
# 539 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.h"
svn_error_t *
...
svn_fs_x__dag_update_ancestry(dag_node_t *target,
                              dag_node_t *source,
                              apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__set_uuid(svn_fs_t *fs,
                   ...
                   const char *instance_id,
                   apr_pool_t *scratch_pool);
# 156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/fs_x.h"
svn_error_t *
...
svn_fs_x__initialize_caches(svn_fs_t *fs,
                            apr_pool_t *scratch_pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__id_create(svn_fs_x__id_context_t *context,
                    ...
                    apr_pool_t *result_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__get_changes(apr_array_header_t **changes,
                      ...
                      svn_revnum_t rev,
                      apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__abort_txn(svn_fs_txn_t *txn,
                    apr_pool_t *scratch_pool);
# 159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/transaction.h"
svn_error_t *
...
svn_fs_x__delete_node_revision(svn_fs_t *fs,
                               const svn_fs_x__id_t *id,
                               apr_pool_t *scratch_pool);
# 290 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/transaction.h"
svn_error_t *
...
svn_fs_x__begin_txn(svn_fs_txn_t **txn_p,
                    ...
                    apr_pool_t *result_pool,
                    apr_pool_t *scratch_pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__deserialize_mergeinfo(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c" 2
...
struct dag_node_t
{
  ...
  svn_node_kind_t kind;
# 73 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c"
...
# 158 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  new_node->fs = fs;
  new_node->id = *id;
  new_node->hint = (~((apr_size_t)0));


  do { svn_error_t *svn_err__temp = (svn_fs_x__get_node_revision(&noderev, fs, id, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 365 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__rep_contents_dir_entry(&dirent, parent->fs, noderev, name, &parent->hint, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 406 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
...
# 432 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
           ...
           apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__dag_get_node(child_p, svn_fs_x__dag_get_fs(parent), &new_noderev.noderev_id, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 784 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__dag_get_node(&node, fs, id, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__rep_contents_dir_entry(&dirent, fs, parent_noderev, name, &parent->hint, subpool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  return svn_fs_x__set_entry(parent->fs, txn_id, parent_noderev, name,
                             ((void*)0), svn_node_unknown, parent->node_pool,
                             scratch_pool);
}
                           ...
                           apr_pool_t *result_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__get_contents(&contents, file->fs, noderev->data_rep, (!0), result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                              ...
                              apr_pool_t *result_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__set_contents(&ws, file->fs, noderev, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (preserve_history)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_x__reserve_copy_id(&copy_id, fs, txn_id, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_x__create_successor(fs, to_noderev, &copy_id, txn_id, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
