...
svn_cl__get_conflict_func_interactive_baton(
  ...
  void *cancel_baton,
  apr_pool_t *result_pool);
# 357 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__conflict_func_interactive(svn_wc_conflict_result_t **result,
                                  ...
                                  apr_pool_t *result_pool,
                                  apr_pool_t *scratch_pool);
# 373 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__print_commit_info(const svn_commit_info_t *commit_info,
                          void *baton,
                          apr_pool_t *pool);
# 385 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__time_cstring_to_human_cstring(const char **human_cstring,
                                      const char *data,
                                      apr_pool_t *pool);
# 413 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
svn_cl__print_status(const char *cwd_abspath,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 436 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__revprop_prepare(const svn_opt_revision_t *revision,
                        ...
                        svn_client_ctx_t *ctx,
                        apr_pool_t *pool);
# 486 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
# 588 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__prop_use_t;
# 698 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__args_to_target_array_print_reserved(apr_array_header_t **targets_p,
                                            ...
                                            apr_pool_t *pool);
# 747 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
const char *
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         const char *wc_repos_root_URL,
                         apr_pool_t *pool);
# 768 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/cl.h"
svn_error_t *
...
# 97 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
static svn_error_t *
...
# 144 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
...
# 326 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
static svn_error_t *
...
# 518 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
static svn_error_t *
  ...
  if (opt_state->xml)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_client_log5(targets, &lb.target_peg_revision, opt_state->revision_ranges, opt_state->limit, opt_state->verbose, opt_state->stop_on_copy, opt_state->use_merge_history, revprops, log_entry_receiver_xml, &lb, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 847 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
  ...
  else
    {
      ...
      if (!opt_state->quiet)
        (*((const char * *)apr_array_push(revprops))) = "svn:" "log";
      do { svn_error_t *svn_err__temp = (svn_client_log5(targets, &lb.target_peg_revision, opt_state->revision_ranges, opt_state->limit, opt_state->verbose, opt_state->stop_on_copy, opt_state->use_merge_history, revprops, log_entry_receiver, &lb, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 870 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/log-cmd.c"
      if (! opt_state->incremental)
        do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "------------------------------------------------------------------------\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
