...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
fs_serialized_init(svn_fs_t *fs, apr_pool_t *common_pool, apr_pool_t *pool)
{
  ...
  apr_status_t status;
# 76 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
  key = apr_pstrcat(pool, "svn-fsfs-shared-", ffd->uuid,
                    (char *) ((void*)0));
  ...
  if (!ffsd)
    {
      ...
      if (status)
        return svn_error_wrap_apr(status,
                                  dcgettext ("subversion", "Can't create FSFS write-lock mutex", 5));
      ...
      if (status)
        return svn_error_wrap_apr(status,
                                  dcgettext ("subversion", "Can't create FSFS txn-current mutex", 5));
      ...
      if (status)
        return svn_error_wrap_apr(status,
                                  dcgettext ("subversion", "Can't create FSFS txn list mutex", 5));
...
# 203 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
...
{
# 234 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
        ...
        apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open(fs, path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_fs_fs__initialize_caches(fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (fs_serialized_init(fs, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return svn_fs_fs__pack(fs, notify_func, notify_baton,
                         cancel_func, cancel_baton, pool);
}
# 297 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
