...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/commit-cmd.c" 2
               ...
               apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cl__check_targets_are_local_paths(targets)); if (svn_err__temp) return svn_error_quick_wrap(svn_err__temp, dcgettext ("subversion", "Commit targets must be local paths", 5)); } while (0);
