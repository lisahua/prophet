      ...
      switch (action->action)
        {
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 262, ((void*)0))); } while (0);
        }
    }
...
# 713 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 732, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (action == ACTION_DELETE)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 832, ((void*)0))); } while (0);
    }
  ...
  for (hi = apr_hash_first(scratch_pool, operation->children);
       hi; hi = apr_hash_next(hi))
    {
      ...
      if (child->kind == svn_kind_dir
        ...
        {
          do { svn_error_t *svn_err__temp = (drive(child, editor, make_abs_paths, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1352 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
  return 0;
}
