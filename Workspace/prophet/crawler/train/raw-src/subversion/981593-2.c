# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
...
svn_cl__eat_peg_revisions(apr_array_header_t **true_targets_p,
                          const apr_array_header_t *targets,
                          apr_pool_t *pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c" 2
                  ...
                  apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%c%c      %s\n", kind_to_char(summary->summarize_kind), summary->prop_changed ? 'M' : ' ', path)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  if ((status = apr_file_open_stdout(&outfile, pool)))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c",172), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't open stdout", 5));
  if ((status = apr_file_open_stderr(&errfile, pool)))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c",174), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't open stderr", 5));
  ...
  if (opt_state->xml)
    {
      ...
      if (!opt_state->summarize)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c",182), (svn_error_create))(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                                dcgettext ("subversion", "'--xml' option only valid with " "'--summarize' option", 5));


      do { svn_error_t *svn_err__temp = (svn_cl__xml_print_header("diff", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      sb = svn_stringbuf_create("", pool);
      svn_xml_make_open_tag(&sb, pool, svn_xml_normal, "paths", ((void*)0));
  ...
  if (! opt_state->old_target && ! opt_state->new_target
      ...
      && svn_path_is_url((((const char * *)(targets)->elts)[1]))
      && opt_state->start_revision.kind == svn_opt_revision_unspecified
      && opt_state->end_revision.kind == svn_opt_revision_unspecified)
    {


      do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&opt_state->start_revision, &old_target, (((const char * *)(targets)->elts)[0]), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&opt_state->end_revision, &new_target, (((const char * *)(targets)->elts)[1]), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else if (opt_state->old_target)
    {
      ...
      (*((const char * *)apr_array_push(tmp))) = (opt_state->old_target);
      (*((const char * *)apr_array_push(tmp))) = (opt_state->new_target
                                            ? opt_state->new_target
                                           : (((const char * *)(tmp)->elts)[0]));


      do { svn_error_t *svn_err__temp = (svn_cl__args_to_target_array_print_reserved(&tmp2, os, tmp, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&old_rev, &old_target, (((const char * *)(tmp2)->elts)[0]), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (old_rev.kind != svn_opt_revision_unspecified)
        opt_state->start_revision = old_rev;
      do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&new_rev, &new_target, (((const char * *)(tmp2)->elts)[1]), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    {
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c",257), (svn_error_create))(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                              dcgettext ("subversion", "'--new' option only valid with " "'--old' option", 5));

    }
  else
    {
      svn_boolean_t working_copy_present = 0, url_present = 0;
      ...
      for (i = 0; i < targets->nelts; ++i)
        {
          ...
          if (! svn_path_is_url(path))
            working_copy_present = (!0);
          else
            url_present = (!0);
        }

      if (url_present && working_copy_present)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c",287), (svn_error_createf))(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
      ...
      if (! pegged_diff)
        {
          ...
          if (svn_path_is_url(path))
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c",321), (svn_error_createf))(SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
                                     dcgettext ("subversion", "Path '%s' not relative to base URLs", 5),
                                     path);
          ...
          if (opt_state->summarize)
            do { svn_error_t *svn_err__temp = (svn_client_diff_summarize2 (target1, &opt_state->start_revision, target2, &opt_state->end_revision, opt_state->depth, ! opt_state->notice_ancestry, opt_state->changelists, summarize_func, &target1, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 339 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
          else
            do { svn_error_t *svn_err__temp = (svn_client_diff5 (options, target1, &(opt_state->start_revision), target2, &(opt_state->end_revision), ((void*)0), opt_state->depth, ! opt_state->notice_ancestry, opt_state->no_diff_deleted, opt_state->show_copies_as_adds, opt_state->force, opt_state->use_git_diff_format, svn_cmdline_output_encoding(pool), outfile, errfile, opt_state->changelists, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 358 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
        }
      else
        {
          const char *truepath;
          ...
          do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&peg_revision, &truepath, path, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (opt_state->summarize)
            do { svn_error_t *svn_err__temp = (svn_client_diff_summarize_peg2 (truepath, &peg_revision, &opt_state->start_revision, &opt_state->end_revision, opt_state->depth, ! opt_state->notice_ancestry, opt_state->changelists, summarize_func, &truepath, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 384 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
          else
            do { svn_error_t *svn_err__temp = (svn_client_diff_peg5 (options, truepath, &peg_revision, &opt_state->start_revision, &opt_state->end_revision, ((void*)0), opt_state->depth, ! opt_state->notice_ancestry, opt_state->no_diff_deleted, opt_state->show_copies_as_adds, opt_state->force, opt_state->use_git_diff_format, svn_cmdline_output_encoding(pool), outfile, errfile, opt_state->changelists, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 403 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/diff-cmd.c"
        }
    }
  ...
  if (opt_state->xml)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cl__error_checked_fputs(sb->data, stdout)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_cl__xml_print_footer("diff", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
