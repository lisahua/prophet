...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
svn_stream__install_get_info(apr_finfo_t *finfo,
                             ...
                             apr_int32_t wanted,
                             apr_pool_t *scratch_pool);
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
svn_config__shallow_replace_section(svn_config_t *target,
                                    svn_config_t *source,
                                    const char *section);
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c" 2
...
svn_stream_create(void *baton, apr_pool_t *pool)
{
  ...
  stream->data_available_fn = ((void*)0);
  ...
  while (remaining > 0)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_read2(stream, buffer, &length)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_stream_read_full(svn_stream_t *stream, char *buffer, apr_size_t *len)
{
  if (stream->read_full_fn == ((void*)0))
    return (full_read_fallback(stream, buffer, len));

  return (stream->read_full_fn(stream->baton, buffer, len));
}
...
svn_stream_skip(svn_stream_t *stream, apr_size_t len)
{
  if (stream->skip_fn == ((void*)0))
    return (skip_default_handler(stream->baton, len, stream->read_full_fn));
                          ...
                          svn_boolean_t *data_available)
{
  ...
  return (stream->data_available_fn(stream->baton, data_available));
                         ...
                         apr_pool_t *pool)
{
  ...
  while (*match)
    {
      numbytes = 1;
      do { svn_error_t *svn_err__temp = (svn_stream_read_full(stream, &c, &numbytes)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (numbytes != 1)
        {
                       ...
                       apr_pool_t *pool)
{
  ...
  numbytes = 80;
  do { svn_error_t *svn_err__temp = (svn_stream_read_full(stream, buffer, &numbytes)); if (svn_err__temp) return (svn_err__temp); } while (0);
  buffer[numbytes] = '\0';
  ...
  else
    {
      ...
      *stringbuf = str;
      ...
      do
      {
        ...
        numbytes = 80;
        do { svn_error_t *svn_err__temp = (svn_stream_read_full(stream, str->data + str->len, &numbytes)); if (svn_err__temp) return (svn_err__temp); } while (0);
        str->len += numbytes;
        str->data[str->len] = '\0';
  ...
  *eof = 0;
  ...
  if (svn_stream_supports_mark(stream) &&
      svn_stream__is_buffered(stream))
    {
      ...
      do { svn_error_t *svn_err__temp = (stream_readline_chunky(stringbuf, eof, eol, stream, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (stream_readline_bytewise(stringbuf, eof, eol, stream, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  while ((to_read > 0) && (bytes_read > 0))
    {
      ...
      do { svn_error_t *svn_err__temp = (read_full_fn(baton, buffer, &bytes_read)); if (svn_err__temp) return (svn_err__temp); } while (0);
      to_read -= bytes_read;
    }
...
{
  return (svn_stream_read2(baton, buffer, len));
}

static svn_error_t *
read_full_handler_disown(void *baton, char *buffer, apr_size_t *len)
{
  return (svn_stream_read_full(baton, buffer, len));
}
...
{
  return (svn_stream_data_available(baton, data_available));
}
...
seek_handler_apr(void *baton, const svn_stream_mark_t *mark)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_seek(btn->file, 0, &offset, btn->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (status == 0)
  ...
  else
    {
      return svn_error_create(SVN_ERR_STREAM_NOT_SUPPORTED,
                              svn_error_create(status, ((void*)0), ((void*)0)),
                              ((void*)0));
    }
}
                         ...
                         apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_open(&file, path, 0x00001 | 0x00080, 0x0FFF, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                         ...
                         apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_open(&file, path, 0x00002 | 0x00080 | 0x00004 | 0x00040, 0x0FFF, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1086 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
struct zbaton {
  z_stream *in;
  z_stream *out;
  svn_read_fn_t read;
  ...
  if (btn->in == ((void*)0))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_error__wrap_zlib(zerr, "inflateInit", btn->in->msg)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  ...
  if (btn->out == ((void*)0))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_error__wrap_zlib(zerr, "deflateInit", btn->out->msg)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  ...
  while (btn->out->avail_in > 0)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_error__wrap_zlib(zerr, "deflate", btn->out->msg)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (btn->in != ((void*)0))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_error__wrap_zlib(zerr, "inflateEnd", btn->in->msg)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  ...
  if (btn->out != ((void*)0))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_error__wrap_zlib(zerr, "deflateEnd", btn->out->msg)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
svn_stream_compressed(svn_stream_t *stream, apr_pool_t *pool)
{
  ...
  ((stream != ((void*)0)) ? (void) (0) : __assert_fail ("stream != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 1299, __PRETTY_FUNCTION__));
...
read_handler_checksum(void *baton, char *buffer, apr_size_t *len)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_read2(btn->proxy, buffer, len)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
read_full_handler_checksum(void *baton, char *buffer, apr_size_t *len)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_read_full(btn->proxy, buffer, len)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
data_available_handler_checksum(void *baton, svn_boolean_t *data_available)
{
  ...
  return (svn_stream_data_available(btn->proxy, data_available));
  ...
  if (btn->read_more)
    {
      ...
      do
        {
          do { svn_error_t *svn_err__temp = (read_full_handler_checksum(baton, buf, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      while (btn->read_more);
    }
                          ...
                          apr_pool_t *pool)
{
  ...
  svn_stringbuf_t *text
    = svn_stringbuf_create_ensure(len_hint ? len_hint : 64, pool);

  do
    {
      to_read = text->blocksize - 1 - text->len;
      do { svn_error_t *svn_err__temp = (svn_stream_read_full(stream, text->data + text->len, &to_read)); if (svn_err__temp) return (svn_err__temp); } while (0);
      text->len += to_read;

      if (to_read && text->blocksize < text->len + 64)
  ...
  while (1)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_read_full(stream, buffer, &len)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_stream_buffered(apr_pool_t *result_pool)
{
  return svn_stream__from_spillbuf(svn_spillbuf__create(1024,
                                                        100000,
                                                        result_pool),
                                   result_pool);
}
  ...
  if (b->real_stream == ((void*)0))
    {
      ...
      do { svn_error_t *svn_err__temp = (b->open_func(&stream, b->open_baton, b->pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                      ...
                      apr_size_t *len)
{
  ...
  do { svn_error_t *svn_err__temp = (lazyopen_if_unopened(b)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_read2(b->real_stream, buffer, len)); if (svn_err__temp) return (svn_err__temp); } while (0);
                      ...
                      apr_size_t *len)
{
  ...
  do { svn_error_t *svn_err__temp = (lazyopen_if_unopened(b)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_read_full(b->real_stream, buffer, len)); if (svn_err__temp) return (svn_err__temp); } while (0);
                      ...
                      apr_size_t len)
{
  ...
  do { svn_error_t *svn_err__temp = (lazyopen_if_unopened(b)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_skip(b->real_stream, len)); if (svn_err__temp) return (svn_err__temp); } while (0);
                       ...
                       apr_size_t *len)
{
  ...
  do { svn_error_t *svn_err__temp = (lazyopen_if_unopened(b)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_write(b->real_stream, data, len)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
close_handler_lazyopen(void *baton)
{
  ...
  if (b->open_on_close)
    do { svn_error_t *svn_err__temp = (lazyopen_if_unopened(b)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (b->real_stream)
    do { svn_error_t *svn_err__temp = (svn_stream_close(b->real_stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
                      ...
                      apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (lazyopen_if_unopened(b)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_mark(b->real_stream, mark, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                      ...
                      const svn_stream_mark_t *mark)
{
  ...
  do { svn_error_t *svn_err__temp = (lazyopen_if_unopened(b)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_stream_seek(b->real_stream, mark)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                ...
                                svn_boolean_t *data_available)
{
  ...
  do { svn_error_t *svn_err__temp = (lazyopen_if_unopened(b)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return (svn_stream_data_available(b->real_stream, data_available));
...
# 2119 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
svn_error_t *
svn_stream__create_for_install(svn_stream_t **install_stream,
                               const char *tmp_abspath,
                               apr_pool_t *result_pool,
                               apr_pool_t *scratch_pool)
{
  ...
  const char *tmp_path;
# 2156 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
  do { if (!(svn_dirent_is_absolute(tmp_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 2156, "svn_dirent_is_absolute(tmp_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  do { svn_error_t *svn_err__temp = (svn_io_open_unique_file3(&file, &tmp_path, tmp_abspath, svn_io_file_del_none, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  *install_stream = svn_stream_from_aprfile2(file, 0, result_pool);

  ib = memset(apr_palloc(result_pool, sizeof(*ib)), 0, sizeof(*ib));
  ib->baton_apr = *(struct baton_apr*)(*install_stream)->baton;

  (((void*)&ib->baton_apr == (void*)ib) ? (void) (0) : __assert_fail ("(void*)&ib->baton_apr == (void*)ib", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 2167, __PRETTY_FUNCTION__));

  (*install_stream)->baton = ib;

  ib->tmp_path = tmp_path;
# 2180 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
  return 0;
}
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(final_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c", 2192, "svn_dirent_is_absolute(final_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 2286 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
  err = svn_io_file_rename(ib->tmp_path, final_abspath, scratch_pool);


  if (make_parents && err && ((err->apr_err) == 2))
    {
      svn_error_t *err2;
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_rename(ib->tmp_path, final_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
...
{
  struct install_baton_t *ib = install_stream->baton;
# 2330 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
  do { svn_error_t *svn_err__temp = (svn_io_stat(finfo, ib->tmp_path, wanted, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_close(install_stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 2354 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/stream.c"
  return (svn_io_remove_file2(ib->tmp_path, 0, scratch_pool));
