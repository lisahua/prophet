...
svn_client_commit5(const apr_array_header_t *targets,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 1963 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
typedef struct svn_client_status_t
{
  ...
  svn_depth_t depth;
# 2141 "./subversion/include/svn_client.h"
  svn_node_kind_t ood_kind;
...
svn_client_status3(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2327 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_diff5(const apr_array_header_t *diff_options,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 2774 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_diff4(const apr_array_header_t *diff_options,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 2802 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_diff_summarize2(const char *path1,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 3034 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_diff_summarize_peg2(const char *path,
                               ...
                               svn_client_ctx_t *ctx,
                               apr_pool_t *pool);
# 3091 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_merge_peg(const char *source,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 3397 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_copy2(svn_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 3917 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_move2(svn_client_commit_info_t **commit_info_p,
                 ...
                 svn_client_ctx_t *ctx,
                 apr_pool_t *pool);
# 4107 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_propset(const char *propname,
                   ...
                   svn_boolean_t recurse,
                   apr_pool_t *pool);
# 4325 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_client_propget3(apr_hash_t **props,
                    ...
                    svn_client_ctx_t *ctx,
                    apr_pool_t *pool);
# 4413 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_ls2(apr_hash_t **dirents,
               ...
               svn_client_ctx_t *ctx,
               apr_pool_t *pool);
# 4882 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_get_changelists(const char *path,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 5075 "./subversion/include/svn_client.h"
svn_error_t *
...
# 5255 "./subversion/include/svn_client.h"
...
svn_info_dup(const svn_info_t *info,
             apr_pool_t *pool);
# 5313 "./subversion/include/svn_client.h"
svn_error_t *
...
svn_cl__print_conflict_stats(void *notify_baton, apr_pool_t *pool)
{
  ...
  if (text_conflicts > 0 || prop_conflicts > 0
    || tree_conflicts > 0 || skipped_paths > 0)
      do { svn_error_t *svn_err__temp = (svn_cmdline_printf(pool, "%s", dcgettext ("subversion", "Summary of conflicts:\n", 5))); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (text_conflicts > 0)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf (pool, dcgettext ("subversion", "  Text conflicts: %u\n", 5), text_conflicts)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (prop_conflicts > 0)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf (pool, dcgettext ("subversion", "  Property conflicts: %u\n", 5), prop_conflicts)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (tree_conflicts > 0)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf (pool, dcgettext ("subversion", "  Tree conflicts: %u\n", 5), tree_conflicts)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (skipped_paths > 0)
    do { svn_error_t *svn_err__temp = (svn_cmdline_printf (pool, dcgettext ("subversion", "  Skipped paths: %u\n", 5), skipped_paths)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
notify(void *baton, const svn_wc_notify_t *n, apr_pool_t *pool)
{
  ...
  switch (n->action)
    ...
    case svn_wc_notify_patch_applied_hunk:
      ...
      if (n->hunk_original_start != n->hunk_matched_line)
      ...
      else if (n->hunk_fuzz)
        {
          if (n->prop_name)
            err = svn_cmdline_printf(pool,
                          dcgettext ("subversion", ">         applied hunk ## -%lu,%lu +%lu,%lu ## " "with fuzz %d (%s)\n", 5),
            ...
            err = svn_cmdline_printf(pool,
                          dcgettext ("subversion", ">         applied hunk @@ -%lu,%lu +%lu,%lu @@ " "with fuzz %d\n", 5),
    ...
    case svn_wc_notify_commit_deleted:
      if ((err = svn_cmdline_printf(pool, dcgettext ("subversion", "Deleting       %s\n", 5),
                                    path_local)))
        goto print_error;
      break;
    ...
    case svn_wc_notify_path_nonexistent:
      err = svn_cmdline_printf(pool, dcgettext ("subversion", "'%s' is not under version control", 5),
                               path_local);
      if (err)
        goto print_error;
      break;
