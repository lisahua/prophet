# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c"
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
...
svn_wc__call_with_write_lock(svn_wc__with_write_lock_func_t func,
                             ...
                             apr_pool_t *result_pool,
                             apr_pool_t *scratch_pool);
# 701 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__has_local_mods(svn_boolean_t *is_modified,
                       ...
                       void *cancel_baton,
                       apr_pool_t *scratch_pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/changelist.c" 2
  ...
  if (kind != svn_node_file)
    {
      ...
      if (b->ctx->notify_func2
          && ! (b->changelist == ((void*)0) && kind == svn_node_dir))
                             ...
                             apr_pool_t *pool)
{
  ...
  if (changelist[0] == '\0')
    return svn_error_create(SVN_ERR_BAD_CHANGELIST_NAME, ((void*)0),
                            dcgettext ("subversion", "Target changelist name must not be empty", 5));
  ...
  for (i = 0; i < paths->nelts; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_dirent_get_absolute(&local_abspath, path, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      snb.changelist = changelist;
      snb.changelist_hash = changelist_hash;
      snb.ctx = ctx;
      snb.pool = iterpool;
      do { svn_error_t *svn_err__temp = (svn_wc__node_walk_children(ctx->wc_ctx, local_abspath, 0, set_node_changelist, &snb, depth, ctx->cancel_func, ctx->cancel_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__node_get_changelist(&changelist, b->wc_ctx, local_abspath, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (svn_wc__changelist_match(b->wc_ctx, local_abspath,
          ...
          || (kind == svn_node_dir)))
    {
      ...
      do { svn_error_t *svn_err__temp = (b->callback_func(b->callback_baton, local_abspath, changelist, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *pool)
{
  ...
  gnb.pool = pool;
  if (changelists)
    do { svn_error_t *svn_err__temp = (svn_hash_from_cstring_keys(&(gnb.changelists), changelists, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
    gnb.changelists = ((void*)0);

  return (svn_wc__node_walk_children(ctx->wc_ctx, local_abspath, 0, get_node_changelist, &gnb, depth, ctx->cancel_func, ctx->cancel_baton, pool));
