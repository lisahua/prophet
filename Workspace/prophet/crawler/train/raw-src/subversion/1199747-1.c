# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c" 2
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c"
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c" 2
...
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         ...
                         apr_pool_t *pool);
# 786 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__local_style_skip_ancestor(const char *parent_path,
                                  const char *path,
                                  apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/relocate-cmd.c" 2
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  apr_array_header_t *targets;
  const char *from = ((void*)0), *to = ((void*)0), *path;
