...
move_page_to_front(inprocess_cache_t *cache,
                   struct cache_page *page)
{
  ((page != cache->sentinel) ? (void) (0) : __assert_fail ("page != cache->sentinel", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 155, __PRETTY_FUNCTION__));
                            ...
                            apr_pool_t *pool)
{
  ...
  do { if (!(pages >= 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 553, "pages >= 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  cache->total_pages = pages;
  cache->unallocated_pages = pages;
  do { if (!(items_per_page >= 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 556, "items_per_page >= 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
