             ...
             apr_pool_t *pool)
{
  ...
  if (targets->nelts < 2)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c",58), (svn_error_create))(SVN_ERR_CL_INSUFFICIENT_ARGS, 0, ((void*)0));
  ...
  if ((! srcs_are_urls) && (! dst_is_url))
    ...
    {
# 113 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c"
  ...
  if (! dst_is_url)
    {
      ...
      if (opt_state->message || opt_state->filedata || opt_state->revprop_table)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/copy-cmd.c",130), (svn_error_create))
