...
# 181 "./subversion/include/svn_types.h"
const void *
...
# 294 "./subversion/include/svn_types.h"
...
# 357 "./subversion/include/svn_types.h"
...
# 433 "./subversion/include/svn_types.h"
...
svn_dirent_dup(const svn_dirent_t *dirent,
               apr_pool_t *pool);
# 697 "./subversion/include/svn_types.h"
...
# 792 "./subversion/include/svn_types.h"
svn_log_changed_path2_t *
...
typedef svn_error_t *(*svn_commit_callback_t)(
  ...
  const char *author,
  void *baton);
# 1067 "./subversion/include/svn_types.h"
svn_error_t *
...
# 1087 "./subversion/include/svn_types.h"
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 1269 "./subversion/include/svn_types.h" 2
...
svn_checksum__from_digest(const unsigned char *digest,
                          svn_checksum_kind_t kind,
                          apr_pool_t *result_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c" 2
...
# 67 "./subversion/include/private/svn_mutex.h"
svn_error_t *
svn_mutex__init(svn_mutex__t **mutex,
                svn_boolean_t enable_mutex,
                apr_pool_t *pool);
# 79 "./subversion/include/private/svn_mutex.h"
svn_error_t *
svn_mutex__lock(svn_mutex__t *mutex);
# 95 "./subversion/include/private/svn_mutex.h"
svn_error_t *
...
# 293 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
typedef entry_t entry_group_t[4];
...
# 445 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static __inline__ entry_t *
get_entry(svn_membuffer_t *cache, apr_uint32_t idx)
{
  return &cache->directory[idx / 4][idx % 4];
}
...
drop_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset != (18446744073709551615UL)) ? (void) (0) : __assert_fail ("entry->offset != (18446744073709551615UL)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 469, __PRETTY_FUNCTION__));
  ...
  entry->offset = (18446744073709551615UL);
}
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == cache->current_data) ? (void) (0) : __assert_fail ("entry->offset == cache->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c", 531, __PRETTY_FUNCTION__));
                ...
                apr_pool_t *pool)
{
  ...
  memcpy(to_find, checksum->digest, 16);
...
is_group_initialized(svn_membuffer_t *cache, apr_uint32_t group_index)
{
  unsigned char flags = cache->group_initialized
                          [group_index / (8 * 32)];
  unsigned char bit_mask = 1 << ((group_index / 32) % 8);
...
initialize_group(svn_membuffer_t *cache, apr_uint32_t group_index)
{
  ...
  for (i = first_index; i < last_index; ++i)
    for (j = 0; j < 4; j++)
        cache->directory[i][j].offset = (18446744073709551615UL);


  bit_mask = 1 << ((group_index / 32) % 8);
  cache->group_initialized[group_index / (8 * 32)]
    |= bit_mask;
}
# 675 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
           ...
           svn_boolean_t find_empty)
{
  ...
  for (i = 0; i < 4; ++i)
    if (group[i].offset != (18446744073709551615UL) &&
        !memcmp(to_find, group[i].key, 16))
      {
...
# 823 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
      ...
      if (end - cache->current_data >= size)
        return (!0);
# 844 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (2 * drop_size > size)
        return 0;
...
# 909 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
...
# 933 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
svn_error_t *
svn_cache__membuffer_cache_create(svn_membuffer_t **cache,
                                  apr_size_t total_size,
                                  apr_size_t directory_size,
                                  ...
                                  apr_pool_t *pool)
{
  ...
  apr_uint64_t data_size;
# 961 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  while (((2 * 0x2000000ull) << (2 * segment_count_shift)) < total_size)
    ++segment_count_shift;
  ...
  if (group_count >= ((4294967295U) / 4))
    {
      group_count = ((4294967295U) / 4) - 1;
    }
  ...
  for (seg = 0; seg < segment_count; ++seg)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_mutex__init(&c[seg].mutex, thread_safe, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 1066 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                             ...
                             apr_pool_t *scratch_pool)
{
  ...
  if ( buffer != ((void*)0)
      ...
      && ensure_data_insertable(cache, size))
    {
      ...
      entry->size = size;
      entry->offset = cache->current_data;
# 1100 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
  ...
  else
    {
      ...
      find_entry(cache, group_index, to_find, (!0));
    }
}
# 1125 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  do { svn_mutex__t *m = (cache->mutex); svn_error_t *e = svn_mutex__lock(m); if (e) return (e); e = svn_mutex__unlock(m, (membuffer_cache_set_internal(cache, to_find, group_index, buffer, size, scratch_pool))); if (e) return (e); } while (0);;
...
# 1172 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 1219 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  entry->hit_count++;
  cache->hit_count++;
  cache->total_hits++;
                    ...
                    apr_pool_t *result_pool)
{
  ...
  do { svn_mutex__t *m = (cache->mutex); svn_error_t *e = svn_mutex__lock(m); if (e) return (e); e = svn_mutex__unlock(m, (membuffer_cache_get_internal(cache, group_index, to_find, &buffer, &size, result_pool))); if (e) return (e); } while (0);;
# 1269 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  if (buffer == ((void*)0))
    {
      *item = ((void*)0);
      return 0;
...
# 1289 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      cache->hit_count++;
      cache->total_hits++;
# 1335 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
                            ...
                            apr_pool_t *result_pool)
{
  ...
  do { svn_mutex__t *m = (cache->mutex); svn_error_t *e = svn_mutex__lock(m); if (e) return (e); e = svn_mutex__unlock(m, (membuffer_cache_get_partial_internal (cache, group_index, to_find, item, found, deserializer, baton, result_pool))); if (e) return (e); } while (0);;
...
# 1384 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->hit_count++;
      cache->total_writes++;
# 1430 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
          ...
          if (data != orig_data)
            {
              ...
              if ( (cache->data_size / 4 > size)
                  && ensure_data_insertable(cache, size))
                {
                  ...
                  insert_entry(cache, entry);
# 1472 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
                }
            }
        }
    }
                            ...
                            apr_pool_t *scratch_pool)
{
  ...
  do { svn_mutex__t *m = (cache->mutex); svn_error_t *e = svn_mutex__lock(m); if (e) return (e); e = svn_mutex__unlock(m, (membuffer_cache_set_partial_internal (cache, group_index, to_find, func, baton, scratch_pool))); if (e) return (e); } while (0);;
...
# 1530 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
typedef struct svn_membuffer_cache_t
{
  ...
  int alloc_counter;
# 1576 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
} svn_membuffer_cache_t;
# 1587 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
static void
                        ...
                        apr_pool_t *result_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_get(cache->membuffer, full_key, full_key_len, value_p, cache->deserializer, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                ...
                                apr_pool_t *result_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_get_partial(cache->membuffer, full_key, full_key_len, value_p, found, func, baton, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1760 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
                                ...
                                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_set_partial(cache->membuffer, full_key, full_key_len, func, baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                               ...
                               svn_cache__info_t *info)
{
  ...
  info->total_size += segment->data_size +
      segment->group_count * 4 * sizeof(entry_t);

  info->used_entries += segment->used_entries;
  info->total_entries += segment->group_count * 4;
  ...
  for (i = 0; i < cache->membuffer->segment_count; ++i)
    {
      ...
      do { svn_mutex__t *m = (segment->mutex); svn_error_t *e = svn_mutex__lock(m); if (e) return (e); e = svn_mutex__unlock(m, (svn_membuffer_get_segment_info(segment, info))); if (e) return (e); } while (0);;
...
# 1963 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-membuffer.c"
