...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
...
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c" 2
...
# 97 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
...
# 162 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
static svn_error_t *
  ...
  if (sqlite_err != 0 && sqlite_err != ignored_err)
    {
      svn_error_t *err = svn_error_createf(((sqlite_err) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err) == 5 ? SVN_ERR_SQLITE_BUSY : ((sqlite_err) == 19 ? SVN_ERR_SQLITE_CONSTRAINT : SVN_ERR_SQLITE_ERROR))), ((void*)0),
                                           dcgettext ("subversion", "sqlite: %s, executing statement '%s'", 5),
                                           err_msg, sql);
...
svn_sqlite__exec_statements(svn_sqlite__db_t *db, int stmt_idx)
{
  do { if (!(stmt_idx < db->nbr_statements)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 198, "stmt_idx < db->nbr_statements")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_sqlite__get_statement(svn_sqlite__stmt_t **stmt, svn_sqlite__db_t *db,
                          int stmt_idx)
{
  do { if (!(stmt_idx < db->nbr_statements)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 208, "stmt_idx < db->nbr_statements")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                       ...
                       int stmt_idx)
{
  ...
  do { if (!(stmt_idx < 7)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 233, "stmt_idx < STMT_INTERNAL_LAST")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      switch (*fmt)
        {
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 374, ((void*)0))); } while (0);
        }
    }
                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_skel__unparse_iproplist(&skel, inherited_props, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_sqlite__finalize(svn_sqlite__stmt_t *stmt)
{
  do { int sqlite_err__temp = (sqlite3_finalize(stmt->s3stmt)); if (sqlite_err__temp != 0) return svn_error_createf(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : ((sqlite_err__temp) == 19 ? SVN_ERR_SQLITE_CONSTRAINT : SVN_ERR_SQLITE_ERROR))), ((void*)0), "sqlite: %s", sqlite3_errmsg((stmt->db)->db3)); } while (0);
  return 0;
}
...
svn_sqlite__reset(svn_sqlite__stmt_t *stmt)
{
  do { int sqlite_err__temp = (sqlite3_reset(stmt->s3stmt)); if (sqlite_err__temp != 0) return svn_error_createf(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : ((sqlite_err__temp) == 19 ? SVN_ERR_SQLITE_CONSTRAINT : SVN_ERR_SQLITE_ERROR))), ((void*)0), "sqlite: %s", sqlite3_errmsg((stmt->db)->db3)); } while (0);
...
{
  {
    ...
    if (mode == svn_sqlite__mode_readonly)
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c", 749, ((void*)0))); } while (0);
# 758 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
    flags |= 0x00008000;
      ...
      if (err_code != 0)
        {
          ...
          return svn_error_createf(((err_code) == 8 ? SVN_ERR_SQLITE_READONLY : ((err_code) == 5 ? SVN_ERR_SQLITE_BUSY : ((err_code) == 19 ? SVN_ERR_SQLITE_CONSTRAINT : SVN_ERR_SQLITE_ERROR))), ((void*)0),
                                   "sqlite: %s: '%s'", msg, path);
        }
    }
  }
  ...
  do { int sqlite_err__temp = (sqlite3_busy_timeout(*db3, 10000)); if (sqlite_err__temp != 0) return svn_error_createf(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : ((sqlite_err__temp) == 19 ? SVN_ERR_SQLITE_CONSTRAINT : SVN_ERR_SQLITE_ERROR))), ((void*)0), "sqlite: %s", (sqlite3_errmsg(*db3))); } while (0);
...
# 878 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
  {
    int ignored_err = 0;
...
# 913 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
  ...
  if (err)
    {
      ...
      if (err2 && err2->apr_err == SVN_ERR_SQLITE_BUSY)
        {
# 1022 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/sqlite.c"
                    ...
                    apr_pool_t *scratch_pool)
{
...

  {
    ...
    if (rc1 != 101)
      do { int sqlite_err__temp = (rc1); if (sqlite_err__temp != 0) return svn_error_createf(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : ((sqlite_err__temp) == 19 ? SVN_ERR_SQLITE_CONSTRAINT : SVN_ERR_SQLITE_ERROR))), ((void*)0), "sqlite: %s", sqlite3_errmsg((dst_db)->db3)); } while (0);
    do { int sqlite_err__temp = (rc2); if (sqlite_err__temp != 0) return svn_error_createf(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : ((sqlite_err__temp) == 19 ? SVN_ERR_SQLITE_CONSTRAINT : SVN_ERR_SQLITE_ERROR))), ((void*)0), "sqlite: %s", sqlite3_errmsg((dst_db)->db3)); } while (0);
                                   ...
                                   void *baton)
{
  ...
  do { int sqlite_err__temp = (sqlite3_create_function(db->db3, func_name, argc, 5, fwb, wrapped_func, ((void*)0), ((void*)0))); if (sqlite_err__temp != 0) return svn_error_createf(((sqlite_err__temp) == 8 ? SVN_ERR_SQLITE_READONLY : ((sqlite_err__temp) == 5 ? SVN_ERR_SQLITE_BUSY : ((sqlite_err__temp) == 19 ? SVN_ERR_SQLITE_CONSTRAINT : SVN_ERR_SQLITE_ERROR))), ((void*)0), "sqlite: %s", sqlite3_errmsg((db)->db3)); } while (0);
