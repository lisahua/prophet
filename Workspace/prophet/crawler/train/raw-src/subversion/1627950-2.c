...
# 91 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/noderevs.c"
...
# 148 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/noderevs.c"
                       ...
                       apr_pool_t *pool)
{
  ...
  do { if (!(container->builder == ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/noderevs.c", 432, "container->builder == NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(container->paths)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_x/noderevs.c", 433, "container->paths")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
