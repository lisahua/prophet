# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
apr_status_t apr_generate_random_bytes(unsigned char * buf,
                                                    apr_size_t length);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_fs_fs__info_config_files(apr_array_header_t **files,
                             ...
                             apr_pool_t *result_pool,
                             apr_pool_t *scratch_pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_error_t *svn_fs_fs__allow_locked_operation(const char *path,
                                               ...
                                               apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_error_t * svn_fs_fs__hotcopy(svn_fs_t *src_fs,
                                 ...
                                 void *cancel_baton,
                                 apr_pool_t *pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_fs_fs__order_dir_entries(svn_fs_t *fs,
                             ...
                             svn_revnum_t revision,
                             apr_pool_t *pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_error_t *svn_fs_fs__recover(svn_fs_t *fs,
                                ...
                                void *cancel_baton,
                                apr_pool_t *pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_fs_fs__lock_rep_cache(svn_fs_t *fs,
                          apr_pool_t *pool);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_fs_fs__delete_revprops_shard(const char *shard_path,
                                 ...
                                 void *cancel_baton,
                                 apr_pool_t *scratch_pool);
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_fs_fs__begin_txn(svn_fs_txn_t **txn_p,
                     ...
                     apr_uint32_t flags,
                     apr_pool_t *pool);
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.h" 1
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/verify.h"
svn_error_t *svn_fs_fs__verify(svn_fs_t *fs,
                               ...
                               void *cancel_baton,
                               apr_pool_t *pool);
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 49 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
svn_fs__compatible_version(svn_version_t **compatible_version,
                           apr_hash_t *config,
                           apr_pool_t *pool);
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c" 2
...
fs_serialized_init(svn_fs_t *fs, apr_pool_t *common_pool, apr_pool_t *pool)
{
  ...
  apr_status_t status;
# 83 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
  do { if (!(fs->uuid)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c", 83, "fs->uuid")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (!ffsd)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_mutex__init(&ffsd->txn_list_lock, 1, common_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 267 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
fs_open(svn_fs_t *fs,
        const char *path,
        svn_mutex__t *common_pool_lock,
        ...
        apr_pool_t *common_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open(fs, path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
fs_open_for_recovery(svn_fs_t *fs,
                     ...
                     apr_pool_t *common_pool)
{
# 308 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
...
# 377 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.c"
static svn_error_t *
fs_hotcopy(svn_fs_t *src_fs,
           ...
           apr_pool_t *pool)
{
  do { svn_error_t *svn_err__temp = (svn_fs__check_fs(src_fs, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (initialize_fs_struct(src_fs)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open(src_fs, src_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_fs_fs__initialize_caches(src_fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (fs_serialized_init(src_fs, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
