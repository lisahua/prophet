...
svn_wc__db_op_read_tree_conflict(
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 1555 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_read_children(const apr_array_header_t **children,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2032 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_scan_base_repos(const char **repos_relpath,
                           ...
                           apr_pool_t *result_pool,
                           apr_pool_t *scratch_pool);
# 2404 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_scan_addition(svn_wc__db_status_t *status,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2514 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_scan_deletion(const char **base_del_abspath,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2531 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_upgrade_apply_dav_cache(svn_sqlite__db_t *sdb,
                                   ...
                                   apr_pool_t *scratch_pool);
# 2558 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_wq_completed(svn_wc__db_t *db,
                        ...
                        apr_uint64_t id,
                        apr_pool_t *scratch_pool);
# 2644 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_wclock_owns_lock(svn_boolean_t *own_lock,
                            ...
                            svn_boolean_t exact,
                            apr_pool_t *scratch_pool);
# 2691 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_is_sparse_checkout(svn_boolean_t *is_sparse_checkout,
                              ...
                              const char *local_abspath,
                              apr_pool_t *scratch_pool);
# 2958 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
# 220 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
svn_error_t *
...
# 328 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
svn_error_t *svn_wc__ensure_directory(const char *path, apr_pool_t *pool);
# 346 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
apr_hash_t *
...
svn_wc__walker_default_error_handler(const char *path,
                                     ...
                                     void *walk_baton,
                                     apr_pool_t *pool);
# 472 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
svn_error_t *
...
svn_wc__internal_node_get_schedule(svn_wc_schedule_t *schedule,
                                   ...
                                   const char *local_abspath,
                                   apr_pool_t *scratch_pool);
# 612 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
svn_error_t *
...
svn_wc__wipe_postupgrade(const char *dir_abspath,
                         ...
                         void *cancel_baton,
                         apr_pool_t *scratch_pool);
# 686 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
svn_error_t *
...
svn_wc__write_check(svn_wc__db_t *db,
                    const char *local_abspath,
                    apr_pool_t *scratch_pool);
# 712 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
svn_error_t *
...
# 61 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
...
# 104 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { if (!(have_base)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 125, "have_base")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (arg1->next->next)
  ...
  else
    {
      ...
      do { if (!(28 <= 28)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 250, "SVN_WC__VERSION <= 28")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 281 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
    }
...
# 339 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  *overwrote_working = 0;
# 379 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
  {
...
# 401 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
...
# 450 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
  ...
  if (overwrote_working)
    ...
    {
      svn_boolean_t modified;
# 485 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
...
# 607 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  if (arg4 != ((void*)0))
    ...
    {
      do { if (!(checksum != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 663, "checksum != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 804 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
...
# 852 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(wri_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 901, "svn_dirent_is_absolute(wri_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(src_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 902, "svn_dirent_is_absolute(src_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(dst_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 903, "svn_dirent_is_absolute(dst_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 934 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                                      ...
                                      apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 995, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(src_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 996, "svn_dirent_is_absolute(src_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(dst_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 997, "svn_dirent_is_absolute(dst_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 1033 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  if (arg1->next != ((void*)0))
    ...
    do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1099, ((void*)0))); } while (0);
  ...
  do { if (!(prejfile_abspath != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1110, "prejfile_abspath != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                              ...
                              apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(conflict_skel != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1133, "conflict_skel != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                 ...
                                 apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1215, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                               ...
                                               apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1308, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                                  ...
                                                  apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1390, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
