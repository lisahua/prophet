# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
svn_io_write_version_file(const char *path,
                          int version,
                          apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
svn_wc__db_repos_ensure(apr_int64_t *repos_id,
                        ...
                        const char *repos_uuid,
                        apr_pool_t *scratch_pool);
# 1053 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
svn_wc__db_op_copy(svn_wc__db_t *db,
                   ...
                   const svn_skel_t *work_items,
                   apr_pool_t *scratch_pool);
# 1068 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_set_props(svn_wc__db_t *db,
                        ...
                        const svn_skel_t *work_items,
                        apr_pool_t *scratch_pool);
# 1195 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_op_set_tree_conflict(svn_wc__db_t *db,
                                ...
                                const svn_wc_conflict_description2_t *tree_conflict,
                                apr_pool_t *scratch_pool);
# 1477 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_read_conflicts(const apr_array_header_t **conflicts,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 1630 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_upgrade_finish(const char *local_dir_abspath,
                          svn_sqlite__db_t *sdb,
                          apr_pool_t *scratch_pool);
# 2115 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_temp_get_all_access(svn_wc__db_t *db,
                               apr_pool_t *result_pool);
# 2331 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_temp_op_set_rev_and_repos_relpath(svn_wc__db_t *db,
                                             ...
                                             apr_pool_t *scratch_pool);
# 2503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__internal_node_get_schedule(svn_wc_schedule_t *schedule,
                                   ...
                                   const char *local_abspath,
                                   apr_pool_t *scratch_pool);
# 610 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc.h"
svn_error_t *
...
svn_wc__check_wc_root(svn_boolean_t *wc_root,
                      ...
                      const char *local_abspath,
                      apr_pool_t *scratch_pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
svn_wc__serialize_file_external(const char **str,
                                ...
                                const svn_opt_revision_t *rev,
                                apr_pool_t *pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c" 2
  ...
  if (kind != svn_node_none && kind != svn_node_dir)
    {
      ...
      return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c",57), (svn_error_createf))(20, ((void*)0),
          ...
          if (shorter[0] == '\0')
            {
              ...
              return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c",88), (svn_error_create))((20000 + 14), ((void*)0),
    ...
    do { if (!(kind == svn_node_dir)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 101, "kind == svn_node_dir")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 256, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 275, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
  ...
  apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 296, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                               ...
                               apr_pool_t *pool)
{
  ...
  do { if (!(svn_uri_is_canonical(repos_url, pool) && svn_relpath_is_canonical(path_in_repos, pool) && ((peg_rev) >= 0))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/util.c", 394, "svn_uri_is_canonical(repos_url, pool) && svn_relpath_is_canonical(path_in_repos, pool) && SVN_IS_VALID_REVNUM(peg_rev)"); abort(); } } while (0);
