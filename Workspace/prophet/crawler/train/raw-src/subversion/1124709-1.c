...
# 146 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c"
  do { svn_error_t *svn_err__temp = (svn_client_propget4(&externals, "svn:" "externals", path, &rev, &rev, ((void*)0), svn_depth_infinity, ((void*)0), ctx, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
