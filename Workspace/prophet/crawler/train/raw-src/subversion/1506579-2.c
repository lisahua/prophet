...
svn_fs_begin_txn(svn_fs_txn_t **txn_p,
                 ...
                 svn_revnum_t rev,
                 apr_pool_t *pool);
# 1026 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 1276 "./subversion/include/svn_fs.h"
...
# 1302 "./subversion/include/svn_fs.h"
...
svn_fs_props_changed(svn_boolean_t *changed_p,
                     ...
                     const char *path2,
                     apr_pool_t *pool);
# 1653 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_get_mergeinfo(svn_mergeinfo_catalog_t *catalog,
                     ...
                     svn_boolean_t include_descendants,
                     apr_pool_t *pool);
# 1769 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_make_dir(svn_fs_root_t *root,
                const char *path,
                apr_pool_t *pool);
# 1837 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_lock(svn_lock_t **lock,
            ...
            apr_pool_t *pool);
# 2389 "./subversion/include/svn_fs.h"
svn_error_t *
...
svn_fs_get_locks2(svn_fs_t *fs,
                  ...
                  apr_pool_t *pool);
# 2483 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 2591 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_verify(const char *path,
              ...
              void *cancel_baton,
              apr_pool_t *scratch_pool);
# 2626 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 2685 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_info(const svn_fs_info_placeholder_t **fs_info,
            svn_fs_t *fs,
            apr_pool_t *result_pool,
            apr_pool_t *scratch_pool);
# 2701 "./subversion/include/svn_fs.h"
void *
...
# 54 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 93 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
struct edit_baton
{
...
# 179 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
               ...
               apr_pool_t *pool)
{
  ...
  do { if (!(!path || pb)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c", 194, "!path || pb"); abort(); } } while (0);
...
# 232 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
static svn_error_t *
  ...
  if (must_dump_props)
    {
      ...
      if (!eb->verify && eb->notify_func && eb->oldest_dumped_rev > 1)
        {
          svn_string_t *mergeinfo_str = apr_hash_get(prophash, "svn:" "mergeinfo", strlen("svn:" "mergeinfo"));
             ...
             apr_pool_t *pool)
{
  ...
  apr_hash_set(pb->deleted_entries, mypath, strlen(mypath), pb);
              ...
              void **child_baton)
{
  ...
  val = apr_hash_get(pb->deleted_entries, path, strlen(path));
  ...
  if (val)
    ...
    apr_hash_set(pb->deleted_entries, path, strlen(path), ((void*)0));
...
# 1024 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
static svn_error_t *
                      ...
                      apr_pool_t *pool)
{
  ...
  datevalue = apr_hash_get(props, "svn:" "date", strlen("svn:" "date"));
  if (datevalue)
    {
      ...
      datevalue = svn_string_create(svn_time_to_cstring(timetemp, pool),
                                    pool);
      apr_hash_set(props, "svn:" "date", strlen("svn:" "date"), datevalue);
    }
  ...
  for (rev = start_rev; rev <= end_rev; rev++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor(&dump_editor, &dump_edit_baton, fs, rev, "", stream, &found_old_reference, &found_old_mergeinfo, ((void*)0), notify_func, notify_baton, start_rev, use_deltas_for_rev, 0, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1206 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
        }
      else
        {
...
# 1289 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
static svn_error_t *
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_dump_editor(&dump_editor, &dump_edit_baton, fs, rev, "", svn_stream_empty(scratch_pool), ((void*)0), ((void*)0), verify_close_directory, notify_func, notify_baton, start_rev, 0, (!0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1381 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
