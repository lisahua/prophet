# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
svn_fs_fs__load_index(svn_fs_t *fs,
                      ...
                      apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
svn_fs_fs__deserialize_p2l_page(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
svn_fs_fs__order_dir_entries(svn_fs_t *fs,
                             ...
                             svn_revnum_t revision,
                             apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
svn_fs_fs__get_changes(apr_array_header_t **changes,
                       ...
                       svn_revnum_t rev,
                       apr_pool_t *pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
svn_fs_fs__write_rep_header(svn_fs_fs__rep_header_t *header,
                            svn_stream_t *stream,
                            apr_pool_t *scratch_pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c" 2
              ...
              apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_info_get(&finfo, 0x00000100, rev_file->file, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *result_pool)
{
  ...
  stats->largest_changes = memset(apr_palloc(result_pool, sizeof(*stats->largest_changes)), 0, sizeof(*stats->largest_changes));
...
# 374 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static rep_stats_t *
  ...
  if (!result)
    {
      ...
      result = memset(apr_palloc(result_pool, sizeof(*result)), 0, sizeof(*result));
      ...
      if (!svn_fs_fs__use_log_addressing(query->fs))
        {
          ...
          do { if (!(revision_info->rev_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c", 456, "revision_info->rev_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
          do { svn_error_t *svn_err__temp = (svn_io_file_seek(revision_info->rev_file->file, 0, &offset, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          do { svn_error_t *svn_err__temp = (svn_fs_fs__read_rep_header(&header, revision_info->rev_file->stream, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
read_noderev(query_t *query,
             ...
             apr_pool_t *result_pool,
             apr_pool_t *scratch_pool);
# 490 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  do { if (!(revision_info->rev_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c", 505, "revision_info->rev_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_readline(revision_info->rev_file->stream, &line, "\n", &eof, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 538 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
          ...
          apr_pool_t *scratch_pool)
{
  ...
  int i;
  apr_array_header_t *entries;
  do { svn_error_t *svn_err__temp = (svn_fs_fs__rep_contents_dir(&entries, query->fs, noderev, subpool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (svn_fs_fs__id_rev(dirent->id) == revision_info->revision)
        {
          ...
          do { svn_error_t *svn_err__temp = (read_phsy_noderev(&noderev_str, query, svn_fs_fs__id_item(dirent->id), revision_info, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


          do { svn_error_t *svn_err__temp = (read_noderev(query, noderev_str, revision_info, result_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 583 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
static svn_error_t *
read_noderev(query_t *query,
             svn_stringbuf_t *noderev_str,
             revision_info_t *revision_info,
             ...
             apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__read_noderev(&noderev, stream, subpool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (noderev->data_rep)
    {
      do { svn_error_t *svn_err__temp = (parse_representation(&text, query, noderev->data_rep, revision_info, result_pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (noderev->prop_rep)
    {
      do { svn_error_t *svn_err__temp = (parse_representation(&props, query, noderev->prop_rep, revision_info, result_pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ( noderev->kind == svn_node_dir && text && text->ref_count == 1
    ...
    do { svn_error_t *svn_err__temp = (parse_dir(query, noderev, revision_info, result_pool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                      ...
                      apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__get_changes(&changes, query->fs, revision_info->revision, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  apr_off_t start = ((info->offset) < (info->end - sizeof(buf)) ? (info->end - sizeof(buf)) : (info->offset));
  apr_size_t len = (apr_size_t)(info->end - start);
  do { svn_error_t *svn_err__temp = (svn_io_file_seek(info->rev_file->file, 0, &start, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(info->rev_file->file, buf, len, ((void*)0), ((void*)0), scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  trailer = svn_stringbuf_ncreate(buf, len, scratch_pool);


  do { svn_error_t *svn_err__temp = (svn_fs_fs__parse_revision_trailer(&root_node_offset, &changes_offset, trailer, info->revision)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (get_phys_change_count(query, info, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (read_phsy_noderev(&noderev_str, query, root_node_offset, info, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (read_noderev(query, noderev_str, info, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open_pack_or_rev_file(&rev_file, query->fs, base, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (get_file_size(&file_size, rev_file, local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < query->shard_size; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (read_phys_revision(query, info, pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      info->representations = apr_array_copy(pool, info->representations);


      info->rev_file = ((void*)0);
                        ...
                        apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open_pack_or_rev_file(&rev_file, query->fs, revision, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (read_phys_revision(query, info, pool, local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_aligned_seek(rev_file->file, rev_file->block_size, ((void*)0), entry->offset, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (offset = 0; offset < max_offset; )
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__p2l_index_lookup(&entries, query->fs, rev_file, base, offset, ffd->p2l_page_size, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          if (entry->type == 5)
            {
              ...
              do { svn_error_t *svn_err__temp = (read_item(&item, rev_file, entry, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              do { svn_error_t *svn_err__temp = (read_noderev(query, item, info, pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
            }
...
# 1190 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/stats.c"
