...
svn_cache__create_inprocess(svn_cache__t **cache_p,
                            ...
                            const char *id,
                            apr_pool_t *pool);
# 221 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__create_memcache(svn_cache__t **cache_p,
                           ...
                           const char *prefix,
                           apr_pool_t *pool);
# 240 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__make_memcache_from_config(svn_memcache_t **memcache_p,
                                     svn_config_t *config,
                                     apr_pool_t *pool);
# 261 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__membuffer_cache_create(svn_membuffer_t **cache,
                                  ...
                                  svn_boolean_t thread_safe,
                                  apr_pool_t *pool);
# 287 "./subversion/include/private/svn_cache.h"
svn_error_t *
svn_cache__create_membuffer_cache(svn_cache__t **cache_p,
                                  ...
                                  const char *prefix,
                                  apr_pool_t *pool);
# 305 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
svn_cache__is_cachable(svn_cache__t *cache,
                       apr_size_t size);
# 330 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
svn_cache__set(svn_cache__t *cache,
               ...
               void *value,
               apr_pool_t *pool);
# 375 "./subversion/include/private/svn_cache.h"
svn_error_t *
...
# 284 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 427 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
drop_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset != (18446744073709551615UL)) ? (void) (0) : __assert_fail ("entry->offset != (18446744073709551615UL)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 489, __PRETTY_FUNCTION__));
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == cache->current_data) ? (void) (0) : __assert_fail ("entry->offset == cache->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 551, __PRETTY_FUNCTION__));
...
# 657 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
...
# 789 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
      ...
      if (end - cache->current_data >= size)
        return (!0);
# 810 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      if (2 * drop_size > size)
        return 0;
...
# 875 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 899 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
svn_error_t *
svn_cache__membuffer_cache_create(svn_membuffer_t **cache,
                                  apr_size_t total_size,
                                  apr_size_t directory_size,
  ...
  for (seg = 0; seg < 16; ++seg)
    {
      ...
      ((c[seg].directory[0][0].offset == -1) ? (void) (0) : __assert_fail ("c[seg].directory[0][0].offset == -1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 986, __PRETTY_FUNCTION__));
...
# 1025 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                    ...
                    apr_pool_t *pool)
{
  ...
  if ( item != ((void*)0)
      ...
      && ensure_data_insertable(cache, size))
    {
      ...
      entry->size = size;
      entry->offset = cache->current_data;
# 1080 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
...
# 1166 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  entry->hit_count++;
  cache->hit_count++;
  cache->total_hits++;
                            ...
                            apr_pool_t *pool)
{
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      ...
      cache->hit_count++;
      cache->total_hits++;
# 1226 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
typedef struct svn_membuffer_cache_t
{
  ...
  int alloc_counter;
# 1302 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
} svn_membuffer_cache_t;
# 1313 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static void
...
# 1372 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
                                ...
                                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_get_partial(cache->membuffer, full_key, full_key_len, value_p, func, baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1631 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
