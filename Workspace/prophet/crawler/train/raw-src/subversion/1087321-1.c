# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c"
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/switch-cmd.c" 2
  ...
  if (svn_path_is_url(from) != svn_path_is_url(to))
    return svn_error_createf
      (SVN_ERR_INCORRECT_PARAMS, ((void*)0),
       dcgettext ("subversion", "'%s' to '%s' is not a valid relocation", 5), from, to);

  subpool = svn_pool_create_ex(pool, ((void*)0));

  if (targets->nelts == 2)
    {
      do { svn_error_t *svn_err__temp = (svn_client_relocate2("", from, to, ignore_externals, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (i = 2; i < targets->nelts; i++)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_client_relocate2(target, from, to, ignore_externals, ctx, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *scratch_pool)
{
  ...
  apr_array_header_t *targets;
  const char *target = ((void*)0), *switch_url = ((void*)0);
  ...
  do { svn_error_t *svn_err__temp = (svn_opt_parse_path(&peg_revision, &true_path, switch_url, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! svn_path_is_url(switch_url))
    return svn_error_createf
      (SVN_ERR_BAD_URL, ((void*)0),
       dcgettext ("subversion", "'%s' does not appear to be a URL", 5), switch_url);
  ...
  err = svn_client_switch3(((void*)0), target, switch_url, &peg_revision,
  ...
  if (err)
    {
      if (err->apr_err == SVN_ERR_CLIENT_UNRELATED_RESOURCES)
        return svn_error_createf(SVN_ERR_CLIENT_UNRELATED_RESOURCES, err,
                                 dcgettext ("subversion", "Path '%s' does not share common version " "control ancestry with the requested switch " "location.  Use --ignore-ancestry to " "disable this check.", 5), target);
  ...
  if (! opt_state->quiet)
    do { svn_error_t *svn_err__temp = (svn_cl__print_conflict_stats(nwb.wrapped_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (nwb.had_externals_error)
    return svn_error_create(SVN_ERR_CL_ERROR_PROCESSING_EXTERNALS, ((void*)0),
