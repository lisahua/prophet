  ...
  while (have_row)
    {
      ...
      (*((const char * *)apr_array_push(child_relpaths))) = local_relpath;
...
wipe_obsolete_files(const char *wcroot_abspath, apr_pool_t *scratch_pool)
{
  ...
  svn_error_clear(svn_io_remove_file2(
                     svn_wc__adm_child(wcroot_abspath,
                                      ...
                                      scratch_pool),
                     (!0), scratch_pool));
# 517 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  svn_error_clear(svn_io_remove_file2(
                    build_lockfile_path(wcroot_abspath, scratch_pool),
                    (!0), scratch_pool));
}
# 532 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  if (entry->repos == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",568), (svn_error_createf))(
  ...
  if (entry->uuid == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",575), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
   ...
   if (entry->url == ((void*)0))
     return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",582), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 855 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  if (*name == '\0')
    {
      base_abspath = svn_wc__adm_child(wcroot_abspath, "dir-prop-base",
                                       scratch_pool);
      revert_abspath = svn_wc__adm_child(wcroot_abspath, "dir-prop-revert",
                                         scratch_pool);
      working_abspath = svn_wc__adm_child(wcroot_abspath, "dir-props",
                                          scratch_pool);
    }
  else
    {
      ...
      propsdir_abspath = svn_wc__adm_child(wcroot_abspath, "props",
                                           scratch_pool);
      basedir_abspath = svn_wc__adm_child(wcroot_abspath, "prop-base",
                                          scratch_pool);
  ...
  return (svn_wc__db_upgrade_apply_props( sdb, wcroot_abspath, name, base_props, revert_props, working_props, original_format, scratch_pool));
...
migrate_props(const char *wcroot_abspath,
              ...
              apr_pool_t *scratch_pool)
{
# 1014 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  const apr_array_header_t *children;
  apr_pool_t *iterpool = svn_pool_create_ex(scratch_pool, ((void*)0));
  int i;


  do { svn_error_t *svn_err__temp = (migrate_node_props(wcroot_abspath, "", sdb, original_format, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (get_versioned_files(&children, sdb, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  for (i = 0; i < children->nelts; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (migrate_node_props(wcroot_abspath, name, sdb, original_format, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
bump_to_18(void *baton, svn_sqlite__db_t *sdb, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (migrate_props(b18->wcroot_abspath, sdb, b18->original_format, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(scratch_pool, dirents); hi;
            hi = apr_hash_next(hi))
    {
      ...
      text_base_path = svn_dirent_join(text_base_dir, text_base_basename,
                                       iterpool);
# 1104 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__db_pristine_get_future_path(&pristine_path, wcroot_abspath, sha1_checksum, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
bump_to_17(void *baton, svn_sqlite__db_t *sdb, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (migrate_text_bases(wcroot_abspath, sdb, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_check_path(logfile_path, &logfile_on_disk, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (logfile_on_disk == svn_node_file)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1203), (svn_error_create))(SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
  ...
  do { svn_error_t *svn_err__temp = (create_physical_lock(dir_abspath, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1230 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  do { svn_error_t *svn_err__temp = (svn_wc__read_entries_old(&entries, dir_abspath, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  this_dir = apr_hash_get(entries, "", (-1));
  do { svn_error_t *svn_err__temp = (ensure_repos_info(this_dir, dir_abspath, repos_info_func, repos_info_baton, repos_cache, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__db_upgrade_begin(&sdb, &repos_id, &wc_id, dir_abspath, this_dir->repos, this_dir->uuid, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1260 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  do { svn_error_t *svn_err__temp = (svn_wc__db_temp_reset_format(18, db, dir_abspath, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_wc__db_wclock_obtain(db, dir_abspath, 0, 0, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_wc__write_upgraded_entries(db, sdb, repos_id, wc_id, dir_abspath, entries, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (old_format != 12)
    {
      ...
      if (old_format <= 7)
        do { svn_error_t *svn_err__temp = (read_many_wcprops(&all_wcprops, dir_abspath, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      else
        do { svn_error_t *svn_err__temp = (read_wcprops(&all_wcprops, dir_abspath, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_wc__db_upgrade_apply_dav_cache(sdb, all_wcprops, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }

  do { svn_error_t *svn_err__temp = (migrate_text_bases(dir_abspath, sdb, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (migrate_props(dir_abspath, sdb, old_format, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_wc__db_upgrade_finish(dir_abspath, sdb, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__db_wclock_release(db, dir_abspath, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  if (start_format < 12 )
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1326), (svn_error_createf))(SVN_ERR_WC_UPGRADE_REQUIRED, ((void*)0),
...
# 1449 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  if (old_format < 12)
    do { svn_error_t *svn_err__temp = (upgrade_to_wcng(db, dir_abspath, old_format, repos_info_func, repos_info_baton, repos_cache, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < subdirs->nelts; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (upgrade_working_copy(db, child_abspath, repos_info_func, repos_info_baton, repos_cache, cancel_func, cancel_baton, notify_func, notify_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1549 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  do { svn_error_t *svn_err__temp = (upgrade_working_copy(db, local_abspath, repos_info_func, repos_info_baton, apr_hash_make(scratch_pool), cancel_func, cancel_baton, notify_func, notify_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
