...
svn_wc__db_scan_addition(svn_wc__db_status_t *status,
                         ...
                         apr_pool_t *result_pool,
                         apr_pool_t *scratch_pool);
# 2540 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_upgrade_apply_props(svn_sqlite__db_t *sdb,
                               ...
                               int original_format,
                               apr_pool_t *scratch_pool);
# 2603 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_wq_add(svn_wc__db_t *db,
                  ...
                  apr_pool_t *scratch_pool);
# 2638 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
...
svn_wc__db_is_sparse_checkout(svn_boolean_t *is_sparse_checkout,
                              ...
                              const char *local_abspath,
                              apr_pool_t *scratch_pool);
# 2984 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/wc_db.h"
svn_error_t *
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (arg1->next->next)
  ...
  else
    {
      ...
      do { if (!(29 <= 28)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 250, "SVN_WC__VERSION <= 28")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  if (arg4 != ((void*)0))
    ...
    {
      do { if (!(checksum != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 661, "checksum != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 802 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(wri_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 899, "svn_dirent_is_absolute(wri_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(src_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 900, "svn_dirent_is_absolute(src_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(dst_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 901, "svn_dirent_is_absolute(dst_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 932 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                                      ...
                                      apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 993, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(src_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 994, "svn_dirent_is_absolute(src_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  do { if (!(svn_dirent_is_absolute(dst_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 995, "svn_dirent_is_absolute(dst_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 1031 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c"
static svn_error_t *
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  if (arg1->next != ((void*)0))
    ...
    do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1097, ((void*)0))); } while (0);
  ...
  do { if (!(prejfile_abspath != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1108, "prejfile_abspath != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                              ...
                              apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(conflict_skel != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1131, "conflict_skel != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                 ...
                                 apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1213, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                               ...
                                               apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1306, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                                  ...
                                                  apr_pool_t *scratch_pool)
{
  ...
  *work_item = svn_skel__make_empty_list(result_pool);
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/workqueue.c", 1388, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
