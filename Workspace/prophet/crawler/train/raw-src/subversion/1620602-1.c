# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/home/ubuntu/Workspace/utils/llvm-build/bin/../lib/clang/3.5.0/include/stddef.h" 1 3 4
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c" 2
...
svn_fs_fs__id_deserialize(void *buffer,
                          svn_fs_id_t **id);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c" 2
...
# 234 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.h"
...
{
# 522 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.h"
  ...
  svn_fs_fs__id_part_t txn_id;
# 553 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.h"
  struct
    {
...
svn_fs_fs__deserialize_p2l_page(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c" 2
...
# 59 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c"
  ...
  while (1)
    {
      ...
      if (result > (9223372036854775807L *2UL+1UL) / 10)
        return 0;
             ...
             const char *data)
{
  ...
  data = (__extension__ (__builtin_constant_p ('-') && !__builtin_constant_p (end) && ('-') == '\0' ? (char *) __rawmemchr (end, '-') : __builtin_strchr (end, '-')));
  if (data == ((void*)0))
    return 0;
...
{
  return ((txn_id->revision) >= 0) || (txn_id->number != 0);
}

void
svn_fs_fs__id_txn_reset(svn_fs_fs__id_part_t *txn_id)
{
  txn_id->revision = ((svn_revnum_t) -1);
  txn_id->number = 0;
}
                            ...
                            const svn_fs_id_t *b)
{
  ...
  if (id_a->private_id.node_id.revision == ((svn_revnum_t) -1))
    {
...
svn_fs_fs__id_txn_create_root(const svn_fs_fs__id_part_t *txn_id,
                              apr_pool_t *pool)
{
  fs_fs__id_t *id = memset(apr_palloc(pool, sizeof(*id)), 0, sizeof(*id));



  id->private_id.txn_id = *txn_id;
  id->private_id.rev_item.revision = ((svn_revnum_t) -1);
                                       ...
                                       apr_pool_t *pool)
{
  ...
  id->private_id.txn_id.revision = ((svn_revnum_t) -1);
  id->private_id.rev_item.revision = revision;
  id->private_id.rev_item.number = 2;
                    ...
                    apr_pool_t *pool)
{
  ...
  id = memset(apr_palloc(pool, sizeof(*id)), 0, sizeof(*id));
  id->generic_id.vtable = &id_vtable;
  id->generic_id.fsap_data = id;
# 511 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/id.c"
