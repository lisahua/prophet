...
# 290 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 443 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
drop_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset != (18446744073709551615UL)) ? (void) (0) : __assert_fail ("entry->offset != (18446744073709551615UL)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 505, __PRETTY_FUNCTION__));
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == cache->current_data) ? (void) (0) : __assert_fail ("entry->offset == cache->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 567, __PRETTY_FUNCTION__));
...
initialize_group(svn_membuffer_t *cache, apr_uint32_t group_index)
{
  ...
  apr_uint32_t first_index = group_index & -32;
  apr_uint32_t last_index = group_index + 32;
  ...
  for (i = first_index; i < last_index; ++i)
    entry[i].offset = (18446744073709551615UL);
...
# 715 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static entry_t *
...
# 863 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
      ...
      if (end - cache->current_data >= size)
        return (!0);
# 884 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      if (2 * drop_size > size)
        return 0;
...
# 949 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 973 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
svn_error_t *
svn_cache__membuffer_cache_create(svn_membuffer_t **cache,
                                  apr_size_t total_size,
                                  apr_size_t directory_size,
                                  ...
                                  apr_pool_t *pool)
{
  ...
  apr_uint64_t data_size;
# 1001 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 1119 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
                    ...
                    apr_pool_t *pool)
{
  ...
  if (item)
    do { svn_error_t *svn_err__temp = (serializer(&buffer, &size, item, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (lock_cache(cache)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if ( item != ((void*)0)
      ...
      && ensure_data_insertable(cache, size))
    {
      ...
      entry->size = size;
      entry->offset = cache->current_data;
# 1174 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
                    ...
                    apr_pool_t *pool)
{
  ...
  buffer = ((void*)((((apr_size_t)(char*)(apr_palloc(pool, size + 16 -1))) + 16 -1) & -16));
  memcpy(buffer, (const char*)cache->data + entry->offset, size);
# 1260 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  entry->hit_count++;
  cache->hit_count++;
  cache->total_hits++;

  do { svn_error_t *svn_err__temp = (unlock_cache(cache, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      cache->hit_count++;
      cache->total_hits++;
# 1330 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->hit_count++;
      cache->total_writes++;
# 1400 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
          ...
          if (data != orig_data)
            {
              ...
              if ( (cache->data_size / 4 > size)
                  && ensure_data_insertable(cache, size))
                {
                  ...
                  insert_entry(cache, entry);
# 1442 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
                }
            }
        }
    }
...
# 1470 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
typedef struct svn_membuffer_cache_t
{
  ...
  int alloc_counter;
# 1516 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
} svn_membuffer_cache_t;
# 1527 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static void
                        ...
                        apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_get(cache->membuffer, full_key, full_key_len, value_p, cache->deserializer, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1586 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
                                ...
                                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_get_partial(cache->membuffer, full_key, full_key_len, value_p, found, func, baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1692 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
                                ...
                                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (membuffer_cache_set_partial(cache->membuffer, full_key, full_key_len, func, baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < cache->membuffer->segment_count; ++i)
    {
      ...
      do { svn_error_t *svn_err__temp = (lock_cache(segment)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (unlock_cache(segment, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 1880 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
