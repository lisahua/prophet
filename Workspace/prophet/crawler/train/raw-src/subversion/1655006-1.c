...
svn_rdump__normalize_prop(const char *name,
                          const svn_string_t **value,
                          apr_pool_t *result_pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
# 157 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
...
# 261 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
static svn_error_t *
                 ...
                 apr_pool_t *pool)
{
  ...
  ((svn_relpath_is_canonical(node_relpath)) ? (void) (0) : __assert_fail ("svn_relpath_is_canonical(node_relpath)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c", 268, __PRETTY_FUNCTION__));
...
# 295 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
static svn_error_t *
          ...
          apr_pool_t *pool)
{
  ...
  ((svn_relpath_is_canonical(repos_relpath)) ? (void) (0) : __assert_fail ("svn_relpath_is_canonical(repos_relpath)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c", 309, __PRETTY_FUNCTION__));
  ((!copyfrom_path || svn_relpath_is_canonical(copyfrom_path)) ? (void) (0) : __assert_fail ("!copyfrom_path || svn_relpath_is_canonical(copyfrom_path)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c", 310, __PRETTY_FUNCTION__));
  ((! (db && fb)) ? (void) (0) : __assert_fail ("! (db && fb)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c", 311, __PRETTY_FUNCTION__));
...
# 407 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
          if (db)
            db->dump_newlines = (!0);
        }
      else
        {
# 428 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
          if (fb)
            fb->dump_props = (!0);
          else if (db)
            db->dump_props = (!0);
...
# 724 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
