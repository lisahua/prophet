# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c" 2
...
svn_cl__merge_file_externally(const char *base_path,
                              ...
                              apr_pool_t *pool);
# 545 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
...
# 590 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
...
svn_cl__operation_str_human_readable(svn_wc_operation_t operation,
                                     apr_pool_t *pool);
# 680 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
void
...
svn_cl__node_description(const svn_wc_conflict_version_t *node,
                         ...
                         apr_pool_t *pool);
# 737 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
const char *
svn_cl__path_join(const char *base,
                  const char *component,
                  apr_pool_t *pool);
# 781 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl.h"
svn_error_t *
svn_cl__eat_peg_revisions(apr_array_header_t **true_targets_p,
                          const apr_array_header_t *targets,
                          apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c" 2
            ...
            apr_pool_t *pool)
{
  ...
  if (! targets->nelts)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c",60), (svn_error_create))(SVN_ERR_CL_INSUFFICIENT_ARGS, 0, ((void*)0));
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (svn_path_is_url(target))
        return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c",74), (svn_error_createf))(SVN_ERR_ILLEGAL_TARGET, ((void*)0), dcgettext ("subversion", "'%s' is not a local path", 5), target));
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cl__try (svn_client_add4(svn_dirent_canonicalize(target, iterpool), opt_state->depth, opt_state->force, opt_state->no_ignore, opt_state->parents, ctx, iterpool), ((void*)0), opt_state->quiet, SVN_ERR_ENTRY_EXISTS, SVN_ERR_WC_PATH_NOT_FOUND, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 96 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/add-cmd.c"
    }
