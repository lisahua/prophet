...
# 112 "./subversion/include/svn_ra_svn.h"
...
svn_ra_svn_create_conn(apr_socket_t *sock,
                       ...
                       apr_file_t *out_file,
                       apr_pool_t *pool);
# 176 "./subversion/include/svn_ra_svn.h"
svn_error_t *
...
svn_ra_svn_flush(svn_ra_svn_conn_t *conn,
                 apr_pool_t *pool);
# 295 "./subversion/include/svn_ra_svn.h"
svn_error_t *
...
# 313 "./subversion/include/svn_ra_svn.h"
svn_error_t *
svn_ra_svn_skip_leading_garbage(svn_ra_svn_conn_t *conn,
                                apr_pool_t *pool);
# 349 "./subversion/include/svn_ra_svn.h"
svn_error_t *
...
svn_ra_svn_drive_editor(svn_ra_svn_conn_t *conn,
                        ...
                        void *edit_baton,
                        svn_boolean_t *aborted);
# 482 "./subversion/include/svn_ra_svn.h"
svn_error_t *
...
svn_error_t *serve(svn_ra_svn_conn_t *conn, serve_params_t *params,
                   apr_pool_t *pool);
# 120 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/server.h"
...
# 195 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
...
{
  apr_size_t i;
# 247 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
...
static svn_error_t * version(apr_pool_t *pool)
{
  ...
  return svn_opt_print_help3(((void*)0), "svnserve", (!0), 0, version_footer->data,
...
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 256:
          {
            ...
            if (err)
              return svn_cmdline_handle_exit_error(
                       (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",484), (svn_error_createf))(SVN_ERR_CL_ARG_PARSING_ERROR, err,
        ...
        case 'T':
          ...
          break;
# 553 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
        case 263:
  ...
  if (config_filename)
      do { svn_error_t *svn_err__temp = (load_configs(&params.cfg, &params.pwdb, &params.authzdb, config_filename, (!0), svn_dirent_dirname(config_filename, pool), ((void*)0), ((void*)0), pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);
  ...
  if (run_mode == run_mode_inetd || run_mode == run_mode_tunnel)
    {
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",623), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't open stdin", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",630), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't open stdout", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }

      conn = svn_ra_svn_create_conn(((void*)0), in_file, out_file, pool);
      svn_error_clear(serve(conn, &params, pool));
      exit(0);
    }
# 699 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",726), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't get address info", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",740), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create server socket", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",751), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't bind server socket", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
...
# 789 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
  while (1)
    {
# 799 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
      connection_pool = svn_pool_create_ex(((void*)0), ((void*)0));
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",816), (svn_error_wrap_apr))
            (status, dcgettext ("subversion", "Can't accept client connection", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
# 829 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c"
      ...
      conn = svn_ra_svn_create_conn(usock, ((void*)0), ((void*)0), connection_pool);
      ...
      switch (handling_mode)
        ...
        case connection_mode_fork:
          ...
          if (status == ((20000 + 50000) + 1))
            ...
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",873), (svn_error_wrap_apr))(status, "apr_proc_fork");
              log_error(err, params.log_file,
                        svn_ra_svn_conn_remote_host(conn),
                        ((void*)0), ((void*)0),
                        connection_pool);
        ...
        case connection_mode_thread:
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",893), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create threadattr", 5));
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",901), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't set detached state", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/main.c",914), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create thread", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
