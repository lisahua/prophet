...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/rep-cache.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/rep-cache.c" 2




static const char * const statements[] = { "PRAGMA AUTO_VACUUM = 1; " "CREATE TABLE rep_cache ( " "  hash TEXT NOT NULL PRIMARY KEY, " "  revision INTEGER NOT NULL, " "  offset INTEGER NOT NULL, " "  size INTEGER NOT NULL, " "  expanded_size INTEGER NOT NULL " "  ); " "PRAGMA USER_VERSION = 1; " "", "SELECT revision, offset, size, expanded_size " "FROM rep_cache " "WHERE hash = ?1 " "", "INSERT OR FAIL INTO rep_cache (hash, revision, offset, size, expanded_size) " "VALUES (?1, ?2, ?3, ?4, ?5) " "", ((void*)0) };
                             ...
                             apr_pool_t *pool)
{
  ...
  do { if (!(ffd->rep_sharing_allowed)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/rep-cache.c", 94, "ffd->rep_sharing_allowed")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  if (! ffd->rep_cache_db)
                             ...
                             apr_pool_t *pool)
{
  ...
  do { if (!(ffd->rep_sharing_allowed)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/rep-cache.c", 155, "ffd->rep_sharing_allowed")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  if (! ffd->rep_cache_db)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__open_rep_cache(fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
