# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c"
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c" 2
...
svn_compat_wrap_file_rev_handler(svn_file_rev_handler_t *handler2,
                                 ...
                                 void *handler_baton,
                                 apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/svnrdump.h" 2
...
svn_rdump__load_dumpstream(svn_stream_t *stream,
                           ...
                           void *cancel_baton,
                           apr_pool_t *pool);
# 106 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/svnrdump.h"
svn_error_t *
svn_rdump__normalize_props(apr_hash_t **normal_props,
                           apr_hash_t *props,
                           apr_pool_t *result_pool);
# 120 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/svnrdump.h"
svn_error_t *
svn_rdump__normalize_prop(const char *name,
                          const svn_string_t **value,
                          apr_pool_t *result_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/util.c" 2
  ...
  *normal_props = apr_hash_make(result_pool);
  ...
  for (hi = apr_hash_first(result_pool, props); hi;
        hi = apr_hash_next(hi))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_rdump__normalize_prop(key, &value, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      apr_hash_set(*normal_props, key, (-1), value);
    }
  return 0;
}
