# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
apr_status_t apr_password_validate(const char *passwd,
                                                const char *hash);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_ra_get_ra_library(svn_ra_plugin_t **library,
                      ...
                      const char *url,
                      apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
# 1 "./subversion/include/svn_error_codes.h" 1
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_client__arbitrary_nodes_diff(const char **root_relpath,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 50 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_ra__replay_ev2(svn_ra_session_t *session,
                   ...
                   svn_editor_t *editor,
                   apr_pool_t *scratch_pool);
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
# 52 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
# 56 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c" 2
...
# 86 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c"
static svn_error_t *
                   ...
                   apr_pool_t *pool)
{
  ...
  if (keywords_val)
    do { svn_error_t *svn_err__temp = (svn_subst_build_keywords3(&keywords, keywords_val->data, "((svn_revnum_t) -1)", "", "", 0, "", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 189 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c"
static svn_error_t *
            ...
            apr_pool_t *pool)
{
  ...
  if (dirent->special)
    {
      apr_hash_set(properties, "svn:" "special", (-1), svn_string_create("*", pool));
...
# 284 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c"
static svn_error_t *
      ...
      if (dirent->kind == svn_node_dir && depth >= svn_depth_immediates)
        {
          ...
          do { svn_error_t *svn_err__temp = (import_dir(editor, dir_baton, this_abspath, this_edit_path, depth_below_here, excludes, global_ignores, no_ignore, no_autoprops, ignore_unknown_node_types, filter_callback, filter_baton, import_ctx, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 515 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c"
static svn_error_t *
import_dir(const svn_delta_editor_t *editor,
           void *dir_baton,
           const char *local_abspath,
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_path_check_valid(local_abspath, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (get_filtered_children(&dirents, local_abspath, excludes, ((void*)0), global_ignores, filter_callback, filter_baton, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (import_children(local_abspath, edit_path, dirents, editor, this_dir_baton, depth, excludes, global_ignores, no_ignore, no_autoprops, ignore_unknown_node_types, filter_callback, filter_baton, import_ctx, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 634 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c"
static svn_error_t *
       ...
       apr_pool_t *pool)
{
  ...
  const char *edit_path = "";
  import_ctx_t import_ctx = { 0 };
  const svn_io_dirent2_t *dirent;

  *updated_repository = 0;

  import_ctx.autoprops = autoprops;
  do { svn_error_t *svn_err__temp = (svn_magic__init(&import_ctx.magic_cookie, ctx->config, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (editor->open_root(edit_baton, base_rev, pool, &root_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_io_stat_dirent2(&dirent, local_abspath, 0, 0, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 717 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/import.c"
  if (dirent->kind == svn_node_file)
  ...
  else if (dirent->kind == svn_node_dir)
    {
      ...
      if (!no_ignore && new_entries->nelts)
        local_ignores = ((void*)0);

      do { svn_error_t *svn_err__temp = (get_filtered_children(&dirents, local_abspath, excludes, local_ignores, global_ignores, filter_callback, filter_baton, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




      do { svn_error_t *svn_err__temp = (import_children(local_abspath, edit_path, dirents, editor, root_baton, depth, excludes, global_ignores, no_ignore, no_autoprops, ignore_unknown_node_types, filter_callback, filter_baton, &import_ctx, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_client_open_ra_session2(&ra_session, url, ((void*)0), ctx, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_ra_get_latest_revnum(ra_session, &base_rev, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_ra_check_path(ra_session, "", base_rev, &kind, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (new_entries->nelts)
    {
      const char *last_component
        = (((const char * *)(new_entries)->elts)[new_entries->nelts - 1]);
  ...
  if (! no_ignore )
    {
      do { svn_error_t *svn_err__temp = (svn_ra_get_dir2(ra_session, ((void*)0), ((void*)0), &url_props, "", base_rev, 0x00001, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_ra_get_inherited_props(ra_session, &inherited_props, "", base_rev, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (no_ignore)
    {
      global_ignores = ((void*)0);
      local_ignores_arr = ((void*)0);
    }
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc_get_default_ignores(&config_ignores, ctx->config, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      global_ignores = apr_array_append(scratch_pool, global_ignores,
                                        config_ignores);

      val = apr_hash_get(url_props, "svn:" "global-ignores", (-1));
      if (val)
      ...
      for (i = 0; i < inherited_props->nelts; i++)
        {
          ...
          val = apr_hash_get(elt->prop_hash, "svn:" "global-ignores", (-1));
      ...
      val = apr_hash_get(url_props, "svn:" "ignore", (-1));
  ...
  err = (import(&updated_repository, local_abspath, url, new_entries, editor, edit_baton, depth, base_rev, excludes, autoprops, local_ignores_arr, global_ignores, no_ignore, no_autoprops, ignore_unknown_node_types, filter_callback, filter_baton, ctx, iterpool));
