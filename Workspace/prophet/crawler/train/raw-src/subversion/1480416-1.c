...
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
...
svn_client__youngest_common_ancestor(const char **ancestor_url,
                                     ...
                                     apr_pool_t *result_pool,
                                     apr_pool_t *scratch_pool);
# 238 "./subversion/include/private/svn_client_private.h"
svn_error_t *
svn_client__wc_node_get_base(svn_client__pathrev_t **base_p,
                             ...
                             apr_pool_t *result_pool,
                             apr_pool_t *scratch_pool);
# 253 "./subversion/include/private/svn_client_private.h"
svn_error_t *
...
svn_client__arbitrary_nodes_diff(const char *local_abspath1,
                                 ...
                                 svn_client_ctx_t *ctx,
                                 apr_pool_t *scratch_pool);
# 283 "./subversion/include/private/svn_client_private.h"
svn_error_t *
svn_client__copy_foreign(const char *url,
                         ...
                         svn_client_ctx_t *ctx,
                         apr_pool_t *scratch_pool);
# 310 "./subversion/include/private/svn_client_private.h"
svn_error_t *
...
# 83 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__get_copy_source(const char **original_repos_relpath,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 138 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
svn_client__repos_locations(const char **start_url,
                            ...
                            svn_client_ctx_t *ctx,
                            apr_pool_t *pool);
# 159 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
svn_client__repos_location(svn_client__pathrev_t **op_loc_p,
                           ...
                           apr_pool_t *result_pool,
                           apr_pool_t *scratch_pool);
# 186 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
svn_client__repos_location_segments(apr_array_header_t **segments,
                                    ...
                                    svn_client_ctx_t *ctx,
                                    apr_pool_t *pool);
# 213 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
svn_client__get_youngest_common_ancestor(svn_client__pathrev_t **ancestor_p,
                                         ...
                                         apr_pool_t *result_pool,
                                         apr_pool_t *scratch_pool);
# 243 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__ra_make_cb_baton(svn_wc_context_t *wc_ctx,
                             ...
                             apr_pool_t *result_pool);
# 350 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *svn_client__get_paths_auto_props(
  ...
  apr_pool_t *result_pool,
  apr_pool_t *scratch_pool);
# 385 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
...
svn_error_t *svn_client__get_inherited_ignores(apr_array_header_t **ignores,
                                               ...
                                               apr_pool_t *result_pool,
                                               apr_pool_t *scratch_pool);
# 413 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__make_local_parents(const char *path,
                               ...
                               svn_client_ctx_t *ctx,
                               apr_pool_t *pool);
# 489 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
# 783 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
typedef struct svn_client__committables_t
{


  apr_hash_t *by_repository;
# 797 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
  apr_hash_t *by_path;
...
typedef svn_error_t *(*svn_client__check_url_kind_t)(void *baton,
                                                     ...
                                                     svn_revnum_t revision,
                                                     apr_pool_t *scratch_pool);
# 851 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__do_commit(const char *base_url,
                      ...
                      apr_pool_t *result_pool,
                      apr_pool_t *scratch_pool);
# 979 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
svn_client__handle_externals(apr_hash_t *externals_new,
                             ...
                             svn_client_ctx_t *ctx,
                             apr_pool_t *pool);
# 1006 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_client__ensure_revprop_table(apr_hash_t **revprop_table_out,
                                 ...
                                 svn_client_ctx_t *ctx,
                                 apr_pool_t *pool);
# 1069 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/client.h"
svn_error_t *
  ...
  if (! props_only)
    {
      ...
      fstream = svn_stream_checksummed2(fstream, ((void*)0), &fb->start_md5_checksum,
                                        svn_checksum_md5, (!0), scratch_pool);
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { if (!(((eb->revision) >= 0))) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c", 548, "((eb->revision) >= 0)"), (((void*)0))); } } while (0);
                ...
                void **handler_baton)
{
  ...
  do { if (!(fb->path_start_revision != ((void*)0))) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/repos_diff.c", 917, "fb->path_start_revision != ((void*)0)"), (((void*)0))); } } while (0);
