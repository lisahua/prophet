# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h" 1
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h"
# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_want.h" 1
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h" 2
...
svn_config_get_user_config_path(const char **path,
                                ...
                                const char *fname,
                                apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h" 2
...
svn_error_t *svn_config__parse_file(svn_config_t *cfg,
                                    ...
                                    svn_boolean_t must_exist,
                                    apr_pool_t *pool);
# 138 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h"
svn_error_t *
svn_config__sys_config_path(const char **path_p,
                            const char *fname,
                            apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
svn_io_write_version_file(const char *path,
                          int version,
                          apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
svn_auth_get_ssl_client_cert_pw_prompt_provider(
  ...
  int retry_limit,
  apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
...
svn_ctype_casecmp(int a,
                  int b);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2

# 1 "./subversion/svn_private_config.h" 1
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c" 2
# 51 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
...
# 82 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
...
parser_getc(parse_context_t *ctx, int *c)
{
  if (ctx->have_ungotten_char)
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_read(ctx->stream, &char_buf, &readlen)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
skip_whitespace(parse_context_t *ctx, int *c, int *pcount)
{
  ...
  while (ch != (-1) && ch != '\n' && (0 != (svn_ctype_table[(unsigned char)((ch))] & (0x0002))))
    {
      ++count;
      do { svn_error_t *svn_err__temp = (parser_getc(ctx, &ch)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 286 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
static svn_error_t *
...
{
  *path_p = ((void*)0);
# 353 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  ...
  do
    {
      ...
      switch (ch)
        ...
        case '[':
          if (count == 0)
            do { svn_error_t *svn_err__temp = (parse_section_name(&ch, &ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          else
        ...
        default:
          if (svn_stringbuf_isempty(ctx.section))
            ...
            do { svn_error_t *svn_err__temp = (parse_option(&ch, &ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;
        }
    }
  while (ch != (-1));
                   ...
                   apr_pool_t *pool)
{
  ...
  subdir_full_path = svn_dirent_join_many(pool, auth_dir, subdir, ((void*)0));
                 ...
                 apr_pool_t *pool)
{
  ...
  auth_dir = svn_dirent_join_many(pool, path, "auth", ((void*)0));
...
# 559 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "# password-stores =" "\n"
# 978 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
        "###" "\n"
...
# 1151 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_file.c"
  {
