...
svn_error_t *serve(svn_ra_svn_conn_t *conn, serve_params_t *params,
                   apr_pool_t *pool);
# 120 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/server.h"
...
# 195 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c"
...
{
  apr_size_t i;
# 247 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c"
...
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c"
  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 256:
          {
            ...
            if (err)
              return svn_cmdline_handle_exit_error(
                       (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",484), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, err,
        ...
        case 'T':
          ...
          break;
# 553 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c"
        case 263:
  ...
  if (run_mode == run_mode_inetd || run_mode == run_mode_tunnel)
    {
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",623), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't open stdin", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",630), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't open stdout", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
...
# 699 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c"
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",726), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't get address info", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",740), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create server socket", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
  ...
  if (status)
    {
      err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",751), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't bind server socket", 5));
      return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
    }
...
# 789 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c"
  while (1)
    {
# 799 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c"
      ...
      if (status)
        {
          err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",816), (svn_error_wrap_apr))
            (status, dcgettext ("subversion", "Can't accept client connection", 5));
          return svn_cmdline_handle_exit_error(err, pool, "svnserve: ");
        }
# 829 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c"
      ...
      switch (handling_mode)
        ...
        case connection_mode_fork:
          ...
          if (status == ((20000 + 50000) + 1))
            ...
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",873), (svn_error_wrap_apr))(status, "apr_proc_fork");
              log_error(err, params.log_file,
                        svn_ra_svn_conn_remote_host(conn),
                        ((void*)0), ((void*)0),
                        connection_pool);
        ...
        case connection_mode_thread:
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",893), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create threadattr", 5));
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",901), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't set detached state", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
          ...
          if (status)
            {
              err = (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnserve/main.c",914), (svn_error_wrap_apr))(status, dcgettext ("subversion", "Can't create thread", 5));
              svn_handle_error2(err, stderr, 0, "svnserve: ");
              svn_error_clear(err);
              exit(1);
            }
