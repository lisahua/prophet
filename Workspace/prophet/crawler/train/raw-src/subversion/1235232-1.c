      ...
      switch (action->action)
        {
          ...
          case ACTION_SET_TEXT:
            {
              ...
              if (!((text_base_revision) >= 0))
                ...
                do { if (!(pca->base_revision == text_base_revision)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 314, "pca->base_revision == text_base_revision")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 338, ((void*)0))); } while (0);
        }
    }
...
# 950 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 969, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      for (i = 0; i < propdiffs->nelts; i++)
        {
          ...
          if (!prop->value)
            ...
            apr_hash_set(operation->prop_mods, prop->name, (-1),
  ...
  if (action == ACTION_DELETE)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 1075, ((void*)0))); } while (0);
    }
           ...
           apr_pool_t *scratch_pool)
{
  ...
  if (op->operation == OP_DELETE || op->operation == OP_REPLACE)
    {
      do { svn_error_t *svn_err__temp = (editor->delete_entry(path, ((svn_revnum_t) -1), parent_op->baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1706 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
  return 0;
}
