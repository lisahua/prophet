# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c"
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/fs.h"
...
svn_fs_fs__pack(svn_fs_t *fs,
                ...
                void *cancel_baton,
                apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c" 2
...
svn_fs_fs__del_rep_reference(svn_fs_t *fs,
                             ...
                             apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c" 2



# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache-db.h" 1
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c" 2




static const char * const statements[] = { "PRAGMA AUTO_VACUUM = 1; " "CREATE TABLE rep_cache ( " "  hash TEXT NOT NULL PRIMARY KEY, " "  revision INTEGER NOT NULL, " "  offset INTEGER NOT NULL, " "  size INTEGER NOT NULL, " "  expanded_size INTEGER NOT NULL " "  ); " "PRAGMA USER_VERSION = 1; " "", "SELECT revision, offset, size, expanded_size " "FROM rep_cache " "WHERE hash = ?1 " "", "INSERT OR FAIL INTO rep_cache (hash, revision, offset, size, expanded_size) " "VALUES (?1, ?2, ?3, ?4, ?5) " "", "SELECT hash, revision, offset, size, expanded_size " "FROM rep_cache " "", "DELETE FROM rep_cache " "WHERE revision > ?1 " "", ((void*)0) };
...
path_rep_cache_db(const char *fs_path,
                  apr_pool_t *result_pool)
{
  return svn_dirent_join(fs_path, "rep-cache.db", result_pool);
}
                  ...
                  apr_pool_t *pool)
{
  ...
  do { if (!(rep)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 62, "rep")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  youngest = ffd->youngest_rev_cache;
  if (youngest < rep->revision)
  {

    do { svn_error_t *svn_err__temp = (svn_fs_fs__youngest_rev(&youngest, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


    if (youngest < rep->revision)
      return svn_error_createf(SVN_ERR_FS_CORRUPT, ((void*)0),
                               dcgettext ("subversion", "Youngest revision is r%ld, but " "rep-cache contains r%ld", 5),
...
# 88 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c"
static svn_error_t *
               ...
               apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_sqlite__open(&ffd->rep_cache_db, db_path, svn_sqlite__mode_rwcreate, statements, 0, ((void*)0), fs->pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_sqlite__read_schema_version(&version, ffd->rep_cache_db, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (version < 1)
    {


      do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(ffd->rep_cache_db, 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *pool)
{
  ...
  return svn_error_quick_wrap(err, dcgettext ("subversion", "Couldn't open rep-cache database", 5));
}
                            ...
                            svn_fs_t *fs, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_check_path(path_rep_cache_db(fs->path, pool), &kind, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                              ...
                              apr_pool_t *pool)
{
  ...
  do { if (!(ffd->format >= 4)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 159, "ffd->format >= SVN_FS_FS__MIN_REP_SHARING_FORMAT")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  if (! ffd->rep_cache_db)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__open_rep_cache(fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_sqlite__get_statement(&stmt, ffd->rep_cache_db, 3)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  while (have_row)
    {
      ...
      rep = memset(apr_palloc(iterpool, sizeof(*rep)), 0, sizeof(*rep));
      sha1_digest = svn_sqlite__column_text(stmt, 0, iterpool);
      do { svn_error_t *svn_err__temp = (svn_checksum_parse_hex(&rep->sha1_checksum, svn_checksum_sha1, sha1_digest, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (rep)
        do { svn_error_t *svn_err__temp = (rep_has_been_born(rep, fs, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (walker(rep, walker_baton, fs, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                             ...
                             apr_pool_t *pool)
{
  ...
  do { if (!(ffd->rep_sharing_allowed)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 224, "ffd->rep_sharing_allowed")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  if (! ffd->rep_cache_db)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__open_rep_cache(fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (checksum->kind != svn_checksum_sha1)
    return svn_error_create(SVN_ERR_BAD_CHECKSUM_KIND, ((void*)0),
                            dcgettext ("subversion", "Only SHA1 checksums can be used as keys in the " "rep_cache table.\n", 5));


  do { svn_error_t *svn_err__temp = (svn_sqlite__get_statement(&stmt, ffd->rep_cache_db, 1)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_sqlite__bindf(stmt, "s", svn_checksum_to_cstring(checksum, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (*rep)
    do { svn_error_t *svn_err__temp = (rep_has_been_born(*rep, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                             ...
                             apr_pool_t *pool)
{
  ...
  do { if (!(ffd->rep_sharing_allowed)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 267, "ffd->rep_sharing_allowed")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  if (! ffd->rep_cache_db)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__open_rep_cache(fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (rep->sha1_checksum == ((void*)0))
    return svn_error_create(SVN_ERR_BAD_CHECKSUM_KIND, ((void*)0),
                            dcgettext ("subversion", "Only SHA1 checksums can be used as keys in the " "rep_cache table.\n", 5));


  do { svn_error_t *svn_err__temp = (svn_sqlite__get_statement(&stmt, ffd->rep_cache_db, 2)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_sqlite__bindf(stmt, "siiii", svn_checksum_to_cstring(rep->sha1_checksum, pool), (apr_int64_t) rep->revision, (apr_int64_t) rep->offset, (apr_int64_t) rep->size, (apr_int64_t) rep->expanded_size)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (err)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__get_rep_reference(&old_rep, fs, rep->sha1_checksum, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (old_rep)
        {
          if (reject_dup && ((old_rep->revision != rep->revision)
            ...
            return svn_error_createf(SVN_ERR_FS_CORRUPT, ((void*)0),
                                     apr_psprintf(pool,
                              dcgettext ("subversion", "Representation key for checksum '%%s' exists " "in filesystem '%%s' with a different value " "(%%ld,%%%s,%%%s,%%%s) than what we were about " "to store (%%ld,%%%s,%%%s,%%%s)", 5),
                             ...
                             apr_pool_t *pool)
{
  ...
  do { if (!(ffd->rep_sharing_allowed)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/rep-cache.c", 344, "ffd->rep_sharing_allowed")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  if (! ffd->rep_cache_db)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__open_rep_cache(fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_sqlite__get_statement(&stmt, ffd->rep_cache_db, 4)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_sqlite__bindf(stmt, "r", youngest)); if (svn_err__temp) return (svn_err__temp); } while (0);
