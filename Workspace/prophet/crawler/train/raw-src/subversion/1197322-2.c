...
# 351 "./subversion/include/svn_editor.h"
typedef struct svn_editor_t svn_editor_t;
# 381 "./subversion/include/svn_editor.h"
...
typedef svn_error_t *(*svn_editor_cb_abort_t)(
  void *baton,
  apr_pool_t *scratch_pool);
# 516 "./subversion/include/svn_editor.h"
svn_error_t *
svn_editor_create(svn_editor_t **editor,
                  ...
                  apr_pool_t *result_pool,
                  apr_pool_t *scratch_pool);
# 531 "./subversion/include/svn_editor.h"
svn_error_t *
...
svn_editor_setcb_many(svn_editor_t *editor,
                      ...
                      apr_pool_t *scratch_pool);
# 724 "./subversion/include/svn_editor.h"
svn_error_t *
svn_editor_add_directory(svn_editor_t *editor,
                         ...
                         apr_hash_t *props,
                         svn_revnum_t replaces_rev);
# 754 "./subversion/include/svn_editor.h"
svn_error_t *
svn_editor_add_file(svn_editor_t *editor,
                    ...
                    apr_hash_t *props,
                    svn_revnum_t replaces_rev);
# 773 "./subversion/include/svn_editor.h"
svn_error_t *
...
svn_editor_set_text(svn_editor_t *editor,
                    ...
                    const svn_checksum_t *checksum,
                    svn_stream_t *contents);
# 849 "./subversion/include/svn_editor.h"
svn_error_t *
svn_editor_set_target(svn_editor_t *editor,
                      const char *relpath,
                      svn_revnum_t revision,
                      const char *target);
# 863 "./subversion/include/svn_editor.h"
svn_error_t *
svn_editor_delete(svn_editor_t *editor,
                  const char *relpath,
                  svn_revnum_t revision);
# 878 "./subversion/include/svn_editor.h"
svn_error_t *
...
# 933 "./subversion/include/svn_editor.h"
svn_error_t *
...
# 95 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
      ...
      switch (action->action)
        {
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 249, ((void*)0))); } while (0);
        }
    }
...
# 683 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 702, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (action == ACTION_RM)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 782, ((void*)0))); } while (0);
    }
      ...
      if (child->operation == OP_OPEN || child->operation == OP_PROPSET)
        {
          if (child->kind == svn_kind_dir)
            ...
            do { svn_error_t *svn_err__temp = (editor->open_file(path, operation->baton, ((svn_revnum_t) -1), iterpool, &child->baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1215 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
  return 0;
}
