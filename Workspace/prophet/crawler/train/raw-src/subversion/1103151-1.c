...
# 136 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c"
static svn_error_t *
  ...
  if ((status == svn_wc__db_status_added) && (have_base || have_more_work))
    {
      ...
      if (replaced && base_replace )
        ...
        {
# 203 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c"
          replaced = 0;
          base_replace = 0;
        }
    }
...
# 226 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c"
      ...
      (base_replace && ! eb->ignore_ancestry))
    {
      ...
      if (base_replace && ! eb->ignore_ancestry)
      ...
      else
        {
          ...
          do { if (!(status == svn_wc__db_status_deleted)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c", 245, "status == svn_wc__db_status_deleted")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      do { if (!(del_checksum != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c", 256, "del_checksum != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 276 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c"
      if (status == svn_wc__db_status_deleted)
        {
...
# 302 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c"
...
# 345 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c"
    }
  else
    {
      const char *translated = ((void*)0);
      ...
      if (base_replace
      ...
      else
        {
          ...
          do { if (!(!replaced || status == svn_wc__db_status_copied || status == svn_wc__db_status_moved_here)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c", 391, "!replaced || status == svn_wc__db_status_copied || status == svn_wc__db_status_moved_here")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 425 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c"
        }
    }
             ...
             apr_pool_t *scratch_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c", 530, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 569 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/diff_local.c"
  return 0;
}
