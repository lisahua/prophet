...
# 73 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/lcs.c"
            ...
            apr_pool_t *pool)
{
  ...
  do { if (!(lines > 0)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/lcs.c", 216, "lines > 0"); abort(); } } while (0);
...
# 311 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_diff/lcs.c"
  fp += length[1] + 1;
