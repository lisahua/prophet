...
svn_wc__node_get_recorded_info(svn_filesize_t *recorded_size,
                               ...
                               const char *local_abspath,
                               apr_pool_t *scratch_pool);
# 325 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__node_get_url(const char **url,
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 351 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
svn_wc__node_get_origin(svn_boolean_t *is_copy,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 372 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__node_get_commit_base_rev(svn_revnum_t *base_revision,
                                 ...
                                 const char *local_abspath,
                                 apr_pool_t *scratch_pool);
# 590 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__min_max_revisions(svn_revnum_t *min_revision,
                          ...
                          svn_boolean_t committed,
                          apr_pool_t *scratch_pool);
# 858 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__get_absent_subtrees(apr_hash_t **absent_subtrees,
                            ...
                            apr_pool_t *result_pool,
                            apr_pool_t *scratch_pool);
# 904 "./subversion/include/private/svn_wc_private.h"
svn_error_t *
...
svn_wc__get_info(svn_wc_context_t *wc_ctx,
                 ...
                 void *cancel_baton,
                 apr_pool_t *scratch_pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c" 2
  ...
  if (tmpinfo->kind == svn_node_file)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__node_get_checksum(&checksum, wc_ctx, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                         ...
                         apr_pool_t *pool)
{
  ...
  do { if (!(info != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/info.c", 280, "info != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (tree_conflict)
    {
      ...
      (*((const svn_wc_conflict_description2_t * *)apr_array_push(info->wc_info->conflicts))) = tree_conflict;
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  err = svn_wc__node_walk_children(wc_ctx, local_abspath, 0,
                                   changelists,
      ...
      if (tree_conflict)
        {
          ...
          do { svn_error_t *svn_err__temp = (build_info_for_unversioned(&info, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          if (tree_conflict)
            {
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__node_get_repos_info(&(info->repos_root_URL), ((void*)0), wc_ctx, local_abspath, 0, 0, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




          do { svn_error_t *svn_err__temp = (receiver(receiver_baton, local_abspath, info, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      else
        return (err);
    }
