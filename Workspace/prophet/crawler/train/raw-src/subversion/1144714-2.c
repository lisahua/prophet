...
svn_client_status2(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2387 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_log3(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 2520 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_blame5(const char *path_or_url,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 2624 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_merge3(const char *source1,
                  ...
                  svn_client_ctx_t *ctx,
                  apr_pool_t *pool);
# 3261 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_revert2(const apr_array_header_t *paths,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 3702 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
static svn_error_t *
...
# 151 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
static svn_error_t *
                 ...
                 apr_pool_t *scratch_pool)
{
  if (targets_are_uris)
    {
      do { svn_error_t *svn_err__temp = (svn_uri_condense_targets(common_parent, target_relpaths, targets, remove_redundancies, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


    }
  else
    {
      do { svn_error_t *svn_err__temp = (svn_dirent_condense_targets(common_parent, target_relpaths, targets, remove_redundancies, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (apr_is_empty_array(*target_relpaths))
    {
      ...
      (*((const char * *)apr_array_push(*target_relpaths))) = base_name;
    }

  return 0;
}
# 223 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
static svn_error_t *
organize_lock_targets(const char **common_parent_url,
                      ...
                      apr_pool_t *scratch_pool)
{
  const char *common_url = ((void*)0);
  const char *common_dirent = ((void*)0);
  apr_hash_t *rel_targets_ret = apr_hash_make(result_pool);
  apr_hash_t *rel_fs_paths = ((void*)0);
  apr_array_header_t *rel_targets;
  svn_boolean_t url_mode;
  int i;

  do { if (!(targets->nelts)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c", 243, "targets->nelts")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  url_mode = svn_path_is_url((((const char * *)(targets)->elts)[0]));
  ...
  if (url_mode)
    {
      ...
      *invalid_revnum = ((svn_revnum_t) -1);
      ...
      do { svn_error_t *svn_err__temp = (condense_targets(&common_url, &rel_targets, targets, (!0), (!0), result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (condense_targets(&common_dirent, &rel_targets, targets, 0, (!0), result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (i = 0; i < rel_targets->nelts; i++)
        {
          ...
          rel_target = (((const char * *)(rel_targets)->elts)[i]);
          local_abspath = svn_dirent_join(common_dirent, rel_target, iterpool);
          do { svn_error_t *svn_err__temp = (svn_wc__node_get_url(&target_url, ctx->wc_ctx, local_abspath, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          (*((const char * *)apr_array_push(target_urls))) = target_url;
        }




      do { svn_error_t *svn_err__temp = (condense_targets(&common_url, &rel_urls, target_urls, (!0), 0, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (i = 0; i < rel_targets->nelts; i++)
        {
          ...
          rel_target = (((const char * *)(rel_targets)->elts)[i]);
          rel_url = (((const char * *)(rel_urls)->elts)[i]);
          apr_hash_set(rel_fs_paths, rel_url, (-1),
          ...
          if (do_lock)
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_wc__node_get_base_rev(revnum, ctx->wc_ctx, abs_path, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          else
            {
              ...
              if (! force)
                {
                  do { svn_error_t *svn_err__temp = (svn_wc__node_get_lock_info(&lock_token, ((void*)0), ((void*)0), ((void*)0), ctx->wc_ctx, abs_path, result_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  if (! lock_token)
                    return svn_error_createf(
                               ...
                               dcgettext ("subversion", "'%s' is not locked in this working copy", 5),
                               abs_path);
                }


              apr_hash_set(rel_targets_ret, rel_url, (-1),
                ...
                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (organize_lock_targets(&common_parent_url, &base_dir, &path_revs, &urls_to_paths, targets, (!0), steal_lock, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (organize_lock_targets(&common_parent_url, &base_dir, &path_tokens, &urls_to_paths, targets, 0, break_lock, ctx, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 503 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/locking_commands.c"
