# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c" 2
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c"
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c" 2
...
svn_opt_print_help(apr_getopt_t *os,
                   ...
                   const char *footer,
                   apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c" 2
# 1 "./subversion/include/svn_repos.h" 1
# 36 "./subversion/include/svn_repos.h"
...
# 37 "./subversion/include/svn_repos.h" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/tools/server-side/svnauthz-validate.c" 2
...
main(int argc, const char **argv)
{
  ...
  opts.username = opts.fspath = opts.repos_name = ((void*)0);
  ...
  do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8(&opts.authz_file, os->argv[os->ind], pool)); if (svn_err__temp) { svn_handle_error2(svn_err__temp, stderr, 0, "svn: "); svn_error_clear(svn_err__temp); return 1; } } while (0);

  opts.authz_file = svn_dirent_internal_style(opts.authz_file, pool);


  err = svn_repos_authz_read(&authz, opts.authz_file, (!0), pool);
  ...
  if (err)
    {
      svn_handle_error2(err, stderr, 0, "svnauthz-validate: ");
      svn_error_clear(err);
      return 1;
    }
  else
