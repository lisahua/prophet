             ...
             apr_pool_t *pool)
{
  ...
  if (! ffb->session)
    do { svn_error_t *svn_err__temp = (svn_client__open_ra_session_internal(&(ffb->session), ffb->repos_root, ((void*)0), ((void*)0), 0, (!0), ffb->ctx, ffb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  do { if (!(path)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/update.c", 128, "path")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);

  if (svn_path_is_url(path))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/update.c",131), (svn_error_createf))(SVN_ERR_WC_NOT_WORKING_COPY, ((void*)0),
  ...
  if (!innerupdate)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__adm_open_anchor_in_context(&adm_access, &dir_access, &target, ctx->wc_ctx, path, (!0), -1, ctx->cancel_func, ctx->cancel_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__adm_open_in_context(&adm_access, ctx->wc_ctx, path, (!0), -1, ctx->cancel_func, ctx->cancel_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (! anchor_url)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/update.c",168), (svn_error_createf))(SVN_ERR_ENTRY_MISSING_URL, ((void*)0),
  ...
  do { svn_error_t *svn_err__temp = (svn_client__open_ra_session_internal(&ra_session, anchor_url, anchor, ((void*)0), (!0), (!0), ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 264 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/update.c"
  ...
  *use_sleep = (!0);
  ...
  if ((((depth) == svn_depth_infinity || (depth) == svn_depth_unknown) ? (!0) : 0) && (! ignore_externals))
    {
      do { svn_error_t *svn_err__temp = (svn_client__handle_externals(adm_access, efb.externals_old, efb.externals_new, efb.ambient_depths, anchor_url, anchor, repos_root, depth, use_sleep, ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
