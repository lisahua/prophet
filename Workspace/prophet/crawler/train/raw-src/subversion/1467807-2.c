...
svn_error_t *svn_config__parse_stream(svn_config_t *cfg,
                                      ...
                                      apr_pool_t *result_pool,
                                      apr_pool_t *scratch_pool);
# 148 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config_impl.h"
svn_error_t *
                 ...
                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_config_create(&cfg, section_names_case_sensitive, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 120 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config.c"
...
# 166 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config.c"
static svn_error_t *
...
# 186 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config.c"
  if (sys_file_path)
    {
      if (red_config)
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_config_read2(cfgp, sys_file_path, 0, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          red_config = (!0);
        }
    }
# 213 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config.c"
  if (usr_file_path)
    {
      if (red_config)
        ...
        {
          do { svn_error_t *svn_err__temp = (svn_config_read2(cfgp, usr_file_path, 0, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          red_config = (!0);
        }
    }

  if (! red_config)
    do { svn_error_t *svn_err__temp = (svn_config_create(cfgp, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 svn_boolean_t must_exist)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_config_read2(&merge_cfg, file, must_exist, 0, cfg->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 509 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config.c"
static void
expand_option_value(svn_config_t *cfg, cfg_section_t *section,
                    const char *opt_value, const char **opt_x_valuep,
                    apr_pool_t *x_pool)
...
# 702 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/config.c"
static svn_error_t *
