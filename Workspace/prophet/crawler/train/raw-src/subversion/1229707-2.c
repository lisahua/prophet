...
svn_delta_get_cancellation_editor(svn_cancel_func_t cancel_func,
                                  ...
                                  void **edit_baton,
                                  apr_pool_t *pool);
# 1233 "./subversion/include/svn_delta.h"
svn_error_t *
...
typedef svn_error_t *(*svn_delta_path_driver_cb_func_t)(
  ...
  const char *path,
  apr_pool_t *pool);
# 1291 "./subversion/include/svn_delta.h"
svn_error_t *
...
typedef svn_error_t *(*svn_file_rev_handler_old_t)(
  ...
  apr_array_header_t *prop_diffs,
  apr_pool_t *pool);
# 1375 "./subversion/include/svn_delta.h"
void
...
# 894 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 913, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (action == ACTION_DELETE)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c", 1020, ((void*)0))); } while (0);
    }
           ...
           apr_pool_t *scratch_pool)
{
  ...
  for (hi = apr_hash_first(scratch_pool, operation->children);
       hi; hi = apr_hash_next(hi))
    {
      ...
      if (path[0] != '/' && *make_abs_paths)
        path = apr_pstrcat(iterpool, "/", path, ((void*)0));


      if (child->operation == OP_DELETE || child->operation == OP_REPLACE)
        {
          do { svn_error_t *svn_err__temp = (editor->delete_entry(path, ((svn_revnum_t) -1), operation->baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (child->operation == OP_OPEN || child->operation == OP_PROPSET)
        {
          if (child->kind == svn_kind_dir)
            do { svn_error_t *svn_err__temp = (editor->open_directory(path, operation->baton, operation->base_revision, iterpool, &child->baton)); if (svn_err__temp) return (svn_err__temp); } while (0);


          else
            do { svn_error_t *svn_err__temp = (editor->open_file(path, operation->baton, operation->base_revision, iterpool, &file_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (child->operation == OP_ADD || child->operation == OP_REPLACE)
        {
          if (child->kind == svn_kind_dir)
            do { svn_error_t *svn_err__temp = (editor->add_directory(path, operation->baton, child->copyfrom_url, child->copyfrom_revision, iterpool, &child->baton)); if (svn_err__temp) return (svn_err__temp); } while (0);



          else
            do { svn_error_t *svn_err__temp = (editor->add_file(path, operation->baton, child->copyfrom_url, child->copyfrom_revision, iterpool, &file_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (child->operation == OP_ADD_ABSENT)
        {
          if (child->kind == svn_kind_dir)
            do { svn_error_t *svn_err__temp = (editor->absent_directory(path, operation->baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          else
            do { svn_error_t *svn_err__temp = (editor->absent_file(path, operation->baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      ...
      if (child->src_file && file_baton)
        {
          ...
          do { svn_error_t *svn_err__temp = (editor->apply_textdelta(file_baton, ((void*)0), iterpool, &handler, &handler_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);

          do { svn_error_t *svn_err__temp = (svn_stream_open_readonly(&contents, child->src_file, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          do { svn_error_t *svn_err__temp = (svn_txdelta_send_stream(contents, handler, handler_baton, ((void*)0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (file_baton)
        {
          if (child->kind == svn_kind_file)
            do { svn_error_t *svn_err__temp = (change_props(editor, file_baton, child, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          do { svn_error_t *svn_err__temp = (editor->close_file(file_baton, ((void*)0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
      ...
      if (child->kind == svn_kind_dir
        ...
        {
          do { svn_error_t *svn_err__temp = (drive_tree(child, editor, make_abs_paths, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          do { svn_error_t *svn_err__temp = (editor->close_directory(child->baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
    }
  apr_pool_destroy(iterpool);
  ...
  if (operation->kind == svn_kind_dir
                   && (operation->operation == OP_OPEN
                    ...
                    || operation->operation == OP_REPLACE))
    {
      do { svn_error_t *svn_err__temp = (change_props(editor, operation->baton, operation, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
...
# 1651 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_delta/compat.c"
  return 0;
}
