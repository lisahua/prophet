# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
...
svn_ctype_casecmp(int a,
                  int b);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
# 1 "./subversion/include/private/svn_string_private.h" 1
# 31 "./subversion/include/private/svn_string_private.h"
...
# 32 "./subversion/include/private/svn_string_private.h" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
...
svn_fs_fs__order_dir_entries(svn_fs_t *fs,
                             ...
                             svn_revnum_t revision,
                             apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
...
svn_fs_fs__use_log_addressing(svn_fs_t *fs,
                              svn_revnum_t rev);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c" 2
...
svn_fs_fs__path_pack_lock(svn_fs_t *fs,
                          apr_pool_t *pool)
{
  return svn_dirent_join(fs->path, "pack-lock", pool);
}
                           ...
                           apr_pool_t *pool)
{
  ...
  ((ffd->max_files_per_dir) ? (void) (0) : __assert_fail ("ffd->max_files_per_dir", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c", 111, __PRETTY_FUNCTION__));
  ((svn_fs_fs__is_packed_rev(fs, rev)) ? (void) (0) : __assert_fail ("svn_fs_fs__is_packed_rev(fs, rev)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c", 112, __PRETTY_FUNCTION__));

  return svn_dirent_join_many(pool, fs->path, "revs",
                              apr_psprintf(pool,
                                           "%ld" ".pack",
                                           rev / ffd->max_files_per_dir),
                              kind, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
}
...
svn_fs_fs__path_rev_shard(svn_fs_t *fs, svn_revnum_t rev, apr_pool_t *pool)
{
  ...
  ((ffd->max_files_per_dir) ? (void) (0) : __assert_fail ("ffd->max_files_per_dir", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c", 126, __PRETTY_FUNCTION__));
  return svn_dirent_join_many(pool, fs->path, "revs",
...
svn_fs_fs__path_rev(svn_fs_t *fs, svn_revnum_t rev, apr_pool_t *pool)
{
  ...
  ((! svn_fs_fs__is_packed_rev(fs, rev)) ? (void) (0) : __assert_fail ("! svn_fs_fs__is_packed_rev(fs, rev)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c", 138, __PRETTY_FUNCTION__));
...
{
  return packed
       ? svn_fs_fs__path_rev_packed(fs, rev, "pack", pool)
...
{
  fs_fs_data_t *ffd = fs->fsap_data;
  svn_boolean_t is_packed = ffd->format >= 4
                               ...
                               apr_pool_t *pool)
{
  ...
  ((ffd->max_files_per_dir) ? (void) (0) : __assert_fail ("ffd->max_files_per_dir", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c", 185, __PRETTY_FUNCTION__));
                                    ...
                                    apr_pool_t *pool)
{
  ...
  ((ffd->max_files_per_dir) ? (void) (0) : __assert_fail ("ffd->max_files_per_dir", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c", 199, __PRETTY_FUNCTION__));
  return svn_dirent_join_many(pool, fs->path, "revprops",
                      ...
                      apr_pool_t *pool)
{
  return apr_pstrcat(pool, svn_fs_fs__id_txn_unparse(txn_id, pool),
                     to_add, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
}
                         ...
                         apr_pool_t *pool)
{
  ...
  return ( ffd->format >= 7
          ? svn_dirent_join(fs->path, "transactions-la", pool)
          : svn_dirent_join(fs->path, "transactions", pool));
}
...
svn_fs_fs__path_txn_dir(svn_fs_t *fs,
                        ...
                        apr_pool_t *pool)
{
  do { if (!(txn_id != ((void*)0))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c", 252, "txn_id != NULL"); abort(); } } while (0);
  return svn_dirent_join(svn_fs_fs__path_txns_dir(fs, pool),
                         combine_txn_id_string(txn_id, ".txn", pool),
                         pool);
}
...
svn_fs_fs__path_txn_proto_revs(svn_fs_t *fs,
                               apr_pool_t *pool)
{
  return svn_dirent_join(fs->path, "txn-protorevs", pool);
}
                              ...
                              apr_pool_t *pool)
{
  ...
  if (ffd->format >= 3)
    return svn_dirent_join(svn_fs_fs__path_txn_proto_revs(fs, pool),
                           combine_txn_id_string(txn_id, ".rev", pool),
                           pool);
  else
    return svn_dirent_join(svn_fs_fs__path_txn_dir(fs, txn_id, pool),
                           "rev", pool);
                                   ...
                                   apr_pool_t *pool)
{
  ...
  if (ffd->format >= 3)
    return svn_dirent_join(svn_fs_fs__path_txn_proto_revs(fs, pool),
                           combine_txn_id_string(txn_id, ".rev-lock",
                                                 pool),
                           pool);
  else
    return svn_dirent_join(svn_fs_fs__path_txn_dir(fs, txn_id, pool),
                               ...
                               apr_pool_t *pool)
{
  return apr_pstrcat(pool, svn_fs_fs__path_txn_node_rev(fs, id, pool),
                     ".props", ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
}
...
{
  return apr_pstrcat(pool, svn_fs_fs__path_txn_node_rev(fs, id, pool),
                     ".children", ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
}
                            ...
                            apr_pool_t *pool)
{
  ...
  return svn_dirent_join_many(pool, fs->path, "node-origins",
                              buffer, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
}
                                 ...
                                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_open(&file, svn_fs_fs__path_min_unpacked_rev(fs, pool), 0x00001 | 0x00080, 0x0FFF, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_revnum_parse(min_unpacked_rev, buf, ((void*)0))); if (svn_err__temp) return (svn_err__temp); } while (0);
  return 0;
}
                                   ...
                                   apr_pool_t *pool)
{
  ...
  do { if (!(ffd->format >= 4)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_fs_fs/util.c", 425, "ffd->format >= SVN_FS_FS__MIN_PACKED_FORMAT")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (ffd->format >= 3)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_revnum_parse(rev, content->data, ((void*)0))); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_revnum_parse(rev, content->data, &str)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (*str != ' ')
                        ...
                        apr_pool_t *pool)
{
  ...
  *content = ((void*)0);
  ...
  for (i = 0; !*content && (i < 10); ++i)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__try_stringbuf_from_file(content, ((void*)0), fname, i + 1 < 10, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  fs_fs_data_t *ffd = fs->fsap_data;
  return ffd->min_log_addressing_rev != ((svn_revnum_t) -1)
