# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
svn_repos_get_logs(svn_repos_t *repos,
                   ...
                   void *receiver_baton,
                   apr_pool_t *pool);
# 1767 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_get_file_revs2(svn_repos_t *repos,
                         ...
                         void *handler_baton,
                         apr_pool_t *pool);
# 1834 "./subversion/include/svn_repos.h"
__attribute__((deprecated))
svn_error_t *
...
svn_repos_fs_change_rev_prop(svn_repos_t *repos,
                             ...
                             const svn_string_t *new_value,
                             apr_pool_t *pool);
# 2155 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_dump_fs(svn_repos_t *repos,
                  ...
                  void *cancel_baton,
                  apr_pool_t *pool);
# 2572 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_check_revision_access(svn_repos_revision_access_level_t *access_level,
                                ...
                                void *authz_read_baton,
                                apr_pool_t *pool);
# 3035 "./subversion/include/svn_repos.h"
svn_error_t *
svn_repos_remember_client_capabilities(svn_repos_t *repos,
                                       const apr_array_header_t *capabilities);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/svnrdump.h" 1
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/svnrdump.h"
...
svn_ra_get_ra_library(svn_ra_plugin_t **library,
                      ...
                      const char *url,
                      apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/svnrdump.h" 2
...
svn_rdump__normalize_props(apr_hash_t **normal_props,
                           apr_hash_t *props,
                           apr_pool_t *result_pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c" 2
# 47 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
struct dir_baton
{
...
# 126 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
              ...
              apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_rdump__normalize_props(&normal_props, eb->props, eb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  svn_stringbuf_setempty(eb->propstring);
  propstream = svn_stream_from_stringbuf(eb->propstring, eb->pool);
  do { svn_error_t *svn_err__temp = (svn_hash_write_incremental(normal_props, eb->deleted_props, propstream, "PROPS-END", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_stream_close(propstream)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Prop-delta" ": true\n")); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Prop-content-length" ": %" "lu" "\n", eb->propstring->len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (dump_data_too)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Content-length" ": %" "lu" "\n\n", eb->propstring->len)); if (svn_err__temp) return (svn_err__temp); } while (0);





      do { svn_error_t *svn_err__temp = (svn_stream_write(eb->stream, eb->propstring->data, &(eb->propstring->len))); if (svn_err__temp) return (svn_err__temp); } while (0);




      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "\n\n")); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_hash__clear(eb->props, eb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_hash__clear(eb->deleted_props, eb->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (trigger_var)
        *trigger_var = 0;
    }
...
# 249 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
static svn_error_t *
          ...
          apr_pool_t *pool)
{
  ...
  if (kind == svn_node_file)
    do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Node-kind" ": file\n")); if (svn_err__temp) return (svn_err__temp); } while (0);

  else if (kind == svn_node_dir)
    do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Node-kind" ": dir\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  switch (action)
    ...
    case svn_node_action_change:
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Node-action" ": change\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_node_action_replace:
      if (!is_copy)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Node-action" ": replace\n")); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Node-action" ": delete\n\n")); if (svn_err__temp) return (svn_err__temp); } while (0);




      do { svn_error_t *svn_err__temp = (dump_node(eb, path, kind, svn_node_action_add, is_copy, copyfrom_path, copyfrom_rev, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    ...
    case svn_node_action_add:
      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Node-action" ": add\n")); if (svn_err__temp) return (svn_err__temp); } while (0);


      if (!is_copy)
        {
# 347 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
          eb->dump_props = (!0);
          break;
        }

      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Node-copyfrom-rev" ": %ld\n" "Node-copyfrom-path" ": %s\n", copyfrom_rev, copyfrom_path)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 365 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnrdump/dump_editor.c"
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (do_dump_props(pb->eb, &(pb->eb->dump_props), (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (do_dump_newlines(pb->eb, &(pb->eb->dump_newlines), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              void **child_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_node(pb->eb, path, svn_node_dir, val ? svn_node_action_replace : svn_node_action_add, is_copy, is_copy ? copyfrom_path : ((void*)0), is_copy ? copyfrom_rev : ((svn_revnum_t) -1), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               void **child_baton)
{
  ...
  if (((pb->copyfrom_path) && ((pb->copyfrom_rev) >= 0)))
    {
                ...
                apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (do_dump_props(eb, &(eb->dump_props), (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (do_dump_newlines(eb, &(eb->dump_newlines), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (hi = apr_hash_first(pool, db->deleted_entries); hi;
       hi = apr_hash_next(hi))
    {
      ...
      do { svn_error_t *svn_err__temp = (dump_node(db->eb, path, svn_node_unknown, svn_node_action_delete, 0, ((void*)0), ((svn_revnum_t) -1), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

    }

  do { svn_error_t *svn_err__temp = (svn_hash__clear(db->deleted_entries, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  return 0;
}
         ...
         void **file_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_node(pb->eb, path, svn_node_file, val ? svn_node_action_replace : svn_node_action_add, is_copy, is_copy ? copyfrom_path : ((void*)0), is_copy ? copyfrom_rev : ((svn_revnum_t) -1), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          void **file_baton)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_node(pb->eb, path, svn_node_file, svn_node_action_change, 0, copyfrom_path, copyfrom_rev, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  ...
  if (value)
    apr_hash_set(db->eb->props, apr_pstrdup(db->eb->pool, name),
                 (-1), svn_string_dup(value, db->eb->pool));
  else
  ...
  if (! db->written_out)
    {
      ...
      do { svn_error_t *svn_err__temp = (dump_node(db->eb, db->abspath, svn_node_dir, svn_node_action_change, 0, db->copyfrom_path, db->copyfrom_rev, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                 ...
                 apr_pool_t *pool)
{
  ...
  if (value)
    apr_hash_set(eb->props, apr_pstrdup(eb->pool, name),
                 (-1), svn_string_dup(value, eb->pool));
  else
                ...
                void **handler_baton)
{
  ...
  hb = memset(apr_palloc(eb->pool, sizeof(*hb)), 0, sizeof(*hb));

  while(0);


  delta_filestream = svn_stream_from_aprfile2(eb->delta_file, (!0), pool);
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_close(delta_filestream)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  struct dump_edit_baton *eb = file_baton;
  apr_finfo_t *info = memset(apr_palloc(pool, sizeof(apr_finfo_t)), 0, sizeof(apr_finfo_t));
  ...
  if (eb->dump_text)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Text-delta" ": true\n")); if (svn_err__temp) return (svn_err__temp); } while (0);



      err = apr_file_info_get(info, 0x00000100, eb->delta_file);
      if (err)
        do { svn_error_t *svn_err__temp = (svn_error_wrap_apr(err, ((void*)0))); if (svn_err__temp) return (svn_err__temp); } while (0);

      if (eb->base_checksum)

        do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Text-delta-base-md5" ": %s\n", eb->base_checksum)); if (svn_err__temp) return (svn_err__temp); } while (0);





      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Text-content-length" ": %lu\n", (unsigned long)info->size)); if (svn_err__temp) return (svn_err__temp); } while (0);





      do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Text-content-md5" ": %s\n", text_checksum)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (eb->dump_props)
    do { svn_error_t *svn_err__temp = (svn_stream_printf(eb->stream, pool, "Content-length" ": %ld\n\n", (unsigned long)info->size + eb->propstring->len)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (eb->dump_text)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_seek(eb->delta_file, 0, &offset, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      delta_filestream = svn_stream_from_aprfile2(eb->delta_file, (!0), pool);
      do { svn_error_t *svn_err__temp = (svn_stream_copy3(delta_filestream, eb->stream, ((void*)0), ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_stream_close(delta_filestream)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_io_file_trunc(eb->delta_file, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      eb->dump_text = 0;
    }
                           ...
                           apr_pool_t *pool)
{
  ...
  eb = memset(apr_palloc(pool, sizeof(struct dump_edit_baton)), 0, sizeof(struct dump_edit_baton));
  eb->stream = stream;


  eb->pool = svn_pool_create_ex(pool, ((void*)0));




  do { svn_error_t *svn_err__temp = (svn_io_open_unique_file3(&(eb->delta_file), &(eb->delta_abspath), ((void*)0), svn_io_file_del_on_close, pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  *editor = de;
  ...
  do { svn_error_t *svn_err__temp = (svn_delta_get_cancellation_editor(cancel_func, cancel_baton, de, eb, editor, edit_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_editor__insert_shims(editor, edit_baton, *editor, *edit_baton, ((void*)0), ((void*)0), ((void*)0), ((void*)0), pool, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
