# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c"
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c" 2
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c" 2
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/fs.h" 2
...
svn_config_copy_config(apr_hash_t **cfg_hash,
                       apr_hash_t *src_hash,
                       apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/fs.h" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/fs.h" 2
...
# 203 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/fs.h"
...
# 245 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/fs.h"
...
{
# 533 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/fs.h"
  ...
  svn_fs_fs__id_part_t txn_id;
# 564 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/fs.h"
  struct
    {
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/index.h" 1
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/index.h"
...
svn_fs_fs__open_pack_or_rev_file(svn_fs_fs__revision_file_t **file,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 108 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/rev_file.h"
svn_error_t *
...
svn_fs_fs__l2p_proto_index_add_revision(apr_file_t *proto_index,
                                        apr_pool_t *pool);
# 98 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/index.h"
svn_error_t *
...
svn_fs_fs__p2l_index_append(svn_fs_t *fs,
                            ...
                            svn_revnum_t revision,
                            apr_pool_t *pool);
# 167 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/index.h"
svn_error_t *
svn_fs_fs__p2l_index_lookup(apr_array_header_t **entries,
                            ...
                            apr_off_t block_size,
                            apr_pool_t *pool);
# 183 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/index.h"
svn_error_t *
svn_fs_fs__p2l_entry_lookup(svn_fs_fs__p2l_entry_t **entry,
                            ...
                            apr_off_t offset,
                            apr_pool_t *pool);
# 202 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/index.h"
svn_error_t *
...
svn_fs_fs__p2l_get_max_offset(apr_off_t *offset,
                              ...
                              svn_revnum_t revision,
                              apr_pool_t *pool);
# 245 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/index.h"
svn_error_t *
svn_fs_fs__l2p_index_from_p2l_entries(const char **protoname,
                                      ...
                                      apr_pool_t *result_pool,
                                      apr_pool_t *scratch_pool);
# 259 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/index.h"
svn_error_t *
...
svn_fs_fs__deserialize_p2l_page(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c" 2
...
svn_fs_fs__path_revprops_pack_shard(svn_fs_t *fs,
                                    svn_revnum_t rev,
                                    apr_pool_t *pool);
# 157 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/util.h"
const char *
...
svn_fs_fs__write_current(svn_fs_t *fs,
                         ...
                         apr_uint64_t next_copy_id,
                         apr_pool_t *pool);
# 339 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/util.h"
svn_error_t *
...
svn_fs_fs__read_number_from_stream(apr_int64_t *result,
                                   ...
                                   svn_stream_t *stream,
                                   apr_pool_t *scratch_pool);
# 378 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/../libsvn_fs_fs/util.h"
svn_error_t *
...
svn_fs_fs__use_log_addressing(svn_fs_t *fs,
                              svn_revnum_t rev);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c" 2
...
open_fs(svn_fs_t **fs,
        const char *path,
        apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svnfsfs/dump-index-cmd.c" 2
               ...
               apr_pool_t *pool)
{
  ...
  apr_uint32_t digest = (__extension__ ({ unsigned int __v, __x = (fnv1); if (__builtin_constant_p (__x)) __v = ((((__x) & 0xff000000) >> 24) | (((__x) & 0x00ff0000) >> 8) | (((__x) & 0x0000ff00) << 8) | (((__x) & 0x000000ff) << 24)); else __asm__ ("bswap %0" : "=r" (__v) : "0" (__x)); __v; }));
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_fs__open_pack_or_rev_file(&rev_file, fs, revision, pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_fs_fs__p2l_get_max_offset(&max_offset, fs, rev_file, revision, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (offset = 0; offset < max_offset; )
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__p2l_index_lookup(&entries, fs, rev_file, revision, offset, ffd->p2l_page_size, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
subcommand__dump_index(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dump_index(opt_state->repository_path, opt_state->start_revision.value.number, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
