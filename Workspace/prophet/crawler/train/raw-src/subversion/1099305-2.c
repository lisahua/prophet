...
svn_client_commit3(svn_commit_info_t **commit_info_p,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2011 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_status5(svn_revnum_t *result_rev,
                   ...
                   void *status_baton,
                   apr_pool_t *scratch_pool);
# 2288 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
svn_client_status4(svn_revnum_t *result_rev,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 2311 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_log2(const apr_array_header_t *targets,
                ...
                svn_client_ctx_t *ctx,
                apr_pool_t *pool);
# 2528 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_diff_peg2(const apr_array_header_t *diff_options,
                     ...
                     svn_client_ctx_t *ctx,
                     apr_pool_t *pool);
# 2989 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_revert2(const apr_array_header_t *paths,
                   ...
                   svn_client_ctx_t *ctx,
                   apr_pool_t *pool);
# 3673 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
...
svn_client_ls3(apr_hash_t **dirents,
               ...
               svn_client_ctx_t *ctx,
               apr_pool_t *pool);
# 4874 "./subversion/include/svn_client.h"
__attribute__((deprecated))
svn_error_t *
            ...
            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_uri_condense_targets(&common_url, &targets, paths, (!0), pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_client__open_ra_session_internal(&ra_session, ((void*)0), common_url, ((void*)0), ((void*)0), 0, (!0), ctx, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_ra_check_path(ra_session, relpath, ((svn_revnum_t) -1), &kind, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      if (kind == svn_node_none)
        {
          return svn_error_createf(SVN_ERR_FS_NOT_FOUND, ((void*)0),
                                   dcgettext ("subversion", "URL '%s' does not exist", 5),
