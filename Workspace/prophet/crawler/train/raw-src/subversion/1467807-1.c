...
# 120 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
...
# 166 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
static svn_error_t *
...
# 186 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
  if (sys_file_path)
    {
      if (red_config)
...
# 213 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
  if (usr_file_path)
    {
      if (red_config)
  ...
  if (!opt->expanded)
    {
      ...
      if ((__extension__ (__builtin_constant_p ('%') && !__builtin_constant_p (opt->value) && ('%') == '\0' ? (char *) __rawmemchr (opt->value, '%') : __builtin_strchr (opt->value, '%'))))
        {
...
# 509 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
static void
expand_option_value(svn_config_t *cfg, cfg_section_t *section,
                    const char *opt_value, const char **opt_x_valuep,
                    apr_pool_t *x_pool)
...
# 702 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config.c"
static svn_error_t *
