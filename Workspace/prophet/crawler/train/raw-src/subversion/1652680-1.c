# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c"
...
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.h" 1
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.h"
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.h" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.h" 2
...
svn_fs_x__dag_update_ancestry(dag_node_t *target,
                              dag_node_t *source,
                              apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__initialize_caches(svn_fs_t *fs,
                            apr_pool_t *scratch_pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__id_create(svn_fs_x__id_context_t *context,
                    ...
                    apr_pool_t *result_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__get_changes(apr_array_header_t **changes,
                      ...
                      svn_revnum_t rev,
                      apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__begin_txn(svn_fs_txn_t **txn_p,
                    ...
                    apr_uint32_t flags,
                    apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
svn_fs_x__deserialize_mergeinfo(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c" 2
...
struct dag_node_t
{
  ...
  svn_node_kind_t kind;
# 72 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c"
...
# 152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
                  ...
                  dag_node_t *node)
{
  ...
  if (! node->node_revision)
    {
      svn_fs_x__noderev_t *noderev;
      apr_pool_t *scratch_pool = svn_pool_create_ex(node->node_pool, ((void*)0));

      do { svn_error_t *svn_err__temp = (svn_fs_x__get_node_revision(&noderev, node->fs, &node->id, node->node_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  svn_fs_x__noderev_t *noderev;
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, node)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           dag_node_t *rhs)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__dag_get_node_id(&lhs_node, lhs)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_fs_x__dag_get_node_id(&rhs_node, rhs)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                   ...
                                   dag_node_t *rhs)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&lhs_noderev, lhs)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (get_node_revision(&rhs_noderev, rhs)); if (svn_err__temp) return (svn_err__temp); } while (0);
                       ...
                       apr_pool_t *result_pool)
{
  ...
  new_node = memset(apr_palloc(result_pool, sizeof(*new_node)), 0, sizeof(*new_node));
  new_node->fs = fs;
  new_node->id = *id;


  new_node->node_pool = result_pool;
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, new_node)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 362 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, parent)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (noderev->kind != svn_node_dir)
    return svn_error_create(SVN_ERR_FS_NOT_DIRECTORY, ((void*)0),
                            dcgettext ("subversion", "Can't get entries of non-directory", 5));


  do { svn_error_t *svn_err__temp = (svn_fs_x__rep_contents_dir_entry(&dirent, parent->fs, noderev, name, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 396 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
          ...
          apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&parent_noderev, parent)); if (svn_err__temp) return (svn_err__temp); } while (0);


  return svn_fs_x__set_entry(parent->fs, txn_id, parent_noderev, name, id,
                             kind, scratch_pool);
}
# 422 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
           ...
           apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__create_node (svn_fs_x__dag_get_fs(parent), &new_noderev, &parent_noderev->copy_id, txn_id, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_fs_x__dag_get_node(child_p, svn_fs_x__dag_get_fs(parent), &new_noderev.noderev_id, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__get_proplist(&proplist, node->fs, noderev, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                        ...
                                        apr_pool_t *scratch_pool)
{
  ...
  return svn_fs_x__put_node_revision(node->fs, noderev, 0, scratch_pool);
}
                            ...
                            apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__get_base_rev(&base_rev, fs, txn_id, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__dag_open(&cur_entry, parent, name, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (svn_fs_x__dag_check_mutable(cur_entry))
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, cur_entry)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_x__create_successor(fs, noderev, copy_id, txn_id, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      new_node_id = &noderev->noderev_id;



      do { svn_error_t *svn_err__temp = (set_entry(parent, name, new_node_id, noderev->kind, txn_id, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 812 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_x/dag.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__dag_get_node(&node, fs, id, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (node->kind == svn_node_dir)
    {
      ...
      if (entries)
        for (i = 0; i < entries->nelts; ++i)
          {
            const svn_fs_x__id_t *noderev_id
              = &(((svn_fs_x__dirent_t * *)(entries)->elts)[i])->id;

            apr_pool_clear(iterpool);
            do { svn_error_t *svn_err__temp = (delete_if_mutable(fs, noderev_id, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          }
                     ...
                     apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__rep_contents_dir_entry(&dirent, fs, parent_noderev, name, subpool, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (delete_if_mutable(parent->fs, &dirent->id, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  apr_pool_destroy(subpool);


  return svn_fs_x__set_entry(parent->fs, txn_id, parent_noderev, name,
                             ((void*)0), svn_node_unknown, scratch_pool);
}
                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  return make_entry(child_p, parent, parent_path, name, 0, txn_id,
                           ...
                           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev, file)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_fs_x__get_contents(&contents, file->fs, noderev->data_rep, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                    ...
                                    apr_pool_t *pool)
{
  ...
  if (source)
    do { svn_error_t *svn_err__temp = (get_node_revision(&src_noderev, source)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
    src_noderev = ((void*)0);
  do { svn_error_t *svn_err__temp = (get_node_revision(&tgt_noderev, target)); if (svn_err__temp) return (svn_err__temp); } while (0);
                              ...
                              apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_x__set_contents(&ws, file->fs, noderev, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (checksum)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_x__dag_file_checksum(&file_checksum, file, checksum->kind, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (dir_entry_id_from_node(&node_id, parent, name, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (preserve_history)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_node_revision(&from_noderev, from_node)); if (svn_err__temp) return (svn_err__temp); } while (0);
      to_noderev = copy_node_revision(from_noderev, pool);


      do { svn_error_t *svn_err__temp = (svn_fs_x__reserve_copy_id(&copy_id, fs, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_x__create_successor(fs, to_noderev, &copy_id, txn_id, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                               ...
                               apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev1, node1)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (get_node_revision(&noderev2, node2)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (props_changed != ((void*)0))
    {
      do { svn_error_t *svn_err__temp = (svn_fs_x__prop_rep_equal(&same, fs, noderev1, noderev2, strict, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                              ...
                              apr_pool_t *scratch_pool)
{
  ...
  if (! svn_fs_x__dag_check_mutable(target))
    return svn_error_createf
      (SVN_ERR_FS_NOT_MUTABLE, ((void*)0),
       dcgettext ("subversion", "Attempted to update ancestry of non-mutable node", 5));

  do { svn_error_t *svn_err__temp = (get_node_revision(&source_noderev, source)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (get_node_revision(&target_noderev, target)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  return svn_fs_x__put_node_revision(target->fs, target_noderev, 0,
                                     scratch_pool);
}
