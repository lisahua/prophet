...
# 121 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  ...
  *all_wcprops = apr_hash_make(result_pool);
  ...
  for (hi = apr_hash_first(scratch_pool, dirents);
       ...
       hi = apr_hash_next(hi))
    {
      ...
      do { if (!(wcprops != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c", 191, "wcprops != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  while (1729)
    {
      ...
      if (eof)
        {
          if (line->len > 0)
            return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",242), (svn_error_createf))
...
wipe_obsolete_files(const char *wcroot_abspath, apr_pool_t *scratch_pool)
{
  ...
  svn_error_clear(svn_io_remove_file2(
                    svn_wc__adm_child(wcroot_abspath,
                                      ...
                                      scratch_pool),
                    (!0), scratch_pool));
# 449 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  svn_error_clear(svn_io_remove_file2(
                    build_lockfile_path(wcroot_abspath, scratch_pool),
                    (!0), scratch_pool));
}
# 463 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  if (entry->repos == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",476), (svn_error_createf))(
  ...
  if (entry->uuid == ((void*)0) && repos_info_func == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",483), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
   ...
   if (entry->url == ((void*)0))
     return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",490), (svn_error_createf))(
        SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
                ...
                apr_pool_t *scratch_pool)
{
  ...
  if (logfile_on_disk == svn_node_file)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",530), (svn_error_create))(SVN_ERR_WC_UNSUPPORTED_FORMAT, ((void*)0),
...
# 557 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  do { svn_error_t *svn_err__temp = (svn_wc__read_entries_old(&entries, dir_abspath, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 575 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
...
{
  do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(sdb, 88)); if (svn_err__temp) return (svn_err__temp); } while (0);

  return 0;
}
# 899 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
static svn_error_t *
...
bump_to_14(void *baton, svn_sqlite__db_t *sdb, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(sdb, 89)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  do { svn_error_t *svn_err__temp = (svn_sqlite__exec_statements(sdb, 91)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
migrate_props(const char *wcroot_abspath,
              ...
              apr_pool_t *scratch_pool)
{
# 1055 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
  const apr_array_header_t *children;
  apr_pool_t *iterpool;
  svn_wc__db_t *db;
  int i;
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__db_open(&db, svn_wc__db_openmode_default, ((void*)0), 0, (!0), scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (migrate_node_props(wcroot_abspath, "", sdb, original_format, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_wc__db_read_children(&children, db, wcroot_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
bump_to_17(void *baton, svn_sqlite__db_t *sdb, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (migrate_props(b17->wcroot_abspath, sdb, b17->original_format, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  if (start_format < 12 )
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c",1234), (svn_error_createf))(SVN_ERR_WC_UPGRADE_REQUIRED, ((void*)0),
...
# 1263 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
        *result_format = 13;
      ...
      case 15:
        ...
        *result_format = 16;
# 1339 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
    }
...
# 1440 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/upgrade.c"
