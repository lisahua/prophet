...
# 276 "./subversion/include/svn_repos.h"
...
# 348 "./subversion/include/svn_repos.h"
const char *
svn_repos_find_root_path(const char *path,
                         apr_pool_t *pool);
# 364 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_open(svn_repos_t **repos_p,
               const char *path,
               apr_pool_t *pool);
# 391 "./subversion/include/svn_repos.h"
svn_error_t *
svn_repos_create(svn_repos_t **repos_p,
                 ...
                 apr_hash_t *fs_config,
                 apr_pool_t *pool);
# 432 "./subversion/include/svn_repos.h"
svn_error_t *
svn_repos_upgrade2(const char *path,
                   ...
                   void *notify_baton,
                   apr_pool_t *pool);
# 446 "./subversion/include/svn_repos.h"
__attribute__((deprecated))
svn_error_t *
...
svn_repos_delete(const char *path,
                 apr_pool_t *pool);
# 473 "./subversion/include/svn_repos.h"
svn_error_t *
svn_repos_has_capability(svn_repos_t *repos,
                         svn_boolean_t *has,
                         const char *capability,
                         apr_pool_t *pool);
# 497 "./subversion/include/svn_repos.h"
svn_fs_t *
...
svn_repos_recover4(const char *path,
                   ...
                   void * cancel_baton,
                   apr_pool_t *pool);
# 590 "./subversion/include/svn_repos.h"
__attribute__((deprecated))
svn_error_t *
...
svn_repos_post_unlock_hook(svn_repos_t *repos,
                           apr_pool_t *pool);
# 813 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_begin_report(void **report_baton,
                       ...
                       void *authz_read_baton,
                       apr_pool_t *pool);
# 896 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_delete_path(void *report_baton,
                      const char *path,
                      apr_pool_t *pool);
# 1028 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_dated_revision(svn_revnum_t *revision,
                         ...
                         apr_time_t tm,
                         apr_pool_t *pool);
# 1395 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_deleted_rev(svn_fs_t *fs,
                      ...
                      apr_pool_t *pool);
# 1449 "./subversion/include/svn_repos.h"
...
svn_repos_fs_begin_txn_for_commit(svn_fs_txn_t **txn_p,
                                  ...
                                  const char *log_msg,
                                  apr_pool_t *pool);
# 1952 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_fs_change_rev_prop4(svn_repos_t *repos,
                              ...
                              void *authz_read_baton,
                              apr_pool_t *pool);
# 2104 "./subversion/include/svn_repos.h"
__attribute__((deprecated))
svn_error_t *
...
svn_repos_verify_fs2(svn_repos_t *repos,
                     ...
                     void *cancel_baton,
                     apr_pool_t *scratch_pool);
# 2453 "./subversion/include/svn_repos.h"
__attribute__((deprecated))
svn_error_t *
svn_repos_verify_fs(svn_repos_t *repos,
                    ...
                    void *cancel_baton,
                    apr_pool_t *pool);
# 2496 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_dump_fs(svn_repos_t *repos,
                  ...
                  void *cancel_baton,
                  apr_pool_t *pool);
# 2588 "./subversion/include/svn_repos.h"
svn_error_t *
...
svn_repos_get_fs_build_parser3(const svn_repos_parse_fns2_t **parser,
                               ...
                               void *notify_baton,
                               apr_pool_t *pool);
# 2812 "./subversion/include/svn_repos.h"
__attribute__((deprecated))
svn_error_t *
...
svn_repos_parse_dumpstream(svn_stream_t *stream,
                           ...
                           void *cancel_baton,
                           apr_pool_t *pool);
# 2888 "./subversion/include/svn_repos.h"
__attribute__((deprecated))
svn_error_t *
...
svn_repos_authz_read(svn_authz_t **authz_p,
                     ...
                     svn_boolean_t must_exist,
                     apr_pool_t *pool);
# 2937 "./subversion/include/svn_repos.h"
svn_error_t *
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/main.c" 2
           ...
           apr_pool_t *pool)
{
  ...
  apr_hash_set(fs_config, "fsfs-cache-deltas",
               (-1), "1");
  apr_hash_set(fs_config, "fsfs-cache-fulltexts",
               (-1), "1");
...
# 331 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/main.c"
...
# 410 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/main.c"
...
# 441 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/main.c"
   {0} },
...
# 541 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/main.c"
static svn_error_t *
           ...
           apr_pool_t *pool)
{
  ...
  if (min_expected || max_expected)
    do { if (!(args)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/main.c", 551, "args")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
# 848 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/main.c"
...
subcommand_crashtest(apr_getopt_t *os, void *baton, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (open_repos(&repos, opt_state->repository_path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnadmin/main.c", 1982, ((void*)0))); } while (0);
