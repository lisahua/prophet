# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c" 2
...
svn_wc__fetch_base_func(const char **filename,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c" 2


# 1 "./subversion/svn_private_config.h" 1
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/context.c" 2
...
svn_wc_context_create(svn_wc_context_t **wc_ctx,
                      ...
                      apr_pool_t *scratch_pool)
{
  svn_wc_context_t *ctx = memset(apr_palloc(result_pool, sizeof(*ctx)), 0, sizeof(*ctx));


  ctx->state_pool = result_pool;
  do { svn_error_t *svn_err__temp = (svn_wc__db_open(&ctx->db, config, (!0), (!0), ctx->state_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  ctx->close_db_on_destroy = (!0);
