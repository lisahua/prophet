# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c"
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
apr_status_t apr_match_glob(const char *dir_pattern,
                                         ...
                                         apr_pool_t *p);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
svn_ctype_casecmp(int a,
                  int b);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c" 2
...
{
  void *new_area;
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c"
                      ...
                      int base)
{
  ...
  if ((*__errno_location ()) == 22 || endptr == str || str[0] == '\0' || *endptr != '\0')
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c",629), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Could not convert '%s' into a number", 5), str));
  ...
  if (((*__errno_location ()) == 34 && (val == (-9223372036854775807L -1) || val == (9223372036854775807L))) ||
    ...
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c",635), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Number '%s' is out of range '[%lu, %lu]'", 5), str, minval, maxval));
                     ...
                     int base)
{
  ...
  val = apr_strtoi64(str, &endptr, base);
  if ((*__errno_location ()) == 22 || endptr == str || str[0] == '\0' || *endptr != '\0')
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c",673), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Could not convert '%s' into a number", 5), str));



  if (((*__errno_location ()) == 34 && (val == (-9223372036854775807L -1) || val == (9223372036854775807L))) ||
      val < minval || val > maxval)
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/svn_string.c",679), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Number '%s' is out of range '[%ld, %ld]'", 5), str, minval, maxval));
