# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 114 "./subversion/include/svn_types.h"
typedef int svn_boolean_t;
# 133 "./subversion/include/svn_types.h"
...
# 151 "./subversion/include/svn_types.h"
  const char *message;
...
# 257 "./subversion/include/svn_types.h"
...
# 286 "./subversion/include/svn_types.h"
const char *
...
svn_revnum_parse(svn_revnum_t *rev,
                 const char *str,
                 const char **endptr);
# 423 "./subversion/include/svn_types.h"
typedef apr_int64_t svn_filesize_t;
# 441 "./subversion/include/svn_types.h"
...
# 760 "./subversion/include/svn_types.h"
svn_commit_info_t *
...
# 820 "./subversion/include/svn_types.h"
svn_log_changed_path2_t *
...
svn_log_changed_path_dup(const svn_log_changed_path_t *changed_path,
                         apr_pool_t *pool);
# 870 "./subversion/include/svn_types.h"
...
# 923 "./subversion/include/svn_types.h"
  apr_hash_t *changed_paths2;
# 935 "./subversion/include/svn_types.h"
...
# 958 "./subversion/include/svn_types.h"
svn_log_entry_t *
svn_log_entry_create(apr_pool_t *pool);
# 969 "./subversion/include/svn_types.h"
svn_log_entry_t *
...
# 1056 "./subversion/include/svn_types.h"
...
# 1184 "./subversion/include/svn_types.h"
svn_lock_t *
...
# 1259 "./subversion/include/svn_types.h"
...
svn_location_segment_dup(const svn_location_segment_t *segment,
                         apr_pool_t *pool);
# 1300 "./subversion/include/svn_types.h"
typedef unsigned long svn_linenum_t;
# 1326 "./subversion/include/svn_types.h"
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 1327 "./subversion/include/svn_types.h" 2
...
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
svn_fs_info_dup(const void *info,
                apr_pool_t *result_pool,
                apr_pool_t *scratch_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
svn_rangelist__merge_many(svn_rangelist_t *merged_rangelist,
                          ...
                          apr_pool_t *result_pool,
                          apr_pool_t *scratch_pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
svn_fs__editor_commit(svn_revnum_t *revision,
                      ...
                      apr_pool_t *result_pool,
                      apr_pool_t *scratch_pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
# 55 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 94 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
struct edit_baton
{
...
# 187 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
               ...
               apr_pool_t *pool)
{
  ...
  do { if (!(!path || pb)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c", 202, "!path || pb"); abort(); } } while (0);
...
# 240 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 1034 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
  ...
  for (rev = start_rev; rev <= end_rev; rev++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor(&dump_editor, &dump_edit_baton, fs, rev, "", stream, &found_old_reference, &found_old_mergeinfo, ((void*)0), notify_func, notify_baton, start_rev, use_deltas_for_rev, 0, ((void*)0), subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1217 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
        }
      else
        {
...
# 1300 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
                       ...
                       void *val, apr_pool_t *pool)
{
  ...
  if (db->edit_baton->verified_dirents_cache)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cache__get((void **)&kind, &found, db->edit_baton->verified_dirents_cache, unparsed_id->data, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (found)
        {
          if (*kind == dirent->kind)
          ...
          else
            {
              ...
              return
                  svn_error_createf(SVN_ERR_NODE_UNEXPECTED_KIND, ((void*)0),
                                    dcgettext ("subversion", "Unexpected node kind %d for '%s'. " "Expected kind was %d.", 5),
  ...
  case svn_node_dir:
    ...
    do { svn_error_t *svn_err__temp = (svn_fs_dir_entries(&dirents, db->edit_baton->fs_root, path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    break;
  case svn_node_file:


    do { svn_error_t *svn_err__temp = (svn_fs_file_length(&len, db->edit_baton->fs_root, path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
    break;
  default:
  ...
  if (db->edit_baton->verified_dirents_cache)
    do { svn_error_t *svn_err__temp = (svn_cache__set(db->edit_baton->verified_dirents_cache, unparsed_id->data, &dirent->kind, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_dump_editor(&dump_editor, &dump_edit_baton, fs, rev, "", svn_stream_empty(scratch_pool), ((void*)0), ((void*)0), verify_close_directory, notify_func, notify_baton, start_rev, 0, (!0), verified_dirents_cache, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1432 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
                     ...
                     apr_pool_t *pool)
{
  ...
  svn_cache__t *verified_dirents_cache = ((void*)0);
  ...
  if (svn_cache__get_global_membuffer_cache())
    do { svn_error_t *svn_err__temp = (svn_cache__create_membuffer_cache (&verified_dirents_cache, svn_cache__get_global_membuffer_cache(), serialize_node_kind, deserialize_node_kind, (-1), svn_uuid_generate(pool), 1000, 0, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1596 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
  for (rev = start_rev; rev <= end_rev; rev++)
    {
