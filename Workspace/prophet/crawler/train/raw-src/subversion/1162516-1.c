...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
svn_mergeinfo__mergeinfo_from_segments(svn_mergeinfo_t *mergeinfo_p,
                                       ...
                                       apr_pool_t *pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c" 2
...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 91 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
struct edit_baton
{
...
# 174 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
               ...
               apr_pool_t *pool)
{
  ...
  do { if (!(!path || pb)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c", 189, "!path || pb"); abort(); } } while (0);
...
# 227 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
      ...
      else
        {
          if (!eb->verify && cmp_rev < eb->oldest_dumped_rev
              && eb->notify_func)
            {
              ...
              notify->warning_str = apr_psprintf(
                     pool,
                     dcgettext ("subversion", "Referencing data in revision %ld," " which is older than the oldest" " dumped revision (%ld).  Loading this dump" " into an empty repository" " will fail.", 5),
              ...
              if (apr_hash_count(old_mergeinfo))
                {
                  ...
                  notify->warning_str = apr_psprintf(
                    pool,
                    dcgettext ("subversion", "Mergeinfo referencing revision(s) prior " "to the oldest dumped revision (%ld). " "Loading this dump may result in invalid " "mergeinfo.", 5),
...
# 911 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
                      ...
                      apr_pool_t *pool)
{
  ...
  datevalue = apr_hash_get(props, "svn:" "date",
                           (-1));
  if (datevalue)
    {
  ...
  for (i = start_rev; i <= end_rev; i++)
    {
          ...
          if (i == 0)
            {
              ...
              do { svn_error_t *svn_err__temp = (write_revision_record(stream, fs, 0, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              to_rev = 0;
              goto loop_end;
            }
      ...
      do { svn_error_t *svn_err__temp = (write_revision_record(stream, fs, to_rev, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);




      use_deltas_for_rev = use_deltas && (incremental || i != start_rev);
      do { svn_error_t *svn_err__temp = (get_dump_editor(&dump_editor, &dump_edit_baton, fs, to_rev, "", stream, notify_func, notify_baton, start_rev, use_deltas_for_rev, 0, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);




      do { svn_error_t *svn_err__temp = (svn_fs_revision_root(&to_root, fs, to_rev, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if ((i == start_rev) && (! incremental))
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_fs_revision_root(&from_root, fs, from_rev, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1119 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
        }
      else
        {
...
# 1205 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
                       ...
                       void *val, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_check_path(&kind, db->edit_baton->fs_root, path, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  switch (kind) {
  case svn_node_dir:
  ...
  default:
    return svn_error_createf(SVN_ERR_NODE_UNEXPECTED_KIND, ((void*)0),
                             dcgettext ("subversion", "Unexpected node kind %d for '%s'", 5), kind, path);
  }
                     ...
                     apr_pool_t *pool)
{
  ...
  if (start_rev == 0)
    do { svn_error_t *svn_err__temp = (svn_fs_verify(svn_fs_path(fs, pool), cancel_func, cancel_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (rev = start_rev; rev <= end_rev; rev++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor((const svn_delta_editor_t **)&dump_editor, &dump_edit_baton, fs, rev, "", svn_stream_empty(pool), notify_func, notify_baton, start_rev, 0, (!0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_delta_get_cancellation_editor(cancel_func, cancel_baton, dump_editor, dump_edit_baton, &cancel_editor, &cancel_edit_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);





      do { svn_error_t *svn_err__temp = (svn_fs_revision_root(&to_root, fs, rev, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_repos_replay2(to_root, "", ((svn_revnum_t) -1), 0, cancel_editor, cancel_edit_baton, ((void*)0), ((void*)0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_fs_revision_proplist(&props, fs, rev, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
