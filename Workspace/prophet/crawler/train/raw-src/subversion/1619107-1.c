...
# 1879 "./subversion/include/svn_wc.h"
...
svn_wc_conflict_description_create_text2(const char *local_abspath,
                                         apr_pool_t *result_pool);
# 1990 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_wc_conflict_description_t *
...
# 2344 "./subversion/include/svn_wc.h"
  ...
  svn_error_t *(*dir_deleted)(svn_wc_notify_state_t *state,
                              ...
                              void *diff_baton,
                              apr_pool_t *scratch_pool);
# 2373 "./subversion/include/svn_wc.h"
  svn_error_t *(*dir_opened)(svn_boolean_t *tree_conflicted,
                             ...
                             void *diff_baton,
                             apr_pool_t *scratch_pool);
# 2392 "./subversion/include/svn_wc.h"
...
# 2412 "./subversion/include/svn_wc.h"
  svn_error_t *(*dir_props_changed)(svn_wc_notify_state_t *propstate,
                                    ...
                                    void *diff_baton,
                                    apr_pool_t *scratch_pool);
# 2428 "./subversion/include/svn_wc.h"
...
# 2446 "./subversion/include/svn_wc.h"
...
# 2542 "./subversion/include/svn_wc.h"
...
svn_wc_ensure_adm4(svn_wc_context_t *wc_ctx,
                   ...
                   svn_depth_t depth,
                   apr_pool_t *scratch_pool);
# 3497 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_get_status_editor4(const svn_delta_editor_t **editor,
                          ...
                          svn_wc_traversal_info_t *traversal_info,
                          apr_pool_t *pool);
# 4285 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
svn_wc_get_status_editor3(const svn_delta_editor_t **editor,
                          ...
                          svn_wc_traversal_info_t *traversal_info,
                          apr_pool_t *pool);
# 4314 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_get_diff_editor4(svn_wc_adm_access_t *anchor,
                        ...
                        void **edit_baton,
                        apr_pool_t *pool);
# 6535 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
typedef svn_error_t *(*svn_wc_relocation_validator3_t)(void *baton,
                                                       ...
                                                       const char *root_url,
                                                       apr_pool_t *pool);
# 7375 "./subversion/include/svn_wc.h"
...
svn_wc_relocate4(svn_wc_context_t *wc_ctx,
                 ...
                 apr_pool_t *scratch_pool);
# 7423 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_transmit_text_deltas(const char *path,
                            ...
                            const char **tempfile,
                            apr_pool_t *pool);
# 7838 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_transmit_prop_deltas(const char *path,
                            ...
                            const char **tempfile,
                            apr_pool_t *pool);
# 7880 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_add_lock(const char *path,
                ...
                svn_wc_adm_access_t *adm_access,
                apr_pool_t *pool);
# 7965 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_remove_lock2(svn_wc_context_t *wc_ctx,
                    const char *local_abspath,
                    apr_pool_t *scratch_pool);
# 7977 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
svn_wc_remove_lock(const char *path,
                   svn_wc_adm_access_t *adm_access,
                   apr_pool_t *pool);
# 7996 "./subversion/include/svn_wc.h"
...
# 8042 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_revision_status2(svn_wc_revision_status_t **result_p,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 8060 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_set_changelist(const char *path,
                      ...
                      void *notify_baton,
                      apr_pool_t *pool);
# 8143 "./subversion/include/svn_wc.h"
...
svn_wc_get_changelists(svn_wc_context_t *wc_ctx,
                       ...
                       void *cancel_baton,
                       apr_pool_t *scratch_pool);
# 8194 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_crop_tree2(svn_wc_context_t *wc_ctx,
                  ...
                  void *notify_baton,
                  apr_pool_t *scratch_pool);
# 8214 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
                                ...
                                apr_pool_t *result_pool)
{
  ...
  version = memset(apr_palloc(result_pool, sizeof(*version)), 0, sizeof(*version));

    do { if (!(svn_uri_is_canonical(repos_url, result_pool) && svn_relpath_is_canonical(repos_relpath) && ((revision) >= 0))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 266, "svn_uri_is_canonical(repos_url, result_pool) && svn_relpath_is_canonical(repos_relpath) && SVN_IS_VALID_REVNUM(revision)"); abort(); } } while (0);
                            ...
                            apr_pool_t *result_pool)
{
  ...
  new_version = memset(apr_palloc(result_pool, sizeof(*new_version)), 0, sizeof(*new_version));
                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__db_read_kind(kind, sfb->db, local_abspath, 0 , (!0) , 0 , scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__db_pristine_get_path(filename, sfb->db, local_abspath, checksum, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
