# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
svn_io_write_version_file(const char *path,
                          int version,
                          apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
svn_wc__fetch_base_func(const char **filename,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
...
svn_wc__serialize_file_external(const char **str,
                                ...
                                apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2


# 1 "./subversion/svn_private_config.h" 1
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c" 2
  ...
  if (kind != svn_node_none && kind != svn_node_dir)
    {
      ...
      return svn_error_createf(20, ((void*)0),
    ...
    do { if (!(kind == svn_node_dir)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 68, "kind == svn_node_dir")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_wc_create_notify(const char *path,
                     ...
                     apr_pool_t *pool)
{
  svn_wc_notify_t *ret = memset(apr_palloc(pool, sizeof(*ret)), 0, sizeof(*ret));
  ret->path = path;
  ret->action = action;
  ...
  ret->revision = ((svn_revnum_t) -1);
  ret->old_revision = ((svn_revnum_t) -1);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 197, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                                         ...
                                         apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 216, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
  ...
  apr_pool_t *result_pool)
{
  ...
  do { if (!(svn_dirent_is_absolute(local_abspath))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 237, "svn_dirent_is_absolute(local_abspath)"); abort(); } } while (0);
                               ...
                               apr_pool_t *pool)
{
  ...
  version = memset(apr_palloc(pool, sizeof(*version)), 0, sizeof(*version));

  do { if (!(svn_uri_is_canonical(repos_url, pool) && svn_relpath_is_canonical(path_in_repos) && ((peg_rev) >= 0))) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_wc/util.c", 300, "svn_uri_is_canonical(repos_url, pool) && svn_relpath_is_canonical(path_in_repos) && SVN_IS_VALID_REVNUM(peg_rev)"); abort(); } } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  new_version = memset(apr_palloc(pool, sizeof(*new_version)), 0, sizeof(*new_version));
                  ...
                  apr_pool_t *result_pool)
{
  ...
  new_conflict = memset(apr_palloc(result_pool, sizeof(*new_conflict)), 0, sizeof(*new_conflict));
                       ...
                       apr_pool_t *scratch_pool)
{
  ...
  *status = memset(apr_palloc(result_pool, sizeof(**status)), 0, sizeof(**status));
  ...
  if (old_status->conflicted)
    {
      const svn_wc_conflict_description2_t *tree_conflict;
      do { svn_error_t *svn_err__temp = (svn_wc__db_op_read_tree_conflict(&tree_conflict, wc_ctx->db, local_abspath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_wc__db_read_kind(kind, sfb->db, local_abspath, 0, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                        ...
                        apr_pool_t *scratch_pool)
{
  ...
  err = svn_wc__db_base_get_info(((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0),
                                 ...
                                 ((void*)0), ((void*)0), ((void*)0), ((void*)0), sfb->db,
  ...
  if (err && err->apr_err == SVN_ERR_WC_PATH_NOT_FOUND)
    ...
    return (err);
  do { svn_error_t *svn_err__temp = (svn_wc__db_pristine_read(&contents, ((void*)0), sfb->db, local_abspath, checksum, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
