                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_fs_check_path(&node_kind, eb->fs_root, path, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 998 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
  ...
  for (i = start_rev; i <= end_rev; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor(&dump_editor, &dump_edit_baton, fs, to_rev, "", stream, &found_old_reference, &found_old_mergeinfo, notify_func, notify_baton, start_rev, use_deltas_for_rev, 0, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1208 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
        }
      else
        {
...
# 1290 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_repos/dump.c"
static svn_error_t *
  ...
  for (rev = start_rev; rev <= end_rev; rev++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor((const svn_delta_editor_t **)&dump_editor, &dump_edit_baton, fs, rev, "", svn_stream_empty(pool), ((void*)0), ((void*)0), notify_func, notify_baton, start_rev, 0, (!0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
