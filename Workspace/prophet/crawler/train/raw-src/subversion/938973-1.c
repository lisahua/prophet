...
# 150 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff.h"
void
...
# 206 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff_memory.c"
static void
...
# 466 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff_memory.c"
...
# 627 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff_memory.c"
  return 0;
}
# 637 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff_memory.c"
typedef struct {
  svn_stream_t *stream;
  const char *data[3];
  apr_size_t len[3];
                               ...
                               apr_size_t *len)
{
  ...
  do { if (!(tcp->lines_to_print > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff_memory.c", 738, "tcp->lines_to_print > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                ...
                svn_diff_t *diff)
{
  ...
  if (style == svn_diff_conflict_display_modified_latest ||
    ...
    do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_diff/diff_memory.c", 887, ((void*)0))); } while (0);
