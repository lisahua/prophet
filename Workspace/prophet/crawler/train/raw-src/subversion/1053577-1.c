...
test_error_root_cause(apr_pool_t *pool)
{
  ...
  err = svn_error_create(root_cause_err_code, ((void*)0), "root cause");
  for (i = 0; i < 2; i++)
    err = svn_error_create(secondary_err_codes[i], err, ((void*)0));
...
test_error_purge_tracing(apr_pool_t *pool)
{
  ...
  err = (svn_error_create(SVN_ERR_BASE, ((void*)0), "root error"));
  ...
  err = (svn_error_create(SVN_ERR_BASE, err, "other error"));
# 110 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c"
  ...
  svn_error_clear(err);
# 182 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/tests/libsvn_subr/error-test.c"
  return 0;
}
