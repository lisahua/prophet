...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
svn_ctype_casecmp(int a,
                  int b);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
static apr_thread_mutex_t *xlate_handle_mutex = ((void*)0);
# 68 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
...
# 86 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
...
static volatile void *xlat_ntou_static_handle = ((void*)0);
static volatile void *xlat_uton_static_handle = ((void*)0);
  ...
  if (!xlate_handle_hash)
    {
      ...
      if (apr_thread_mutex_create(&mutex, 0x0, subpool)
          == 0)
...
# 200 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
}
# 211 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
static svn_error_t *
                      ...
                      const char *userdata_key, apr_pool_t *pool)
{
      ...
      if (xlate_handle_hash)
        {
          ...
          if (apr_err != 0)
            return svn_error_create(apr_err, ((void*)0),
                                    dcgettext ("subversion", "Can't lock charset translation mutex", 5));
              ...
              if (old_node->valid)
                {
                  ...
                  *old_node_p = old_node->next;
                  ...
                  if (apr_err != 0)
                    return svn_error_create(apr_err, ((void*)0),
                                            dcgettext ("subversion", "Can't unlock charset " "translation mutex", 5));
  ...
  if (((apr_err) == 22) || ((apr_err) == ((20000 + 50000) + 23)))
  ...
  else if (apr_err != 0)
    {
      ...
      err = svn_error_create(apr_err, ((void*)0), errstr);
      goto cleanup;
    }
  ...
  if (userdata_key && xlate_handle_hash)
    {
      ...
      if (unlock_err != 0)
        return svn_error_create(unlock_err, ((void*)0),
                                dcgettext ("subversion", "Can't unlock charset translation mutex", 5));
    }
...
put_xlate_handle_node(xlate_handle_node_t *node,
                      ...
                      apr_pool_t *pool)
{
  ((node->next == ((void*)0)) ? (void) (0) : __assert_fail ("node->next == ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c", 375, __PRETTY_FUNCTION__));
  if (!userdata_key)
    return;
  ...
  if (xlate_handle_hash)
    {
      ...
      if (apr_thread_mutex_lock(xlate_handle_mutex) != 0)
        do { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c", 394, ((void*)0)); abort(); } while (1);
      ...
      *node_p = node;
      ...
      if (apr_thread_mutex_unlock(xlate_handle_mutex) != 0)
        do { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c", 412, ((void*)0)); abort(); } while (1);
...
{
  return get_xlate_handle_node(ret, (const char *)1,
  ...
  for (; len > 0; --len, data++)
    {
      if ((! (0 != (svn_ctype_table[(unsigned char)((*data))] & (0x0080))))
        ...
        {
# 610 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
          if (data - data_start)
            {
                          ...
                          apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (check_utf8(src, strlen(src), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
