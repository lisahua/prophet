# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c"
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.h" 1
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.h"
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.h" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.h" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.h" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.h" 2
...
svn_cl__append_conflict_info_xml(
  ...
  const svn_wc_conflict_description2_t *conflict,
  apr_pool_t *pool);
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
...
svn_xml_make_close_tag(svn_stringbuf_t **str,
                       apr_pool_t *pool,
                       const char *tagname);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
...
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
...
svn_token__from_mem(const svn_token_map_t *map,
                    const char *word,
                    apr_size_t len);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
...
svn_cl__deprecated_merge_reintegrate(const char *source_path_or_url,
                                     ...
                                     svn_client_ctx_t *ctx,
                                     apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c" 2
  ...
  switch (kind)
    {
        ...
        switch (reason)
          ...
          case svn_wc_conflict_reason_missing:
            if (operation == svn_wc_operation_merge)
              return dcgettext ("subversion", "local file missing (deleted or moved away?)", 5);
            else
      ...
      case svn_node_dir:
        switch (reason)
          ...
          case svn_wc_conflict_reason_missing:
            if (operation == svn_wc_operation_merge)
              return dcgettext ("subversion", "local dir missing (deleted or moved away?)", 5);
            else
...
operation_str(svn_wc_operation_t operation)
{
  ...
  do { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c", 190, ((void*)0)); abort(); } while (1);
  return ((void*)0);
}
  ...
  apr_pool_t *pool)
{
  ...
  do { if (!(reason_str && action_str)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c", 241, "reason_str && action_str")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  apr_pool_t *pool)
{
  ...
  do { if (!(operation)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c", 281, "operation")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  switch (conflict->kind)
    {
      ...
      case svn_wc_conflict_kind_tree:
        do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/cl-conflicts.c", 454, ((void*)0))); } while (0);
        break;
    }
