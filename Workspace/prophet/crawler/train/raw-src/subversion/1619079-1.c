# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_env.h" 1
# 24 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_env.h"
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h" 1
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h"
# 1 "/home/ubuntu/Workspace/prophet/build/benchmarks/apache-deps/apr-build/include/apr-1/apr_want.h" 1
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h" 2
...
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h" 2
...
svn_io_file_readline(apr_file_t *file,
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h" 2
...
svn_config_copy_config(apr_hash_t **cfg_hash,
                       apr_hash_t *src_hash,
                       apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h" 2
...
svn_error_t *svn_config__parse_stream(svn_config_t *cfg,
                                      ...
                                      apr_pool_t *result_pool,
                                      apr_pool_t *scratch_pool);
# 155 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_impl.h"
svn_error_t *
svn_config__sys_config_path(const char **path_p,
                            const char *fname,
                            apr_pool_t *pool);
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
svn_auth_get_ssl_client_cert_pw_prompt_provider(
  ...
  int retry_limit,
  apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
svn_ctype_casecmp(int a,
                  int b);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c" 2
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
typedef struct parse_context_t
{
  ...
  char parser_buffer[16384];
  size_t buffer_pos;
  size_t buffer_size;
} parse_context_t;
# 87 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
  ...
  do
    {
      if (ctx->ungotten_char != (-1))
      ...
      else
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_stream_read_full(ctx->stream, ctx->parser_buffer, &(ctx->buffer_size))); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 131 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
static __inline__ svn_error_t *
...
skip_whitespace(parse_context_t *ctx, int *c, int *pcount)
{
  ...
  do { svn_error_t *svn_err__temp = (parser_getc(ctx, &ch)); if (svn_err__temp) return (svn_err__temp); } while (0);
  while ((0 != (svn_ctype_table[(unsigned char)((ch))] & (0x0002))) && ch != '\n' && ch != (-1))
    {
      ++count;
      do { svn_error_t *svn_err__temp = (parser_getc_plain(ctx, &ch)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  *pcount = count;
  *c = ch;
  return 0;
  ...
  if (ch == 0xEF)
    {
      ...
      do { if (!(ctx->buffer_size > ctx->buffer_pos + 1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c", 227, "ctx->buffer_size > ctx->buffer_pos + 1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      if (buf[ctx->buffer_pos] == 0xBB && buf[ctx->buffer_pos + 1] == 0xBF)
        ctx->buffer_pos += 2;
      else
        do { svn_error_t *svn_err__temp = (parser_ungetc(ctx, ch)); if (svn_err__temp) return (svn_err__temp); } while (0);
    }
  else
    do { svn_error_t *svn_err__temp = (parser_ungetc(ctx, ch)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (;;)
    {
      ...
      if (ch == (-1) || end_of_val)
      ...
      else
        {
          int count;
          ++ctx->line;
          do { svn_error_t *svn_err__temp = (skip_whitespace(ctx, &ch, &count)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
parse_option(int *pch, parse_context_t *ctx, apr_pool_t *scratch_pool)
{
  ...
  if (ch != ':' && ch != '=')
    {
      ch = (-1);
      err = svn_error_createf(SVN_ERR_MALFORMED_FILE, ((void*)0),
                              dcgettext ("subversion", "line %d: Option must end with ':' or '='", 5),
                              ctx->line);
    }
  else
    {
...
# 367 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
static svn_error_t *
  ...
  if (ch != ']')
    {
      ch = (-1);
      err = svn_error_createf(SVN_ERR_MALFORMED_FILE, ((void*)0),
                              dcgettext ("subversion", "line %d: Section header must end with ']'", 5),
                              ctx->line);
    }
  else
    {

      do { svn_error_t *svn_err__temp = (skip_to_eoln(ctx, &ch)); if (svn_err__temp) return (svn_err__temp); } while (0);
      if (ch != (-1))
        ++ctx->line;
    }
...
{
  *path_p = ((void*)0);
# 436 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
  *path_p = svn_dirent_join_many(pool, "/etc/subversion", fname,
                         ...
                         apr_pool_t *pool)
{
  ...
  svn_config_enumerate2(cfg, name, expand_value, ((void*)0), pool);
                         ...
                         apr_pool_t *pool)
{
  ...
  cfg->x_pool = src->read_only ? ((void*)0) : svn_pool_create_ex(pool, ((void*)0));
                                    ...
                                    const char *section)
{
  ...
  apr_hash_set(target->sections, section, (-1), apr_hash_get(source->sections, section, (-1)));
                       ...
                       svn_boolean_t must_exist, apr_pool_t *result_pool)
{
  ...
  err = svn_io_file_open(&apr_file, file, 0x00001, 0x0FFF,
                         scratch_pool);
  ...
  stream = svn_stream_from_aprfile2(apr_file, 0, scratch_pool);
  ...
  if (err != 0)
    {
      ...
      err = svn_error_createf(err->apr_err, err,
                              dcgettext ("subversion", "Error while parsing config file: %s:", 5),
                         ...
                         apr_pool_t *result_pool, apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (skip_bom(ctx)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do
    {
      ...
      switch (ch)
        ...
        case '[':
          if (count == 0)
            do { svn_error_t *svn_err__temp = (parse_section_name(&ch, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          else
            return svn_error_createf(SVN_ERR_MALFORMED_FILE, ((void*)0),
                                     dcgettext ("subversion", "line %d: Section header" " must start in the first column", 5),
        ...
        case '#':
          if (count == 0)
            ...
            return svn_error_createf(SVN_ERR_MALFORMED_FILE, ((void*)0),
                                     dcgettext ("subversion", "line %d: Comment" " must start in the first column", 5),
        ...
        default:
          if (svn_stringbuf_isempty(ctx->section))
            return svn_error_createf(SVN_ERR_MALFORMED_FILE, ((void*)0),
                                     dcgettext ("subversion", "line %d: Section header expected", 5),
                                     ctx->line);
          else if (count != 0)
            return svn_error_createf(SVN_ERR_MALFORMED_FILE, ((void*)0),
                                     dcgettext ("subversion", "line %d: Option expected", 5),
                                     ctx->line);
          else
            do { svn_error_t *svn_err__temp = (parse_option(&ch, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
          break;
        }
    }
  while (ch != (-1));
...
svn_config_ensure(const char *config_dir, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_config_get_user_config_path(&path, config_dir, ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 746 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
  ensure_auth_dirs(path, pool);


  do { svn_error_t *svn_err__temp = (svn_config_get_user_config_path (&path, config_dir, "README.txt", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (kind == svn_node_none)
   ...
   "" "\n";
      ...
      if (! err)
        {
          do { svn_error_t *svn_err__temp = (svn_io_file_write_full(f, contents, strlen(contents), ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_config_get_user_config_path (&path, config_dir, "servers", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "###   http-pipelining            Whether to use HTTP pipelining " "\n"
        "###                              or send requests one by one." "\n"
  ...
  do { svn_error_t *svn_err__temp = (svn_config_get_user_config_path (&path, config_dir, "config", pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (kind == svn_node_none)
    {
      ...
      const char *contents =
        ...
        "# password-stores =" "\n"
# 1184 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
        "###" "\n"
                                ...
                                apr_pool_t *pool)
{
  *path= ((void*)0);
  ...
  if (config_dir)
    {
      *path = svn_dirent_join_many(pool, config_dir, fname, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
      return 0;
    }
# 1411 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/config_file.c"
  {
    ...
    *path = svn_dirent_join_many(pool,
                               ...
                               ".subversion", fname, ((struct svn_null_pointer_constant_stdarg_sentinel_t*)0));
  }
