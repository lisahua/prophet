# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 29 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
apr_status_t apr_password_get(const char *prompt, char *pwbuf,
                                           apr_size_t *bufsize);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
svn_hash_from_cstring_keys(apr_hash_t **hash,
                           ...
                           apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
svn_ctype_casecmp(int a,
                  int b);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/win32_xlate.h" 1
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
svn_mutex__unlock(svn_mutex__t *mutex,
                  svn_error_t *err);
# 48 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c" 2
...
# 71 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
...
# 89 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
...
# 202 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
}
                   ...
                   apr_pool_t *pool)
{
  ...
  do { if (!(frompage != (const char *)0 && topage != (const char *)0 && (frompage != (const char *)1 || topage != (const char *)1))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c", 222, "frompage != SVN_APR_DEFAULT_CHARSET && topage != SVN_APR_DEFAULT_CHARSET && (frompage != SVN_APR_LOCALE_CHARSET || topage != SVN_APR_LOCALE_CHARSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
# 230 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
  ...
  else if (apr_err != 0)
    {
      ...
      if (frompage == (const char *)1)
        errstr = apr_psprintf(pool,
                              dcgettext ("subversion", "Can't create a character converter from " "native encoding to '%s'", 5), topage);

      else if (topage == (const char *)1)
        errstr = apr_psprintf(pool,
                              dcgettext ("subversion", "Can't create a character converter from " "'%s' to native encoding", 5), frompage);

      else
        errstr = apr_psprintf(pool,
                              dcgettext ("subversion", "Can't create a character converter from " "'%s' to '%s'", 5), frompage, topage);
  ...
  *ret = apr_palloc(pool, sizeof(xlate_handle_node_t));
  (*ret)->handle = handle;
  (*ret)->valid = (!0);
  (*ret)->frompage = ((frompage != (const char *)1)
                      ? apr_pstrdup(pool, frompage) : frompage);
  (*ret)->topage = ((topage != (const char *)1)
...
# 296 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
static svn_error_t *
  ...
  if (userdata_key && xlate_handle_hash)
    {
      ...
      xlate_handle_node_t **old_node_p = apr_hash_get(xlate_handle_hash, userdata_key, strlen(userdata_key));
...
# 343 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
static svn_error_t *
                      ...
                      const char *userdata_key, apr_pool_t *pool)
{
  ...
  do { svn_mutex__t *svn_mutex__m = (xlate_handle_mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (get_xlate_handle_node_internal(ret, topage, frompage, userdata_key, pool)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  xlate_handle_node_t **node_p = apr_hash_get(xlate_handle_hash, userdata_key, strlen(userdata_key));
  if (node_p == ((void*)0))
    {
      ...
      node_p = apr_palloc(apr_hash_pool_get(xlate_handle_hash),
                          sizeof(*node_p));
      *node_p = ((void*)0);
      apr_hash_set(xlate_handle_hash, userdata_key, strlen(userdata_key), node_p);
    }
  node->next = *node_p;
  *node_p = node;
...
put_xlate_handle_node(xlate_handle_node_t *node,
                      ...
                      apr_pool_t *pool)
{
  ((node->next == ((void*)0)) ? (void) (0) : __assert_fail ("node->next == ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c", 426, __PRETTY_FUNCTION__));
  if (!userdata_key)
    return 0;
  ...
  if (xlate_handle_hash)
    {
      ...
      do { svn_mutex__t *svn_mutex__m = (xlate_handle_mutex); do { svn_error_t *svn_err__temp = (svn_mutex__lock(svn_mutex__m)); if (svn_err__temp) return (svn_err__temp); } while (0); do { svn_error_t *svn_err__temp = (svn_mutex__unlock(svn_mutex__m, (put_xlate_handle_node_internal(node, userdata_key)))); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (apr_err)
    {
      ...
      if (node->frompage == (const char *)1)
        errstr = apr_psprintf
          (pool, dcgettext ("subversion", "Can't convert string from native encoding to '%s':", 5),
           node->topage);
      else if (node->topage == (const char *)1)
        errstr = apr_psprintf
          (pool, dcgettext ("subversion", "Can't convert string from '%s' to native encoding:", 5),
           node->frompage);
      else
        errstr = apr_psprintf
          (pool, dcgettext ("subversion", "Can't convert string from '%s' to '%s':", 5),
           node->frompage, node->topage);

      err = svn_error_create(apr_err, ((void*)0), fuzzy_escape(src_data,
                                                         src_length, pool));
...
check_non_ascii(const char *data, apr_size_t len, apr_pool_t *pool)
{
  ...
  for (; len > 0; --len, data++)
    {
      if ((! (0 != (svn_ctype_table[(unsigned char)((*data))] & (0x0080))))
          || ((! (0 != (svn_ctype_table[(unsigned char)((*data))] & (0x0002))))
              && (0 != (svn_ctype_table[(unsigned char)((*data))] & (0x0001)))))
        {
# 647 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/utf.c"
          if (data - data_start)
            {
              ...
              return svn_error_createf
                (22, ((void*)0),
                 dcgettext ("subversion", "Safe data '%s' was followed by non-ASCII byte %d: " "unable to convert to/from UTF-8", 5),
          ...
          else
            {
              return svn_error_createf
                (22, ((void*)0),
                 dcgettext ("subversion", "Non-ASCII character (code %d) detected, " "and unable to convert to/from UTF-8", 5),
...
invalid_utf8(const char *data, apr_size_t len, apr_pool_t *pool)
{
  ...
  return svn_error_createf(22, ((void*)0),
                           dcgettext ("subversion", "Valid UTF-8 data\n(hex:%s)\n" "followed by invalid UTF-8 sequence\n(hex:%s)", 5),
                          ...
                          apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_ntou_xlate_handle_node(&node, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                ...
                apr_pool_t *pool)
{
  if (node->handle)
    {
      svn_stringbuf_t *destbuf;
      do { svn_error_t *svn_err__temp = (convert_to_stringbuf(node, src, strlen(src), &destbuf, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (check_non_ascii(src, len, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                        ...
                        apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_error_compose_create(err, put_xlate_handle_node (node, SVN_UTF_NTOU_XLATE_HANDLE, pool))); if (svn_err__temp) return (svn_err__temp); } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_xlate_handle_node(&node, SVN_APR_UTF8_CHARSET, frompage, convset_key, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_uton_xlate_handle_node(&node, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                          ...
                          apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (check_cstring_utf8(src, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                              ...
                              apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_xlate_handle_node(&node, topage, SVN_APR_UTF8_CHARSET, convset_key, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                    ...
                                    apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_utf_stringbuf_from_utf8(&destbuf, src, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  *dest = destbuf->data;
