...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/cat.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/cat.c" 2
...
svn_client__arbitrary_nodes_diff(const char **root_relpath,
                                 ...
                                 apr_pool_t *result_pool,
                                 apr_pool_t *scratch_pool);
# 41 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/cat.c" 2
...
svn_wc__diff7(const char **root_relpath,
              ...
              apr_pool_t *result_pool,
              apr_pool_t *scratch_pool);
# 44 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/cat.c" 2
                                  ...
                                  apr_pool_t *scratch_pool)
{
  ...
  do { if (!(((revision->kind) == svn_opt_revision_base || (revision->kind) == svn_opt_revision_working || (revision->kind) == svn_opt_revision_committed))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/cat.c", 69, "SVN_CLIENT__REVKIND_IS_LOCAL_TO_WC(revision->kind)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
