# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c"
...
svn_cmdline__getopt_init(apr_getopt_t **os,
                         ...
                         const char *argv[],
                         apr_pool_t *pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
...
svn_client_open_ra_session(svn_ra_session_t **session,
                           ...
                           svn_client_ctx_t *ctx,
                           apr_pool_t *pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
...
svn_error_t *svn_subst_detranslate_string(svn_string_t **new_value,
                                          ...
                                          apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c" 2
                ...
                apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_opt_parse_num_args(&args, os, opt_state->filedata ? 1 : 2, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  pname = (((const char * *)(args)->elts)[0]);
  do { svn_error_t *svn_err__temp = (svn_utf_cstring_to_utf8(&pname_utf8, pname, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (! svn_prop_name_is_valid(pname_utf8))
    return svn_error_createf(SVN_ERR_CLIENT_PROPERTY_NAME, ((void*)0),
                             dcgettext ("subversion", "'%s' is not a valid Subversion property name", 5),
                             pname_utf8);
  ...
  if (opt_state->filedata)
    {
      ...
      propval_came_from_cmdline = 0;
    }
  else
    {
      propval = svn_string_create((((const char * *)(args)->elts)[1]),
                                  scratch_pool);
      propval_came_from_cmdline = (!0);
    }
  ...
  if (svn_prop_needs_translation(pname_utf8))
    do { svn_error_t *svn_err__temp = (svn_subst_translate_string2(&propval, ((void*)0), ((void*)0), propval, opt_state->encoding, 0, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  else if (opt_state->encoding)
    return svn_error_create
      (SVN_ERR_UNSUPPORTED_FEATURE, ((void*)0),
       dcgettext ("subversion", "--encoding option applies only to textual" " Subversion-controlled properties", 5));
  ...
  if (opt_state->revprop)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_cl__revprop_prepare(&opt_state->start_revision, targets, &URL, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



      do { svn_error_t *svn_err__temp = (svn_client_revprop_set2(pname_utf8, propval, ((void*)0), URL, &(opt_state->start_revision), &rev, opt_state->force, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else if (opt_state->start_revision.kind != svn_opt_revision_unspecified)
    {
      return svn_error_createf
        (SVN_ERR_CL_ARG_PARSING_ERROR, ((void*)0),
         dcgettext ("subversion", "Cannot specify revision for setting versioned property '%s'", 5),
         pname);
    }
  else
    {
...
# 155 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svn/propset-cmd.c"
      if (targets->nelts == 0)
        {
          if (propval_came_from_cmdline)
            {
              return svn_error_createf
                (SVN_ERR_CL_INSUFFICIENT_ARGS, ((void*)0),
                 dcgettext ("subversion", "Explicit target required ('%s' interpreted as prop value)", 5),
                 propval->data);
            }
          else
            {
              return svn_error_create
                (SVN_ERR_CL_INSUFFICIENT_ARGS, ((void*)0),
                 dcgettext ("subversion", "Explicit target argument required", 5));
            }
        }

      do { svn_error_t *svn_err__temp = (svn_client_propset4(pname_utf8, propval, targets, opt_state->depth, opt_state->force, ((svn_revnum_t) -1), opt_state->changelists, ((void*)0), svn_cl__print_commit_info, ((void*)0), ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
