               ...
               apr_pool_t *scratch_pool)
{
  ...
  if (nwb.had_externals_error)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/svn/update-cmd.c",170), (svn_error_create))(SVN_ERR_CL_ERROR_PROCESSING_EXTERNALS, ((void*)0),
