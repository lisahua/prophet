                      ...
                      svn_error_t *(*init_func)(apr_pool_t*), apr_pool_t* pool)
{
  ...
  if (status == 0)
    ...
    {
      if (status == 2)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/atomic.c",67), (svn_error_create))(SVN_ERR_ATOMIC_INIT_FAILURE, ((void*)0),
