...
# 167 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
  if (!setlocale(6, "")
      && !setlocale(0, ""))
    {
      if (error_stream)
...
svn_cmdline_printf(apr_pool_t *pool, const char *fmt, ...)
{
  const char *message;
  va_list ap;
# 313 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
...
# 436 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
static svn_error_t *
  ...
  for (i = 0; i < config_options->nelts; i++)
   {
     ...
     cfg = apr_hash_get(config, arg->file, strlen(arg->file));
                   ...
                   apr_hash_t *config)
{
  ...
  if (! e)
    e = getenv("EDITOR");
# 999 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cmdline.c"
  if (e)
    {
      const char *c;
