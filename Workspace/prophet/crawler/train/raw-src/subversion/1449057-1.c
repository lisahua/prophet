# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_uri_get_file_url_from_dirent(const char **url,
                                 const char *dirent,
                                 apr_pool_t *result_pool);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_path_resolve_repos_relative_url(const char **absolute_url,
                                    ...
                                    apr_pool_t *pool);
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
...
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2

# 1 "./subversion/include/private/svn_fs_util.h" 1
# 54 "./subversion/include/private/svn_fs_util.h"
const char *
...
# 186 "./subversion/include/private/svn_fs_util.h"
char *
...
svn_fs__append_to_merged_froms(svn_mergeinfo_t *output,
                               ...
                               const char *rel_path,
                               apr_pool_t *pool);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
...
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h" 1
# 66 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
...
# 140 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
typedef svn_error_t *(*fs_init_func_t)(const svn_version_t *loader_version,
                                       fs_library_vtable_t **vtable,
                                       apr_pool_t* common_pool);
# 152 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
...
# 245 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
...
# 387 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/../libsvn_fs/fs-loader.h"
struct svn_fs_t
{
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_util/fs-util.c" 2
...
svn_fs__canonicalize_abspath(const char *path, apr_pool_t *pool)
{
  ...
  svn_boolean_t eating_slashes = 0;
  ...
  newpath = memset(apr_palloc(pool, path_len + 2), 0, path_len + 2);
                 ...
                 svn_boolean_t expect_open)
{
  ...
  if (expect_open)
    return svn_error_create(SVN_ERR_FS_NOT_OPEN, 0,
                            dcgettext ("subversion", "Filesystem object has not been opened yet", 5));
  else
    return svn_error_create(SVN_ERR_FS_ALREADY_OPEN, 0,
                            dcgettext ("subversion", "Filesystem object already open", 5));
}
                        ...
                        apr_pool_t *pool)
{
  ...
  end = (__extension__ (__builtin_constant_p ('/') && !__builtin_constant_p (path) && ('/') == '\0' ? (char *) __rawmemchr (path, '/') : __builtin_strchr (path, '/')));
  ...
  for (hi = apr_hash_first(pool, input); hi; hi = apr_hash_next(hi))
    {
      ...
      apr_hash_set(*output, svn_fspath__join(path, rel_path, pool),
                   (-1), svn_rangelist_dup(rangelist, pool));
    }
