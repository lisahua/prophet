      ...
      switch (action->action)
        {
          case ACTION_PROPSET:
            {
              ...
              if (!props)
                {
                  ...
                  do { svn_error_t *svn_err__temp = (eb->fetch_props_func(&props, eb->fetch_props_baton, path, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              ...
              if (!((props_base_revision) >= 0))
                ...
                do { if (!(p_args->base_revision == props_base_revision)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 262, "p_args->base_revision == props_base_revision")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
          ...
          case ACTION_SET_TEXT:
            {
              ...
              if (!((text_base_revision) >= 0))
                ...
                do { if (!(pca->base_revision == text_base_revision)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 308, "pca->base_revision == text_base_revision")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
          ...
          case ACTION_COPY:
            {
              ...
              do { svn_error_t *svn_err__temp = (svn_editor_copy(eb->editor, c_args->copyfrom_path, c_args->copyfrom_rev, path, ((svn_revnum_t) -1))); if (svn_err__temp) return (svn_err__temp); } while (0);
          ...
          default:
            do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 332, ((void*)0))); } while (0);
        }
    }
             ...
             void **file_baton)
{
  ...
  *file_baton = fb;
  ...
  do { svn_error_t *svn_err__temp = (fb->eb->fetch_base_func(&fb->delta_base, fb->eb->fetch_base_baton, path, result_pool, result_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 897 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
static svn_error_t *
      ...
      apr_pool_t *scratch_pool)
{
  ...
  do { if (!((props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 916, "(props && action == ACTION_PROPSET) || (!props && action != ACTION_PROPSET)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (props)
    {
      ...
      if (kind == svn_kind_unknown)
        do { svn_error_t *svn_err__temp = (eb->fetch_kind_func(&operation->kind, eb->fetch_kind_baton, relpath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      else
        operation->kind = kind;

      do { svn_error_t *svn_err__temp = (eb->fetch_props_func(&current_props, eb->fetch_props_baton, relpath, scratch_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




      do { svn_error_t *svn_err__temp = (svn_prop_diffs(&propdiffs, props, current_props, eb->edit_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (i = 0; i < propdiffs->nelts; i++)
        {
          ...
          if (!prop->value)
            (*((const char * *)apr_array_push(operation->prop_dels))) = prop->name;
          else
  ...
  if (action == ACTION_DELETE)
  ...
  else
    {
      ...
      do { return (svn_error__malfunction( (!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c", 1023, ((void*)0))); } while (0);
    }
                 ...
                 apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (ensure_root_opened(eb)); if (svn_err__temp) return (svn_err__temp); } while (0);
           ...
           apr_pool_t *scratch_pool)
{
  ...
  if (op->kind == svn_kind_dir)
  ...
  else
    {
      ...
      if (op->operation == OP_OPEN || op->operation == OP_PROPSET)
        do { svn_error_t *svn_err__temp = (editor->open_file(path, parent_op->baton, parent_op->base_revision, scratch_pool, &file_baton)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1681 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_delta/compat.c"
  return 0;
}
