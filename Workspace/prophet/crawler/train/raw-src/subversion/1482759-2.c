...
# 244 "./subversion/svn_private_config.h"
  ...
  while (1)
    {
      ...
      switch (opt)
        ...
        case 269:
          ...
          break;
# 729 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
        case 263:
...
# 906 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
...
# 1000 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
  {
    ...
    if (handling_mode == connection_mode_thread)
      {
        ...
        settings.single_threaded = 0;
# 1019 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
      }
  ...
  while (1)
    {
# 1035 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
      connection_pool
      ...
      if (((status) == 4) || ((status) == 103 || (status) == 71))
        {
...
# 1066 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/svnserve/svnserve.c"
