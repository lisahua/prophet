                          ...
                          apr_pool_t *pool)
{
  ...
  do { if (!(is_valid_version_info_skel(skel))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 314, "is_valid_version_info_skel(skel)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                           ...
                           apr_pool_t *scratch_pool)
{
  ...
  do { if (!(conflict->node_kind == svn_node_dir || conflict->node_kind == svn_node_file)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 362, "conflict->node_kind == svn_node_dir || conflict->node_kind == svn_node_file")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(strlen(victim_basename) > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 368, "strlen(victim_basename) > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(is_valid_conflict_skel(c_skel))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 373, "is_valid_conflict_skel(c_skel)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_wc__del_tree_conflict(svn_wc_context_t *wc_ctx,
                          ...
                          apr_pool_t *scratch_pool)
{
  do { if (!(svn_dirent_is_absolute(victim_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 385, "svn_dirent_is_absolute(victim_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_wc__get_tree_conflict(const svn_wc_conflict_description2_t **tree_conflict,
                          ...
                          apr_pool_t *scratch_pool)
{
  do { if (!(svn_dirent_is_absolute(victim_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 424, "svn_dirent_is_absolute(victim_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_wc__get_all_tree_conflicts(apr_hash_t **tree_conflicts,
                               ...
                               apr_pool_t *scratch_pool)
{
  do { if (!(svn_dirent_is_absolute(local_abspath))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_wc/tree_conflicts.c", 438, "svn_dirent_is_absolute(local_abspath)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
