  ...
  for (i = 0; i < targets->nelts; i++)
    {
      ...
      if (kind == svn_node_none)
        return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/delete.c",229), (svn_error_createf))(SVN_ERR_FS_NOT_FOUND, ((void*)0),
