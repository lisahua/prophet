                      ...
                      int base)
{
  ...
  if (val < 0 || val < minval || val > maxval)
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/svn_string.c",634), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Number '%s' is out of range", 5), str));
                     ...
                     int base)
{
  ...
  val = apr_strtoi64(str, &endptr, base);
  if ((*__errno_location ()) != 0 || endptr == str)
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/svn_string.c",671), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Could not convert '%s' into a number", 5), str));



  if (val < minval || val > maxval)
    return ((svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/svn_string.c",676), (svn_error_createf))(SVN_ERR_INCORRECT_PARAMS, ((void*)0), dcgettext ("subversion", "Number '%s' is out of range", 5), str));
