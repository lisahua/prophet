# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 311 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
# 23 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2

# 1 "./subversion/include/svn_io.h" 1
# 33 "./subversion/include/svn_io.h"
...
# 34 "./subversion/include/svn_io.h" 2
...
# 35 "./subversion/include/svn_io.h" 2
...
# 36 "./subversion/include/svn_io.h" 2
...
# 38 "./subversion/include/svn_io.h" 2
...
svn_io_file_readline(apr_file_t *file,
                     ...
                     apr_pool_t *result_pool,
                     apr_pool_t *scratch_pool);
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
svn_sort_compare_ranges(const void *a,
                        const void *b);
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
svn_bit_array__get(svn_bit_array__t *array,
                   apr_size_t idx);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2

# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.h" 1
# 26 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.h"
...
svn_fs_get_lock(svn_lock_t **lock,
                ...
                const char *path,
                apr_pool_t *pool);
# 2769 "./subversion/include/svn_fs.h"
...
svn_fs_get_locks2(svn_fs_t *fs,
                  ...
                  apr_pool_t *pool);
# 2816 "./subversion/include/svn_fs.h"
__attribute__((deprecated))
svn_error_t *
...
svn_fs_pack(const char *db_path,
            ...
            void *cancel_baton,
            apr_pool_t *pool);
# 2924 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_verify(const char *path,
              ...
              void *cancel_baton,
              apr_pool_t *scratch_pool);
# 2959 "./subversion/include/svn_fs.h"
svn_error_t *
...
# 3008 "./subversion/include/svn_fs.h"
...
# 3044 "./subversion/include/svn_fs.h"
svn_error_t *
svn_fs_info(const svn_fs_info_placeholder_t **fs_info,
            svn_fs_t *fs,
            apr_pool_t *result_pool,
            apr_pool_t *scratch_pool);
# 3060 "./subversion/include/svn_fs.h"
void *
...
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.h" 2
...
svn_fs_fs__deserialize_p2l_page(void **out,
                                ...
                                apr_size_t data_len,
                                apr_pool_t *pool);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
svn_fs_fs__order_dir_entries(svn_fs_t *fs,
                             ...
                             svn_revnum_t revision,
                             apr_pool_t *pool);
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
svn_fs_fs__deserialize_mergeinfo(void **out,
                                 ...
                                 apr_size_t data_len,
                                 apr_pool_t *pool);
# 38 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
# 42 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c" 2
...
# 141 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
                    ...
                    const char *message)
{
  const char *file_name;
  apr_off_t offset = 0;
  do { svn_error_t *svn_err__temp = (svn_io_file_name_get(&file_name, stream->file, stream->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_io_file_seek(stream->file, 1, &offset, stream->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  return svn_error_createf(err, ((void*)0), message, file_name,
                           (apr_uint64_t)offset);
}
...
packed_stream_read(svn_fs_fs__packed_number_stream_t *stream)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_aligned_seek(stream->file, stream->block_size, &block_start, stream->next_offset, stream->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (err && !((err) == ((20000 + 50000) + 14)))
    return stream_error_create(stream, err,
      dcgettext ("subversion", "Can't read index file '%s' at offset 0x%" "lx", 5));
  ...
  if (__builtin_expect(read == 0, 0))
    return stream_error_create(stream, err,
      dcgettext ("subversion", "Unexpected end of index file %s at offset 0x%""lx", 5));
  ...
  for (i = 0; i < read;)
    {
      if (buffer[i] < 0x80)
      ...
      else
        {
          ...
          if (__builtin_expect(shift > 8 * sizeof(value), 0))
            return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_CORRUPTION, ((void*)0),
                                     dcgettext ("subversion", "Corrupt index: number too large", 5));
       }
    }
                   ...
                   apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_open(&result->file, file_name, 0x00001 | 0x00080, 0x0FFF, result->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_fs_fs__packed_stream_close(svn_fs_fs__packed_number_stream_t *stream)
{
  if (stream)
    {
      do { svn_error_t *svn_err__temp = (svn_io_file_close(stream->file, stream->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  svn_fs_fs__packed_number_stream_t *stream)
{
  if (stream->current == stream->used)
    do { svn_error_t *svn_err__temp = (packed_stream_read(stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 448 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
                           ...
                           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_write(proto_index, &entry, &written, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { if (!(written == sizeof(entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 456, "written == sizeof(entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  for (i = start; i < end; ++i)
    {
      ...
      last_value = values[i];
      do { svn_error_t *svn_err__temp = (svn_spillbuf__write(buffer, (const char *)encoded, encode_int(encoded, diff), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_fs_fs__l2p_proto_index_open(apr_file_t **proto_index,
                                ...
                                apr_pool_t *pool)
{
  do { svn_error_t *svn_err__temp = (svn_io_file_open(proto_index, file_name, 0x00001 | 0x00002 | 0x00004 | 0x00008 | 0x00080, 0x0FFF, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                        ...
                                        apr_pool_t *pool)
{
  ...
  return (write_entry_to_proto_index(proto_index, entry, pool));
                                     ...
                                     apr_pool_t *pool)
{
  ...
  do { if (!(offset >= -1)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 523, "offset >= -1")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  do { if (!(item_index < (2147483647 *2U +1U) / 2)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 530, "item_index < UINT_MAX / 2")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
index_create(apr_file_t **index_file, const char *file_name, apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_remove_file2(file_name, (!0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  do { svn_error_t *svn_err__temp = (svn_io_file_open(index_file, file_name, 0x00002 | 0x00004 | 0x00080, 0x0FFF, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  apr_pool_t *local_pool = svn_pool_create_ex(pool, ((void*)0));
  apr_pool_t *iterpool = svn_pool_create_ex(local_pool, ((void*)0));
  ...
  if (ffd->l2p_page_size > (2147483647))
    return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_OVERFLOW , ((void*)0),
                            dcgettext ("subversion", "L2P index page size  %" "lu" " exceeds current limit of 2G entries", 5),

                            ffd->l2p_page_size);


  do { svn_error_t *svn_err__temp = (svn_io_file_open(&proto_index, proto_file_name, 0x00001 | 0x00004 | 0x00080, 0x0FFF, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (entry = 0; !eof; ++entry)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(proto_index, &proto_entry, sizeof(proto_entry), &read, &eof, local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { if (!(eof || read == sizeof(proto_entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 613, "eof || read == sizeof(proto_entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      if ((entry > 0 && proto_entry.offset == 0) || eof)
        {
          ...
          for (i = 0; i < entries->nelts; i += entry_count)
            {
              ...
              entry_count = ffd->l2p_page_size < entries->nelts - i
                          ...
                          : entries->nelts - i;
              do { svn_error_t *svn_err__temp = (encode_l2p_page(entries, i, i + entry_count, buffer, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


              (*((apr_uint64_t *)apr_array_push(entry_counts))) = entry_count;
              (*((apr_uint64_t *)apr_array_push(page_sizes)))
          ...
          (*((apr_uint64_t *)apr_array_push(page_counts)))
      ...
      else
        {
          ...
          if (proto_entry.item_index > (2147483647))
            return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_OVERFLOW , ((void*)0),
                                    dcgettext ("subversion", "Item index %" "lu" " too large in l2p proto index for" " revision %ld", 5),
          ...
          while (idx >= entries->nelts)
            (*((apr_uint64_t *)apr_array_push(entries))) = 0;

          (((apr_uint64_t *)(entries)->elts)[idx]) = proto_entry.offset;
        }
    }


  do { svn_error_t *svn_err__temp = (svn_io_file_close(proto_index, local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (index_create(&index_file, file_name, local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



  if (page_counts->nelts > (2147483647))
    return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_OVERFLOW , ((void*)0),
                            dcgettext ("subversion", "L2P index page count  %d" " exceeds current limit of 2G pages", 5),

                            page_counts->nelts);


  do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, revision), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, ffd->l2p_page_size), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, page_counts->nelts), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, page_sizes->nelts), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < page_counts->nelts; ++i)
    {
      apr_uint64_t value = (((apr_uint64_t *)(page_counts)->elts)[i]);
      do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, value), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (i = 0; i < page_sizes->nelts; ++i)
    {
      apr_uint64_t value = (((apr_uint64_t *)(page_sizes)->elts)[i]);
      do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, value), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      value = (((apr_uint64_t *)(entry_counts)->elts)[i]);
      do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, value), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_stream_copy3(svn_stream__from_spillbuf(buffer, local_pool), svn_stream_from_aprfile2(index_file, (!0), local_pool), ((void*)0), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);





  do { svn_error_t *svn_err__temp = (svn_io_file_close(index_file, local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (svn_io_set_file_read_only(file_name, 0, local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                     ...
                     svn_revnum_t revision)
{
  ...
  if (rev_file->file)
    do { svn_error_t *svn_err__temp = (svn_fs_fs__reopen_revision_file(rev_file, fs, revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
    rev_file->is_packed = svn_fs_fs__is_packed_rev(fs, revision);


  do { svn_error_t *svn_err__temp = (packed_stream_open(&rev_file->l2p_stream, svn_fs_fs__path_l2p_index(fs, revision, rev_file->is_packed, rev_file->pool), ffd->block_size, rev_file->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *pool)
{
  ...
  apr_off_t offset;
  l2p_header_t *result = memset(apr_palloc(pool, sizeof(*result)), 0, sizeof(*result));
  apr_size_t page_table_index;
  ...
  do { svn_error_t *svn_err__temp = (auto_open_l2p_index(rev_file, fs, revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
  packed_stream_seek(rev_file->l2p_stream, 0);


  do { svn_error_t *svn_err__temp = (packed_stream_get(&value, rev_file->l2p_stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (result->first_revision > revision
    ...
    return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_CORRUPTION, ((void*)0),
                      dcgettext ("subversion", "Corrupt L2P index for r%ld only covers r%ld:%ld", 5),
                      revision, result->first_revision,
                      result->first_revision + result->revision_count);


  result->page_table
    = memset(apr_palloc(pool, page_count * sizeof(*result->page_table)), 0, page_count * sizeof(*result->page_table));
  result->page_table_index
    = memset(apr_palloc(pool, (result->revision_count + 1) * sizeof(*result->page_table_index)), 0, (result->revision_count + 1) * sizeof(*result->page_table_index));
  ...
  *header = result;
  do { svn_error_t *svn_err__temp = (svn_cache__set(ffd->l2p_header_cache, &key, result, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   const apr_size_t *page_table_index)
{
  ...
  if (rel_revision >= header->revision_count)
    return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_REVISION , ((void*)0),
                             dcgettext ("subversion", "Revision %ld not covered by item index", 5),
                             baton->revision);
  ...
  if (baton->item_index < header->page_size)
  ...
  else
    {
      ...
      if (baton->item_index >= max_item_index)
        return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_OVERFLOW , ((void*)0),
                                dcgettext ("subversion", "Item index %" "lu" " exceeds l2p limit of %" "lu" " for revision %ld", 5),
                  ...
                  apr_pool_t *pool)
{
  ...
  key.revision = rev_file->start_revision;
  key.second = rev_file->is_packed;
  do { svn_error_t *svn_err__temp = (svn_cache__get_partial((void**)&dummy, &is_cached, ffd->l2p_header_cache, &key, l2p_page_info_access_func, baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (get_l2p_header_body(&result, rev_file, fs, baton->revision, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  do { svn_error_t *svn_err__temp = (l2p_page_info_copy(baton, result, result->page_table, result->page_table_index)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (rel_revision < header->revision_count)
    {
      ...
      for (; entry < last_entry; ++entry)
        (*((l2p_page_table_entry_t *)apr_array_push(table_baton->pages)))
          = *entry;
    }
...
# 1067 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
                   ...
                   apr_pool_t *pool)
{
  ...
  baton.pages = pages;
  do { svn_error_t *svn_err__temp = (svn_cache__get_partial((void**)&pages, &is_cached, ffd->l2p_header_cache, &key, l2p_page_table_access_func, &baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
{
  apr_uint32_t i;
  l2p_page_t *result = memset(apr_palloc(pool, sizeof(*result)), 0, sizeof(*result));
  apr_uint64_t last_value = 0;


  do { svn_error_t *svn_err__temp = (auto_open_l2p_index(rev_file, fs, start_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
  packed_stream_seek(rev_file->l2p_stream, table_entry->offset);


  result->entry_count = table_entry->entry_count;
  result->offsets = memset(apr_palloc(pool, result->entry_count * sizeof(*result->offsets)), 0, result->entry_count * sizeof(*result->offsets));
...
# 1141 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
                   ...
                   apr_pool_t *scratch_pool)
{
  ...
  *end = 0;
  do { svn_error_t *svn_err__temp = (get_l2p_page_table(pages, fs, rev_file, revision, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (pages->nelts == 0 || rev_file->l2p_stream == ((void*)0))
    {
  ...
  ((revision <= (4294967295U)) ? (void) (0) : __assert_fail ("revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1171, __PRETTY_FUNCTION__));
  ...
  for (i = 0; i < pages->nelts && !*end; ++i)
    {
      l2p_page_table_entry_t *entry
        = &(((l2p_page_table_entry_t *)(pages)->elts)[i]);
      apr_pool_clear(iterpool);
      ...
      key.page = i;
      do { svn_error_t *svn_err__temp = (svn_cache__has_key(end, ffd->l2p_page_cache, &key, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (!*end)
        {
          ...
          do { svn_error_t *svn_err__temp = (get_l2p_page(&page, rev_file, fs, first_revision, entry, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


          do { svn_error_t *svn_err__temp = (svn_cache__set(ffd->l2p_page_cache, &key, page, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   const apr_uint64_t *offsets)
{
  ...
  if (page->entry_count <= baton->page_offset)
    return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_OVERFLOW , ((void*)0),
                             dcgettext ("subversion", "Item index %" "lu" " too large in revision %ld", 5),
                 ...
                 apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_l2p_page_info(&info_baton, rev_file, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  ((revision <= (4294967295U)) ? (void) (0) : __assert_fail ("revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1305, __PRETTY_FUNCTION__));
  key.revision = (apr_uint32_t)revision;
  key.is_packed = svn_fs_fs__is_packed_rev(fs, revision);
  key.page = info_baton.page_no;

  do { svn_error_t *svn_err__temp = (svn_cache__get_partial(&dummy, &is_cached, ffd->l2p_page_cache, &key, l2p_entry_access_func, &page_baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!is_cached)
    {
      ...
      svn_boolean_t end;
      apr_off_t max_offset
        = (((info_baton.entry.offset + info_baton.entry.size) + ((0x10000) - 1)) & ~((0x10000) - 1));

      apr_off_t min_offset = max_offset - 0x10000;


      do { svn_error_t *svn_err__temp = (get_l2p_page(&page, rev_file, fs, info_baton.first_revision, &info_baton.entry, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);



      do { svn_error_t *svn_err__temp = (svn_cache__set(ffd->l2p_page_cache, &key, page, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (l2p_page_get_entry(&page_baton, page, page->offsets)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (prefetch_revision = revision;
           ...
           ++prefetch_revision)
        {
          ...
          do { svn_error_t *svn_err__temp = (prefetch_l2p_pages(&end, fs, rev_file, info_baton.first_revision, prefetch_revision, pages, excluded_page_no, min_offset, max_offset, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (prefetch_revision = revision-1;
           ...
           --prefetch_revision)
        {
          ...
          do { svn_error_t *svn_err__temp = (prefetch_l2p_pages(&end, fs, rev_file, info_baton.first_revision, prefetch_revision, pages, -1, min_offset, max_offset, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                       ...
                       apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_open(&file, svn_fs_fs__path_l2p_proto_index(fs, txn_id, pool), 0x00001 | 0x00080, 0x0FFF, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  while (!eof)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(file, &entry, sizeof(entry), &read, &eof, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { if (!(eof || read == sizeof(entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1405, "eof || read == sizeof(entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
               ...
               apr_pool_t *pool)
{
  ...
  key.revision = rev_file->start_revision;
  key.second = rev_file->is_packed;
  do { svn_error_t *svn_err__temp = (svn_cache__get((void**)header, &is_cached, ffd->l2p_header_cache, &key, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (is_cached)
    return 0;


  do { svn_error_t *svn_err__temp = (get_l2p_header_body(header, rev_file, fs, revision, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
svn_fs_fs__l2p_get_max_ids(apr_array_header_t **max_ids,
                           ...
                           apr_pool_t *pool)
{
  l2p_header_t *header = ((void*)0);
  svn_revnum_t revision;
  svn_revnum_t last_rev = (svn_revnum_t)(start_rev + count);
  svn_fs_fs__revision_file_t rev_file;
  apr_pool_t *header_pool = svn_pool_create_ex(pool, ((void*)0));


  svn_fs_fs__init_revision_file(&rev_file, fs, start_rev, header_pool);
  do { svn_error_t *svn_err__temp = (get_l2p_header(&header, &rev_file, fs, start_rev, header_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  for (revision = start_rev; revision < last_rev; ++revision)
    {
      ...
      if (revision >= header->first_revision + header->revision_count)
        {
          ...
          apr_pool_clear(header_pool);
          rev_file.start_revision = revision;
          do { svn_error_t *svn_err__temp = (get_l2p_header(&header, &rev_file, fs, revision, header_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      (*((apr_uint64_t *)apr_array_push(*max_ids))) = item_count;
    }

  apr_pool_destroy(header_pool);
  return 0;
}
                       ...
                       apr_pool_t *pool)
{
  ...
  if (txn_id)
      ...
      if (svn_fs_fs__use_log_addressing(fs, txn_id->revision + 1))
        {
          ...
          do { svn_error_t *svn_err__temp = (l2p_proto_index_lookup(absolute_position, fs, txn_id, item_index, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (err && !rev_file->is_packed)
        {
          ...
          if (svn_fs_fs__is_packed_rev(fs, revision) != rev_file->is_packed)
            {
              svn_error_clear(err);
              do { svn_error_t *svn_err__temp = (retry_open_l2p_index(rev_file, fs, revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  else if (rev_file->is_packed)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_fs_fs__get_packed_offset(&rev_offset, fs, revision, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                                     ...
                                     apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_write_full(proto_index, entry, sizeof(*entry), &written, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { if (!(written == sizeof(*entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1597, "written == sizeof(*entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                                       ...
                                       apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_seek(proto_index, 2, &offset, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  if (offset == 0)
    {
      *next_offset = 0;
    }
  else
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_seek(proto_index, 0, &offset, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(proto_index, &entry, sizeof(entry), ((void*)0), ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  apr_pool_t *iter_pool = svn_pool_create_ex(pool, ((void*)0));
  ...
  while (!eof)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_file_read_full2(proto_index, &entry, sizeof(entry), &read, &eof, iter_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { if (!(eof || read == sizeof(entry))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 1688, "eof || read == sizeof(entry)")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
      ...
      if (eof)
        {
          ...
          entry.size = (((entry.offset) + ((page_size) - 1)) & ~((page_size) - 1)) - entry.offset;
          entry.type = 0;
      ...
      else
        {
          ...
          if (entry.item.revision == ((svn_revnum_t) -1))
      ...
      while (entry_end - last_page_end > page_size)
        {
          ...
          (*((apr_uint64_t *)apr_array_push(table_sizes)))
      ...
      if (new_page)
        {
          do { svn_error_t *svn_err__temp = (svn_spillbuf__write(buffer, (const char *)encoded, encode_uint(encoded, entry.offset), iter_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_spillbuf__write(buffer, (const char *)encoded, encode_uint(encoded, entry.size), iter_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_spillbuf__write(buffer, (const char *)encoded, encode_int(encoded, compound_diff), iter_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_spillbuf__write(buffer, (const char *)encoded, encode_int(encoded, rev_diff), iter_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


      do { svn_error_t *svn_err__temp = (svn_spillbuf__write(buffer, (const char *)encoded, encode_uint(encoded, entry.fnv1_checksum), iter_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, file_size), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, page_size), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);




  do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, table_sizes->nelts), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  for (i = 0; i < table_sizes->nelts; ++i)
    {
      apr_uint64_t value = (((apr_uint64_t *)(table_sizes)->elts)[i]);
      do { svn_error_t *svn_err__temp = (svn_io_file_write_full(index_file, encoded, encode_uint(encoded, value), ((void*)0), local_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                     ...
                     svn_revnum_t revision)
{
  ...
  do { svn_error_t *svn_err__temp = (packed_stream_open(&rev_file->p2l_stream, svn_fs_fs__path_p2l_index(fs, revision, rev_file->is_packed, rev_file->pool), ffd->block_size, rev_file->pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
               ...
               apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__get((void**)header, &is_cached, ffd->p2l_header_cache, &key, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (rev_file->p2l_stream == ((void*)0))
    do { svn_error_t *svn_err__temp = (auto_open_p2l_index(rev_file, fs, key.revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
  else
  ...
  do { svn_error_t *svn_err__temp = (packed_stream_get(&value, rev_file->p2l_stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
  result->first_revision = (svn_revnum_t)value;
  do { svn_error_t *svn_err__temp = (packed_stream_get(&value, rev_file->p2l_stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  result->offsets
    = memset(apr_palloc(pool, (result->page_count + 1) * sizeof(*result->offsets)), 0, (result->page_count + 1) * sizeof(*result->offsets));
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__set(ffd->p2l_header_cache, &key, result, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                  ...
                  apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__get_partial(&dummy, &is_cached, ffd->p2l_header_cache, &key, p2l_page_info_func, baton, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  if (is_cached)
    return 0;

  do { svn_error_t *svn_err__temp = (get_p2l_header(&header, rev_file, fs, baton->revision, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
           ...
           apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (packed_stream_get(&value, stream)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  *last_revision += (svn_revnum_t)decode_int(value);
  ...
  (*((svn_fs_fs__p2l_entry_t *)apr_array_push(result))) = entry;
  *item_offset += entry.size;

  return 0;
}
# 2094 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (auto_open_p2l_index(rev_file, fs, start_revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do
    {
      do { svn_error_t *svn_err__temp = (read_entry(rev_file->p2l_stream, &item_offset, &last_revision, &last_compound, result, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 2160 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
static svn_error_t *
                  ...
                  apr_pool_t *scratch_pool)
{
  ...
  *end = 0;
  ...
  do { svn_error_t *svn_err__temp = (get_p2l_page_info(baton, rev_file, fs, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  ((baton->first_revision <= (4294967295U)) ? (void) (0) : __assert_fail ("baton->first_revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2186, __PRETTY_FUNCTION__));
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__has_key(&already_cached, ffd->p2l_page_cache, &key, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (get_p2l_page(&page, rev_file, fs, baton->first_revision, baton->start_offset, baton->next_offset, baton->page_start, baton->page_size, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 2215 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c"
  do { svn_error_t *svn_err__temp = (svn_cache__set(ffd->p2l_page_cache, &key, page, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
             ...
             apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (get_p2l_page_info(&page_info, rev_file, fs, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);


  if (page_info.page_count <= page_info.page_no)
    return svn_error_createf(SVN_ERR_FS_ITEM_INDEX_OVERFLOW , ((void*)0),
                              dcgettext ("subversion", "Offset %s too large in revision %ld", 5),
  ...
  if (key_p)
    {
      svn_fs_fs__page_cache_key_t key = { 0 };
      ((page_info.first_revision <= (4294967295U)) ? (void) (0) : __assert_fail ("page_info.first_revision <= (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2256, __PRETTY_FUNCTION__));
                   ...
                   apr_off_t block_end)
{
  ...
  if (idx > 0)
    {
      entry = &(((svn_fs_fs__p2l_entry_t *)(page_entries)->elts)[idx - 1]);
  ...
  for ( ; idx < page_entries->nelts; ++idx)
    {
      entry = &(((svn_fs_fs__p2l_entry_t *)(page_entries)->elts)[idx]);
      if (entry->offset >= block_end)
        break;

      (*((svn_fs_fs__p2l_entry_t *)apr_array_push(entries))) = *entry;
    }
}
                 ...
                 apr_pool_t *pool)
{
  ...
  do { if (!(block_start < block_end)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2373, "block_start < block_end")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


  do { svn_error_t *svn_err__temp = (get_p2l_keys(&page_info, &key, rev_file, fs, revision, block_start, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_cache__get_partial((void**)&local_result, &is_cached, ffd->p2l_page_cache, &key, p2l_entries_func, &block, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!is_cached)
    {
      ...
      apr_off_t max_offset
        = (((page_info.next_offset) + ((ffd->block_size) - 1)) & ~((ffd->block_size) - 1));
      apr_off_t min_offset
        = (((page_info.start_offset) + ((ffd->block_size) - 1)) & ~((ffd->block_size) - 1)) - ffd->block_size;
      ...
      while (prefetch_info.offset >= prefetch_info.page_size && !end)
        {
          ...
          do { svn_error_t *svn_err__temp = (prefetch_p2l_page(&end, &leaking_bucket, fs, rev_file, &prefetch_info, min_offset, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);


        }


      do { svn_error_t *svn_err__temp = (get_p2l_page(&page_entries, rev_file, fs, page_info.first_revision, page_info.start_offset, page_info.next_offset, page_info.page_start, page_info.page_size, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      do { svn_error_t *svn_err__temp = (svn_cache__set(ffd->p2l_page_cache, &key, page_entries, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { if (!(entries->nelts > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2450, "entries->nelts > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
  ...
  if (page_info.page_no + 1 >= page_info.page_count)
    {
      svn_fs_fs__p2l_entry_t *entry
        = &(((svn_fs_fs__p2l_entry_t *)(entries)->elts)[entries->nelts-1]);
                            ...
                            apr_pool_t *pool)
{
  ...
  while (block_start < block_end)
    {
      svn_fs_fs__p2l_entry_t *entry;
      do { svn_error_t *svn_err__temp = (p2l_index_lookup(result, rev_file, fs, revision, block_start, block_end, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      do { if (!(result->nelts > 0)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2510, "result->nelts > 0")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);


      entry = &(((svn_fs_fs__p2l_entry_t *)(result)->elts)[result->nelts-1]);
      ...
      if (last_count > 0 && last_count < result->nelts)
        {
           entry = &(((svn_fs_fs__p2l_entry_t *)(result)->elts)[last_count - 1]);

           do { if (!((((svn_fs_fs__p2l_entry_t *)(result)->elts)[last_count]).offset >= entry->offset + entry->size)) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_fs_fs/index.c", 2524, "APR_ARRAY_IDX(result, last_count, svn_fs_fs__p2l_entry_t).offset >= entry->offset + entry->size")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
                               ...
                               apr_pool_t *pool)
{
  ...
  entry = svn_sort__array_lookup(entries, &offset, ((void*)0),
      (int (*)(const void *, const void *))compare_p2l_entry_offsets);


  return entry ? apr_pmemdup(pool, entry, sizeof(*entry)) : ((void*)0);
}
                            ...
                            apr_pool_t *pool)
{
  ...
  *entry_p = ((void*)0);
  ...
  do { svn_error_t *svn_err__temp = (get_p2l_keys(&page_info, &key, rev_file, fs, revision, offset, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

  do { svn_error_t *svn_err__temp = (svn_cache__get_partial((void**)entry_p, &is_cached, ffd->p2l_page_cache, &key, p2l_entry_lookup_func, &offset, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  if (!is_cached)
    {
      ...
      do { svn_error_t *svn_err__temp = (p2l_index_lookup(entries, rev_file, fs, revision, offset, offset + 1, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                   ...
                   apr_pool_t *pool)
{
  ...
  do { svn_error_t *svn_err__temp = (svn_cache__get_partial((void **)&offset_p, &is_cached, ffd->p2l_header_cache, &key, p2l_get_max_offset_func, ((void*)0), pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  do { svn_error_t *svn_err__temp = (get_p2l_header(&header, rev_file, fs, revision, pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                              ...
                              apr_pool_t *pool)
{
  ...
  if (err && svn_fs_fs__is_packed_rev(fs, revision) != rev_file->is_packed)
    {
      svn_error_clear(err);
      do { svn_error_t *svn_err__temp = (retry_open_p2l_index(rev_file, fs, revision)); if (svn_err__temp) return (svn_err__temp); } while (0);
