...
svn_wc_walk_status(svn_wc_context_t *wc_ctx,
                   ...
                   void *cancel_baton,
                   apr_pool_t *scratch_pool);
# 4347 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_get_diff_editor6(const svn_delta_editor_t **editor,
                        ...
                        apr_pool_t *result_pool,
                        apr_pool_t *scratch_pool);
# 6591 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_transmit_text_deltas3(const svn_checksum_t **new_text_base_md5_checksum,
                             ...
                             apr_pool_t *result_pool,
                             apr_pool_t *scratch_pool);
# 7854 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
...
svn_wc_transmit_prop_deltas(const char *path,
                            ...
                            const char **tempfile,
                            apr_pool_t *pool);
# 7928 "./subversion/include/svn_wc.h"
svn_error_t *
...
# 8089 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_revision_status(svn_wc_revision_status_t **result_p,
                       ...
                       void *cancel_baton,
                       apr_pool_t *pool);
# 8150 "./subversion/include/svn_wc.h"
svn_error_t *
...
svn_wc_set_changelist(const char *path,
                      ...
                      void *notify_baton,
                      apr_pool_t *pool);
# 8190 "./subversion/include/svn_wc.h"
...
svn_wc_get_changelists(svn_wc_context_t *wc_ctx,
                       ...
                       void *cancel_baton,
                       apr_pool_t *scratch_pool);
# 8241 "./subversion/include/svn_wc.h"
svn_error_t *
svn_wc_crop_tree2(svn_wc_context_t *wc_ctx,
                  ...
                  void *notify_baton,
                  apr_pool_t *scratch_pool);
# 8261 "./subversion/include/svn_wc.h"
__attribute__((deprecated))
svn_error_t *
svn_wc_crop_tree(svn_wc_adm_access_t *anchor,
                 ...
                 void *cancel_baton,
                 apr_pool_t *pool);
# 8291 "./subversion/include/svn_wc.h"
svn_error_t *
...
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
...
svn_wc__acquire_write_lock_for_resolve(const char **lock_root_abspath,
                                       ...
                                       apr_pool_t *result_pool,
                                       apr_pool_t *scratch_pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c" 2
  ...
  if (remove_unversioned_items || remove_ignored_items)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc_locked2(&is_locked_here, &is_locked, ctx->wc_ctx, local_abspath, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);

      if (is_locked && !is_locked_here)
        return svn_error_createf(SVN_ERR_WC_LOCKED, ((void*)0),
                                 dcgettext ("subversion", "Working copy at '%s' is already locked.", 5),
                                 svn_dirent_local_style(local_abspath,
                                                        scratch_pool));

      do { svn_error_t *svn_err__temp = (svn_config_get_bool(cfg, &sqlite_exclusive, "working-copy", "exclusive-locking", 0)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (sqlite_exclusive)
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__close_db(local_abspath, ctx->wc_ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
        }
    }
  ...
  if (remove_unversioned_items || remove_ignored_items || include_externals)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc_walk_status(ctx->wc_ctx, local_abspath, svn_depth_infinity, (!0), remove_ignored_items, (!0), ignores, cleanup_status_walk, &b, ctx->cancel_func, ctx->cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 132 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_client/cleanup.c"
    }
  ...
  if (status->node_status == svn_wc_status_external && b->include_externals)
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_io_check_path(local_abspath, &kind_on_disk, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
  ...
  switch (kind_on_disk)
    {
      ...
      case svn_node_symlink:
        ...
        break;
      case svn_node_dir:
        do { svn_error_t *svn_err__temp = (svn_io_remove_dir2(local_abspath, 0, b->ctx->cancel_func, b->ctx->cancel_baton, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
                    ...
                    apr_pool_t *scratch_pool)
{
  ...
  do { svn_error_t *svn_err__temp = (do_cleanup(local_abspath, include_externals, remove_unversioned_items, remove_ignored_items, ctx, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
