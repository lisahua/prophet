# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c" 2
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c"
...
svn_error_abort_on_malfunction(svn_boolean_t can_return,
                               ...
                               int line,
                               const char *expr);
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c" 2
...
svn_wc_read_kind(svn_node_kind_t *kind,
                 ...
                 svn_boolean_t show_hidden,
                 apr_pool_t *scratch_pool);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c" 2
...
svn_client__do_commit(const char *base_url,
                      ...
                      apr_pool_t *result_pool,
                      apr_pool_t *scratch_pool);
# 980 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
svn_client__handle_externals(apr_hash_t *externals_new,
                             ...
                             svn_client_ctx_t *ctx,
                             apr_pool_t *pool);
# 1011 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/client.h"
svn_error_t *
...
svn_cl__rev_default_to_peg(const svn_opt_revision_t *revision,
                           const svn_opt_revision_t *peg_revision);
# 36 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c" 2
...
svn_wc__move2(svn_wc_context_t *wc_ctx,
              ...
              void *notify_baton,
              apr_pool_t *scratch_pool);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_client/iprops.c" 2
  ...
  if (((revision) >= 0))
    {
      ...
      do { svn_error_t *svn_err__temp = (svn_wc__get_cached_iprop_children(&iprop_paths, depth, ctx->wc_ctx, local_abspath, scratch_pool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (!apr_hash_get(iprop_paths, local_abspath, (-1)))
        {
          svn_boolean_t needs_cached_iprops;

          do { svn_error_t *svn_err__temp = (need_to_cache_iprops(&needs_cached_iprops, local_abspath, ctx, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      for (hi = apr_hash_first(scratch_pool, iprop_paths);
           ...
           hi = apr_hash_next(hi))
        {
          ...
          do { svn_error_t *svn_err__temp = (svn_wc__node_get_url(&url, ctx->wc_ctx, child_abspath, iterpool, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);

          if (ra_session)
            {
              if (old_session_url)
                do { svn_error_t *svn_err__temp = (svn_ra_reparent(ra_session, url, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
              else
          ...
          do { svn_error_t *svn_err__temp = (svn_ra_get_inherited_props(ra_session, &inherited_props, "", revision, result_pool, scratch_pool)); if (svn_err__temp) return (svn_err__temp); } while (0);
      ...
      if (old_session_url)
        do { svn_error_t *svn_err__temp = (svn_ra_reparent(ra_session, old_session_url, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
