...
svn_mutex__unlock(svn_mutex__t *mutex,
                  svn_error_t *err);
# 34 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c" 2
                   ...
                   struct cache_page *page)
{
  ...
  do { if (!(page != cache->sentinel)) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 160, "page != cache->sentinel"), (((void*)0))); } } while (0);
...
# 230 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c"
  *value_p = ((void*)0);
  *found = buffer != ((void*)0);
  return buffer && size
  ...
  if (existing_entry && cache->items_per_page == 1)
    {
      ...
      do { if (!(page->next != ((void*)0))) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 291, "page->next != ((void*)0)"), (((void*)0))); } } while (0);
      do { if (!(cache->partial_page == ((void*)0))) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 292, "cache->partial_page == ((void*)0)"), (((void*)0))); } } while (0);
  ...
  if (cache->partial_page == ((void*)0))
    {
      ...
      do { if (!(oldest_page != cache->sentinel)) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 342, "oldest_page != cache->sentinel"), (((void*)0))); } } while (0);


      erase_page(cache, oldest_page);
    }

  do { if (!(cache->partial_page != ((void*)0))) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 348, "cache->partial_page != ((void*)0)"), (((void*)0))); } } while (0);
                            ...
                            apr_pool_t *pool)
{
  ...
  do { if (!(klen == (-1) || klen >= 1)) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 619, "klen == (-1) || klen >= 1"), (((void*)0))); } } while (0);
  ...
  do { if (!(pages >= 1)) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 627, "pages >= 1"), (((void*)0))); } } while (0);
  cache->total_pages = pages;
  cache->unallocated_pages = pages;
  do { if (!(items_per_page >= 1)) { return svn_error_compose_create( svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src1/subversion/libsvn_subr/cache-inprocess.c", 630, "items_per_page >= 1"), (((void*)0))); } } while (0);
