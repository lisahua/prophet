# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 313 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
# 24 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c"
...
# 25 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 27 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
# 28 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
# 30 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
# 31 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
# 32 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
apr_status_t apr_temp_dir_get(const char **temp_dir,
                                           apr_pool_t *p);
# 33 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
apr_status_t apr_password_validate(const char *passwd,
                                                const char *hash);
# 35 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
# 37 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
svn_pool_create_ex_debug(apr_pool_t *parent_pool,
                         apr_allocator_t *allocator,
                         const char *file_line);
# 39 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
svn_io_write_version_file(const char *path,
                          int version,
                          apr_pool_t *pool);
# 40 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
svn_utf_cstring_from_utf8_string(const char **dest,
                                 const svn_string_t *src,
                                 apr_pool_t *pool);
# 43 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
svn_path_cstring_to_utf8(const char **path_utf8,
                         const char *path_apr,
                         apr_pool_t *pool);
# 45 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
# 46 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c" 2
...
{
  do { if (!(stream->read_fn != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c", 125, "stream->read_fn != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
{
  do { if (!(stream->write_fn != ((void*)0))) do { svn_error_t *svn_err__temp = (svn_error__malfunction((!0), "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c", 133, "stream->write_fn != NULL")); if (svn_err__temp) return (svn_err__temp); } while (0); } while (0);
...
svn_stream_reset(svn_stream_t *stream)
{
  if (stream->reset_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",142), (svn_error_create))(SVN_ERR_STREAM_RESET_NOT_SUPPORTED, ((void*)0), ((void*)0));
                ...
                apr_pool_t *pool)
{
  if (stream->mark_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",152), (svn_error_create))(SVN_ERR_STREAM_SEEK_NOT_SUPPORTED, ((void*)0), ((void*)0));
...
svn_stream_seek(svn_stream_t *stream, svn_stream_mark_t *mark)
{
  if (stream->seek_fn == ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",161), (svn_error_create))(SVN_ERR_STREAM_SEEK_NOT_SUPPORTED, ((void*)0), ((void*)0));
...
# 833 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c"
struct zbaton {
  z_stream *in;
  z_stream *out;
  svn_read_fn_t read;
...
zerr_to_svn_error(int zerr, const char *function, z_stream *stream)
{
  ...
  if (stream->msg != ((void*)0))
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",910), (svn_error_createf))(status, ((void*)0), "zlib (%s): %s: %s", function,
                             message, stream->msg);
  else
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",913), (svn_error_createf))(status, ((void*)0), "zlib (%s): %s", function,
                             message);
}
...
svn_stream_compressed(svn_stream_t *stream, apr_pool_t *pool)
{
  ...
  ((stream != ((void*)0)) ? (void) (0) : __assert_fail ("stream != ((void*)0)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c", 1090, __PRETTY_FUNCTION__));
...
svn_stream_for_stdout(svn_stream_t **out, apr_pool_t *pool)
{
  ...
  if (apr_err)
    return (svn_error__locate("/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/stream.c",1442), (svn_error_wrap_apr))(apr_err, "Can't open stdout");
