...
# 592 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 711 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
allocate_spare_group(svn_membuffer_t *cache)
{
  ...
  ((!group || !group->header.used) ? (void) (0) : __assert_fail ("!group || !group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 781, __PRETTY_FUNCTION__));
  return group;
}
...
free_spare_group(svn_membuffer_t *cache,
                 entry_group_t *group)
{
  ((group->header.used == 0) ? (void) (0) : __assert_fail ("group->header.used == 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 791, __PRETTY_FUNCTION__));
  ((group->header.previous != (4294967295U)) ? (void) (0) : __assert_fail ("group->header.previous != (4294967295U)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 792, __PRETTY_FUNCTION__));
  ((group - cache->directory >= (apr_ssize_t)cache->group_count) ? (void) (0) : __assert_fail ("group - cache->directory >= (apr_ssize_t)cache->group_count", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 793, __PRETTY_FUNCTION__));
            ...
            apr_uint32_t idx)
{
  ...
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 877, __PRETTY_FUNCTION__));
...
unchain_entry(svn_membuffer_t *cache,
              ...
              apr_uint32_t idx)
{
  ((idx == get_index(cache, entry)) ? (void) (0) : __assert_fail ("idx == get_index(cache, entry)", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 924, __PRETTY_FUNCTION__));
...
insert_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((entry->offset == level->current_data) ? (void) (0) : __assert_fail ("entry->offset == level->current_data", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1052, __PRETTY_FUNCTION__));
  ((idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used) ? (void) (0) : __assert_fail ("idx == group_index * ((512 - sizeof(group_header_t)) / sizeof(entry_t)) + group->header.used", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1053, __PRETTY_FUNCTION__));
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1070, __PRETTY_FUNCTION__));
}
  ...
  while (1)
    {
      ...
      ((group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))) ? (void) (0) : __assert_fail ("group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t))", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1176, __PRETTY_FUNCTION__));
      group = &cache->directory[group->header.next];
    }
  ...
  if (find_empty)
    {
      ...
      if (group->header.used == ((512 - sizeof(group_header_t)) / sizeof(entry_t)))
        {
# 1213 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
move_entry(svn_membuffer_t *cache, entry_t *entry)
{
  ...
  ((level->current_data <= level->start_offset + level->size) ? (void) (0) : __assert_fail ("level->current_data <= level->start_offset + level->size", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1292, __PRETTY_FUNCTION__));
}
...
promote_entry(svn_membuffer_t *cache, entry_t *entry)
{
  apr_uint32_t idx = get_index(cache, entry);
  apr_size_t size = (((entry->size) + 16 -1) & -16);
  ((get_cache_level(cache, entry) == &cache->l1) ? (void) (0) : __assert_fail ("get_cache_level(cache, entry) == &cache->l1", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1302, __PRETTY_FUNCTION__));
  ((idx == cache->l1.next) ? (void) (0) : __assert_fail ("idx == cache->l1.next", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1303, __PRETTY_FUNCTION__));
...
# 1365 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  while (1)
    {
...
# 1498 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_boolean_t
...
# 1564 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
                                  ...
                                  apr_pool_t *pool)
{
  ...
  if (segment_count < 1)
    {
# 1634 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  ...
  ((spare_group_count > 0 && main_group_count > 0) ? (void) (0) : __assert_fail ("spare_group_count > 0 && main_group_count > 0", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 1700, __PRETTY_FUNCTION__));
...
# 1901 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
      if (size)
  ...
  if (level)
    {
      ...
      entry->offset = level->current_data;
      entry->priority = priority;
# 1933 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 1965 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 1998 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
# 2010 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
...
# 2057 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  entry->hit_count++;
  cache->hit_count++;
  cache->total_hits++;
...
# 2097 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  if (buffer == ((void*)0))
    {
      *item = ((void*)0);
      return 0;
...
# 2173 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry == ((void*)0))
  ...
  else
    {
      *found = (!0);
      ...
      cache->hit_count++;
      cache->total_hits++;
# 2219 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2264 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static svn_error_t *
  ...
  if (entry != ((void*)0))
    {
      ...
      cache->hit_count++;
      cache->total_writes++;
# 2310 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2355 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
        }
    }
...
# 2405 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
...
# 2486 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
static void
combine_long_key(svn_membuffer_cache_t *cache,
                 const void *key,
                 apr_ssize_t key_len)
{
  ((cache->last_access) ? (void) (0) : __assert_fail ("cache->last_access", "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c", 2491, __PRETTY_FUNCTION__));
...
# 2755 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 2951 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
  return 0;
}
...
# 3091 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_subr/cache-membuffer.c"
