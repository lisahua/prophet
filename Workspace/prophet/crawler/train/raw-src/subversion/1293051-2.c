...
# 53 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 91 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
struct edit_baton
{
               ...
               apr_pool_t *pool)
{
  ...
  do { if (!(!path || pb)) { svn_error__malfunction(0, "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c", 192, "!path || pb"); abort(); } } while (0);
...
# 230 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
static svn_error_t *
...
# 1022 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
static svn_error_t *
  ...
  for (i = start_rev; i <= end_rev; i++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor(&dump_editor, &dump_edit_baton, fs, to_rev, "", stream, &found_old_reference, &found_old_mergeinfo, ((void*)0), notify_func, notify_baton, start_rev, use_deltas_for_rev, 0, subpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
...
# 1232 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
        }
      else
        {
...
# 1314 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
static svn_error_t *
  ...
  for (rev = start_rev; rev <= end_rev; rev++)
    {
      ...
      do { svn_error_t *svn_err__temp = (get_dump_editor((const svn_delta_editor_t **)&dump_editor, &dump_edit_baton, fs, rev, "", svn_stream_empty(iterpool), ((void*)0), ((void*)0), verify_close_directory, notify_func, notify_baton, start_rev, 0, (!0), iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
# 1425 "/home/ubuntu/Workspace/prophet/crawler/__tmp/src2/subversion/libsvn_repos/dump.c"
      ...
      do { svn_error_t *svn_err__temp = (cancel_editor->close_edit(cancel_edit_baton, iterpool)); if (svn_err__temp) return (svn_err__temp); } while (0);
